...
<div align="left">
    ...
    <a href="https://github.com/unified-to/unified-java-sdk.git/actions"><img src="https://img.shields.io/github/actions/workflow/status/speakeasy-sdks/bolt-php/speakeasy_sdk_generation.yml?style=for-the-badge" /></a>
...
```groovy
implementation 'com.unifiedapi.unifiedto:Unified-java-sdk:0.3.0'
```
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DeleteTicketingConnectionIdAgentIdRequest req = new DeleteTicketingConnectionIdAgentIdRequest("unde", "nulla");            
