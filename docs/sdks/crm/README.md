    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateCrmCompanyRequest req = CreateCrmCompanyRequest.builder()
                .crmCompany(CrmCompany.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2025-02-08T18:52:45.950Z"))
                    .websites(List.of(
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateCrmContactRequest req = CreateCrmContactRequest.builder()
                .crmContact(CrmContact.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2021-02-23T11:02:48.853Z"))
                    .build())
                .connectionId("<id>")
                .build();
                ...
                .crmCompany(CrmCompany.builder()
                    ...
                    .telephones(List.of(
                        ...
                        CrmTelephone.builder()
                            ...
                            .build()))
                    .timezone("Europe/San_Marino")
                    .updatedAt(OffsetDateTime.parse("2025-02-08T18:52:45.974Z"))
                    .websites(List.of(
                        "https://wise-possession.org"))
                    .build())
                .connectionId("<id>")
                ...
                .crmContact(CrmContact.builder()
                    ...
                    .telephones(List.of(
                        ...
                        CrmTelephone.builder()
                            ...
                            .build()))
                    .title("National Tactics Analyst")
                    .updatedAt(OffsetDateTime.parse("2021-02-23T11:02:48.854Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
