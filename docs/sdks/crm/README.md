                ...
                .crmCompany(CrmCompany.builder()
                    ...
                    .emails(List.of(
                        ...
                        CrmEmail.builder()
                            ...
                            .build()))
                    .employees(967d)
                    .id("d6435bfe-3e06-42d0-9aa1-587f16a08c4b")
                    ...
                    .metadata(List.of(
                        CrmMetadata.builder()
                            ...
                            .id("261cfe4b-64bc-40d9-9c01-88e45c01aa20")
                            .namespace("custom")
                    ...
                    .updatedAt(OffsetDateTime.parse("2025-02-08T01:13:54.245Z"))
                    .websites(List.of(
                ...
                .crmLead(CrmLead.builder()
                    ...
                    .emails(List.of(
                        ...
                        CrmEmail.builder()
                            ...
                            .build()))
                    .firstName("Velda")
                    .id("93316bb7-7a90-4855-bb4b-5cb4f6b8d59f")
                    .isActive(true)
                    .lastName("Sporer")
                    .linkUrls(List.of(
                    ...
                    .metadata(List.of(
                        CrmMetadata.builder()
                            .extraData(CrmMetadataExtraData.of(Map.ofEntries(
                                Map.entry("display_name", "Custom Property"))))
                            .format(CrmMetadataFormat.TEXT)
                            .id("253339e5-ea42-4944-8cc5-17eb7954266c")
                            .namespace("custom")
                            .slug("custom_property")
                    ...
                    .telephones(List.of(
                        ...
                        CrmTelephone.builder()
                            ...
                            .type(CrmTelephoneType.WORK)
                            .build()))
                    .updatedAt(OffsetDateTime.parse("2020-05-15T06:19:44.096Z"))
                    .build())
                .connectionId("<id>")
                .build();
                ...
                .crmCompany(CrmCompany.builder()
                    ...
                    .emails(List.of(
                        ...
                        CrmEmail.builder()
                            ...
                            .build()))
                    .employees(967d)
                    .id("ca569fd4-8deb-419c-bffe-d4ba9cc43af3")
                    .industry("Infrastructure")
                    .isActive(true)
                    .linkUrls(List.of(
                        "https://blue-license.org",
                    ...
                    .metadata(List.of(
                        CrmMetadata.builder()
                            .extraData(CrmMetadataExtraData.of(Map.ofEntries(
                                Map.entry("display_name", "Custom Property"))))
                            .format(CrmMetadataFormat.TEXT)
                            .id("9fec581a-c38c-441f-aa52-bf9c38c7e8e5")
                            .namespace("custom")
                            .slug("custom_property")
                            .value(CrmMetadataValue.of("esse"))
                            .build()))
                    ...
                    .telephones(List.of(
                        ...
                        CrmTelephone.builder()
                            ...
                            .build()))
                    .timezone("Europe/San_Marino")
                    .updatedAt(OffsetDateTime.parse("2025-02-08T01:13:54.261Z"))
                    .websites(List.of(
                        "https://wise-possession.org"))
                    .build())
                .connectionId("<id>")
                ...
                .crmLead(CrmLead.builder()
                    ...
                    .emails(List.of(
                        ...
                        CrmEmail.builder()
                            ...
                            .build()))
                    .firstName("Velda")
                    .id("bf999213-a99e-4508-ac9c-1caf633ec33b")
                    .isActive(true)
                    .lastName("Sporer")
                    .linkUrls(List.of(
                        "https://classic-sightseeing.com/"))
                    .metadata(List.of(
                        CrmMetadata.builder()
                            .extraData(CrmMetadataExtraData.of(Map.ofEntries(
                                Map.entry("display_name", "Custom Property"))))
                            .format(CrmMetadataFormat.TEXT)
                            .id("d4e56c59-814d-4d7e-bd9b-cf8ccd2f39a8")
                            .namespace("custom")
                            .slug("custom_property")
                            .value(CrmMetadataValue.of("sublime"))
                            .build()))
                    ...
                    .telephones(List.of(
                        ...
                        CrmTelephone.builder()
                            ...
                            .type(CrmTelephoneType.WORK)
                            .build()))
                    .updatedAt(OffsetDateTime.parse("2020-05-15T06:19:44.098Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
