                ...
                .crmContact(CrmContact.builder()
                    ...
                    .emails(List.of(
                        ...
                        CrmEmail.builder()
                            ...
                            .build()))
                    .firstName("Mohammad")
                    .id("3c4b1ca4-7025-4dee-8326-b493f613c7b6")
                    ...
                    .metadata(List.of(
                        CrmMetadata.builder()
                            ...
                            .id("f24741c8-6cc1-4dd1-8654-4c27822a2b2d")
                            .namespace("custom")
                    ...
                    .updatedAt(OffsetDateTime.parse("2021-02-23T10:27:11.405Z"))
                    .build())
                .connectionId("<id>")
                .build();
                ...
                .ucContact(UcContact.builder()
                    ...
                    .emails(List.of(
                        UcEmail.builder()
                            ...
                            .build()))
                    .firstName("Luther")
                    .id("05af7cbc-759d-4baa-ae43-3c33bc097fbe")
                    .lastName("Rogahn")
                    .name("Luther Rogahn")
                    .telephones(List.of(
                        UcTelephone.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2023-11-20T03:27:02.739Z"))
                    .build())
                .connectionId("<id>")
                .build();
                ...
                .crmContact(CrmContact.builder()
                    ...
                    .emails(List.of(
                        ...
                        CrmEmail.builder()
                            ...
                            .build()))
                    .firstName("Mohammad")
                    .id("f1a53844-24e0-4afe-8fd9-4171dcb17fe4")
                    .imageUrl("https://picsum.photos/seed/zmbPeg/2905/378")
                    .lastName("Bartell")
                    .linkUrls(List.of(
                        "https://limited-parade.info",
                    ...
                    .metadata(List.of(
                        CrmMetadata.builder()
                            .extraData(CrmMetadataExtraData.of(Map.ofEntries(
                                Map.entry("display_name", "Custom Property"))))
                            .format(CrmMetadataFormat.TEXT)
                            .id("44203d62-338b-4fb5-9dcd-969a0cd6d70a")
                            .namespace("custom")
                            .slug("custom_property")
                            .value(CrmMetadataValue.of("autem"))
                            .build()))
                ...
                .ucContact(UcContact.builder()
                    ...
                    .emails(List.of(
                        UcEmail.builder()
                            ...
                            .build()))
                    .firstName("Luther")
                    .id("4ef9d7f3-8a40-42e6-afae-4b0c6b7358e9")
                    .lastName("Rogahn")
                    .name("Luther Rogahn")
                    .telephones(List.of(
                        UcTelephone.builder()
                        ...
                        UcTelephone.builder()
                            ...
                            .build()))
                    .title("Chief Optimization Executive")
                    .updatedAt(OffsetDateTime.parse("2023-11-20T03:27:02.745Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
