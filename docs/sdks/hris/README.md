    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisBankaccountRequest req = CreateHrisBankaccountRequest.builder()
                .hrisBankaccount(HrisBankaccount.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2025-06-05T06:49:26.998Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisBenefitRequest req = CreateHrisBenefitRequest.builder()
                .hrisBenefit(HrisBenefit.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2023-03-06T21:22:57.403Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisCompanyRequest req = CreateHrisCompanyRequest.builder()
                .hrisCompany(HrisCompany.builder()
                    ...
                    .name("Gottlieb Group")
                    .updatedAt(OffsetDateTime.parse("2026-09-06T20:50:08.814Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisDeductionRequest req = CreateHrisDeductionRequest.builder()
                .hrisDeduction(HrisDeduction.builder()
                    ...
                    .endAt(OffsetDateTime.parse("2026-05-23T21:29:57.490Z"))
                    .frequency(HrisDeductionFrequency.MONTH)
                    .id("49e17ba0-b8a7-4629-8aa8-a6f9261d136b")
                    .isActive(false)
                    .notes("Carmen desidero.")
                    .startAt(OffsetDateTime.parse("2025-02-18T22:44:53.609Z"))
                    .type(HrisDeductionType.FIXED)
                    .updatedAt(OffsetDateTime.parse("2024-03-02T14:20:12.674Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisDocumentRequest req = CreateHrisDocumentRequest.builder()
                .hrisDocument(HrisDocument.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2025-09-17T19:34:58.709Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisEmployeeRequest req = CreateHrisEmployeeRequest.builder()
                .hrisEmployee(HrisEmployee.builder()
                    ...
                    .hasMfa(true)
                    .hiredAt(OffsetDateTime.parse("2023-05-11T04:37:54.703Z"))
                    ...
                    .updatedAt(OffsetDateTime.parse("2022-02-19T15:16:40.928Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisGroupRequest req = CreateHrisGroupRequest.builder()
                .hrisGroup(HrisGroup.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2026-04-24T10:52:26.444Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisLocationRequest req = CreateHrisLocationRequest.builder()
                .hrisLocation(HrisLocation.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2023-06-09T09:22:19.218Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisTaxonomyRequest req = CreateHrisTaxonomyRequest.builder()
                .hrisTaxonomy(HrisTaxonomy.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2023-05-22T10:04:44.206Z"))
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisTimeoffRequest req = CreateHrisTimeoffRequest.builder()
                .hrisTimeoff(HrisTimeoff.builder()
                    .userId("<id>")
                    .approvedAt(OffsetDateTime.parse("2022-02-20T22:50:58.781Z"))
                    ...
                    .endAt(OffsetDateTime.parse("2024-12-08T05:05:47.297Z"))
                    .id("c87586bc-2f30-459d-942c-4aadb2dc6e3b")
                    .isPaid(true)
                    .originalType("acerbitas ut")
                    .reason("verto")
                    .startAt(OffsetDateTime.parse("2023-08-23T15:58:25.742Z"))
                    .status(HrisTimeoffStatus.DENIED)
                    .type(HrisTimeoffType.IN_LIEU)
                    .updatedAt(OffsetDateTime.parse("2022-07-07T23:11:27.531Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchHrisBankaccountRequest req = PatchHrisBankaccountRequest.builder()
                .hrisBankaccount(HrisBankaccount.builder()
                    ...
                    .name("Checking Account")
                    .routingNumber("448650724")
                    .updatedAt(OffsetDateTime.parse("2025-06-05T06:49:27.003Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchHrisBenefitRequest req = PatchHrisBenefitRequest.builder()
                .hrisBenefit(HrisBenefit.builder()
                    ...
                    .tax(Tax.PRE_TAX)
                    .type(HrisBenefitType.GARNISHMENT)
                    .updatedAt(OffsetDateTime.parse("2023-03-06T21:22:57.408Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchHrisCompanyRequest req = PatchHrisCompanyRequest.builder()
                .hrisCompany(HrisCompany.builder()
                    ...
                    .legalName("Schultz LLC")
                    .name("Gottlieb Group")
                    .updatedAt(OffsetDateTime.parse("2026-09-06T20:50:08.832Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchHrisDeductionRequest req = PatchHrisDeductionRequest.builder()
                .hrisDeduction(HrisDeduction.builder()
                    ...
                    .coverageLevel(HrisDeductionCoverageLevel.EMPLOYEE_ONLY)
                    .createdAt(OffsetDateTime.parse("2020-02-05T01:46:31.384Z"))
                    .endAt(OffsetDateTime.parse("2026-05-23T21:29:57.498Z"))
                    .frequency(HrisDeductionFrequency.MONTH)
                    .id("083ef8df-15a1-488f-a9e1-6a023410267a")
                    .isActive(false)
                    .notes("Carmen desidero.")
                    .startAt(OffsetDateTime.parse("2025-02-18T22:44:53.615Z"))
                    .type(HrisDeductionType.FIXED)
                    .updatedAt(OffsetDateTime.parse("2024-03-02T14:20:12.679Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchHrisDocumentRequest req = PatchHrisDocumentRequest.builder()
                .hrisDocument(HrisDocument.builder()
                    ...
                    .type(HrisDocumentType.POLICY)
                    .updatedAt(OffsetDateTime.parse("2025-09-17T19:34:58.715Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchHrisEmployeeRequest req = PatchHrisEmployeeRequest.builder()
                .hrisEmployee(HrisEmployee.builder()
                    ...
                    .gender(HrisEmployeeGender.INTERSEX)
                    .hasMfa(true)
                    .hiredAt(OffsetDateTime.parse("2023-05-11T04:37:54.752Z"))
                    ...
                    .timezone("Africa/Harare")
                    .title("Investor Paradigm Liaison")
                    .updatedAt(OffsetDateTime.parse("2022-02-19T15:16:40.961Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchHrisGroupRequest req = PatchHrisGroupRequest.builder()
                .hrisGroup(HrisGroup.builder()
                    ...
                    .name("Games")
                    .type(HrisGroupType.BUSINESS_UNIT)
                    .updatedAt(OffsetDateTime.parse("2026-04-24T10:52:26.448Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
                ...
                .hrisLocation(HrisLocation.builder()
                    ...
                    .telephones(List.of(
                        ...
                        HrisTelephone.builder()
                            ...
                            .build()))
                    .timezone("America/Guyana")
                    .updatedAt(OffsetDateTime.parse("2023-06-09T09:22:19.225Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchHrisTimeoffRequest req = PatchHrisTimeoffRequest.builder()
                .hrisTimeoff(HrisTimeoff.builder()
                    .userId("<id>")
                    .approvedAt(OffsetDateTime.parse("2022-02-20T22:50:58.782Z"))
                    .comments("Blandior ventus curiositas amplitudo.")
                    .createdAt(OffsetDateTime.parse("2021-10-06T18:00:20.615Z"))
                    .duration(4d)
                    .durationType(DurationType.DAY)
                    .endAt(OffsetDateTime.parse("2024-12-08T05:05:47.306Z"))
                    .id("e846be99-d30d-46a1-ad0b-ede5f0d09ab5")
                    .isPaid(true)
                    .originalType("acerbitas ut")
                    .reason("verto")
                    .startAt(OffsetDateTime.parse("2023-08-23T15:58:25.748Z"))
                    .status(HrisTimeoffStatus.DENIED)
                    .type(HrisTimeoffType.IN_LIEU)
                    .updatedAt(OffsetDateTime.parse("2022-07-07T23:11:27.533Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
