    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisBankaccountRequest req = CreateHrisBankaccountRequest.builder()
                .hrisBankaccount(HrisBankaccount.builder()
                    ...
                    .id("988edc71-7426-438f-93c4-9b5e3e57d782")
                    .isPrimary(false)
                    .name("Checking Account")
                    .routingNumber("448650724")
                    .updatedAt(OffsetDateTime.parse("2025-06-06T03:23:40.457Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisBenefitRequest req = CreateHrisBenefitRequest.builder()
                .hrisBenefit(HrisBenefit.builder()
                    ...
                    .id("caa25197-7205-478c-ba3d-65189093d390")
                    .isActive(false)
                    .name("Frozen Wooden Ball")
                    .tax(Tax.PRE_TAX)
                    .type(HrisBenefitType.GARNISHMENT)
                    .updatedAt(OffsetDateTime.parse("2023-03-07T08:25:59.703Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisCompanyRequest req = CreateHrisCompanyRequest.builder()
                .hrisCompany(HrisCompany.builder()
                    ...
                    .id("d15b4307-5ea1-4ffb-8bc8-403305f3b5e4")
                    .legalName("Schultz LLC")
                    .name("Gottlieb Group")
                    .updatedAt(OffsetDateTime.parse("2026-09-07T22:01:30.960Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisDeductionRequest req = CreateHrisDeductionRequest.builder()
                .hrisDeduction(HrisDeduction.builder()
                    ...
                    .endAt(OffsetDateTime.parse("2026-05-24T21:36:25.989Z"))
                    .frequency(HrisDeductionFrequency.MONTH)
                    .id("63554669-ce6f-4995-81c5-7690b293db19")
                    .isActive(false)
                    .notes("Carmen desidero.")
                    .startAt(OffsetDateTime.parse("2025-02-19T18:02:42.763Z"))
                    .type(HrisDeductionType.FIXED)
                    .updatedAt(OffsetDateTime.parse("2024-03-03T05:55:47.423Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisDeviceRequest req = CreateHrisDeviceRequest.builder()
                .hrisDevice(HrisDevice.builder()
                    ...
                    .hasScreenlock(true)
                    .id("ec411ea5-8dd2-4196-ba8f-faa98365e522")
                    .isMissing(false)
                    ...
                    .os("monitor")
                    .osVersion("1.12.16")
                    .updatedAt(OffsetDateTime.parse("2023-05-22T04:08:12.338Z"))
                    .version("2.20.17")
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisDocumentRequest req = CreateHrisDocumentRequest.builder()
                .hrisDocument(HrisDocument.builder()
                    ...
                    .id("1128de32-cf66-468d-b1cc-809ac6b58799")
                    .type(HrisDocumentType.POLICY)
                    .updatedAt(OffsetDateTime.parse("2025-09-18T14:24:16.119Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisGroupRequest req = CreateHrisGroupRequest.builder()
                .hrisGroup(HrisGroup.builder()
                    ...
                    .id("bf04cebd-0446-4715-bc7d-d87f564e667e")
                    .isActive(false)
                    .name("Games")
                    .type(HrisGroupType.BUSINESS_UNIT)
                    .updatedAt(OffsetDateTime.parse("2026-04-25T08:40:00.755Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateHrisTimeoffRequest req = CreateHrisTimeoffRequest.builder()
                .hrisTimeoff(HrisTimeoff.builder()
                    .userId("<id>")
                    .approvedAt(OffsetDateTime.parse("2022-02-21T00:46:22.086Z"))
                    ...
                    .endAt(OffsetDateTime.parse("2024-12-08T21:20:04.146Z"))
                    .id("aa4271fe-4c32-42b0-924e-75d743fb3dfb")
                    .isPaid(true)
                    .originalType("acerbitas ut")
                    .reason("verto")
                    .startAt(OffsetDateTime.parse("2023-08-24T01:35:17.534Z"))
                    .status(HrisTimeoffStatus.DENIED)
                    .type(HrisTimeoffType.IN_LIEU)
                    .updatedAt(OffsetDateTime.parse("2022-07-08T03:02:04.674Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchHrisBankaccountRequest req = PatchHrisBankaccountRequest.builder()
                .hrisBankaccount(HrisBankaccount.builder()
                    ...
                    .bankName("Huel Group")
                    .createdAt(OffsetDateTime.parse("2019-11-16T16:43:45.976Z"))
                    .id("7a538736-7a73-4a78-a42f-dc16d4fd2da3")
                    .isPrimary(false)
                    .name("Checking Account")
                    .routingNumber("448650724")
                    .updatedAt(OffsetDateTime.parse("2025-06-06T03:23:40.462Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchHrisBenefitRequest req = PatchHrisBenefitRequest.builder()
                .hrisBenefit(HrisBenefit.builder()
                    ...
                    .employerContributionType(EmployerContributionType.PERCENTAGE)
                    .frequency(HrisBenefitFrequency.HOUR)
                    .id("64f679ba-df86-4a2e-89aa-6fc1a89147a5")
                    .isActive(false)
                    .name("Frozen Wooden Ball")
                    .tax(Tax.PRE_TAX)
                    .type(HrisBenefitType.GARNISHMENT)
                    .updatedAt(OffsetDateTime.parse("2023-03-07T08:25:59.708Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
        ...
        PatchHrisCompanyRequest req = PatchHrisCompanyRequest.builder()
                .hrisCompany(HrisCompany.builder()
                    .address(PropertyHrisCompanyAddress.builder()
                        ...
                        .build())
                    .createdAt(OffsetDateTime.parse("2021-05-02T22:27:38.970Z"))
                    .id("89823757-fdef-41f7-b933-dd16d604034e")
                    .legalName("Schultz LLC")
                    .name("Gottlieb Group")
                    .updatedAt(OffsetDateTime.parse("2026-09-07T22:01:30.976Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchHrisDeductionRequest req = PatchHrisDeductionRequest.builder()
                .hrisDeduction(HrisDeduction.builder()
                    ...
                    .coverageLevel(HrisDeductionCoverageLevel.EMPLOYEE_ONLY)
                    .createdAt(OffsetDateTime.parse("2020-02-05T01:46:31.384Z"))
                    .endAt(OffsetDateTime.parse("2026-05-24T21:36:26.006Z"))
                    .frequency(HrisDeductionFrequency.MONTH)
                    .id("114aca0f-b3a0-4794-8190-e317430b8605")
                    .isActive(false)
                    .notes("Carmen desidero.")
                    .startAt(OffsetDateTime.parse("2025-02-19T18:02:42.777Z"))
                    .type(HrisDeductionType.FIXED)
                    .updatedAt(OffsetDateTime.parse("2024-03-03T05:55:47.434Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchHrisDeviceRequest req = PatchHrisDeviceRequest.builder()
                .hrisDevice(HrisDevice.builder()
                    ...
                    .hasPasswordManager(true)
                    .hasScreenlock(true)
                    .id("71391a96-8b30-4b3f-81a8-f3f9058844c5")
                    .isMissing(false)
                    .manufacturer("Sanford - Hamill")
                    .model("Refined")
                    .name("cross_contamination_if.rar")
                    .os("monitor")
                    .osVersion("1.12.16")
                    .updatedAt(OffsetDateTime.parse("2023-05-22T04:08:12.345Z"))
                    .version("2.20.17")
                    .build())
                .connectionId("<id>")
                .id("<id>")
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchHrisDocumentRequest req = PatchHrisDocumentRequest.builder()
                .hrisDocument(HrisDocument.builder()
                    ...
                    .documentUrl("https://sore-decision.biz/")
                    .filename("ridge_forager.xsl")
                    .id("681bedc3-1b0d-4847-867d-a3df99868afb")
                    .type(HrisDocumentType.POLICY)
                    .updatedAt(OffsetDateTime.parse("2025-09-18T14:24:16.127Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchHrisGroupRequest req = PatchHrisGroupRequest.builder()
                .hrisGroup(HrisGroup.builder()
                    .createdAt(OffsetDateTime.parse("2023-11-01T13:13:40.714Z"))
                    .description("Absorbeo casso.")
                    .id("916a4618-2b1b-4d56-bcd4-c3fd2044f34d")
                    .isActive(false)
                    .name("Games")
                    .type(HrisGroupType.BUSINESS_UNIT)
                    .updatedAt(OffsetDateTime.parse("2026-04-25T08:40:00.761Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchHrisTimeoffRequest req = PatchHrisTimeoffRequest.builder()
                .hrisTimeoff(HrisTimeoff.builder()
                    .userId("<id>")
                    .approvedAt(OffsetDateTime.parse("2022-02-21T00:46:22.088Z"))
                    .comments("Blandior ventus curiositas amplitudo.")
                    .createdAt(OffsetDateTime.parse("2021-10-06T18:00:20.615Z"))
                    .duration(4d)
                    .durationType(DurationType.DAY)
                    .endAt(OffsetDateTime.parse("2024-12-08T21:20:04.158Z"))
                    .id("7cd3db5d-a931-42f7-9629-b171d3e54ec4")
                    .isPaid(true)
                    .originalType("acerbitas ut")
                    .reason("verto")
                    .startAt(OffsetDateTime.parse("2023-08-24T01:35:17.541Z"))
                    .status(HrisTimeoffStatus.DENIED)
                    .type(HrisTimeoffType.IN_LIEU)
                    .updatedAt(OffsetDateTime.parse("2022-07-08T03:02:04.677Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
