                ...
                .formsForm(FormsForm.builder()
                    ...
                    .fields(List.of(
                        FormField.builder()
                            ...
                            .maxLength(146d)
                            .order(0d)
                            .updatedAt(OffsetDateTime.parse("2025-04-12T05:30:27.587Z"))
                            .build(),
                        FormField.builder()
                            ...
                            .isRequired(false)
                            .order(1d)
                            .updatedAt(OffsetDateTime.parse("2024-08-23T14:16:53.904Z"))
                            .build(),
                        FormField.builder()
                            ...
                            .isRequired(false)
                            .order(2d)
                            .updatedAt(OffsetDateTime.parse("2024-02-22T05:18:44.719Z"))
                            .build(),
                        FormField.builder()
                            ...
                            .isRequired(false)
                            .order(3d)
                            .updatedAt(OffsetDateTime.parse("2024-11-15T08:40:56.645Z"))
                            .build()))
                    ...
                    .responseCount(423d)
                    .updatedAt(OffsetDateTime.parse("2024-08-15T11:19:33.533Z"))
                    .build())
                .connectionId("<id>")
                .build();
                ...
                .formsForm(FormsForm.builder()
                    ...
                    .fields(List.of(
                        FormField.builder()
                            ...
                            .maxLength(146d)
                            .order(0d)
                            .updatedAt(OffsetDateTime.parse("2025-04-12T05:30:27.597Z"))
                            .build(),
                        FormField.builder()
                            .name("alo crebro vado")
                            .type(FormFieldType.TEXTAREA)
                            ...
                            .isRequired(false)
                            .order(1d)
                            .updatedAt(OffsetDateTime.parse("2024-08-23T14:16:53.911Z"))
                            .build(),
                        FormField.builder()
                            .name("casso tenus nesciunt")
                            .type(FormFieldType.MULTIPLE_SELECT)
                            ...
                            .isRequired(false)
                            .order(2d)
                            .updatedAt(OffsetDateTime.parse("2024-02-22T05:18:44.721Z"))
                            .build(),
                        FormField.builder()
                            .name("comburo utique ipsa")
                            .type(FormFieldType.TEXTAREA)
                            ...
                            .isRequired(false)
                            .order(3d)
                            .updatedAt(OffsetDateTime.parse("2024-11-15T08:40:56.653Z"))
                            .build()))
                    .hasMultipleSubmissions(false)
                    .hasProgressBar(false)
                    .hasShuffleQuestions(true)
                    ...
                    .publishedUrl("https://impartial-institute.org/")
                    .responseCount(423d)
                    .updatedAt(OffsetDateTime.parse("2024-08-15T11:19:33.539Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
