                ...
                .formsForm(FormsForm.builder()
                    ...
                    .fields(List.of(
                        FormField.builder()
                            ...
                            .maxLength(146d)
                            .order(0d)
                            .updatedAt(OffsetDateTime.parse("2025-04-13T06:40:27.582Z"))
                            .build(),
                        FormField.builder()
                            ...
                            .isRequired(false)
                            .order(1d)
                            .updatedAt(OffsetDateTime.parse("2024-08-24T04:55:55.482Z"))
                            .build(),
                        FormField.builder()
                            ...
                            .isRequired(false)
                            .order(2d)
                            .updatedAt(OffsetDateTime.parse("2024-02-22T11:38:15.626Z"))
                            .build(),
                        FormField.builder()
                            ...
                            .isRequired(false)
                            .order(3d)
                            .updatedAt(OffsetDateTime.parse("2024-11-16T03:08:09.084Z"))
                            .build()))
                    ...
                    .responseCount(423d)
                    .updatedAt(OffsetDateTime.parse("2024-08-16T01:36:27.459Z"))
                    .build())
                .connectionId("<id>")
                .build();
                ...
                .formsForm(FormsForm.builder()
                    ...
                    .fields(List.of(
                        FormField.builder()
                            ...
                            .maxLength(146d)
                            .order(0d)
                            .updatedAt(OffsetDateTime.parse("2025-04-13T06:40:27.594Z"))
                            .build(),
                        FormField.builder()
                            .name("alo crebro vado")
                            .type(FormFieldType.TEXTAREA)
                            ...
                            .isRequired(false)
                            .order(1d)
                            .updatedAt(OffsetDateTime.parse("2024-08-24T04:55:55.489Z"))
                            .build(),
                        FormField.builder()
                            .name("casso tenus nesciunt")
                            .type(FormFieldType.MULTIPLE_SELECT)
                            ...
                            .isRequired(false)
                            .order(2d)
                            .updatedAt(OffsetDateTime.parse("2024-02-22T11:38:15.629Z"))
                            .build(),
                        FormField.builder()
                            .name("comburo utique ipsa")
                            .type(FormFieldType.TEXTAREA)
                            ...
                            .isRequired(false)
                            .order(3d)
                            .updatedAt(OffsetDateTime.parse("2024-11-16T03:08:09.093Z"))
                            .build()))
                    .hasMultipleSubmissions(false)
                    .hasProgressBar(false)
                    .hasShuffleQuestions(true)
                    ...
                    .publishedUrl("https://impartial-institute.org/")
                    .responseCount(423d)
                    .updatedAt(OffsetDateTime.parse("2024-08-16T01:36:27.466Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
