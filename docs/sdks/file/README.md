    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateStorageFileRequest req = CreateStorageFileRequest.builder()
                .storageFile(StorageFile.builder()
                    ...
                    .id("c75912b1-75a5-4d92-ab3c-371b19ec99a9")
                    .mimeType("FOLDER")
                    .name("softly.tiff")
                    .references(List.of(
                    ...
                    .updatedAt(OffsetDateTime.parse("2023-01-28T01:25:49.422Z"))
                    .version("1")
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchStorageFileRequest req = PatchStorageFileRequest.builder()
                .storageFile(StorageFile.builder()
                    ...
                    .downloadUrl("https://stingy-casement.name/")
                    .hash("fe6a659e-75cd-4079-9b76-351f9af2205a")
                    .id("c4e1e4f0-bbd9-45e9-80d4-4de20a42e5b6")
                    .mimeType("FOLDER")
                    .name("softly.tiff")
                    .references(List.of(
                        StorageReference.builder()
                    ...
                    .tags(List.of(
                        "spoliatio"))
                    .type(StorageFileType.FILE)
                    .updatedAt(OffsetDateTime.parse("2023-01-28T01:25:49.427Z"))
                    .version("1")
                    .webUrl("https://sandy-distinction.info/")
                    .build())
                .connectionId("<id>")
