    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAnalyticsPropertyRequest req = CreateAnalyticsPropertyRequest.builder()
                .analyticsProperty(AnalyticsProperty.builder()
                    ...
                    .currency("USD")
                    .id("9b8dbbc2-c1be-4a0e-878a-e83d8c432445")
                    .name("Daniel, Goldner and Dickinson")
                    .timezone("UTC")
                    .updatedAt(OffsetDateTime.parse("2021-09-14T16:50:33.538Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAnalyticsVisitorRequest req = CreateAnalyticsVisitorRequest.builder()
                .analyticsVisitor(AnalyticsVisitor.builder()
                    ...
                    .id("27b0700a-fdd4-4d6d-bf64-af7c603581e6")
                    .lastSeenAt(OffsetDateTime.parse("2021-12-05T06:39:41.522Z"))
                    .metadata(Map.ofEntries(
                        Map.entry("segment", PropertyAnalyticsVisitorMetadata.builder()
                            .build())))
                    .name("Desiree O'Hara")
                    .totalEvents(3639d)
                    .updatedAt(OffsetDateTime.parse("2025-06-04T23:43:31.555Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAnalyticsPropertyRequest req = PatchAnalyticsPropertyRequest.builder()
                .analyticsProperty(AnalyticsProperty.builder()
                    .createdAt(OffsetDateTime.parse("2021-09-05T19:04:58.430Z"))
                    .currency("USD")
                    .id("29744ace-510c-45f5-b8c8-485e774b9b31")
                    .name("Daniel, Goldner and Dickinson")
                    .timezone("UTC")
                    .updatedAt(OffsetDateTime.parse("2021-09-14T16:50:33.538Z"))
                    .build())
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAnalyticsVisitorRequest req = PatchAnalyticsVisitorRequest.builder()
                .analyticsVisitor(AnalyticsVisitor.builder()
                    ...
                    .email("Dallas_Mitchell@yahoo.com")
                    .firstSeenAt(OffsetDateTime.parse("2020-04-16T20:29:48.281Z"))
                    .id("6198a8c8-cd08-4896-9079-7603745e97f2")
                    .lastSeenAt(OffsetDateTime.parse("2021-12-05T06:39:41.526Z"))
                    .metadata(Map.ofEntries(
                        Map.entry("segment", PropertyAnalyticsVisitorMetadata.builder()
                            .build())))
                    .name("Desiree O'Hara")
                    .totalEvents(3639d)
                    .updatedAt(OffsetDateTime.parse("2025-06-04T23:43:31.567Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
