    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateMessagingChannelRequest req = CreateMessagingChannelRequest.builder()
                .messagingChannel(MessagingChannel.builder()
                    ...
                    .hasSubchannels(true)
                    .id("027d3aff-7813-4c04-bbbd-b3f97e9c86a6")
                    .isActive(false)
                    .isPrivate(true)
                    .members(List.of())
                    .name("tego")
                    .updatedAt(OffsetDateTime.parse("2026-04-24T20:47:35.393Z"))
                ...
                .messagingMessage(MessagingMessage.builder()
                    .attachments(List.of(
                        MessagingAttachment.builder()
                            .contentIdentifier("b6fad9be-f0d6-466a-a483-05a3376e05ce")
                            .contentType("coaegresco")
                            .downloadUrl("https://rotating-advertisement.org")
                            .filename("super")
                            .messageId("8c1da6f6-f77b-43c1-9c88-d2dbd59cf9fb")
                            .size(327d)
                            .build()))
                    .buttons(List.of(
                        MessagingButton.builder()
                            .id("496b7b91-f009-4e05-8797-e6224655fe08")
                            .text("denuo")
                            .build()))
                    ...
                    .id("8c1da6f6-f77b-43c1-9c88-d2dbd59cf9fb")
                    .isUnread(false)
                    ...
                    .updatedAt(OffsetDateTime.parse("2023-07-07T03:38:43.089Z"))
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchMessagingChannelRequest req = PatchMessagingChannelRequest.builder()
                .messagingChannel(MessagingChannel.builder()
                    ...
                    .description("Dolores tutis.")
                    .hasSubchannels(true)
                    .id("7261168e-244c-48b4-805c-61f9b04cea09")
                    .isActive(false)
                    .isPrivate(true)
                    .members(List.of())
                    .name("tego")
                    .updatedAt(OffsetDateTime.parse("2026-04-24T20:47:35.398Z"))
                    .webUrl("https://svelte-rule.name/")
                    .build())
                .connectionId("<id>")
                .id("<id>")
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchMessagingMessageRequest req = PatchMessagingMessageRequest.builder()
                .messagingMessage(MessagingMessage.builder()
                    .attachments(List.of(
                        MessagingAttachment.builder()
                            .contentIdentifier("c8153a4b-f46c-430a-92d2-b7ddff028291")
                            .contentType("coaegresco")
                            .downloadUrl("https://rotating-advertisement.org")
                            .filename("super")
                            .messageId("97cfcd19-fce7-46e1-bafa-c8ddfb97f937")
                            .size(327d)
                            .build()))
                    .buttons(List.of(
                        MessagingButton.builder()
                            .id("2c0f3789-db8f-4451-a3ed-3eb1e477147b")
                            .text("denuo")
                            .build()))
                    .createdAt(OffsetDateTime.parse("2021-11-26T09:26:33.973Z"))
                    .destinationMembers(List.of())
                    .hasChildren(true)
                    .hiddenMembers(List.of())
                    .id("97cfcd19-fce7-46e1-bafa-c8ddfb97f937")
                    .isUnread(false)
                    .mentionedMembers(List.of())
                    .message("Sum utique aliquid.")
                    .messageHtml("Articulus tardus tergiversatio.")
                    ...
                    .reference("571483f2-d95b-4f06-8b78-d35e7046bb74")
                    .subject("Cernuus optio cohaero summisse in.")
                    .updatedAt(OffsetDateTime.parse("2023-07-07T03:38:43.096Z"))
                    .webUrl("https://grumpy-kit.net")
                    .build())
                .connectionId("<id>")
                .id("<id>")
