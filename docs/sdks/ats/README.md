                ...
                .atsCandidate(AtsCandidate.builder()
                    ...
                    .experiences(List.of(
                        AtsCandidateExperience.builder()
                            ...
                            .build()))
                    .firstName("Ardith")
                    .id("f0c7ea5b-c0d0-4ad8-903e-0737d1289ee2")
                    ...
                    .metadata(List.of(
                        AtsMetadata.builder()
                            ...
                            .format(AtsMetadataFormat.TEXT)
                            .id("7b8c939c-b7d4-4ba5-b94a-2f787c6bb4a9")
                            .namespace("custom")
                            .slug("custom_field")
                    ...
                    .updatedAt(OffsetDateTime.parse("2024-04-23T05:50:24.921Z"))
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAtsCompanyRequest req = CreateAtsCompanyRequest.builder()
                .atsCompany(AtsCompany.builder()
                    ...
                    .id("c654cc05-b43f-4234-8c63-3219d8752414")
                    .name("Gulgowski, Dibbert and Wilderman")
                    .phone("1-602-210-4548")
                    .updatedAt(OffsetDateTime.parse("2020-09-25T04:58:37.482Z"))
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAtsDocumentRequest req = CreateAtsDocumentRequest.builder()
                .atsDocument(AtsDocument.builder()
                    ...
                    .id("50425cf3-fb28-472f-ba7b-3636bf9144f9")
                    .type(AtsDocumentType.RESUME)
                    .updatedAt(OffsetDateTime.parse("2022-11-29T10:29:35.221Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAtsInterviewRequest req = CreateAtsInterviewRequest.builder()
                .atsInterview(AtsInterview.builder()
                    ...
                    .endAt(OffsetDateTime.parse("2025-09-24T23:21:50.464Z"))
                    .externalEventXref("41de76cc-4b33-4b24-b894-f01b773f8488")
                    .id("1c6e6ba6-21bf-4865-9d48-4d71a048fbcf")
                    .location("26596 Halle Trafficway")
                    .startAt(OffsetDateTime.parse("2025-05-20T17:56:21.223Z"))
                    .status(AtsInterviewStatus.SCHEDULED)
                    .updatedAt(OffsetDateTime.parse("2026-02-05T19:25:50.760Z"))
                    .build())
                .connectionId("<id>")
                .build();
                ...
                .atsCandidate(AtsCandidate.builder()
                    ...
                    .experiences(List.of(
                        AtsCandidateExperience.builder()
                            ...
                            .build()))
                    .firstName("Ardith")
                    .id("4893aa54-82c4-4c73-a67f-421b727b353a")
                    .imageUrl("https://loremflickr.com/40/3693?lock=5634712403880328")
                    .jobIds(List.of())
                    .lastName("Beatty")
                    .linkUrls(List.of(
                    ...
                    .metadata(List.of(
                        AtsMetadata.builder()
                            ...
                            .format(AtsMetadataFormat.TEXT)
                            .id("c361851e-0ba0-42aa-bb53-5bf0d0b4df30")
                            .namespace("custom")
                            .slug("custom_field")
                            .value(AtsMetadataValue.of("cariosus"))
                            .build()))
                    ...
                    .telephones(List.of(
                        AtsTelephone.builder()
                            ...
                            .build()))
                    .title("Principal Implementation Analyst")
                    .updatedAt(OffsetDateTime.parse("2024-04-23T05:50:24.927Z"))
                    .webUrl("https://expert-lender.name/")
                    .build())
                .connectionId("<id>")
                .id("<id>")
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAtsCompanyRequest req = PatchAtsCompanyRequest.builder()
                .atsCompany(AtsCompany.builder()
                    .createdAt(OffsetDateTime.parse("2019-04-22T03:50:02.920Z"))
                    .id("f4701e37-556d-487c-bf46-710be65b8086")
                    .name("Gulgowski, Dibbert and Wilderman")
                    .phone("1-602-210-4548")
                    .updatedAt(OffsetDateTime.parse("2020-09-25T04:58:37.485Z"))
                    .websiteUrl("https://somber-substitution.com/")
                    .build())
                .connectionId("<id>")
                .id("<id>")
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAtsDocumentRequest req = PatchAtsDocumentRequest.builder()
                .atsDocument(AtsDocument.builder()
                    ...
                    .documentUrl("https://vengeful-lashes.biz")
                    .filename("bah_white_frantically.bz")
                    .id("27e877d8-711e-4a83-a1e5-da609ecff3eb")
                    .type(AtsDocumentType.RESUME)
                    .updatedAt(OffsetDateTime.parse("2022-11-29T10:29:35.223Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAtsInterviewRequest req = PatchAtsInterviewRequest.builder()
                .atsInterview(AtsInterview.builder()
                    .createdAt(OffsetDateTime.parse("2021-11-28T03:14:47.774Z"))
                    .endAt(OffsetDateTime.parse("2025-09-24T23:21:50.474Z"))
                    .externalEventXref("f74a3886-4202-48aa-bbec-a17a9670d950")
                    .id("36d20d54-1d09-47f5-95a6-0ef784909dc3")
                    .location("26596 Halle Trafficway")
                    .startAt(OffsetDateTime.parse("2025-05-20T17:56:21.232Z"))
                    .status(AtsInterviewStatus.SCHEDULED)
                    .updatedAt(OffsetDateTime.parse("2026-02-05T19:25:50.771Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
