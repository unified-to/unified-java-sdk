    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAtsActivityRequest req = CreateAtsActivityRequest.builder()
                .atsActivity(AtsActivity.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2026-03-07T10:15:31.456Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAtsApplicationRequest req = CreateAtsApplicationRequest.builder()
                .atsApplication(AtsApplication.builder()
                    .answers(List.of())
                    .appliedAt(OffsetDateTime.parse("2025-09-09T00:14:07.164Z"))
                    .createdAt(OffsetDateTime.parse("2023-10-17T07:19:48.787Z"))
                    .hiredAt(OffsetDateTime.parse("2026-04-15T10:51:39.782Z"))
                    ...
                    .rejectedAt(OffsetDateTime.parse("2026-09-09T19:25:59.827Z"))
                    ...
                    .updatedAt(OffsetDateTime.parse("2026-09-16T10:53:24.705Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAtsCompanyRequest req = CreateAtsCompanyRequest.builder()
                .atsCompany(AtsCompany.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2020-09-25T00:05:26.577Z"))
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAtsDocumentRequest req = CreateAtsDocumentRequest.builder()
                .atsDocument(AtsDocument.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2022-11-29T04:07:49.309Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAtsInterviewRequest req = CreateAtsInterviewRequest.builder()
                .atsInterview(AtsInterview.builder()
                    ...
                    .endAt(OffsetDateTime.parse("2025-09-24T03:12:45.642Z"))
                    ...
                    .startAt(OffsetDateTime.parse("2025-05-19T23:37:23.888Z"))
                    .status(AtsInterviewStatus.SCHEDULED)
                    .updatedAt(OffsetDateTime.parse("2026-02-04T21:20:55.157Z"))
                    .build())
                .connectionId("<id>")
                .build();
                ...
                .atsActivity(AtsActivity.builder()
                    ...
                    .to(List.of(
                        AtsEmail.builder()
                            ...
                            .build()))
                    .type(AtsActivityType.TASK)
                    .updatedAt(OffsetDateTime.parse("2026-03-07T10:15:31.482Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAtsApplicationRequest req = PatchAtsApplicationRequest.builder()
                .atsApplication(AtsApplication.builder()
                    .answers(List.of())
                    .appliedAt(OffsetDateTime.parse("2025-09-09T00:14:07.189Z"))
                    .createdAt(OffsetDateTime.parse("2023-10-17T07:19:48.787Z"))
                    .hiredAt(OffsetDateTime.parse("2026-04-15T10:51:39.815Z"))
                    ...
                    .originalStatus("vomica")
                    .originalSubstatus("allatus")
                    .rejectedAt(OffsetDateTime.parse("2026-09-09T19:25:59.866Z"))
                    .rejectedReason("Cometes amplitudo videlicet talio.")
                    .source("credo")
                    .status(AtsApplicationStatus.REVIEWING)
                    .summary("Comburo quidem vesica vulnus curatio. Appositus amita attonbitus conatus degenero charisma sordeo villa victoria varius. Cenaculum acsi officia.")
                    .updatedAt(OffsetDateTime.parse("2026-09-16T10:53:24.744Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAtsCompanyRequest req = PatchAtsCompanyRequest.builder()
                .atsCompany(AtsCompany.builder()
                    ...
                    .name("Gulgowski, Dibbert and Wilderman")
                    .phone("1-602-210-4548")
                    .updatedAt(OffsetDateTime.parse("2020-09-25T00:05:26.581Z"))
                    .websiteUrl("https://somber-substitution.com/")
                    .build())
                .connectionId("<id>")
                .id("<id>")
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAtsDocumentRequest req = PatchAtsDocumentRequest.builder()
                .atsDocument(AtsDocument.builder()
                    ...
                    .type(AtsDocumentType.RESUME)
                    .updatedAt(OffsetDateTime.parse("2022-11-29T04:07:49.311Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAtsInterviewRequest req = PatchAtsInterviewRequest.builder()
                .atsInterview(AtsInterview.builder()
                    .createdAt(OffsetDateTime.parse("2021-11-28T03:14:47.774Z"))
                    .endAt(OffsetDateTime.parse("2025-09-24T03:12:45.650Z"))
                    .externalEventXref("948dae4e-d3a4-4510-ae54-7ba47c693a09")
                    .id("2deb3bc6-2684-458b-9913-29daf8d2b30b")
                    .location("26596 Halle Trafficway")
                    .startAt(OffsetDateTime.parse("2025-05-19T23:37:23.895Z"))
                    .status(AtsInterviewStatus.SCHEDULED)
                    .updatedAt(OffsetDateTime.parse("2026-02-04T21:20:55.166Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
