    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsAdRequest req = CreateAdsAdRequest.builder()
                .adsAd(AdsAd.builder()
                    ...
                    .id("2485dc1a-45ab-441e-8ef6-57917c997da3")
                    .name("Hermiston Group")
                    .status(AdsAdStatus.ARCHIVED)
                    .updatedAt(OffsetDateTime.parse("2024-06-05T22:40:35.522Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsAssetRequest req = CreateAdsAssetRequest.builder()
                .adsAsset(AdsAsset.builder()
                    ...
                    .height(400d)
                    .id("b010fa3a-311a-49c3-a221-f1fd26daacda")
                    .mimeType("IMAGE_PNG")
                    .name("Lockman - DuBuque")
                    .type(AdsAssetType.IMAGE)
                    .updatedAt(OffsetDateTime.parse("2022-03-15T19:19:16.016Z"))
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsCampaignRequest req = CreateAdsCampaignRequest.builder()
                .adsCampaign(AdsCampaign.builder()
                    ...
                    .endAt(OffsetDateTime.parse("2025-05-10T18:00:21.856Z"))
                    .id("f6acf0e5-a741-4502-b6a4-9ff4982c5a0d")
                    .labels(List.of(
                        "comedo"))
                    .name("Emard Inc")
                    .startAt(OffsetDateTime.parse("2022-07-20T06:42:57.512Z"))
                    ...
                    .updatedAt(OffsetDateTime.parse("2025-12-07T05:49:14.039Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsGroupRequest req = CreateAdsGroupRequest.builder()
                .adsGroup(AdsGroup.builder()
                    ...
                    .endAt(OffsetDateTime.parse("2026-05-26T12:13:21.268Z"))
                    .id("ff339f7d-c1c6-4f52-91fb-fb7028d8c191")
                    .languageLocale("fr-FR")
                    .name("Stark - Baumbach")
                    .startAt(OffsetDateTime.parse("2025-12-12T16:56:58.032Z"))
                    .status(AdsGroupStatus.PROCESSING)
                    .targeting(PropertyAdsGroupTargeting.builder()
                        .build())
                    .updatedAt(OffsetDateTime.parse("2022-01-03T09:06:24.367Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsInsertionorderRequest req = CreateAdsInsertionorderRequest.builder()
                .adsInsertionorder(AdsInsertionorder.builder()
                    ...
                    .id("e2cdd10f-4153-4ba6-8805-8facb64b683f")
                    .name("Kunde, Smith and Reinger")
                    .status(AdsInsertionorderStatus.UNSPECIFIED)
                    .updatedAt(OffsetDateTime.parse("2021-04-28T12:58:25.308Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsOrganizationRequest req = CreateAdsOrganizationRequest.builder()
                .adsOrganization(AdsOrganization.builder()
                    ...
                    .currency("USD")
                    .id("1693a161-f921-4f29-a388-64f33ab6c27f")
                    .managers(List.of(
                        AdsManager.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2026-02-28T23:13:17.841Z"))
                    .build())
                .connectionId("<id>")
                .build();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        GetAdsPromotedResponse res = sdk.ads().getAdsPromoted()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        GetAdsTargetResponse res = sdk.ads().getAdsTarget()
                .request(req)
                .call();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAdsAdRequest req = PatchAdsAdRequest.builder()
                .adsAd(AdsAd.builder()
                    ...
                    .description("Accedo vespillo carpo dolor decet stillicidium comptus tenuis.")
                    .finalUrl("https://improbable-sanity.com")
                    .id("68dd1d3e-7eb1-46b2-a708-c6a88e4a34c2")
                    .name("Hermiston Group")
                    .status(AdsAdStatus.ARCHIVED)
                    .updatedAt(OffsetDateTime.parse("2024-06-05T22:40:35.528Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAdsCampaignRequest req = PatchAdsCampaignRequest.builder()
                .adsCampaign(AdsCampaign.builder()
                    ...
                    .currency("USD")
                    .effectiveStatus(EffectiveStatus.NOT_ELIGIBLE)
                    .endAt(OffsetDateTime.parse("2025-05-10T18:00:21.935Z"))
                    .id("f7e7285e-6a1d-411f-8055-12f95fd7f5fb")
                    .labels(List.of(
                        "comedo"))
                    .name("Emard Inc")
                    .startAt(OffsetDateTime.parse("2022-07-20T06:42:57.517Z"))
                    .status(AdsCampaignStatus.PROCESSING_FAILED)
                    .targeting(PropertyAdsCampaignTargeting.builder()
                        .build())
                    .totalSpendAmount(2349.8642875347286)
                    .updatedAt(OffsetDateTime.parse("2025-12-07T05:49:14.135Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAdsGroupRequest req = PatchAdsGroupRequest.builder()
                .adsGroup(AdsGroup.builder()
                    ...
                    .currency("USD")
                    .effectiveStatus(AdsGroupEffectiveStatus.PAUSED)
                    .endAt(OffsetDateTime.parse("2026-05-26T12:13:21.385Z"))
                    .id("ed25928d-eb64-4636-8d5c-add42de3fef4")
                    .languageLocale("fr-FR")
                    .name("Stark - Baumbach")
                    .startAt(OffsetDateTime.parse("2025-12-12T16:56:58.141Z"))
                    .status(AdsGroupStatus.PROCESSING)
                    .targeting(PropertyAdsGroupTargeting.builder()
                        .build())
                    .updatedAt(OffsetDateTime.parse("2022-01-03T09:06:24.408Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAdsInsertionorderRequest req = PatchAdsInsertionorderRequest.builder()
                .adsInsertionorder(AdsInsertionorder.builder()
                    .createdAt(OffsetDateTime.parse("2021-04-10T06:57:36.611Z"))
                    .id("bbb46a3b-88f8-4987-a580-8a7124050004")
                    .name("Kunde, Smith and Reinger")
                    .status(AdsInsertionorderStatus.UNSPECIFIED)
                    .updatedAt(OffsetDateTime.parse("2021-04-28T12:58:25.308Z"))
                    .build())
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAdsOrganizationRequest req = PatchAdsOrganizationRequest.builder()
                .adsOrganization(AdsOrganization.builder()
                    ...
                    .createdAt(OffsetDateTime.parse("2020-07-23T21:47:11.440Z"))
                    .currency("USD")
                    .id("2a35da14-09e0-4cc3-9cc9-05db7c085142")
                    .managers(List.of(
                        AdsManager.builder()
                            .id("e4fd87df-9f8b-4fa0-a77b-b7d18669e350")
                            .name("Parker, Leannon and Gibson")
                    ...
                    .status(AdsOrganizationStatus.PROCESSING)
                    .timezone("Europe/Chisinau")
                    .updatedAt(OffsetDateTime.parse("2026-02-28T23:13:17.849Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
