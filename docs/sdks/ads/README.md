    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsAdRequest req = CreateAdsAdRequest.builder()
                .adsAd(AdsAd.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2024-06-05T12:20:24.265Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsAssetRequest req = CreateAdsAssetRequest.builder()
                .adsAsset(AdsAsset.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2022-03-15T11:38:01.835Z"))
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsCampaignRequest req = CreateAdsCampaignRequest.builder()
                .adsCampaign(AdsCampaign.builder()
                    ...
                    .endAt(OffsetDateTime.parse("2025-05-10T00:37:26.834Z"))
                    .id("eb5ac5b0-56b4-489b-be16-ded64547cf4c")
                    .labels(List.of(
                        "comedo"))
                    .name("Emard Inc")
                    .startAt(OffsetDateTime.parse("2022-07-20T05:45:23.511Z"))
                    ...
                    .updatedAt(OffsetDateTime.parse("2025-12-06T09:04:03.594Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsGroupRequest req = CreateAdsGroupRequest.builder()
                .adsGroup(AdsGroup.builder()
                    ...
                    .endAt(OffsetDateTime.parse("2026-05-25T12:01:20.593Z"))
                    .id("53c56d6e-732d-4677-a725-158241d2ed4d")
                    .languageLocale("fr-FR")
                    .name("Stark - Baumbach")
                    .startAt(OffsetDateTime.parse("2025-12-11T18:22:09.671Z"))
                    .status(AdsGroupStatus.PROCESSING)
                    .targeting(PropertyAdsGroupTargeting.builder()
                        .build())
                    .updatedAt(OffsetDateTime.parse("2022-01-03T00:40:33.200Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsInsertionorderRequest req = CreateAdsInsertionorderRequest.builder()
                .adsInsertionorder(AdsInsertionorder.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2021-04-28T12:44:27.963Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsOrganizationRequest req = CreateAdsOrganizationRequest.builder()
                .adsOrganization(AdsOrganization.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2026-02-28T00:09:51.373Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAdsAdRequest req = PatchAdsAdRequest.builder()
                .adsAd(AdsAd.builder()
                    ...
                    .name("Hermiston Group")
                    .status(AdsAdStatus.ARCHIVED)
                    .updatedAt(OffsetDateTime.parse("2024-06-05T12:20:24.272Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAdsCampaignRequest req = PatchAdsCampaignRequest.builder()
                .adsCampaign(AdsCampaign.builder()
                    ...
                    .currency("USD")
                    .effectiveStatus(EffectiveStatus.NOT_ELIGIBLE)
                    .endAt(OffsetDateTime.parse("2025-05-10T00:37:26.947Z"))
                    .id("62dcec1c-db7a-4069-b8a4-4603edded4b4")
                    .labels(List.of(
                        "comedo"))
                    .name("Emard Inc")
                    .startAt(OffsetDateTime.parse("2022-07-20T05:45:23.518Z"))
                    .status(AdsCampaignStatus.PROCESSING_FAILED)
                    .targeting(PropertyAdsCampaignTargeting.builder()
                        .build())
                    .totalSpendAmount(2349.8642875347286)
                    .updatedAt(OffsetDateTime.parse("2025-12-06T09:04:03.729Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAdsGroupRequest req = PatchAdsGroupRequest.builder()
                .adsGroup(AdsGroup.builder()
                    ...
                    .currency("USD")
                    .effectiveStatus(AdsGroupEffectiveStatus.PAUSED)
                    .endAt(OffsetDateTime.parse("2026-05-25T12:01:20.774Z"))
                    .id("c256e0ae-82b2-4430-88be-034c23ab3142")
                    .languageLocale("fr-FR")
                    .name("Stark - Baumbach")
                    .startAt(OffsetDateTime.parse("2025-12-11T18:22:09.839Z"))
                    .status(AdsGroupStatus.PROCESSING)
                    .targeting(PropertyAdsGroupTargeting.builder()
                        .build())
                    .updatedAt(OffsetDateTime.parse("2022-01-03T00:40:33.263Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAdsInsertionorderRequest req = PatchAdsInsertionorderRequest.builder()
                .adsInsertionorder(AdsInsertionorder.builder()
                    ...
                    .name("Kunde, Smith and Reinger")
                    .status(AdsInsertionorderStatus.UNSPECIFIED)
                    .updatedAt(OffsetDateTime.parse("2021-04-28T12:44:27.964Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAdsOrganizationRequest req = PatchAdsOrganizationRequest.builder()
                .adsOrganization(AdsOrganization.builder()
                    ...
                    .status(AdsOrganizationStatus.PROCESSING)
                    .timezone("Europe/Chisinau")
                    .updatedAt(OffsetDateTime.parse("2026-02-28T00:09:51.383Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
