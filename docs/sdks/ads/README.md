    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsAdRequest req = CreateAdsAdRequest.builder()
                .adsAd(AdsAd.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2024-06-06T08:19:09.244Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsAssetRequest req = CreateAdsAssetRequest.builder()
                .adsAsset(AdsAsset.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2022-03-16T02:29:32.674Z"))
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsCampaignRequest req = CreateAdsCampaignRequest.builder()
                .adsCampaign(AdsCampaign.builder()
                    ...
                    .endAt(OffsetDateTime.parse("2025-05-11T10:13:16.657Z"))
                    .id("b7845a2b-55ce-4073-a0ed-06c84d3fc889")
                    .labels(List.of(
                        "comedo"))
                    .name("Emard Inc")
                    .startAt(OffsetDateTime.parse("2022-07-20T07:36:39.670Z"))
                    ...
                    .updatedAt(OffsetDateTime.parse("2025-12-08T01:10:49.698Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsCreativeRequest req = CreateAdsCreativeRequest.builder()
                .adsCreative(AdsCreative.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2021-06-21T15:50:31.757Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsGroupRequest req = CreateAdsGroupRequest.builder()
                .adsGroup(AdsGroup.builder()
                    ...
                    .endAt(OffsetDateTime.parse("2026-05-27T10:47:54.397Z"))
                    .id("a78580ac-5f27-4480-8b54-5f6b61a3d2db")
                    .languageLocale("fr-FR")
                    .name("Stark - Baumbach")
                    .startAt(OffsetDateTime.parse("2025-12-13T14:00:50.313Z"))
                    .status(AdsGroupStatus.PROCESSING)
                    .targeting(PropertyAdsGroupTargeting.builder()
                        .build())
                    .updatedAt(OffsetDateTime.parse("2022-01-03T16:58:18.363Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAdsInsertionorderRequest req = CreateAdsInsertionorderRequest.builder()
                .adsInsertionorder(AdsInsertionorder.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2021-04-28T13:11:26.449Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAdsAdRequest req = PatchAdsAdRequest.builder()
                .adsAd(AdsAd.builder()
                    ...
                    .name("Hermiston Group")
                    .status(AdsAdStatus.ARCHIVED)
                    .updatedAt(OffsetDateTime.parse("2024-06-06T08:19:09.255Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAdsCampaignRequest req = PatchAdsCampaignRequest.builder()
                .adsCampaign(AdsCampaign.builder()
                    ...
                    .currency("USD")
                    .effectiveStatus(EffectiveStatus.NOT_ELIGIBLE)
                    .endAt(OffsetDateTime.parse("2025-05-11T10:13:16.729Z"))
                    .id("9d5b5933-d96e-4219-abbd-af2e7056899b")
                    .labels(List.of(
                        "comedo"))
                    .name("Emard Inc")
                    .startAt(OffsetDateTime.parse("2022-07-20T07:36:39.674Z"))
                    .status(AdsCampaignStatus.PROCESSING_FAILED)
                    .targeting(PropertyAdsCampaignTargeting.builder()
                        .build())
                    .totalSpendAmount(2349.8642875347286)
                    .updatedAt(OffsetDateTime.parse("2025-12-08T01:10:49.785Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAdsCreativeRequest req = PatchAdsCreativeRequest.builder()
                .adsCreative(AdsCreative.builder()
                    ...
                    .name("Brekke, Bradtke and Robel")
                    .status(AdsCreativeStatus.PAUSED)
                    .updatedAt(OffsetDateTime.parse("2021-06-21T15:50:31.764Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAdsGroupRequest req = PatchAdsGroupRequest.builder()
                .adsGroup(AdsGroup.builder()
                    ...
                    .currency("USD")
                    .effectiveStatus(AdsGroupEffectiveStatus.PAUSED)
                    .endAt(OffsetDateTime.parse("2026-05-27T10:47:54.564Z"))
                    .id("ea9eb928-96eb-4e5b-a608-6caf8c5ab32f")
                    .languageLocale("fr-FR")
                    .name("Stark - Baumbach")
                    .startAt(OffsetDateTime.parse("2025-12-13T14:00:50.468Z"))
                    .status(AdsGroupStatus.PROCESSING)
                    .targeting(PropertyAdsGroupTargeting.builder()
                        .build())
                    .updatedAt(OffsetDateTime.parse("2022-01-03T16:58:18.420Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAdsInsertionorderRequest req = PatchAdsInsertionorderRequest.builder()
                .adsInsertionorder(AdsInsertionorder.builder()
                    ...
                    .name("Kunde, Smith and Reinger")
                    .status(AdsInsertionorderStatus.UNSPECIFIED)
                    .updatedAt(OffsetDateTime.parse("2021-04-28T13:11:26.450Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
