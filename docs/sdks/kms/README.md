    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateKmsPageRequest req = CreateKmsPageRequest.builder()
                .kmsPage(KmsPage.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2025-09-11T14:54:39.502Z"))
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateKmsSpaceRequest req = CreateKmsSpaceRequest.builder()
                .kmsSpace(KmsSpace.builder()
                    ...
                    .isActive(false)
                    .name("into nor afore")
                    .updatedAt(OffsetDateTime.parse("2025-12-04T10:48:59.729Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchKmsPageRequest req = PatchKmsPageRequest.builder()
                .kmsPage(KmsPage.builder()
                    ...
                    .metadata(List.of())
                    .title("even minister extract")
                    .updatedAt(OffsetDateTime.parse("2025-09-11T14:54:39.517Z"))
                    .webUrl("https://another-petticoat.info")
                    .build())
                .connectionId("<id>")
                .id("<id>")
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchKmsSpaceRequest req = PatchKmsSpaceRequest.builder()
                .kmsSpace(KmsSpace.builder()
                    ...
                    .isActive(false)
                    .name("into nor afore")
                    .updatedAt(OffsetDateTime.parse("2025-12-04T10:48:59.736Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
