    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateKmsCommentRequest req = CreateKmsCommentRequest.builder()
                .kmsComment(KmsComment.builder()
                    ...
                    .id("211a83d7-d748-4b78-a6c1-a91443d24075")
                    .type(KmsCommentType.PAGE)
                    .updatedAt(OffsetDateTime.parse("2023-11-16T23:03:08.266Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateKmsPageRequest req = CreateKmsPageRequest.builder()
                .kmsPage(KmsPage.builder()
                    ...
                    .hasChildren(true)
                    .id("e3d54442-804d-4165-99d7-cfee9e2af94b")
                    .isActive(true)
                    .metadata(List.of())
                    .title("even minister extract")
                    .updatedAt(OffsetDateTime.parse("2025-09-12T12:43:58.345Z"))
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateKmsSpaceRequest req = CreateKmsSpaceRequest.builder()
                .kmsSpace(KmsSpace.builder()
                    ...
                    .description("Acer.")
                    .id("7d877067-28a2-42e0-b25d-c67c500b4b86")
                    .isActive(false)
                    .name("into nor afore")
                    .updatedAt(OffsetDateTime.parse("2025-12-05T07:00:30.796Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchKmsCommentRequest req = PatchKmsCommentRequest.builder()
                .kmsComment(KmsComment.builder()
                    ...
                    .contentType(ContentType.HTML)
                    .createdAt(OffsetDateTime.parse("2022-08-26T14:40:49.732Z"))
                    .id("164a7adf-2048-4544-912e-275129bc6ab0")
                    .type(KmsCommentType.PAGE)
                    .updatedAt(OffsetDateTime.parse("2023-11-16T23:03:08.268Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchKmsPageRequest req = PatchKmsPageRequest.builder()
                .kmsPage(KmsPage.builder()
                    ...
                    .downloadUrl("https://agitated-validity.info")
                    .hasChildren(true)
                    .id("8261b44b-9a51-465f-8e52-067740f50a6a")
                    .isActive(true)
                    .metadata(List.of())
                    .title("even minister extract")
                    .updatedAt(OffsetDateTime.parse("2025-09-12T12:43:58.361Z"))
                    .webUrl("https://another-petticoat.info")
                    .build())
                .connectionId("<id>")
                .id("<id>")
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchKmsSpaceRequest req = PatchKmsSpaceRequest.builder()
                .kmsSpace(KmsSpace.builder()
                    .createdAt(OffsetDateTime.parse("2022-10-31T00:56:54.246Z"))
                    .description("Acer.")
                    .id("c18c3478-e950-41c6-8c76-5b6609663e23")
                    .isActive(false)
                    .name("into nor afore")
                    .updatedAt(OffsetDateTime.parse("2025-12-05T07:00:30.805Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
