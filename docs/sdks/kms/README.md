    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateKmsCommentRequest req = CreateKmsCommentRequest.builder()
                .kmsComment(KmsComment.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2023-11-17T06:10:22.975Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateKmsPageRequest req = CreateKmsPageRequest.builder()
                .kmsPage(KmsPage.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2025-09-13T09:05:24.001Z"))
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateKmsSpaceRequest req = CreateKmsSpaceRequest.builder()
                .kmsSpace(KmsSpace.builder()
                    ...
                    .isActive(false)
                    .name("into nor afore")
                    .updatedAt(OffsetDateTime.parse("2025-12-06T01:50:42.552Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchKmsCommentRequest req = PatchKmsCommentRequest.builder()
                .kmsComment(KmsComment.builder()
                    ...
                    .type(KmsCommentType.PAGE)
                    .updatedAt(OffsetDateTime.parse("2023-11-17T06:10:22.978Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchKmsPageRequest req = PatchKmsPageRequest.builder()
                .kmsPage(KmsPage.builder()
                    ...
                    .metadata(List.of())
                    .title("even minister extract")
                    .updatedAt(OffsetDateTime.parse("2025-09-13T09:05:24.016Z"))
                    .webUrl("https://another-petticoat.info")
                    .build())
                .connectionId("<id>")
                .id("<id>")
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchKmsSpaceRequest req = PatchKmsSpaceRequest.builder()
                .kmsSpace(KmsSpace.builder()
                    ...
                    .isActive(false)
                    .name("into nor afore")
                    .updatedAt(OffsetDateTime.parse("2025-12-06T01:50:42.558Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
