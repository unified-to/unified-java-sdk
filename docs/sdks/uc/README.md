    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateUcRecordingRequest req = CreateUcRecordingRequest.builder()
                .ucRecording(UcRecording.builder()
                    ...
                    .endAt(OffsetDateTime.parse("2024-04-22T05:53:52.961Z"))
                    .expiresAt(OffsetDateTime.parse("2026-03-29T13:19:23.353Z"))
                    .id("d47f9784-3823-4b39-af0e-c2897538fe69")
                    .media(List.of())
                    .startAt(OffsetDateTime.parse("2023-04-22T23:57:25.655Z"))
                    .type(UcRecordingType.INBOUND)
                    .updatedAt(OffsetDateTime.parse("2025-02-24T22:53:53.642Z"))
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchUcRecordingRequest req = PatchUcRecordingRequest.builder()
                .ucRecording(UcRecording.builder()
                    .contacts(List.of())
                    .createdAt(OffsetDateTime.parse("2022-09-17T19:41:46.956Z"))
                    .endAt(OffsetDateTime.parse("2024-04-22T05:53:52.973Z"))
                    .expiresAt(OffsetDateTime.parse("2026-03-29T13:19:23.381Z"))
                    .id("b64b7c62-f251-4b12-abb6-22b79a6783eb")
                    .media(List.of())
                    .startAt(OffsetDateTime.parse("2023-04-22T23:57:25.659Z"))
                    .type(UcRecordingType.INBOUND)
                    .updatedAt(OffsetDateTime.parse("2025-02-24T22:53:53.660Z"))
                    .userName("Melyna Larson")
                    .userPhone("1-915-327-0429 x509")
                    .webUrl("https://spherical-comparison.org")
                    .build())
