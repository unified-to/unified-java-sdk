...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            com.unifiedapi.unifiedto.models.operations.ListAtsApplicationstatusesResponse res = sdk.applicationstatus.listAtsApplicationstatuses(req, new ListAtsApplicationstatusesSecurity(
            "<value>"){{
