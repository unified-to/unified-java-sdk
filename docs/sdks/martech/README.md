    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateMartechListRequest req = CreateMartechListRequest.builder()
                .marketingList(MarketingList.builder()
                    ...
                    .description("Currus.")
                    .id("2a9f6171-a648-4a29-a24f-751bb9825778")
                    .isActive(true)
                    .language("it")
                    .name("Annette Nolan")
                    ...
                    .updatedAt(OffsetDateTime.parse("2022-08-31T09:05:10.462Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchMartechListRequest req = PatchMartechListRequest.builder()
                .marketingList(MarketingList.builder()
                    ...
                    .createdAt(OffsetDateTime.parse("2019-09-18T02:01:36.950Z"))
                    .description("Currus.")
                    .id("9df7dc86-a70b-4aff-b9a4-3a13e6b61ee7")
                    .isActive(true)
                    .language("it")
                    .name("Annette Nolan")
                    .senderCompany("Hickle - Homenick")
                    ...
                    .senderPhone("896-328-1153 x4957")
                    .subject("Tenetur thymum circumvenio triumphus celo.")
                    .updatedAt(OffsetDateTime.parse("2022-08-31T09:05:10.468Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
