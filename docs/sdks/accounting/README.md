    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingBankfeedaccountRequest req = CreateAccountingBankfeedaccountRequest.builder()
                .accountingBankfeedaccount(AccountingBankfeedaccount.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2024-04-11T21:48:26.320Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingBankfeedtransactionRequest req = CreateAccountingBankfeedtransactionRequest.builder()
                .accountingBankfeedtransaction(AccountingBankfeedtransaction.builder()
                    ...
                    .postedAt(OffsetDateTime.parse("2025-03-24T10:28:18.240Z"))
                    .reference("93642593")
                    .transactionAt(OffsetDateTime.parse("2022-07-27T21:36:58.881Z"))
                    .type(AccountingBankfeedtransactionType.CREDIT)
                    .updatedAt(OffsetDateTime.parse("2022-05-23T21:39:30.941Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingBillRequest req = CreateAccountingBillRequest.builder()
                .accountingBill(AccountingBill.builder()
                    ...
                    .payments(List.of())
                    .postedAt(OffsetDateTime.parse("2024-04-04T22:57:51.533Z"))
                    .send(true)
                    .status(AccountingBillStatus.DELETED)
                    .taxAmount(0d)
                    .term(Term.NET10)
                    .totalAmount(0d)
                    .updatedAt(OffsetDateTime.parse("2025-01-29T19:17:10.104Z"))
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingCategoryRequest req = CreateAccountingCategoryRequest.builder()
                .accountingCategory(AccountingCategory.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2025-08-20T22:37:08.764Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingCreditmemoRequest req = CreateAccountingCreditmemoRequest.builder()
                .accountingCreditmemo(AccountingCreditmemo.builder()
                    ...
                    .postedAt(OffsetDateTime.parse("2025-11-16T04:10:08.958Z"))
                    .refundAmount(0d)
                    ...
                    .taxAmount(0d)
                    .totalAmount(0d)
                    .updatedAt(OffsetDateTime.parse("2024-11-15T22:43:50.085Z"))
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingJournalRequest req = CreateAccountingJournalRequest.builder()
                .accountingJournal(AccountingJournal.builder()
                    ...
                    .postedAt(OffsetDateTime.parse("2023-10-19T15:06:14.496Z"))
                    .reference("ullam")
                    .source("crustulum")
                    .taxAmount(78672d)
                    .updatedAt(OffsetDateTime.parse("2022-01-01T17:53:31.468Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingPaymenttermRequest req = CreateAccountingPaymenttermRequest.builder()
                .accountingPaymentterm(AccountingPaymentterm.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2025-12-12T07:18:03.363Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingPurchaseorderRequest req = CreateAccountingPurchaseorderRequest.builder()
                .accountingPurchaseorder(AccountingPurchaseorder.builder()
                    ...
                    .lineitems(List.of())
                    .metadata(List.of())
                    .postedAt(OffsetDateTime.parse("2025-04-25T21:32:34.799Z"))
                    ...
                    .totalAmount(0d)
                    .updatedAt(OffsetDateTime.parse("2021-02-26T04:10:11.504Z"))
                    .build())
                .connectionId("<id>")
                .build();
        ...
        CreateAccountingSalesorderRequest req = CreateAccountingSalesorderRequest.builder()
                .accountingSalesorder(AccountingSalesorder.builder()
                    .billingAddress(PropertyAccountingSalesorderBillingAddress.builder()
                        ...
                        .build())
                    .categoryIds(List.of())
                    .closedAt(OffsetDateTime.parse("2023-08-17T05:50:05.521Z"))
                    ...
                    .orderNumber("988187")
                    .payments(List.of())
                    .postedAt(OffsetDateTime.parse("2026-01-11T22:29:07.252Z"))
                    .refundedAmount(0d)
                    ...
                    .tipAmount(34d)
                    .totalAmount(0d)
                    .updatedAt(OffsetDateTime.parse("2022-02-10T19:09:20.343Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingTaxrateRequest req = CreateAccountingTaxrateRequest.builder()
                .accountingTaxrate(AccountingTaxrate.builder()
                    ...
                    .name("cogo")
                    .rate(1d)
                    .updatedAt(OffsetDateTime.parse("2025-11-05T04:35:51.547Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingVendorcreditRequest req = CreateAccountingVendorcreditRequest.builder()
                .accountingVendorcredit(AccountingVendorcredit.builder()
                    ...
                    .postedAt(OffsetDateTime.parse("2023-09-28T19:52:50.818Z"))
                    .status(AccountingVendorcreditStatus.SUBMITTED)
                    .totalAmount(0d)
                    .updatedAt(OffsetDateTime.parse("2023-11-26T18:52:08.268Z"))
                    .build())
                .connectionId("<id>")
                .build();
                ...
                .accountingAccount(AccountingAccount.builder()
                    ...
                    .taxonomy(List.of(
                        ...
                        AccountingAccountTaxonomy.builder()
                            ...
                            .build()))
                    .type(Type.BANK)
                    .updatedAt(OffsetDateTime.parse("2023-01-03T06:01:37.839Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingBankfeedaccountRequest req = PatchAccountingBankfeedaccountRequest.builder()
                .accountingBankfeedaccount(AccountingBankfeedaccount.builder()
                    ...
                    .routingNumber("667753156")
                    .status(AccountingBankfeedaccountStatus.ACTIVE)
                    .updatedAt(OffsetDateTime.parse("2024-04-11T21:48:26.325Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingBankfeedtransactionRequest req = PatchAccountingBankfeedtransactionRequest.builder()
                .accountingBankfeedtransaction(AccountingBankfeedtransaction.builder()
                    ...
                    .isPending(true)
                    .merchantName("Reichert, Erdman and Tillman")
                    .postedAt(OffsetDateTime.parse("2025-03-24T10:28:18.249Z"))
                    .reference("93642593")
                    .transactionAt(OffsetDateTime.parse("2022-07-27T21:36:58.882Z"))
                    .type(AccountingBankfeedtransactionType.CREDIT)
                    .updatedAt(OffsetDateTime.parse("2022-05-23T21:39:30.942Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingBillRequest req = PatchAccountingBillRequest.builder()
                .accountingBill(AccountingBill.builder()
                    ...
                    .paymentCollectionMethod(PaymentCollectionMethod.CHARGE_AUTOMATICALLY)
                    .payments(List.of())
                    .postedAt(OffsetDateTime.parse("2024-04-04T22:57:51.571Z"))
                    .send(true)
                    .status(AccountingBillStatus.DELETED)
                    .taxAmount(0d)
                    .term(Term.NET10)
                    .totalAmount(0d)
                    .updatedAt(OffsetDateTime.parse("2025-01-29T19:17:10.149Z"))
                    .url("https://coarse-interviewer.biz/")
                    .build())
                .connectionId("<id>")
                .id("<id>")
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingCategoryRequest req = PatchAccountingCategoryRequest.builder()
                .accountingCategory(AccountingCategory.builder()
                    ...
                    .metadata(List.of())
                    .name("Electronic Cotton Shoes")
                    .updatedAt(OffsetDateTime.parse("2025-08-20T22:37:08.777Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingCreditmemoRequest req = PatchAccountingCreditmemoRequest.builder()
                .accountingCreditmemo(AccountingCreditmemo.builder()
                    ...
                    .notes("Dedecor amo adfero torqueo quas.")
                    .paymentCollectionMethod(AccountingCreditmemoPaymentCollectionMethod.CHARGE_AUTOMATICALLY)
                    .postedAt(OffsetDateTime.parse("2025-11-16T04:10:08.990Z"))
                    .refundAmount(0d)
                    .refundReason("Virgo inflammatio quibusdam aestivus magnam.")
                    .refundedAt(OffsetDateTime.parse("2023-10-23T00:35:36.814Z"))
                    .send(false)
                    ...
                    .taxAmount(0d)
                    .totalAmount(0d)
                    .updatedAt(OffsetDateTime.parse("2024-11-15T22:43:50.102Z"))
                    .url("https://lighthearted-bandwidth.net/")
                    .build())
                .connectionId("<id>")
                .id("<id>")
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingJournalRequest req = PatchAccountingJournalRequest.builder()
                .accountingJournal(AccountingJournal.builder()
                    ...
                    .postedAt(OffsetDateTime.parse("2023-10-19T15:06:14.508Z"))
                    .reference("ullam")
                    .source("crustulum")
                    .taxAmount(78672d)
                    .updatedAt(OffsetDateTime.parse("2022-01-01T17:53:31.474Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingPaymenttermRequest req = PatchAccountingPaymenttermRequest.builder()
                .accountingPaymentterm(AccountingPaymentterm.builder()
                    ...
                    .name("Net 30")
                    .type(AccountingPaymenttermType.NET15)
                    .updatedAt(OffsetDateTime.parse("2025-12-12T07:18:03.378Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingPurchaseorderRequest req = PatchAccountingPurchaseorderRequest.builder()
                .accountingPurchaseorder(AccountingPurchaseorder.builder()
                    ...
                    .lineitems(List.of())
                    .metadata(List.of())
                    .postedAt(OffsetDateTime.parse("2025-04-25T21:32:34.840Z"))
                    .shippingAddress(PropertyAccountingPurchaseorderShippingAddress.builder()
                        .address1("649 Maggio Overpass")
                        .city("Lake Jaylan")
                        .countryCode("US")
                    ...
                    .status(AccountingPurchaseorderStatus.PARTIALLY_REFUNDED)
                    .totalAmount(0d)
                    .updatedAt(OffsetDateTime.parse("2021-02-26T04:10:11.506Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
        ...
        PatchAccountingSalesorderRequest req = PatchAccountingSalesorderRequest.builder()
                .accountingSalesorder(AccountingSalesorder.builder()
                    .billingAddress(PropertyAccountingSalesorderBillingAddress.builder()
                        ...
                        .build())
                    .categoryIds(List.of())
                    .closedAt(OffsetDateTime.parse("2023-08-17T05:50:05.543Z"))
                    .createdAt(OffsetDateTime.parse("2022-01-17T16:11:50.310Z"))
                    .currency("ANG")
                    .discountAmount(99d)
                    .employeeUserId("4a6b8990-c85a-499f-82d0-5011c3c95a0b")
                    ...
                    .orderNumber("988187")
                    .payments(List.of())
                    .postedAt(OffsetDateTime.parse("2026-01-11T22:29:07.309Z"))
                    .refundedAmount(0d)
                    .salesChannel("Harvey, Collier and Weimann")
                    .serviceChargeAmount(63d)
                    .shippingAddress(PropertyAccountingSalesorderShippingAddress.builder()
                    ...
                    .tipAmount(34d)
                    .totalAmount(0d)
                    .updatedAt(OffsetDateTime.parse("2022-02-10T19:09:20.344Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingTaxrateRequest req = PatchAccountingTaxrateRequest.builder()
                .accountingTaxrate(AccountingTaxrate.builder()
                    ...
                    .name("cogo")
                    .rate(1d)
                    .updatedAt(OffsetDateTime.parse("2025-11-05T04:35:51.561Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingVendorcreditRequest req = PatchAccountingVendorcreditRequest.builder()
                .accountingVendorcredit(AccountingVendorcredit.builder()
                    ...
                    .metadata(List.of())
                    .notes("Conatus cruciamentum decor avaritia tantum.")
                    .postedAt(OffsetDateTime.parse("2023-09-28T19:52:50.823Z"))
                    .status(AccountingVendorcreditStatus.SUBMITTED)
                    .totalAmount(0d)
                    .updatedAt(OffsetDateTime.parse("2023-11-26T18:52:08.275Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
