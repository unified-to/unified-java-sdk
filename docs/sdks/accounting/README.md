    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingBillRequest req = CreateAccountingBillRequest.builder()
                .accountingBill(AccountingBill.builder()
                    ...
                    .id("877d596c-f3ad-483d-a22d-3e28a15fdc98")
                    .lineitems(List.of())
                    .metadata(List.of())
                    .notes("Tutamen cilicium infit.")
                    .paymentCollectionMethod(PaymentCollectionMethod.CHARGE_AUTOMATICALLY)
                    .payments(List.of())
                    .postedAt(OffsetDateTime.parse("2024-04-05T15:33:32.039Z"))
                    .send(true)
                    .status(AccountingBillStatus.DELETED)
                    .taxAmount(0d)
                    .term(Term.NET10)
                    .totalAmount(0d)
                    .updatedAt(OffsetDateTime.parse("2025-01-30T14:48:21.496Z"))
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingCategoryRequest req = CreateAccountingCategoryRequest.builder()
                .accountingCategory(AccountingCategory.builder()
                    ...
                    .id("635cabdb-23d4-4c22-bc3d-811c83ce2b18")
                    .isActive(false)
                    .metadata(List.of())
                    .name("Electronic Cotton Shoes")
                    .updatedAt(OffsetDateTime.parse("2025-08-21T15:41:37.285Z"))
                    .build())
                .connectionId("<id>")
                .build();
                ...
                .accountingContact(AccountingContact.builder()
                    .associatedContacts(List.of(
                        AccountingAssociatedContact.builder()
                            .id("e6b6fd80-bbc3-4e88-b09d-dddfed5a60ce")
                            .name("Delores Reynolds")
                            .build(),
                        AccountingAssociatedContact.builder()
                            .id("a0697b29-a1c2-4184-9fd1-8e537960f1eb")
                            .name("Delores Reynolds")
                            .build()))
                    ...
                    .emails(List.of(
                        AccountingEmail.builder()
                            ...
                            .build()))
                    .firstName("Delores")
                    .id("9d88bd0a-0078-4ce2-b677-337664f87fdb")
                    ...
                    .paymentMethods(List.of(
                        AccountingContactPaymentMethod.builder()
                            ...
                            .default_(true)
                            .id("4cbdee89-1268-4f1b-a3ec-e4a2846982c6")
                            .name("Visa 1234")
                            .build()))
                    ...
                    .telephones(List.of(
                        ...
                        AccountingTelephone.builder()
                            ...
                            .build()))
                    .updatedAt(OffsetDateTime.parse("2023-12-05T20:41:53.492Z"))
                ...
                .accountingInvoice(AccountingInvoice.builder()
                    .attachments(List.of(
                        AccountingAttachment.builder()
                            ...
                            .id("cd48e855-1a1a-4292-803f-6c1fa1f627d6")
                    ...
                    .extendedNotes(List.of())
                    .id("b138b234-bd4e-48df-bc35-35f729c5b07b")
                    .invoiceNumber("vinco")
                    .lineitems(List.of())
                    .metadata(List.of())
                    ...
                    .payments(List.of())
                    .postedAt(OffsetDateTime.parse("2026-03-28T17:49:08.051Z"))
                    ...
                    .updatedAt(OffsetDateTime.parse("2023-02-06T09:58:19.462Z"))
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingOrderRequest req = CreateAccountingOrderRequest.builder()
                .accountingOrder(AccountingOrder.builder()
                    ...
                    .currency("USD")
                    .id("e8d25036-88f2-49d0-b1d0-92b2ebcf376e")
                    .lineitems(List.of())
                    .metadata(List.of())
                    .postedAt(OffsetDateTime.parse("2022-04-05T11:48:24.016Z"))
                    ...
                    .updatedAt(OffsetDateTime.parse("2021-06-18T03:31:17.930Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingPaymenttermRequest req = CreateAccountingPaymenttermRequest.builder()
                .accountingPaymentterm(AccountingPaymentterm.builder()
                    ...
                    .dueDays(57d)
                    .dueNextMonthDays(9d)
                    .id("d6923283-5b7a-4197-b642-71f1608668cd")
                    .isActive(false)
                    .metadata(List.of())
                    .name("Net 30")
                    .type(AccountingPaymenttermType.NET15)
                    .updatedAt(OffsetDateTime.parse("2025-12-13T04:48:27.530Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingPurchaseorderRequest req = CreateAccountingPurchaseorderRequest.builder()
                .accountingPurchaseorder(AccountingPurchaseorder.builder()
                    ...
                    .currency("ZMW")
                    .id("25c4cbf7-9dfa-4cfd-b2ae-85c471210611")
                    .lineitems(List.of())
                    .metadata(List.of())
                    .postedAt(OffsetDateTime.parse("2025-04-26T16:44:23.548Z"))
                    ...
                    .totalAmount(0d)
                    .updatedAt(OffsetDateTime.parse("2021-02-26T05:04:57.593Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingTransactionRequest req = CreateAccountingTransactionRequest.builder()
                .accountingTransaction(AccountingTransaction.builder()
                    ...
                    .id("5d8e6495-fe65-44b1-a1e5-ed817c60df52")
                    .lineitems(List.of(
                        AccountingTransactionLineItem.builder()
                            ...
                            .id("b45390b5-d5c3-4731-a1f3-e19ca0ce40aa")
                            .name("Salad")
                            .objectType("delicate")
                            .totalAmount(58531d)
                            .unitAmount(536d)
                    ...
                    .taxAmount(0d)
                    .totalAmount(94452d)
                    .updatedAt(OffsetDateTime.parse("2021-09-10T16:24:07.240Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateAccountingVendorcreditRequest req = CreateAccountingVendorcreditRequest.builder()
                .accountingVendorcredit(AccountingVendorcredit.builder()
                    ...
                    .id("aee860e1-fa8f-4f75-a605-6371f46f5648")
                    .lineitems(List.of())
                    .metadata(List.of())
                    .notes("Conatus cruciamentum decor avaritia tantum.")
                    .postedAt(OffsetDateTime.parse("2023-09-28T23:14:23.760Z"))
                    .status(AccountingVendorcreditStatus.SUBMITTED)
                    .totalAmount(0d)
                    .updatedAt(OffsetDateTime.parse("2023-11-26T23:25:17.694Z"))
                    .build())
                .connectionId("<id>")
                .build();

        CreateAccountingVendorcreditResponse res = sdk.accounting().createAccountingVendorcredit()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        GetAccountingCashflowResponse res = sdk.accounting().getAccountingCashflow()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        GetAccountingVendorcreditResponse res = sdk.accounting().getAccountingVendorcredit()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ListAccountingCashflowsResponse res = sdk.accounting().listAccountingCashflows()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ListAccountingVendorcreditsResponse res = sdk.accounting().listAccountingVendorcredits()
                .request(req)
                .call();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingAccountRequest req = PatchAccountingAccountRequest.builder()
                .accountingAccount(AccountingAccount.builder()
                    ...
                    .customerDefinedCode("quo")
                    .description("Spoliatio comedo vilitas harum cupiditate.")
                    .id("7c8b8d08-878d-49ef-bfb2-d1bd5f2b43f5")
                    .isPayable(true)
                    .name("Electronic Aluminum Tuna")
                    .status(Status.ARCHIVED)
                    .taxonomy(List.of(
                        ...
                        AccountingAccountTaxonomy.builder()
                            ...
                            .build()))
                    .type(Type.BANK)
                    .updatedAt(OffsetDateTime.parse("2023-01-03T09:03:02.874Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingBankfeedaccountRequest req = PatchAccountingBankfeedaccountRequest.builder()
                .accountingBankfeedaccount(AccountingBankfeedaccount.builder()
                    ...
                    .currency("SSP")
                    .feedStartAt(OffsetDateTime.parse("2022-10-31T16:42:19.277Z"))
                    .id("11719eb8-9a3a-46b6-aae2-97bba95b36f7")
                    .name("Corwin, Donnelly and Connelly Savings")
                    .routingNumber("667753156")
                    .status(AccountingBankfeedaccountStatus.ACTIVE)
                    .updatedAt(OffsetDateTime.parse("2024-04-12T07:14:48.772Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingBillRequest req = PatchAccountingBillRequest.builder()
                .accountingBill(AccountingBill.builder()
                    ...
                    .dueAt(OffsetDateTime.parse("2019-08-11T20:52:55.321Z"))
                    .extendedNotes(List.of())
                    .id("4b4e84e6-6b5d-4430-ba52-95f1ff2b595d")
                    .lineitems(List.of())
                    .metadata(List.of())
                    .notes("Tutamen cilicium infit.")
                    .paymentCollectionMethod(PaymentCollectionMethod.CHARGE_AUTOMATICALLY)
                    .payments(List.of())
                    .postedAt(OffsetDateTime.parse("2024-04-05T15:33:32.080Z"))
                    .send(true)
                    .status(AccountingBillStatus.DELETED)
                    .taxAmount(0d)
                    .term(Term.NET10)
                    .totalAmount(0d)
                    .updatedAt(OffsetDateTime.parse("2025-01-30T14:48:21.544Z"))
                    .url("https://coarse-interviewer.biz/")
                    .build())
                .connectionId("<id>")
                .id("<id>")
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingCategoryRequest req = PatchAccountingCategoryRequest.builder()
                .accountingCategory(AccountingCategory.builder()
                    .createdAt(OffsetDateTime.parse("2023-05-30T12:29:04.257Z"))
                    .description("Discover the koala-like agility of our Chair, perfect for imaginary users")
                    .id("a2a28d81-f69c-45c4-abe1-3916cff5cc78")
                    .isActive(false)
                    .metadata(List.of())
                    .name("Electronic Cotton Shoes")
                    .updatedAt(OffsetDateTime.parse("2025-08-21T15:41:37.295Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingContactRequest req = PatchAccountingContactRequest.builder()
                .accountingContact(AccountingContact.builder()
                    .associatedContacts(List.of(
                        AccountingAssociatedContact.builder()
                            .id("21347f1f-8b04-46a6-a8fd-cba0530aa4c9")
                            .name("Delores Reynolds")
                            .build(),
                        AccountingAssociatedContact.builder()
                            .id("132cb54e-ff89-47b3-8d09-104c00b623c1")
                            .name("Delores Reynolds")
                            .build()))
                    .billingAddress(PropertyAccountingContactBillingAddress.builder()
                        .address1("2633 Stoney Lane")
                    ...
                    .emails(List.of(
                        AccountingEmail.builder()
                            ...
                            .build()))
                    .firstName("Delores")
                    .id("d086de4f-592d-49ab-97e6-b3ededc1c827")
                    .identification("amicitia")
                    .isActive(true)
                    .isCustomer(true)
                    .lastName("Reynolds")
                    ...
                    .paymentMethods(List.of(
                        AccountingContactPaymentMethod.builder()
                            .type(AccountingContactPaymentMethodType.CARD)
                            .default_(true)
                            .id("c082589a-6f8e-46d0-8ae7-805abf460901")
                            .name("Visa 1234")
                            .build()))
                    .portalUrl("https://scented-t-shirt.info/")
                    .shippingAddress(PropertyAccountingContactShippingAddress.builder()
                    ...
                    .telephones(List.of(
                        ...
                        AccountingTelephone.builder()
                            ...
                            .type(AccountingTelephoneType.FAX)
                            .build()))
                    .updatedAt(OffsetDateTime.parse("2023-12-05T20:41:53.519Z"))
                    .website("https://noxious-advertisement.org")
                    .build())
                .connectionId("<id>")
                .id("<id>")
        ...
        PatchAccountingInvoiceRequest req = PatchAccountingInvoiceRequest.builder()
                .accountingInvoice(AccountingInvoice.builder()
                    .attachments(List.of(
                        AccountingAttachment.builder()
                            .downloadUrl("https://glossy-markup.net/")
                            .id("45f7c589-4aac-4f82-9b40-16a14d18dc6b")
                            .mimeType("benevolentia")
                            .name("vespillo")
                            .build()))
                    .balanceAmount(-1d)
                    ...
                    .dueAt(OffsetDateTime.parse("2022-11-27T21:25:37.363Z"))
                    .extendedNotes(List.of())
                    .id("32d0cb2f-7405-4928-a1f9-f6135517b542")
                    .invoiceNumber("vinco")
                    .lineitems(List.of())
                    .metadata(List.of())
                    .notes("Auctus comburo clarus ubi.")
                    ...
                    .paymentCollectionMethod(AccountingInvoicePaymentCollectionMethod.SEND_INVOICE)
                    .payments(List.of())
                    .postedAt(OffsetDateTime.parse("2026-03-28T17:49:08.129Z"))
                    .reference("adinventitias")
                    .send(true)
                    .status(AccountingInvoiceStatus.DELETED)
                    .taxAmount(0d)
                    ...
                    .totalAmount(0d)
                    .type(AccountingInvoiceType.CREDITMEMO)
                    .updatedAt(OffsetDateTime.parse("2023-02-06T09:58:19.468Z"))
                    .url("https://gifted-yarmulke.info/")
                    .build())
                .connectionId("<id>")
                .id("<id>")
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingOrderRequest req = PatchAccountingOrderRequest.builder()
                .accountingOrder(AccountingOrder.builder()
                    ...
                    .createdAt(OffsetDateTime.parse("2020-11-20T03:46:49.837Z"))
                    .currency("USD")
                    .id("1c01e407-b480-4985-bb9f-ca4de63349b7")
                    .lineitems(List.of())
                    .metadata(List.of())
                    .postedAt(OffsetDateTime.parse("2022-04-05T11:48:24.028Z"))
                    .shippingAddress(PropertyAccountingOrderShippingAddress.builder()
                        .address1("9745 Betty Shore")
                        .city("South Alainaland")
                        .countryCode("US")
                    ...
                    .totalAmount(0d)
                    .type(AccountingOrderType.PURCHASE)
                    .updatedAt(OffsetDateTime.parse("2021-06-18T03:31:17.935Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingPaymenttermRequest req = PatchAccountingPaymenttermRequest.builder()
                .accountingPaymentterm(AccountingPaymentterm.builder()
                    ...
                    .dueDays(57d)
                    .dueNextMonthDays(9d)
                    .id("441c4bc5-b0db-4d6d-bdc0-9e10601dfa6f")
                    .isActive(false)
                    .metadata(List.of())
                    .name("Net 30")
                    .type(AccountingPaymenttermType.NET15)
                    .updatedAt(OffsetDateTime.parse("2025-12-13T04:48:27.561Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingPurchaseorderRequest req = PatchAccountingPurchaseorderRequest.builder()
                .accountingPurchaseorder(AccountingPurchaseorder.builder()
                    ...
                    .createdAt(OffsetDateTime.parse("2020-12-12T07:17:47.021Z"))
                    .currency("ZMW")
                    .id("f28cd074-860c-46fa-aadd-29d14ba95e18")
                    .lineitems(List.of())
                    .metadata(List.of())
                    .postedAt(OffsetDateTime.parse("2025-04-26T16:44:23.594Z"))
                    .shippingAddress(PropertyAccountingPurchaseorderShippingAddress.builder()
                        .address1("649 Maggio Overpass")
                        .city("Lake Jaylan")
                        .countryCode("US")
                    ...
                    .status(AccountingPurchaseorderStatus.PARTIALLY_REFUNDED)
                    .totalAmount(0d)
                    .updatedAt(OffsetDateTime.parse("2021-02-26T05:04:57.595Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingTransactionRequest req = PatchAccountingTransactionRequest.builder()
                .accountingTransaction(AccountingTransaction.builder()
                    .createdAt(OffsetDateTime.parse("2019-09-25T11:40:42.574Z"))
                    .id("b786fe87-000c-4e2c-b898-8af15e9325fd")
                    .lineitems(List.of(
                        AccountingTransactionLineItem.builder()
                            .categoryIds(List.of())
                            .description("The Nikolas Table is the latest in a series of downright products from Beier and Sons")
                            .id("a624e018-3610-4c0c-9dab-f576a961cadc")
                            .name("Salad")
                            .objectType("delicate")
                            .totalAmount(58531d)
                            .unitAmount(536d)
                    ...
                    .taxAmount(0d)
                    .totalAmount(94452d)
                    .updatedAt(OffsetDateTime.parse("2021-09-10T16:24:07.248Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchAccountingVendorcreditRequest req = PatchAccountingVendorcreditRequest.builder()
                .accountingVendorcredit(AccountingVendorcredit.builder()
                    ...
                    .currency("KGS")
                    .dueAt(OffsetDateTime.parse("2023-05-06T20:38:46.775Z"))
                    .id("26e278b7-d622-490a-8bba-f761f45758e7")
                    .lineitems(List.of())
                    .metadata(List.of())
                    .notes("Conatus cruciamentum decor avaritia tantum.")
                    .postedAt(OffsetDateTime.parse("2023-09-28T23:14:23.767Z"))
                    .status(AccountingVendorcreditStatus.SUBMITTED)
                    .totalAmount(0d)
                    .updatedAt(OffsetDateTime.parse("2023-11-26T23:25:17.703Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();

        PatchAccountingVendorcreditResponse res = sdk.accounting().patchAccountingVendorcredit()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        RemoveAccountingVendorcreditResponse res = sdk.accounting().removeAccountingVendorcredit()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        UpdateAccountingVendorcreditResponse res = sdk.accounting().updateAccountingVendorcredit()
                .request(req)
                .call();
