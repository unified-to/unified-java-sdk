    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateSigningDocumentRequest req = CreateSigningDocumentRequest.builder()
                .signingDocument(SigningDocument.builder()
                    ...
                    .expiresAt(OffsetDateTime.parse("2026-12-19T11:03:25.768Z"))
                    .id("b2f0411f-28da-4877-92cf-b9c6e682766e")
                    .name("nam audax absens")
                    .status(SigningDocumentStatus.VOIDED)
                    .updatedAt(OffsetDateTime.parse("2025-08-10T03:55:15.160Z"))
                    .build())
                .connectionId("<id>")
                .build();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchSigningDocumentRequest req = PatchSigningDocumentRequest.builder()
                .signingDocument(SigningDocument.builder()
                    .createdAt(OffsetDateTime.parse("2021-05-02T09:35:23.679Z"))
                    .expiresAt(OffsetDateTime.parse("2026-12-19T11:03:25.779Z"))
                    .id("5f467819-867a-49f2-8899-12411a9c144c")
                    .name("nam audax absens")
                    .status(SigningDocumentStatus.VOIDED)
                    .updatedAt(OffsetDateTime.parse("2025-08-10T03:55:15.168Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
