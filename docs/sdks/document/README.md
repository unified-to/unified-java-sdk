    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateSigningDocumentRequest req = CreateSigningDocumentRequest.builder()
                .signingDocument(SigningDocument.builder()
                    ...
                    .expiresAt(OffsetDateTime.parse("2026-12-17T10:04:01.177Z"))
                    .id("a33856b3-abc5-4f96-af57-04323af2f629")
                    .name("nam audax absens")
                    .status(SigningDocumentStatus.VOIDED)
                    .updatedAt(OffsetDateTime.parse("2025-08-08T13:03:38.230Z"))
                    .build())
                .connectionId("<id>")
                .build();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchSigningDocumentRequest req = PatchSigningDocumentRequest.builder()
                .signingDocument(SigningDocument.builder()
                    .createdAt(OffsetDateTime.parse("2021-05-02T09:35:23.679Z"))
                    .expiresAt(OffsetDateTime.parse("2026-12-17T10:04:01.189Z"))
                    .id("a5868fd1-f890-488c-b7d9-5f8aa4eddbf5")
                    .name("nam audax absens")
                    .status(SigningDocumentStatus.VOIDED)
                    .updatedAt(OffsetDateTime.parse("2025-08-08T13:03:38.239Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
