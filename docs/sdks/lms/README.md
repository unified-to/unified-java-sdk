    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateLmsActivityRequest req = CreateLmsActivityRequest.builder()
                .lmsActivity(LmsActivity.builder()
                    ...
                    .completedAt(OffsetDateTime.parse("2025-04-13T08:28:05.675Z"))
                    ...
                    .updatedAt(OffsetDateTime.parse("2022-01-24T02:51:09.394Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateLmsClassRequest req = CreateLmsClassRequest.builder()
                .lmsClass(LmsClass.builder()
                    ...
                    .name("virtus")
                    .students(List.of())
                    .updatedAt(OffsetDateTime.parse("2025-07-08T17:04:13.155Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateLmsContentRequest req = CreateLmsContentRequest.builder()
                .lmsContent(LmsContent.builder()
                    ...
                    .tags(List.of(
                        "dens"))
                    .updatedAt(OffsetDateTime.parse("2022-09-23T18:57:23.469Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateLmsCourseRequest req = CreateLmsCourseRequest.builder()
                .lmsCourse(LmsCourse.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2023-02-07T00:33:01.953Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateLmsInstructorRequest req = CreateLmsInstructorRequest.builder()
                .lmsInstructor(LmsInstructor.builder()
                    ...
                    .updatedAt(OffsetDateTime.parse("2025-06-30T08:01:08.663Z"))
                    .build())
                .connectionId("<id>")
                .build();
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchLmsActivityRequest req = PatchLmsActivityRequest.builder()
                .lmsActivity(LmsActivity.builder()
                    .assignedGrade("summopere")
                    .completedAt(OffsetDateTime.parse("2025-04-13T08:28:05.679Z"))
                    .createdAt(OffsetDateTime.parse("2020-10-17T01:25:21.745Z"))
                    .durationMinutes(55d)
                    ...
                    .progressPercentage(100d)
                    .startedAt(OffsetDateTime.parse("2023-12-24T04:54:05.825Z"))
                    .updatedAt(OffsetDateTime.parse("2022-01-24T02:51:09.396Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchLmsClassRequest req = PatchLmsClassRequest.builder()
                .lmsClass(LmsClass.builder()
                    ...
                    .name("virtus")
                    .students(List.of())
                    .updatedAt(OffsetDateTime.parse("2025-07-08T17:04:13.168Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchLmsContentRequest req = PatchLmsContentRequest.builder()
                .lmsContent(LmsContent.builder()
                    ...
                    .tags(List.of(
                        "dens"))
                    .updatedAt(OffsetDateTime.parse("2022-09-23T18:57:23.477Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchLmsCourseRequest req = PatchLmsCourseRequest.builder()
                .lmsCourse(LmsCourse.builder()
                    ...
                    .students(List.of())
                    .timeEstimateMinutes(100d)
                    .updatedAt(OffsetDateTime.parse("2023-02-07T00:33:01.954Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
                ...
                .lmsInstructor(LmsInstructor.builder()
                    ...
                    .telephones(List.of(
                        LmsTelephone.builder()
                            ...
                            .build()))
                    .title("Product Solutions Engineer")
                    .updatedAt(OffsetDateTime.parse("2025-06-30T08:01:08.669Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
