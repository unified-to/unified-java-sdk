    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateLmsCollectionRequest req = CreateLmsCollectionRequest.builder()
                .lmsCollection(LmsCollection.builder()
                    ...
                    .description("Ab.")
                    .id("1be2d5cb-dbc8-4386-88bf-094214b7d9d9")
                    .isActive(true)
                    .media(List.of(
                        LmsMedia.builder()
                            ...
                            .build()))
                    .name("ara")
                    .updatedAt(OffsetDateTime.parse("2026-06-30T07:36:07.720Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CreateLmsCourseRequest req = CreateLmsCourseRequest.builder()
                .lmsCourse(LmsCourse.builder()
                    ...
                    .id("cc636fb7-698c-4c16-8ea3-6c003a81679c")
                    .instructors(List.of())
                    .isActive(true)
                    .isPrivate(false)
                    .languages(List.of(
                    ...
                    .updatedAt(OffsetDateTime.parse("2023-02-07T02:43:14.885Z"))
                    .build())
                .connectionId("<id>")
                .build();
                ...
                .lmsInstructor(LmsInstructor.builder()
                    ...
                    .emails(List.of(
                        ...
                        LmsEmail.builder()
                            .build()))
                    .firstName("Deangelo")
                    .id("421aaebf-f9fc-4958-b62f-95957ccdd9cc")
                    ...
                    .updatedAt(OffsetDateTime.parse("2025-07-01T03:05:51.398Z"))
                    .build())
                .connectionId("<id>")
                .build();
                ...
                .lmsStudent(LmsStudent.builder()
                    ...
                    .emails(List.of(
                        ...
                        LmsEmail.builder()
                            .build()))
                    .firstName("Marcella")
                    .id("ab0752a8-ed38-4939-a933-1a258fb16b3f")
                    ...
                    .telephones(List.of(
                        LmsTelephone.builder()
                            ...
                            .build()))
                    .updatedAt(OffsetDateTime.parse("2022-06-20T06:54:02.171Z"))
                    .build())
                .connectionId("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchLmsCollectionRequest req = PatchLmsCollectionRequest.builder()
                .lmsCollection(LmsCollection.builder()
                    .createdAt(OffsetDateTime.parse("2019-08-19T14:40:29.227Z"))
                    .description("Ab.")
                    .id("1a2389f6-1db8-453a-bc24-9f13c4eedd4a")
                    .isActive(true)
                    .media(List.of(
                        LmsMedia.builder()
                            .content("Accusamus earum sulum libero adficio testimonium vitae. Calcar contra vergo curis sollers. Caste brevis denuo. Tam amita ducimus capillus. Vulgaris temporibus arbustum solium id. Suppono commodo fuga surculus tripudio doloribus.")
                            ...
                            .build()))
                    .name("ara")
                    .updatedAt(OffsetDateTime.parse("2026-06-30T07:36:07.728Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        ...
        PatchLmsCourseRequest req = PatchLmsCourseRequest.builder()
                .lmsCourse(LmsCourse.builder()
                    ...
                    .description("Vinco alias aut capitulus.")
                    .durationMinutes(148d)
                    .id("2078105f-8828-47bf-834b-90714be6519d")
                    .instructors(List.of())
                    .isActive(true)
                    .isPrivate(false)
                    .languages(List.of(
                    ...
                    .students(List.of())
                    .timeEstimateMinutes(100d)
                    .updatedAt(OffsetDateTime.parse("2023-02-07T02:43:14.887Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
                ...
                .lmsInstructor(LmsInstructor.builder()
                    ...
                    .emails(List.of(
                        ...
                        LmsEmail.builder()
                            .build()))
                    .firstName("Deangelo")
                    .id("b0cd4a2a-d9a7-4e2c-84c1-9b1286a2866a")
                    .imageUrl("https://avatars.githubusercontent.com/u/20232618")
                    .lastName("Ritchie")
                    .name("Deangelo Ritchie")
                    .telephones(List.of(
                        LmsTelephone.builder()
                            ...
                            .build()))
                    .title("Product Solutions Engineer")
                    .updatedAt(OffsetDateTime.parse("2025-07-01T03:05:51.406Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
                ...
                .lmsStudent(LmsStudent.builder()
                    ...
                    .emails(List.of(
                        ...
                        LmsEmail.builder()
                            .build()))
                    .firstName("Marcella")
                    .id("e9ac20e8-9f75-43f3-8b95-1ad03fff2be2")
                    .imageUrl("https://avatars.githubusercontent.com/u/36301374")
                    .lastName("Murazik")
                    .name("Marcella Murazik")
                    .telephones(List.of(
                        LmsTelephone.builder()
                            ...
                            .type(LmsTelephoneType.FAX)
                            .build()))
                    .updatedAt(OffsetDateTime.parse("2022-06-20T06:54:02.176Z"))
                    .build())
                .connectionId("<id>")
                .id("<id>")
                .build();
