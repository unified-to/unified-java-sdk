...
```java
import to.unified.unified_java_sdk.models.shared.WebhookObjectType;

WebhookObjectType value = WebhookObjectType.ACCOUNTING_ACCOUNT;

// Open enum: use .of() to create instances from custom string values
WebhookObjectType custom = WebhookObjectType.of("custom_value");
```
