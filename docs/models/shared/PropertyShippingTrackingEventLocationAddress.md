...
| `deliveryInstructions` | *Optional\<String>*    | :heavy_minus_sign:     | N/A                    |
| `email`                | *Optional\<String>*    | :heavy_minus_sign:     | N/A                    |
| `isResidential`        | *Optional\<Boolean>*   | :heavy_minus_sign:     | N/A                    |
| `isValidated`          | *Optional\<Boolean>*   | :heavy_minus_sign:     | N/A                    |
