...
```java
import to.unified.unified_java_sdk.models.operations.CreateAdsCreativeQueryParamFields;

CreateAdsCreativeQueryParamFields value = CreateAdsCreativeQueryParamFields.ID;
```
