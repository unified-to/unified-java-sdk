...
```java
import to.unified.unified_java_sdk.models.operations.GetAssessmentOrderQueryParamFields;

GetAssessmentOrderQueryParamFields value = GetAssessmentOrderQueryParamFields.ID;
```
