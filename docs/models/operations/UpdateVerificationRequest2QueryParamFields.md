...
```java
import to.unified.unified_java_sdk.models.operations.UpdateVerificationRequest2QueryParamFields;

UpdateVerificationRequest2QueryParamFields value = UpdateVerificationRequest2QueryParamFields.ID;
```
