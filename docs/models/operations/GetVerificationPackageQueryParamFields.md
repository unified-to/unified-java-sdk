...
```java
import to.unified.unified_java_sdk.models.operations.GetVerificationPackageQueryParamFields;

GetVerificationPackageQueryParamFields value = GetVerificationPackageQueryParamFields.ID;
```
