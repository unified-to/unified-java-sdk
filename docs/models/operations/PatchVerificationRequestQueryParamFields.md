...
```java
import to.unified.unified_java_sdk.models.operations.PatchVerificationRequestQueryParamFields;

PatchVerificationRequestQueryParamFields value = PatchVerificationRequestQueryParamFields.ID;
```
