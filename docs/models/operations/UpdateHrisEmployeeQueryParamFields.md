...
```java
import to.unified.unified_java_sdk.models.operations.UpdateHrisEmployeeQueryParamFields;

UpdateHrisEmployeeQueryParamFields value = UpdateHrisEmployeeQueryParamFields.ID;
```
