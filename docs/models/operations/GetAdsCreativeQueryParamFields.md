...
```java
import to.unified.unified_java_sdk.models.operations.GetAdsCreativeQueryParamFields;

GetAdsCreativeQueryParamFields value = GetAdsCreativeQueryParamFields.ID;
```
