...
```java
import to.unified.unified_java_sdk.models.operations.UpdateAssessmentOrder2QueryParamFields;

UpdateAssessmentOrder2QueryParamFields value = UpdateAssessmentOrder2QueryParamFields.ID;
```
