...
```java
import to.unified.unified_java_sdk.models.operations.UpdateAdsGroup2QueryParamFields;

UpdateAdsGroup2QueryParamFields value = UpdateAdsGroup2QueryParamFields.ID;
```
