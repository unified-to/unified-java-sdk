...
```java
import to.unified.unified_java_sdk.models.operations.PatchAssessmentOrder2QueryParamFields;

PatchAssessmentOrder2QueryParamFields value = PatchAssessmentOrder2QueryParamFields.ID;
```
