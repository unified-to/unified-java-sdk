...
```java
import to.unified.unified_java_sdk.models.operations.PatchAdsCampaignQueryParamFields;

PatchAdsCampaignQueryParamFields value = PatchAdsCampaignQueryParamFields.ID;
```
