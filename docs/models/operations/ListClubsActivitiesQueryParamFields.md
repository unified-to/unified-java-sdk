...
```java
import to.unified.unified_java_sdk.models.operations.ListClubsActivitiesQueryParamFields;

ListClubsActivitiesQueryParamFields value = ListClubsActivitiesQueryParamFields.ID;
```
