...
```java
import to.unified.unified_java_sdk.models.operations.ListAccountingProfitlosses2QueryParamFields;

ListAccountingProfitlosses2QueryParamFields value = ListAccountingProfitlosses2QueryParamFields.ID;
```
