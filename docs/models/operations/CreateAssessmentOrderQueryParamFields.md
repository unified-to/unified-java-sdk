...
```java
import to.unified.unified_java_sdk.models.operations.CreateAssessmentOrderQueryParamFields;

CreateAssessmentOrderQueryParamFields value = CreateAssessmentOrderQueryParamFields.ID;
```
