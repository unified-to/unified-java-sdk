...
```java
import to.unified.unified_java_sdk.models.operations.UpdateAdsCreative2QueryParamFields;

UpdateAdsCreative2QueryParamFields value = UpdateAdsCreative2QueryParamFields.ID;
```
