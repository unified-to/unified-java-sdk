...
```java
import to.unified.unified_java_sdk.models.operations.GetAccountingCashflowQueryParamFields;

GetAccountingCashflowQueryParamFields value = GetAccountingCashflowQueryParamFields.ID;
```
