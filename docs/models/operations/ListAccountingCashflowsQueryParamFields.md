...
```java
import to.unified.unified_java_sdk.models.operations.ListAccountingCashflowsQueryParamFields;

ListAccountingCashflowsQueryParamFields value = ListAccountingCashflowsQueryParamFields.ID;
```
