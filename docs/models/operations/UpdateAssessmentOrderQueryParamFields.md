...
```java
import to.unified.unified_java_sdk.models.operations.UpdateAssessmentOrderQueryParamFields;

UpdateAssessmentOrderQueryParamFields value = UpdateAssessmentOrderQueryParamFields.ID;
```
