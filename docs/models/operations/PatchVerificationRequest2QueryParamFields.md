...
```java
import to.unified.unified_java_sdk.models.operations.PatchVerificationRequest2QueryParamFields;

PatchVerificationRequest2QueryParamFields value = PatchVerificationRequest2QueryParamFields.ID;
```
