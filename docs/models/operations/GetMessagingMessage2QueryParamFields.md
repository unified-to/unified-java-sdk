...
```java
import to.unified.unified_java_sdk.models.operations.GetMessagingMessage2QueryParamFields;

GetMessagingMessage2QueryParamFields value = GetMessagingMessage2QueryParamFields.ID;
```
