...
```java
import to.unified.unified_java_sdk.models.operations.ListMartechReports2QueryParamFields;

ListMartechReports2QueryParamFields value = ListMartechReports2QueryParamFields.ID;
```
