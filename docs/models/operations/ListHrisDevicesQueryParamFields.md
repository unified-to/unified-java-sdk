...
```java
import to.unified.unified_java_sdk.models.operations.ListHrisDevicesQueryParamFields;

ListHrisDevicesQueryParamFields value = ListHrisDevicesQueryParamFields.ID;
```
