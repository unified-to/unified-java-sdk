...
```java
import to.unified.unified_java_sdk.models.operations.PatchAdsCreativeQueryParamFields;

PatchAdsCreativeQueryParamFields value = PatchAdsCreativeQueryParamFields.ID;
```
