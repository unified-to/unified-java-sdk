...
```java
import to.unified.unified_java_sdk.models.operations.CreateAdsCampaignQueryParamFields;

CreateAdsCampaignQueryParamFields value = CreateAdsCampaignQueryParamFields.ID;
```
