...
```java
import to.unified.unified_java_sdk.models.operations.GetAccountingProfitloss2QueryParamFields;

GetAccountingProfitloss2QueryParamFields value = GetAccountingProfitloss2QueryParamFields.ID;
```
