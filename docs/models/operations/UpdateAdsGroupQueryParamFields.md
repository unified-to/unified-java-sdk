...
```java
import to.unified.unified_java_sdk.models.operations.UpdateAdsGroupQueryParamFields;

UpdateAdsGroupQueryParamFields value = UpdateAdsGroupQueryParamFields.ID;
```
