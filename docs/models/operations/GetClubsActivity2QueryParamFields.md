...
```java
import to.unified.unified_java_sdk.models.operations.GetClubsActivity2QueryParamFields;

GetClubsActivity2QueryParamFields value = GetClubsActivity2QueryParamFields.ID;
```
