...
```java
import to.unified.unified_java_sdk.models.operations.CreateVerificationRequest2QueryParamFields;

CreateVerificationRequest2QueryParamFields value = CreateVerificationRequest2QueryParamFields.ID;
```
