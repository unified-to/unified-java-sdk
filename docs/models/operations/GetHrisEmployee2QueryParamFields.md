...
```java
import to.unified.unified_java_sdk.models.operations.GetHrisEmployee2QueryParamFields;

GetHrisEmployee2QueryParamFields value = GetHrisEmployee2QueryParamFields.ID;
```
