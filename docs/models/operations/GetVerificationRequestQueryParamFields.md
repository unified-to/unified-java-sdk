...
```java
import to.unified.unified_java_sdk.models.operations.GetVerificationRequestQueryParamFields;

GetVerificationRequestQueryParamFields value = GetVerificationRequestQueryParamFields.ID;
```
