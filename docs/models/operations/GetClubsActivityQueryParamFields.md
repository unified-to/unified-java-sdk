...
```java
import to.unified.unified_java_sdk.models.operations.GetClubsActivityQueryParamFields;

GetClubsActivityQueryParamFields value = GetClubsActivityQueryParamFields.ID;
```
