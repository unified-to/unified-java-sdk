...
```java
import to.unified.unified_java_sdk.models.operations.PatchHrisDeviceQueryParamFields;

PatchHrisDeviceQueryParamFields value = PatchHrisDeviceQueryParamFields.ID;
```
