...
```java
import to.unified.unified_java_sdk.models.operations.PatchAccountingProjectQueryParamFields;

PatchAccountingProjectQueryParamFields value = PatchAccountingProjectQueryParamFields.ID;
```
