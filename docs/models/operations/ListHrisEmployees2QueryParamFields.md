...
```java
import to.unified.unified_java_sdk.models.operations.ListHrisEmployees2QueryParamFields;

ListHrisEmployees2QueryParamFields value = ListHrisEmployees2QueryParamFields.ID;
```
