...
```java
import to.unified.unified_java_sdk.models.operations.CreateHrisEmployee2QueryParamFields;

CreateHrisEmployee2QueryParamFields value = CreateHrisEmployee2QueryParamFields.ID;
```
