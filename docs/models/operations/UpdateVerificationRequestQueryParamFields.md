...
```java
import to.unified.unified_java_sdk.models.operations.UpdateVerificationRequestQueryParamFields;

UpdateVerificationRequestQueryParamFields value = UpdateVerificationRequestQueryParamFields.ID;
```
