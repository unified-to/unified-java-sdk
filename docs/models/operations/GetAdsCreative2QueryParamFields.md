...
```java
import to.unified.unified_java_sdk.models.operations.GetAdsCreative2QueryParamFields;

GetAdsCreative2QueryParamFields value = GetAdsCreative2QueryParamFields.ID;
```
