...
```java
import to.unified.unified_java_sdk.models.operations.GetVerificationRequest2QueryParamFields;

GetVerificationRequest2QueryParamFields value = GetVerificationRequest2QueryParamFields.ID;
```
