...
```java
import to.unified.unified_java_sdk.models.operations.ListHrisEmployeesQueryParamFields;

ListHrisEmployeesQueryParamFields value = ListHrisEmployeesQueryParamFields.ID;
```
