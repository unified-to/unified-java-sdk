...
```java
import to.unified.unified_java_sdk.models.operations.CreateAdsCreative2QueryParamFields;

CreateAdsCreative2QueryParamFields value = CreateAdsCreative2QueryParamFields.ID;
```
