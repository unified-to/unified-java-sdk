...
```java
import to.unified.unified_java_sdk.models.operations.PatchHrisEmployeeQueryParamFields;

PatchHrisEmployeeQueryParamFields value = PatchHrisEmployeeQueryParamFields.ID;
```
