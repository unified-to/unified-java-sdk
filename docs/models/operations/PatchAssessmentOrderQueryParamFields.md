...
```java
import to.unified.unified_java_sdk.models.operations.PatchAssessmentOrderQueryParamFields;

PatchAssessmentOrderQueryParamFields value = PatchAssessmentOrderQueryParamFields.ID;
```
