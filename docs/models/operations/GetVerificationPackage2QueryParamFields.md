...
```java
import to.unified.unified_java_sdk.models.operations.GetVerificationPackage2QueryParamFields;

GetVerificationPackage2QueryParamFields value = GetVerificationPackage2QueryParamFields.ID;
```
