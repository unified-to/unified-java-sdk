...
```java
import to.unified.unified_java_sdk.models.operations.ListAccountingCashflows2QueryParamFields;

ListAccountingCashflows2QueryParamFields value = ListAccountingCashflows2QueryParamFields.ID;
```
