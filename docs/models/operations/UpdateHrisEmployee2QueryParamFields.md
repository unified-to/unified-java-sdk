...
```java
import to.unified.unified_java_sdk.models.operations.UpdateHrisEmployee2QueryParamFields;

UpdateHrisEmployee2QueryParamFields value = UpdateHrisEmployee2QueryParamFields.ID;
```
