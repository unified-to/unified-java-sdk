...
```java
import to.unified.unified_java_sdk.models.operations.ListClubsActivities2QueryParamFields;

ListClubsActivities2QueryParamFields value = ListClubsActivities2QueryParamFields.ID;
```
