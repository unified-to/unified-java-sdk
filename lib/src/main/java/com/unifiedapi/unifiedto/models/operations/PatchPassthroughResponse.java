...
public class PatchPassthroughResponse {
    ...
    public PatchPassthroughResponse withUndefined(com.unifiedapi.unifiedto.models.shared.Undefined undefined) {
        this.undefined = undefined;
        return this;
    }
    
    public PatchPassthroughResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
