...
public class PatchStorageFileRequest {
    ...
    public PatchStorageFileRequest withStorageFile(com.unifiedapi.unifiedto.models.shared.StorageFile storageFile) {
    ...
    public PatchStorageFileRequest(@JsonProperty("connection_id") String connectionId, @JsonProperty("id") String id) {
        this.connectionId = connectionId;
        this.id = id;
  }
}
