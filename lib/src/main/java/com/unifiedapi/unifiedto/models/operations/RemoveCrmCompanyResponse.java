...
public class RemoveCrmCompanyResponse {
    ...
    public RemoveCrmCompanyResponse withString(String string) {
        this.string = string;
        return this;
    }
    
    public RemoveCrmCompanyResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode, @JsonProperty("RawResponse") HttpResponse<byte[]> rawResponse) {
        this.contentType = contentType;
        this.statusCode = statusCode;
        this.rawResponse = rawResponse;
  }
