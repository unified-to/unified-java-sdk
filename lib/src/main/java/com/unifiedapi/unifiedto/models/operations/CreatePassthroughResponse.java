...
public class CreatePassthroughResponse {
    ...
    public CreatePassthroughResponse withUndefined(com.unifiedapi.unifiedto.models.shared.Undefined undefined) {
        this.undefined = undefined;
        return this;
    }
    
    public CreatePassthroughResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
