...
public class UpdateAtsActivityRequest {
    ...
    public UpdateAtsActivityRequest withAtsActivity(com.unifiedapi.unifiedto.models.shared.AtsActivity atsActivity) {
    ...
    public UpdateAtsActivityRequest(@JsonProperty("connection_id") String connectionId, @JsonProperty("id") String id) {
        this.connectionId = connectionId;
        this.id = id;
  }
}
