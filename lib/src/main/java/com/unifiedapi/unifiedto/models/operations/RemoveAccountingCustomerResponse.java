...
public class RemoveAccountingCustomerResponse {
    ...
    public RemoveAccountingCustomerResponse withRes(String res) {
        this.res = res;
        return this;
    }
    
    public RemoveAccountingCustomerResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode, @JsonProperty("RawResponse") HttpResponse<byte[]> rawResponse) {
        this.contentType = contentType;
        this.statusCode = statusCode;
        this.rawResponse = rawResponse;
  }
