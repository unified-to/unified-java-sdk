...
public class Hris {
    ...
    public com.unifiedapi.unifiedto.models.operations.CreateHrisEmployeeResponse createHrisEmployee(com.unifiedapi.unifiedto.models.operations.CreateHrisEmployeeRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = com.unifiedapi.unifiedto.utils.Utils.getQueryParams(com.unifiedapi.unifiedto.models.operations.CreateHrisEmployeeRequest.class, request, null);
        if (queryParams != null) {
    ...
    public com.unifiedapi.unifiedto.models.operations.PatchHrisEmployeeResponse patchHrisEmployee(com.unifiedapi.unifiedto.models.operations.PatchHrisEmployeeRequest request) throws Exception {
        ...
        req.addHeader("Accept", "application/json");
        req.addHeader("user-agent", this.sdkConfiguration.userAgent);
        java.util.List<NameValuePair> queryParams = com.unifiedapi.unifiedto.utils.Utils.getQueryParams(com.unifiedapi.unifiedto.models.operations.PatchHrisEmployeeRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
    ...
    public com.unifiedapi.unifiedto.models.operations.UpdateHrisEmployeeResponse updateHrisEmployee(com.unifiedapi.unifiedto.models.operations.UpdateHrisEmployeeRequest request) throws Exception {
        ...
        req.addHeader("Accept", "application/json");
        req.addHeader("user-agent", this.sdkConfiguration.userAgent);
        java.util.List<NameValuePair> queryParams = com.unifiedapi.unifiedto.utils.Utils.getQueryParams(com.unifiedapi.unifiedto.models.operations.UpdateHrisEmployeeRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
