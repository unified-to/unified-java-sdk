...
public class PatchCommerceMetadataResponse implements Response {
    ...
    @JsonCreator
    public PatchCommerceMetadataResponse(
     ...
     * Successful
     */
    public PatchCommerceMetadataResponse withCommerceMetadata(CommerceMetadata commerceMetadata) {
        Utils.checkNotNull(commerceMetadata, "commerceMetadata");
     ...
     * Successful
     */
    public PatchCommerceMetadataResponse withCommerceMetadata(Optional<? extends CommerceMetadata> commerceMetadata) {
        Utils.checkNotNull(commerceMetadata, "commerceMetadata");
        this.commerceMetadata = commerceMetadata;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public PatchCommerceMetadataResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PatchCommerceMetadataResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PatchCommerceMetadataResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PatchCommerceMetadataResponse other = (PatchCommerceMetadataResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PatchCommerceMetadataResponse.class,
    ...
    public final static class Builder {
        ...
        public PatchCommerceMetadataResponse build() {
            return new PatchCommerceMetadataResponse(
                commerceMetadata,
                contentType,
                statusCode,
                rawResponse);
