...
public class GetCommerceMetadataResponse implements Response {
    ...
    @JsonCreator
    public GetCommerceMetadataResponse(
     ...
     * Successful
     */
    public GetCommerceMetadataResponse withCommerceMetadata(CommerceMetadata commerceMetadata) {
        Utils.checkNotNull(commerceMetadata, "commerceMetadata");
     ...
     * Successful
     */
    public GetCommerceMetadataResponse withCommerceMetadata(Optional<? extends CommerceMetadata> commerceMetadata) {
        Utils.checkNotNull(commerceMetadata, "commerceMetadata");
        this.commerceMetadata = commerceMetadata;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public GetCommerceMetadataResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetCommerceMetadataResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetCommerceMetadataResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCommerceMetadataResponse other = (GetCommerceMetadataResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCommerceMetadataResponse.class,
    ...
    public final static class Builder {
        ...
        public GetCommerceMetadataResponse build() {
            return new GetCommerceMetadataResponse(
                commerceMetadata,
                contentType,
                statusCode,
                rawResponse);
