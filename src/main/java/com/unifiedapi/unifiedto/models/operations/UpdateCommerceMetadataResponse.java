...
public class UpdateCommerceMetadataResponse implements Response {
    ...
    @JsonCreator
    public UpdateCommerceMetadataResponse(
     ...
     * Successful
     */
    public UpdateCommerceMetadataResponse withCommerceMetadata(CommerceMetadata commerceMetadata) {
        Utils.checkNotNull(commerceMetadata, "commerceMetadata");
     ...
     * Successful
     */
    public UpdateCommerceMetadataResponse withCommerceMetadata(Optional<? extends CommerceMetadata> commerceMetadata) {
        Utils.checkNotNull(commerceMetadata, "commerceMetadata");
        this.commerceMetadata = commerceMetadata;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public UpdateCommerceMetadataResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public UpdateCommerceMetadataResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateCommerceMetadataResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateCommerceMetadataResponse other = (UpdateCommerceMetadataResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateCommerceMetadataResponse.class,
    ...
    public final static class Builder {
        ...
        public UpdateCommerceMetadataResponse build() {
            return new UpdateCommerceMetadataResponse(
                commerceMetadata,
                contentType,
                statusCode,
                rawResponse);
