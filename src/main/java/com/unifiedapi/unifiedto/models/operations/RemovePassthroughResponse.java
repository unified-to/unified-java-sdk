...
public class RemovePassthroughResponse implements Response {
     ...
     * Successful
     */
    public RemovePassthroughResponse withResult(Map<String, Object> result) {
        Utils.checkNotNull(result, "result");
     ...
     * Successful
     */
    public RemovePassthroughResponse withResult(Optional<? extends Map<String, Object>> result) {
        Utils.checkNotNull(result, "result");
        this.result = result;
        return this;
    }
