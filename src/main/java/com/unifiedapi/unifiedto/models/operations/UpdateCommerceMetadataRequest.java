...
public class UpdateCommerceMetadataRequest {
    ...
    @JsonCreator
    public UpdateCommerceMetadataRequest(
    ...
    public UpdateCommerceMetadataRequest withCommerceMetadata(CommerceMetadata commerceMetadata) {
        Utils.checkNotNull(commerceMetadata, "commerceMetadata");
        this.commerceMetadata = Optional.ofNullable(commerceMetadata);
        return this;
    }

    public UpdateCommerceMetadataRequest withCommerceMetadata(Optional<? extends CommerceMetadata> commerceMetadata) {
        Utils.checkNotNull(commerceMetadata, "commerceMetadata");
        this.commerceMetadata = commerceMetadata;
        return this;
    }
     ...
     * ID of the connection
     */
    public UpdateCommerceMetadataRequest withConnectionId(String connectionId) {
        Utils.checkNotNull(connectionId, "connectionId");
        this.connectionId = connectionId;
        return this;
    }
     ...
     * Comma-delimited fields to return
     */
    public UpdateCommerceMetadataRequest withFields(List<String> fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * Comma-delimited fields to return
     */
    public UpdateCommerceMetadataRequest withFields(Optional<? extends List<String>> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * ID of the Metadata
     */
    public UpdateCommerceMetadataRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateCommerceMetadataRequest other = (UpdateCommerceMetadataRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateCommerceMetadataRequest.class,
    ...
    public final static class Builder {
        ...
        public UpdateCommerceMetadataRequest build() {
            return new UpdateCommerceMetadataRequest(
                commerceMetadata,
                connectionId,
                fields,
                id);
