...
public class PatchCommerceMetadataRequest {
    ...
    @JsonCreator
    public PatchCommerceMetadataRequest(
    ...
    public PatchCommerceMetadataRequest withCommerceMetadata(CommerceMetadata commerceMetadata) {
        Utils.checkNotNull(commerceMetadata, "commerceMetadata");
        this.commerceMetadata = Optional.ofNullable(commerceMetadata);
        return this;
    }

    public PatchCommerceMetadataRequest withCommerceMetadata(Optional<? extends CommerceMetadata> commerceMetadata) {
        Utils.checkNotNull(commerceMetadata, "commerceMetadata");
        this.commerceMetadata = commerceMetadata;
        return this;
    }
     ...
     * ID of the connection
     */
    public PatchCommerceMetadataRequest withConnectionId(String connectionId) {
        Utils.checkNotNull(connectionId, "connectionId");
        this.connectionId = connectionId;
        return this;
    }
     ...
     * Comma-delimited fields to return
     */
    public PatchCommerceMetadataRequest withFields(List<String> fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * Comma-delimited fields to return
     */
    public PatchCommerceMetadataRequest withFields(Optional<? extends List<String>> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * ID of the Metadata
     */
    public PatchCommerceMetadataRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PatchCommerceMetadataRequest other = (PatchCommerceMetadataRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PatchCommerceMetadataRequest.class,
    ...
    public final static class Builder {
        ...
        public PatchCommerceMetadataRequest build() {
            return new PatchCommerceMetadataRequest(
                commerceMetadata,
                connectionId,
                fields,
                id);
