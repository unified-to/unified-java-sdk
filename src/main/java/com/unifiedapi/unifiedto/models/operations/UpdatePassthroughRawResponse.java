...
public class UpdatePassthroughRawResponse implements Response {
     ...
     * Successful
     */
    public UpdatePassthroughRawResponse withTwoXXApplicationJsonAny(Object twoXXApplicationJsonAny) {
        Utils.checkNotNull(twoXXApplicationJsonAny, "twoXXApplicationJsonAny");
     ...
     * Successful
     */
    public UpdatePassthroughRawResponse withTwoXXApplicationJsonAny(Optional<? extends Object> twoXXApplicationJsonAny) {
        Utils.checkNotNull(twoXXApplicationJsonAny, "twoXXApplicationJsonAny");
        this.twoXXApplicationJsonAny = twoXXApplicationJsonAny;
        return this;
    }
     ...
     * Successful
     */
    public UpdatePassthroughRawResponse withTwoXXTextPlainRes(String twoXXTextPlainRes) {
        Utils.checkNotNull(twoXXTextPlainRes, "twoXXTextPlainRes");
     ...
     * Successful
     */
    public UpdatePassthroughRawResponse withTwoXXTextPlainRes(Optional<String> twoXXTextPlainRes) {
        Utils.checkNotNull(twoXXTextPlainRes, "twoXXTextPlainRes");
        this.twoXXTextPlainRes = twoXXTextPlainRes;
        return this;
    }

    public UpdatePassthroughRawResponse withBody(byte[] body) {
        Utils.checkNotNull(body, "body");
        this.body = Optional.ofNullable(body);
        return this;
    }

    public UpdatePassthroughRawResponse withBody(Optional<? extends byte[]> body) {
        Utils.checkNotNull(body, "body");
        this.body = body;
        return this;
    }
