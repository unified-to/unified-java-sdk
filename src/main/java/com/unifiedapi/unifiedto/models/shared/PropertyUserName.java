...
public class PropertyUserName {
    ...
    public PropertyUserName withFamilyName(String familyName) {
        Utils.checkNotNull(familyName, "familyName");
        this.familyName = Optional.ofNullable(familyName);
        return this;
    }

    public PropertyUserName withFamilyName(Optional<String> familyName) {
        Utils.checkNotNull(familyName, "familyName");
        this.familyName = familyName;
        return this;
    }

    public PropertyUserName withFormatted(String formatted) {
        Utils.checkNotNull(formatted, "formatted");
        this.formatted = Optional.ofNullable(formatted);
        return this;
    }

    public PropertyUserName withFormatted(Optional<String> formatted) {
        Utils.checkNotNull(formatted, "formatted");
        this.formatted = formatted;
        return this;
    }

    public PropertyUserName withGivenName(String givenName) {
        Utils.checkNotNull(givenName, "givenName");
        this.givenName = Optional.ofNullable(givenName);
        return this;
    }

    public PropertyUserName withGivenName(Optional<String> givenName) {
        Utils.checkNotNull(givenName, "givenName");
        this.givenName = givenName;
        return this;
    }

    public PropertyUserName withHonorificPrefix(String honorificPrefix) {
        Utils.checkNotNull(honorificPrefix, "honorificPrefix");
        this.honorificPrefix = Optional.ofNullable(honorificPrefix);
        return this;
    }

    public PropertyUserName withHonorificPrefix(Optional<String> honorificPrefix) {
        Utils.checkNotNull(honorificPrefix, "honorificPrefix");
        this.honorificPrefix = honorificPrefix;
        return this;
    }

    public PropertyUserName withHonorificSuffix(String honorificSuffix) {
        Utils.checkNotNull(honorificSuffix, "honorificSuffix");
        this.honorificSuffix = Optional.ofNullable(honorificSuffix);
        return this;
    }

    public PropertyUserName withHonorificSuffix(Optional<String> honorificSuffix) {
        Utils.checkNotNull(honorificSuffix, "honorificSuffix");
        this.honorificSuffix = honorificSuffix;
        return this;
    }

    public PropertyUserName withMiddleName(String middleName) {
        Utils.checkNotNull(middleName, "middleName");
        this.middleName = Optional.ofNullable(middleName);
        return this;
    }

    public PropertyUserName withMiddleName(Optional<String> middleName) {
        Utils.checkNotNull(middleName, "middleName");
        this.middleName = middleName;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PropertyUserName other = (PropertyUserName) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PropertyUserName.class,
    ...
    public final static class Builder {
        ...
        public PropertyUserName build() {
            return new PropertyUserName(
                familyName,
                formatted,
                givenName,
                honorificPrefix,
