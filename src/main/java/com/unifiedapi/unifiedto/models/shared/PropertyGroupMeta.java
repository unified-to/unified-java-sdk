...
public class PropertyGroupMeta {
    ...
    public PropertyGroupMeta withCreated(String created) {
        Utils.checkNotNull(created, "created");
        this.created = Optional.ofNullable(created);
        return this;
    }

    public PropertyGroupMeta withCreated(Optional<String> created) {
        Utils.checkNotNull(created, "created");
        this.created = created;
        return this;
    }

    public PropertyGroupMeta withLastModified(String lastModified) {
        Utils.checkNotNull(lastModified, "lastModified");
        this.lastModified = Optional.ofNullable(lastModified);
        return this;
    }

    public PropertyGroupMeta withLastModified(Optional<String> lastModified) {
        Utils.checkNotNull(lastModified, "lastModified");
        this.lastModified = lastModified;
        return this;
    }

    public PropertyGroupMeta withLocation(String location) {
        Utils.checkNotNull(location, "location");
        this.location = Optional.ofNullable(location);
        return this;
    }

    public PropertyGroupMeta withLocation(Optional<String> location) {
        Utils.checkNotNull(location, "location");
        this.location = location;
        return this;
    }

    public PropertyGroupMeta withResourceType(ResourceType resourceType) {
        Utils.checkNotNull(resourceType, "resourceType");
        this.resourceType = Optional.ofNullable(resourceType);
        return this;
    }

    public PropertyGroupMeta withResourceType(Optional<? extends ResourceType> resourceType) {
        Utils.checkNotNull(resourceType, "resourceType");
        this.resourceType = resourceType;
        return this;
    }

    public PropertyGroupMeta withVersion(String version) {
        Utils.checkNotNull(version, "version");
        this.version = Optional.ofNullable(version);
        return this;
    }

    public PropertyGroupMeta withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PropertyGroupMeta other = (PropertyGroupMeta) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PropertyGroupMeta.class,
                "created", created,
    ...
    public final static class Builder {
        ...
        public PropertyGroupMeta build() {
            return new PropertyGroupMeta(
                created,
                lastModified,
                location,
                resourceType,
