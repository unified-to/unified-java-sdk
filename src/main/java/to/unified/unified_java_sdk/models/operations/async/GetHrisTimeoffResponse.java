...
public class GetHrisTimeoffResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public GetHrisTimeoffResponse withContentType(@Nonnull String contentType) {
     ...
     * Successful
     */
    public GetHrisTimeoffResponse withHrisTimeoff(@Nullable HrisTimeoff hrisTimeoff) {
        this.hrisTimeoff = hrisTimeoff;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetHrisTimeoffResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
