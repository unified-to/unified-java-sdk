...
public class ListAccountingProfitlosses2Request {
    ...
    private List<ListAccountingProfitlosses2QueryParamFields> fields;
    ...
    @JsonCreator
    public ListAccountingProfitlosses2Request(
            @Nullable String categoryId,
            @Nonnull String connectionId,
            @Nullable String contactId,
            @Nullable String endLt,
            @Nullable List<ListAccountingProfitlosses2QueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListAccountingProfitlosses2QueryParamFields>> fields() {
     ...
     * The category ID to filter by (reference to AccountingCategory)
     */
    public ListAccountingProfitlosses2Request withCategoryId(@Nullable String categoryId) {
        this.categoryId = categoryId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListAccountingProfitlosses2Request withConnectionId(@Nonnull String connectionId) {
     ...
     * The contact ID to filter by (reference to AccountingContact)
     */
    public ListAccountingProfitlosses2Request withContactId(@Nullable String contactId) {
        this.contactId = contactId;
        return this;
    }
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAccountingProfitlosses2Request withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListAccountingProfitlosses2Request withFields(@Nullable List<ListAccountingProfitlosses2QueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListAccountingProfitlosses2Request withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListAccountingProfitlosses2Request withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListAccountingProfitlosses2Request withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListAccountingProfitlosses2Request withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAccountingProfitlosses2Request withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListAccountingProfitlosses2Request withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAccountingProfitlosses2Request withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAccountingProfitlosses2Request withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAccountingProfitlosses2Request other = (ListAccountingProfitlosses2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListAccountingProfitlosses2Request.class,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListAccountingProfitlosses2QueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListAccountingProfitlosses2Request build() {
            return new ListAccountingProfitlosses2Request(
                categoryId, connectionId, contactId,
                endLt, fields, limit,
                offset, order, query,
                raw, sort, startGte,
