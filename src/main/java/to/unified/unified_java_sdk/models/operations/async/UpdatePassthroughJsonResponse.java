...
public class UpdatePassthroughJsonResponse implements AsyncResponse {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdatePassthroughJsonResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
     ...
     * Successful
     */
    public UpdatePassthroughJsonResponse withDefaultWildcardWildcardResponseStream(@Nullable Blob defaultWildcardWildcardResponseStream) {
        this.defaultWildcardWildcardResponseStream = defaultWildcardWildcardResponseStream;
        return this;
    }
