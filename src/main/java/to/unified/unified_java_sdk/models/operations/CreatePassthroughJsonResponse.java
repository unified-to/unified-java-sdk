...
public class CreatePassthroughJsonResponse implements Response {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreatePassthroughJsonResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Successful
     */
    public CreatePassthroughJsonResponse withDefaultWildcardWildcardResponseStream(@Nullable InputStream defaultWildcardWildcardResponseStream) {
        this.defaultWildcardWildcardResponseStream = defaultWildcardWildcardResponseStream;
        return this;
    }
