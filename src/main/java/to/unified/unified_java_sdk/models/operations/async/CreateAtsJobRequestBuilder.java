...
public class CreateAtsJobRequestBuilder {
    ...
    public CreateAtsJobRequestBuilder request(@Nonnull CreateAtsJobRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CreateAtsJobRequest _buildRequest() {
        return this.request;
    }
    
    public CreateAtsJobRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<CreateAtsJobResponse> call() {
