...
public class CreateRepoOrganizationRequestBuilder {
    ...
    public CreateRepoOrganizationRequestBuilder request(@Nonnull CreateRepoOrganizationRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CreateRepoOrganizationRequest _buildRequest() {
        return this.request;
    }
    
    public CreateRepoOrganizationRequestBuilder header(String name, String value) {
