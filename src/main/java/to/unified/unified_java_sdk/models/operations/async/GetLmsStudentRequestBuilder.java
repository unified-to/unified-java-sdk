...
public class GetLmsStudentRequestBuilder {
    ...
    public GetLmsStudentRequestBuilder request(@Nonnull GetLmsStudentRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetLmsStudentRequest _buildRequest() {
        return this.request;
    }
    
    public GetLmsStudentRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetLmsStudentResponse> call() {
