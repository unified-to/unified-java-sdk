...
public class ListAccountingReportsRequest {
    ...
    private List<ListAccountingReportsQueryParamFields> fields;
    ...
    public ListAccountingReportsRequest(
            ...
            @Nullable List<ListAccountingReportsQueryParamFields> fields,
     ...
     * ID of the connection
     */
    public ListAccountingReportsRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAccountingReportsRequest withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListAccountingReportsRequest withFields(@Nullable List<ListAccountingReportsQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListAccountingReportsRequest withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListAccountingReportsRequest withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListAccountingReportsRequest withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListAccountingReportsRequest withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAccountingReportsRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListAccountingReportsRequest withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAccountingReportsRequest withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }


    public ListAccountingReportsRequest withType(@Nullable String type) {
        this.type = type;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAccountingReportsRequest withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListAccountingReportsQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
