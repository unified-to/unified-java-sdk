...
public class PatchRepoOrganizationRequestBuilder {
    ...
    public PatchRepoOrganizationRequestBuilder request(@Nonnull PatchRepoOrganizationRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private PatchRepoOrganizationRequest _buildRequest() {
        return this.request;
    }
    
    public PatchRepoOrganizationRequestBuilder header(String name, String value) {
