...
public class PatchCommerceCollectionRequestBuilder {
    ...
    public PatchCommerceCollectionRequestBuilder request(@Nonnull PatchCommerceCollectionRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private PatchCommerceCollectionRequest _buildRequest() {
        return this.request;
    }
    
    public PatchCommerceCollectionRequestBuilder header(String name, String value) {
