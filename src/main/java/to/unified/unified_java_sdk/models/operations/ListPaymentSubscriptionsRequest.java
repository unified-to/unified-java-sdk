...
public class ListPaymentSubscriptionsRequest {
    ...
    private List<ListPaymentSubscriptionsQueryParamFields> fields;
    ...
    public ListPaymentSubscriptionsRequest(
            ...
            @Nullable List<ListPaymentSubscriptionsQueryParamFields> fields,
     ...
     * ID of the connection
     */
    public ListPaymentSubscriptionsRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * The contact ID to filter by (reference to AccountingContact)
     */
    public ListPaymentSubscriptionsRequest withContactId(@Nullable String contactId) {
        this.contactId = contactId;
        return this;
    }
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListPaymentSubscriptionsRequest withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListPaymentSubscriptionsRequest withFields(@Nullable List<ListPaymentSubscriptionsQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListPaymentSubscriptionsRequest withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListPaymentSubscriptionsRequest withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListPaymentSubscriptionsRequest withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListPaymentSubscriptionsRequest withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListPaymentSubscriptionsRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListPaymentSubscriptionsRequest withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListPaymentSubscriptionsRequest withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListPaymentSubscriptionsRequest withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPaymentSubscriptionsRequest other = (ListPaymentSubscriptionsRequest) o;
        return 
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListPaymentSubscriptionsQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
