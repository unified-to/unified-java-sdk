...
public class ListCrmEvents2Request {
    ...
    private List<ListCrmEvents2QueryParamFields> fields;
    ...
    @JsonCreator
    public ListCrmEvents2Request(
            @Nullable String companyId,
            @Nonnull String connectionId,
            @Nullable String contactId,
            @Nullable String dealId,
            @Nullable List<ListCrmEvents2QueryParamFields> fields,
    ...
    public Optional<String> dealId() {
        return Optional.ofNullable(this.dealId);
    }

    /**
     * Fields to return
     */
    public Optional<List<ListCrmEvents2QueryParamFields>> fields() {
    ...
    public Optional<String> leadId() {
        return Optional.ofNullable(this.leadId);
    }
     ...
     * The company ID to filter by (reference to CrmCompany)
     */
    public ListCrmEvents2Request withCompanyId(@Nullable String companyId) {
        this.companyId = companyId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListCrmEvents2Request withConnectionId(@Nonnull String connectionId) {
     ...
     * The contact ID to filter by (reference to CrmContact)
     */
    public ListCrmEvents2Request withContactId(@Nullable String contactId) {
        this.contactId = contactId;
        return this;
    }
     ...
     * The deal ID to filter by (reference to CrmDeal)
     */
    public ListCrmEvents2Request withDealId(@Nullable String dealId) {
        this.dealId = dealId;
        return this;
    }
     ...
     * Fields to return
     */
    public ListCrmEvents2Request withFields(@Nullable List<ListCrmEvents2QueryParamFields> fields) {
        this.fields = fields;
        return this;
    }
     ...
     * The CRM lead ID to filter by (reference to CrmLead)
     */
    public ListCrmEvents2Request withLeadId(@Nullable String leadId) {
        this.leadId = leadId;
        return this;
    }


    public ListCrmEvents2Request withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListCrmEvents2Request withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListCrmEvents2Request withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListCrmEvents2Request withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListCrmEvents2Request withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListCrmEvents2Request withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }


    public ListCrmEvents2Request withType(@Nullable String type) {
        this.type = type;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListCrmEvents2Request withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
     ...
     * The user/employee ID to filter by (reference to HrisEmployee)
     */
    public ListCrmEvents2Request withUserId(@Nullable String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListCrmEvents2Request other = (ListCrmEvents2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListCrmEvents2Request.class,
                "companyId", companyId,
    ...
    public final static class Builder {
         ...
         * The deal ID to filter by (reference to CrmDeal)
         */
        public Builder dealId(@Nullable String dealId) {
            this.dealId = dealId;
            return this;
        }
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListCrmEvents2QueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListCrmEvents2Request build() {
            return new ListCrmEvents2Request(
                companyId, connectionId, contactId,
                dealId, fields, leadId,
                limit, offset, order,
                query, raw, sort,
