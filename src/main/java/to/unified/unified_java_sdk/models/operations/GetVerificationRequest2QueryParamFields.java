...
public enum GetVerificationRequest2QueryParamFields {
    ...
    GetVerificationRequest2QueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetVerificationRequest2QueryParamFields> fromValue(String value) {
        for (GetVerificationRequest2QueryParamFields o: GetVerificationRequest2QueryParamFields.values()) {
