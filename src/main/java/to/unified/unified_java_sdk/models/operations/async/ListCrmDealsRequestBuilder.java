...
public class ListCrmDealsRequestBuilder {
    ...
    public ListCrmDealsRequestBuilder request(@Nonnull ListCrmDealsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListCrmDealsRequest _buildRequest() {
        return this.request;
    }
    
    public ListCrmDealsRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ListCrmDealsResponse> call() {
