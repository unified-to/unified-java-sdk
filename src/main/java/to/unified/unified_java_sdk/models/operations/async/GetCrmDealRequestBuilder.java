...
public class GetCrmDealRequestBuilder {
    ...
    public GetCrmDealRequestBuilder request(@Nonnull GetCrmDealRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetCrmDealRequest _buildRequest() {
        return this.request;
    }
    
    public GetCrmDealRequestBuilder header(String name, String value) {
