...
public class ListGenaiModelsRequestBuilder {
    ...
    public ListGenaiModelsRequestBuilder request(@Nonnull ListGenaiModelsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListGenaiModelsRequest _buildRequest() {
        return this.request;
    }
    
    public ListGenaiModelsRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ListGenaiModelsResponse> call() {
