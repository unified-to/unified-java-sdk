...
public class ListScimUsersRequestBuilder {
    ...
    public ListScimUsersRequestBuilder request(@Nonnull ListScimUsersRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListScimUsersRequest _buildRequest() {
        return this.request;
    }
    
    public ListScimUsersRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ListScimUsersResponse> call() {
