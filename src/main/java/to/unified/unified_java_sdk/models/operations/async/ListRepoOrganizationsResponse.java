...
public class ListRepoOrganizationsResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListRepoOrganizationsResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
