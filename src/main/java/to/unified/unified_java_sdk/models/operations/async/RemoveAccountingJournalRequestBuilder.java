...
public class RemoveAccountingJournalRequestBuilder {
    ...
    public RemoveAccountingJournalRequestBuilder request(@Nonnull RemoveAccountingJournalRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemoveAccountingJournalRequest _buildRequest() {
        return this.request;
    }
    
    public RemoveAccountingJournalRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<RemoveAccountingJournalResponse> call() {
