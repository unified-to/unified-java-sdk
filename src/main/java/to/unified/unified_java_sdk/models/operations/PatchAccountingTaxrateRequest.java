...
public class PatchAccountingTaxrateRequest {
    ...
    private Optional<? extends List<PatchAccountingTaxrateQueryParamFields>> fields;
    ...
    public PatchAccountingTaxrateRequest(
            ...
            String connectionId,
            Optional<? extends List<PatchAccountingTaxrateQueryParamFields>> fields,
            String id,
            Optional<String> raw) {
    ...
    public Optional<List<PatchAccountingTaxrateQueryParamFields>> fields() {
        return (Optional<List<PatchAccountingTaxrateQueryParamFields>>) fields;
    }
     ...
     * Fields to return
     */
    public PatchAccountingTaxrateRequest withFields(List<PatchAccountingTaxrateQueryParamFields> fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * Fields to return
     */
    public PatchAccountingTaxrateRequest withFields(Optional<? extends List<PatchAccountingTaxrateQueryParamFields>> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public PatchAccountingTaxrateRequest withRaw(String raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public PatchAccountingTaxrateRequest withRaw(Optional<String> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<PatchAccountingTaxrateQueryParamFields>> fields = Optional.empty();
         ...
         * Fields to return
         */
        public Builder fields(List<PatchAccountingTaxrateQueryParamFields> fields) {
            Utils.checkNotNull(fields, "fields");
            this.fields = Optional.ofNullable(fields);
            return this;
        }
         ...
         * Fields to return
         */
        public Builder fields(Optional<? extends List<PatchAccountingTaxrateQueryParamFields>> fields) {
            Utils.checkNotNull(fields, "fields");
            this.fields = fields;
            return this;
        }
