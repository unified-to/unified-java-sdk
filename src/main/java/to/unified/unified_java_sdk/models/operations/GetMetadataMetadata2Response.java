...
public class GetMetadataMetadata2Response implements Response {
    /**
    ...
    @JsonCreator
    public GetMetadataMetadata2Response(
     ...
     * HTTP response content type for this operation
     */
    public GetMetadataMetadata2Response withContentType(@Nonnull String contentType) {
     ...
     * Successful
     */
    public GetMetadataMetadata2Response withMetadataMetadata(@Nullable MetadataMetadata metadataMetadata) {
        this.metadataMetadata = metadataMetadata;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetMetadataMetadata2Response withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetMetadataMetadata2Response withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMetadataMetadata2Response other = (GetMetadataMetadata2Response) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMetadataMetadata2Response.class,
    ...
    public final static class Builder {
        ...
        public GetMetadataMetadata2Response build() {
            return new GetMetadataMetadata2Response(
                contentType, metadataMetadata, statusCode,
                rawResponse);
        }
