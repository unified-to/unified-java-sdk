...
public class CreateAccountingTaxrateRequest {
    ...
    private Optional<? extends List<CreateAccountingTaxrateQueryParamFields>> fields;
    ...
    public CreateAccountingTaxrateRequest(
            ...
            String connectionId,
            Optional<? extends List<CreateAccountingTaxrateQueryParamFields>> fields,
            Optional<String> raw) {
    ...
    public Optional<List<CreateAccountingTaxrateQueryParamFields>> fields() {
        return (Optional<List<CreateAccountingTaxrateQueryParamFields>>) fields;
    }
     ...
     * Fields to return
     */
    public CreateAccountingTaxrateRequest withFields(List<CreateAccountingTaxrateQueryParamFields> fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * Fields to return
     */
    public CreateAccountingTaxrateRequest withFields(Optional<? extends List<CreateAccountingTaxrateQueryParamFields>> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public CreateAccountingTaxrateRequest withRaw(String raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public CreateAccountingTaxrateRequest withRaw(Optional<String> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<CreateAccountingTaxrateQueryParamFields>> fields = Optional.empty();
         ...
         * Fields to return
         */
        public Builder fields(List<CreateAccountingTaxrateQueryParamFields> fields) {
            Utils.checkNotNull(fields, "fields");
            this.fields = Optional.ofNullable(fields);
            return this;
        }
         ...
         * Fields to return
         */
        public Builder fields(Optional<? extends List<CreateAccountingTaxrateQueryParamFields>> fields) {
            Utils.checkNotNull(fields, "fields");
            this.fields = fields;
            return this;
        }
