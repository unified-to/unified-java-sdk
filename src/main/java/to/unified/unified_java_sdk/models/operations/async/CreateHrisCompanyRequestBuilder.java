...
public class CreateHrisCompanyRequestBuilder {
    ...
    public CreateHrisCompanyRequestBuilder request(@Nonnull CreateHrisCompanyRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CreateHrisCompanyRequest _buildRequest() {
        return this.request;
    }
    
    public CreateHrisCompanyRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<CreateHrisCompanyResponse> call() {
