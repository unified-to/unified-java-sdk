...
public class ListPaymentPaymentsRequestBuilder {
    ...
    public ListPaymentPaymentsRequestBuilder request(@Nonnull ListPaymentPaymentsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListPaymentPaymentsRequest _buildRequest() {
        return this.request;
    }
    
    public ListPaymentPaymentsRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ListPaymentPaymentsResponse> call() {
