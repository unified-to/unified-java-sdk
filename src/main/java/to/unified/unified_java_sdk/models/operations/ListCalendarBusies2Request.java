...
public class ListCalendarBusies2Request {
    ...
    private List<ListCalendarBusies2QueryParamFields> fields;
    ...
    @JsonCreator
    public ListCalendarBusies2Request(
            @Nullable String calendarId,
            @Nonnull String connectionId,
            @Nullable String endLt,
            @Nullable List<ListCalendarBusies2QueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListCalendarBusies2QueryParamFields>> fields() {
     ...
     * The calendar ID to filter by (reference to CalendarCalendar)
     */
    public ListCalendarBusies2Request withCalendarId(@Nullable String calendarId) {
        this.calendarId = calendarId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListCalendarBusies2Request withConnectionId(@Nonnull String connectionId) {
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListCalendarBusies2Request withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListCalendarBusies2Request withFields(@Nullable List<ListCalendarBusies2QueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListCalendarBusies2Request withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListCalendarBusies2Request withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListCalendarBusies2Request withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListCalendarBusies2Request withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListCalendarBusies2Request withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListCalendarBusies2Request withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListCalendarBusies2Request withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListCalendarBusies2Request withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
     ...
     * The user/employee ID to filter by (reference to HrisEmployee)
     */
    public ListCalendarBusies2Request withUserId(@Nullable String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListCalendarBusies2Request other = (ListCalendarBusies2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListCalendarBusies2Request.class,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListCalendarBusies2QueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListCalendarBusies2Request build() {
            return new ListCalendarBusies2Request(
                calendarId, connectionId, endLt,
                fields, limit, offset,
                order, query, raw,
                sort, startGte, updatedGte,
