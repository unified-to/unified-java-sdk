...
public class ListCrmContactsRequest {
    ...
    private List<ListCrmContactsQueryParamFields> fields;
    ...
    public ListCrmContactsRequest(
            ...
            @Nullable List<ListCrmContactsQueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListCrmContactsQueryParamFields>> fields() {
     ...
     * The company ID to filter by (reference to CrmCompany)
     */
    public ListCrmContactsRequest withCompanyId(@Nullable String companyId) {
        this.companyId = companyId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListCrmContactsRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * The deal ID to filter by (reference to CrmDeal)
     */
    public ListCrmContactsRequest withDealId(@Nullable String dealId) {
        this.dealId = dealId;
        return this;
    }
     ...
     * Fields to return
     */
    public ListCrmContactsRequest withFields(@Nullable List<ListCrmContactsQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListCrmContactsRequest withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListCrmContactsRequest withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListCrmContactsRequest withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListCrmContactsRequest withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListCrmContactsRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListCrmContactsRequest withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListCrmContactsRequest withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
     ...
     * The user/employee ID to filter by (reference to HrisEmployee)
     */
    public ListCrmContactsRequest withUserId(@Nullable String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListCrmContactsQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
