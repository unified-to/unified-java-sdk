...
public class ListTaskProjectsRequestBuilder {
    ...
    public ListTaskProjectsRequestBuilder request(@Nonnull ListTaskProjectsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListTaskProjectsRequest _buildRequest() {
        return this.request;
    }
    
    public ListTaskProjectsRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ListTaskProjectsResponse> call() {
