...
public enum UpdateVerificationRequestQueryParamFields {
    ...
    UpdateVerificationRequestQueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<UpdateVerificationRequestQueryParamFields> fromValue(String value) {
        for (UpdateVerificationRequestQueryParamFields o: UpdateVerificationRequestQueryParamFields.values()) {
