...
public class ListUnifiedIssuesResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public ListUnifiedIssuesResponse withContentType(@Nonnull String contentType) {
     ...
     * Successful
     */
    public ListUnifiedIssuesResponse withIssues(@Nullable List<Issue> issues) {
        this.issues = issues;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListUnifiedIssuesResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
    ...
    public final static class Builder {
         ...
         * Successful
         */
        public Builder issues(@Nullable List<Issue> issues) {
            this.issues = issues;
            return this;
        }
