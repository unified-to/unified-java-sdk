...
public class ListAtsCandidatesRequest {
     ...
     * The company ID to filter by (reference to AtsCompany)
     */
    public ListAtsCandidatesRequest withCompanyId(@Nullable String companyId) {
        this.companyId = companyId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListAtsCandidatesRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * Fields to return
     */
    public ListAtsCandidatesRequest withFields(@Nullable List<ListAtsCandidatesQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }
    ...
    public ListAtsCandidatesRequest withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListAtsCandidatesRequest withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListAtsCandidatesRequest withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAtsCandidatesRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListAtsCandidatesRequest withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAtsCandidatesRequest withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
