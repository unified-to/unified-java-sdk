...
public class RemoveAtsJobResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public RemoveAtsJobResponse withContentType(@Nonnull String contentType) {
        this.contentType = Utils.checkNotNull(contentType, "contentType");
        return this;
    }


    public RemoveAtsJobResponse withHeaders(@Nonnull Map<String, List<String>> headers) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RemoveAtsJobResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
