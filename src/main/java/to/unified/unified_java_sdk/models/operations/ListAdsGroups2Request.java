...
public class ListAdsGroups2Request {
    ...
    private List<ListAdsGroups2QueryParamFields> fields;
    ...
    @JsonCreator
    public ListAdsGroups2Request(
            @Nullable String campaignId,
            @Nonnull String connectionId,
            @Nullable String endLt,
            @Nullable List<ListAdsGroups2QueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListAdsGroups2QueryParamFields>> fields() {
     ...
     * The campaign ID to filter by
     */
    public ListAdsGroups2Request withCampaignId(@Nullable String campaignId) {
        this.campaignId = campaignId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListAdsGroups2Request withConnectionId(@Nonnull String connectionId) {
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAdsGroups2Request withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListAdsGroups2Request withFields(@Nullable List<ListAdsGroups2QueryParamFields> fields) {
        this.fields = fields;
        return this;
    }
     ...
     * The IO ID to filter by
     */
    public ListAdsGroups2Request withIoId(@Nullable String ioId) {
        this.ioId = ioId;
        return this;
    }


    public ListAdsGroups2Request withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListAdsGroups2Request withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListAdsGroups2Request withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * The org ID to filter by (reference to AdsOrganization)
     */
    public ListAdsGroups2Request withOrgId(@Nullable String orgId) {
        this.orgId = orgId;
        return this;
    }
     ...
     * The parent ID to filter by
     */
    public ListAdsGroups2Request withParentId(@Nullable String parentId) {
        this.parentId = parentId;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListAdsGroups2Request withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAdsGroups2Request withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListAdsGroups2Request withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAdsGroups2Request withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
     ...
     * The status to filter by
     */
    public ListAdsGroups2Request withStatus(@Nullable String status) {
        this.status = status;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAdsGroups2Request withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAdsGroups2Request other = (ListAdsGroups2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListAdsGroups2Request.class,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListAdsGroups2QueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListAdsGroups2Request build() {
            return new ListAdsGroups2Request(
                campaignId, connectionId, endLt,
                fields, ioId, limit,
                offset, order, orgId,
                parentId, query, raw,
