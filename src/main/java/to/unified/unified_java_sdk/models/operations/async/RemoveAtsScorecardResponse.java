...
public class RemoveAtsScorecardResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RemoveAtsScorecardResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
