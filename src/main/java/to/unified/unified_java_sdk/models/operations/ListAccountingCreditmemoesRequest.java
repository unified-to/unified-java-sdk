...
public class ListAccountingCreditmemoesRequest {
     ...
     * ID of the connection
     */
    public ListAccountingCreditmemoesRequest withConnectionId(String connectionId) {
        Utils.checkNotNull(connectionId, "connectionId");
        this.connectionId = connectionId;
        return this;
    }
    ...
    public ListAccountingCreditmemoesRequest withLimit(double limit) {
        Utils.checkNotNull(limit, "limit");
    ...
    public ListAccountingCreditmemoesRequest withLimit(Optional<Double> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }

    public ListAccountingCreditmemoesRequest withOffset(double offset) {
        Utils.checkNotNull(offset, "offset");
    ...
    public ListAccountingCreditmemoesRequest withOffset(Optional<Double> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public ListAccountingCreditmemoesRequest withOrder(String order) {
        Utils.checkNotNull(order, "order");
    ...
    public ListAccountingCreditmemoesRequest withOrder(Optional<String> order) {
        Utils.checkNotNull(order, "order");
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListAccountingCreditmemoesRequest withQuery(String query) {
        Utils.checkNotNull(query, "query");
     ...
     * Query string to search. eg. email address or name
     */
    public ListAccountingCreditmemoesRequest withQuery(Optional<String> query) {
        Utils.checkNotNull(query, "query");
        this.query = query;
        return this;
    }
     ...
     * Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAccountingCreditmemoesRequest withRaw(String raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAccountingCreditmemoesRequest withRaw(Optional<String> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }

    public ListAccountingCreditmemoesRequest withSort(String sort) {
        Utils.checkNotNull(sort, "sort");
    ...
    public ListAccountingCreditmemoesRequest withSort(Optional<String> sort) {
        Utils.checkNotNull(sort, "sort");
        this.sort = sort;
        return this;
    }
