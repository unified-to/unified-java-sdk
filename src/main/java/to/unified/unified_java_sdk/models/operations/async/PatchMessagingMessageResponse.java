...
public class PatchMessagingMessageResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PatchMessagingMessageResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
