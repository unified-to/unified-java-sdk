...
public class PatchCalendarCalendarResponse implements AsyncResponse {
    /**
     * Successful
     */
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PatchCalendarCalendarResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
