...
public class GetHrisLocationResponse implements AsyncResponse {
     ...
     * HTTP response content type for this operation
     */
    public GetHrisLocationResponse withContentType(@Nonnull String contentType) {
     ...
     * Successful
     */
    public GetHrisLocationResponse withHrisLocation(@Nullable HrisLocation hrisLocation) {
        this.hrisLocation = hrisLocation;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetHrisLocationResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
