...
public class GetAccountingPurchaseorderRequestBuilder {
    ...
    public GetAccountingPurchaseorderRequestBuilder request(@Nonnull GetAccountingPurchaseorderRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetAccountingPurchaseorderRequest _buildRequest() {
        return this.request;
    }
    
    public GetAccountingPurchaseorderRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetAccountingPurchaseorderResponse> call() {
