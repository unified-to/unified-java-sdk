...
public class CreateTaskCommentRequestBuilder {
    ...
    public CreateTaskCommentRequestBuilder request(@Nonnull CreateTaskCommentRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CreateTaskCommentRequest _buildRequest() {
        return this.request;
    }
    
    public CreateTaskCommentRequestBuilder header(String name, String value) {
