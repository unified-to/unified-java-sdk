...
public enum PatchAssessmentOrderQueryParamFields {
    ...
    PatchAssessmentOrderQueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<PatchAssessmentOrderQueryParamFields> fromValue(String value) {
        for (PatchAssessmentOrderQueryParamFields o: PatchAssessmentOrderQueryParamFields.values()) {
