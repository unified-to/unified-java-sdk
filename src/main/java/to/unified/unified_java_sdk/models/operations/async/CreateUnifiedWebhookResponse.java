...
public class CreateUnifiedWebhookResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public CreateUnifiedWebhookResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateUnifiedWebhookResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
     ...
     * Successful
     */
    public CreateUnifiedWebhookResponse withWebhook(@Nullable Webhook webhook) {
        this.webhook = webhook;
        return this;
    }
