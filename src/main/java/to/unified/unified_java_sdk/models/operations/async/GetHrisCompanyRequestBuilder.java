...
public class GetHrisCompanyRequestBuilder {
    ...
    public GetHrisCompanyRequestBuilder request(@Nonnull GetHrisCompanyRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetHrisCompanyRequest _buildRequest() {
        return this.request;
    }
    
    public GetHrisCompanyRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetHrisCompanyResponse> call() {
