...
public class ListAtsInterviewsRequest {
    ...
    private List<ListAtsInterviewsQueryParamFields> fields;
    ...
    public ListAtsInterviewsRequest(
            ...
            @Nullable List<ListAtsInterviewsQueryParamFields> fields,
     ...
     * The application ID to filter by
     */
    public ListAtsInterviewsRequest withApplicationId(@Nullable String applicationId) {
        this.applicationId = applicationId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListAtsInterviewsRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * Fields to return
     */
    public ListAtsInterviewsRequest withFields(@Nullable List<ListAtsInterviewsQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListAtsInterviewsRequest withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListAtsInterviewsRequest withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListAtsInterviewsRequest withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListAtsInterviewsRequest withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAtsInterviewsRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListAtsInterviewsRequest withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAtsInterviewsRequest withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListAtsInterviewsQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
