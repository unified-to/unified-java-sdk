...
public class ListAtsInterviewsRequest {
    ...
    private Optional<? extends List<ListAtsInterviewsQueryParamFields>> fields;
    ...
    public ListAtsInterviewsRequest(
            ...
            String connectionId,
            Optional<? extends List<ListAtsInterviewsQueryParamFields>> fields,
    ...
    @JsonIgnore
    public Optional<List<ListAtsInterviewsQueryParamFields>> fields() {
        return (Optional<List<ListAtsInterviewsQueryParamFields>>) fields;
    }
     ...
     * Fields to return
     */
    public ListAtsInterviewsRequest withFields(List<ListAtsInterviewsQueryParamFields> fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * Fields to return
     */
    public ListAtsInterviewsRequest withFields(Optional<? extends List<ListAtsInterviewsQueryParamFields>> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
    ...
    public ListAtsInterviewsRequest withOrder(Optional<String> order) {
        Utils.checkNotNull(order, "order");
        this.order = order;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAtsInterviewsRequest withRaw(String raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAtsInterviewsRequest withRaw(Optional<String> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
    ...
    public ListAtsInterviewsRequest withSort(Optional<String> sort) {
        Utils.checkNotNull(sort, "sort");
        this.sort = sort;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAtsInterviewsRequest withUpdatedGte(String updatedGte) {
        Utils.checkNotNull(updatedGte, "updatedGte");
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAtsInterviewsRequest withUpdatedGte(Optional<String> updatedGte) {
        Utils.checkNotNull(updatedGte, "updatedGte");
        this.updatedGte = updatedGte;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<ListAtsInterviewsQueryParamFields>> fields = Optional.empty();
         ...
         * Fields to return
         */
        public Builder fields(List<ListAtsInterviewsQueryParamFields> fields) {
            Utils.checkNotNull(fields, "fields");
            this.fields = Optional.ofNullable(fields);
            return this;
        }
         ...
         * Fields to return
         */
        public Builder fields(Optional<? extends List<ListAtsInterviewsQueryParamFields>> fields) {
            Utils.checkNotNull(fields, "fields");
            this.fields = fields;
            return this;
        }
