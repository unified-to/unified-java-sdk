...
public class CreateMetadataMetadataRequest {
    ...
    private List<CreateMetadataMetadataQueryParamFields> fields;
    ...
    public CreateMetadataMetadataRequest(
            ...
            @Nullable List<CreateMetadataMetadataQueryParamFields> fields,
            @Nullable String raw) {
    ...
    public CreateMetadataMetadataRequest withMetadataMetadata(@Nonnull MetadataMetadata metadataMetadata) {
     ...
     * ID of the connection
     */
    public CreateMetadataMetadataRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * Fields to return
     */
    public CreateMetadataMetadataRequest withFields(@Nullable List<CreateMetadataMetadataQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public CreateMetadataMetadataRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<CreateMetadataMetadataQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
