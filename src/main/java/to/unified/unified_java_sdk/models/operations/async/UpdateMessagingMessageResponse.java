...
public class UpdateMessagingMessageResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateMessagingMessageResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
