...
public class UpdateAccountingInvoiceRequest {
    ...
    private List<UpdateAccountingInvoiceQueryParamFields> fields;
    ...
    public UpdateAccountingInvoiceRequest(
            ...
            @Nullable List<UpdateAccountingInvoiceQueryParamFields> fields,
            @Nonnull String id,
            @Nullable String raw) {
    ...
    public UpdateAccountingInvoiceRequest withAccountingInvoice(@Nonnull AccountingInvoice accountingInvoice) {
     ...
     * ID of the connection
     */
    public UpdateAccountingInvoiceRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * Fields to return
     */
    public UpdateAccountingInvoiceRequest withFields(@Nullable List<UpdateAccountingInvoiceQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }
     ...
     * ID of the Invoice
     */
    public UpdateAccountingInvoiceRequest withId(@Nonnull String id) {
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public UpdateAccountingInvoiceRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<UpdateAccountingInvoiceQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
