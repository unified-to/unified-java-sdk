...
public enum UpdateVerificationRequest2QueryParamFields {
    ...
    UpdateVerificationRequest2QueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<UpdateVerificationRequest2QueryParamFields> fromValue(String value) {
        for (UpdateVerificationRequest2QueryParamFields o: UpdateVerificationRequest2QueryParamFields.values()) {
