...
public class PatchRepoPullrequestRequestBuilder {
    ...
    public PatchRepoPullrequestRequestBuilder request(@Nonnull PatchRepoPullrequestRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private PatchRepoPullrequestRequest _buildRequest() {
        return this.request;
    }
    
    public PatchRepoPullrequestRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<PatchRepoPullrequestResponse> call() {
