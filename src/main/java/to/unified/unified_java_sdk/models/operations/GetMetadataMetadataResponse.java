...
public class GetMetadataMetadataResponse implements Response {
     ...
     * HTTP response content type for this operation
     */
    public GetMetadataMetadataResponse withContentType(@Nonnull String contentType) {
     ...
     * Successful
     */
    public GetMetadataMetadataResponse withMetadataMetadata(@Nullable MetadataMetadata metadataMetadata) {
        this.metadataMetadata = metadataMetadata;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetMetadataMetadataResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
