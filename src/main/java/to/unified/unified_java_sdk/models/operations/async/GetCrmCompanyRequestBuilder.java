...
public class GetCrmCompanyRequestBuilder {
    ...
    public GetCrmCompanyRequestBuilder request(@Nonnull GetCrmCompanyRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetCrmCompanyRequest _buildRequest() {
        return this.request;
    }
    
    public GetCrmCompanyRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetCrmCompanyResponse> call() {
