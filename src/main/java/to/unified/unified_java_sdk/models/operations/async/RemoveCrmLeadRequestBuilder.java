...
public class RemoveCrmLeadRequestBuilder {
    ...
    public RemoveCrmLeadRequestBuilder request(@Nonnull RemoveCrmLeadRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemoveCrmLeadRequest _buildRequest() {
        return this.request;
    }
    
    public RemoveCrmLeadRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<RemoveCrmLeadResponse> call() {
