...
public class GetHrisTimeoffRequestBuilder {
    ...
    public GetHrisTimeoffRequestBuilder request(@Nonnull GetHrisTimeoffRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetHrisTimeoffRequest _buildRequest() {
        return this.request;
    }
    
    public GetHrisTimeoffRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetHrisTimeoffResponse> call() {
