...
public class UpdateCommerceItemvariantResponse implements Response {
     ...
     * HTTP response content type for this operation
     */
    public UpdateCommerceItemvariantResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateCommerceItemvariantResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
