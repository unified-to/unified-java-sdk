...
public class UpdateAccountingOrderResponse implements AsyncResponse {
     ...
     * Successful
     */
    public UpdateAccountingOrderResponse withAccountingOrder(@Nullable AccountingOrder accountingOrder) {
        this.accountingOrder = accountingOrder;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public UpdateAccountingOrderResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateAccountingOrderResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
