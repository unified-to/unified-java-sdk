...
public class ListHrisAttendancesRequest {
    ...
    private List<ListHrisAttendancesQueryParamFields> fields;
    ...
    @JsonCreator
    public ListHrisAttendancesRequest(
            @Nullable String companyId,
            @Nonnull String connectionId,
            @Nullable String endLt,
            @Nullable List<ListHrisAttendancesQueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListHrisAttendancesQueryParamFields>> fields() {
     ...
     * The company ID to filter by (reference to HrisCompany)
     */
    public ListHrisAttendancesRequest withCompanyId(@Nullable String companyId) {
        this.companyId = companyId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListHrisAttendancesRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListHrisAttendancesRequest withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListHrisAttendancesRequest withFields(@Nullable List<ListHrisAttendancesQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListHrisAttendancesRequest withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }
     ...
     * The location ID to filter by (reference to HrisLocation)
     */
    public ListHrisAttendancesRequest withLocationId(@Nullable String locationId) {
        this.locationId = locationId;
        return this;
    }


    public ListHrisAttendancesRequest withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListHrisAttendancesRequest withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListHrisAttendancesRequest withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListHrisAttendancesRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListHrisAttendancesRequest withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListHrisAttendancesRequest withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListHrisAttendancesRequest withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
     ...
     * The user/employee ID to filter by (reference to HrisEmployee)
     */
    public ListHrisAttendancesRequest withUserId(@Nullable String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListHrisAttendancesRequest other = (ListHrisAttendancesRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListHrisAttendancesRequest.class,
                "companyId", companyId,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListHrisAttendancesQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListHrisAttendancesRequest build() {
            return new ListHrisAttendancesRequest(
                companyId, connectionId, endLt,
                fields, limit, locationId,
                offset, order, query,
                raw, sort, startGte,
