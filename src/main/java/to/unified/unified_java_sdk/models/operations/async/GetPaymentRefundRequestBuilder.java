...
public class GetPaymentRefundRequestBuilder {
    ...
    public GetPaymentRefundRequestBuilder request(@Nonnull GetPaymentRefundRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetPaymentRefundRequest _buildRequest() {
        return this.request;
    }
    
    public GetPaymentRefundRequestBuilder header(String name, String value) {
