...
public class ListRepoRepositoriesRequestBuilder {
    ...
    public ListRepoRepositoriesRequestBuilder request(@Nonnull ListRepoRepositoriesRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListRepoRepositoriesRequest _buildRequest() {
        return this.request;
    }
    
    public ListRepoRepositoriesRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ListRepoRepositoriesResponse> call() {
