...
public class ListAccountingCashflows2Request {
    ...
    private List<ListAccountingCashflows2QueryParamFields> fields;
    ...
    @JsonCreator
    public ListAccountingCashflows2Request(
            @Nullable String categoryId,
            @Nonnull String connectionId,
            @Nullable String contactId,
            @Nullable String endLt,
            @Nullable List<ListAccountingCashflows2QueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListAccountingCashflows2QueryParamFields>> fields() {
     ...
     * The category ID to filter by (reference to AccountingCategory)
     */
    public ListAccountingCashflows2Request withCategoryId(@Nullable String categoryId) {
        this.categoryId = categoryId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListAccountingCashflows2Request withConnectionId(@Nonnull String connectionId) {
     ...
     * The contact ID to filter by (reference to AccountingContact)
     */
    public ListAccountingCashflows2Request withContactId(@Nullable String contactId) {
        this.contactId = contactId;
        return this;
    }
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAccountingCashflows2Request withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListAccountingCashflows2Request withFields(@Nullable List<ListAccountingCashflows2QueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListAccountingCashflows2Request withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListAccountingCashflows2Request withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListAccountingCashflows2Request withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListAccountingCashflows2Request withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAccountingCashflows2Request withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListAccountingCashflows2Request withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAccountingCashflows2Request withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAccountingCashflows2Request withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAccountingCashflows2Request other = (ListAccountingCashflows2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListAccountingCashflows2Request.class,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListAccountingCashflows2QueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListAccountingCashflows2Request build() {
            return new ListAccountingCashflows2Request(
                categoryId, connectionId, contactId,
                endLt, fields, limit,
                offset, order, query,
                raw, sort, startGte,
