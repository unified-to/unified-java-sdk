...
public class GetCrmContactRequestBuilder {
    ...
    public GetCrmContactRequestBuilder request(@Nonnull GetCrmContactRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetCrmContactRequest _buildRequest() {
        return this.request;
    }
    
    public GetCrmContactRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetCrmContactResponse> call() {
