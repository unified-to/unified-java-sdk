...
public class UpdateScimGroupsRequest {
    ...
    public UpdateScimGroupsRequest withScimGroup(@Nonnull ScimGroup scimGroup) {
     ...
     * ID of the connection
     */
    public UpdateScimGroupsRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * ID of the Group
     */
    public UpdateScimGroupsRequest withId(@Nonnull String id) {
