...
public class PatchPassthroughRawResponse implements Response {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PatchPassthroughRawResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Successful
     */
    public PatchPassthroughRawResponse withDefaultWildcardWildcardResponseStream(@Nullable InputStream defaultWildcardWildcardResponseStream) {
        this.defaultWildcardWildcardResponseStream = defaultWildcardWildcardResponseStream;
        return this;
    }
