...
public class RemoveHrisDeviceRequestBuilder {
    ...
    public RemoveHrisDeviceRequestBuilder request(@Nonnull RemoveHrisDeviceRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemoveHrisDeviceRequest _buildRequest() {
        return this.request;
    }
    
    public RemoveHrisDeviceRequestBuilder header(String name, String value) {
    ...
    */
    public RemoveHrisDeviceResponse call() {
