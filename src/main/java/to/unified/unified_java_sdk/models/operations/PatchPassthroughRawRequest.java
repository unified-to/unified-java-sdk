...
public class PatchPassthroughRawRequest {
     ...
     * integration-specific payload
     */
    public PatchPassthroughRawRequest withRequestBody(@Nullable byte[] requestBody) {
        this.requestBody = requestBody;
        return this;
    }
     ...
     * ID of the connection
     */
    public PatchPassthroughRawRequest withConnectionId(@Nonnull String connectionId) {
        this.connectionId = Utils.checkNotNull(connectionId, "connectionId");
        return this;
    }


    public PatchPassthroughRawRequest withPath(@Nonnull String path) {
        this.path = Utils.checkNotNull(path, "path");
        return this;
    }


    public PatchPassthroughRawRequest withQuery(@Nullable Map<String, Object> query) {
        this.query = query;
        return this;
    }
