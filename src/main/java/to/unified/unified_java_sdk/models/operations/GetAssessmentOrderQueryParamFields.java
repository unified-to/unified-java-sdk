...
public enum GetAssessmentOrderQueryParamFields {
    ...
    GetAssessmentOrderQueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetAssessmentOrderQueryParamFields> fromValue(String value) {
        for (GetAssessmentOrderQueryParamFields o: GetAssessmentOrderQueryParamFields.values()) {
