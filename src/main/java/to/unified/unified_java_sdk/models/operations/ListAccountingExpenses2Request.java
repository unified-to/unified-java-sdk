...
public class ListAccountingExpenses2Request {
    ...
    private List<ListAccountingExpenses2QueryParamFields> fields;
    ...
    @JsonCreator
    public ListAccountingExpenses2Request(
            @Nullable String categoryId,
            @Nonnull String connectionId,
            @Nullable String contactId,
            @Nullable String endLt,
            @Nullable List<ListAccountingExpenses2QueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListAccountingExpenses2QueryParamFields>> fields() {
     ...
     * The category ID to filter by (reference to AccountingCategory)
     */
    public ListAccountingExpenses2Request withCategoryId(@Nullable String categoryId) {
        this.categoryId = categoryId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListAccountingExpenses2Request withConnectionId(@Nonnull String connectionId) {
     ...
     * The contact ID to filter by (reference to AccountingContact)
     */
    public ListAccountingExpenses2Request withContactId(@Nullable String contactId) {
        this.contactId = contactId;
        return this;
    }
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAccountingExpenses2Request withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListAccountingExpenses2Request withFields(@Nullable List<ListAccountingExpenses2QueryParamFields> fields) {
        this.fields = fields;
        return this;
    }
     ...
     * The group ID to filter by (reference to HrisGroup)
     */
    public ListAccountingExpenses2Request withGroupId(@Nullable String groupId) {
        this.groupId = groupId;
        return this;
    }


    public ListAccountingExpenses2Request withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListAccountingExpenses2Request withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListAccountingExpenses2Request withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * The org ID to filter by (reference to AccountingOrganization)
     */
    public ListAccountingExpenses2Request withOrgId(@Nullable String orgId) {
        this.orgId = orgId;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListAccountingExpenses2Request withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAccountingExpenses2Request withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListAccountingExpenses2Request withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAccountingExpenses2Request withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAccountingExpenses2Request withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
     ...
     * The user/employee ID to filter by (reference to HrisEmployee)
     */
    public ListAccountingExpenses2Request withUserId(@Nullable String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAccountingExpenses2Request other = (ListAccountingExpenses2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListAccountingExpenses2Request.class,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListAccountingExpenses2QueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListAccountingExpenses2Request build() {
            return new ListAccountingExpenses2Request(
                categoryId, connectionId, contactId,
                endLt, fields, groupId,
                limit, offset, order,
                orgId, query, raw,
