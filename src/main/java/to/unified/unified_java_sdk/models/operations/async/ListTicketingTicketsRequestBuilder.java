...
public class ListTicketingTicketsRequestBuilder {
    ...
    public ListTicketingTicketsRequestBuilder request(@Nonnull ListTicketingTicketsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListTicketingTicketsRequest _buildRequest() {
        return this.request;
    }
    
    public ListTicketingTicketsRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ListTicketingTicketsResponse> call() {
