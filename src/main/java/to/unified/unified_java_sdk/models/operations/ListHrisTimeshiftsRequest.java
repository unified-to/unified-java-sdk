...
public class ListHrisTimeshiftsRequest {
    ...
    private List<ListHrisTimeshiftsQueryParamFields> fields;
    ...
    public ListHrisTimeshiftsRequest(
            ...
            @Nullable List<ListHrisTimeshiftsQueryParamFields> fields,
     ...
     * The company ID to filter by (reference to HrisCompany)
     */
    public ListHrisTimeshiftsRequest withCompanyId(@Nullable String companyId) {
        this.companyId = companyId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListHrisTimeshiftsRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListHrisTimeshiftsRequest withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListHrisTimeshiftsRequest withFields(@Nullable List<ListHrisTimeshiftsQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListHrisTimeshiftsRequest withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }
     ...
     * The location ID to filter by (reference to HrisLocation)
     */
    public ListHrisTimeshiftsRequest withLocationId(@Nullable String locationId) {
        this.locationId = locationId;
        return this;
    }


    public ListHrisTimeshiftsRequest withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListHrisTimeshiftsRequest withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListHrisTimeshiftsRequest withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListHrisTimeshiftsRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListHrisTimeshiftsRequest withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListHrisTimeshiftsRequest withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListHrisTimeshiftsRequest withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
     ...
     * The user/employee ID to filter by (reference to HrisEmployee)
     */
    public ListHrisTimeshiftsRequest withUserId(@Nullable String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListHrisTimeshiftsQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
