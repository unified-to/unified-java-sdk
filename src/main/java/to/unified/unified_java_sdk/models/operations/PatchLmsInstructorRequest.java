...
public class PatchLmsInstructorRequest {
    ...
    public PatchLmsInstructorRequest(
            ...
            String connectionId,
            String id) {
        this(lmsInstructor, connectionId, Optional.empty(), id, Optional.empty());
    }
     ...
     * Comma-delimited fields to return
     */
    public PatchLmsInstructorRequest withFields(List<String> fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * Comma-delimited fields to return
     */
    public PatchLmsInstructorRequest withFields(Optional<? extends List<String>> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
