...
public class ListAtsJobsRequest {
    ...
    public ListAtsJobsRequest withOrder(String order) {
        Utils.checkNotNull(order, "order");
     ...
     * Query string to search. eg. email address or name
     */
    public ListAtsJobsRequest withQuery(Optional<String> query) {
        Utils.checkNotNull(query, "query");
        this.query = query;
        return this;
    }
     ...
     * Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAtsJobsRequest withRaw(String raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAtsJobsRequest withRaw(Optional<String> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }

    public ListAtsJobsRequest withSort(String sort) {
        Utils.checkNotNull(sort, "sort");
     ...
     * The status to filter by
     */
    public ListAtsJobsRequest withStatus(String status) {
        Utils.checkNotNull(status, "status");
     ...
     * The status to filter by
     */
    public ListAtsJobsRequest withStatus(Optional<String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
