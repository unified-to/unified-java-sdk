...
public class GetCommerceReviewRequestBuilder {
    ...
    public GetCommerceReviewRequestBuilder request(@Nonnull GetCommerceReviewRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetCommerceReviewRequest _buildRequest() {
        return this.request;
    }
    
    public GetCommerceReviewRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetCommerceReviewResponse> call() {
