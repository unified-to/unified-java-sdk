...
public class ListHrisTimeshifts2Request {
    ...
    private List<ListHrisTimeshifts2QueryParamFields> fields;
    ...
    @JsonCreator
    public ListHrisTimeshifts2Request(
            @Nullable String companyId,
            @Nonnull String connectionId,
            @Nullable String endLt,
            @Nullable List<ListHrisTimeshifts2QueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListHrisTimeshifts2QueryParamFields>> fields() {
     ...
     * The company ID to filter by (reference to HrisCompany)
     */
    public ListHrisTimeshifts2Request withCompanyId(@Nullable String companyId) {
        this.companyId = companyId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListHrisTimeshifts2Request withConnectionId(@Nonnull String connectionId) {
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListHrisTimeshifts2Request withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListHrisTimeshifts2Request withFields(@Nullable List<ListHrisTimeshifts2QueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListHrisTimeshifts2Request withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }
     ...
     * The location ID to filter by (reference to HrisLocation)
     */
    public ListHrisTimeshifts2Request withLocationId(@Nullable String locationId) {
        this.locationId = locationId;
        return this;
    }


    public ListHrisTimeshifts2Request withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListHrisTimeshifts2Request withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListHrisTimeshifts2Request withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListHrisTimeshifts2Request withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListHrisTimeshifts2Request withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListHrisTimeshifts2Request withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListHrisTimeshifts2Request withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
     ...
     * The user/employee ID to filter by (reference to HrisEmployee)
     */
    public ListHrisTimeshifts2Request withUserId(@Nullable String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListHrisTimeshifts2Request other = (ListHrisTimeshifts2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListHrisTimeshifts2Request.class,
                "companyId", companyId,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListHrisTimeshifts2QueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListHrisTimeshifts2Request build() {
            return new ListHrisTimeshifts2Request(
                companyId, connectionId, endLt,
                fields, limit, locationId,
                offset, order, query,
                raw, sort, startGte,
