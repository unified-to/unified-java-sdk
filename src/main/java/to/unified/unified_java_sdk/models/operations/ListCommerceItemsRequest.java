...
public class ListCommerceItemsRequest {
    ...
    private List<ListCommerceItemsQueryParamFields> fields;
    ...
    public ListCommerceItemsRequest(
            ...
            @Nullable List<ListCommerceItemsQueryParamFields> fields,
     ...
     * The collection ID to filter by (reference to CommerceCollection)
     */
    public ListCommerceItemsRequest withCollectionId(@Nullable String collectionId) {
        this.collectionId = collectionId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListCommerceItemsRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * Fields to return
     */
    public ListCommerceItemsRequest withFields(@Nullable List<ListCommerceItemsQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListCommerceItemsRequest withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListCommerceItemsRequest withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListCommerceItemsRequest withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListCommerceItemsRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListCommerceItemsRequest withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListCommerceItemsRequest withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListCommerceItemsQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
