...
public class RemoveCommerceReviewRequestBuilder {
    ...
    public RemoveCommerceReviewRequestBuilder request(@Nonnull RemoveCommerceReviewRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemoveCommerceReviewRequest _buildRequest() {
        return this.request;
    }
    
    public RemoveCommerceReviewRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<RemoveCommerceReviewResponse> call() {
