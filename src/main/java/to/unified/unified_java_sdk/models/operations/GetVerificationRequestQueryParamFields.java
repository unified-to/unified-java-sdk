...
public enum GetVerificationRequestQueryParamFields {
    ...
    GetVerificationRequestQueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetVerificationRequestQueryParamFields> fromValue(String value) {
        for (GetVerificationRequestQueryParamFields o: GetVerificationRequestQueryParamFields.values()) {
