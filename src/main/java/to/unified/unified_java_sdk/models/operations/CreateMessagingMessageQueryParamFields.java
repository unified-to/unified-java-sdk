...
public enum CreateMessagingMessageQueryParamFields {
    ...
    CreateMessagingMessageQueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<CreateMessagingMessageQueryParamFields> fromValue(String value) {
        for (CreateMessagingMessageQueryParamFields o: CreateMessagingMessageQueryParamFields.values()) {
