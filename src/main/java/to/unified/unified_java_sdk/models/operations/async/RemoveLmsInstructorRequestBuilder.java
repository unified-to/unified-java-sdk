...
public class RemoveLmsInstructorRequestBuilder {
    ...
    public RemoveLmsInstructorRequestBuilder request(@Nonnull RemoveLmsInstructorRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemoveLmsInstructorRequest _buildRequest() {
        return this.request;
    }
    
    public RemoveLmsInstructorRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<RemoveLmsInstructorResponse> call() {
