...
public class UpdateTicketingTicketResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateTicketingTicketResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
