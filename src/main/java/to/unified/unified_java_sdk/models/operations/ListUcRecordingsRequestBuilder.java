...
public class ListUcRecordingsRequestBuilder {
    ...
    public ListUcRecordingsRequestBuilder request(@Nonnull ListUcRecordingsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListUcRecordingsRequest _buildRequest() {
        return this.request;
    }
    
    public ListUcRecordingsRequestBuilder header(String name, String value) {
    ...
    */
    public ListUcRecordingsResponse call() {
