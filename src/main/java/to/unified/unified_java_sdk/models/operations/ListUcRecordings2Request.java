...
public class ListUcRecordings2Request {
    ...
    private List<ListUcRecordings2QueryParamFields> fields;
    ...
    @JsonCreator
    public ListUcRecordings2Request(
            @Nullable String callId,
            @Nonnull String connectionId,
            @Nullable String contactId,
            @Nullable String endLt,
            @Nullable List<ListUcRecordings2QueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListUcRecordings2QueryParamFields>> fields() {
     ...
     * The call ID to filter by
     */
    public ListUcRecordings2Request withCallId(@Nullable String callId) {
        this.callId = callId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListUcRecordings2Request withConnectionId(@Nonnull String connectionId) {
     ...
     * The contact ID to filter by (reference to UcContact)
     */
    public ListUcRecordings2Request withContactId(@Nullable String contactId) {
        this.contactId = contactId;
        return this;
    }
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListUcRecordings2Request withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListUcRecordings2Request withFields(@Nullable List<ListUcRecordings2QueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListUcRecordings2Request withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListUcRecordings2Request withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListUcRecordings2Request withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListUcRecordings2Request withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListUcRecordings2Request withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListUcRecordings2Request withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListUcRecordings2Request withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListUcRecordings2Request withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
     ...
     * The user/employee ID to filter by (reference to HrisEmployee)
     */
    public ListUcRecordings2Request withUserId(@Nullable String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListUcRecordings2Request other = (ListUcRecordings2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListUcRecordings2Request.class,
                "callId", callId,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListUcRecordings2QueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListUcRecordings2Request build() {
            return new ListUcRecordings2Request(
                callId, connectionId, contactId,
                endLt, fields, limit,
                offset, order, query,
                raw, sort, startGte,
