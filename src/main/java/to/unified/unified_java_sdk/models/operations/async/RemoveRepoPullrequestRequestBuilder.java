...
public class RemoveRepoPullrequestRequestBuilder {
    ...
    public RemoveRepoPullrequestRequestBuilder request(@Nonnull RemoveRepoPullrequestRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemoveRepoPullrequestRequest _buildRequest() {
        return this.request;
    }
    
    public RemoveRepoPullrequestRequestBuilder header(String name, String value) {
