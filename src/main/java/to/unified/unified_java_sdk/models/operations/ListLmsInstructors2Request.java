...
public class ListLmsInstructors2Request {
    ...
    private List<ListLmsInstructors2QueryParamFields> fields;
    ...
    @JsonCreator
    public ListLmsInstructors2Request(
            @Nullable String classId,
            @Nullable String companyId,
            @Nonnull String connectionId,
            @Nullable String courseId,
            @Nullable List<ListLmsInstructors2QueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListLmsInstructors2QueryParamFields>> fields() {
     ...
     * The class ID to filter by (reference to LmsClass)
     */
    public ListLmsInstructors2Request withClassId(@Nullable String classId) {
        this.classId = classId;
        return this;
    }
     ...
     * The company ID to filter by (reference to HrisCompany)
     */
    public ListLmsInstructors2Request withCompanyId(@Nullable String companyId) {
        this.companyId = companyId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListLmsInstructors2Request withConnectionId(@Nonnull String connectionId) {
     ...
     * The course ID to filter by (reference to Course)
     */
    public ListLmsInstructors2Request withCourseId(@Nullable String courseId) {
        this.courseId = courseId;
        return this;
    }
     ...
     * Fields to return
     */
    public ListLmsInstructors2Request withFields(@Nullable List<ListLmsInstructors2QueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListLmsInstructors2Request withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListLmsInstructors2Request withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListLmsInstructors2Request withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListLmsInstructors2Request withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListLmsInstructors2Request withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListLmsInstructors2Request withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListLmsInstructors2Request withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListLmsInstructors2Request other = (ListLmsInstructors2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListLmsInstructors2Request.class,
                "classId", classId,
                "companyId", companyId,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListLmsInstructors2QueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListLmsInstructors2Request build() {
            return new ListLmsInstructors2Request(
                classId, companyId, connectionId,
                courseId, fields, limit,
                offset, order, query,
                raw, sort, updatedGte);
