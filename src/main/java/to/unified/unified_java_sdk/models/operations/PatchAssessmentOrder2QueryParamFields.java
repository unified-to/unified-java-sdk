...
public enum PatchAssessmentOrder2QueryParamFields {
    ...
    PatchAssessmentOrder2QueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<PatchAssessmentOrder2QueryParamFields> fromValue(String value) {
        for (PatchAssessmentOrder2QueryParamFields o: PatchAssessmentOrder2QueryParamFields.values()) {
