...
public class PatchRepoRepositoryRequest {
    ...
    public PatchRepoRepositoryRequest(
            ...
            String connectionId,
            String id) {
        this(repoRepository, connectionId, Optional.empty(), id, Optional.empty());
    }
     ...
     * Comma-delimited fields to return
     */
    public PatchRepoRepositoryRequest withFields(List<String> fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * Comma-delimited fields to return
     */
    public PatchRepoRepositoryRequest withFields(Optional<? extends List<String>> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
