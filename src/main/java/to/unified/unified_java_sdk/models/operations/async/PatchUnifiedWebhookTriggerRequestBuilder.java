...
public class PatchUnifiedWebhookTriggerRequestBuilder {
    ...
    public PatchUnifiedWebhookTriggerRequestBuilder request(@Nonnull PatchUnifiedWebhookTriggerRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private PatchUnifiedWebhookTriggerRequest _buildRequest() {
        return this.request;
    }
    
    public PatchUnifiedWebhookTriggerRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<PatchUnifiedWebhookTriggerResponse> call() {
