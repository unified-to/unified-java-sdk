...
public class UpdateCrmEventRequestBuilder {
    ...
    public UpdateCrmEventRequestBuilder request(@Nonnull UpdateCrmEventRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private UpdateCrmEventRequest _buildRequest() {
        return this.request;
    }
    
    public UpdateCrmEventRequestBuilder header(String name, String value) {
