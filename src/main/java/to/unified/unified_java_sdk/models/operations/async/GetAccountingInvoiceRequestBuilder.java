...
public class GetAccountingInvoiceRequestBuilder {
    ...
    public GetAccountingInvoiceRequestBuilder request(@Nonnull GetAccountingInvoiceRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetAccountingInvoiceRequest _buildRequest() {
        return this.request;
    }
    
    public GetAccountingInvoiceRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetAccountingInvoiceResponse> call() {
