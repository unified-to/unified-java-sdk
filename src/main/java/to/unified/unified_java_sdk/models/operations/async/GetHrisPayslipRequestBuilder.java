...
public class GetHrisPayslipRequestBuilder {
    ...
    public GetHrisPayslipRequestBuilder request(@Nonnull GetHrisPayslipRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetHrisPayslipRequest _buildRequest() {
        return this.request;
    }
    
    public GetHrisPayslipRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetHrisPayslipResponse> call() {
