...
public class ListAnalyticsReportsRequest {
    ...
    private List<ListAnalyticsReportsQueryParamFields> fields;
    ...
    @JsonCreator
    public ListAnalyticsReportsRequest(
            @Nonnull String connectionId,
            @Nullable String dimension,
            @Nullable String endLt,
            @Nullable List<ListAnalyticsReportsQueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListAnalyticsReportsQueryParamFields>> fields() {
     ...
     * ID of the connection
     */
    public ListAnalyticsReportsRequest withConnectionId(@Nonnull String connectionId) {
        this.connectionId = Utils.checkNotNull(connectionId, "connectionId");
        return this;
    }


    public ListAnalyticsReportsRequest withDimension(@Nullable String dimension) {
        this.dimension = dimension;
        return this;
    }
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAnalyticsReportsRequest withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListAnalyticsReportsRequest withFields(@Nullable List<ListAnalyticsReportsQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListAnalyticsReportsRequest withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListAnalyticsReportsRequest withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListAnalyticsReportsRequest withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * The analytics property ID to filter by
     */
    public ListAnalyticsReportsRequest withPropertyId(@Nullable String propertyId) {
        this.propertyId = propertyId;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListAnalyticsReportsRequest withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAnalyticsReportsRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListAnalyticsReportsRequest withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAnalyticsReportsRequest withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }


    public ListAnalyticsReportsRequest withType(@Nullable String type) {
        this.type = type;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAnalyticsReportsRequest withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAnalyticsReportsRequest other = (ListAnalyticsReportsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListAnalyticsReportsRequest.class,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListAnalyticsReportsQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListAnalyticsReportsRequest build() {
            return new ListAnalyticsReportsRequest(
                connectionId, dimension, endLt,
                fields, limit, offset,
                order, propertyId, query,
                raw, sort, startGte,
