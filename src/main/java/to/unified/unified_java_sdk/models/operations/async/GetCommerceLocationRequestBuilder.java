...
public class GetCommerceLocationRequestBuilder {
    ...
    public GetCommerceLocationRequestBuilder request(@Nonnull GetCommerceLocationRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetCommerceLocationRequest _buildRequest() {
        return this.request;
    }
    
    public GetCommerceLocationRequestBuilder header(String name, String value) {
