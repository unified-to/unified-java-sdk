...
public class GetVerificationRequestRequestBuilder {
    ...
    public GetVerificationRequestRequestBuilder request(GetVerificationRequestRequest request) {
        Utils.checkNotNull(request, "request");
        this.request = request;
        return this;
    }

    public CompletableFuture<GetVerificationRequestResponse> call() throws Exception {
