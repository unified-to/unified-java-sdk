...
public class GetKmsCommentRequestBuilder {
    ...
    public GetKmsCommentRequestBuilder request(@Nonnull GetKmsCommentRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetKmsCommentRequest _buildRequest() {
        return this.request;
    }
    
    public GetKmsCommentRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetKmsCommentResponse> call() {
