...
public class RemoveMessagingMessageRequestBuilder {
    ...
    public RemoveMessagingMessageRequestBuilder request(@Nonnull RemoveMessagingMessageRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemoveMessagingMessageRequest _buildRequest() {
        return this.request;
    }
    
    public RemoveMessagingMessageRequestBuilder header(String name, String value) {
    ...
    */
    public RemoveMessagingMessageResponse call() {
