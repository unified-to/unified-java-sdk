...
public class ListUnifiedIssuesRequestBuilder {
    ...
    public ListUnifiedIssuesRequestBuilder request(@Nonnull ListUnifiedIssuesRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListUnifiedIssuesRequest _buildRequest() {
        return this.request;
    }
    
    public ListUnifiedIssuesRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ListUnifiedIssuesResponse> call() {
