...
public class GetUnifiedIntegrationSamlRequest {
    ...
    @JsonCreator
    public GetUnifiedIntegrationSamlRequest(
            @Nullable String env,
    ...
    public GetUnifiedIntegrationSamlRequest withEnv(@Nullable String env) {
        this.env = env;
        return this;
    }
     ...
     * variable will be appended.
     */
    public GetUnifiedIntegrationSamlRequest withFailureRedirect(@Nullable String failureRedirect) {
        this.failureRedirect = failureRedirect;
        return this;
    }
     ...
     * Type of the supported integration
     */
    public GetUnifiedIntegrationSamlRequest withIntegrationType(@Nonnull String integrationType) {
        this.integrationType = Utils.checkNotNull(integrationType, "integrationType");
        return this;
    }


    public GetUnifiedIntegrationSamlRequest withRedirect(@Nullable Boolean redirect) {
        this.redirect = redirect;
        return this;
    }
     ...
     * Extra state to send back to your success URL
     */
    public GetUnifiedIntegrationSamlRequest withState(@Nullable String state) {
        this.state = state;
        return this;
    }
     ...
     * signed-in.
     */
    public GetUnifiedIntegrationSamlRequest withSuccessRedirect(@Nullable String successRedirect) {
        this.successRedirect = successRedirect;
        return this;
    }
     ...
     * The ID of the workspace
     */
    public GetUnifiedIntegrationSamlRequest withWorkspaceId(@Nonnull String workspaceId) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetUnifiedIntegrationSamlRequest other = (GetUnifiedIntegrationSamlRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetUnifiedIntegrationSamlRequest.class,
                "env", env,
    ...
    public final static class Builder {
        ...
        public GetUnifiedIntegrationSamlRequest build() {
            return new GetUnifiedIntegrationSamlRequest(
                env, failureRedirect, integrationType,
                redirect, state, successRedirect,
                workspaceId);
        }
