...
public enum ListVerificationRequestsQueryParamFields {
    ...
    ListVerificationRequestsQueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListVerificationRequestsQueryParamFields> fromValue(String value) {
        for (ListVerificationRequestsQueryParamFields o: ListVerificationRequestsQueryParamFields.values()) {
