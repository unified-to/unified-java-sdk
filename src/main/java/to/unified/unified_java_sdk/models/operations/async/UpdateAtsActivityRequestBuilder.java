...
public class UpdateAtsActivityRequestBuilder {
    ...
    public UpdateAtsActivityRequestBuilder request(@Nonnull UpdateAtsActivityRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private UpdateAtsActivityRequest _buildRequest() {
        return this.request;
    }
    
    public UpdateAtsActivityRequestBuilder header(String name, String value) {
