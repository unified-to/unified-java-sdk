...
public class ListAdsCampaignsRequest {
    ...
    public ListAdsCampaignsRequest withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListAdsCampaignsRequest withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListAdsCampaignsRequest withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * The org ID to filter by (reference to AdsOrganization)
     */
    public ListAdsCampaignsRequest withOrgId(@Nullable String orgId) {
        this.orgId = orgId;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListAdsCampaignsRequest withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAdsCampaignsRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListAdsCampaignsRequest withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAdsCampaignsRequest withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
