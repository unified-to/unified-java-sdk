...
public class GetPaymentPayoutRequestBuilder {
    ...
    public GetPaymentPayoutRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public GetPaymentPayoutRequestBuilder request(@Nonnull GetPaymentPayoutRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetPaymentPayoutRequest _buildRequest() {
        return this.request;
    }
    
    public GetPaymentPayoutRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetPaymentPayoutResponse> call() {
