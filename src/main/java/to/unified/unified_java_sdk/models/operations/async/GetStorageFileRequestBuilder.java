...
public class GetStorageFileRequestBuilder {
    ...
    public GetStorageFileRequestBuilder request(@Nonnull GetStorageFileRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetStorageFileRequest _buildRequest() {
        return this.request;
    }
    
    public GetStorageFileRequestBuilder header(String name, String value) {
