...
public class RemoveMartechListRequestBuilder {
    ...
    public RemoveMartechListRequestBuilder request(@Nonnull RemoveMartechListRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemoveMartechListRequest _buildRequest() {
        return this.request;
    }
    
    public RemoveMartechListRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<RemoveMartechListResponse> call() {
