...
public class ListKmsCommentsRequestBuilder {
    ...
    public ListKmsCommentsRequestBuilder request(@Nonnull ListKmsCommentsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListKmsCommentsRequest _buildRequest() {
        return this.request;
    }
    
    public ListKmsCommentsRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ListKmsCommentsResponse> call() {
