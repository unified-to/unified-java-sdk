...
public class ListAnalyticsReports2Request {
    ...
    private List<ListAnalyticsReports2QueryParamFields> fields;
    ...
    @JsonCreator
    public ListAnalyticsReports2Request(
            @Nonnull String connectionId,
            @Nullable String dimension,
            @Nullable String endLt,
            @Nullable List<ListAnalyticsReports2QueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListAnalyticsReports2QueryParamFields>> fields() {
     ...
     * ID of the connection
     */
    public ListAnalyticsReports2Request withConnectionId(@Nonnull String connectionId) {
        this.connectionId = Utils.checkNotNull(connectionId, "connectionId");
        return this;
    }


    public ListAnalyticsReports2Request withDimension(@Nullable String dimension) {
        this.dimension = dimension;
        return this;
    }
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAnalyticsReports2Request withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListAnalyticsReports2Request withFields(@Nullable List<ListAnalyticsReports2QueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListAnalyticsReports2Request withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListAnalyticsReports2Request withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListAnalyticsReports2Request withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * The analytics property ID to filter by
     */
    public ListAnalyticsReports2Request withPropertyId(@Nullable String propertyId) {
        this.propertyId = propertyId;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListAnalyticsReports2Request withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAnalyticsReports2Request withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListAnalyticsReports2Request withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAnalyticsReports2Request withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }


    public ListAnalyticsReports2Request withType(@Nullable String type) {
        this.type = type;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAnalyticsReports2Request withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAnalyticsReports2Request other = (ListAnalyticsReports2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListAnalyticsReports2Request.class,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListAnalyticsReports2QueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListAnalyticsReports2Request build() {
            return new ListAnalyticsReports2Request(
                connectionId, dimension, endLt,
                fields, limit, offset,
                order, propertyId, query,
                raw, sort, startGte,
