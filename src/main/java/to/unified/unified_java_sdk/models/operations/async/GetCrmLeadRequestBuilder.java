...
public class GetCrmLeadRequestBuilder {
    ...
    public GetCrmLeadRequestBuilder request(@Nonnull GetCrmLeadRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetCrmLeadRequest _buildRequest() {
        return this.request;
    }
    
    public GetCrmLeadRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetCrmLeadResponse> call() {
