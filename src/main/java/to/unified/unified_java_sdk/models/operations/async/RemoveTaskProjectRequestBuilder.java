...
public class RemoveTaskProjectRequestBuilder {
    ...
    public RemoveTaskProjectRequestBuilder request(@Nonnull RemoveTaskProjectRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemoveTaskProjectRequest _buildRequest() {
        return this.request;
    }
    
    public RemoveTaskProjectRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<RemoveTaskProjectResponse> call() {
