...
public enum ListAccountingProfitlosses2QueryParamFields {
    ...
    ListAccountingProfitlosses2QueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListAccountingProfitlosses2QueryParamFields> fromValue(String value) {
        for (ListAccountingProfitlosses2QueryParamFields o: ListAccountingProfitlosses2QueryParamFields.values()) {
