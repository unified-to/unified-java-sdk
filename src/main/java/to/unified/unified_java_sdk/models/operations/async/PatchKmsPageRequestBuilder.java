...
public class PatchKmsPageRequestBuilder {
    ...
    public PatchKmsPageRequestBuilder request(@Nonnull PatchKmsPageRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private PatchKmsPageRequest _buildRequest() {
        return this.request;
    }
    
    public PatchKmsPageRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<PatchKmsPageResponse> call() {
