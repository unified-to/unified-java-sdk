...
public class UpdateAtsDocumentResponse implements AsyncResponse {
    /**
     * Successful
     */
     ...
     * Successful
     */
    public UpdateAtsDocumentResponse withAtsDocument(@Nullable AtsDocument atsDocument) {
        this.atsDocument = atsDocument;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public UpdateAtsDocumentResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateAtsDocumentResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
