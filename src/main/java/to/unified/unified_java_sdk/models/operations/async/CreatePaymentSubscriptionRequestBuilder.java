...
public class CreatePaymentSubscriptionRequestBuilder {
    ...
    public CreatePaymentSubscriptionRequestBuilder request(@Nonnull CreatePaymentSubscriptionRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CreatePaymentSubscriptionRequest _buildRequest() {
        return this.request;
    }
    
    public CreatePaymentSubscriptionRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<CreatePaymentSubscriptionResponse> call() {
