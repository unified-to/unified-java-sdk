...
public class RemoveAtsActivityResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public RemoveAtsActivityResponse withContentType(@Nonnull String contentType) {
        this.contentType = Utils.checkNotNull(contentType, "contentType");
        return this;
    }


    public RemoveAtsActivityResponse withHeaders(@Nonnull Map<String, List<String>> headers) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RemoveAtsActivityResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
