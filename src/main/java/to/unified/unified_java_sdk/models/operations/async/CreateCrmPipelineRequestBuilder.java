...
public class CreateCrmPipelineRequestBuilder {
    ...
    public CreateCrmPipelineRequestBuilder request(@Nonnull CreateCrmPipelineRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CreateCrmPipelineRequest _buildRequest() {
        return this.request;
    }
    
    public CreateCrmPipelineRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<CreateCrmPipelineResponse> call() {
