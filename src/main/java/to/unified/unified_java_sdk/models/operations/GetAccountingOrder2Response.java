...
public class GetAccountingOrder2Response implements Response {
    /**
     * Successful
     */
    ...
    @JsonCreator
    public GetAccountingOrder2Response(
     ...
     * Successful
     */
    public GetAccountingOrder2Response withAccountingOrder(@Nullable AccountingOrder accountingOrder) {
        this.accountingOrder = accountingOrder;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public GetAccountingOrder2Response withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public GetAccountingOrder2Response withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetAccountingOrder2Response withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetAccountingOrder2Response other = (GetAccountingOrder2Response) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetAccountingOrder2Response.class,
    ...
    public final static class Builder {
        ...
        public GetAccountingOrder2Response build() {
            return new GetAccountingOrder2Response(
                accountingOrder, contentType, statusCode,
                rawResponse);
        }
