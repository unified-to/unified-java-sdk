...
public enum PatchVerificationRequest2QueryParamFields {
    ...
    PatchVerificationRequest2QueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<PatchVerificationRequest2QueryParamFields> fromValue(String value) {
        for (PatchVerificationRequest2QueryParamFields o: PatchVerificationRequest2QueryParamFields.values()) {
