...
public class ListHrisLocationsRequestBuilder {
    ...
    public ListHrisLocationsRequestBuilder request(@Nonnull ListHrisLocationsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListHrisLocationsRequest _buildRequest() {
        return this.request;
    }
    
    public ListHrisLocationsRequestBuilder header(String name, String value) {
