...
public class ListCalendarEvents2Request {
    ...
    private List<ListCalendarEvents2QueryParamFields> fields;
    ...
    @JsonCreator
    public ListCalendarEvents2Request(
            @Nullable String calendarId,
            @Nonnull String connectionId,
            @Nullable String endLt,
            @Nullable Boolean expand,
            @Nullable List<ListCalendarEvents2QueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListCalendarEvents2QueryParamFields>> fields() {
     ...
     * The calendar ID to filter by (reference to CalendarCalendar)
     */
    public ListCalendarEvents2Request withCalendarId(@Nullable String calendarId) {
        this.calendarId = calendarId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListCalendarEvents2Request withConnectionId(@Nonnull String connectionId) {
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListCalendarEvents2Request withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Whether to flatten grouped or recurring items into individual entries.
     */
    public ListCalendarEvents2Request withExpand(@Nullable Boolean expand) {
        this.expand = expand;
        return this;
    }
     ...
     * Fields to return
     */
    public ListCalendarEvents2Request withFields(@Nullable List<ListCalendarEvents2QueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListCalendarEvents2Request withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListCalendarEvents2Request withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListCalendarEvents2Request withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListCalendarEvents2Request withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListCalendarEvents2Request withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListCalendarEvents2Request withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListCalendarEvents2Request withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListCalendarEvents2Request withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListCalendarEvents2Request other = (ListCalendarEvents2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListCalendarEvents2Request.class,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListCalendarEvents2QueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListCalendarEvents2Request build() {
            return new ListCalendarEvents2Request(
                calendarId, connectionId, endLt,
                expand, fields, limit,
                offset, order, query,
                raw, sort, startGte,
