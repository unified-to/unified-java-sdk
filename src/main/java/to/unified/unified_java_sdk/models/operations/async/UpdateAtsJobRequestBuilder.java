...
public class UpdateAtsJobRequestBuilder {
    ...
    public UpdateAtsJobRequestBuilder request(@Nonnull UpdateAtsJobRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private UpdateAtsJobRequest _buildRequest() {
        return this.request;
    }
    
    public UpdateAtsJobRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<UpdateAtsJobResponse> call() {
