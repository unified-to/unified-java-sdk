...
public enum CreateAssessmentOrderQueryParamFields {
    ...
    CreateAssessmentOrderQueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<CreateAssessmentOrderQueryParamFields> fromValue(String value) {
        for (CreateAssessmentOrderQueryParamFields o: CreateAssessmentOrderQueryParamFields.values()) {
