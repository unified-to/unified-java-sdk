...
public class GetTicketingCategoryRequestBuilder {
    ...
    public GetTicketingCategoryRequestBuilder request(GetTicketingCategoryRequest request) {
        Utils.checkNotNull(request, "request");
        this.request = request;
        return this;
    }

    public CompletableFuture<GetTicketingCategoryResponse> call() throws Exception {
