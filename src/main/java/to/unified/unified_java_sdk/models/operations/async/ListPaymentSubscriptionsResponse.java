...
public class ListPaymentSubscriptionsResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public ListPaymentSubscriptionsResponse withContentType(@Nonnull String contentType) {
     ...
     * Successful
     */
    public ListPaymentSubscriptionsResponse withPaymentSubscriptions(@Nullable List<PaymentSubscription> paymentSubscriptions) {
        this.paymentSubscriptions = paymentSubscriptions;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListPaymentSubscriptionsResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
