...
public class CreateLmsStudentRequestBuilder {
    ...
    public CreateLmsStudentRequestBuilder request(@Nonnull CreateLmsStudentRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CreateLmsStudentRequest _buildRequest() {
        return this.request;
    }
    
    public CreateLmsStudentRequestBuilder header(String name, String value) {
