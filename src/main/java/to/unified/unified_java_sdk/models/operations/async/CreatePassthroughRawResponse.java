...
public class CreatePassthroughRawResponse implements AsyncResponse {
    /**
    ...
    @JsonCreator
    public CreatePassthroughRawResponse(
            String contentType,
     ...
     * HTTP response content type for this operation
     */
    public CreatePassthroughRawResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }

    public CreatePassthroughRawResponse withHeaders(Map<String, List<String>> headers) {
        Utils.checkNotNull(headers, "headers");
        this.headers = headers;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public CreatePassthroughRawResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreatePassthroughRawResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Successful
     */
    public CreatePassthroughRawResponse withDefaultWildcardWildcardResponseStream(Blob defaultWildcardWildcardResponseStream) {
        Utils.checkNotNull(defaultWildcardWildcardResponseStream, "defaultWildcardWildcardResponseStream");
     ...
     * Successful
     */
    public CreatePassthroughRawResponse withDefaultWildcardWildcardResponseStream(Optional<? extends Blob> defaultWildcardWildcardResponseStream) {
        Utils.checkNotNull(defaultWildcardWildcardResponseStream, "defaultWildcardWildcardResponseStream");
        this.defaultWildcardWildcardResponseStream = defaultWildcardWildcardResponseStream;
        return this;
    }
     ...
     * Successful
     */
    public CreatePassthroughRawResponse withDefaultApplicationJsonAny(Object defaultApplicationJsonAny) {
        Utils.checkNotNull(defaultApplicationJsonAny, "defaultApplicationJsonAny");
     ...
     * Successful
     */
    public CreatePassthroughRawResponse withDefaultApplicationJsonAny(Optional<? extends Object> defaultApplicationJsonAny) {
        Utils.checkNotNull(defaultApplicationJsonAny, "defaultApplicationJsonAny");
        this.defaultApplicationJsonAny = defaultApplicationJsonAny;
        return this;
    }
     ...
     * Successful
     */
    public CreatePassthroughRawResponse withDefaultApplicationXmlRes(String defaultApplicationXmlRes) {
        Utils.checkNotNull(defaultApplicationXmlRes, "defaultApplicationXmlRes");
     ...
     * Successful
     */
    public CreatePassthroughRawResponse withDefaultApplicationXmlRes(Optional<String> defaultApplicationXmlRes) {
        Utils.checkNotNull(defaultApplicationXmlRes, "defaultApplicationXmlRes");
        this.defaultApplicationXmlRes = defaultApplicationXmlRes;
        return this;
    }
     ...
     * Successful
     */
    public CreatePassthroughRawResponse withDefaultTextCsvRes(String defaultTextCsvRes) {
        Utils.checkNotNull(defaultTextCsvRes, "defaultTextCsvRes");
     ...
     * Successful
     */
    public CreatePassthroughRawResponse withDefaultTextCsvRes(Optional<String> defaultTextCsvRes) {
        Utils.checkNotNull(defaultTextCsvRes, "defaultTextCsvRes");
        this.defaultTextCsvRes = defaultTextCsvRes;
        return this;
    }
     ...
     * Successful
     */
    public CreatePassthroughRawResponse withDefaultTextPlainRes(String defaultTextPlainRes) {
        Utils.checkNotNull(defaultTextPlainRes, "defaultTextPlainRes");
     ...
     * Successful
     */
    public CreatePassthroughRawResponse withDefaultTextPlainRes(Optional<String> defaultTextPlainRes) {
        Utils.checkNotNull(defaultTextPlainRes, "defaultTextPlainRes");
        this.defaultTextPlainRes = defaultTextPlainRes;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreatePassthroughRawResponse other = (CreatePassthroughRawResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreatePassthroughRawResponse.class,
    ...
    public final static class Builder {
        ...
        public CreatePassthroughRawResponse build() {
