...
public class UpdateCommerceInventoryRequestBuilder {
    ...
    public UpdateCommerceInventoryRequestBuilder request(@Nonnull UpdateCommerceInventoryRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private UpdateCommerceInventoryRequest _buildRequest() {
        return this.request;
    }
    
    public UpdateCommerceInventoryRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<UpdateCommerceInventoryResponse> call() {
