...
public class ListUcCommentsRequest {
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListUcCommentsRequest withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListUcCommentsRequest withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
