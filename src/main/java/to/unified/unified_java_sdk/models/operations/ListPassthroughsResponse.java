...
public class ListPassthroughsResponse implements Response {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListPassthroughsResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Successful
     */
    public ListPassthroughsResponse withDefaultWildcardWildcardResponseStream(@Nullable InputStream defaultWildcardWildcardResponseStream) {
        this.defaultWildcardWildcardResponseStream = defaultWildcardWildcardResponseStream;
        return this;
    }
