...
public class GetAccountingContactRequestBuilder {
    ...
    public GetAccountingContactRequestBuilder request(@Nonnull GetAccountingContactRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetAccountingContactRequest _buildRequest() {
        return this.request;
    }
    
    public GetAccountingContactRequestBuilder header(String name, String value) {
