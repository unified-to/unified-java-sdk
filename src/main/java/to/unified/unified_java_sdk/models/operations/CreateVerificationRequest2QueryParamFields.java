...
public enum CreateVerificationRequest2QueryParamFields {
    ...
    CreateVerificationRequest2QueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<CreateVerificationRequest2QueryParamFields> fromValue(String value) {
        for (CreateVerificationRequest2QueryParamFields o: CreateVerificationRequest2QueryParamFields.values()) {
