...
public class PatchHrisGroupRequestBuilder {
    ...
    public PatchHrisGroupRequestBuilder request(@Nonnull PatchHrisGroupRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private PatchHrisGroupRequest _buildRequest() {
        return this.request;
    }
    
    public PatchHrisGroupRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<PatchHrisGroupResponse> call() {
