...
public class CreateUcRecordingRequest {
    ...
    public CreateUcRecordingRequest(
            UcRecording ucRecording,
            String connectionId) {
        this(ucRecording, connectionId, Optional.empty(), Optional.empty());
    }
     ...
     * Comma-delimited fields to return
     */
    public CreateUcRecordingRequest withFields(List<String> fields) {
        Utils.checkNotNull(fields, "fields");
     ...
     * Comma-delimited fields to return
     */
    public CreateUcRecordingRequest withFields(Optional<? extends List<String>> fields) {
        Utils.checkNotNull(fields, "fields");
        this.fields = fields;
        return this;
    }
