...
public class GetCrmPipelineRequestBuilder {
    ...
    public GetCrmPipelineRequestBuilder request(@Nonnull GetCrmPipelineRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetCrmPipelineRequest _buildRequest() {
        return this.request;
    }
    
    public GetCrmPipelineRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetCrmPipelineResponse> call() {
