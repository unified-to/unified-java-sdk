...
public class ListPaymentPayments2Request {
    ...
    private List<ListPaymentPayments2QueryParamFields> fields;
    ...
    @JsonCreator
    public ListPaymentPayments2Request(
            @Nullable String billId,
            @Nonnull String connectionId,
            @Nullable String contactId,
            @Nullable String endLt,
            @Nullable List<ListPaymentPayments2QueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListPaymentPayments2QueryParamFields>> fields() {
     ...
     * The bill ID to filter by
     */
    public ListPaymentPayments2Request withBillId(@Nullable String billId) {
        this.billId = billId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListPaymentPayments2Request withConnectionId(@Nonnull String connectionId) {
     ...
     * The contact ID to filter by (reference to AccountingContact)
     */
    public ListPaymentPayments2Request withContactId(@Nullable String contactId) {
        this.contactId = contactId;
        return this;
    }
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListPaymentPayments2Request withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListPaymentPayments2Request withFields(@Nullable List<ListPaymentPayments2QueryParamFields> fields) {
        this.fields = fields;
        return this;
    }
     ...
     * The invoice ID to filter by (reference to AccountingInvoice)
     */
    public ListPaymentPayments2Request withInvoiceId(@Nullable String invoiceId) {
        this.invoiceId = invoiceId;
        return this;
    }


    public ListPaymentPayments2Request withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }
     ...
     * The link ID to filter by
     */
    public ListPaymentPayments2Request withLinkId(@Nullable String linkId) {
        this.linkId = linkId;
        return this;
    }


    public ListPaymentPayments2Request withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListPaymentPayments2Request withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * The org ID to filter by (reference to AccountingOrganization)
     */
    public ListPaymentPayments2Request withOrgId(@Nullable String orgId) {
        this.orgId = orgId;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListPaymentPayments2Request withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListPaymentPayments2Request withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListPaymentPayments2Request withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListPaymentPayments2Request withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
     ...
     * The type to filter by
     */
    public ListPaymentPayments2Request withType(@Nullable String type) {
        this.type = type;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListPaymentPayments2Request withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPaymentPayments2Request other = (ListPaymentPayments2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListPaymentPayments2Request.class,
                "billId", billId,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListPaymentPayments2QueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListPaymentPayments2Request build() {
            return new ListPaymentPayments2Request(
                billId, connectionId, contactId,
                endLt, fields, invoiceId,
                limit, linkId, offset,
                order, orgId, query,
