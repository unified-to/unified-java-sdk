...
public class CreateUnifiedWebhookRequestBuilder {
    ...
    public CreateUnifiedWebhookRequestBuilder request(@Nonnull CreateUnifiedWebhookRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CreateUnifiedWebhookRequest _buildRequest() {
        return this.request;
    }
    
    public CreateUnifiedWebhookRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<CreateUnifiedWebhookResponse> call() {
