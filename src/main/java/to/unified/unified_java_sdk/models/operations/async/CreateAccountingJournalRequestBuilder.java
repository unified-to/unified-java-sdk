...
public class CreateAccountingJournalRequestBuilder {
    ...
    public CreateAccountingJournalRequestBuilder request(@Nonnull CreateAccountingJournalRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CreateAccountingJournalRequest _buildRequest() {
        return this.request;
    }
    
    public CreateAccountingJournalRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<CreateAccountingJournalResponse> call() {
