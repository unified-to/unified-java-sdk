...
public class CreateLmsCourseResponse implements AsyncResponse {
     ...
     * HTTP response content type for this operation
     */
    public CreateLmsCourseResponse withContentType(@Nonnull String contentType) {
     ...
     * Successful
     */
    public CreateLmsCourseResponse withLmsCourse(@Nullable LmsCourse lmsCourse) {
        this.lmsCourse = lmsCourse;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateLmsCourseResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
