...
public class UpdateCrmPipelineRequest {
    ...
    private List<UpdateCrmPipelineQueryParamFields> fields;
    ...
    public UpdateCrmPipelineRequest(
            ...
            @Nullable List<UpdateCrmPipelineQueryParamFields> fields,
            @Nonnull String id,
            @Nullable String raw) {
    ...
    public UpdateCrmPipelineRequest withCrmPipeline(@Nonnull CrmPipeline crmPipeline) {
     ...
     * ID of the connection
     */
    public UpdateCrmPipelineRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * Fields to return
     */
    public UpdateCrmPipelineRequest withFields(@Nullable List<UpdateCrmPipelineQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }
     ...
     * ID of the Pipeline
     */
    public UpdateCrmPipelineRequest withId(@Nonnull String id) {
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public UpdateCrmPipelineRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<UpdateCrmPipelineQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
