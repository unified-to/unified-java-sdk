...
public class UpdateTicketingNoteRequestBuilder {
    ...
    public UpdateTicketingNoteRequestBuilder request(@Nonnull UpdateTicketingNoteRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private UpdateTicketingNoteRequest _buildRequest() {
        return this.request;
    }
    
    public UpdateTicketingNoteRequestBuilder header(String name, String value) {
