...
public class CreateMartechMemberRequestBuilder {
    ...
    public CreateMartechMemberRequestBuilder request(@Nonnull CreateMartechMemberRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CreateMartechMemberRequest _buildRequest() {
        return this.request;
    }
    
    public CreateMartechMemberRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<CreateMartechMemberResponse> call() {
