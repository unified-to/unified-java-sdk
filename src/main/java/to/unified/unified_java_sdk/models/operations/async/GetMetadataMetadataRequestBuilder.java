...
public class GetMetadataMetadataRequestBuilder {
    ...
    public GetMetadataMetadataRequestBuilder request(@Nonnull GetMetadataMetadataRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetMetadataMetadataRequest _buildRequest() {
        return this.request;
    }
    
    public GetMetadataMetadataRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetMetadataMetadataResponse> call() {
