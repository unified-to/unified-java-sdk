...
public class UpdateUnifiedConnectionResponse implements AsyncResponse {
    /**
     * Successful
     */
     ...
     * Successful
     */
    public UpdateUnifiedConnectionResponse withConnection(@Nullable Connection connection) {
        this.connection = connection;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public UpdateUnifiedConnectionResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateUnifiedConnectionResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
