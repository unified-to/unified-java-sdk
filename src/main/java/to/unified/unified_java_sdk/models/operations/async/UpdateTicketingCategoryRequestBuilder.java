...
public class UpdateTicketingCategoryRequestBuilder {
    ...
    public UpdateTicketingCategoryRequestBuilder request(@Nonnull UpdateTicketingCategoryRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private UpdateTicketingCategoryRequest _buildRequest() {
        return this.request;
    }
    
    public UpdateTicketingCategoryRequestBuilder header(String name, String value) {
