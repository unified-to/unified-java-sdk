...
public enum UpdateAssessmentOrderQueryParamFields {
    ...
    UpdateAssessmentOrderQueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<UpdateAssessmentOrderQueryParamFields> fromValue(String value) {
        for (UpdateAssessmentOrderQueryParamFields o: UpdateAssessmentOrderQueryParamFields.values()) {
