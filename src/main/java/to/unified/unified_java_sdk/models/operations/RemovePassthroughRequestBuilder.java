...
public class RemovePassthroughRequestBuilder {
    ...
    public RemovePassthroughRequestBuilder request(@Nonnull RemovePassthroughRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemovePassthroughRequest _buildRequest() {
        return this.request;
    }
    
    public RemovePassthroughRequestBuilder header(String name, String value) {
    ...
    */
    public RemovePassthroughResponse call() {
