...
public class RemovePassthrough2Response implements Response {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RemovePassthrough2Response withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Successful
     */
    public RemovePassthrough2Response withDefaultWildcardWildcardResponseStream(@Nullable InputStream defaultWildcardWildcardResponseStream) {
        this.defaultWildcardWildcardResponseStream = defaultWildcardWildcardResponseStream;
        return this;
    }
