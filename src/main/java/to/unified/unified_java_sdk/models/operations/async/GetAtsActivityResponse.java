...
public class GetAtsActivityResponse implements AsyncResponse {
    /**
     * Successful
     */
     ...
     * Successful
     */
    public GetAtsActivityResponse withAtsActivity(@Nullable AtsActivity atsActivity) {
        this.atsActivity = atsActivity;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public GetAtsActivityResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetAtsActivityResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
