...
public class GetAccountingJournalRequestBuilder {
    ...
    public GetAccountingJournalRequestBuilder request(@Nonnull GetAccountingJournalRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetAccountingJournalRequest _buildRequest() {
        return this.request;
    }
    
    public GetAccountingJournalRequestBuilder header(String name, String value) {
