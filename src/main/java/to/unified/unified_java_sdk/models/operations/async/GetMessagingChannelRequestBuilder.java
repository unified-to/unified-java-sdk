...
public class GetMessagingChannelRequestBuilder {
    ...
    public GetMessagingChannelRequestBuilder request(@Nonnull GetMessagingChannelRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetMessagingChannelRequest _buildRequest() {
        return this.request;
    }
    
    public GetMessagingChannelRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetMessagingChannelResponse> call() {
