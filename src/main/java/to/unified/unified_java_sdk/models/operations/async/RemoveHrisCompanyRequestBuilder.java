...
public class RemoveHrisCompanyRequestBuilder {
    ...
    public RemoveHrisCompanyRequestBuilder request(@Nonnull RemoveHrisCompanyRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemoveHrisCompanyRequest _buildRequest() {
        return this.request;
    }
    
    public RemoveHrisCompanyRequestBuilder header(String name, String value) {
