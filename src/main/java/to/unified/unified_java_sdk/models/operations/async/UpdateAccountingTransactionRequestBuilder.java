...
public class UpdateAccountingTransactionRequestBuilder {
    ...
    public UpdateAccountingTransactionRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public UpdateAccountingTransactionRequestBuilder request(@Nonnull UpdateAccountingTransactionRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private UpdateAccountingTransactionRequest _buildRequest() {
        return this.request;
    }
    
    public UpdateAccountingTransactionRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<UpdateAccountingTransactionResponse> call() {
