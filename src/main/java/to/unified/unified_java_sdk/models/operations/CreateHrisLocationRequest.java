...
public class CreateHrisLocationRequest {
    ...
    private List<CreateHrisLocationQueryParamFields> fields;
    ...
    public CreateHrisLocationRequest(
            ...
            @Nullable List<CreateHrisLocationQueryParamFields> fields,
            @Nullable String raw) {
    ...
    public CreateHrisLocationRequest withHrisLocation(@Nonnull HrisLocation hrisLocation) {
     ...
     * ID of the connection
     */
    public CreateHrisLocationRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * Fields to return
     */
    public CreateHrisLocationRequest withFields(@Nullable List<CreateHrisLocationQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public CreateHrisLocationRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<CreateHrisLocationQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
