...
public class ListUcCalls2Request {
    ...
    private List<ListUcCalls2QueryParamFields> fields;
    ...
    @JsonCreator
    public ListUcCalls2Request(
            @Nonnull String connectionId,
            @Nullable String contactId,
            @Nullable String endLt,
            @Nullable List<ListUcCalls2QueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListUcCalls2QueryParamFields>> fields() {
     ...
     * ID of the connection
     */
    public ListUcCalls2Request withConnectionId(@Nonnull String connectionId) {
     ...
     * The contact ID to filter by (reference to UcContact)
     */
    public ListUcCalls2Request withContactId(@Nullable String contactId) {
        this.contactId = contactId;
        return this;
    }
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListUcCalls2Request withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListUcCalls2Request withFields(@Nullable List<ListUcCalls2QueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListUcCalls2Request withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListUcCalls2Request withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListUcCalls2Request withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListUcCalls2Request withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListUcCalls2Request withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListUcCalls2Request withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListUcCalls2Request withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListUcCalls2Request withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
     ...
     * The user/employee ID to filter by (reference to HrisEmployee)
     */
    public ListUcCalls2Request withUserId(@Nullable String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListUcCalls2Request other = (ListUcCalls2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListUcCalls2Request.class,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListUcCalls2QueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListUcCalls2Request build() {
            return new ListUcCalls2Request(
                connectionId, contactId, endLt,
                fields, limit, offset,
                order, query, raw,
                sort, startGte, updatedGte,
