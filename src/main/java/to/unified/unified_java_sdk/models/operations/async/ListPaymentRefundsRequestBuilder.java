...
public class ListPaymentRefundsRequestBuilder {
    ...
    public ListPaymentRefundsRequestBuilder request(@Nonnull ListPaymentRefundsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListPaymentRefundsRequest _buildRequest() {
        return this.request;
    }
    
    public ListPaymentRefundsRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ListPaymentRefundsResponse> call() {
