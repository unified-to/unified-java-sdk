...
public class ListCrmEventsRequestBuilder {
    ...
    public ListCrmEventsRequestBuilder request(@Nonnull ListCrmEventsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListCrmEventsRequest _buildRequest() {
        return this.request;
    }
    
    public ListCrmEventsRequestBuilder header(String name, String value) {
