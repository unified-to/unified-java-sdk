...
public class CreateRepoBranchRequestBuilder {
    ...
    public CreateRepoBranchRequestBuilder request(@Nonnull CreateRepoBranchRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CreateRepoBranchRequest _buildRequest() {
        return this.request;
    }
    
    public CreateRepoBranchRequestBuilder header(String name, String value) {
