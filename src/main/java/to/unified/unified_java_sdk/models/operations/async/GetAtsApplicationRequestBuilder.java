...
public class GetAtsApplicationRequestBuilder {
    ...
    public GetAtsApplicationRequestBuilder request(@Nonnull GetAtsApplicationRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetAtsApplicationRequest _buildRequest() {
        return this.request;
    }
    
    public GetAtsApplicationRequestBuilder header(String name, String value) {
