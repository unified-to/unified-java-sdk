...
public class PatchPaymentSubscriptionRequestBuilder {
    ...
    public PatchPaymentSubscriptionRequestBuilder request(@Nonnull PatchPaymentSubscriptionRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private PatchPaymentSubscriptionRequest _buildRequest() {
        return this.request;
    }
    
    public PatchPaymentSubscriptionRequestBuilder header(String name, String value) {
