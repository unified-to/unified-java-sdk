...
public class GetAccountingTransactionRequestBuilder {
    ...
    private GetAccountingTransactionRequest request;

    public GetAccountingTransactionRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public GetAccountingTransactionRequestBuilder request(@Nonnull GetAccountingTransactionRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetAccountingTransactionRequest _buildRequest() {
        return this.request;
    }
    
    public GetAccountingTransactionRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetAccountingTransactionResponse> call() {
