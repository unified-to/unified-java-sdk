...
public class UpdateLmsInstructorResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateLmsInstructorResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
