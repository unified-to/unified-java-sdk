...
public class ListHrisTimeoffsRequest {
    ...
    private List<ListHrisTimeoffsQueryParamFields> fields;
    ...
    public ListHrisTimeoffsRequest(
            ...
            @Nullable List<ListHrisTimeoffsQueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListHrisTimeoffsQueryParamFields>> fields() {
     ...
     * The company ID to filter by (reference to HrisCompany)
     */
    public ListHrisTimeoffsRequest withCompanyId(@Nullable String companyId) {
        this.companyId = companyId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListHrisTimeoffsRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListHrisTimeoffsRequest withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListHrisTimeoffsRequest withFields(@Nullable List<ListHrisTimeoffsQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListHrisTimeoffsRequest withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListHrisTimeoffsRequest withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListHrisTimeoffsRequest withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListHrisTimeoffsRequest withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListHrisTimeoffsRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListHrisTimeoffsRequest withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListHrisTimeoffsRequest withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListHrisTimeoffsRequest withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
     ...
     * The user/employee ID to filter by (reference to HrisEmployee)
     */
    public ListHrisTimeoffsRequest withUserId(@Nullable String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListHrisTimeoffsQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
