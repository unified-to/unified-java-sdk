...
public class PatchCrmContactRequest {
    ...
    private List<PatchCrmContactQueryParamFields> fields;
    ...
    public PatchCrmContactRequest(
            ...
            @Nullable List<PatchCrmContactQueryParamFields> fields,
            @Nonnull String id,
            @Nullable String raw) {
     ...
     * A contact represents a person that optionally is associated with a deal and/or a company
     */
    public PatchCrmContactRequest withCrmContact(@Nonnull CrmContact crmContact) {
     ...
     * ID of the connection
     */
    public PatchCrmContactRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * Fields to return
     */
    public PatchCrmContactRequest withFields(@Nullable List<PatchCrmContactQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }
     ...
     * ID of the Contact
     */
    public PatchCrmContactRequest withId(@Nonnull String id) {
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public PatchCrmContactRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<PatchCrmContactQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
