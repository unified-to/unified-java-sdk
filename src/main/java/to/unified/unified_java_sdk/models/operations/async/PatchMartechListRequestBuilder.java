...
public class PatchMartechListRequestBuilder {
    ...
    public PatchMartechListRequestBuilder request(@Nonnull PatchMartechListRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private PatchMartechListRequest _buildRequest() {
        return this.request;
    }
    
    public PatchMartechListRequestBuilder header(String name, String value) {
