...
public class GetLmsClassRequestBuilder {
    ...
    public GetLmsClassRequestBuilder request(@Nonnull GetLmsClassRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetLmsClassRequest _buildRequest() {
        return this.request;
    }
    
    public GetLmsClassRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetLmsClassResponse> call() {
