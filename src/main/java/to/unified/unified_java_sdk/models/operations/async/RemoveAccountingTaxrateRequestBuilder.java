...
public class RemoveAccountingTaxrateRequestBuilder {
    ...
    public RemoveAccountingTaxrateRequestBuilder request(@Nonnull RemoveAccountingTaxrateRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemoveAccountingTaxrateRequest _buildRequest() {
        return this.request;
    }
    
    public RemoveAccountingTaxrateRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<RemoveAccountingTaxrateResponse> call() {
