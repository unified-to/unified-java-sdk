...
public class PatchAccountingJournalResponse implements AsyncResponse {
    /**
     * Successful
     */
     ...
     * Successful
     */
    public PatchAccountingJournalResponse withAccountingJournal(@Nullable AccountingJournal accountingJournal) {
        this.accountingJournal = accountingJournal;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public PatchAccountingJournalResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PatchAccountingJournalResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
