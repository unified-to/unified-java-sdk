...
public class PatchPassthroughJsonResponse implements AsyncResponse {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PatchPassthroughJsonResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
     ...
     * Successful
     */
    public PatchPassthroughJsonResponse withDefaultWildcardWildcardResponseStream(@Nullable Blob defaultWildcardWildcardResponseStream) {
        this.defaultWildcardWildcardResponseStream = defaultWildcardWildcardResponseStream;
        return this;
    }
