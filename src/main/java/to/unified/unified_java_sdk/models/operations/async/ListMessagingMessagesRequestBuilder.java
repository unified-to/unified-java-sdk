...
public class ListMessagingMessagesRequestBuilder {
    ...
    public ListMessagingMessagesRequestBuilder request(@Nonnull ListMessagingMessagesRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListMessagingMessagesRequest _buildRequest() {
        return this.request;
    }
    
    public ListMessagingMessagesRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ListMessagingMessagesResponse> call() {
