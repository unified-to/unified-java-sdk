...
public class CreateRepoPullrequestResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public CreateRepoPullrequestResponse withContentType(@Nonnull String contentType) {
     ...
     * Successful
     */
    public CreateRepoPullrequestResponse withRepoPullrequest(@Nullable RepoPullrequest repoPullrequest) {
        this.repoPullrequest = repoPullrequest;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateRepoPullrequestResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
