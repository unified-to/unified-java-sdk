...
public class GetMetadataMetadata2Response implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetMetadataMetadata2Response withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
