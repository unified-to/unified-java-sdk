...
public class GetAtsScorecardRequestBuilder {
    ...
    public GetAtsScorecardRequestBuilder request(@Nonnull GetAtsScorecardRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetAtsScorecardRequest _buildRequest() {
        return this.request;
    }
    
    public GetAtsScorecardRequestBuilder header(String name, String value) {
