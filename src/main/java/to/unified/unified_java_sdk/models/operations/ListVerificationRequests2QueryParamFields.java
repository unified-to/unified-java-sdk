...
public enum ListVerificationRequests2QueryParamFields {
    ...
    ListVerificationRequests2QueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListVerificationRequests2QueryParamFields> fromValue(String value) {
        for (ListVerificationRequests2QueryParamFields o: ListVerificationRequests2QueryParamFields.values()) {
