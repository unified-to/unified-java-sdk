...
public class ListUnifiedWebhooksRequestBuilder {
    ...
    public ListUnifiedWebhooksRequestBuilder request(@Nonnull ListUnifiedWebhooksRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListUnifiedWebhooksRequest _buildRequest() {
        return this.request;
    }
    
    public ListUnifiedWebhooksRequestBuilder header(String name, String value) {
