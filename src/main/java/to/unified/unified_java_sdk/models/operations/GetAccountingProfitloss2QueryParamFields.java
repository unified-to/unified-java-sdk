...
public enum GetAccountingProfitloss2QueryParamFields {
    ...
    GetAccountingProfitloss2QueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetAccountingProfitloss2QueryParamFields> fromValue(String value) {
        for (GetAccountingProfitloss2QueryParamFields o: GetAccountingProfitloss2QueryParamFields.values()) {
