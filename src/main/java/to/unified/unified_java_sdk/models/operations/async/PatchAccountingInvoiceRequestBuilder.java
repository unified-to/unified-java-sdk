...
public class PatchAccountingInvoiceRequestBuilder {
    ...
    public PatchAccountingInvoiceRequestBuilder request(@Nonnull PatchAccountingInvoiceRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private PatchAccountingInvoiceRequest _buildRequest() {
        return this.request;
    }
    
    public PatchAccountingInvoiceRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<PatchAccountingInvoiceResponse> call() {
