...
public class PatchKmsPageRequest {
    ...
    private List<PatchKmsPageQueryParamFields> fields;
    ...
    public PatchKmsPageRequest(
            ...
            @Nullable List<PatchKmsPageQueryParamFields> fields,
            @Nonnull String id,
            @Nullable String raw) {
    ...
    public PatchKmsPageRequest withKmsPage(@Nonnull KmsPage kmsPage) {
     ...
     * ID of the connection
     */
    public PatchKmsPageRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * Fields to return
     */
    public PatchKmsPageRequest withFields(@Nullable List<PatchKmsPageQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }
     ...
     * ID of the Page
     */
    public PatchKmsPageRequest withId(@Nonnull String id) {
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public PatchKmsPageRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<PatchKmsPageQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
