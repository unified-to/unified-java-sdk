...
public class ListAtsApplicationsResponse implements AsyncResponse {
    /**
     * Successful
     */
     ...
     * Successful
     */
    public ListAtsApplicationsResponse withAtsApplications(@Nullable List<AtsApplication> atsApplications) {
        this.atsApplications = atsApplications;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public ListAtsApplicationsResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListAtsApplicationsResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
