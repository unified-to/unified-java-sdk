...
public class CreateAccountingTaxrateRequestBuilder {
    ...
    public CreateAccountingTaxrateRequestBuilder request(@Nonnull CreateAccountingTaxrateRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CreateAccountingTaxrateRequest _buildRequest() {
        return this.request;
    }
    
    public CreateAccountingTaxrateRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<CreateAccountingTaxrateResponse> call() {
