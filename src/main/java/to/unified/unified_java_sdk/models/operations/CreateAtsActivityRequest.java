...
public class CreateAtsActivityRequest {
    ...
    public CreateAtsActivityRequest(
            AtsActivity atsActivity,
            String connectionId) {
        this(atsActivity, connectionId, Optional.empty(), Optional.empty());
    }
     ...
     * Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public CreateAtsActivityRequest withRaw(String raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public CreateAtsActivityRequest withRaw(Optional<String> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
