...
public class CreateCommerceInventoryRequestBuilder {
    ...
    public CreateCommerceInventoryRequestBuilder request(@Nonnull CreateCommerceInventoryRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CreateCommerceInventoryRequest _buildRequest() {
        return this.request;
    }
    
    public CreateCommerceInventoryRequestBuilder header(String name, String value) {
