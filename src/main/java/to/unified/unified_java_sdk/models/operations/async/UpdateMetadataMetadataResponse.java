...
public class UpdateMetadataMetadataResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateMetadataMetadataResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
