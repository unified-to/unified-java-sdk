...
public class CreateAccountingTransactionRequestBuilder {
    ...
    public CreateAccountingTransactionRequestBuilder request(@Nonnull CreateAccountingTransactionRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CreateAccountingTransactionRequest _buildRequest() {
        return this.request;
    }
    
    public CreateAccountingTransactionRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<CreateAccountingTransactionResponse> call() {
