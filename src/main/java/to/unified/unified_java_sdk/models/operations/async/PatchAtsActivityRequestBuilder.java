...
public class PatchAtsActivityRequestBuilder {
    ...
    public PatchAtsActivityRequestBuilder request(@Nonnull PatchAtsActivityRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private PatchAtsActivityRequest _buildRequest() {
        return this.request;
    }
    
    public PatchAtsActivityRequestBuilder header(String name, String value) {
