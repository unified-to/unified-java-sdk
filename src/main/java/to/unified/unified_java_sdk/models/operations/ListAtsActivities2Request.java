...
public class ListAtsActivities2Request {
    ...
    private List<ListAtsActivities2QueryParamFields> fields;
    ...
    @JsonCreator
    public ListAtsActivities2Request(
            @Nullable String applicationId,
            @Nullable String candidateId,
            @Nonnull String connectionId,
            @Nullable String documentId,
            @Nullable List<ListAtsActivities2QueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListAtsActivities2QueryParamFields>> fields() {
     ...
     * The application ID to filter by
     */
    public ListAtsActivities2Request withApplicationId(@Nullable String applicationId) {
        this.applicationId = applicationId;
        return this;
    }
     ...
     * The candidate ID to filter by
     */
    public ListAtsActivities2Request withCandidateId(@Nullable String candidateId) {
        this.candidateId = candidateId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListAtsActivities2Request withConnectionId(@Nonnull String connectionId) {
     ...
     * The document ID to filter by
     */
    public ListAtsActivities2Request withDocumentId(@Nullable String documentId) {
        this.documentId = documentId;
        return this;
    }
     ...
     * Fields to return
     */
    public ListAtsActivities2Request withFields(@Nullable List<ListAtsActivities2QueryParamFields> fields) {
        this.fields = fields;
        return this;
    }
     ...
     * The interview ID to filter by
     */
    public ListAtsActivities2Request withInterviewId(@Nullable String interviewId) {
        this.interviewId = interviewId;
        return this;
    }
     ...
     * The job ID to filter by
     */
    public ListAtsActivities2Request withJobId(@Nullable String jobId) {
        this.jobId = jobId;
        return this;
    }


    public ListAtsActivities2Request withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListAtsActivities2Request withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListAtsActivities2Request withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListAtsActivities2Request withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAtsActivities2Request withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListAtsActivities2Request withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The type to filter by
     */
    public ListAtsActivities2Request withType(@Nullable String type) {
        this.type = type;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAtsActivities2Request withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
     ...
     * The user/employee ID to filter by (reference to HrisEmployee)
     */
    public ListAtsActivities2Request withUserId(@Nullable String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAtsActivities2Request other = (ListAtsActivities2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListAtsActivities2Request.class,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListAtsActivities2QueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListAtsActivities2Request build() {
            return new ListAtsActivities2Request(
                applicationId, candidateId, connectionId,
                documentId, fields, interviewId,
                jobId, limit, offset,
                order, query, raw,
