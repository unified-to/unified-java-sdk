...
public class CreateUcContactResponse implements AsyncResponse {
     ...
     * HTTP response content type for this operation
     */
    public CreateUcContactResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateUcContactResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
     ...
     * Successful
     */
    public CreateUcContactResponse withUcContact(@Nullable UcContact ucContact) {
        this.ucContact = ucContact;
        return this;
    }
