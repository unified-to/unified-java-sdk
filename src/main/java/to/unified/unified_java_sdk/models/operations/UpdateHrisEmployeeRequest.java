...
public class UpdateHrisEmployeeRequest {
    ...
    private List<UpdateHrisEmployeeQueryParamFields> fields;
    ...
    public UpdateHrisEmployeeRequest(
            ...
            @Nullable List<UpdateHrisEmployeeQueryParamFields> fields,
            @Nonnull String id,
            @Nullable String raw) {
    ...
    public UpdateHrisEmployeeRequest withHrisEmployee(@Nonnull HrisEmployee hrisEmployee) {
     ...
     * ID of the connection
     */
    public UpdateHrisEmployeeRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * Fields to return
     */
    public UpdateHrisEmployeeRequest withFields(@Nullable List<UpdateHrisEmployeeQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }
     ...
     * ID of the Employee
     */
    public UpdateHrisEmployeeRequest withId(@Nonnull String id) {
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public UpdateHrisEmployeeRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<UpdateHrisEmployeeQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
