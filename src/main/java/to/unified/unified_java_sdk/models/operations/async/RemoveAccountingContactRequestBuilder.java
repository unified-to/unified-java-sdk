...
public class RemoveAccountingContactRequestBuilder {
    ...
    public RemoveAccountingContactRequestBuilder request(@Nonnull RemoveAccountingContactRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemoveAccountingContactRequest _buildRequest() {
        return this.request;
    }
    
    public RemoveAccountingContactRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<RemoveAccountingContactResponse> call() {
