...
public class UpdateHrisLocationRequestBuilder {
    ...
    public UpdateHrisLocationRequestBuilder request(@Nonnull UpdateHrisLocationRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private UpdateHrisLocationRequest _buildRequest() {
        return this.request;
    }
    
    public UpdateHrisLocationRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<UpdateHrisLocationResponse> call() {
