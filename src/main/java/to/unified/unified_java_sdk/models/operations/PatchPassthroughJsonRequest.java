...
public class PatchPassthroughJsonRequest {
    ...
    public PatchPassthroughJsonRequest withQuery(Map<String, Object> query) {
        Utils.checkNotNull(query, "query");
        this.query = Optional.ofNullable(query);
        return this;
    }

    public PatchPassthroughJsonRequest withQuery(Optional<? extends Map<String, Object>> query) {
        Utils.checkNotNull(query, "query");
        this.query = query;
        return this;
    }
