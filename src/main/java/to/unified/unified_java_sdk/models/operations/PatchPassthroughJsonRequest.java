...
public class PatchPassthroughJsonRequest {
     ...
     * integration-specific payload
     */
    public PatchPassthroughJsonRequest withRequestBody(@Nullable Object requestBody) {
        this.requestBody = requestBody;
        return this;
    }
     ...
     * ID of the connection
     */
    public PatchPassthroughJsonRequest withConnectionId(@Nonnull String connectionId) {
        this.connectionId = Utils.checkNotNull(connectionId, "connectionId");
        return this;
    }


    public PatchPassthroughJsonRequest withPath(@Nonnull String path) {
        this.path = Utils.checkNotNull(path, "path");
        return this;
    }


    public PatchPassthroughJsonRequest withQuery(@Nullable Map<String, Object> query) {
        this.query = query;
        return this;
    }
