...
public class PatchMetadataMetadata2Response implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PatchMetadataMetadata2Response withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
