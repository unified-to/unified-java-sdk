...
public class GetHrisEmployeeResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public GetHrisEmployeeResponse withContentType(@Nonnull String contentType) {
     ...
     * Successful
     */
    public GetHrisEmployeeResponse withHrisEmployee(@Nullable HrisEmployee hrisEmployee) {
        this.hrisEmployee = hrisEmployee;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetHrisEmployeeResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
