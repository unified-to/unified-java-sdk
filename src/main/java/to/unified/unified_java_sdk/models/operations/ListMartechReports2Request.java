...
public class ListMartechReports2Request {
    ...
    private List<ListMartechReports2QueryParamFields> fields;
    ...
    @JsonCreator
    public ListMartechReports2Request(
            @Nullable String campaignId,
            @Nonnull String connectionId,
            @Nullable String endLt,
            @Nullable List<ListMartechReports2QueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListMartechReports2QueryParamFields>> fields() {
     ...
     * The campaign ID to filter by
     */
    public ListMartechReports2Request withCampaignId(@Nullable String campaignId) {
        this.campaignId = campaignId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListMartechReports2Request withConnectionId(@Nonnull String connectionId) {
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListMartechReports2Request withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListMartechReports2Request withFields(@Nullable List<ListMartechReports2QueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListMartechReports2Request withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }
     ...
     * The list ID to filter by
     */
    public ListMartechReports2Request withListId(@Nullable String listId) {
        this.listId = listId;
        return this;
    }


    public ListMartechReports2Request withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListMartechReports2Request withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListMartechReports2Request withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListMartechReports2Request withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListMartechReports2Request withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListMartechReports2Request withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListMartechReports2Request withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListMartechReports2Request other = (ListMartechReports2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListMartechReports2Request.class,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListMartechReports2QueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListMartechReports2Request build() {
            return new ListMartechReports2Request(
                campaignId, connectionId, endLt,
                fields, limit, listId,
                offset, order, query,
                raw, sort, startGte,
