...
public class ListMetadataMetadatasResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListMetadataMetadatasResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
