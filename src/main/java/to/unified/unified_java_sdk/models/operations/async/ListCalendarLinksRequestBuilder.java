...
public class ListCalendarLinksRequestBuilder {
    ...
    public ListCalendarLinksRequestBuilder request(@Nonnull ListCalendarLinksRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListCalendarLinksRequest _buildRequest() {
        return this.request;
    }
    
    public ListCalendarLinksRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ListCalendarLinksResponse> call() {
