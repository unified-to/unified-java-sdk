...
public class CreateTicketingNoteRequestBuilder {
    ...
    public CreateTicketingNoteRequestBuilder request(@Nonnull CreateTicketingNoteRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private CreateTicketingNoteRequest _buildRequest() {
        return this.request;
    }
    
    public CreateTicketingNoteRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<CreateTicketingNoteResponse> call() {
