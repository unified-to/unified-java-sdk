...
public class UpdateAtsJobRequest {
    ...
    public UpdateAtsJobRequest(
            ...
            String connectionId,
            String id) {
        this(atsJob, connectionId, Optional.empty(), id, Optional.empty());
    }
     ...
     * Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public UpdateAtsJobRequest withRaw(String raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Raw parameters to include in the 3rd-party request. Encoded as a URL component. eg. raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public UpdateAtsJobRequest withRaw(Optional<String> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
