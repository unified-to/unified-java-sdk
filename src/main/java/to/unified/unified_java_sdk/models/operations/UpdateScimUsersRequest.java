...
public class UpdateScimUsersRequest {
    ...
    public UpdateScimUsersRequest withScimUser(@Nonnull ScimUser scimUser) {
     ...
     * ID of the connection
     */
    public UpdateScimUsersRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * ID of the User
     */
    public UpdateScimUsersRequest withId(@Nonnull String id) {
