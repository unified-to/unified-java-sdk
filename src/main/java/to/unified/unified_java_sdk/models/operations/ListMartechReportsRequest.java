...
public class ListMartechReportsRequest {
    ...
    private List<ListMartechReportsQueryParamFields> fields;
    ...
    @JsonCreator
    public ListMartechReportsRequest(
            @Nullable String campaignId,
            @Nonnull String connectionId,
            @Nullable String endLt,
            @Nullable List<ListMartechReportsQueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListMartechReportsQueryParamFields>> fields() {
     ...
     * The campaign ID to filter by
     */
    public ListMartechReportsRequest withCampaignId(@Nullable String campaignId) {
        this.campaignId = campaignId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListMartechReportsRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListMartechReportsRequest withEndLt(@Nullable String endLt) {
        this.endLt = endLt;
        return this;
    }
     ...
     * Fields to return
     */
    public ListMartechReportsRequest withFields(@Nullable List<ListMartechReportsQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListMartechReportsRequest withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }
     ...
     * The list ID to filter by
     */
    public ListMartechReportsRequest withListId(@Nullable String listId) {
        this.listId = listId;
        return this;
    }


    public ListMartechReportsRequest withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListMartechReportsRequest withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListMartechReportsRequest withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListMartechReportsRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListMartechReportsRequest withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * The start date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListMartechReportsRequest withStartGte(@Nullable String startGte) {
        this.startGte = startGte;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListMartechReportsRequest withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListMartechReportsRequest other = (ListMartechReportsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListMartechReportsRequest.class,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListMartechReportsQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListMartechReportsRequest build() {
            return new ListMartechReportsRequest(
                campaignId, connectionId, endLt,
                fields, limit, listId,
                offset, order, query,
                raw, sort, startGte,
