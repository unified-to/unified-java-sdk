...
public class GetAccountingOrderResponse implements Response {
     ...
     * Successful
     */
    public GetAccountingOrderResponse withAccountingOrder(@Nullable AccountingOrder accountingOrder) {
        this.accountingOrder = accountingOrder;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public GetAccountingOrderResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetAccountingOrderResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
