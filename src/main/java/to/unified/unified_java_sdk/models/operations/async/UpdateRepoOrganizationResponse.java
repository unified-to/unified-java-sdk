...
public class UpdateRepoOrganizationResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateRepoOrganizationResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
