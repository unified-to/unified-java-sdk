...
public class RemoveAccountingBillRequestBuilder {
    ...
    public RemoveAccountingBillRequestBuilder request(@Nonnull RemoveAccountingBillRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemoveAccountingBillRequest _buildRequest() {
        return this.request;
    }
    
    public RemoveAccountingBillRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<RemoveAccountingBillResponse> call() {
