...
public class ListCalendarBusiesRequestBuilder {
    ...
    public ListCalendarBusiesRequestBuilder request(@Nonnull ListCalendarBusiesRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListCalendarBusiesRequest _buildRequest() {
        return this.request;
    }
    
    public ListCalendarBusiesRequestBuilder header(String name, String value) {
