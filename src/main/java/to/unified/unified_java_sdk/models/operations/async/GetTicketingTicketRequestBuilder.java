...
public class GetTicketingTicketRequestBuilder {
    ...
    public GetTicketingTicketRequestBuilder request(@Nonnull GetTicketingTicketRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetTicketingTicketRequest _buildRequest() {
        return this.request;
    }
    
    public GetTicketingTicketRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetTicketingTicketResponse> call() {
