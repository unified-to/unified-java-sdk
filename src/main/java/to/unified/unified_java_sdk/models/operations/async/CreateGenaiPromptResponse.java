...
public class CreateGenaiPromptResponse implements AsyncResponse {
     ...
     * HTTP response content type for this operation
     */
    public CreateGenaiPromptResponse withContentType(@Nonnull String contentType) {
     ...
     * Successful
     */
    public CreateGenaiPromptResponse withGenaiPrompt(@Nullable GenaiPrompt genaiPrompt) {
        this.genaiPrompt = genaiPrompt;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateGenaiPromptResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
