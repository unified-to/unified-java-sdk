...
public class RemovePaymentLinkRequestBuilder {
    ...
    public RemovePaymentLinkRequestBuilder request(@Nonnull RemovePaymentLinkRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemovePaymentLinkRequest _buildRequest() {
        return this.request;
    }
    
    public RemovePaymentLinkRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<RemovePaymentLinkResponse> call() {
