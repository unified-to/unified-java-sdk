...
public enum PatchVerificationRequestQueryParamFields {
    ...
    PatchVerificationRequestQueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<PatchVerificationRequestQueryParamFields> fromValue(String value) {
        for (PatchVerificationRequestQueryParamFields o: PatchVerificationRequestQueryParamFields.values()) {
