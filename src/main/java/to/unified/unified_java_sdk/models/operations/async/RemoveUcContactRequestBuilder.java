...
public class RemoveUcContactRequestBuilder {
    ...
    public RemoveUcContactRequestBuilder request(@Nonnull RemoveUcContactRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemoveUcContactRequest _buildRequest() {
        return this.request;
    }
    
    public RemoveUcContactRequestBuilder header(String name, String value) {
