...
public class ListPaymentSubscriptionsRequestBuilder {
    ...
    public ListPaymentSubscriptionsRequestBuilder request(@Nonnull ListPaymentSubscriptionsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListPaymentSubscriptionsRequest _buildRequest() {
        return this.request;
    }
    
    public ListPaymentSubscriptionsRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ListPaymentSubscriptionsResponse> call() {
