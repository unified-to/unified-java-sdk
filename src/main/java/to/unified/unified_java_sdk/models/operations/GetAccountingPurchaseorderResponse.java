...
public class GetAccountingPurchaseorderResponse implements Response {
     ...
     * Successful
     */
    public GetAccountingPurchaseorderResponse withAccountingPurchaseorder(AccountingPurchaseorder accountingPurchaseorder) {
        Utils.checkNotNull(accountingPurchaseorder, "accountingPurchaseorder");
     ...
     * Successful
     */
    public GetAccountingPurchaseorderResponse withAccountingPurchaseorder(Optional<? extends AccountingPurchaseorder> accountingPurchaseorder) {
        Utils.checkNotNull(accountingPurchaseorder, "accountingPurchaseorder");
        this.accountingPurchaseorder = accountingPurchaseorder;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public GetAccountingPurchaseorderResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetAccountingPurchaseorderResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
