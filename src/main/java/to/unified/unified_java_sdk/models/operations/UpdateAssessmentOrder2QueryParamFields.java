...
public enum UpdateAssessmentOrder2QueryParamFields {
    ...
    UpdateAssessmentOrder2QueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<UpdateAssessmentOrder2QueryParamFields> fromValue(String value) {
        for (UpdateAssessmentOrder2QueryParamFields o: UpdateAssessmentOrder2QueryParamFields.values()) {
