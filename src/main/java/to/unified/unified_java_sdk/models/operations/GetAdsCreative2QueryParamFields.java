...
public enum GetAdsCreative2QueryParamFields {
    ...
    GetAdsCreative2QueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetAdsCreative2QueryParamFields> fromValue(String value) {
        for (GetAdsCreative2QueryParamFields o: GetAdsCreative2QueryParamFields.values()) {
