...
public class UpdateCommerceItemRequest {
    ...
    private List<UpdateCommerceItemQueryParamFields> fields;
    ...
    public UpdateCommerceItemRequest(
            ...
            @Nullable List<UpdateCommerceItemQueryParamFields> fields,
            @Nonnull String id,
            @Nullable String raw) {
    ...
    public UpdateCommerceItemRequest withCommerceItem(@Nonnull CommerceItem commerceItem) {
     ...
     * ID of the connection
     */
    public UpdateCommerceItemRequest withConnectionId(@Nonnull String connectionId) {
     ...
     * Fields to return
     */
    public UpdateCommerceItemRequest withFields(@Nullable List<UpdateCommerceItemQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }
     ...
     * ID of the Item
     */
    public UpdateCommerceItemRequest withId(@Nonnull String id) {
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public UpdateCommerceItemRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<UpdateCommerceItemQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
