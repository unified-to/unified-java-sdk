...
public class PatchTaskCommentResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public PatchTaskCommentResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PatchTaskCommentResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
     ...
     * Successful
     */
    public PatchTaskCommentResponse withTaskComment(@Nullable TaskComment taskComment) {
        this.taskComment = taskComment;
        return this;
    }
