...
public class PatchLmsStudentResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public PatchLmsStudentResponse withContentType(@Nonnull String contentType) {
     ...
     * Successful
     */
    public PatchLmsStudentResponse withLmsStudent(@Nullable LmsStudent lmsStudent) {
        this.lmsStudent = lmsStudent;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PatchLmsStudentResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
