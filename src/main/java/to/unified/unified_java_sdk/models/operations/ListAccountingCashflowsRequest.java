...
public class ListAccountingCashflowsRequest {
     ...
     * ID of the connection
     */
    public ListAccountingCashflowsRequest withConnectionId(String connectionId) {
        Utils.checkNotNull(connectionId, "connectionId");
        this.connectionId = connectionId;
        return this;
    }
    ...
    public ListAccountingCashflowsRequest withLimit(double limit) {
        Utils.checkNotNull(limit, "limit");
    ...
    public ListAccountingCashflowsRequest withLimit(Optional<Double> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }

    public ListAccountingCashflowsRequest withOffset(double offset) {
        Utils.checkNotNull(offset, "offset");
    ...
    public ListAccountingCashflowsRequest withOffset(Optional<Double> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public ListAccountingCashflowsRequest withOrder(String order) {
        Utils.checkNotNull(order, "order");
    ...
    public ListAccountingCashflowsRequest withOrder(Optional<String> order) {
        Utils.checkNotNull(order, "order");
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListAccountingCashflowsRequest withQuery(String query) {
        Utils.checkNotNull(query, "query");
     ...
     * Query string to search. eg. email address or name
     */
    public ListAccountingCashflowsRequest withQuery(Optional<String> query) {
        Utils.checkNotNull(query, "query");
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAccountingCashflowsRequest withRaw(String raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAccountingCashflowsRequest withRaw(Optional<String> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }

    public ListAccountingCashflowsRequest withSort(String sort) {
        Utils.checkNotNull(sort, "sort");
    ...
    public ListAccountingCashflowsRequest withSort(Optional<String> sort) {
        Utils.checkNotNull(sort, "sort");
        this.sort = sort;
        return this;
    }
