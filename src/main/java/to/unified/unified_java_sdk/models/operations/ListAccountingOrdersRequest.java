...
public class ListAccountingOrdersRequest {
     ...
     * Fields to return
     */
    public ListAccountingOrdersRequest withFields(@Nullable List<ListAccountingOrdersQueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListAccountingOrdersRequest withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListAccountingOrdersRequest withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListAccountingOrdersRequest withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * The org ID to filter by (reference to AccountingOrganization)
     */
    public ListAccountingOrdersRequest withOrgId(@Nullable String orgId) {
        this.orgId = orgId;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListAccountingOrdersRequest withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListAccountingOrdersRequest withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListAccountingOrdersRequest withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }


    public ListAccountingOrdersRequest withType(@Nullable String type) {
        this.type = type;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListAccountingOrdersRequest withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListAccountingOrdersQueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
