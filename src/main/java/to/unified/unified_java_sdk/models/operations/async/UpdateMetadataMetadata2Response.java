...
public class UpdateMetadataMetadata2Response implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateMetadataMetadata2Response withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
