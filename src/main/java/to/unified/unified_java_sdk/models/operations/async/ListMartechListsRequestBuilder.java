...
public class ListMartechListsRequestBuilder {
    ...
    public ListMartechListsRequestBuilder request(@Nonnull ListMartechListsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListMartechListsRequest _buildRequest() {
        return this.request;
    }
    
    public ListMartechListsRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ListMartechListsResponse> call() {
