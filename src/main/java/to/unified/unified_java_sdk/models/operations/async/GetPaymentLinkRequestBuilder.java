...
public class GetPaymentLinkRequestBuilder {
    ...
    public GetPaymentLinkRequestBuilder request(@Nonnull GetPaymentLinkRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetPaymentLinkRequest _buildRequest() {
        return this.request;
    }
    
    public GetPaymentLinkRequestBuilder header(String name, String value) {
