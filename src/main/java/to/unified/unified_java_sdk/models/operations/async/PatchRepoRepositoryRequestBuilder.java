...
public class PatchRepoRepositoryRequestBuilder {
    ...
    public PatchRepoRepositoryRequestBuilder request(@Nonnull PatchRepoRepositoryRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private PatchRepoRepositoryRequest _buildRequest() {
        return this.request;
    }
    
    public PatchRepoRepositoryRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<PatchRepoRepositoryResponse> call() {
