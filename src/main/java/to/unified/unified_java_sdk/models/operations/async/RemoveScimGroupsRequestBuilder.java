...
public class RemoveScimGroupsRequestBuilder {
    ...
    public RemoveScimGroupsRequestBuilder request(@Nonnull RemoveScimGroupsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private RemoveScimGroupsRequest _buildRequest() {
        return this.request;
    }
    
    public RemoveScimGroupsRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<RemoveScimGroupsResponse> call() {
