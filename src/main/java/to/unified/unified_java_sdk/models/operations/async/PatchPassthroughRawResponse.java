...
public class PatchPassthroughRawResponse implements AsyncResponse {
     ...
     * HTTP response content type for this operation
     */
    public PatchPassthroughRawResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }

    public PatchPassthroughRawResponse withHeaders(Map<String, List<String>> headers) {
        Utils.checkNotNull(headers, "headers");
        this.headers = headers;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PatchPassthroughRawResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Successful
     */
    public PatchPassthroughRawResponse withDefaultWildcardWildcardResponseStream(Blob defaultWildcardWildcardResponseStream) {
        Utils.checkNotNull(defaultWildcardWildcardResponseStream, "defaultWildcardWildcardResponseStream");
     ...
     * Successful
     */
    public PatchPassthroughRawResponse withDefaultWildcardWildcardResponseStream(Optional<? extends Blob> defaultWildcardWildcardResponseStream) {
        Utils.checkNotNull(defaultWildcardWildcardResponseStream, "defaultWildcardWildcardResponseStream");
        this.defaultWildcardWildcardResponseStream = defaultWildcardWildcardResponseStream;
        return this;
    }
