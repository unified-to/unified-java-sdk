...
public class ListCrmDeals2Request {
    ...
    private List<ListCrmDeals2QueryParamFields> fields;
    ...
    @JsonCreator
    public ListCrmDeals2Request(
            @Nullable String companyId,
            @Nonnull String connectionId,
            @Nullable String contactId,
            @Nullable List<ListCrmDeals2QueryParamFields> fields,
     ...
     * Fields to return
     */
    public Optional<List<ListCrmDeals2QueryParamFields>> fields() {
     ...
     * The company ID to filter by (reference to CrmCompany)
     */
    public ListCrmDeals2Request withCompanyId(@Nullable String companyId) {
        this.companyId = companyId;
        return this;
    }
     ...
     * ID of the connection
     */
    public ListCrmDeals2Request withConnectionId(@Nonnull String connectionId) {
     ...
     * The contact ID to filter by (reference to CrmContact)
     */
    public ListCrmDeals2Request withContactId(@Nullable String contactId) {
        this.contactId = contactId;
        return this;
    }
     ...
     * Fields to return
     */
    public ListCrmDeals2Request withFields(@Nullable List<ListCrmDeals2QueryParamFields> fields) {
        this.fields = fields;
        return this;
    }


    public ListCrmDeals2Request withLimit(@Nullable Double limit) {
        this.limit = limit;
        return this;
    }


    public ListCrmDeals2Request withOffset(@Nullable Double offset) {
        this.offset = offset;
        return this;
    }


    public ListCrmDeals2Request withOrder(@Nullable String order) {
        this.order = order;
        return this;
    }
     ...
     * The pipeline ID to filter by
     */
    public ListCrmDeals2Request withPipelineId(@Nullable String pipelineId) {
        this.pipelineId = pipelineId;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListCrmDeals2Request withQuery(@Nullable String query) {
        this.query = query;
        return this;
    }
     ...
     * <p>raw parameters: foo=bar&amp;zoo=bar -&gt; raw=foo%3Dbar%26zoo%3Dbar
     */
    public ListCrmDeals2Request withRaw(@Nullable String raw) {
        this.raw = raw;
        return this;
    }


    public ListCrmDeals2Request withSort(@Nullable String sort) {
        this.sort = sort;
        return this;
    }
     ...
     * YYYY-MM-DDTHH:MM:SSZ format)
     */
    public ListCrmDeals2Request withUpdatedGte(@Nullable String updatedGte) {
        this.updatedGte = updatedGte;
        return this;
    }
     ...
     * The user/employee ID to filter by (reference to HrisEmployee)
     */
    public ListCrmDeals2Request withUserId(@Nullable String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListCrmDeals2Request other = (ListCrmDeals2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListCrmDeals2Request.class,
                "companyId", companyId,
    ...
    public final static class Builder {
         ...
         * Fields to return
         */
        public Builder fields(@Nullable List<ListCrmDeals2QueryParamFields> fields) {
            this.fields = fields;
            return this;
        }
        ...
        public ListCrmDeals2Request build() {
            return new ListCrmDeals2Request(
                companyId, connectionId, contactId,
                fields, limit, offset,
                order, pipelineId, query,
                raw, sort, updatedGte,
