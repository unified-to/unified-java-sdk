...
public class ListPaymentPayoutsResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListPaymentPayoutsResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
