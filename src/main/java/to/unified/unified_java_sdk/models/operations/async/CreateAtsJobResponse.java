...
public class CreateAtsJobResponse implements AsyncResponse {
    /**
     * Successful
     */
     ...
     * Successful
     */
    public CreateAtsJobResponse withAtsJob(@Nullable AtsJob atsJob) {
        this.atsJob = atsJob;
        return this;
    }
     ...
     * HTTP response content type for this operation
     */
    public CreateAtsJobResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateAtsJobResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
