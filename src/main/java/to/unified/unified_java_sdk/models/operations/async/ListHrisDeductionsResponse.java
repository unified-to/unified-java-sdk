...
public class ListHrisDeductionsResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListHrisDeductionsResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
