...
public class UpdatePassthrough2RawResponse implements Response {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdatePassthrough2RawResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Successful
     */
    public UpdatePassthrough2RawResponse withDefaultWildcardWildcardResponseStream(@Nullable InputStream defaultWildcardWildcardResponseStream) {
        this.defaultWildcardWildcardResponseStream = defaultWildcardWildcardResponseStream;
        return this;
    }
