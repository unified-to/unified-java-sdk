...
public enum ListAccountingProfitlossesQueryParamFields {
    ...
    ListAccountingProfitlossesQueryParamFields(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListAccountingProfitlossesQueryParamFields> fromValue(String value) {
        for (ListAccountingProfitlossesQueryParamFields o: ListAccountingProfitlossesQueryParamFields.values()) {
