...
public class GetKmsPageRequestBuilder {
    ...
    public GetKmsPageRequestBuilder request(@Nonnull GetKmsPageRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetKmsPageRequest _buildRequest() {
        return this.request;
    }
    
    public GetKmsPageRequestBuilder header(String name, String value) {
