...
public class PropertyHrisLocationAddress {
    ...
    public PropertyHrisLocationAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }


    public PropertyHrisLocationAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }


    public PropertyHrisLocationAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }


    public PropertyHrisLocationAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }


    public PropertyHrisLocationAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }


    public PropertyHrisLocationAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }


    public PropertyHrisLocationAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }


    public PropertyHrisLocationAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PropertyHrisLocationAddress other = (PropertyHrisLocationAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PropertyHrisLocationAddress.class,
                "address1", address1,
                "address2", address2,
                "city", city,
                "country", country,
