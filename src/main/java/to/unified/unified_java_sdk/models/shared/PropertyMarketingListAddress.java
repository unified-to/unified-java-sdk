...
public class PropertyMarketingListAddress {
    ...
    public PropertyMarketingListAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }


    public PropertyMarketingListAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }


    public PropertyMarketingListAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }


    public PropertyMarketingListAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }


    public PropertyMarketingListAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }


    public PropertyMarketingListAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }


    public PropertyMarketingListAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PropertyMarketingListAddress other = (PropertyMarketingListAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PropertyMarketingListAddress.class,
                "address1", address1,
                "address2", address2,
                "city", city,
                "country", country,
