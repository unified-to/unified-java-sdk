...
public class PropertyAdsReportMetricsGroupTargetingDevice {
    ...
    public PropertyAdsReportMetricsGroupTargetingDevice withCarriers(@Nullable List<String> carriers) {
        this.carriers = carriers;
        return this;
    }


    public PropertyAdsReportMetricsGroupTargetingDevice withTypes(@Nullable List<String> types) {
        this.types = types;
        return this;
    }


    public PropertyAdsReportMetricsGroupTargetingDevice withUserDevice(@Nullable List<String> userDevice) {
        this.userDevice = userDevice;
        return this;
    }


    public PropertyAdsReportMetricsGroupTargetingDevice withUserOs(@Nullable List<String> userOs) {
        this.userOs = userOs;
        return this;
    }
