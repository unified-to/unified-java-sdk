...
public class PropertyAccountingContactBillingAddress {
    ...
    public PropertyAccountingContactBillingAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }


    public PropertyAccountingContactBillingAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }


    public PropertyAccountingContactBillingAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }


    public PropertyAccountingContactBillingAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }


    public PropertyAccountingContactBillingAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }


    public PropertyAccountingContactBillingAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }


    public PropertyAccountingContactBillingAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }


    public PropertyAccountingContactBillingAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
