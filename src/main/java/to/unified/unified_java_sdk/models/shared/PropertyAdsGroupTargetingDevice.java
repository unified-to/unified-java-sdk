...
public class PropertyAdsGroupTargetingDevice {
    ...
    public PropertyAdsGroupTargetingDevice withCarriers(@Nullable List<DeviceTarget> carriers) {
        this.carriers = carriers;
        return this;
    }


    public PropertyAdsGroupTargetingDevice withTypes(@Nullable List<DeviceTarget> types) {
        this.types = types;
        return this;
    }


    public PropertyAdsGroupTargetingDevice withUserDevice(@Nullable List<DeviceTarget> userDevice) {
        this.userDevice = userDevice;
        return this;
    }


    public PropertyAdsGroupTargetingDevice withUserOs(@Nullable List<DeviceTarget> userOs) {
        this.userOs = userOs;
        return this;
    }
