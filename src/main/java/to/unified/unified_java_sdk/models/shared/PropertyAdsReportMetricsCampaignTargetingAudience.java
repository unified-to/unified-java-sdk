...
public class PropertyAdsReportMetricsCampaignTargetingAudience {
    ...
    public PropertyAdsReportMetricsCampaignTargetingAudience withBehaviors(@Nullable List<TargetRef> behaviors) {
        this.behaviors = behaviors;
        return this;
    }
    ...
    public PropertyAdsReportMetricsCampaignTargetingAudience withCustomAudiences(@Nullable List<TargetRef> customAudiences) {
        this.customAudiences = customAudiences;
        return this;
    }


    public PropertyAdsReportMetricsCampaignTargetingAudience withExcludedBehaviors(@Nullable List<TargetRef> excludedBehaviors) {
        this.excludedBehaviors = excludedBehaviors;
        return this;
    }


    public PropertyAdsReportMetricsCampaignTargetingAudience withExcludedCustomAudiences(@Nullable List<TargetRef> excludedCustomAudiences) {
        this.excludedCustomAudiences = excludedCustomAudiences;
        return this;
    }


    public PropertyAdsReportMetricsCampaignTargetingAudience withExcludedInterests(@Nullable List<TargetRef> excludedInterests) {
        this.excludedInterests = excludedInterests;
        return this;
    }


    public PropertyAdsReportMetricsCampaignTargetingAudience withInterests(@Nullable List<TargetRef> interests) {
        this.interests = interests;
        return this;
    }
