...
public class PropertyMessagingMessageAuthorMember {
    ...
    public PropertyMessagingMessageAuthorMember withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
    ...
    public PropertyMessagingMessageAuthorMember withUserId(Optional<String> userId) {
        Utils.checkNotNull(userId, "userId");
        this.userId = userId;
        return this;
    }
