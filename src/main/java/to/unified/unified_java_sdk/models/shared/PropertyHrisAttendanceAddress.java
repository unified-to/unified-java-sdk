...
public class PropertyHrisAttendanceAddress {
    ...
    @JsonCreator
    public PropertyHrisAttendanceAddress(
    ...
    public PropertyHrisAttendanceAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }


    public PropertyHrisAttendanceAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }


    public PropertyHrisAttendanceAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }


    public PropertyHrisAttendanceAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }


    public PropertyHrisAttendanceAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }


    public PropertyHrisAttendanceAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }


    public PropertyHrisAttendanceAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }


    public PropertyHrisAttendanceAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PropertyHrisAttendanceAddress other = (PropertyHrisAttendanceAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PropertyHrisAttendanceAddress.class,
                "address1", address1,
                "address2", address2,
                "city", city,
                "country", country,
    ...
    public final static class Builder {
        ...
        public PropertyHrisAttendanceAddress build() {
            return new PropertyHrisAttendanceAddress(
                address1, address2, city,
                country, countryCode, postalCode,
                region, regionCode);
        }
