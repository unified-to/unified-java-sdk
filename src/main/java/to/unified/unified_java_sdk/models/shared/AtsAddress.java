...
public class AtsAddress {
    ...
    public AtsAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }


    public AtsAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }


    public AtsAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }


    public AtsAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }


    public AtsAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }


    public AtsAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }


    public AtsAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }


    public AtsAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
