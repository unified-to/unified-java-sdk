...
public class PropertyClubsGroupAddress {
    ...
    @JsonCreator
    public PropertyClubsGroupAddress(
    ...
    public PropertyClubsGroupAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }


    public PropertyClubsGroupAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }


    public PropertyClubsGroupAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }


    public PropertyClubsGroupAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }


    public PropertyClubsGroupAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }


    public PropertyClubsGroupAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }


    public PropertyClubsGroupAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }


    public PropertyClubsGroupAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PropertyClubsGroupAddress other = (PropertyClubsGroupAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PropertyClubsGroupAddress.class,
                "address1", address1,
                "address2", address2,
                "city", city,
                "country", country,
    ...
    public final static class Builder {
        ...
        public PropertyClubsGroupAddress build() {
            return new PropertyClubsGroupAddress(
                address1, address2, city,
                country, countryCode, postalCode,
                region, regionCode);
        }
