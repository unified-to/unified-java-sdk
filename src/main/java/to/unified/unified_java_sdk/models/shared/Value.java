...
public class Value {
    ...
    public static Value of(List<AccountingMetadata5> value) {
        Utils.checkNotNull(value, "value");
        return new Value(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }
     ...
     * <li>{@code double}</li>
     * <li>{@code boolean}</li>
     * <li>{@code java.util.List<to.unified.unified_java_sdk.models.shared.AccountingMetadata5>}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<Value> {
        ...
        public _Deserializer() {
            super(Value.class, false,
                  ...
                  TypeReferenceWithShape.of(new TypeReference<List<AccountingMetadata5>>() {}, JsonShape.DEFAULT));
        }
    }
