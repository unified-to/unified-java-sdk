...
public class PropertyClubsLocationAddress {
    ...
    @JsonCreator
    public PropertyClubsLocationAddress(
    ...
    public PropertyClubsLocationAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }


    public PropertyClubsLocationAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }


    public PropertyClubsLocationAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }


    public PropertyClubsLocationAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }


    public PropertyClubsLocationAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }


    public PropertyClubsLocationAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }


    public PropertyClubsLocationAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }


    public PropertyClubsLocationAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PropertyClubsLocationAddress other = (PropertyClubsLocationAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PropertyClubsLocationAddress.class,
                "address1", address1,
                "address2", address2,
                "city", city,
                "country", country,
    ...
    public final static class Builder {
        ...
        public PropertyClubsLocationAddress build() {
            return new PropertyClubsLocationAddress(
                address1, address2, city,
                country, countryCode, postalCode,
                region, regionCode);
        }
