...
public class PropertyAccountingOrderShippingAddress {
    ...
    public PropertyAccountingOrderShippingAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }


    public PropertyAccountingOrderShippingAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }


    public PropertyAccountingOrderShippingAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }


    public PropertyAccountingOrderShippingAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }


    public PropertyAccountingOrderShippingAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }


    public PropertyAccountingOrderShippingAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }


    public PropertyAccountingOrderShippingAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }


    public PropertyAccountingOrderShippingAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
