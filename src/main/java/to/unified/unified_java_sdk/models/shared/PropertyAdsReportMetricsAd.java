...
public class PropertyAdsReportMetricsAd {
    ...
    public PropertyAdsReportMetricsAd withDisplayUrl(@Nullable String displayUrl) {
        this.displayUrl = displayUrl;
        return this;
    }
    ...
    public PropertyAdsReportMetricsAd withPath1(@Nullable String path1) {
        this.path1 = path1;
        return this;
    }


    public PropertyAdsReportMetricsAd withPath2(@Nullable String path2) {
        this.path2 = path2;
        return this;
    }
