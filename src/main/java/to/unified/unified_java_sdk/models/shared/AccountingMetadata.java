...
public class AccountingMetadata {
    ...
    public AccountingMetadata withExtraData(@Nullable ExtraData extraData) {
        this.extraData = extraData;
        return this;
    }


    public AccountingMetadata withFormat(@Nullable Format format) {
        this.format = format;
        return this;
    }


    public AccountingMetadata withId(@Nullable String id) {
        this.id = id;
        return this;
    }


    public AccountingMetadata withNamespace(@Nullable String namespace) {
        this.namespace = namespace;
        return this;
    }


    public AccountingMetadata withSlug(@Nullable String slug) {
        this.slug = slug;
        return this;
    }


    public AccountingMetadata withValue(@Nullable Value value) {
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountingMetadata other = (AccountingMetadata) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AccountingMetadata.class,
                "extraData", extraData,
                "format", format,
                "id", id,
                "namespace", namespace,
    ...
    public final static class Builder {
        ...
        public AccountingMetadata build() {
            return new AccountingMetadata(
                extraData, format, id,
                namespace, slug, value);
        }
