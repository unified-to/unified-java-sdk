...
public class PropertyCrmContactAddress {
    ...
    @JsonCreator
    public PropertyCrmContactAddress(
    ...
    public PropertyCrmContactAddress withAddress1(String address1) {
        Utils.checkNotNull(address1, "address1");
    ...
    public PropertyCrmContactAddress withAddress1(Optional<String> address1) {
        Utils.checkNotNull(address1, "address1");
        this.address1 = address1;
        return this;
    }

    public PropertyCrmContactAddress withAddress2(String address2) {
        Utils.checkNotNull(address2, "address2");
    ...
    public PropertyCrmContactAddress withAddress2(Optional<String> address2) {
        Utils.checkNotNull(address2, "address2");
        this.address2 = address2;
        return this;
    }

    public PropertyCrmContactAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
    ...
    public PropertyCrmContactAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }

    public PropertyCrmContactAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
    ...
    public PropertyCrmContactAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }

    public PropertyCrmContactAddress withCountryCode(String countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
    ...
    public PropertyCrmContactAddress withCountryCode(Optional<String> countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }

    public PropertyCrmContactAddress withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
    ...
    public PropertyCrmContactAddress withPostalCode(Optional<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }

    public PropertyCrmContactAddress withRegion(String region) {
        Utils.checkNotNull(region, "region");
    ...
    public PropertyCrmContactAddress withRegion(Optional<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }

    public PropertyCrmContactAddress withRegionCode(String regionCode) {
        Utils.checkNotNull(regionCode, "regionCode");
    ...
    public PropertyCrmContactAddress withRegionCode(Optional<String> regionCode) {
        Utils.checkNotNull(regionCode, "regionCode");
        this.regionCode = regionCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PropertyCrmContactAddress other = (PropertyCrmContactAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PropertyCrmContactAddress.class,
                "address1", address1,
                "address2", address2,
                "city", city,
                "country", country,
    ...
    public final static class Builder {
        ...
        public PropertyCrmContactAddress build() {

            return new PropertyCrmContactAddress(
                address1, address2, city,
                country, countryCode, postalCode,
                region, regionCode);
        }
