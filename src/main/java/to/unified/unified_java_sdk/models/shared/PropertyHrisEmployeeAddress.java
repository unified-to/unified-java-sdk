...
public class PropertyHrisEmployeeAddress {
    ...
    @JsonCreator
    public PropertyHrisEmployeeAddress(
    ...
    public PropertyHrisEmployeeAddress withAddress1(String address1) {
        Utils.checkNotNull(address1, "address1");
        this.address1 = Optional.ofNullable(address1);
        return this;
    }

    public PropertyHrisEmployeeAddress withAddress1(Optional<String> address1) {
        Utils.checkNotNull(address1, "address1");
        this.address1 = address1;
        return this;
    }

    public PropertyHrisEmployeeAddress withAddress2(String address2) {
        Utils.checkNotNull(address2, "address2");
        this.address2 = Optional.ofNullable(address2);
        return this;
    }

    public PropertyHrisEmployeeAddress withAddress2(Optional<String> address2) {
        Utils.checkNotNull(address2, "address2");
        this.address2 = address2;
        return this;
    }

    public PropertyHrisEmployeeAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
        this.city = Optional.ofNullable(city);
        return this;
    }

    public PropertyHrisEmployeeAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }

    public PropertyHrisEmployeeAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
        this.country = Optional.ofNullable(country);
        return this;
    }

    public PropertyHrisEmployeeAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }

    public PropertyHrisEmployeeAddress withCountryCode(String countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = Optional.ofNullable(countryCode);
        return this;
    }

    public PropertyHrisEmployeeAddress withCountryCode(Optional<String> countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }

    public PropertyHrisEmployeeAddress withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = Optional.ofNullable(postalCode);
        return this;
    }

    public PropertyHrisEmployeeAddress withPostalCode(Optional<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }

    public PropertyHrisEmployeeAddress withRegion(String region) {
        Utils.checkNotNull(region, "region");
        this.region = Optional.ofNullable(region);
        return this;
    }

    public PropertyHrisEmployeeAddress withRegion(Optional<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }

    public PropertyHrisEmployeeAddress withRegionCode(String regionCode) {
        Utils.checkNotNull(regionCode, "regionCode");
        this.regionCode = Optional.ofNullable(regionCode);
        return this;
    }

    public PropertyHrisEmployeeAddress withRegionCode(Optional<String> regionCode) {
        Utils.checkNotNull(regionCode, "regionCode");
        this.regionCode = regionCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PropertyHrisEmployeeAddress other = (PropertyHrisEmployeeAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PropertyHrisEmployeeAddress.class,
                "address1", address1,
                "address2", address2,
                "city", city,
                "country", country,
    ...
    public final static class Builder {
        ...
        public PropertyHrisEmployeeAddress build() {
            return new PropertyHrisEmployeeAddress(
                address1,
                address2,
                city,
                country,
