...
public class PropertyAccountingContactShippingAddress {
    ...
    public PropertyAccountingContactShippingAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }


    public PropertyAccountingContactShippingAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }


    public PropertyAccountingContactShippingAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }


    public PropertyAccountingContactShippingAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }


    public PropertyAccountingContactShippingAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }


    public PropertyAccountingContactShippingAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }


    public PropertyAccountingContactShippingAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }


    public PropertyAccountingContactShippingAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
