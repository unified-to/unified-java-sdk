...
public class PropertyAtsJobPostingAddress {
    ...
    @JsonCreator
    public PropertyAtsJobPostingAddress(
    ...
    public PropertyAtsJobPostingAddress withAddress1(String address1) {
        Utils.checkNotNull(address1, "address1");
        this.address1 = Optional.ofNullable(address1);
        return this;
    }

    public PropertyAtsJobPostingAddress withAddress1(Optional<String> address1) {
        Utils.checkNotNull(address1, "address1");
        this.address1 = address1;
        return this;
    }

    public PropertyAtsJobPostingAddress withAddress2(String address2) {
        Utils.checkNotNull(address2, "address2");
        this.address2 = Optional.ofNullable(address2);
        return this;
    }

    public PropertyAtsJobPostingAddress withAddress2(Optional<String> address2) {
        Utils.checkNotNull(address2, "address2");
        this.address2 = address2;
        return this;
    }

    public PropertyAtsJobPostingAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
        this.city = Optional.ofNullable(city);
        return this;
    }

    public PropertyAtsJobPostingAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }

    public PropertyAtsJobPostingAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
        this.country = Optional.ofNullable(country);
        return this;
    }

    public PropertyAtsJobPostingAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }

    public PropertyAtsJobPostingAddress withCountryCode(String countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = Optional.ofNullable(countryCode);
        return this;
    }

    public PropertyAtsJobPostingAddress withCountryCode(Optional<String> countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }

    public PropertyAtsJobPostingAddress withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = Optional.ofNullable(postalCode);
        return this;
    }

    public PropertyAtsJobPostingAddress withPostalCode(Optional<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }

    public PropertyAtsJobPostingAddress withRegion(String region) {
        Utils.checkNotNull(region, "region");
        this.region = Optional.ofNullable(region);
        return this;
    }

    public PropertyAtsJobPostingAddress withRegion(Optional<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }

    public PropertyAtsJobPostingAddress withRegionCode(String regionCode) {
        Utils.checkNotNull(regionCode, "regionCode");
        this.regionCode = Optional.ofNullable(regionCode);
        return this;
    }

    public PropertyAtsJobPostingAddress withRegionCode(Optional<String> regionCode) {
        Utils.checkNotNull(regionCode, "regionCode");
        this.regionCode = regionCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PropertyAtsJobPostingAddress other = (PropertyAtsJobPostingAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PropertyAtsJobPostingAddress.class,
                "address1", address1,
                "address2", address2,
                "city", city,
                "country", country,
    ...
    public final static class Builder {
        ...
        public PropertyAtsJobPostingAddress build() {
            return new PropertyAtsJobPostingAddress(
                address1,
                address2,
                city,
                country,
