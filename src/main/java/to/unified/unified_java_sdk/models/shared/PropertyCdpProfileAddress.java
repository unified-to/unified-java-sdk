...
public class PropertyCdpProfileAddress {
    ...
    @JsonCreator
    public PropertyCdpProfileAddress(
    ...
    public PropertyCdpProfileAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }


    public PropertyCdpProfileAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }


    public PropertyCdpProfileAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }


    public PropertyCdpProfileAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }


    public PropertyCdpProfileAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }


    public PropertyCdpProfileAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }


    public PropertyCdpProfileAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }


    public PropertyCdpProfileAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PropertyCdpProfileAddress other = (PropertyCdpProfileAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PropertyCdpProfileAddress.class,
                "address1", address1,
                "address2", address2,
                "city", city,
                "country", country,
    ...
    public final static class Builder {
        ...
        public PropertyCdpProfileAddress build() {
            return new PropertyCdpProfileAddress(
                address1, address2, city,
                country, countryCode, postalCode,
                region, regionCode);
        }
