...
public class PropertyAccountingOrganizationAddress {
    ...
    public PropertyAccountingOrganizationAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }


    public PropertyAccountingOrganizationAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }


    public PropertyAccountingOrganizationAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }


    public PropertyAccountingOrganizationAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }


    public PropertyAccountingOrganizationAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }


    public PropertyAccountingOrganizationAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }


    public PropertyAccountingOrganizationAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }


    public PropertyAccountingOrganizationAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
