...
public class AccountingBalancesheet {
    ...
    public AccountingBalancesheet withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
    ...
    public AccountingBalancesheet withEndAt(OffsetDateTime endAt) {
        Utils.checkNotNull(endAt, "endAt");
    ...
    public AccountingBalancesheet withEquity(List<AccountingBalancesheetItem> equity) {
        Utils.checkNotNull(equity, "equity");
    ...
    public AccountingBalancesheet withId(String id) {
        Utils.checkNotNull(id, "id");
    ...
    public AccountingBalancesheet withLiabilities(List<AccountingBalancesheetItem> liabilities) {
        Utils.checkNotNull(liabilities, "liabilities");
    ...
    public AccountingBalancesheet withName(String name) {
        Utils.checkNotNull(name, "name");
    ...
    public AccountingBalancesheet withNetAssetsAmount(double netAssetsAmount) {
        Utils.checkNotNull(netAssetsAmount, "netAssetsAmount");
    ...
    public AccountingBalancesheet withRaw(Map<String, Object> raw) {
        Utils.checkNotNull(raw, "raw");
    ...
    public AccountingBalancesheet withStartAt(OffsetDateTime startAt) {
        Utils.checkNotNull(startAt, "startAt");
    ...
    public AccountingBalancesheet withUpdatedAt(OffsetDateTime updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
