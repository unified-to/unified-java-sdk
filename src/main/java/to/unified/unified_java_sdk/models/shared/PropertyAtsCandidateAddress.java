...
public class PropertyAtsCandidateAddress {
    ...
    public PropertyAtsCandidateAddress withAddress1(Optional<String> address1) {
        Utils.checkNotNull(address1, "address1");
        this.address1 = address1;
        return this;
    }
    ...
    public PropertyAtsCandidateAddress withAddress2(Optional<String> address2) {
        Utils.checkNotNull(address2, "address2");
        this.address2 = address2;
        return this;
    }
    ...
    public PropertyAtsCandidateAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
    ...
    public PropertyAtsCandidateAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    public PropertyAtsCandidateAddress withCountryCode(Optional<String> countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }
    ...
    public PropertyAtsCandidateAddress withPostalCode(Optional<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
    ...
    public PropertyAtsCandidateAddress withRegion(Optional<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
    ...
    public PropertyAtsCandidateAddress withRegionCode(Optional<String> regionCode) {
        Utils.checkNotNull(regionCode, "regionCode");
        this.regionCode = regionCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PropertyAtsCandidateAddress other = (PropertyAtsCandidateAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PropertyAtsCandidateAddress.class,
                "address1", address1,
                "address2", address2,
                "city", city,
                "country", country,
    ...
    public final static class Builder {
        ...
        public PropertyAtsCandidateAddress build() {
            return new PropertyAtsCandidateAddress(
                address1,
                address2,
                city,
                country,
