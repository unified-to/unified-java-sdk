...
public class PropertyEnrichCompanyAddress {
    ...
    public PropertyEnrichCompanyAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }


    public PropertyEnrichCompanyAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }


    public PropertyEnrichCompanyAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }


    public PropertyEnrichCompanyAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }


    public PropertyEnrichCompanyAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }


    public PropertyEnrichCompanyAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }


    public PropertyEnrichCompanyAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }


    public PropertyEnrichCompanyAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
