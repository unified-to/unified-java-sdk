...
public class PropertyEnrichPersonAddress {
    ...
    public PropertyEnrichPersonAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }


    public PropertyEnrichPersonAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }


    public PropertyEnrichPersonAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }


    public PropertyEnrichPersonAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }


    public PropertyEnrichPersonAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }


    public PropertyEnrichPersonAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }


    public PropertyEnrichPersonAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }


    public PropertyEnrichPersonAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PropertyEnrichPersonAddress other = (PropertyEnrichPersonAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PropertyEnrichPersonAddress.class,
                "address1", address1,
                "address2", address2,
                "city", city,
                "country", country,
