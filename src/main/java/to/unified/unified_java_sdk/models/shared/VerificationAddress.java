...
public class VerificationAddress {
    ...
    public VerificationAddress withAddress1(String address1) {
        Utils.checkNotNull(address1, "address1");
    ...
    public VerificationAddress withAddress1(Optional<String> address1) {
        Utils.checkNotNull(address1, "address1");
        this.address1 = address1;
        return this;
    }

    public VerificationAddress withAddress2(String address2) {
        Utils.checkNotNull(address2, "address2");
    ...
    public VerificationAddress withAddress2(Optional<String> address2) {
        Utils.checkNotNull(address2, "address2");
        this.address2 = address2;
        return this;
    }

    public VerificationAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
    ...
    public VerificationAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }

    public VerificationAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
    ...
    public VerificationAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }

    public VerificationAddress withCountryCode(String countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
    ...
    public VerificationAddress withCountryCode(Optional<String> countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }

    public VerificationAddress withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
    ...
    public VerificationAddress withPostalCode(Optional<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }

    public VerificationAddress withRegion(String region) {
        Utils.checkNotNull(region, "region");
    ...
    public VerificationAddress withRegion(Optional<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }

    public VerificationAddress withRegionCode(String regionCode) {
        Utils.checkNotNull(regionCode, "regionCode");
    ...
    public VerificationAddress withRegionCode(Optional<String> regionCode) {
        Utils.checkNotNull(regionCode, "regionCode");
        this.regionCode = regionCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VerificationAddress other = (VerificationAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VerificationAddress.class,
                "address1", address1,
                "address2", address2,
                "city", city,
                "country", country,
    ...
    public final static class Builder {
        ...
        public VerificationAddress build() {
