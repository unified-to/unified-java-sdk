...
public class VerificationAddress {
    ...
    public VerificationAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }


    public VerificationAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }


    public VerificationAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }


    public VerificationAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }


    public VerificationAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }


    public VerificationAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }


    public VerificationAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }


    public VerificationAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
