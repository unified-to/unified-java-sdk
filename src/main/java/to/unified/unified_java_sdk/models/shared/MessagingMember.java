...
public class MessagingMember {
    ...
    public MessagingMember withEmail(@Nullable String email) {
        this.email = email;
        return this;
    }


    public MessagingMember withImageUrl(@Nullable String imageUrl) {
        this.imageUrl = imageUrl;
        return this;
    }


    public MessagingMember withName(@Nullable String name) {
        this.name = name;
        return this;
    }


    public MessagingMember withUserId(@Nullable String userId) {
        this.userId = userId;
        return this;
    }
