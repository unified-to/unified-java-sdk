...
public class PropertyAdsCampaignTargetingAudience {
    ...
    @JsonCreator
    public PropertyAdsCampaignTargetingAudience(
    ...
    public PropertyAdsCampaignTargetingAudience withBehaviors(@Nullable List<AudienceSegment> behaviors) {
        this.behaviors = behaviors;
        return this;
    }


    public PropertyAdsCampaignTargetingAudience withCombinationSpec(@Nullable List<AudienceCombination> combinationSpec) {
        this.combinationSpec = combinationSpec;
        return this;
    }


    public PropertyAdsCampaignTargetingAudience withCustomAudiences(@Nullable List<AudienceSegment> customAudiences) {
        this.customAudiences = customAudiences;
        return this;
    }


    public PropertyAdsCampaignTargetingAudience withExcludedBehaviors(@Nullable List<AudienceSegment> excludedBehaviors) {
        this.excludedBehaviors = excludedBehaviors;
        return this;
    }


    public PropertyAdsCampaignTargetingAudience withExcludedCustomAudiences(@Nullable List<AudienceSegment> excludedCustomAudiences) {
        this.excludedCustomAudiences = excludedCustomAudiences;
        return this;
    }


    public PropertyAdsCampaignTargetingAudience withExcludedInterests(@Nullable List<AudienceSegment> excludedInterests) {
        this.excludedInterests = excludedInterests;
        return this;
    }


    public PropertyAdsCampaignTargetingAudience withInterests(@Nullable List<AudienceSegment> interests) {
        this.interests = interests;
        return this;
    }


    public PropertyAdsCampaignTargetingAudience withLookalikeAudiences(@Nullable List<LookalikeAudience> lookalikeAudiences) {
        this.lookalikeAudiences = lookalikeAudiences;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PropertyAdsCampaignTargetingAudience other = (PropertyAdsCampaignTargetingAudience) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PropertyAdsCampaignTargetingAudience.class,
                "behaviors", behaviors,
    ...
    public final static class Builder {
        ...
        public PropertyAdsCampaignTargetingAudience build() {
            return new PropertyAdsCampaignTargetingAudience(
                behaviors, combinationSpec, customAudiences,
                excludedBehaviors, excludedCustomAudiences, excludedInterests,
                interests, lookalikeAudiences);
        }
