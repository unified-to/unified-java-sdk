...
public class PropertyAdsCampaignTargetingAudience {
    ...
    public PropertyAdsCampaignTargetingAudience withBehaviors(@Nullable List<TargetRef> behaviors) {
        this.behaviors = behaviors;
        return this;
    }
    ...
    public PropertyAdsCampaignTargetingAudience withCustomAudiences(@Nullable List<TargetRef> customAudiences) {
        this.customAudiences = customAudiences;
        return this;
    }


    public PropertyAdsCampaignTargetingAudience withExcludedBehaviors(@Nullable List<TargetRef> excludedBehaviors) {
        this.excludedBehaviors = excludedBehaviors;
        return this;
    }


    public PropertyAdsCampaignTargetingAudience withExcludedCustomAudiences(@Nullable List<TargetRef> excludedCustomAudiences) {
        this.excludedCustomAudiences = excludedCustomAudiences;
        return this;
    }


    public PropertyAdsCampaignTargetingAudience withExcludedInterests(@Nullable List<TargetRef> excludedInterests) {
        this.excludedInterests = excludedInterests;
        return this;
    }


    public PropertyAdsCampaignTargetingAudience withInterests(@Nullable List<TargetRef> interests) {
        this.interests = interests;
        return this;
    }
