...
public class Three {
    ...
    public static Three of(AtsMetadataSchemasExtraData32 value) {
        Utils.checkNotNull(value, "value");
        return new Three(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<AtsMetadataSchemasExtraData32>(){}));
    }
     ...
     * <ul>
     * <li>{@code double}</li>
     * <li>{@code to.unified.unified_java_sdk.models.shared.AtsMetadataSchemasExtraData32}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<Three> {
        ...
        public _Deserializer() {
            super(Three.class, false,
                  ...
                  TypeReferenceWithShape.of(new TypeReference<AtsMetadataSchemasExtraData32>() {}, JsonShape.DEFAULT));
        }
    }
