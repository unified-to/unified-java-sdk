...
public class PropertyCommerceLocationAddress {
    ...
    public PropertyCommerceLocationAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }


    public PropertyCommerceLocationAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }


    public PropertyCommerceLocationAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }


    public PropertyCommerceLocationAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }


    public PropertyCommerceLocationAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }


    public PropertyCommerceLocationAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }


    public PropertyCommerceLocationAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }


    public PropertyCommerceLocationAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
