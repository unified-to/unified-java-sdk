...
public class AssessmentAddress {
    ...
    public AssessmentAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }


    public AssessmentAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }


    public AssessmentAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }


    public AssessmentAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }


    public AssessmentAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }


    public AssessmentAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }


    public AssessmentAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }


    public AssessmentAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AssessmentAddress other = (AssessmentAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AssessmentAddress.class,
                "address1", address1,
                "address2", address2,
                "city", city,
                "country", country,
    ...
    public final static class Builder {
        ...
        public AssessmentAddress build() {
            return new AssessmentAddress(
                address1, address2, city,
                country, countryCode, postalCode,
                region, regionCode);
        }
