...
public class PropertyAdsCampaignTargetingDevice {
    ...
    public PropertyAdsCampaignTargetingDevice withCarriers(@Nullable List<String> carriers) {
        this.carriers = carriers;
        return this;
    }


    public PropertyAdsCampaignTargetingDevice withTypes(@Nullable List<String> types) {
        this.types = types;
        return this;
    }


    public PropertyAdsCampaignTargetingDevice withUserDevice(@Nullable List<String> userDevice) {
        this.userDevice = userDevice;
        return this;
    }


    public PropertyAdsCampaignTargetingDevice withUserOs(@Nullable List<String> userOs) {
        this.userOs = userOs;
        return this;
    }
