...
public class PropertyAdsCampaignTargetingDevice {
    ...
    public PropertyAdsCampaignTargetingDevice withCarriers(@Nullable List<DeviceTarget> carriers) {
        this.carriers = carriers;
        return this;
    }


    public PropertyAdsCampaignTargetingDevice withTypes(@Nullable List<DeviceTarget> types) {
        this.types = types;
        return this;
    }


    public PropertyAdsCampaignTargetingDevice withUserDevice(@Nullable List<DeviceTarget> userDevice) {
        this.userDevice = userDevice;
        return this;
    }


    public PropertyAdsCampaignTargetingDevice withUserOs(@Nullable List<DeviceTarget> userOs) {
        this.userOs = userOs;
        return this;
    }
