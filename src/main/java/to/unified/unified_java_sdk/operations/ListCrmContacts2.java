...
public class ListCrmContacts2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCrmContacts2Request, ListCrmContacts2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCrmContacts2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmContacts2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmContacts2Request request) {
        ...
        @Override
        public ListCrmContacts2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCrmContacts2Response.Builder resBuilder =
            ...
            ListCrmContacts2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCrmContacts(Utils.unmarshal(response, new TypeReference<List<CrmContact>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCrmContacts2Request, to.unified.unified_java_sdk.models.operations.async.ListCrmContacts2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCrmContacts2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmContacts2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCrmContacts2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCrmContacts2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCrmContacts2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCrmContacts2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCrmContacts2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CrmContact>>() {})
                            .thenApply(res::withCrmContacts);
                } else {
