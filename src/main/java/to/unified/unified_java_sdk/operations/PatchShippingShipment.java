...
public class PatchShippingShipment {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchShippingShipmentRequest, PatchShippingShipmentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchShippingShipmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchShippingShipmentRequest.class, new TypeReference<PatchShippingShipmentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchShippingShipmentRequest request) {
        ...
        @Override
        public PatchShippingShipmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchShippingShipmentResponse.Builder resBuilder =
            ...
            PatchShippingShipmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchShippingShipmentRequest, to.unified.unified_java_sdk.models.operations.async.PatchShippingShipmentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchShippingShipmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchShippingShipmentRequest.class, new TypeReference<PatchShippingShipmentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchShippingShipmentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchShippingShipmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchShippingShipmentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchShippingShipmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchShippingShipmentResponse res = resBuilder.build();
