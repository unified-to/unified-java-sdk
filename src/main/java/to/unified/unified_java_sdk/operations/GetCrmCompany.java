...
public class GetCrmCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCrmCompanyRequest, GetCrmCompanyResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCrmCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmCompanyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCrmCompanyRequest request) {
        ...
        @Override
        public GetCrmCompanyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCrmCompanyResponse.Builder resBuilder =
            ...
            GetCrmCompanyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCrmCompanyRequest, to.unified.unified_java_sdk.models.operations.async.GetCrmCompanyResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCrmCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmCompanyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCrmCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCrmCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCrmCompanyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCrmCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCrmCompanyResponse res = resBuilder.build();
