...
public class ListTicketingTickets {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTicketingTicketsRequest request) throws Exception {
        ...
        @Override
        public ListTicketingTicketsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<TicketingTicket> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTicketingTickets(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
