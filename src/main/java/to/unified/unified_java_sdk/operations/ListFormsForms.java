...
public class ListFormsForms {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListFormsFormsRequest, ListFormsFormsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListFormsFormsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListFormsFormsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListFormsFormsRequest request) {
        ...
        @Override
        public ListFormsFormsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListFormsFormsResponse.Builder resBuilder =
            ...
            ListFormsFormsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListFormsFormsRequest, to.unified.unified_java_sdk.models.operations.async.ListFormsFormsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListFormsFormsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListFormsFormsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListFormsFormsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListFormsFormsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListFormsFormsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListFormsFormsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListFormsFormsResponse res = resBuilder.build();
