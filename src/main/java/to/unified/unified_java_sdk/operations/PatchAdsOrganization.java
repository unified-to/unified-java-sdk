...
public class PatchAdsOrganization {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAdsOrganizationRequest, PatchAdsOrganizationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAdsOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsOrganizationRequest.class, new TypeReference<PatchAdsOrganizationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAdsOrganizationRequest request) {
        ...
        @Override
        public PatchAdsOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAdsOrganizationResponse.Builder resBuilder =
            ...
            PatchAdsOrganizationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAdsOrganizationRequest, to.unified.unified_java_sdk.models.operations.async.PatchAdsOrganizationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAdsOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsOrganizationRequest.class, new TypeReference<PatchAdsOrganizationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAdsOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAdsOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAdsOrganizationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAdsOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAdsOrganizationResponse res = resBuilder.build();
