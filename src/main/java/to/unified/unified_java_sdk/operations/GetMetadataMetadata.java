...
public class GetMetadataMetadata {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMetadataMetadataRequest, GetMetadataMetadataResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetMetadataMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataMetadataRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMetadataMetadataRequest request) {
        ...
        @Override
        public GetMetadataMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMetadataMetadataResponse.Builder resBuilder =
            ...
            GetMetadataMetadataResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMetadataMetadataRequest, to.unified.unified_java_sdk.models.operations.async.GetMetadataMetadataResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMetadataMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataMetadataRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMetadataMetadataRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetMetadataMetadataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetMetadataMetadataResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetMetadataMetadataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetMetadataMetadataResponse res = resBuilder.build();
