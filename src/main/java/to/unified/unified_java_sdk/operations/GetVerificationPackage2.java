...
public class GetVerificationPackage2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetVerificationPackage2Request, GetVerificationPackage2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetVerificationPackage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetVerificationPackage2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetVerificationPackage2Request request) {
        ...
        @Override
        public GetVerificationPackage2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetVerificationPackage2Response.Builder resBuilder =
            ...
            GetVerificationPackage2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withVerificationPackage(Utils.unmarshal(response, new TypeReference<VerificationPackage>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetVerificationPackage2Request, to.unified.unified_java_sdk.models.operations.async.GetVerificationPackage2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetVerificationPackage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetVerificationPackage2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetVerificationPackage2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetVerificationPackage2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetVerificationPackage2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetVerificationPackage2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetVerificationPackage2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<VerificationPackage>() {})
                            .thenApply(res::withVerificationPackage);
                } else {
