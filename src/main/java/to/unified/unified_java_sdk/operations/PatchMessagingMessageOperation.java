...
public class PatchMessagingMessageOperation implements RequestOperation<PatchMessagingMessageRequest, PatchMessagingMessageResponse> {
    ...
    public PatchMessagingMessageOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchMessagingMessageRequest request) throws Exception {
