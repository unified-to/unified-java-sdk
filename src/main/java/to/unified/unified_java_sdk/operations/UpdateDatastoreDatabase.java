...
public class UpdateDatastoreDatabase {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateDatastoreDatabaseRequest, UpdateDatastoreDatabaseResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateDatastoreDatabaseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDatastoreDatabaseRequest.class, new TypeReference<UpdateDatastoreDatabaseRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateDatastoreDatabaseRequest request) {
        ...
        @Override
        public UpdateDatastoreDatabaseResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateDatastoreDatabaseResponse.Builder resBuilder =
            ...
            UpdateDatastoreDatabaseResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateDatastoreDatabaseRequest, to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreDatabaseResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateDatastoreDatabaseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDatastoreDatabaseRequest.class, new TypeReference<UpdateDatastoreDatabaseRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateDatastoreDatabaseRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreDatabaseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreDatabaseResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreDatabaseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreDatabaseResponse res = resBuilder.build();
