...
public class ListRepoCommitsOperation implements RequestOperation<ListRepoCommitsRequest, ListRepoCommitsResponse> {
    ...
    public ListRepoCommitsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListRepoCommitsRequest request) throws Exception {
