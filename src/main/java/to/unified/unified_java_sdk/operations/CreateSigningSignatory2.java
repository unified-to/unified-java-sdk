...
public class CreateSigningSignatory2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateSigningSignatory2Request, CreateSigningSignatory2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateSigningSignatory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSigningSignatory2Request.class, new TypeReference<CreateSigningSignatory2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSigningSignatory2Request request) {
        ...
        @Override
        public CreateSigningSignatory2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSigningSignatory2Response.Builder resBuilder =
            ...
            CreateSigningSignatory2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateSigningSignatory2Request, to.unified.unified_java_sdk.models.operations.async.CreateSigningSignatory2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateSigningSignatory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSigningSignatory2Request.class, new TypeReference<CreateSigningSignatory2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateSigningSignatory2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateSigningSignatory2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateSigningSignatory2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateSigningSignatory2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateSigningSignatory2Response res = resBuilder.build();
