...
public class GetRepoBranch2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRepoBranch2Request, GetRepoBranch2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRepoBranch2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoBranch2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRepoBranch2Request request) {
        ...
        @Override
        public GetRepoBranch2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRepoBranch2Response.Builder resBuilder =
            ...
            GetRepoBranch2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRepoBranch2Request, to.unified.unified_java_sdk.models.operations.async.GetRepoBranch2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRepoBranch2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoBranch2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRepoBranch2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetRepoBranch2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetRepoBranch2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetRepoBranch2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetRepoBranch2Response res = resBuilder.build();
