...
public class GetSocialReview {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSocialReviewRequest, GetSocialReviewResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSocialReviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSocialReviewRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSocialReviewRequest request) {
        ...
        @Override
        public GetSocialReviewResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSocialReviewResponse.Builder resBuilder =
            ...
            GetSocialReviewResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSocialReviewRequest, to.unified.unified_java_sdk.models.operations.async.GetSocialReviewResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSocialReviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSocialReviewRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSocialReviewRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetSocialReviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetSocialReviewResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetSocialReviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetSocialReviewResponse res = resBuilder.build();
