...
public class GetHrisBankaccount2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisBankaccount2Request, GetHrisBankaccount2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisBankaccount2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisBankaccount2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisBankaccount2Request request) {
        ...
        @Override
        public GetHrisBankaccount2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisBankaccount2Response.Builder resBuilder =
            ...
            GetHrisBankaccount2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisBankaccount2Request, to.unified.unified_java_sdk.models.operations.async.GetHrisBankaccount2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisBankaccount2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisBankaccount2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisBankaccount2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisBankaccount2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisBankaccount2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisBankaccount2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisBankaccount2Response res = resBuilder.build();
