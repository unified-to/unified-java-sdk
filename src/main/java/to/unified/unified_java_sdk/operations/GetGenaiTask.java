...
public class GetGenaiTask {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetGenaiTaskRequest, GetGenaiTaskResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetGenaiTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetGenaiTaskRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetGenaiTaskRequest request) {
        ...
        @Override
        public GetGenaiTaskResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetGenaiTaskResponse.Builder resBuilder =
            ...
            GetGenaiTaskResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetGenaiTaskRequest, to.unified.unified_java_sdk.models.operations.async.GetGenaiTaskResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetGenaiTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetGenaiTaskRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetGenaiTaskRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetGenaiTaskResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetGenaiTaskResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetGenaiTaskResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetGenaiTaskResponse res = resBuilder.build();
