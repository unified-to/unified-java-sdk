...
public class PatchCommerceLocationOperation implements RequestOperation<PatchCommerceLocationRequest, PatchCommerceLocationResponse> {
    ...
    public PatchCommerceLocationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchCommerceLocationRequest request) throws Exception {
