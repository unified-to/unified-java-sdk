...
public class GetPaymentPayout2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPaymentPayout2Request, GetPaymentPayout2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPaymentPayout2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentPayout2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentPayout2Request request) {
        ...
        @Override
        public GetPaymentPayout2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPaymentPayout2Response.Builder resBuilder =
            ...
            GetPaymentPayout2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentPayout(Utils.unmarshal(response, new TypeReference<PaymentPayout>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentPayout2Request, to.unified.unified_java_sdk.models.operations.async.GetPaymentPayout2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPaymentPayout2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentPayout2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPaymentPayout2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetPaymentPayout2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetPaymentPayout2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetPaymentPayout2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetPaymentPayout2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaymentPayout>() {})
                            .thenApply(res::withPaymentPayout);
                } else {
