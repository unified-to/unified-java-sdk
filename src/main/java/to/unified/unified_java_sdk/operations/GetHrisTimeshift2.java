...
public class GetHrisTimeshift2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisTimeshift2Request, GetHrisTimeshift2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisTimeshift2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisTimeshift2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisTimeshift2Request request) {
        ...
        @Override
        public GetHrisTimeshift2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisTimeshift2Response.Builder resBuilder =
            ...
            GetHrisTimeshift2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisTimeshift2Request, to.unified.unified_java_sdk.models.operations.async.GetHrisTimeshift2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisTimeshift2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisTimeshift2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisTimeshift2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisTimeshift2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisTimeshift2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisTimeshift2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisTimeshift2Response res = resBuilder.build();
