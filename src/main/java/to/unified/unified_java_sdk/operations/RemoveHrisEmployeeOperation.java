...
public class RemoveHrisEmployeeOperation implements RequestOperation<RemoveHrisEmployeeRequest, RemoveHrisEmployeeResponse> {
    ...
    public RemoveHrisEmployeeOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveHrisEmployeeRequest request) throws Exception {
