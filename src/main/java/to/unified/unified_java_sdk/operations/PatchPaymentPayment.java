...
public class PatchPaymentPayment {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchPaymentPaymentRequest, PatchPaymentPaymentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchPaymentPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPaymentPaymentRequest.class, new TypeReference<PatchPaymentPaymentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchPaymentPaymentRequest request) {
        ...
        @Override
        public PatchPaymentPaymentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchPaymentPaymentResponse.Builder resBuilder =
            ...
            PatchPaymentPaymentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchPaymentPaymentRequest, to.unified.unified_java_sdk.models.operations.async.PatchPaymentPaymentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchPaymentPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPaymentPaymentRequest.class, new TypeReference<PatchPaymentPaymentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchPaymentPaymentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchPaymentPaymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchPaymentPaymentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchPaymentPaymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchPaymentPaymentResponse res = resBuilder.build();
