...
public class GetDatastoreRecord2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDatastoreRecord2Request, GetDatastoreRecord2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDatastoreRecord2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetDatastoreRecord2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDatastoreRecord2Request request) {
        ...
        @Override
        public GetDatastoreRecord2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDatastoreRecord2Response.Builder resBuilder =
            ...
            GetDatastoreRecord2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDatastoreRecord2Request, to.unified.unified_java_sdk.models.operations.async.GetDatastoreRecord2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetDatastoreRecord2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetDatastoreRecord2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDatastoreRecord2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetDatastoreRecord2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetDatastoreRecord2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetDatastoreRecord2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetDatastoreRecord2Response res = resBuilder.build();
