...
public class UpdateAtsApplication2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAtsApplication2Request, UpdateAtsApplication2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAtsApplication2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsApplication2Request.class, new TypeReference<UpdateAtsApplication2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsApplication2Request request) {
        ...
        @Override
        public UpdateAtsApplication2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAtsApplication2Response.Builder resBuilder =
            ...
            UpdateAtsApplication2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAtsApplication2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAtsApplication2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAtsApplication2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsApplication2Request.class, new TypeReference<UpdateAtsApplication2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAtsApplication2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAtsApplication2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAtsApplication2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAtsApplication2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAtsApplication2Response res = resBuilder.build();
