...
public class UpdateLmsActivity2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLmsActivity2Request, UpdateLmsActivity2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateLmsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsActivity2Request.class, new TypeReference<UpdateLmsActivity2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLmsActivity2Request request) {
        ...
        @Override
        public UpdateLmsActivity2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateLmsActivity2Response.Builder resBuilder =
            ...
            UpdateLmsActivity2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLmsActivity(Utils.unmarshal(response, new TypeReference<LmsActivity>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLmsActivity2Request, to.unified.unified_java_sdk.models.operations.async.UpdateLmsActivity2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLmsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsActivity2Request.class, new TypeReference<UpdateLmsActivity2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLmsActivity2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateLmsActivity2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateLmsActivity2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateLmsActivity2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateLmsActivity2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<LmsActivity>() {})
                            .thenApply(res::withLmsActivity);
                } else {
