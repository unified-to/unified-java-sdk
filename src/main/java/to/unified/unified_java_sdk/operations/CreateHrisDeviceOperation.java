...
public class CreateHrisDeviceOperation implements RequestOperation<CreateHrisDeviceRequest, CreateHrisDeviceResponse> {
    ...
    public CreateHrisDeviceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateHrisDeviceRequest request) throws Exception {
