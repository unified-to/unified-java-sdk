...
public class ListDatastoreDatabases2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDatastoreDatabases2Request, ListDatastoreDatabases2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListDatastoreDatabases2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListDatastoreDatabases2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDatastoreDatabases2Request request) {
        ...
        @Override
        public ListDatastoreDatabases2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListDatastoreDatabases2Response.Builder resBuilder =
            ...
            ListDatastoreDatabases2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDatastoreDatabases(Utils.unmarshal(response, new TypeReference<List<DatastoreDatabase>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListDatastoreDatabases2Request, to.unified.unified_java_sdk.models.operations.async.ListDatastoreDatabases2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListDatastoreDatabases2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListDatastoreDatabases2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDatastoreDatabases2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListDatastoreDatabases2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListDatastoreDatabases2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListDatastoreDatabases2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListDatastoreDatabases2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<DatastoreDatabase>>() {})
                            .thenApply(res::withDatastoreDatabases);
                } else {
