...
public class ListMessagingMessages {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMessagingMessagesRequest, ListMessagingMessagesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListMessagingMessagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMessagingMessagesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMessagingMessagesRequest request) {
        ...
        @Override
        public ListMessagingMessagesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMessagingMessagesResponse.Builder resBuilder =
            ...
            ListMessagingMessagesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMessagingMessagesRequest, to.unified.unified_java_sdk.models.operations.async.ListMessagingMessagesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMessagingMessagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMessagingMessagesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMessagingMessagesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListMessagingMessagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListMessagingMessagesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListMessagingMessagesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListMessagingMessagesResponse res = resBuilder.build();
