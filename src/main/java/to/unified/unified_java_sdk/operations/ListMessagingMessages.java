...
public class ListMessagingMessages {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMessagingMessagesRequest request) throws Exception {
        ...
        @Override
        public ListMessagingMessagesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<MessagingMessage> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMessagingMessages(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
