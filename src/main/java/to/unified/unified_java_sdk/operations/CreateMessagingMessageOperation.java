...
public class CreateMessagingMessageOperation implements RequestOperation<CreateMessagingMessageRequest, CreateMessagingMessageResponse> {
    ...
    public CreateMessagingMessageOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateMessagingMessageRequest request) throws Exception {
