...
public class CreateRepoOrganization2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateRepoOrganization2Request, CreateRepoOrganization2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateRepoOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoOrganization2Request.class, new TypeReference<CreateRepoOrganization2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateRepoOrganization2Request request) {
        ...
        @Override
        public CreateRepoOrganization2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateRepoOrganization2Response.Builder resBuilder =
            ...
            CreateRepoOrganization2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateRepoOrganization2Request, to.unified.unified_java_sdk.models.operations.async.CreateRepoOrganization2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateRepoOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoOrganization2Request.class, new TypeReference<CreateRepoOrganization2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateRepoOrganization2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateRepoOrganization2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateRepoOrganization2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateRepoOrganization2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateRepoOrganization2Response res = resBuilder.build();
