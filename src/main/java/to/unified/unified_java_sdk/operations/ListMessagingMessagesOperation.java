...
public class ListMessagingMessagesOperation implements RequestOperation<ListMessagingMessagesRequest, ListMessagingMessagesResponse> {
    ...
    public ListMessagingMessagesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListMessagingMessagesRequest request) throws Exception {
