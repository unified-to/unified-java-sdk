...
public class ListCrmContactsOperation implements RequestOperation<ListCrmContactsRequest, ListCrmContactsResponse> {
    ...
    public ListCrmContactsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCrmContactsRequest request) throws Exception {
