...
public class RemoveHrisDeviceOperation implements RequestOperation<RemoveHrisDeviceRequest, RemoveHrisDeviceResponse> {
    ...
    public RemoveHrisDeviceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveHrisDeviceRequest request) throws Exception {
