...
public class PatchLmsActivity2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchLmsActivity2Request, PatchLmsActivity2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchLmsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsActivity2Request.class, new TypeReference<PatchLmsActivity2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchLmsActivity2Request request) {
        ...
        @Override
        public PatchLmsActivity2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchLmsActivity2Response.Builder resBuilder =
            ...
            PatchLmsActivity2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchLmsActivity2Request, to.unified.unified_java_sdk.models.operations.async.PatchLmsActivity2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchLmsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsActivity2Request.class, new TypeReference<PatchLmsActivity2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchLmsActivity2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchLmsActivity2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchLmsActivity2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchLmsActivity2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchLmsActivity2Response res = resBuilder.build();
