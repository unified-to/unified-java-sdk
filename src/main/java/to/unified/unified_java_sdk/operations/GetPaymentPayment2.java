...
public class GetPaymentPayment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPaymentPayment2Request, GetPaymentPayment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPaymentPayment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentPayment2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentPayment2Request request) {
        ...
        @Override
        public GetPaymentPayment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPaymentPayment2Response.Builder resBuilder =
            ...
            GetPaymentPayment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentPayment2Request, to.unified.unified_java_sdk.models.operations.async.GetPaymentPayment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPaymentPayment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentPayment2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPaymentPayment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetPaymentPayment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetPaymentPayment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetPaymentPayment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetPaymentPayment2Response res = resBuilder.build();
