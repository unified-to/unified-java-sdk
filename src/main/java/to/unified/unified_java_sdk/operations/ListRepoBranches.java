...
public class ListRepoBranches {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRepoBranchesRequest, ListRepoBranchesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListRepoBranchesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoBranchesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRepoBranchesRequest request) {
        ...
        @Override
        public ListRepoBranchesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListRepoBranchesResponse.Builder resBuilder =
            ...
            ListRepoBranchesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListRepoBranchesRequest, to.unified.unified_java_sdk.models.operations.async.ListRepoBranchesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListRepoBranchesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoBranchesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRepoBranchesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListRepoBranchesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListRepoBranchesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListRepoBranchesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListRepoBranchesResponse res = resBuilder.build();
