...
public class ListRepoBranches {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRepoBranchesRequest request) throws Exception {
        ...
        @Override
        public ListRepoBranchesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<RepoBranch> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withRepoBranches(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
