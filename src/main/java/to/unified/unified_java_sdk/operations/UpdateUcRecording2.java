...
public class UpdateUcRecording2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateUcRecording2Request, UpdateUcRecording2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateUcRecording2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUcRecording2Request.class, new TypeReference<UpdateUcRecording2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateUcRecording2Request request) {
        ...
        @Override
        public UpdateUcRecording2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateUcRecording2Response.Builder resBuilder =
            ...
            UpdateUcRecording2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateUcRecording2Request, to.unified.unified_java_sdk.models.operations.async.UpdateUcRecording2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateUcRecording2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUcRecording2Request.class, new TypeReference<UpdateUcRecording2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateUcRecording2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateUcRecording2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateUcRecording2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateUcRecording2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateUcRecording2Response res = resBuilder.build();
