...
public class CreateCommerceItemOperation implements RequestOperation<CreateCommerceItemRequest, CreateCommerceItemResponse> {
    ...
    public CreateCommerceItemOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateCommerceItemRequest request) throws Exception {
