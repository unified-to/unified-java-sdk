...
public class GetPaymentPayoutOperation implements RequestOperation<GetPaymentPayoutRequest, GetPaymentPayoutResponse> {
    ...
    public GetPaymentPayoutOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetPaymentPayoutRequest request) throws Exception {
