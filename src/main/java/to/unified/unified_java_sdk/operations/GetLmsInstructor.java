...
public class GetLmsInstructor {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLmsInstructorRequest, GetLmsInstructorResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLmsInstructorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsInstructorRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLmsInstructorRequest request) {
        ...
        @Override
        public GetLmsInstructorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLmsInstructorResponse.Builder resBuilder =
            ...
            GetLmsInstructorResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLmsInstructorRequest, to.unified.unified_java_sdk.models.operations.async.GetLmsInstructorResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLmsInstructorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsInstructorRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLmsInstructorRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetLmsInstructorResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetLmsInstructorResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetLmsInstructorResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetLmsInstructorResponse res = resBuilder.build();
