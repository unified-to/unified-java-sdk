...
public class UpdateHrisLocationOperation implements RequestOperation<UpdateHrisLocationRequest, UpdateHrisLocationResponse> {
    ...
    public UpdateHrisLocationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateHrisLocationRequest request) throws Exception {
