...
public class GetRepoOrganization {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRepoOrganizationRequest, GetRepoOrganizationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRepoOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoOrganizationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRepoOrganizationRequest request) {
        ...
        @Override
        public GetRepoOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRepoOrganizationResponse.Builder resBuilder =
            ...
            GetRepoOrganizationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRepoOrganizationRequest, to.unified.unified_java_sdk.models.operations.async.GetRepoOrganizationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRepoOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoOrganizationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRepoOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetRepoOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetRepoOrganizationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetRepoOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetRepoOrganizationResponse res = resBuilder.build();
