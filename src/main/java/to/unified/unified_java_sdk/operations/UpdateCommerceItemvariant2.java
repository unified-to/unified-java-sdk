...
public class UpdateCommerceItemvariant2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommerceItemvariant2Request, UpdateCommerceItemvariant2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCommerceItemvariant2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceItemvariant2Request.class, new TypeReference<UpdateCommerceItemvariant2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceItemvariant2Request request) {
        ...
        @Override
        public UpdateCommerceItemvariant2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommerceItemvariant2Response.Builder resBuilder =
            ...
            UpdateCommerceItemvariant2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommerceItemvariant2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCommerceItemvariant2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommerceItemvariant2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceItemvariant2Request.class, new TypeReference<UpdateCommerceItemvariant2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommerceItemvariant2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCommerceItemvariant2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceItemvariant2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCommerceItemvariant2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceItemvariant2Response res = resBuilder.build();
