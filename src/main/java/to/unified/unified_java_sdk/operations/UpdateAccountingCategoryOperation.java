...
public class UpdateAccountingCategoryOperation implements RequestOperation<UpdateAccountingCategoryRequest, UpdateAccountingCategoryResponse> {
    ...
    public UpdateAccountingCategoryOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAccountingCategoryRequest request) throws Exception {
