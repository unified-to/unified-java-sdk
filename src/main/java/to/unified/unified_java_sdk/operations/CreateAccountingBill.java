...
public class CreateAccountingBill {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAccountingBillRequest, CreateAccountingBillResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAccountingBillRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingBillRequest.class, new TypeReference<CreateAccountingBillRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingBillRequest request) {
        ...
        @Override
        public CreateAccountingBillResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAccountingBillResponse.Builder resBuilder =
            ...
            CreateAccountingBillResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAccountingBillRequest, to.unified.unified_java_sdk.models.operations.async.CreateAccountingBillResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAccountingBillRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingBillRequest.class, new TypeReference<CreateAccountingBillRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAccountingBillRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAccountingBillResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAccountingBillResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAccountingBillResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAccountingBillResponse res = resBuilder.build();
