...
public class GetCommerceItem2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceItem2Request, GetCommerceItem2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommerceItem2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceItem2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceItem2Request request) {
        ...
        @Override
        public GetCommerceItem2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommerceItem2Response.Builder resBuilder =
            ...
            GetCommerceItem2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommerceItem2Request, to.unified.unified_java_sdk.models.operations.async.GetCommerceItem2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommerceItem2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceItem2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommerceItem2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCommerceItem2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCommerceItem2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCommerceItem2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCommerceItem2Response res = resBuilder.build();
