...
public class ListAccountingTransactionsOperation implements RequestOperation<ListAccountingTransactionsRequest, ListAccountingTransactionsResponse> {
    ...
    public ListAccountingTransactionsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAccountingTransactionsRequest request) throws Exception {
