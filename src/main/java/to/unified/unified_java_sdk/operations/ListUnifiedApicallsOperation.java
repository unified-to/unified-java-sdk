...
public class ListUnifiedApicallsOperation implements RequestOperation<ListUnifiedApicallsRequest, ListUnifiedApicallsResponse> {
    ...
    public ListUnifiedApicallsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListUnifiedApicallsRequest request) throws Exception {
