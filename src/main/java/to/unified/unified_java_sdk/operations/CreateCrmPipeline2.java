...
public class CreateCrmPipeline2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCrmPipeline2Request, CreateCrmPipeline2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCrmPipeline2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmPipeline2Request.class, new TypeReference<CreateCrmPipeline2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCrmPipeline2Request request) {
        ...
        @Override
        public CreateCrmPipeline2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCrmPipeline2Response.Builder resBuilder =
            ...
            CreateCrmPipeline2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCrmPipeline(Utils.unmarshal(response, new TypeReference<CrmPipeline>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCrmPipeline2Request, to.unified.unified_java_sdk.models.operations.async.CreateCrmPipeline2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCrmPipeline2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmPipeline2Request.class, new TypeReference<CreateCrmPipeline2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCrmPipeline2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCrmPipeline2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCrmPipeline2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCrmPipeline2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCrmPipeline2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CrmPipeline>() {})
                            .thenApply(res::withCrmPipeline);
                } else {
