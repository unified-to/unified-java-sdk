...
public class PatchCdpProfile {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCdpProfileRequest, PatchCdpProfileResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCdpProfileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCdpProfileRequest.class, new TypeReference<PatchCdpProfileRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCdpProfileRequest request) {
        ...
        @Override
        public PatchCdpProfileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCdpProfileResponse.Builder resBuilder =
            ...
            PatchCdpProfileResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCdpProfileRequest, to.unified.unified_java_sdk.models.operations.async.PatchCdpProfileResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCdpProfileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCdpProfileRequest.class, new TypeReference<PatchCdpProfileRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCdpProfileRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCdpProfileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCdpProfileResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCdpProfileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCdpProfileResponse res = resBuilder.build();
