...
public class CreateGenaiEmbedding2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateGenaiEmbedding2Request, CreateGenaiEmbedding2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateGenaiEmbedding2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateGenaiEmbedding2Request.class, new TypeReference<CreateGenaiEmbedding2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateGenaiEmbedding2Request request) {
        ...
        @Override
        public CreateGenaiEmbedding2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateGenaiEmbedding2Response.Builder resBuilder =
            ...
            CreateGenaiEmbedding2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGenaiEmbedding(Utils.unmarshal(response, new TypeReference<GenaiEmbedding>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateGenaiEmbedding2Request, to.unified.unified_java_sdk.models.operations.async.CreateGenaiEmbedding2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateGenaiEmbedding2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateGenaiEmbedding2Request.class, new TypeReference<CreateGenaiEmbedding2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateGenaiEmbedding2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateGenaiEmbedding2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateGenaiEmbedding2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateGenaiEmbedding2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateGenaiEmbedding2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GenaiEmbedding>() {})
                            .thenApply(res::withGenaiEmbedding);
                } else {
