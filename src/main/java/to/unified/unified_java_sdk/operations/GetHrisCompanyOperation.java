...
public class GetHrisCompanyOperation implements RequestOperation<GetHrisCompanyRequest, GetHrisCompanyResponse> {
    ...
    public GetHrisCompanyOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetHrisCompanyRequest request) throws Exception {
