...
public class CreateTicketingTicket {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTicketingTicketRequest, CreateTicketingTicketResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTicketingTicketRequest request) {
        ...
        @Override
        public CreateTicketingTicketResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTicketingTicketResponse.Builder resBuilder =
            ...
            CreateTicketingTicketResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTicketingTicketRequest, to.unified.unified_java_sdk.models.operations.async.CreateTicketingTicketResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTicketingTicketRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTicketingTicketRequest.class, new TypeReference<CreateTicketingTicketRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTicketingTicketRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateTicketingTicketResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateTicketingTicketResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateTicketingTicketResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateTicketingTicketResponse res = resBuilder.build();
