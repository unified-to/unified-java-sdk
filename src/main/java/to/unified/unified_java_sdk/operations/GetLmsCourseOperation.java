...
public class GetLmsCourseOperation implements RequestOperation<GetLmsCourseRequest, GetLmsCourseResponse> {
    ...
    public GetLmsCourseOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetLmsCourseRequest request) throws Exception {
