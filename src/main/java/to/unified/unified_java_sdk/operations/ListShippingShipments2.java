...
public class ListShippingShipments2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListShippingShipments2Request, ListShippingShipments2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListShippingShipments2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListShippingShipments2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListShippingShipments2Request request) {
        ...
        @Override
        public ListShippingShipments2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListShippingShipments2Response.Builder resBuilder =
            ...
            ListShippingShipments2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withShippingShipments(Utils.unmarshal(response, new TypeReference<List<ShippingShipment>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListShippingShipments2Request, to.unified.unified_java_sdk.models.operations.async.ListShippingShipments2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListShippingShipments2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListShippingShipments2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListShippingShipments2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListShippingShipments2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListShippingShipments2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListShippingShipments2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListShippingShipments2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ShippingShipment>>() {})
                            .thenApply(res::withShippingShipments);
                } else {
