...
public class UpdateAtsJob2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAtsJob2Request, UpdateAtsJob2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAtsJob2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsJob2Request.class, new TypeReference<UpdateAtsJob2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsJob2Request request) {
        ...
        @Override
        public UpdateAtsJob2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAtsJob2Response.Builder resBuilder =
            ...
            UpdateAtsJob2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAtsJob2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAtsJob2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAtsJob2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsJob2Request.class, new TypeReference<UpdateAtsJob2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAtsJob2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAtsJob2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAtsJob2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAtsJob2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAtsJob2Response res = resBuilder.build();
