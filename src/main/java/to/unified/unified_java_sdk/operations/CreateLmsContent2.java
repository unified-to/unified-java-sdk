...
public class CreateLmsContent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateLmsContent2Request, CreateLmsContent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateLmsContent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsContent2Request.class, new TypeReference<CreateLmsContent2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateLmsContent2Request request) {
        ...
        @Override
        public CreateLmsContent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateLmsContent2Response.Builder resBuilder =
            ...
            CreateLmsContent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateLmsContent2Request, to.unified.unified_java_sdk.models.operations.async.CreateLmsContent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateLmsContent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsContent2Request.class, new TypeReference<CreateLmsContent2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateLmsContent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateLmsContent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateLmsContent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateLmsContent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateLmsContent2Response res = resBuilder.build();
