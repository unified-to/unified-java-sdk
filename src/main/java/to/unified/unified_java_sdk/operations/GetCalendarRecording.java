...
public class GetCalendarRecording {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCalendarRecordingRequest, GetCalendarRecordingResponse> {
        ...
        public GetCalendarRecordingResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            GetCalendarRecordingResponse.Builder resBuilder =
            ...
            GetCalendarRecordingResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCalendarRecordingRequest, to.unified.unified_java_sdk.models.operations.async.GetCalendarRecordingResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCalendarRecordingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarRecordingRequest.class);
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCalendarRecordingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCalendarRecordingResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCalendarRecordingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCalendarRecordingResponse res = resBuilder.build();
