...
public class ListClubsGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListClubsGroupsRequest, ListClubsGroupsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListClubsGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsGroupsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListClubsGroupsRequest request) {
        ...
        @Override
        public ListClubsGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListClubsGroupsResponse.Builder resBuilder =
            ...
            ListClubsGroupsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListClubsGroupsRequest, to.unified.unified_java_sdk.models.operations.async.ListClubsGroupsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListClubsGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsGroupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListClubsGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListClubsGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListClubsGroupsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListClubsGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListClubsGroupsResponse res = resBuilder.build();
