...
public class RemoveMessagingMessage2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveMessagingMessage2Request, RemoveMessagingMessage2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveMessagingMessage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMessagingMessage2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveMessagingMessage2Request request) {
        ...
        @Override
        public RemoveMessagingMessage2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveMessagingMessage2Response.Builder resBuilder =
            ...
            RemoveMessagingMessage2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveMessagingMessage2Request, to.unified.unified_java_sdk.models.operations.async.RemoveMessagingMessage2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveMessagingMessage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMessagingMessage2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveMessagingMessage2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveMessagingMessage2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveMessagingMessage2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveMessagingMessage2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveMessagingMessage2Response res = resBuilder.build();
