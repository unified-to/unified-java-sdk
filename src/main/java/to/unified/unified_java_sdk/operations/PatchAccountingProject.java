...
public class PatchAccountingProject {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingProjectRequest, PatchAccountingProjectResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingProjectRequest.class, new TypeReference<PatchAccountingProjectRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingProjectRequest request) {
        ...
        @Override
        public PatchAccountingProjectResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingProjectResponse.Builder resBuilder =
            ...
            PatchAccountingProjectResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingProjectRequest, to.unified.unified_java_sdk.models.operations.async.PatchAccountingProjectResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingProjectRequest.class, new TypeReference<PatchAccountingProjectRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingProjectRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingProjectResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingProjectResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingProjectResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingProjectResponse res = resBuilder.build();
