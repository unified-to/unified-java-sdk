...
public class UpdateCalendarWebinar2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCalendarWebinar2Request, UpdateCalendarWebinar2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCalendarWebinar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCalendarWebinar2Request.class, new TypeReference<UpdateCalendarWebinar2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCalendarWebinar2Request request) {
        ...
        @Override
        public UpdateCalendarWebinar2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCalendarWebinar2Response.Builder resBuilder =
            ...
            UpdateCalendarWebinar2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCalendarWebinar2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCalendarWebinar2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCalendarWebinar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCalendarWebinar2Request.class, new TypeReference<UpdateCalendarWebinar2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCalendarWebinar2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCalendarWebinar2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCalendarWebinar2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCalendarWebinar2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCalendarWebinar2Response res = resBuilder.build();
