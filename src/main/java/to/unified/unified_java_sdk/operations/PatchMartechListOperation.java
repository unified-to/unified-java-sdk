...
public class PatchMartechListOperation implements RequestOperation<PatchMartechListRequest, PatchMartechListResponse> {
    ...
    public PatchMartechListOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchMartechListRequest request) throws Exception {
