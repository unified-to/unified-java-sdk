...
public class CreateAccountingCategory {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingCategoryRequest request) throws Exception {
        ...
        @Override
        public CreateAccountingCategoryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingCategory out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingCategory(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
