...
public class ListUnifiedWorkspaceSecretsmanagers {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    this.baseUrl,
                    "/unified/workspace/secretsmanager");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUnifiedWorkspaceSecretsmanagersRequest, ListUnifiedWorkspaceSecretsmanagersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListUnifiedWorkspaceSecretsmanagersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUnifiedWorkspaceSecretsmanagersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUnifiedWorkspaceSecretsmanagersRequest request) {
        ...
        @Override
        public ListUnifiedWorkspaceSecretsmanagersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUnifiedWorkspaceSecretsmanagersResponse.Builder resBuilder =
            ...
            ListUnifiedWorkspaceSecretsmanagersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSecretsManagers(Utils.unmarshal(response, new TypeReference<List<SecretsManager>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUnifiedWorkspaceSecretsmanagersRequest, to.unified.unified_java_sdk.models.operations.async.ListUnifiedWorkspaceSecretsmanagersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListUnifiedWorkspaceSecretsmanagersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUnifiedWorkspaceSecretsmanagersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUnifiedWorkspaceSecretsmanagersRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListUnifiedWorkspaceSecretsmanagersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListUnifiedWorkspaceSecretsmanagersResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListUnifiedWorkspaceSecretsmanagersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListUnifiedWorkspaceSecretsmanagersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<SecretsManager>>() {})
                            .thenApply(res::withSecretsManagers);
                } else {
