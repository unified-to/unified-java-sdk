...
public class GetUnifiedIntegrationSaml {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUnifiedIntegrationSamlRequest, GetUnifiedIntegrationSamlResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUnifiedIntegrationSamlRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUnifiedIntegrationSamlRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUnifiedIntegrationSamlRequest request) {
        ...
        @Override
        public GetUnifiedIntegrationSamlResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUnifiedIntegrationSamlResponse.Builder resBuilder =
            ...
            GetUnifiedIntegrationSamlResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUnifiedIntegrationSamlRequest, to.unified.unified_java_sdk.models.operations.async.GetUnifiedIntegrationSamlResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUnifiedIntegrationSamlRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUnifiedIntegrationSamlRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUnifiedIntegrationSamlRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetUnifiedIntegrationSamlResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetUnifiedIntegrationSamlResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetUnifiedIntegrationSamlResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetUnifiedIntegrationSamlResponse res = resBuilder.build();
