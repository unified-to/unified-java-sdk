...
public class PatchHrisTimeoff {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisTimeoffRequest, PatchHrisTimeoffResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisTimeoffRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisTimeoffRequest.class, new TypeReference<PatchHrisTimeoffRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisTimeoffRequest request) {
        ...
        @Override
        public PatchHrisTimeoffResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisTimeoffResponse.Builder resBuilder =
            ...
            PatchHrisTimeoffResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisTimeoffRequest, to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeoffResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisTimeoffRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisTimeoffRequest.class, new TypeReference<PatchHrisTimeoffRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisTimeoffRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeoffResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeoffResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeoffResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeoffResponse res = resBuilder.build();
