...
public class CreateUcContactOperation implements RequestOperation<CreateUcContactRequest, CreateUcContactResponse> {
    ...
    public CreateUcContactOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateUcContactRequest request) throws Exception {
