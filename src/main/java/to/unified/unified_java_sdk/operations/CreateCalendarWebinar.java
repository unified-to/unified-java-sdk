...
public class CreateCalendarWebinar {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCalendarWebinarRequest, CreateCalendarWebinarResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCalendarWebinarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCalendarWebinarRequest.class, new TypeReference<CreateCalendarWebinarRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCalendarWebinarRequest request) {
        ...
        @Override
        public CreateCalendarWebinarResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCalendarWebinarResponse.Builder resBuilder =
            ...
            CreateCalendarWebinarResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCalendarWebinarRequest, to.unified.unified_java_sdk.models.operations.async.CreateCalendarWebinarResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCalendarWebinarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCalendarWebinarRequest.class, new TypeReference<CreateCalendarWebinarRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCalendarWebinarRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCalendarWebinarResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCalendarWebinarResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCalendarWebinarResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCalendarWebinarResponse res = resBuilder.build();
