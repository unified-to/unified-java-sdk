...
public class RemoveFormsForm2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveFormsForm2Request, RemoveFormsForm2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveFormsForm2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveFormsForm2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveFormsForm2Request request) {
        ...
        @Override
        public RemoveFormsForm2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveFormsForm2Response.Builder resBuilder =
            ...
            RemoveFormsForm2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveFormsForm2Request, to.unified.unified_java_sdk.models.operations.async.RemoveFormsForm2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveFormsForm2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveFormsForm2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveFormsForm2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveFormsForm2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveFormsForm2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveFormsForm2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveFormsForm2Response res = resBuilder.build();
