...
public class ListTicketingCategories {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTicketingCategoriesRequest, ListTicketingCategoriesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListTicketingCategoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTicketingCategoriesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTicketingCategoriesRequest request) {
        ...
        @Override
        public ListTicketingCategoriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTicketingCategoriesResponse.Builder resBuilder =
            ...
            ListTicketingCategoriesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTicketingCategoriesRequest, to.unified.unified_java_sdk.models.operations.async.ListTicketingCategoriesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListTicketingCategoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTicketingCategoriesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTicketingCategoriesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListTicketingCategoriesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListTicketingCategoriesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListTicketingCategoriesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListTicketingCategoriesResponse res = resBuilder.build();
