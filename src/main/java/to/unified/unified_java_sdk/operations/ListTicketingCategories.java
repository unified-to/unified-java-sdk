...
public class ListTicketingCategories {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTicketingCategoriesRequest request) throws Exception {
        ...
        @Override
        public ListTicketingCategoriesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<TicketingCategory> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTicketingCategories(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
