...
public class RemoveCrmLeadOperation implements RequestOperation<RemoveCrmLeadRequest, RemoveCrmLeadResponse> {
    ...
    public RemoveCrmLeadOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveCrmLeadRequest request) throws Exception {
