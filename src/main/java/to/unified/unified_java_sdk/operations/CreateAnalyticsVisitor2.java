...
public class CreateAnalyticsVisitor2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAnalyticsVisitor2Request, CreateAnalyticsVisitor2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAnalyticsVisitor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAnalyticsVisitor2Request.class, new TypeReference<CreateAnalyticsVisitor2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAnalyticsVisitor2Request request) {
        ...
        @Override
        public CreateAnalyticsVisitor2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAnalyticsVisitor2Response.Builder resBuilder =
            ...
            CreateAnalyticsVisitor2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAnalyticsVisitor2Request, to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsVisitor2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAnalyticsVisitor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAnalyticsVisitor2Request.class, new TypeReference<CreateAnalyticsVisitor2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAnalyticsVisitor2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsVisitor2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsVisitor2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsVisitor2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsVisitor2Response res = resBuilder.build();
