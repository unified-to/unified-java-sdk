...
public class GetMessagingMessageOperation implements RequestOperation<GetMessagingMessageRequest, GetMessagingMessageResponse> {
    ...
    public GetMessagingMessageOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetMessagingMessageRequest request) throws Exception {
