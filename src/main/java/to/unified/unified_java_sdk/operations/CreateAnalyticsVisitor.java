...
public class CreateAnalyticsVisitor {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAnalyticsVisitorRequest, CreateAnalyticsVisitorResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAnalyticsVisitorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAnalyticsVisitorRequest.class, new TypeReference<CreateAnalyticsVisitorRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAnalyticsVisitorRequest request) {
        ...
        @Override
        public CreateAnalyticsVisitorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAnalyticsVisitorResponse.Builder resBuilder =
            ...
            CreateAnalyticsVisitorResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAnalyticsVisitorRequest, to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsVisitorResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAnalyticsVisitorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAnalyticsVisitorRequest.class, new TypeReference<CreateAnalyticsVisitorRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAnalyticsVisitorRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsVisitorResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsVisitorResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsVisitorResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsVisitorResponse res = resBuilder.build();
