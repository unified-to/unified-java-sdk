...
public class ListCalendarRecordings2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCalendarRecordings2Request, ListCalendarRecordings2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCalendarRecordings2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarRecordings2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarRecordings2Request request) {
        ...
        @Override
        public ListCalendarRecordings2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCalendarRecordings2Response.Builder resBuilder =
            ...
            ListCalendarRecordings2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCalendarRecordings(Utils.unmarshal(response, new TypeReference<List<CalendarRecording>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCalendarRecordings2Request, to.unified.unified_java_sdk.models.operations.async.ListCalendarRecordings2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCalendarRecordings2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarRecordings2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCalendarRecordings2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCalendarRecordings2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCalendarRecordings2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCalendarRecordings2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCalendarRecordings2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CalendarRecording>>() {})
                            .thenApply(res::withCalendarRecordings);
                } else {
