...
public class GetPaymentSubscription {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPaymentSubscriptionRequest, GetPaymentSubscriptionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPaymentSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentSubscriptionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentSubscriptionRequest request) {
        ...
        @Override
        public GetPaymentSubscriptionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPaymentSubscriptionResponse.Builder resBuilder =
            ...
            GetPaymentSubscriptionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentSubscriptionRequest, to.unified.unified_java_sdk.models.operations.async.GetPaymentSubscriptionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPaymentSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentSubscriptionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPaymentSubscriptionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetPaymentSubscriptionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetPaymentSubscriptionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetPaymentSubscriptionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetPaymentSubscriptionResponse res = resBuilder.build();
