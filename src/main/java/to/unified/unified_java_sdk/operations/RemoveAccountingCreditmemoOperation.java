...
public class RemoveAccountingCreditmemoOperation implements RequestOperation<RemoveAccountingCreditmemoRequest, RemoveAccountingCreditmemoResponse> {
    ...
    public RemoveAccountingCreditmemoOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAccountingCreditmemoRequest request) throws Exception {
        String url = Utils.generateURL(
                RemoveAccountingCreditmemoRequest.class,
                this.baseUrl,
