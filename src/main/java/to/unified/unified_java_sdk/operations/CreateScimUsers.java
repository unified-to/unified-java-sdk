...
public class CreateScimUsers {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateScimUsersRequest, CreateScimUsersResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateScimUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateScimUsersRequest.class, new TypeReference<CreateScimUsersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateScimUsersRequest request) {
        ...
        @Override
        public CreateScimUsersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateScimUsersResponse.Builder resBuilder =
            ...
            CreateScimUsersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withScimUser(Utils.unmarshal(response, new TypeReference<ScimUser>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateScimUsersRequest, to.unified.unified_java_sdk.models.operations.async.CreateScimUsersResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateScimUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateScimUsersRequest.class, new TypeReference<CreateScimUsersRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateScimUsersRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateScimUsersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateScimUsersResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateScimUsersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateScimUsersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ScimUser>() {})
                            .thenApply(res::withScimUser);
                } else {
