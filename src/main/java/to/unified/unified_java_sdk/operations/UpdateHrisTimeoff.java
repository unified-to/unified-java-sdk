...
public class UpdateHrisTimeoff {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisTimeoffRequest, UpdateHrisTimeoffResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisTimeoffRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisTimeoffRequest.class, new TypeReference<UpdateHrisTimeoffRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisTimeoffRequest request) {
        ...
        @Override
        public UpdateHrisTimeoffResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisTimeoffResponse.Builder resBuilder =
            ...
            UpdateHrisTimeoffResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisTimeoffRequest, to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeoffResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisTimeoffRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisTimeoffRequest.class, new TypeReference<UpdateHrisTimeoffRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisTimeoffRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeoffResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeoffResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeoffResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeoffResponse res = resBuilder.build();
