...
public class CreateMetadataMetadata2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateMetadataMetadata2Request, CreateMetadataMetadata2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateMetadataMetadata2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMetadataMetadata2Request.class, new TypeReference<CreateMetadataMetadata2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMetadataMetadata2Request request) {
        ...
        @Override
        public CreateMetadataMetadata2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateMetadataMetadata2Response.Builder resBuilder =
            ...
            CreateMetadataMetadata2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateMetadataMetadata2Request, to.unified.unified_java_sdk.models.operations.async.CreateMetadataMetadata2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateMetadataMetadata2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMetadataMetadata2Request.class, new TypeReference<CreateMetadataMetadata2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateMetadataMetadata2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateMetadataMetadata2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateMetadataMetadata2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateMetadataMetadata2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateMetadataMetadata2Response res = resBuilder.build();
