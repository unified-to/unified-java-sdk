...
public class GetSocialProfile {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSocialProfileRequest, GetSocialProfileResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSocialProfileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSocialProfileRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSocialProfileRequest request) {
        ...
        @Override
        public GetSocialProfileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSocialProfileResponse.Builder resBuilder =
            ...
            GetSocialProfileResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSocialProfile(Utils.unmarshal(response, new TypeReference<SocialProfile>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSocialProfileRequest, to.unified.unified_java_sdk.models.operations.async.GetSocialProfileResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSocialProfileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSocialProfileRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSocialProfileRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetSocialProfileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetSocialProfileResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetSocialProfileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetSocialProfileResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SocialProfile>() {})
                            .thenApply(res::withSocialProfile);
                } else {
