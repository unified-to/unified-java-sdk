...
public class ListPaymentPaymentsOperation implements RequestOperation<ListPaymentPaymentsRequest, ListPaymentPaymentsResponse> {
    ...
    public ListPaymentPaymentsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListPaymentPaymentsRequest request) throws Exception {
