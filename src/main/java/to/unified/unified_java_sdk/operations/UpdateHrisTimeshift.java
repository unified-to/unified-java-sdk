...
public class UpdateHrisTimeshift {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisTimeshiftRequest request) throws Exception {
        ...
        @Override
        public UpdateHrisTimeshiftResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HrisTimeshift out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHrisTimeshift(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
