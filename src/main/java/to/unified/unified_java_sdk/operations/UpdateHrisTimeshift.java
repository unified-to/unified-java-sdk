...
public class UpdateHrisTimeshift {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisTimeshiftRequest, UpdateHrisTimeshiftResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisTimeshiftRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisTimeshiftRequest.class, new TypeReference<UpdateHrisTimeshiftRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisTimeshiftRequest request) {
        ...
        @Override
        public UpdateHrisTimeshiftResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisTimeshiftResponse.Builder resBuilder =
            ...
            UpdateHrisTimeshiftResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisTimeshiftRequest, to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeshiftResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisTimeshiftRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisTimeshiftRequest.class, new TypeReference<UpdateHrisTimeshiftRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisTimeshiftRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeshiftResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeshiftResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeshiftResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeshiftResponse res = resBuilder.build();
