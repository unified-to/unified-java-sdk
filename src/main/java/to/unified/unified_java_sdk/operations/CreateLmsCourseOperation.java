...
public class CreateLmsCourseOperation implements RequestOperation<CreateLmsCourseRequest, CreateLmsCourseResponse> {
    ...
    public CreateLmsCourseOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateLmsCourseRequest request) throws Exception {
