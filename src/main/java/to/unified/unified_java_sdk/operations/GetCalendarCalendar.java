...
public class GetCalendarCalendar {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCalendarCalendarRequest, GetCalendarCalendarResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCalendarCalendarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarCalendarRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCalendarCalendarRequest request) {
        ...
        @Override
        public GetCalendarCalendarResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCalendarCalendarResponse.Builder resBuilder =
            ...
            GetCalendarCalendarResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCalendarCalendarRequest, to.unified.unified_java_sdk.models.operations.async.GetCalendarCalendarResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCalendarCalendarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarCalendarRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCalendarCalendarRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCalendarCalendarResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCalendarCalendarResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCalendarCalendarResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCalendarCalendarResponse res = resBuilder.build();
