...
public class ListLmsClasses {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListLmsClassesRequest, ListLmsClassesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListLmsClassesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsClassesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsClassesRequest request) {
        ...
        @Override
        public ListLmsClassesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListLmsClassesResponse.Builder resBuilder =
            ...
            ListLmsClassesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLmsClassesRequest, to.unified.unified_java_sdk.models.operations.async.ListLmsClassesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListLmsClassesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsClassesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListLmsClassesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListLmsClassesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListLmsClassesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListLmsClassesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListLmsClassesResponse res = resBuilder.build();
