...
public class ListLmsClasses {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsClassesRequest request) throws Exception {
        ...
        @Override
        public ListLmsClassesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<LmsClass> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withLmsClasses(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
