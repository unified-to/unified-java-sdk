...
public class GetTaskCommentOperation implements RequestOperation<GetTaskCommentRequest, GetTaskCommentResponse> {
    ...
    public GetTaskCommentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetTaskCommentRequest request) throws Exception {
