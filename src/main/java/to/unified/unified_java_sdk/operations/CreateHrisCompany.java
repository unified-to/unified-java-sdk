...
public class CreateHrisCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisCompanyRequest, CreateHrisCompanyResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisCompanyRequest request) {
        ...
        @Override
        public CreateHrisCompanyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisCompanyResponse.Builder resBuilder =
            ...
            CreateHrisCompanyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisCompanyRequest, to.unified.unified_java_sdk.models.operations.async.CreateHrisCompanyResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisCompanyRequest.class, new TypeReference<CreateHrisCompanyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisCompanyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisCompanyResponse res = resBuilder.build();
