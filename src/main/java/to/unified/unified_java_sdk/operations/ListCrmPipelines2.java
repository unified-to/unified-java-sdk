...
public class ListCrmPipelines2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCrmPipelines2Request, ListCrmPipelines2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCrmPipelines2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmPipelines2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmPipelines2Request request) {
        ...
        @Override
        public ListCrmPipelines2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCrmPipelines2Response.Builder resBuilder =
            ...
            ListCrmPipelines2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCrmPipelines(Utils.unmarshal(response, new TypeReference<List<CrmPipeline>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCrmPipelines2Request, to.unified.unified_java_sdk.models.operations.async.ListCrmPipelines2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCrmPipelines2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmPipelines2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCrmPipelines2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCrmPipelines2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCrmPipelines2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCrmPipelines2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCrmPipelines2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CrmPipeline>>() {})
                            .thenApply(res::withCrmPipelines);
                } else {
