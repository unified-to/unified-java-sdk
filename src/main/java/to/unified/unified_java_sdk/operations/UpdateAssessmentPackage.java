...
public class UpdateAssessmentPackage {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAssessmentPackageRequest, UpdateAssessmentPackageResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAssessmentPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAssessmentPackageRequest.class, new TypeReference<UpdateAssessmentPackageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAssessmentPackageRequest request) {
        ...
        @Override
        public UpdateAssessmentPackageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAssessmentPackageResponse.Builder resBuilder =
            ...
            UpdateAssessmentPackageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAssessmentPackageRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentPackageResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAssessmentPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAssessmentPackageRequest.class, new TypeReference<UpdateAssessmentPackageRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAssessmentPackageRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentPackageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentPackageResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentPackageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentPackageResponse res = resBuilder.build();
