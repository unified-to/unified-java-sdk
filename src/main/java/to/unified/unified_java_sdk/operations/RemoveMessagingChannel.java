...
public class RemoveMessagingChannel {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveMessagingChannelRequest, RemoveMessagingChannelResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveMessagingChannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMessagingChannelRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveMessagingChannelRequest request) {
        ...
        @Override
        public RemoveMessagingChannelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveMessagingChannelResponse.Builder resBuilder =
            ...
            RemoveMessagingChannelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveMessagingChannelRequest, to.unified.unified_java_sdk.models.operations.async.RemoveMessagingChannelResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveMessagingChannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMessagingChannelRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveMessagingChannelRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveMessagingChannelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveMessagingChannelResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveMessagingChannelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveMessagingChannelResponse res = resBuilder.build();
