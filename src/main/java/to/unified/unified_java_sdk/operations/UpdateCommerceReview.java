...
public class UpdateCommerceReview {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommerceReviewRequest, UpdateCommerceReviewResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceReviewRequest request) {
        ...
        @Override
        public UpdateCommerceReviewResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommerceReviewResponse.Builder resBuilder =
            ...
            UpdateCommerceReviewResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommerceReviewRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReviewResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommerceReviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceReviewRequest.class, new TypeReference<UpdateCommerceReviewRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommerceReviewRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReviewResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReviewResponse res = resBuilder.build();
