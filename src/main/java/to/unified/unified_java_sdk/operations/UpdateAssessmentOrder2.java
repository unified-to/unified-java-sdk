...
public class UpdateAssessmentOrder2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAssessmentOrder2Request, UpdateAssessmentOrder2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAssessmentOrder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAssessmentOrder2Request.class, new TypeReference<UpdateAssessmentOrder2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAssessmentOrder2Request request) {
        ...
        @Override
        public UpdateAssessmentOrder2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAssessmentOrder2Response.Builder resBuilder =
            ...
            UpdateAssessmentOrder2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAssessmentOrder(Utils.unmarshal(response, new TypeReference<AssessmentOrder>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAssessmentOrder2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentOrder2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAssessmentOrder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAssessmentOrder2Request.class, new TypeReference<UpdateAssessmentOrder2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAssessmentOrder2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentOrder2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentOrder2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentOrder2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentOrder2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AssessmentOrder>() {})
                            .thenApply(res::withAssessmentOrder);
                } else {
