...
public class UpdateAnalyticsProperty {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAnalyticsPropertyRequest, UpdateAnalyticsPropertyResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAnalyticsPropertyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAnalyticsPropertyRequest.class, new TypeReference<UpdateAnalyticsPropertyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAnalyticsPropertyRequest request) {
        ...
        @Override
        public UpdateAnalyticsPropertyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAnalyticsPropertyResponse.Builder resBuilder =
            ...
            UpdateAnalyticsPropertyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAnalyticsPropertyRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsPropertyResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAnalyticsPropertyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAnalyticsPropertyRequest.class, new TypeReference<UpdateAnalyticsPropertyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAnalyticsPropertyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsPropertyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsPropertyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsPropertyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsPropertyResponse res = resBuilder.build();
