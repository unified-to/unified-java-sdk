...
public class PatchLmsStudentOperation implements RequestOperation<PatchLmsStudentRequest, PatchLmsStudentResponse> {
    ...
    public PatchLmsStudentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchLmsStudentRequest request) throws Exception {
