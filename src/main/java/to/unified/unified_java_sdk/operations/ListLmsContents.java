...
public class ListLmsContents {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListLmsContentsRequest, ListLmsContentsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListLmsContentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsContentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsContentsRequest request) {
        ...
        @Override
        public ListLmsContentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListLmsContentsResponse.Builder resBuilder =
            ...
            ListLmsContentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLmsContentsRequest, to.unified.unified_java_sdk.models.operations.async.ListLmsContentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListLmsContentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsContentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListLmsContentsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListLmsContentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListLmsContentsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListLmsContentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListLmsContentsResponse res = resBuilder.build();
