...
public class CreateFormsForm2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateFormsForm2Request, CreateFormsForm2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateFormsForm2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateFormsForm2Request.class, new TypeReference<CreateFormsForm2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateFormsForm2Request request) {
        ...
        @Override
        public CreateFormsForm2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateFormsForm2Response.Builder resBuilder =
            ...
            CreateFormsForm2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateFormsForm2Request, to.unified.unified_java_sdk.models.operations.async.CreateFormsForm2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateFormsForm2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateFormsForm2Request.class, new TypeReference<CreateFormsForm2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateFormsForm2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateFormsForm2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateFormsForm2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateFormsForm2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateFormsForm2Response res = resBuilder.build();
