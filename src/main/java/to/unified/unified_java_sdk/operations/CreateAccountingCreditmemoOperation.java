...
public class CreateAccountingCreditmemoOperation implements RequestOperation<CreateAccountingCreditmemoRequest, CreateAccountingCreditmemoResponse> {
    ...
    public CreateAccountingCreditmemoOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAccountingCreditmemoRequest request) throws Exception {
