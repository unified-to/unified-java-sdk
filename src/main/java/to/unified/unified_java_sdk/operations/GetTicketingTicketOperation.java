...
public class GetTicketingTicketOperation implements RequestOperation<GetTicketingTicketRequest, GetTicketingTicketResponse> {
    ...
    public GetTicketingTicketOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetTicketingTicketRequest request) throws Exception {
