...
public class ListUcComments {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUcCommentsRequest, ListUcCommentsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListUcCommentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUcCommentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUcCommentsRequest request) {
        ...
        @Override
        public ListUcCommentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUcCommentsResponse.Builder resBuilder =
            ...
            ListUcCommentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUcCommentsRequest, to.unified.unified_java_sdk.models.operations.async.ListUcCommentsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListUcCommentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUcCommentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUcCommentsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListUcCommentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListUcCommentsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListUcCommentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListUcCommentsResponse res = resBuilder.build();
