...
public class ListHrisTimeshifts2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisTimeshifts2Request, ListHrisTimeshifts2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisTimeshifts2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisTimeshifts2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisTimeshifts2Request request) {
        ...
        @Override
        public ListHrisTimeshifts2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisTimeshifts2Response.Builder resBuilder =
            ...
            ListHrisTimeshifts2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisTimeshifts(Utils.unmarshal(response, new TypeReference<List<HrisTimeshift>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisTimeshifts2Request, to.unified.unified_java_sdk.models.operations.async.ListHrisTimeshifts2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisTimeshifts2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisTimeshifts2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisTimeshifts2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisTimeshifts2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisTimeshifts2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisTimeshifts2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisTimeshifts2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<HrisTimeshift>>() {})
                            .thenApply(res::withHrisTimeshifts);
                } else {
