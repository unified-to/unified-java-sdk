...
public class CreateCommerceCollectionOperation implements RequestOperation<CreateCommerceCollectionRequest, CreateCommerceCollectionResponse> {
    ...
    public CreateCommerceCollectionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateCommerceCollectionRequest request) throws Exception {
