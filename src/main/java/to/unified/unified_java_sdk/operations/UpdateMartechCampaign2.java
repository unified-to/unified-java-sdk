...
public class UpdateMartechCampaign2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMartechCampaign2Request, UpdateMartechCampaign2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateMartechCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMartechCampaign2Request.class, new TypeReference<UpdateMartechCampaign2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMartechCampaign2Request request) {
        ...
        @Override
        public UpdateMartechCampaign2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMartechCampaign2Response.Builder resBuilder =
            ...
            UpdateMartechCampaign2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMartechCampaign2Request, to.unified.unified_java_sdk.models.operations.async.UpdateMartechCampaign2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMartechCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMartechCampaign2Request.class, new TypeReference<UpdateMartechCampaign2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMartechCampaign2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateMartechCampaign2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateMartechCampaign2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateMartechCampaign2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateMartechCampaign2Response res = resBuilder.build();
