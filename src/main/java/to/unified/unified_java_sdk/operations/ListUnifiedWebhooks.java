...
public class ListUnifiedWebhooks {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUnifiedWebhooksRequest, ListUnifiedWebhooksResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListUnifiedWebhooksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUnifiedWebhooksRequest.class);
        ...
        public ListUnifiedWebhooksResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListUnifiedWebhooksResponse.Builder resBuilder =
            ...
            ListUnifiedWebhooksResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUnifiedWebhooksRequest, to.unified.unified_java_sdk.models.operations.async.ListUnifiedWebhooksResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListUnifiedWebhooksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUnifiedWebhooksRequest.class);
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListUnifiedWebhooksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListUnifiedWebhooksResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListUnifiedWebhooksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListUnifiedWebhooksResponse res = resBuilder.build();
