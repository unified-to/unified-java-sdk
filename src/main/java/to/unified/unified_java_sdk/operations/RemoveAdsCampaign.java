...
public class RemoveAdsCampaign {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAdsCampaignRequest, RemoveAdsCampaignResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAdsCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsCampaignRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAdsCampaignRequest request) {
        ...
        @Override
        public RemoveAdsCampaignResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAdsCampaignResponse.Builder resBuilder =
            ...
            RemoveAdsCampaignResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAdsCampaignRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAdsCampaignResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAdsCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsCampaignRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAdsCampaignRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAdsCampaignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAdsCampaignResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAdsCampaignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAdsCampaignResponse res = resBuilder.build();
