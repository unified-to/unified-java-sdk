...
public class GetKmsPage {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetKmsPageRequest, GetKmsPageResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetKmsPageRequest request) {
        ...
        @Override
        public GetKmsPageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetKmsPageResponse.Builder resBuilder =
                    GetKmsPageResponse
                            .builder()
            ...
            GetKmsPageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetKmsPageRequest, to.unified.unified_java_sdk.models.operations.async.GetKmsPageResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetKmsPageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetKmsPageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetKmsPageRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetKmsPageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetKmsPageResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetKmsPageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetKmsPageResponse res = resBuilder.build();
