...
public class ListAtsJobsOperation implements RequestOperation<ListAtsJobsRequest, ListAtsJobsResponse> {
    ...
    public ListAtsJobsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAtsJobsRequest request) throws Exception {
