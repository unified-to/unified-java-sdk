...
public class ListAtsDocuments2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAtsDocuments2Request, ListAtsDocuments2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAtsDocuments2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsDocuments2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsDocuments2Request request) {
        ...
        @Override
        public ListAtsDocuments2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsDocuments2Response.Builder resBuilder =
            ...
            ListAtsDocuments2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsDocuments(Utils.unmarshal(response, new TypeReference<List<AtsDocument>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsDocuments2Request, to.unified.unified_java_sdk.models.operations.async.ListAtsDocuments2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsDocuments2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsDocuments2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsDocuments2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsDocuments2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsDocuments2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsDocuments2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsDocuments2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AtsDocument>>() {})
                            .thenApply(res::withAtsDocuments);
                } else {
