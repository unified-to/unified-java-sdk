...
public class PatchAccountingCreditmemoOperation implements RequestOperation<PatchAccountingCreditmemoRequest, PatchAccountingCreditmemoResponse> {
    ...
    public PatchAccountingCreditmemoOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchAccountingCreditmemoRequest request) throws Exception {
