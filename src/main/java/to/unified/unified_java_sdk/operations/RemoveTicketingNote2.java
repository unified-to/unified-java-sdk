...
public class RemoveTicketingNote2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveTicketingNote2Request, RemoveTicketingNote2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveTicketingNote2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTicketingNote2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveTicketingNote2Request request) {
        ...
        @Override
        public RemoveTicketingNote2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveTicketingNote2Response.Builder resBuilder =
            ...
            RemoveTicketingNote2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveTicketingNote2Request, to.unified.unified_java_sdk.models.operations.async.RemoveTicketingNote2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveTicketingNote2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTicketingNote2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveTicketingNote2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveTicketingNote2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveTicketingNote2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveTicketingNote2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveTicketingNote2Response res = resBuilder.build();
