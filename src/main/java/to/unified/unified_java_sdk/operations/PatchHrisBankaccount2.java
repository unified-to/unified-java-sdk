...
public class PatchHrisBankaccount2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisBankaccount2Request, PatchHrisBankaccount2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisBankaccount2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisBankaccount2Request.class, new TypeReference<PatchHrisBankaccount2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisBankaccount2Request request) {
        ...
        @Override
        public PatchHrisBankaccount2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisBankaccount2Response.Builder resBuilder =
            ...
            PatchHrisBankaccount2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisBankaccount2Request, to.unified.unified_java_sdk.models.operations.async.PatchHrisBankaccount2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisBankaccount2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisBankaccount2Request.class, new TypeReference<PatchHrisBankaccount2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisBankaccount2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisBankaccount2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisBankaccount2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisBankaccount2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisBankaccount2Response res = resBuilder.build();
