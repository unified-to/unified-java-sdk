...
public class PatchAccountingCreditmemo2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingCreditmemo2Request, PatchAccountingCreditmemo2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingCreditmemo2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingCreditmemo2Request.class, new TypeReference<PatchAccountingCreditmemo2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingCreditmemo2Request request) {
        ...
        @Override
        public PatchAccountingCreditmemo2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingCreditmemo2Response.Builder resBuilder =
            ...
            PatchAccountingCreditmemo2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingCreditmemo2Request, to.unified.unified_java_sdk.models.operations.async.PatchAccountingCreditmemo2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingCreditmemo2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingCreditmemo2Request.class, new TypeReference<PatchAccountingCreditmemo2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingCreditmemo2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingCreditmemo2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingCreditmemo2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingCreditmemo2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingCreditmemo2Response res = resBuilder.build();
