...
public class PatchCdpDestination {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCdpDestinationRequest, PatchCdpDestinationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCdpDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCdpDestinationRequest.class, new TypeReference<PatchCdpDestinationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCdpDestinationRequest request) {
        ...
        @Override
        public PatchCdpDestinationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCdpDestinationResponse.Builder resBuilder =
            ...
            PatchCdpDestinationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCdpDestinationRequest, to.unified.unified_java_sdk.models.operations.async.PatchCdpDestinationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCdpDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCdpDestinationRequest.class, new TypeReference<PatchCdpDestinationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCdpDestinationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCdpDestinationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCdpDestinationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCdpDestinationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCdpDestinationResponse res = resBuilder.build();
