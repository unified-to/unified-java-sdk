...
public class UpdateShippingLabel2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateShippingLabel2Request, UpdateShippingLabel2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateShippingLabel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateShippingLabel2Request.class, new TypeReference<UpdateShippingLabel2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateShippingLabel2Request request) {
        ...
        @Override
        public UpdateShippingLabel2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateShippingLabel2Response.Builder resBuilder =
            ...
            UpdateShippingLabel2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withShippingLabel(Utils.unmarshal(response, new TypeReference<ShippingLabel>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateShippingLabel2Request, to.unified.unified_java_sdk.models.operations.async.UpdateShippingLabel2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateShippingLabel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateShippingLabel2Request.class, new TypeReference<UpdateShippingLabel2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateShippingLabel2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateShippingLabel2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateShippingLabel2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateShippingLabel2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateShippingLabel2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ShippingLabel>() {})
                            .thenApply(res::withShippingLabel);
                } else {
