...
public class RemoveCommerceCollection2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCommerceCollection2Request, RemoveCommerceCollection2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCommerceCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceCollection2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCommerceCollection2Request request) {
        ...
        @Override
        public RemoveCommerceCollection2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCommerceCollection2Response.Builder resBuilder =
            ...
            RemoveCommerceCollection2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCommerceCollection2Request, to.unified.unified_java_sdk.models.operations.async.RemoveCommerceCollection2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCommerceCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceCollection2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCommerceCollection2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCommerceCollection2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceCollection2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCommerceCollection2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceCollection2Response res = resBuilder.build();
