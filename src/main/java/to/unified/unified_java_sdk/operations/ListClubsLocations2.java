...
public class ListClubsLocations2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListClubsLocations2Request, ListClubsLocations2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListClubsLocations2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsLocations2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListClubsLocations2Request request) {
        ...
        @Override
        public ListClubsLocations2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListClubsLocations2Response.Builder resBuilder =
            ...
            ListClubsLocations2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClubsLocations(Utils.unmarshal(response, new TypeReference<List<ClubsLocation>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListClubsLocations2Request, to.unified.unified_java_sdk.models.operations.async.ListClubsLocations2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListClubsLocations2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsLocations2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListClubsLocations2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListClubsLocations2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListClubsLocations2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListClubsLocations2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListClubsLocations2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ClubsLocation>>() {})
                            .thenApply(res::withClubsLocations);
                } else {
