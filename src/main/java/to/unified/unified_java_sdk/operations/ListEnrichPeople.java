...
public class ListEnrichPeople {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListEnrichPeopleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEnrichPeopleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListEnrichPeopleRequest request) {
        ...
        @Override
        public ListEnrichPeopleResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListEnrichPeopleRequest, to.unified.unified_java_sdk.models.operations.async.ListEnrichPeopleResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListEnrichPeopleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEnrichPeopleRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListEnrichPeopleRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListEnrichPeopleResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListEnrichPeopleResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListEnrichPeopleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListEnrichPeopleResponse res = resBuilder.build();
