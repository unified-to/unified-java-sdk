...
public class CreateLmsInstructor2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateLmsInstructor2Request, CreateLmsInstructor2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateLmsInstructor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsInstructor2Request.class, new TypeReference<CreateLmsInstructor2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateLmsInstructor2Request request) {
        ...
        @Override
        public CreateLmsInstructor2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateLmsInstructor2Response.Builder resBuilder =
            ...
            CreateLmsInstructor2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLmsInstructor(Utils.unmarshal(response, new TypeReference<LmsInstructor>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateLmsInstructor2Request, to.unified.unified_java_sdk.models.operations.async.CreateLmsInstructor2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateLmsInstructor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsInstructor2Request.class, new TypeReference<CreateLmsInstructor2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateLmsInstructor2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateLmsInstructor2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateLmsInstructor2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateLmsInstructor2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateLmsInstructor2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<LmsInstructor>() {})
                            .thenApply(res::withLmsInstructor);
                } else {
