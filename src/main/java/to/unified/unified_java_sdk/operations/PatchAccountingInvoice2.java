...
public class PatchAccountingInvoice2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingInvoice2Request, PatchAccountingInvoice2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingInvoice2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingInvoice2Request.class, new TypeReference<PatchAccountingInvoice2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingInvoice2Request request) {
        ...
        @Override
        public PatchAccountingInvoice2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingInvoice2Response.Builder resBuilder =
            ...
            PatchAccountingInvoice2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingInvoice2Request, to.unified.unified_java_sdk.models.operations.async.PatchAccountingInvoice2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingInvoice2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingInvoice2Request.class, new TypeReference<PatchAccountingInvoice2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingInvoice2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingInvoice2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingInvoice2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingInvoice2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingInvoice2Response res = resBuilder.build();
