...
public class CreateHrisDevice2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisDevice2Request, CreateHrisDevice2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisDevice2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisDevice2Request.class, new TypeReference<CreateHrisDevice2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisDevice2Request request) {
        ...
        @Override
        public CreateHrisDevice2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisDevice2Response.Builder resBuilder =
            ...
            CreateHrisDevice2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisDevice2Request, to.unified.unified_java_sdk.models.operations.async.CreateHrisDevice2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisDevice2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisDevice2Request.class, new TypeReference<CreateHrisDevice2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisDevice2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisDevice2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisDevice2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisDevice2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisDevice2Response res = resBuilder.build();
