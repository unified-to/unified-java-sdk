...
public class CreateDatastoreQuery2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateDatastoreQuery2Request, CreateDatastoreQuery2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateDatastoreQuery2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDatastoreQuery2Request.class, new TypeReference<CreateDatastoreQuery2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDatastoreQuery2Request request) {
        ...
        @Override
        public CreateDatastoreQuery2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDatastoreQuery2Response.Builder resBuilder =
            ...
            CreateDatastoreQuery2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDatastoreQuery(Utils.unmarshal(response, new TypeReference<DatastoreQuery>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateDatastoreQuery2Request, to.unified.unified_java_sdk.models.operations.async.CreateDatastoreQuery2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateDatastoreQuery2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDatastoreQuery2Request.class, new TypeReference<CreateDatastoreQuery2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateDatastoreQuery2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateDatastoreQuery2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateDatastoreQuery2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateDatastoreQuery2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateDatastoreQuery2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DatastoreQuery>() {})
                            .thenApply(res::withDatastoreQuery);
                } else {
