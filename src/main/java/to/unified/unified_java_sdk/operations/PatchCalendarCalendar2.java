...
public class PatchCalendarCalendar2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCalendarCalendar2Request, PatchCalendarCalendar2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCalendarCalendar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCalendarCalendar2Request.class, new TypeReference<PatchCalendarCalendar2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCalendarCalendar2Request request) {
        ...
        @Override
        public PatchCalendarCalendar2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCalendarCalendar2Response.Builder resBuilder =
            ...
            PatchCalendarCalendar2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCalendarCalendar2Request, to.unified.unified_java_sdk.models.operations.async.PatchCalendarCalendar2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCalendarCalendar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCalendarCalendar2Request.class, new TypeReference<PatchCalendarCalendar2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCalendarCalendar2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCalendarCalendar2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCalendarCalendar2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCalendarCalendar2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCalendarCalendar2Response res = resBuilder.build();
