...
public class ListTaskComments2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTaskComments2Request, ListTaskComments2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListTaskComments2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaskComments2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTaskComments2Request request) {
        ...
        @Override
        public ListTaskComments2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTaskComments2Response.Builder resBuilder =
            ...
            ListTaskComments2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTaskComments(Utils.unmarshal(response, new TypeReference<List<TaskComment>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTaskComments2Request, to.unified.unified_java_sdk.models.operations.async.ListTaskComments2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListTaskComments2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaskComments2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTaskComments2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListTaskComments2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListTaskComments2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListTaskComments2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListTaskComments2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<TaskComment>>() {})
                            .thenApply(res::withTaskComments);
                } else {
