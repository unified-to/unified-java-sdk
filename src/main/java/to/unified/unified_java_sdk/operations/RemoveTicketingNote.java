...
public class RemoveTicketingNote {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveTicketingNoteRequest request) throws Exception {
        ...
        @Override
        public RemoveTicketingNoteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveTicketingNoteResponse.Builder resBuilder =
            ...
            RemoveTicketingNoteResponse res = resBuilder.build();
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RemoveTicketingNoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTicketingNoteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveTicketingNoteRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveTicketingNoteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveTicketingNoteResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveTicketingNoteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveTicketingNoteResponse res = resBuilder.build();
