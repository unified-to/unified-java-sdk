...
public class CreateTicketingNote {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTicketingNoteRequest, CreateTicketingNoteResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateTicketingNoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTicketingNoteRequest.class, new TypeReference<CreateTicketingNoteRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTicketingNoteRequest request) {
        ...
        @Override
        public CreateTicketingNoteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTicketingNoteResponse.Builder resBuilder =
            ...
            CreateTicketingNoteResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTicketingNoteRequest, to.unified.unified_java_sdk.models.operations.async.CreateTicketingNoteResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTicketingNoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTicketingNoteRequest.class, new TypeReference<CreateTicketingNoteRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTicketingNoteRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateTicketingNoteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateTicketingNoteResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateTicketingNoteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateTicketingNoteResponse res = resBuilder.build();
