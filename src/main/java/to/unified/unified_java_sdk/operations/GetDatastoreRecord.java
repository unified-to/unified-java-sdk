...
public class GetDatastoreRecord {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDatastoreRecordRequest, GetDatastoreRecordResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDatastoreRecordRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDatastoreRecordRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDatastoreRecordRequest request) {
        ...
        @Override
        public GetDatastoreRecordResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDatastoreRecordResponse.Builder resBuilder =
            ...
            GetDatastoreRecordResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDatastoreRecordRequest, to.unified.unified_java_sdk.models.operations.async.GetDatastoreRecordResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetDatastoreRecordRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDatastoreRecordRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDatastoreRecordRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetDatastoreRecordResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetDatastoreRecordResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetDatastoreRecordResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetDatastoreRecordResponse res = resBuilder.build();
