...
public class ListAccountingPurchaseorders {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountingPurchaseordersRequest request) throws Exception {
        ...
        @Override
        public ListAccountingPurchaseordersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AccountingPurchaseorder> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingPurchaseorders(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
