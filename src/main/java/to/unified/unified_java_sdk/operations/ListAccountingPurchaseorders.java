...
public class ListAccountingPurchaseorders {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAccountingPurchaseordersRequest, ListAccountingPurchaseordersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAccountingPurchaseordersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAccountingPurchaseordersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountingPurchaseordersRequest request) {
        ...
        @Override
        public ListAccountingPurchaseordersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAccountingPurchaseordersResponse.Builder resBuilder =
            ...
            ListAccountingPurchaseordersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAccountingPurchaseordersRequest, to.unified.unified_java_sdk.models.operations.async.ListAccountingPurchaseordersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAccountingPurchaseordersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAccountingPurchaseordersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAccountingPurchaseordersRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAccountingPurchaseordersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAccountingPurchaseordersResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAccountingPurchaseordersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAccountingPurchaseordersResponse res = resBuilder.build();
