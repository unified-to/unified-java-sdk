...
public class ListPaymentRefundsOperation implements RequestOperation<ListPaymentRefundsRequest, ListPaymentRefundsResponse> {
    ...
    public ListPaymentRefundsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListPaymentRefundsRequest request) throws Exception {
