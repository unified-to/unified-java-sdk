...
public class ListUcRecordings {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUcRecordingsRequest, ListUcRecordingsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListUcRecordingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUcRecordingsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUcRecordingsRequest request) {
        ...
        @Override
        public ListUcRecordingsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUcRecordingsResponse.Builder resBuilder =
            ...
            ListUcRecordingsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUcRecordingsRequest, to.unified.unified_java_sdk.models.operations.async.ListUcRecordingsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListUcRecordingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUcRecordingsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUcRecordingsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListUcRecordingsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListUcRecordingsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListUcRecordingsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListUcRecordingsResponse res = resBuilder.build();
