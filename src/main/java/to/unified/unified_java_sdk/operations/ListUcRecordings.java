...
public class ListUcRecordings {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUcRecordingsRequest request) throws Exception {
        ...
        @Override
        public ListUcRecordingsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<UcRecording> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUcRecordings(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
