...
public class CreateLmsCollection2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateLmsCollection2Request, CreateLmsCollection2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateLmsCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsCollection2Request.class, new TypeReference<CreateLmsCollection2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateLmsCollection2Request request) {
        ...
        @Override
        public CreateLmsCollection2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateLmsCollection2Response.Builder resBuilder =
            ...
            CreateLmsCollection2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateLmsCollection2Request, to.unified.unified_java_sdk.models.operations.async.CreateLmsCollection2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateLmsCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsCollection2Request.class, new TypeReference<CreateLmsCollection2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateLmsCollection2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateLmsCollection2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateLmsCollection2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateLmsCollection2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateLmsCollection2Response res = resBuilder.build();
