...
public class RemoveLmsInstructor {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveLmsInstructorRequest, RemoveLmsInstructorResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveLmsInstructorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsInstructorRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveLmsInstructorRequest request) throws Exception {
        ...
        @Override
        public RemoveLmsInstructorResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveLmsInstructorResponse.Builder resBuilder =
            ...
            RemoveLmsInstructorResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveLmsInstructorRequest, to.unified.unified_java_sdk.models.operations.async.RemoveLmsInstructorResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveLmsInstructorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsInstructorRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveLmsInstructorRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveLmsInstructorResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveLmsInstructorResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveLmsInstructorResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveLmsInstructorResponse res = resBuilder.build();
