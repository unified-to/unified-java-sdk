...
public class ListClubsActivities {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListClubsActivitiesRequest, ListClubsActivitiesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListClubsActivitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsActivitiesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListClubsActivitiesRequest request) {
        ...
        @Override
        public ListClubsActivitiesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListClubsActivitiesResponse.Builder resBuilder =
            ...
            ListClubsActivitiesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListClubsActivitiesRequest, to.unified.unified_java_sdk.models.operations.async.ListClubsActivitiesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListClubsActivitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsActivitiesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListClubsActivitiesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListClubsActivitiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListClubsActivitiesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListClubsActivitiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListClubsActivitiesResponse res = resBuilder.build();
