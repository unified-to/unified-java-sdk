...
public class ListEnrichPeople2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListEnrichPeople2Request, ListEnrichPeople2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListEnrichPeople2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListEnrichPeople2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListEnrichPeople2Request request) {
        ...
        @Override
        public ListEnrichPeople2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListEnrichPeople2Response.Builder resBuilder =
            ...
            ListEnrichPeople2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEnrichPerson(Utils.unmarshal(response, new TypeReference<EnrichPerson>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListEnrichPeople2Request, to.unified.unified_java_sdk.models.operations.async.ListEnrichPeople2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListEnrichPeople2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListEnrichPeople2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListEnrichPeople2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListEnrichPeople2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListEnrichPeople2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListEnrichPeople2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListEnrichPeople2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EnrichPerson>() {})
                            .thenApply(res::withEnrichPerson);
                } else {
