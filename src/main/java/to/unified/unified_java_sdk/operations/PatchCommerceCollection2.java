...
public class PatchCommerceCollection2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCommerceCollection2Request, PatchCommerceCollection2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCommerceCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceCollection2Request.class, new TypeReference<PatchCommerceCollection2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCommerceCollection2Request request) {
        ...
        @Override
        public PatchCommerceCollection2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCommerceCollection2Response.Builder resBuilder =
            ...
            PatchCommerceCollection2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCommerceCollection2Request, to.unified.unified_java_sdk.models.operations.async.PatchCommerceCollection2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCommerceCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceCollection2Request.class, new TypeReference<PatchCommerceCollection2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCommerceCollection2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCommerceCollection2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCommerceCollection2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCommerceCollection2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCommerceCollection2Response res = resBuilder.build();
