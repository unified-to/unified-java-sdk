...
public class RemoveDatastoreRecord2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveDatastoreRecord2Request, RemoveDatastoreRecord2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveDatastoreRecord2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDatastoreRecord2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveDatastoreRecord2Request request) {
        ...
        @Override
        public RemoveDatastoreRecord2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveDatastoreRecord2Response.Builder resBuilder =
            ...
            RemoveDatastoreRecord2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveDatastoreRecord2Request, to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreRecord2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveDatastoreRecord2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDatastoreRecord2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveDatastoreRecord2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreRecord2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreRecord2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreRecord2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreRecord2Response res = resBuilder.build();
