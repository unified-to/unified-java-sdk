...
public class RemoveCdpDestination {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCdpDestinationRequest, RemoveCdpDestinationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCdpDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCdpDestinationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCdpDestinationRequest request) {
        ...
        @Override
        public RemoveCdpDestinationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCdpDestinationResponse.Builder resBuilder =
            ...
            RemoveCdpDestinationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCdpDestinationRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCdpDestinationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCdpDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCdpDestinationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCdpDestinationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCdpDestinationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCdpDestinationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCdpDestinationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCdpDestinationResponse res = resBuilder.build();
