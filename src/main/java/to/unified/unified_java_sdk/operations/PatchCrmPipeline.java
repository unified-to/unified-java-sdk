...
public class PatchCrmPipeline {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCrmPipelineRequest, PatchCrmPipelineResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCrmPipelineRequest request) {
        ...
        @Override
        public PatchCrmPipelineResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCrmPipelineResponse.Builder resBuilder =
            ...
            PatchCrmPipelineResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCrmPipelineRequest, to.unified.unified_java_sdk.models.operations.async.PatchCrmPipelineResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCrmPipelineRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmPipelineRequest.class, new TypeReference<PatchCrmPipelineRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCrmPipelineRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCrmPipelineResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCrmPipelineResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCrmPipelineResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCrmPipelineResponse res = resBuilder.build();
