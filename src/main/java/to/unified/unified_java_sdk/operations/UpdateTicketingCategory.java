...
public class UpdateTicketingCategory {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTicketingCategoryRequest, UpdateTicketingCategoryResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTicketingCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketingCategoryRequest.class, new TypeReference<UpdateTicketingCategoryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTicketingCategoryRequest request) throws Exception {
        ...
        @Override
        public UpdateTicketingCategoryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTicketingCategoryResponse.Builder resBuilder =
            ...
            UpdateTicketingCategoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateTicketingCategoryRequest, to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCategoryResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateTicketingCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketingCategoryRequest.class, new TypeReference<UpdateTicketingCategoryRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateTicketingCategoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCategoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCategoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCategoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCategoryResponse res = resBuilder.build();
