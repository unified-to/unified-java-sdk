...
public class UpdateCdpDestination {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCdpDestinationRequest, UpdateCdpDestinationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCdpDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCdpDestinationRequest.class, new TypeReference<UpdateCdpDestinationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCdpDestinationRequest request) {
        ...
        @Override
        public UpdateCdpDestinationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCdpDestinationResponse.Builder resBuilder =
            ...
            UpdateCdpDestinationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCdpDestinationRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCdpDestinationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCdpDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCdpDestinationRequest.class, new TypeReference<UpdateCdpDestinationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCdpDestinationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCdpDestinationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCdpDestinationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCdpDestinationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCdpDestinationResponse res = resBuilder.build();
