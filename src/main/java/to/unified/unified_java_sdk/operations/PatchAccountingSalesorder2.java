...
public class PatchAccountingSalesorder2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingSalesorder2Request, PatchAccountingSalesorder2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingSalesorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingSalesorder2Request.class, new TypeReference<PatchAccountingSalesorder2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingSalesorder2Request request) {
        ...
        @Override
        public PatchAccountingSalesorder2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingSalesorder2Response.Builder resBuilder =
            ...
            PatchAccountingSalesorder2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingSalesorder2Request, to.unified.unified_java_sdk.models.operations.async.PatchAccountingSalesorder2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingSalesorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingSalesorder2Request.class, new TypeReference<PatchAccountingSalesorder2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingSalesorder2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingSalesorder2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingSalesorder2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingSalesorder2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingSalesorder2Response res = resBuilder.build();
