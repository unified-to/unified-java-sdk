...
public class GetDatastoreTable2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDatastoreTable2Request, GetDatastoreTable2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDatastoreTable2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetDatastoreTable2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDatastoreTable2Request request) {
        ...
        @Override
        public GetDatastoreTable2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDatastoreTable2Response.Builder resBuilder =
            ...
            GetDatastoreTable2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDatastoreTable2Request, to.unified.unified_java_sdk.models.operations.async.GetDatastoreTable2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetDatastoreTable2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetDatastoreTable2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDatastoreTable2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetDatastoreTable2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetDatastoreTable2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetDatastoreTable2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetDatastoreTable2Response res = resBuilder.build();
