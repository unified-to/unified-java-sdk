...
public class GetTaskProject {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTaskProjectRequest, GetTaskProjectResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTaskProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskProjectRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTaskProjectRequest request) {
        ...
        @Override
        public GetTaskProjectResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTaskProjectResponse.Builder resBuilder =
            ...
            GetTaskProjectResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTaskProjectRequest, to.unified.unified_java_sdk.models.operations.async.GetTaskProjectResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTaskProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskProjectRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTaskProjectRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetTaskProjectResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetTaskProjectResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetTaskProjectResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetTaskProjectResponse res = resBuilder.build();
