...
public class UpdateAtsActivity2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAtsActivity2Request, UpdateAtsActivity2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAtsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsActivity2Request.class, new TypeReference<UpdateAtsActivity2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsActivity2Request request) {
        ...
        @Override
        public UpdateAtsActivity2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAtsActivity2Response.Builder resBuilder =
            ...
            UpdateAtsActivity2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsActivity(Utils.unmarshal(response, new TypeReference<AtsActivity>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAtsActivity2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAtsActivity2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAtsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsActivity2Request.class, new TypeReference<UpdateAtsActivity2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAtsActivity2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAtsActivity2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAtsActivity2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAtsActivity2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAtsActivity2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AtsActivity>() {})
                            .thenApply(res::withAtsActivity);
                } else {
