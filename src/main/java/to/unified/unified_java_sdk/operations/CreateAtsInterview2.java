...
public class CreateAtsInterview2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAtsInterview2Request, CreateAtsInterview2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAtsInterview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsInterview2Request.class, new TypeReference<CreateAtsInterview2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsInterview2Request request) {
        ...
        @Override
        public CreateAtsInterview2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAtsInterview2Response.Builder resBuilder =
            ...
            CreateAtsInterview2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAtsInterview2Request, to.unified.unified_java_sdk.models.operations.async.CreateAtsInterview2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAtsInterview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsInterview2Request.class, new TypeReference<CreateAtsInterview2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAtsInterview2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAtsInterview2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAtsInterview2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAtsInterview2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAtsInterview2Response res = resBuilder.build();
