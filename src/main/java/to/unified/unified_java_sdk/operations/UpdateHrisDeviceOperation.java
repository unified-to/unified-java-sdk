...
public class UpdateHrisDeviceOperation implements RequestOperation<UpdateHrisDeviceRequest, UpdateHrisDeviceResponse> {
    ...
    public UpdateHrisDeviceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateHrisDeviceRequest request) throws Exception {
