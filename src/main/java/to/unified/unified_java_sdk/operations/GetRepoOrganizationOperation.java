...
public class GetRepoOrganizationOperation implements RequestOperation<GetRepoOrganizationRequest, GetRepoOrganizationResponse> {
    ...
    public GetRepoOrganizationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetRepoOrganizationRequest request) throws Exception {
