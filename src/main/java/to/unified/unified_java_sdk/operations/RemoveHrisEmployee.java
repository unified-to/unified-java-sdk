...
public class RemoveHrisEmployee {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisEmployeeRequest, RemoveHrisEmployeeResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisEmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisEmployeeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisEmployeeRequest request) throws Exception {
        ...
        @Override
        public RemoveHrisEmployeeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisEmployeeResponse.Builder resBuilder =
            ...
            RemoveHrisEmployeeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisEmployeeRequest, to.unified.unified_java_sdk.models.operations.async.RemoveHrisEmployeeResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisEmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisEmployeeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisEmployeeRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisEmployeeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisEmployeeResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisEmployeeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisEmployeeResponse res = resBuilder.build();
