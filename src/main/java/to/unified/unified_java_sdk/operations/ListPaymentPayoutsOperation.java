...
public class ListPaymentPayoutsOperation implements RequestOperation<ListPaymentPayoutsRequest, ListPaymentPayoutsResponse> {
    ...
    public ListPaymentPayoutsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListPaymentPayoutsRequest request) throws Exception {
