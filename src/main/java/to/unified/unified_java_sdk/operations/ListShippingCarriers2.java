...
public class ListShippingCarriers2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListShippingCarriers2Request, ListShippingCarriers2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListShippingCarriers2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListShippingCarriers2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListShippingCarriers2Request request) {
        ...
        @Override
        public ListShippingCarriers2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListShippingCarriers2Response.Builder resBuilder =
            ...
            ListShippingCarriers2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListShippingCarriers2Request, to.unified.unified_java_sdk.models.operations.async.ListShippingCarriers2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListShippingCarriers2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListShippingCarriers2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListShippingCarriers2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListShippingCarriers2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListShippingCarriers2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListShippingCarriers2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListShippingCarriers2Response res = resBuilder.build();
