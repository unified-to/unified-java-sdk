...
public class RemoveHrisLocation {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisLocationRequest, RemoveHrisLocationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisLocationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisLocationRequest request) throws Exception {
        ...
        @Override
        public RemoveHrisLocationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisLocationResponse.Builder resBuilder =
            ...
            RemoveHrisLocationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisLocationRequest, to.unified.unified_java_sdk.models.operations.async.RemoveHrisLocationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisLocationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisLocationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisLocationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisLocationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisLocationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisLocationResponse res = resBuilder.build();
