...
public class PatchAdsGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAdsGroupRequest, PatchAdsGroupResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAdsGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsGroupRequest.class, new TypeReference<PatchAdsGroupRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAdsGroupRequest request) {
        ...
        @Override
        public PatchAdsGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAdsGroupResponse.Builder resBuilder =
            ...
            PatchAdsGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAdsGroupRequest, to.unified.unified_java_sdk.models.operations.async.PatchAdsGroupResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAdsGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsGroupRequest.class, new TypeReference<PatchAdsGroupRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAdsGroupRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAdsGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAdsGroupResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAdsGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAdsGroupResponse res = resBuilder.build();
