...
public class PatchCommerceReview {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCommerceReviewRequest, PatchCommerceReviewResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCommerceReviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceReviewRequest.class, new TypeReference<PatchCommerceReviewRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCommerceReviewRequest request) {
        ...
        @Override
        public PatchCommerceReviewResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCommerceReviewResponse.Builder resBuilder =
            ...
            PatchCommerceReviewResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCommerceReviewRequest, to.unified.unified_java_sdk.models.operations.async.PatchCommerceReviewResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCommerceReviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceReviewRequest.class, new TypeReference<PatchCommerceReviewRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCommerceReviewRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCommerceReviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCommerceReviewResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCommerceReviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCommerceReviewResponse res = resBuilder.build();
