...
public class GetMartechCampaign {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMartechCampaignRequest, GetMartechCampaignResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetMartechCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMartechCampaignRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMartechCampaignRequest request) {
        ...
        @Override
        public GetMartechCampaignResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMartechCampaignResponse.Builder resBuilder =
            ...
            GetMartechCampaignResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMartechCampaignRequest, to.unified.unified_java_sdk.models.operations.async.GetMartechCampaignResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMartechCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMartechCampaignRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMartechCampaignRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetMartechCampaignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetMartechCampaignResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetMartechCampaignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetMartechCampaignResponse res = resBuilder.build();
