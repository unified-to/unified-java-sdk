...
public class CreateMartechMemberOperation implements RequestOperation<CreateMartechMemberRequest, CreateMartechMemberResponse> {
    ...
    public CreateMartechMemberOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateMartechMemberRequest request) throws Exception {
