...
public class CreateAccountingTaxrateOperation implements RequestOperation<CreateAccountingTaxrateRequest, CreateAccountingTaxrateResponse> {
    ...
    public CreateAccountingTaxrateOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAccountingTaxrateRequest request) throws Exception {
