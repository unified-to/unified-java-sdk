...
public class GetCrmContactOperation implements RequestOperation<GetCrmContactRequest, GetCrmContactResponse> {
    ...
    public GetCrmContactOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetCrmContactRequest request) throws Exception {
