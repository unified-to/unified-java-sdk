...
public class UpdateAnalyticsProperty2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAnalyticsProperty2Request, UpdateAnalyticsProperty2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAnalyticsProperty2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAnalyticsProperty2Request.class, new TypeReference<UpdateAnalyticsProperty2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAnalyticsProperty2Request request) {
        ...
        @Override
        public UpdateAnalyticsProperty2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAnalyticsProperty2Response.Builder resBuilder =
            ...
            UpdateAnalyticsProperty2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAnalyticsProperty(Utils.unmarshal(response, new TypeReference<AnalyticsProperty>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAnalyticsProperty2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsProperty2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAnalyticsProperty2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAnalyticsProperty2Request.class, new TypeReference<UpdateAnalyticsProperty2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAnalyticsProperty2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsProperty2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsProperty2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsProperty2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsProperty2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AnalyticsProperty>() {})
                            .thenApply(res::withAnalyticsProperty);
                } else {
