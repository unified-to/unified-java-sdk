...
public class UpdateAccountingOrderOperation implements RequestOperation<UpdateAccountingOrderRequest, UpdateAccountingOrderResponse> {
    ...
    public UpdateAccountingOrderOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAccountingOrderRequest request) throws Exception {
