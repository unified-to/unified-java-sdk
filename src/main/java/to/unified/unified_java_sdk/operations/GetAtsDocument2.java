...
public class GetAtsDocument2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAtsDocument2Request, GetAtsDocument2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAtsDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsDocument2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAtsDocument2Request request) {
        ...
        @Override
        public GetAtsDocument2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAtsDocument2Response.Builder resBuilder =
            ...
            GetAtsDocument2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAtsDocument2Request, to.unified.unified_java_sdk.models.operations.async.GetAtsDocument2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAtsDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsDocument2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAtsDocument2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAtsDocument2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAtsDocument2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAtsDocument2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAtsDocument2Response res = resBuilder.build();
