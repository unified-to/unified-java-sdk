...
public class UpdateMartechList2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMartechList2Request, UpdateMartechList2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateMartechList2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMartechList2Request.class, new TypeReference<UpdateMartechList2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMartechList2Request request) {
        ...
        @Override
        public UpdateMartechList2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMartechList2Response.Builder resBuilder =
            ...
            UpdateMartechList2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMartechList2Request, to.unified.unified_java_sdk.models.operations.async.UpdateMartechList2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMartechList2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMartechList2Request.class, new TypeReference<UpdateMartechList2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMartechList2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateMartechList2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateMartechList2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateMartechList2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateMartechList2Response res = resBuilder.build();
