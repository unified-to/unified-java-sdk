...
public class ListLmsStudentsOperation implements RequestOperation<ListLmsStudentsRequest, ListLmsStudentsResponse> {
    ...
    public ListLmsStudentsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListLmsStudentsRequest request) throws Exception {
