...
public class CreateDatastoreDatabase {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateDatastoreDatabaseRequest, CreateDatastoreDatabaseResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateDatastoreDatabaseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDatastoreDatabaseRequest.class, new TypeReference<CreateDatastoreDatabaseRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDatastoreDatabaseRequest request) {
        ...
        @Override
        public CreateDatastoreDatabaseResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDatastoreDatabaseResponse.Builder resBuilder =
            ...
            CreateDatastoreDatabaseResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateDatastoreDatabaseRequest, to.unified.unified_java_sdk.models.operations.async.CreateDatastoreDatabaseResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateDatastoreDatabaseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDatastoreDatabaseRequest.class, new TypeReference<CreateDatastoreDatabaseRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateDatastoreDatabaseRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateDatastoreDatabaseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateDatastoreDatabaseResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateDatastoreDatabaseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateDatastoreDatabaseResponse res = resBuilder.build();
