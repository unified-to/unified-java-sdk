...
public class PatchHrisLocation {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisLocationRequest, PatchHrisLocationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisLocationRequest.class, new TypeReference<PatchHrisLocationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisLocationRequest request) {
        ...
        @Override
        public PatchHrisLocationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisLocationResponse.Builder resBuilder =
            ...
            PatchHrisLocationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisLocationRequest, to.unified.unified_java_sdk.models.operations.async.PatchHrisLocationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisLocationRequest.class, new TypeReference<PatchHrisLocationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisLocationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisLocationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisLocationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisLocationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisLocationResponse res = resBuilder.build();
