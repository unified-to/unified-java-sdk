...
public class CreateAccountingOrder {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingOrderRequest request) throws Exception {
        ...
        @Override
        public CreateAccountingOrderResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingOrder out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingOrder(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
