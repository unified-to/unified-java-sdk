...
public class ListHrisLocations2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisLocations2Request, ListHrisLocations2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisLocations2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisLocations2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisLocations2Request request) {
        ...
        @Override
        public ListHrisLocations2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisLocations2Response.Builder resBuilder =
            ...
            ListHrisLocations2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisLocations(Utils.unmarshal(response, new TypeReference<List<HrisLocation>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisLocations2Request, to.unified.unified_java_sdk.models.operations.async.ListHrisLocations2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisLocations2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisLocations2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisLocations2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisLocations2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisLocations2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisLocations2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisLocations2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<HrisLocation>>() {})
                            .thenApply(res::withHrisLocations);
                } else {
