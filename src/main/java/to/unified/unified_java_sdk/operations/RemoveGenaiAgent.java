...
public class RemoveGenaiAgent {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveGenaiAgentRequest, RemoveGenaiAgentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveGenaiAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveGenaiAgentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveGenaiAgentRequest request) {
        ...
        @Override
        public RemoveGenaiAgentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveGenaiAgentResponse.Builder resBuilder =
            ...
            RemoveGenaiAgentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveGenaiAgentRequest, to.unified.unified_java_sdk.models.operations.async.RemoveGenaiAgentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveGenaiAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveGenaiAgentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveGenaiAgentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveGenaiAgentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveGenaiAgentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveGenaiAgentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveGenaiAgentResponse res = resBuilder.build();
