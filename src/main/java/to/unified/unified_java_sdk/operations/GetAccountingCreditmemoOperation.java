...
public class GetAccountingCreditmemoOperation implements RequestOperation<GetAccountingCreditmemoRequest, GetAccountingCreditmemoResponse> {
    ...
    public GetAccountingCreditmemoOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountingCreditmemoRequest request) throws Exception {
