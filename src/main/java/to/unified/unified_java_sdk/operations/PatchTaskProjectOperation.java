...
public class PatchTaskProjectOperation implements RequestOperation<PatchTaskProjectRequest, PatchTaskProjectResponse> {
    ...
    public PatchTaskProjectOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchTaskProjectRequest request) throws Exception {
