...
public class ListTaskCommentsOperation implements RequestOperation<ListTaskCommentsRequest, ListTaskCommentsResponse> {
    ...
    public ListTaskCommentsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListTaskCommentsRequest request) throws Exception {
