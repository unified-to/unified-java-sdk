...
public class CreateAccountingAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAccountingAccountRequest, CreateAccountingAccountResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAccountingAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingAccountRequest.class, new TypeReference<CreateAccountingAccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingAccountRequest request) throws Exception {
        ...
        @Override
        public CreateAccountingAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAccountingAccountResponse.Builder resBuilder =
            ...
            CreateAccountingAccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingAccount out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingAccount(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAccountingAccountRequest, to.unified.unified_java_sdk.models.operations.async.CreateAccountingAccountResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAccountingAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingAccountRequest.class, new TypeReference<CreateAccountingAccountRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAccountingAccountRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAccountingAccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAccountingAccountResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAccountingAccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAccountingAccountResponse res = resBuilder.build();
