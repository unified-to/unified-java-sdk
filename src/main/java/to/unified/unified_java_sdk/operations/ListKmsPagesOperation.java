...
public class ListKmsPagesOperation implements RequestOperation<ListKmsPagesRequest, ListKmsPagesResponse> {
    ...
    public ListKmsPagesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListKmsPagesRequest request) throws Exception {
