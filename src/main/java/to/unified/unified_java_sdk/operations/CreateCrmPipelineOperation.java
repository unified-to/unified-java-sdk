...
public class CreateCrmPipelineOperation implements RequestOperation<CreateCrmPipelineRequest, CreateCrmPipelineResponse> {
    ...
    public CreateCrmPipelineOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateCrmPipelineRequest request) throws Exception {
