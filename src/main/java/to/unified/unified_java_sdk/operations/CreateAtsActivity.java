...
public class CreateAtsActivity {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAtsActivityRequest, CreateAtsActivityResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAtsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsActivityRequest.class, new TypeReference<CreateAtsActivityRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsActivityRequest request) {
        ...
        @Override
        public CreateAtsActivityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAtsActivityResponse.Builder resBuilder =
            ...
            CreateAtsActivityResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAtsActivityRequest, to.unified.unified_java_sdk.models.operations.async.CreateAtsActivityResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAtsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsActivityRequest.class, new TypeReference<CreateAtsActivityRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAtsActivityRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAtsActivityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAtsActivityResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAtsActivityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAtsActivityResponse res = resBuilder.build();
