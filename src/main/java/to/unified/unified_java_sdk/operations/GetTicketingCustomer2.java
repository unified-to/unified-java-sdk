...
public class GetTicketingCustomer2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTicketingCustomer2Request, GetTicketingCustomer2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTicketingCustomer2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetTicketingCustomer2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTicketingCustomer2Request request) {
        ...
        @Override
        public GetTicketingCustomer2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTicketingCustomer2Response.Builder resBuilder =
            ...
            GetTicketingCustomer2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTicketingCustomer2Request, to.unified.unified_java_sdk.models.operations.async.GetTicketingCustomer2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTicketingCustomer2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetTicketingCustomer2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTicketingCustomer2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetTicketingCustomer2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetTicketingCustomer2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetTicketingCustomer2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetTicketingCustomer2Response res = resBuilder.build();
