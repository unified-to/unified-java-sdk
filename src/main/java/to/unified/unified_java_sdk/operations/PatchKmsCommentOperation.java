...
public class PatchKmsCommentOperation implements RequestOperation<PatchKmsCommentRequest, PatchKmsCommentResponse> {
    ...
    public PatchKmsCommentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchKmsCommentRequest request) throws Exception {
