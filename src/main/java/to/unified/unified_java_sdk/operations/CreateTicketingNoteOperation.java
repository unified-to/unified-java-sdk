...
public class CreateTicketingNoteOperation implements RequestOperation<CreateTicketingNoteRequest, CreateTicketingNoteResponse> {
    ...
    public CreateTicketingNoteOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateTicketingNoteRequest request) throws Exception {
