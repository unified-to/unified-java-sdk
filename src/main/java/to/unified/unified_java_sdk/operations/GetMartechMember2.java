...
public class GetMartechMember2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMartechMember2Request, GetMartechMember2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetMartechMember2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetMartechMember2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMartechMember2Request request) {
        ...
        @Override
        public GetMartechMember2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMartechMember2Response.Builder resBuilder =
            ...
            GetMartechMember2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMartechMember2Request, to.unified.unified_java_sdk.models.operations.async.GetMartechMember2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMartechMember2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetMartechMember2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMartechMember2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetMartechMember2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetMartechMember2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetMartechMember2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetMartechMember2Response res = resBuilder.build();
