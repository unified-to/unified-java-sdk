...
public class UpdateUcContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateUcContactRequest, UpdateUcContactResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateUcContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUcContactRequest.class, new TypeReference<UpdateUcContactRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateUcContactRequest request) {
        ...
        @Override
        public UpdateUcContactResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateUcContactResponse.Builder resBuilder =
            ...
            UpdateUcContactResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateUcContactRequest, to.unified.unified_java_sdk.models.operations.async.UpdateUcContactResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateUcContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUcContactRequest.class, new TypeReference<UpdateUcContactRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateUcContactRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateUcContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateUcContactResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateUcContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateUcContactResponse res = resBuilder.build();
