...
public class UpdateUcContact {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateUcContactRequest request) throws Exception {
        ...
        @Override
        public UpdateUcContactResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UcContact out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUcContact(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
