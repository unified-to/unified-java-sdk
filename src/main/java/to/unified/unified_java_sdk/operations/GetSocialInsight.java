...
public class GetSocialInsight {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSocialInsightRequest, GetSocialInsightResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSocialInsightRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSocialInsightRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSocialInsightRequest request) {
        ...
        @Override
        public GetSocialInsightResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSocialInsightResponse.Builder resBuilder =
            ...
            GetSocialInsightResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSocialInsight(Utils.unmarshal(response, new TypeReference<SocialInsight>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSocialInsightRequest, to.unified.unified_java_sdk.models.operations.async.GetSocialInsightResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSocialInsightRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSocialInsightRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSocialInsightRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetSocialInsightResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetSocialInsightResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetSocialInsightResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetSocialInsightResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SocialInsight>() {})
                            .thenApply(res::withSocialInsight);
                } else {
