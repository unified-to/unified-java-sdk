...
public class ListAccountingTrialbalancesOperation implements RequestOperation<ListAccountingTrialbalancesRequest, ListAccountingTrialbalancesResponse> {
    ...
    public ListAccountingTrialbalancesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAccountingTrialbalancesRequest request) throws Exception {
        String url = Utils.generateURL(
                ListAccountingTrialbalancesRequest.class,
                this.baseUrl,
