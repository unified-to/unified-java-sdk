...
public class RemoveCrmContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCrmContactRequest, RemoveCrmContactResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCrmContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmContactRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCrmContactRequest request) throws Exception {
        ...
        @Override
        public RemoveCrmContactResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCrmContactResponse.Builder resBuilder =
            ...
            RemoveCrmContactResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCrmContactRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCrmContactResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCrmContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmContactRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCrmContactRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCrmContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCrmContactResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCrmContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCrmContactResponse res = resBuilder.build();
