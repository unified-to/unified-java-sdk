...
public class PatchCommerceSaleschannel2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCommerceSaleschannel2Request, PatchCommerceSaleschannel2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCommerceSaleschannel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceSaleschannel2Request.class, new TypeReference<PatchCommerceSaleschannel2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCommerceSaleschannel2Request request) {
        ...
        @Override
        public PatchCommerceSaleschannel2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCommerceSaleschannel2Response.Builder resBuilder =
            ...
            PatchCommerceSaleschannel2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCommerceSaleschannel2Request, to.unified.unified_java_sdk.models.operations.async.PatchCommerceSaleschannel2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCommerceSaleschannel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceSaleschannel2Request.class, new TypeReference<PatchCommerceSaleschannel2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCommerceSaleschannel2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCommerceSaleschannel2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCommerceSaleschannel2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCommerceSaleschannel2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCommerceSaleschannel2Response res = resBuilder.build();
