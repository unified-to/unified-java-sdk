...
public class UpdateMetadataMetadata {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMetadataMetadataRequest, UpdateMetadataMetadataResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateMetadataMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMetadataMetadataRequest.class, new TypeReference<UpdateMetadataMetadataRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMetadataMetadataRequest request) {
        ...
        @Override
        public UpdateMetadataMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMetadataMetadataResponse.Builder resBuilder =
            ...
            UpdateMetadataMetadataResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMetadataMetadataRequest, to.unified.unified_java_sdk.models.operations.async.UpdateMetadataMetadataResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMetadataMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMetadataMetadataRequest.class, new TypeReference<UpdateMetadataMetadataRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMetadataMetadataRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateMetadataMetadataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateMetadataMetadataResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateMetadataMetadataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateMetadataMetadataResponse res = resBuilder.build();
