...
public class CreateLmsStudent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateLmsStudent2Request, CreateLmsStudent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateLmsStudent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsStudent2Request.class, new TypeReference<CreateLmsStudent2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateLmsStudent2Request request) {
        ...
        @Override
        public CreateLmsStudent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateLmsStudent2Response.Builder resBuilder =
            ...
            CreateLmsStudent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateLmsStudent2Request, to.unified.unified_java_sdk.models.operations.async.CreateLmsStudent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateLmsStudent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsStudent2Request.class, new TypeReference<CreateLmsStudent2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateLmsStudent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateLmsStudent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateLmsStudent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateLmsStudent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateLmsStudent2Response res = resBuilder.build();
