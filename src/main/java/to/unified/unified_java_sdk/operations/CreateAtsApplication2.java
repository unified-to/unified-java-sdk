...
public class CreateAtsApplication2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAtsApplication2Request, CreateAtsApplication2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAtsApplication2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsApplication2Request.class, new TypeReference<CreateAtsApplication2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsApplication2Request request) {
        ...
        @Override
        public CreateAtsApplication2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAtsApplication2Response.Builder resBuilder =
            ...
            CreateAtsApplication2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsApplication(Utils.unmarshal(response, new TypeReference<AtsApplication>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAtsApplication2Request, to.unified.unified_java_sdk.models.operations.async.CreateAtsApplication2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAtsApplication2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsApplication2Request.class, new TypeReference<CreateAtsApplication2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAtsApplication2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAtsApplication2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAtsApplication2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAtsApplication2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAtsApplication2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AtsApplication>() {})
                            .thenApply(res::withAtsApplication);
                } else {
