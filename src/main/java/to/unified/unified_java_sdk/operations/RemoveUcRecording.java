...
public class RemoveUcRecording {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveUcRecordingRequest, RemoveUcRecordingResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveUcRecordingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUcRecordingRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveUcRecordingRequest request) throws Exception {
        ...
        @Override
        public RemoveUcRecordingResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveUcRecordingResponse.Builder resBuilder =
            ...
            RemoveUcRecordingResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveUcRecordingRequest, to.unified.unified_java_sdk.models.operations.async.RemoveUcRecordingResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveUcRecordingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUcRecordingRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveUcRecordingRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveUcRecordingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveUcRecordingResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveUcRecordingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveUcRecordingResponse res = resBuilder.build();
