...
public class GetScimGroupsOperation implements RequestOperation<GetScimGroupsRequest, GetScimGroupsResponse> {
    ...
    public GetScimGroupsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetScimGroupsRequest request) throws Exception {
