...
public class PatchCommerceInventory {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCommerceInventoryRequest, PatchCommerceInventoryResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCommerceInventoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceInventoryRequest.class, new TypeReference<PatchCommerceInventoryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCommerceInventoryRequest request) {
        ...
        @Override
        public PatchCommerceInventoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCommerceInventoryResponse.Builder resBuilder =
            ...
            PatchCommerceInventoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCommerceInventoryRequest, to.unified.unified_java_sdk.models.operations.async.PatchCommerceInventoryResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCommerceInventoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceInventoryRequest.class, new TypeReference<PatchCommerceInventoryRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCommerceInventoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCommerceInventoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCommerceInventoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCommerceInventoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCommerceInventoryResponse res = resBuilder.build();
