...
public class PatchAccountingPurchaseorder2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingPurchaseorder2Request, PatchAccountingPurchaseorder2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingPurchaseorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingPurchaseorder2Request.class, new TypeReference<PatchAccountingPurchaseorder2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingPurchaseorder2Request request) {
        ...
        @Override
        public PatchAccountingPurchaseorder2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingPurchaseorder2Response.Builder resBuilder =
            ...
            PatchAccountingPurchaseorder2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingPurchaseorder2Request, to.unified.unified_java_sdk.models.operations.async.PatchAccountingPurchaseorder2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingPurchaseorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingPurchaseorder2Request.class, new TypeReference<PatchAccountingPurchaseorder2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingPurchaseorder2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingPurchaseorder2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingPurchaseorder2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingPurchaseorder2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingPurchaseorder2Response res = resBuilder.build();
