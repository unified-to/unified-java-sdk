...
public class UpdateAccountingBill {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(UpdateAccountingBillRequest request) throws Exception {
            String url = Utils.generateURL(
                    UpdateAccountingBillRequest.class,
                    this.baseUrl,
            ...
            Object convertedRequest = Utils.convertToShape(
                    request,
                    JsonShape.DEFAULT,
                    new TypeReference<UpdateAccountingBillRequest>() {
                    });
