...
public class ListAtsApplicationstatuses {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsApplicationstatusesRequest request) throws Exception {
        ...
        @Override
        public ListAtsApplicationstatusesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AtsStatus> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAtsStatuses(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
