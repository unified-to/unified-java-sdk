...
public class ListAtsApplicationstatuses {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAtsApplicationstatusesRequest, ListAtsApplicationstatusesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAtsApplicationstatusesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsApplicationstatusesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsApplicationstatusesRequest request) {
        ...
        @Override
        public ListAtsApplicationstatusesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsApplicationstatusesResponse.Builder resBuilder =
            ...
            ListAtsApplicationstatusesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsApplicationstatusesRequest, to.unified.unified_java_sdk.models.operations.async.ListAtsApplicationstatusesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsApplicationstatusesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsApplicationstatusesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsApplicationstatusesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsApplicationstatusesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsApplicationstatusesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsApplicationstatusesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsApplicationstatusesResponse res = resBuilder.build();
