...
public class CreateAccountingContactOperation implements RequestOperation<CreateAccountingContactRequest, CreateAccountingContactResponse> {
    ...
    public CreateAccountingContactOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAccountingContactRequest request) throws Exception {
