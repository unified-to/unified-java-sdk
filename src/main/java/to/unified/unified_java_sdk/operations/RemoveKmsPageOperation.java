...
public class RemoveKmsPageOperation implements RequestOperation<RemoveKmsPageRequest, RemoveKmsPageResponse> {
    ...
    public RemoveKmsPageOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveKmsPageRequest request) throws Exception {
