...
public class CreateAdsGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAdsGroupRequest, CreateAdsGroupResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAdsGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsGroupRequest.class, new TypeReference<CreateAdsGroupRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAdsGroupRequest request) {
        ...
        @Override
        public CreateAdsGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAdsGroupResponse.Builder resBuilder =
            ...
            CreateAdsGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAdsGroupRequest, to.unified.unified_java_sdk.models.operations.async.CreateAdsGroupResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAdsGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsGroupRequest.class, new TypeReference<CreateAdsGroupRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAdsGroupRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAdsGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAdsGroupResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAdsGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAdsGroupResponse res = resBuilder.build();
