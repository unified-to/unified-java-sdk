...
public class UpdateLmsCollection {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLmsCollectionRequest, UpdateLmsCollectionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateLmsCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsCollectionRequest.class, new TypeReference<UpdateLmsCollectionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLmsCollectionRequest request) {
        ...
        @Override
        public UpdateLmsCollectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateLmsCollectionResponse.Builder resBuilder =
            ...
            UpdateLmsCollectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLmsCollectionRequest, to.unified.unified_java_sdk.models.operations.async.UpdateLmsCollectionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLmsCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsCollectionRequest.class, new TypeReference<UpdateLmsCollectionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLmsCollectionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateLmsCollectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateLmsCollectionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateLmsCollectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateLmsCollectionResponse res = resBuilder.build();
