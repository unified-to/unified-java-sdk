...
public class ListGenaiAgents {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListGenaiAgentsRequest, ListGenaiAgentsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListGenaiAgentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListGenaiAgentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListGenaiAgentsRequest request) {
        ...
        @Override
        public ListGenaiAgentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListGenaiAgentsResponse.Builder resBuilder =
            ...
            ListGenaiAgentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGenaiAgents(Utils.unmarshal(response, new TypeReference<List<GenaiAgent>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListGenaiAgentsRequest, to.unified.unified_java_sdk.models.operations.async.ListGenaiAgentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListGenaiAgentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListGenaiAgentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListGenaiAgentsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListGenaiAgentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListGenaiAgentsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListGenaiAgentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListGenaiAgentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<GenaiAgent>>() {})
                            .thenApply(res::withGenaiAgents);
                } else {
