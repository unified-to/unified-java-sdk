...
public class ListUnifiedIntegrations {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUnifiedIntegrationsRequest, ListUnifiedIntegrationsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListUnifiedIntegrationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUnifiedIntegrationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUnifiedIntegrationsRequest request) {
        ...
        @Override
        public ListUnifiedIntegrationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUnifiedIntegrationsResponse.Builder resBuilder =
            ...
            ListUnifiedIntegrationsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUnifiedIntegrationsRequest, to.unified.unified_java_sdk.models.operations.async.ListUnifiedIntegrationsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListUnifiedIntegrationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUnifiedIntegrationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUnifiedIntegrationsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListUnifiedIntegrationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListUnifiedIntegrationsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListUnifiedIntegrationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListUnifiedIntegrationsResponse res = resBuilder.build();
