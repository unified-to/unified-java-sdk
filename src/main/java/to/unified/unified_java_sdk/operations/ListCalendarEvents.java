...
public class ListCalendarEvents {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarEventsRequest request) throws Exception {
        ...
        @Override
        public ListCalendarEventsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CalendarEvent> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCalendarEvents(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
