...
public class ListCalendarEvents {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCalendarEventsRequest, ListCalendarEventsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCalendarEventsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarEventsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarEventsRequest request) {
        ...
        @Override
        public ListCalendarEventsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCalendarEventsResponse.Builder resBuilder =
            ...
            ListCalendarEventsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCalendarEventsRequest, to.unified.unified_java_sdk.models.operations.async.ListCalendarEventsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCalendarEventsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarEventsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCalendarEventsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCalendarEventsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCalendarEventsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCalendarEventsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCalendarEventsResponse res = resBuilder.build();
