...
public class ListHrisTimeoffsOperation implements RequestOperation<ListHrisTimeoffsRequest, ListHrisTimeoffsResponse> {
    ...
    public ListHrisTimeoffsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListHrisTimeoffsRequest request) throws Exception {
