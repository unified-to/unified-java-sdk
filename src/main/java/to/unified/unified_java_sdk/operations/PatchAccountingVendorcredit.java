...
public class PatchAccountingVendorcredit {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingVendorcreditRequest, PatchAccountingVendorcreditResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingVendorcreditRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingVendorcreditRequest.class, new TypeReference<PatchAccountingVendorcreditRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingVendorcreditRequest request) {
        ...
        @Override
        public PatchAccountingVendorcreditResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingVendorcreditResponse.Builder resBuilder =
                    PatchAccountingVendorcreditResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            PatchAccountingVendorcreditResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingVendorcreditRequest, to.unified.unified_java_sdk.models.operations.async.PatchAccountingVendorcreditResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingVendorcreditRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingVendorcreditRequest.class, new TypeReference<PatchAccountingVendorcreditRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingVendorcreditRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingVendorcreditResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingVendorcreditResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingVendorcreditResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingVendorcreditResponse res = resBuilder.build();
