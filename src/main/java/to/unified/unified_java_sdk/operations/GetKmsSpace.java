...
public class GetKmsSpace {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetKmsSpaceRequest, GetKmsSpaceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetKmsSpaceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetKmsSpaceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetKmsSpaceRequest request) {
        ...
        @Override
        public GetKmsSpaceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetKmsSpaceResponse.Builder resBuilder =
                    GetKmsSpaceResponse
                            .builder()
            ...
            GetKmsSpaceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetKmsSpaceRequest, to.unified.unified_java_sdk.models.operations.async.GetKmsSpaceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetKmsSpaceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetKmsSpaceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetKmsSpaceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetKmsSpaceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetKmsSpaceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetKmsSpaceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetKmsSpaceResponse res = resBuilder.build();
