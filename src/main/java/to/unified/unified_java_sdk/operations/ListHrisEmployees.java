...
public class ListHrisEmployees {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisEmployeesRequest, ListHrisEmployeesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisEmployeesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisEmployeesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisEmployeesRequest request) {
        ...
        @Override
        public ListHrisEmployeesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisEmployeesResponse.Builder resBuilder =
            ...
            ListHrisEmployeesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisEmployeesRequest, to.unified.unified_java_sdk.models.operations.async.ListHrisEmployeesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisEmployeesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisEmployeesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisEmployeesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisEmployeesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisEmployeesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisEmployeesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisEmployeesResponse res = resBuilder.build();
