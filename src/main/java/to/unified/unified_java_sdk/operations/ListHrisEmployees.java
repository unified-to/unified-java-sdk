...
public class ListHrisEmployees {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisEmployeesRequest request) throws Exception {
        ...
        @Override
        public ListHrisEmployeesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<HrisEmployee> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHrisEmployees(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
