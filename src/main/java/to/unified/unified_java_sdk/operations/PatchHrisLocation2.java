...
public class PatchHrisLocation2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisLocation2Request, PatchHrisLocation2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisLocation2Request.class, new TypeReference<PatchHrisLocation2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisLocation2Request request) {
        ...
        @Override
        public PatchHrisLocation2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisLocation2Response.Builder resBuilder =
            ...
            PatchHrisLocation2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisLocation2Request, to.unified.unified_java_sdk.models.operations.async.PatchHrisLocation2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisLocation2Request.class, new TypeReference<PatchHrisLocation2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisLocation2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisLocation2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisLocation2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisLocation2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisLocation2Response res = resBuilder.build();
