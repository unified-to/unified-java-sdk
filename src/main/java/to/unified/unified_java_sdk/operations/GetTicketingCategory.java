...
public class GetTicketingCategory {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTicketingCategoryRequest, GetTicketingCategoryResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetTicketingCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTicketingCategoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTicketingCategoryRequest request) throws Exception {
        ...
        @Override
        public GetTicketingCategoryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTicketingCategoryResponse.Builder resBuilder =
            ...
            GetTicketingCategoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTicketingCategoryRequest, to.unified.unified_java_sdk.models.operations.async.GetTicketingCategoryResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTicketingCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTicketingCategoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTicketingCategoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetTicketingCategoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetTicketingCategoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetTicketingCategoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetTicketingCategoryResponse res = resBuilder.build();
