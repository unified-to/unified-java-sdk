...
public class CreateLmsCourse2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateLmsCourse2Request, CreateLmsCourse2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateLmsCourse2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsCourse2Request.class, new TypeReference<CreateLmsCourse2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateLmsCourse2Request request) {
        ...
        @Override
        public CreateLmsCourse2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateLmsCourse2Response.Builder resBuilder =
            ...
            CreateLmsCourse2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateLmsCourse2Request, to.unified.unified_java_sdk.models.operations.async.CreateLmsCourse2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateLmsCourse2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsCourse2Request.class, new TypeReference<CreateLmsCourse2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateLmsCourse2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateLmsCourse2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateLmsCourse2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateLmsCourse2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateLmsCourse2Response res = resBuilder.build();
