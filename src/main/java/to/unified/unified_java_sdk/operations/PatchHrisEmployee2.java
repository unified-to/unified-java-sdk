...
public class PatchHrisEmployee2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisEmployee2Request, PatchHrisEmployee2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisEmployee2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisEmployee2Request.class, new TypeReference<PatchHrisEmployee2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisEmployee2Request request) {
        ...
        @Override
        public PatchHrisEmployee2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisEmployee2Response.Builder resBuilder =
            ...
            PatchHrisEmployee2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisEmployee2Request, to.unified.unified_java_sdk.models.operations.async.PatchHrisEmployee2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisEmployee2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisEmployee2Request.class, new TypeReference<PatchHrisEmployee2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisEmployee2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisEmployee2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisEmployee2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisEmployee2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisEmployee2Response res = resBuilder.build();
