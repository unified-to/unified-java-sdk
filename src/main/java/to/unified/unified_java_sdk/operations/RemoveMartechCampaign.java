...
public class RemoveMartechCampaign {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveMartechCampaignRequest, RemoveMartechCampaignResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveMartechCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMartechCampaignRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveMartechCampaignRequest request) {
        ...
        @Override
        public RemoveMartechCampaignResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveMartechCampaignResponse.Builder resBuilder =
            ...
            RemoveMartechCampaignResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveMartechCampaignRequest, to.unified.unified_java_sdk.models.operations.async.RemoveMartechCampaignResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveMartechCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMartechCampaignRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveMartechCampaignRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveMartechCampaignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveMartechCampaignResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveMartechCampaignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveMartechCampaignResponse res = resBuilder.build();
