...
public class ListAssessmentPackages2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAssessmentPackages2Request, ListAssessmentPackages2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAssessmentPackages2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAssessmentPackages2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAssessmentPackages2Request request) {
        ...
        @Override
        public ListAssessmentPackages2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAssessmentPackages2Response.Builder resBuilder =
            ...
            ListAssessmentPackages2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAssessmentPackages(Utils.unmarshal(response, new TypeReference<List<AssessmentPackage>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAssessmentPackages2Request, to.unified.unified_java_sdk.models.operations.async.ListAssessmentPackages2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAssessmentPackages2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAssessmentPackages2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAssessmentPackages2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAssessmentPackages2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAssessmentPackages2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAssessmentPackages2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAssessmentPackages2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AssessmentPackage>>() {})
                            .thenApply(res::withAssessmentPackages);
                } else {
