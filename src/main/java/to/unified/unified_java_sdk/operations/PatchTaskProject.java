...
public class PatchTaskProject {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchTaskProjectRequest, PatchTaskProjectResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchTaskProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTaskProjectRequest.class, new TypeReference<PatchTaskProjectRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchTaskProjectRequest request) {
        ...
        @Override
        public PatchTaskProjectResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchTaskProjectResponse.Builder resBuilder =
            ...
            PatchTaskProjectResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchTaskProjectRequest, to.unified.unified_java_sdk.models.operations.async.PatchTaskProjectResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchTaskProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTaskProjectRequest.class, new TypeReference<PatchTaskProjectRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchTaskProjectRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchTaskProjectResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchTaskProjectResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchTaskProjectResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchTaskProjectResponse res = resBuilder.build();
