...
public class ListMartechReports {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMartechReportsRequest, ListMartechReportsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListMartechReportsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMartechReportsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMartechReportsRequest request) {
        ...
        @Override
        public ListMartechReportsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMartechReportsResponse.Builder resBuilder =
            ...
            ListMartechReportsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMartechReportsRequest, to.unified.unified_java_sdk.models.operations.async.ListMartechReportsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMartechReportsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMartechReportsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMartechReportsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListMartechReportsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListMartechReportsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListMartechReportsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListMartechReportsResponse res = resBuilder.build();
