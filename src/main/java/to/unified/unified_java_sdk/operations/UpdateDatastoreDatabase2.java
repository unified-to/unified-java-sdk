...
public class UpdateDatastoreDatabase2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateDatastoreDatabase2Request, UpdateDatastoreDatabase2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateDatastoreDatabase2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDatastoreDatabase2Request.class, new TypeReference<UpdateDatastoreDatabase2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateDatastoreDatabase2Request request) {
        ...
        @Override
        public UpdateDatastoreDatabase2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateDatastoreDatabase2Response.Builder resBuilder =
            ...
            UpdateDatastoreDatabase2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDatastoreDatabase(Utils.unmarshal(response, new TypeReference<DatastoreDatabase>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateDatastoreDatabase2Request, to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreDatabase2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateDatastoreDatabase2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDatastoreDatabase2Request.class, new TypeReference<UpdateDatastoreDatabase2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateDatastoreDatabase2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreDatabase2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreDatabase2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreDatabase2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreDatabase2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DatastoreDatabase>() {})
                            .thenApply(res::withDatastoreDatabase);
                } else {
