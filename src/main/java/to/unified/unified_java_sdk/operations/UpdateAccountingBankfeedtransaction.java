...
public class UpdateAccountingBankfeedtransaction {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAccountingBankfeedtransactionRequest, UpdateAccountingBankfeedtransactionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAccountingBankfeedtransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingBankfeedtransactionRequest.class, new TypeReference<UpdateAccountingBankfeedtransactionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAccountingBankfeedtransactionRequest request) {
        ...
        @Override
        public UpdateAccountingBankfeedtransactionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAccountingBankfeedtransactionResponse.Builder resBuilder =
                    UpdateAccountingBankfeedtransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            UpdateAccountingBankfeedtransactionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountingBankfeedtransaction(Utils.unmarshal(response, new TypeReference<AccountingBankfeedtransaction>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAccountingBankfeedtransactionRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAccountingBankfeedtransactionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAccountingBankfeedtransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingBankfeedtransactionRequest.class, new TypeReference<UpdateAccountingBankfeedtransactionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAccountingBankfeedtransactionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAccountingBankfeedtransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingBankfeedtransactionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAccountingBankfeedtransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingBankfeedtransactionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountingBankfeedtransaction>() {})
                            .thenApply(res::withAccountingBankfeedtransaction);
                } else {
