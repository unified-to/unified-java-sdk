...
public class PatchAtsCompany2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAtsCompany2Request, PatchAtsCompany2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAtsCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsCompany2Request.class, new TypeReference<PatchAtsCompany2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAtsCompany2Request request) {
        ...
        @Override
        public PatchAtsCompany2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAtsCompany2Response.Builder resBuilder =
            ...
            PatchAtsCompany2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAtsCompany2Request, to.unified.unified_java_sdk.models.operations.async.PatchAtsCompany2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAtsCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsCompany2Request.class, new TypeReference<PatchAtsCompany2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAtsCompany2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAtsCompany2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAtsCompany2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAtsCompany2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAtsCompany2Response res = resBuilder.build();
