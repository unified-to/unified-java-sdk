...
public class GetUnifiedWorkspaceSecretsmanager {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUnifiedWorkspaceSecretsmanagerRequest, GetUnifiedWorkspaceSecretsmanagerResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUnifiedWorkspaceSecretsmanagerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUnifiedWorkspaceSecretsmanagerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUnifiedWorkspaceSecretsmanagerRequest request) {
        ...
        @Override
        public GetUnifiedWorkspaceSecretsmanagerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUnifiedWorkspaceSecretsmanagerResponse.Builder resBuilder =
            ...
            GetUnifiedWorkspaceSecretsmanagerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSecretsManager(Utils.unmarshal(response, new TypeReference<SecretsManager>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUnifiedWorkspaceSecretsmanagerRequest, to.unified.unified_java_sdk.models.operations.async.GetUnifiedWorkspaceSecretsmanagerResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUnifiedWorkspaceSecretsmanagerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUnifiedWorkspaceSecretsmanagerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUnifiedWorkspaceSecretsmanagerRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetUnifiedWorkspaceSecretsmanagerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetUnifiedWorkspaceSecretsmanagerResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetUnifiedWorkspaceSecretsmanagerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetUnifiedWorkspaceSecretsmanagerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SecretsManager>() {})
                            .thenApply(res::withSecretsManager);
                } else {
