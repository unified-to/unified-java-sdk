...
public class ListCalendarBusies2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCalendarBusies2Request, ListCalendarBusies2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCalendarBusies2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarBusies2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarBusies2Request request) {
        ...
        @Override
        public ListCalendarBusies2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCalendarBusies2Response.Builder resBuilder =
            ...
            ListCalendarBusies2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCalendarBusies(Utils.unmarshal(response, new TypeReference<List<CalendarBusy>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCalendarBusies2Request, to.unified.unified_java_sdk.models.operations.async.ListCalendarBusies2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCalendarBusies2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarBusies2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCalendarBusies2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCalendarBusies2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCalendarBusies2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCalendarBusies2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCalendarBusies2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CalendarBusy>>() {})
                            .thenApply(res::withCalendarBusies);
                } else {
