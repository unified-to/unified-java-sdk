...
public class RemoveHrisDeduction2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisDeduction2Request, RemoveHrisDeduction2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisDeduction2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisDeduction2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisDeduction2Request request) {
        ...
        @Override
        public RemoveHrisDeduction2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisDeduction2Response.Builder resBuilder =
            ...
            RemoveHrisDeduction2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisDeduction2Request, to.unified.unified_java_sdk.models.operations.async.RemoveHrisDeduction2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisDeduction2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisDeduction2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisDeduction2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisDeduction2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisDeduction2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisDeduction2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisDeduction2Response res = resBuilder.build();
