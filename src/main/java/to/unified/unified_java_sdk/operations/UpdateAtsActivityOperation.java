...
public class UpdateAtsActivityOperation implements RequestOperation<UpdateAtsActivityRequest, UpdateAtsActivityResponse> {
    ...
    public UpdateAtsActivityOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAtsActivityRequest request) throws Exception {
