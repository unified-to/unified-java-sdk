...
public class CreateUcContact2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateUcContact2Request, CreateUcContact2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateUcContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateUcContact2Request.class, new TypeReference<CreateUcContact2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateUcContact2Request request) {
        ...
        @Override
        public CreateUcContact2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateUcContact2Response.Builder resBuilder =
            ...
            CreateUcContact2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUcContact(Utils.unmarshal(response, new TypeReference<UcContact>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateUcContact2Request, to.unified.unified_java_sdk.models.operations.async.CreateUcContact2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateUcContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateUcContact2Request.class, new TypeReference<CreateUcContact2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateUcContact2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateUcContact2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateUcContact2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateUcContact2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateUcContact2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UcContact>() {})
                            .thenApply(res::withUcContact);
                } else {
