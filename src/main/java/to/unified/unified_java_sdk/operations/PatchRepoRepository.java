...
public class PatchRepoRepository {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchRepoRepositoryRequest, PatchRepoRepositoryResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchRepoRepositoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoRepositoryRequest.class, new TypeReference<PatchRepoRepositoryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchRepoRepositoryRequest request) {
        ...
        @Override
        public PatchRepoRepositoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchRepoRepositoryResponse.Builder resBuilder =
            ...
            PatchRepoRepositoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchRepoRepositoryRequest, to.unified.unified_java_sdk.models.operations.async.PatchRepoRepositoryResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchRepoRepositoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoRepositoryRequest.class, new TypeReference<PatchRepoRepositoryRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchRepoRepositoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchRepoRepositoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchRepoRepositoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchRepoRepositoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchRepoRepositoryResponse res = resBuilder.build();
