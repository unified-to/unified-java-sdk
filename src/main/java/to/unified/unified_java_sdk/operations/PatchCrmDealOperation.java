...
public class PatchCrmDealOperation implements RequestOperation<PatchCrmDealRequest, PatchCrmDealResponse> {
    ...
    public PatchCrmDealOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchCrmDealRequest request) throws Exception {
