...
public class RemoveCommerceReservation2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCommerceReservation2Request, RemoveCommerceReservation2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCommerceReservation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceReservation2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCommerceReservation2Request request) {
        ...
        @Override
        public RemoveCommerceReservation2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCommerceReservation2Response.Builder resBuilder =
            ...
            RemoveCommerceReservation2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCommerceReservation2Request, to.unified.unified_java_sdk.models.operations.async.RemoveCommerceReservation2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCommerceReservation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceReservation2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCommerceReservation2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCommerceReservation2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceReservation2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCommerceReservation2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceReservation2Response res = resBuilder.build();
