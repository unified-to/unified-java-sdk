...
public class RemoveTaskCommentOperation implements RequestOperation<RemoveTaskCommentRequest, RemoveTaskCommentResponse> {
    ...
    public RemoveTaskCommentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveTaskCommentRequest request) throws Exception {
