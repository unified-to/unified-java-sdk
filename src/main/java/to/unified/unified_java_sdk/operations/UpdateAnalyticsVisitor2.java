...
public class UpdateAnalyticsVisitor2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAnalyticsVisitor2Request, UpdateAnalyticsVisitor2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAnalyticsVisitor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAnalyticsVisitor2Request.class, new TypeReference<UpdateAnalyticsVisitor2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAnalyticsVisitor2Request request) {
        ...
        @Override
        public UpdateAnalyticsVisitor2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAnalyticsVisitor2Response.Builder resBuilder =
            ...
            UpdateAnalyticsVisitor2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAnalyticsVisitor(Utils.unmarshal(response, new TypeReference<AnalyticsVisitor>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAnalyticsVisitor2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsVisitor2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAnalyticsVisitor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAnalyticsVisitor2Request.class, new TypeReference<UpdateAnalyticsVisitor2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAnalyticsVisitor2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsVisitor2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsVisitor2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsVisitor2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsVisitor2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AnalyticsVisitor>() {})
                            .thenApply(res::withAnalyticsVisitor);
                } else {
