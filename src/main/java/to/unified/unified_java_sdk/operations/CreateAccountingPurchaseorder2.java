...
public class CreateAccountingPurchaseorder2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAccountingPurchaseorder2Request, CreateAccountingPurchaseorder2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAccountingPurchaseorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingPurchaseorder2Request.class, new TypeReference<CreateAccountingPurchaseorder2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingPurchaseorder2Request request) {
        ...
        @Override
        public CreateAccountingPurchaseorder2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAccountingPurchaseorder2Response.Builder resBuilder =
            ...
            CreateAccountingPurchaseorder2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAccountingPurchaseorder2Request, to.unified.unified_java_sdk.models.operations.async.CreateAccountingPurchaseorder2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAccountingPurchaseorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingPurchaseorder2Request.class, new TypeReference<CreateAccountingPurchaseorder2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAccountingPurchaseorder2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAccountingPurchaseorder2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAccountingPurchaseorder2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAccountingPurchaseorder2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAccountingPurchaseorder2Response res = resBuilder.build();
