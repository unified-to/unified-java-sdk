...
public class UpdateTaskCommentOperation implements RequestOperation<UpdateTaskCommentRequest, UpdateTaskCommentResponse> {
    ...
    public UpdateTaskCommentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateTaskCommentRequest request) throws Exception {
