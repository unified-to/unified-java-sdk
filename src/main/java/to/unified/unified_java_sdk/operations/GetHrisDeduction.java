...
public class GetHrisDeduction {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisDeductionRequest, GetHrisDeductionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisDeductionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisDeductionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisDeductionRequest request) {
        ...
        @Override
        public GetHrisDeductionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisDeductionResponse.Builder resBuilder =
            ...
            GetHrisDeductionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisDeductionRequest, to.unified.unified_java_sdk.models.operations.async.GetHrisDeductionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisDeductionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisDeductionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisDeductionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisDeductionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisDeductionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisDeductionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisDeductionResponse res = resBuilder.build();
