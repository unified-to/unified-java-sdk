...
public class ListCalendarCalendarsOperation implements RequestOperation<ListCalendarCalendarsRequest, ListCalendarCalendarsResponse> {
    ...
    public ListCalendarCalendarsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCalendarCalendarsRequest request) throws Exception {
