...
public class UpdateLmsStudentOperation implements RequestOperation<UpdateLmsStudentRequest, UpdateLmsStudentResponse> {
    ...
    public UpdateLmsStudentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateLmsStudentRequest request) throws Exception {
