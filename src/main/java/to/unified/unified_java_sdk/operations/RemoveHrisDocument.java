...
public class RemoveHrisDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisDocumentRequest, RemoveHrisDocumentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisDocumentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisDocumentRequest request) {
        ...
        @Override
        public RemoveHrisDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisDocumentResponse.Builder resBuilder =
            ...
            RemoveHrisDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisDocumentRequest, to.unified.unified_java_sdk.models.operations.async.RemoveHrisDocumentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisDocumentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisDocumentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisDocumentResponse res = resBuilder.build();
