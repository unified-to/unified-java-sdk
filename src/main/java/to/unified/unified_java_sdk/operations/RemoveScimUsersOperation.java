...
public class RemoveScimUsersOperation implements RequestOperation<RemoveScimUsersRequest, RemoveScimUsersResponse> {
    ...
    public RemoveScimUsersOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveScimUsersRequest request) throws Exception {
