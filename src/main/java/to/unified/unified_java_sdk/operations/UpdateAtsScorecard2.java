...
public class UpdateAtsScorecard2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAtsScorecard2Request, UpdateAtsScorecard2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAtsScorecard2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsScorecard2Request.class, new TypeReference<UpdateAtsScorecard2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsScorecard2Request request) {
        ...
        @Override
        public UpdateAtsScorecard2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAtsScorecard2Response.Builder resBuilder =
            ...
            UpdateAtsScorecard2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsScorecard(Utils.unmarshal(response, new TypeReference<AtsScorecard>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAtsScorecard2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAtsScorecard2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAtsScorecard2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsScorecard2Request.class, new TypeReference<UpdateAtsScorecard2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAtsScorecard2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAtsScorecard2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAtsScorecard2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAtsScorecard2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAtsScorecard2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AtsScorecard>() {})
                            .thenApply(res::withAtsScorecard);
                } else {
