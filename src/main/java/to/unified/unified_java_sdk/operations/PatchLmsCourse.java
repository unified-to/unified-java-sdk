...
public class PatchLmsCourse {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchLmsCourseRequest, PatchLmsCourseResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchLmsCourseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsCourseRequest.class, new TypeReference<PatchLmsCourseRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchLmsCourseRequest request) {
        ...
        @Override
        public PatchLmsCourseResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchLmsCourseResponse.Builder resBuilder =
            ...
            PatchLmsCourseResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchLmsCourseRequest, to.unified.unified_java_sdk.models.operations.async.PatchLmsCourseResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchLmsCourseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsCourseRequest.class, new TypeReference<PatchLmsCourseRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchLmsCourseRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchLmsCourseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchLmsCourseResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchLmsCourseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchLmsCourseResponse res = resBuilder.build();
