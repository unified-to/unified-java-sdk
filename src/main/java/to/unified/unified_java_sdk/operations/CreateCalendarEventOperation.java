...
public class CreateCalendarEventOperation implements RequestOperation<CreateCalendarEventRequest, CreateCalendarEventResponse> {
    ...
    public CreateCalendarEventOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateCalendarEventRequest request) throws Exception {
