...
public class ListLmsClassesOperation implements RequestOperation<ListLmsClassesRequest, ListLmsClassesResponse> {
    ...
    public ListLmsClassesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListLmsClassesRequest request) throws Exception {
