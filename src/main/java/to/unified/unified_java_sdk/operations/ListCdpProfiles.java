...
public class ListCdpProfiles {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCdpProfilesRequest, ListCdpProfilesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCdpProfilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCdpProfilesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCdpProfilesRequest request) {
        ...
        @Override
        public ListCdpProfilesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCdpProfilesResponse.Builder resBuilder =
            ...
            ListCdpProfilesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCdpProfiles(Utils.unmarshal(response, new TypeReference<List<CdpProfile>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCdpProfilesRequest, to.unified.unified_java_sdk.models.operations.async.ListCdpProfilesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCdpProfilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCdpProfilesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCdpProfilesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCdpProfilesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCdpProfilesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCdpProfilesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCdpProfilesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CdpProfile>>() {})
                            .thenApply(res::withCdpProfiles);
                } else {
