...
public class UpdateLmsCourse2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLmsCourse2Request, UpdateLmsCourse2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateLmsCourse2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsCourse2Request.class, new TypeReference<UpdateLmsCourse2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLmsCourse2Request request) {
        ...
        @Override
        public UpdateLmsCourse2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateLmsCourse2Response.Builder resBuilder =
            ...
            UpdateLmsCourse2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLmsCourse(Utils.unmarshal(response, new TypeReference<LmsCourse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLmsCourse2Request, to.unified.unified_java_sdk.models.operations.async.UpdateLmsCourse2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLmsCourse2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsCourse2Request.class, new TypeReference<UpdateLmsCourse2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLmsCourse2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateLmsCourse2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateLmsCourse2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateLmsCourse2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateLmsCourse2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<LmsCourse>() {})
                            .thenApply(res::withLmsCourse);
                } else {
