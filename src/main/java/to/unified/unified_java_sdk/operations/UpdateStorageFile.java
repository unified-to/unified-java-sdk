...
public class UpdateStorageFile {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateStorageFileRequest, UpdateStorageFileResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateStorageFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateStorageFileRequest.class, new TypeReference<UpdateStorageFileRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateStorageFileRequest request) {
        ...
        @Override
        public UpdateStorageFileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateStorageFileResponse.Builder resBuilder =
            ...
            UpdateStorageFileResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateStorageFileRequest, to.unified.unified_java_sdk.models.operations.async.UpdateStorageFileResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateStorageFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateStorageFileRequest.class, new TypeReference<UpdateStorageFileRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateStorageFileRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateStorageFileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateStorageFileResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateStorageFileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateStorageFileResponse res = resBuilder.build();
