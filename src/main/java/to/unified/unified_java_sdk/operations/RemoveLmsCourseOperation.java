...
public class RemoveLmsCourseOperation implements RequestOperation<RemoveLmsCourseRequest, RemoveLmsCourseResponse> {
    ...
    public RemoveLmsCourseOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveLmsCourseRequest request) throws Exception {
