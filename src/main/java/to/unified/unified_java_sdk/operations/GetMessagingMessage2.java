...
public class GetMessagingMessage2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMessagingMessage2Request, GetMessagingMessage2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetMessagingMessage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetMessagingMessage2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMessagingMessage2Request request) {
        ...
        @Override
        public GetMessagingMessage2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMessagingMessage2Response.Builder resBuilder =
            ...
            GetMessagingMessage2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMessagingMessage2Request, to.unified.unified_java_sdk.models.operations.async.GetMessagingMessage2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMessagingMessage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetMessagingMessage2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMessagingMessage2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetMessagingMessage2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetMessagingMessage2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetMessagingMessage2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetMessagingMessage2Response res = resBuilder.build();
