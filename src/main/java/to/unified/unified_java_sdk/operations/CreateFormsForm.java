...
public class CreateFormsForm {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateFormsFormRequest, CreateFormsFormResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateFormsFormRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateFormsFormRequest.class, new TypeReference<CreateFormsFormRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateFormsFormRequest request) {
        ...
        @Override
        public CreateFormsFormResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateFormsFormResponse.Builder resBuilder =
            ...
            CreateFormsFormResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateFormsFormRequest, to.unified.unified_java_sdk.models.operations.async.CreateFormsFormResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateFormsFormRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateFormsFormRequest.class, new TypeReference<CreateFormsFormRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateFormsFormRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateFormsFormResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateFormsFormResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateFormsFormResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateFormsFormResponse res = resBuilder.build();
