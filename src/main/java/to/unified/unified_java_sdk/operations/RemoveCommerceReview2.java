...
public class RemoveCommerceReview2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCommerceReview2Request, RemoveCommerceReview2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCommerceReview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceReview2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCommerceReview2Request request) {
        ...
        @Override
        public RemoveCommerceReview2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCommerceReview2Response.Builder resBuilder =
            ...
            RemoveCommerceReview2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCommerceReview2Request, to.unified.unified_java_sdk.models.operations.async.RemoveCommerceReview2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCommerceReview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceReview2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCommerceReview2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCommerceReview2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceReview2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCommerceReview2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceReview2Response res = resBuilder.build();
