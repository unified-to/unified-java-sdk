...
public class GetVerificationRequest2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetVerificationRequest2Request, GetVerificationRequest2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetVerificationRequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetVerificationRequest2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetVerificationRequest2Request request) {
        ...
        @Override
        public GetVerificationRequest2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetVerificationRequest2Response.Builder resBuilder =
            ...
            GetVerificationRequest2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetVerificationRequest2Request, to.unified.unified_java_sdk.models.operations.async.GetVerificationRequest2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetVerificationRequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetVerificationRequest2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetVerificationRequest2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetVerificationRequest2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetVerificationRequest2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetVerificationRequest2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetVerificationRequest2Response res = resBuilder.build();
