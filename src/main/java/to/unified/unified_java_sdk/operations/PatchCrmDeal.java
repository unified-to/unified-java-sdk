...
public class PatchCrmDeal {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCrmDealRequest, PatchCrmDealResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCrmDealRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmDealRequest.class, new TypeReference<PatchCrmDealRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCrmDealRequest request) {
        ...
        @Override
        public PatchCrmDealResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCrmDealResponse.Builder resBuilder =
            ...
            PatchCrmDealResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCrmDealRequest, to.unified.unified_java_sdk.models.operations.async.PatchCrmDealResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCrmDealRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmDealRequest.class, new TypeReference<PatchCrmDealRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCrmDealRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCrmDealResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCrmDealResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCrmDealResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCrmDealResponse res = resBuilder.build();
