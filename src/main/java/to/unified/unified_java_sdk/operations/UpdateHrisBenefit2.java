...
public class UpdateHrisBenefit2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisBenefit2Request, UpdateHrisBenefit2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisBenefit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisBenefit2Request.class, new TypeReference<UpdateHrisBenefit2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisBenefit2Request request) {
        ...
        @Override
        public UpdateHrisBenefit2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisBenefit2Response.Builder resBuilder =
            ...
            UpdateHrisBenefit2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisBenefit(Utils.unmarshal(response, new TypeReference<HrisBenefit>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisBenefit2Request, to.unified.unified_java_sdk.models.operations.async.UpdateHrisBenefit2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisBenefit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisBenefit2Request.class, new TypeReference<UpdateHrisBenefit2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisBenefit2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisBenefit2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisBenefit2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisBenefit2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisBenefit2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HrisBenefit>() {})
                            .thenApply(res::withHrisBenefit);
                } else {
