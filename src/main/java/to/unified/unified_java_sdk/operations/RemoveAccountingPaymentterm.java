...
public class RemoveAccountingPaymentterm {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingPaymenttermRequest, RemoveAccountingPaymenttermResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingPaymenttermRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingPaymenttermRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingPaymenttermRequest request) {
        ...
        @Override
        public RemoveAccountingPaymenttermResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingPaymenttermResponse.Builder resBuilder =
            ...
            RemoveAccountingPaymenttermResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingPaymenttermRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingPaymenttermResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingPaymenttermRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingPaymenttermRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingPaymenttermRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingPaymenttermResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingPaymenttermResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingPaymenttermResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingPaymenttermResponse res = resBuilder.build();
