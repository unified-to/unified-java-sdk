...
public class ListCrmCompanies {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmCompaniesRequest request) throws Exception {
        ...
        @Override
        public ListCrmCompaniesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CrmCompany> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCrmCompanies(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
