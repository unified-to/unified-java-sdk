...
public class ListCrmCompanies {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCrmCompaniesRequest, ListCrmCompaniesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCrmCompaniesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmCompaniesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmCompaniesRequest request) {
        ...
        @Override
        public ListCrmCompaniesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCrmCompaniesResponse.Builder resBuilder =
            ...
            ListCrmCompaniesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCrmCompaniesRequest, to.unified.unified_java_sdk.models.operations.async.ListCrmCompaniesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCrmCompaniesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmCompaniesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCrmCompaniesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCrmCompaniesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCrmCompaniesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCrmCompaniesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCrmCompaniesResponse res = resBuilder.build();
