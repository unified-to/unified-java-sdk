...
public class RemoveCdpEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCdpEventRequest, RemoveCdpEventResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCdpEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCdpEventRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCdpEventRequest request) {
        ...
        @Override
        public RemoveCdpEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCdpEventResponse.Builder resBuilder =
            ...
            RemoveCdpEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCdpEventRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCdpEventResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCdpEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCdpEventRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCdpEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCdpEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCdpEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCdpEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCdpEventResponse res = resBuilder.build();
