...
public class RemoveAccountingTaxrateOperation implements RequestOperation<RemoveAccountingTaxrateRequest, RemoveAccountingTaxrateResponse> {
    ...
    public RemoveAccountingTaxrateOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAccountingTaxrateRequest request) throws Exception {
