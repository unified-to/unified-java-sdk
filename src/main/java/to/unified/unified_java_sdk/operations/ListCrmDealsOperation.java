...
public class ListCrmDealsOperation implements RequestOperation<ListCrmDealsRequest, ListCrmDealsResponse> {
    ...
    public ListCrmDealsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCrmDealsRequest request) throws Exception {
