...
public class RemoveStorageFileOperation implements RequestOperation<RemoveStorageFileRequest, RemoveStorageFileResponse> {
    ...
    public RemoveStorageFileOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveStorageFileRequest request) throws Exception {
