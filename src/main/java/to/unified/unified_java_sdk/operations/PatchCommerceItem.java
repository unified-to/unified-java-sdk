...
public class PatchCommerceItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCommerceItemRequest, PatchCommerceItemResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCommerceItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceItemRequest.class, new TypeReference<PatchCommerceItemRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCommerceItemRequest request) {
        ...
        @Override
        public PatchCommerceItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCommerceItemResponse.Builder resBuilder =
            ...
            PatchCommerceItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCommerceItemRequest, to.unified.unified_java_sdk.models.operations.async.PatchCommerceItemResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCommerceItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceItemRequest.class, new TypeReference<PatchCommerceItemRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCommerceItemRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCommerceItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCommerceItemResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCommerceItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCommerceItemResponse res = resBuilder.build();
