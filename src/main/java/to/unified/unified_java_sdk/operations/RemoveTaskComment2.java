...
public class RemoveTaskComment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveTaskComment2Request, RemoveTaskComment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveTaskComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTaskComment2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveTaskComment2Request request) {
        ...
        @Override
        public RemoveTaskComment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveTaskComment2Response.Builder resBuilder =
            ...
            RemoveTaskComment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveTaskComment2Request, to.unified.unified_java_sdk.models.operations.async.RemoveTaskComment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveTaskComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTaskComment2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveTaskComment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveTaskComment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveTaskComment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveTaskComment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveTaskComment2Response res = resBuilder.build();
