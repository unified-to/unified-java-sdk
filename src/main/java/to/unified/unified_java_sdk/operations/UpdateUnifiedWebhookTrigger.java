...
public class UpdateUnifiedWebhookTrigger {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateUnifiedWebhookTriggerRequest, UpdateUnifiedWebhookTriggerResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateUnifiedWebhookTriggerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUnifiedWebhookTriggerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateUnifiedWebhookTriggerRequest request) throws Exception {
        ...
        @Override
        public UpdateUnifiedWebhookTriggerResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateUnifiedWebhookTriggerResponse.Builder resBuilder =
            ...
            UpdateUnifiedWebhookTriggerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateUnifiedWebhookTriggerRequest, to.unified.unified_java_sdk.models.operations.async.UpdateUnifiedWebhookTriggerResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateUnifiedWebhookTriggerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUnifiedWebhookTriggerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateUnifiedWebhookTriggerRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateUnifiedWebhookTriggerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateUnifiedWebhookTriggerResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateUnifiedWebhookTriggerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateUnifiedWebhookTriggerResponse res = resBuilder.build();
