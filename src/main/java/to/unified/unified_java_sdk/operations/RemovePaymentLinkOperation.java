...
public class RemovePaymentLinkOperation implements RequestOperation<RemovePaymentLinkRequest, RemovePaymentLinkResponse> {
    ...
    public RemovePaymentLinkOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemovePaymentLinkRequest request) throws Exception {
