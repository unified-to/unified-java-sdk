...
public class PatchUcContact2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchUcContact2Request, PatchUcContact2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchUcContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUcContact2Request.class, new TypeReference<PatchUcContact2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchUcContact2Request request) {
        ...
        @Override
        public PatchUcContact2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchUcContact2Response.Builder resBuilder =
            ...
            PatchUcContact2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchUcContact2Request, to.unified.unified_java_sdk.models.operations.async.PatchUcContact2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchUcContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUcContact2Request.class, new TypeReference<PatchUcContact2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchUcContact2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchUcContact2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchUcContact2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchUcContact2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchUcContact2Response res = resBuilder.build();
