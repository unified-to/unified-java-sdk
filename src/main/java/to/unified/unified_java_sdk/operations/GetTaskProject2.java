...
public class GetTaskProject2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTaskProject2Request, GetTaskProject2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTaskProject2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskProject2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTaskProject2Request request) {
        ...
        @Override
        public GetTaskProject2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTaskProject2Response.Builder resBuilder =
            ...
            GetTaskProject2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTaskProject2Request, to.unified.unified_java_sdk.models.operations.async.GetTaskProject2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTaskProject2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskProject2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTaskProject2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetTaskProject2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetTaskProject2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetTaskProject2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetTaskProject2Response res = resBuilder.build();
