...
public class PatchRepoBranch {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchRepoBranchRequest, PatchRepoBranchResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchRepoBranchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoBranchRequest.class, new TypeReference<PatchRepoBranchRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchRepoBranchRequest request) {
        ...
        @Override
        public PatchRepoBranchResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchRepoBranchResponse.Builder resBuilder =
            ...
            PatchRepoBranchResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchRepoBranchRequest, to.unified.unified_java_sdk.models.operations.async.PatchRepoBranchResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchRepoBranchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoBranchRequest.class, new TypeReference<PatchRepoBranchRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchRepoBranchRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchRepoBranchResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchRepoBranchResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchRepoBranchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchRepoBranchResponse res = resBuilder.build();
