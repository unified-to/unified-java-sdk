...
public class GetAccountingBalancesheetOperation implements RequestOperation<GetAccountingBalancesheetRequest, GetAccountingBalancesheetResponse> {
    ...
    public GetAccountingBalancesheetOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountingBalancesheetRequest request) throws Exception {
