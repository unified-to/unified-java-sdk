...
public class GetKmsCommentOperation implements RequestOperation<GetKmsCommentRequest, GetKmsCommentResponse> {
    ...
    public GetKmsCommentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetKmsCommentRequest request) throws Exception {
