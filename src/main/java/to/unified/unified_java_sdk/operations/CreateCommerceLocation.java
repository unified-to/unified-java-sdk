...
public class CreateCommerceLocation {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommerceLocationRequest, CreateCommerceLocationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommerceLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceLocationRequest.class, new TypeReference<CreateCommerceLocationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceLocationRequest request) {
        ...
        @Override
        public CreateCommerceLocationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommerceLocationResponse.Builder resBuilder =
            ...
            CreateCommerceLocationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommerceLocationRequest, to.unified.unified_java_sdk.models.operations.async.CreateCommerceLocationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommerceLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceLocationRequest.class, new TypeReference<CreateCommerceLocationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommerceLocationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCommerceLocationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCommerceLocationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCommerceLocationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCommerceLocationResponse res = resBuilder.build();
