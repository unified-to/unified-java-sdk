...
public class ListAccountingReportsOperation implements RequestOperation<ListAccountingReportsRequest, ListAccountingReportsResponse> {
    ...
    public ListAccountingReportsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAccountingReportsRequest request) throws Exception {
