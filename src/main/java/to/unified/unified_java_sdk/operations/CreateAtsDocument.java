...
public class CreateAtsDocument {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsDocumentRequest request) throws Exception {
        ...
        @Override
        public CreateAtsDocumentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AtsDocument out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAtsDocument(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
