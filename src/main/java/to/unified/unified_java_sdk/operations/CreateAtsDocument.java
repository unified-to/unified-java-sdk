...
public class CreateAtsDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAtsDocumentRequest, CreateAtsDocumentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAtsDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsDocumentRequest.class, new TypeReference<CreateAtsDocumentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsDocumentRequest request) {
        ...
        @Override
        public CreateAtsDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAtsDocumentResponse.Builder resBuilder =
            ...
            CreateAtsDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAtsDocumentRequest, to.unified.unified_java_sdk.models.operations.async.CreateAtsDocumentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAtsDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsDocumentRequest.class, new TypeReference<CreateAtsDocumentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAtsDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAtsDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAtsDocumentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAtsDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAtsDocumentResponse res = resBuilder.build();
