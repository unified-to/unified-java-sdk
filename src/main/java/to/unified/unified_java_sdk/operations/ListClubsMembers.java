...
public class ListClubsMembers {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListClubsMembersRequest, ListClubsMembersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListClubsMembersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsMembersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListClubsMembersRequest request) {
        ...
        @Override
        public ListClubsMembersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListClubsMembersResponse.Builder resBuilder =
            ...
            ListClubsMembersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListClubsMembersRequest, to.unified.unified_java_sdk.models.operations.async.ListClubsMembersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListClubsMembersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsMembersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListClubsMembersRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListClubsMembersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListClubsMembersResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListClubsMembersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListClubsMembersResponse res = resBuilder.build();
