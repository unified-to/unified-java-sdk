...
public class ListDatastoreTables {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDatastoreTablesRequest, ListDatastoreTablesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListDatastoreTablesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDatastoreTablesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDatastoreTablesRequest request) {
        ...
        @Override
        public ListDatastoreTablesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListDatastoreTablesResponse.Builder resBuilder =
            ...
            ListDatastoreTablesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListDatastoreTablesRequest, to.unified.unified_java_sdk.models.operations.async.ListDatastoreTablesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListDatastoreTablesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDatastoreTablesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDatastoreTablesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListDatastoreTablesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListDatastoreTablesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListDatastoreTablesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListDatastoreTablesResponse res = resBuilder.build();
