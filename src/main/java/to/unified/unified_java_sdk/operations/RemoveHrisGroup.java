...
public class RemoveHrisGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisGroupRequest, RemoveHrisGroupResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(RemoveHrisGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisGroupRequest request) throws Exception {
        ...
        @Override
        public RemoveHrisGroupResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisGroupResponse.Builder resBuilder =
            ...
            RemoveHrisGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisGroupRequest, to.unified.unified_java_sdk.models.operations.async.RemoveHrisGroupResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisGroupRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisGroupResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisGroupResponse res = resBuilder.build();
