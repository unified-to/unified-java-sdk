...
public class RemoveTicketingTicket2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveTicketingTicket2Request, RemoveTicketingTicket2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveTicketingTicket2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTicketingTicket2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveTicketingTicket2Request request) {
        ...
        @Override
        public RemoveTicketingTicket2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveTicketingTicket2Response.Builder resBuilder =
            ...
            RemoveTicketingTicket2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveTicketingTicket2Request, to.unified.unified_java_sdk.models.operations.async.RemoveTicketingTicket2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveTicketingTicket2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTicketingTicket2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveTicketingTicket2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveTicketingTicket2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveTicketingTicket2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveTicketingTicket2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveTicketingTicket2Response res = resBuilder.build();
