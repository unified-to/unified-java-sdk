...
public class GetPaymentPayment {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPaymentPaymentRequest, GetPaymentPaymentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPaymentPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentPaymentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentPaymentRequest request) {
        ...
        @Override
        public GetPaymentPaymentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPaymentPaymentResponse.Builder resBuilder =
            ...
            GetPaymentPaymentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentPaymentRequest, to.unified.unified_java_sdk.models.operations.async.GetPaymentPaymentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPaymentPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentPaymentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPaymentPaymentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetPaymentPaymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetPaymentPaymentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetPaymentPaymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetPaymentPaymentResponse res = resBuilder.build();
