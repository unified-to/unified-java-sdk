...
public class UpdateLmsCollection2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLmsCollection2Request, UpdateLmsCollection2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateLmsCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsCollection2Request.class, new TypeReference<UpdateLmsCollection2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLmsCollection2Request request) {
        ...
        @Override
        public UpdateLmsCollection2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateLmsCollection2Response.Builder resBuilder =
            ...
            UpdateLmsCollection2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLmsCollection(Utils.unmarshal(response, new TypeReference<LmsCollection>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLmsCollection2Request, to.unified.unified_java_sdk.models.operations.async.UpdateLmsCollection2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLmsCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsCollection2Request.class, new TypeReference<UpdateLmsCollection2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLmsCollection2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateLmsCollection2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateLmsCollection2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateLmsCollection2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateLmsCollection2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<LmsCollection>() {})
                            .thenApply(res::withLmsCollection);
                } else {
