...
public class UpdateDatastoreRecord2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateDatastoreRecord2Request, UpdateDatastoreRecord2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateDatastoreRecord2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDatastoreRecord2Request.class, new TypeReference<UpdateDatastoreRecord2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateDatastoreRecord2Request request) {
        ...
        @Override
        public UpdateDatastoreRecord2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateDatastoreRecord2Response.Builder resBuilder =
            ...
            UpdateDatastoreRecord2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateDatastoreRecord2Request, to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreRecord2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateDatastoreRecord2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDatastoreRecord2Request.class, new TypeReference<UpdateDatastoreRecord2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateDatastoreRecord2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreRecord2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreRecord2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreRecord2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreRecord2Response res = resBuilder.build();
