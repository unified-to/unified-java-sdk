...
public class GetAtsActivityOperation implements RequestOperation<GetAtsActivityRequest, GetAtsActivityResponse> {
    ...
    public GetAtsActivityOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAtsActivityRequest request) throws Exception {
