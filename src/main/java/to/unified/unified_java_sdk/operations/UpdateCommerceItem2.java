...
public class UpdateCommerceItem2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommerceItem2Request, UpdateCommerceItem2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCommerceItem2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceItem2Request.class, new TypeReference<UpdateCommerceItem2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceItem2Request request) {
        ...
        @Override
        public UpdateCommerceItem2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommerceItem2Response.Builder resBuilder =
            ...
            UpdateCommerceItem2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceItem(Utils.unmarshal(response, new TypeReference<CommerceItem>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommerceItem2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCommerceItem2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommerceItem2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceItem2Request.class, new TypeReference<UpdateCommerceItem2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommerceItem2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCommerceItem2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceItem2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCommerceItem2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceItem2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CommerceItem>() {})
                            .thenApply(res::withCommerceItem);
                } else {
