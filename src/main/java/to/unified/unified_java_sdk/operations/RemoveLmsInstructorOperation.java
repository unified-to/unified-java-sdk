...
public class RemoveLmsInstructorOperation implements RequestOperation<RemoveLmsInstructorRequest, RemoveLmsInstructorResponse> {
    ...
    public RemoveLmsInstructorOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveLmsInstructorRequest request) throws Exception {
