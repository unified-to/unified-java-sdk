...
public class GetCalendarCalendarOperation implements RequestOperation<GetCalendarCalendarRequest, GetCalendarCalendarResponse> {
    ...
    public GetCalendarCalendarOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetCalendarCalendarRequest request) throws Exception {
