...
public class PatchCommerceLocation2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCommerceLocation2Request, PatchCommerceLocation2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCommerceLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceLocation2Request.class, new TypeReference<PatchCommerceLocation2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCommerceLocation2Request request) {
        ...
        @Override
        public PatchCommerceLocation2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCommerceLocation2Response.Builder resBuilder =
            ...
            PatchCommerceLocation2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCommerceLocation2Request, to.unified.unified_java_sdk.models.operations.async.PatchCommerceLocation2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCommerceLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceLocation2Request.class, new TypeReference<PatchCommerceLocation2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCommerceLocation2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCommerceLocation2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCommerceLocation2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCommerceLocation2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCommerceLocation2Response res = resBuilder.build();
