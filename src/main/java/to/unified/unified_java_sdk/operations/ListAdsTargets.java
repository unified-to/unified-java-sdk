...
public class ListAdsTargets {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsTargetsRequest, ListAdsTargetsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsTargetsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsTargetsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsTargetsRequest request) {
        ...
        @Override
        public ListAdsTargetsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsTargetsResponse.Builder resBuilder =
            ...
            ListAdsTargetsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsTargetsRequest, to.unified.unified_java_sdk.models.operations.async.ListAdsTargetsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsTargetsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsTargetsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsTargetsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsTargetsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsTargetsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsTargetsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsTargetsResponse res = resBuilder.build();
