...
public class RemoveAdsAd {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAdsAdRequest, RemoveAdsAdResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAdsAdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsAdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAdsAdRequest request) {
        ...
        @Override
        public RemoveAdsAdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAdsAdResponse.Builder resBuilder =
                    RemoveAdsAdResponse
                            .builder()
            ...
            RemoveAdsAdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAdsAdRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAdsAdResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAdsAdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsAdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAdsAdRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAdsAdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAdsAdResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAdsAdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAdsAdResponse res = resBuilder.build();
