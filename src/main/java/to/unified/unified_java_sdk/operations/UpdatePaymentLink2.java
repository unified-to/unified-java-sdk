...
public class UpdatePaymentLink2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatePaymentLink2Request, UpdatePaymentLink2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdatePaymentLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePaymentLink2Request.class, new TypeReference<UpdatePaymentLink2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePaymentLink2Request request) {
        ...
        @Override
        public UpdatePaymentLink2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatePaymentLink2Response.Builder resBuilder =
            ...
            UpdatePaymentLink2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatePaymentLink2Request, to.unified.unified_java_sdk.models.operations.async.UpdatePaymentLink2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePaymentLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePaymentLink2Request.class, new TypeReference<UpdatePaymentLink2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatePaymentLink2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdatePaymentLink2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdatePaymentLink2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdatePaymentLink2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdatePaymentLink2Response res = resBuilder.build();
