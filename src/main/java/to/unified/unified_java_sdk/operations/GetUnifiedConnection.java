...
public class GetUnifiedConnection {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUnifiedConnectionRequest, GetUnifiedConnectionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUnifiedConnectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUnifiedConnectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUnifiedConnectionRequest request) {
        ...
        @Override
        public GetUnifiedConnectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUnifiedConnectionResponse.Builder resBuilder =
            ...
            GetUnifiedConnectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUnifiedConnectionRequest, to.unified.unified_java_sdk.models.operations.async.GetUnifiedConnectionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUnifiedConnectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUnifiedConnectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUnifiedConnectionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetUnifiedConnectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetUnifiedConnectionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetUnifiedConnectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetUnifiedConnectionResponse res = resBuilder.build();
