...
public class UpdateAtsActivity {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAtsActivityRequest, UpdateAtsActivityResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAtsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsActivityRequest.class, new TypeReference<UpdateAtsActivityRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsActivityRequest request) {
        ...
        @Override
        public UpdateAtsActivityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAtsActivityResponse.Builder resBuilder =
            ...
            UpdateAtsActivityResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAtsActivityRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAtsActivityResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAtsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsActivityRequest.class, new TypeReference<UpdateAtsActivityRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAtsActivityRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAtsActivityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAtsActivityResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAtsActivityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAtsActivityResponse res = resBuilder.build();
