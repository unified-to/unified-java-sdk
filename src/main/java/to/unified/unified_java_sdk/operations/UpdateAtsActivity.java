...
public class UpdateAtsActivity {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsActivityRequest request) throws Exception {
        ...
        @Override
        public UpdateAtsActivityResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AtsActivity out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAtsActivity(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
