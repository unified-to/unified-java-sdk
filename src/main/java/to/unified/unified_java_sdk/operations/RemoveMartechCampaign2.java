...
public class RemoveMartechCampaign2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveMartechCampaign2Request, RemoveMartechCampaign2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveMartechCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMartechCampaign2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveMartechCampaign2Request request) {
        ...
        @Override
        public RemoveMartechCampaign2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveMartechCampaign2Response.Builder resBuilder =
            ...
            RemoveMartechCampaign2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveMartechCampaign2Request, to.unified.unified_java_sdk.models.operations.async.RemoveMartechCampaign2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveMartechCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMartechCampaign2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveMartechCampaign2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveMartechCampaign2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveMartechCampaign2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveMartechCampaign2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveMartechCampaign2Response res = resBuilder.build();
