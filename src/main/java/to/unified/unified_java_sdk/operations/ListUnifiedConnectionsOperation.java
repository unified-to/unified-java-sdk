...
public class ListUnifiedConnectionsOperation implements RequestOperation<ListUnifiedConnectionsRequest, ListUnifiedConnectionsResponse> {
    ...
    public ListUnifiedConnectionsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListUnifiedConnectionsRequest request) throws Exception {
