...
public class ListCalendarLinksOperation implements RequestOperation<ListCalendarLinksRequest, ListCalendarLinksResponse> {
    ...
    public ListCalendarLinksOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCalendarLinksRequest request) throws Exception {
