...
public class RemovePaymentPayment {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemovePaymentPaymentRequest, RemovePaymentPaymentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemovePaymentPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePaymentPaymentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemovePaymentPaymentRequest request) throws Exception {
        ...
        @Override
        public RemovePaymentPaymentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemovePaymentPaymentResponse.Builder resBuilder =
            ...
            RemovePaymentPaymentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemovePaymentPaymentRequest, to.unified.unified_java_sdk.models.operations.async.RemovePaymentPaymentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemovePaymentPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePaymentPaymentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemovePaymentPaymentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemovePaymentPaymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemovePaymentPaymentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemovePaymentPaymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemovePaymentPaymentResponse res = resBuilder.build();
