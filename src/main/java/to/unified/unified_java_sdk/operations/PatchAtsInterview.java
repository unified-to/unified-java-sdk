...
public class PatchAtsInterview {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAtsInterviewRequest, PatchAtsInterviewResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAtsInterviewRequest request) {
        ...
        @Override
        public PatchAtsInterviewResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAtsInterviewResponse.Builder resBuilder =
            ...
            PatchAtsInterviewResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAtsInterviewRequest, to.unified.unified_java_sdk.models.operations.async.PatchAtsInterviewResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAtsInterviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsInterviewRequest.class, new TypeReference<PatchAtsInterviewRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAtsInterviewRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAtsInterviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAtsInterviewResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAtsInterviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAtsInterviewResponse res = resBuilder.build();
