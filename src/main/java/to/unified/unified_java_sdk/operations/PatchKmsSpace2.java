...
public class PatchKmsSpace2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchKmsSpace2Request, PatchKmsSpace2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchKmsSpace2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchKmsSpace2Request.class, new TypeReference<PatchKmsSpace2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchKmsSpace2Request request) {
        ...
        @Override
        public PatchKmsSpace2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchKmsSpace2Response.Builder resBuilder =
            ...
            PatchKmsSpace2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchKmsSpace2Request, to.unified.unified_java_sdk.models.operations.async.PatchKmsSpace2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchKmsSpace2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchKmsSpace2Request.class, new TypeReference<PatchKmsSpace2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchKmsSpace2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchKmsSpace2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchKmsSpace2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchKmsSpace2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchKmsSpace2Response res = resBuilder.build();
