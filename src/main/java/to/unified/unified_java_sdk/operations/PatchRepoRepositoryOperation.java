...
public class PatchRepoRepositoryOperation implements RequestOperation<PatchRepoRepositoryRequest, PatchRepoRepositoryResponse> {
    ...
    public PatchRepoRepositoryOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchRepoRepositoryRequest request) throws Exception {
