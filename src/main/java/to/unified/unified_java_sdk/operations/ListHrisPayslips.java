...
public class ListHrisPayslips {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisPayslipsRequest, ListHrisPayslipsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisPayslipsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisPayslipsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisPayslipsRequest request) {
        ...
        @Override
        public ListHrisPayslipsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisPayslipsResponse.Builder resBuilder =
            ...
            ListHrisPayslipsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisPayslipsRequest, to.unified.unified_java_sdk.models.operations.async.ListHrisPayslipsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisPayslipsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisPayslipsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisPayslipsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisPayslipsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisPayslipsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisPayslipsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisPayslipsResponse res = resBuilder.build();
