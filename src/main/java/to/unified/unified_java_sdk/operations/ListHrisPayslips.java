...
public class ListHrisPayslips {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisPayslipsRequest request) throws Exception {
        ...
        @Override
        public ListHrisPayslipsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<HrisPayslip> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHrisPayslips(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
