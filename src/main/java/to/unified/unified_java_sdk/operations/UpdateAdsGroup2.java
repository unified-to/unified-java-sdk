...
public class UpdateAdsGroup2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAdsGroup2Request, UpdateAdsGroup2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAdsGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsGroup2Request.class, new TypeReference<UpdateAdsGroup2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAdsGroup2Request request) {
        ...
        @Override
        public UpdateAdsGroup2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAdsGroup2Response.Builder resBuilder =
            ...
            UpdateAdsGroup2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAdsGroup2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAdsGroup2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAdsGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsGroup2Request.class, new TypeReference<UpdateAdsGroup2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAdsGroup2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAdsGroup2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAdsGroup2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAdsGroup2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAdsGroup2Response res = resBuilder.build();
