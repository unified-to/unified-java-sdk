...
public class GetCrmLeadOperation implements RequestOperation<GetCrmLeadRequest, GetCrmLeadResponse> {
    ...
    public GetCrmLeadOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetCrmLeadRequest request) throws Exception {
