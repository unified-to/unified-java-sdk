...
public class ListTicketingTicketsOperation implements RequestOperation<ListTicketingTicketsRequest, ListTicketingTicketsResponse> {
    ...
    public ListTicketingTicketsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListTicketingTicketsRequest request) throws Exception {
