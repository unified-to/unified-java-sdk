...
public class CreateAtsApplication {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAtsApplicationRequest, CreateAtsApplicationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAtsApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsApplicationRequest.class, new TypeReference<CreateAtsApplicationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsApplicationRequest request) {
        ...
        @Override
        public CreateAtsApplicationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAtsApplicationResponse.Builder resBuilder =
            ...
            CreateAtsApplicationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAtsApplicationRequest, to.unified.unified_java_sdk.models.operations.async.CreateAtsApplicationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAtsApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsApplicationRequest.class, new TypeReference<CreateAtsApplicationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAtsApplicationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAtsApplicationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAtsApplicationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAtsApplicationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAtsApplicationResponse res = resBuilder.build();
