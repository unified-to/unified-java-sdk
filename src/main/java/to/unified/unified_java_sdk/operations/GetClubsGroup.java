...
public class GetClubsGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetClubsGroupRequest, GetClubsGroupResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetClubsGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClubsGroupRequest request) {
        ...
        @Override
        public GetClubsGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetClubsGroupResponse.Builder resBuilder =
            ...
            GetClubsGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetClubsGroupRequest, to.unified.unified_java_sdk.models.operations.async.GetClubsGroupResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetClubsGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetClubsGroupRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetClubsGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetClubsGroupResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetClubsGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetClubsGroupResponse res = resBuilder.build();
