...
public class CreateAtsActivity2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAtsActivity2Request, CreateAtsActivity2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAtsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsActivity2Request.class, new TypeReference<CreateAtsActivity2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsActivity2Request request) {
        ...
        @Override
        public CreateAtsActivity2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAtsActivity2Response.Builder resBuilder =
            ...
            CreateAtsActivity2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAtsActivity2Request, to.unified.unified_java_sdk.models.operations.async.CreateAtsActivity2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAtsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsActivity2Request.class, new TypeReference<CreateAtsActivity2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAtsActivity2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAtsActivity2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAtsActivity2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAtsActivity2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAtsActivity2Response res = resBuilder.build();
