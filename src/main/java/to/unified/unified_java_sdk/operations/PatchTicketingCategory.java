...
public class PatchTicketingCategory {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchTicketingCategoryRequest, PatchTicketingCategoryResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(PatchTicketingCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTicketingCategoryRequest.class, new TypeReference<PatchTicketingCategoryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchTicketingCategoryRequest request) throws Exception {
        ...
        @Override
        public PatchTicketingCategoryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchTicketingCategoryResponse.Builder resBuilder =
            ...
            PatchTicketingCategoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchTicketingCategoryRequest, to.unified.unified_java_sdk.models.operations.async.PatchTicketingCategoryResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchTicketingCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTicketingCategoryRequest.class, new TypeReference<PatchTicketingCategoryRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchTicketingCategoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchTicketingCategoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchTicketingCategoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchTicketingCategoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchTicketingCategoryResponse res = resBuilder.build();
