...
public class PatchAccountingPaymentterm {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingPaymenttermRequest, PatchAccountingPaymenttermResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingPaymenttermRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingPaymenttermRequest.class, new TypeReference<PatchAccountingPaymenttermRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingPaymenttermRequest request) {
        ...
        @Override
        public PatchAccountingPaymenttermResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingPaymenttermResponse.Builder resBuilder =
                    PatchAccountingPaymenttermResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            PatchAccountingPaymenttermResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingPaymenttermRequest, to.unified.unified_java_sdk.models.operations.async.PatchAccountingPaymenttermResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingPaymenttermRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingPaymenttermRequest.class, new TypeReference<PatchAccountingPaymenttermRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingPaymenttermRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingPaymenttermResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingPaymenttermResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingPaymenttermResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingPaymenttermResponse res = resBuilder.build();
