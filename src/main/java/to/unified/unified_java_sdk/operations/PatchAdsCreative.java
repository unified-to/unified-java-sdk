...
public class PatchAdsCreative {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAdsCreativeRequest, PatchAdsCreativeResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAdsCreativeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsCreativeRequest.class, new TypeReference<PatchAdsCreativeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAdsCreativeRequest request) {
        ...
        @Override
        public PatchAdsCreativeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAdsCreativeResponse.Builder resBuilder =
            ...
            PatchAdsCreativeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAdsCreativeRequest, to.unified.unified_java_sdk.models.operations.async.PatchAdsCreativeResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAdsCreativeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsCreativeRequest.class, new TypeReference<PatchAdsCreativeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAdsCreativeRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAdsCreativeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAdsCreativeResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAdsCreativeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAdsCreativeResponse res = resBuilder.build();
