...
public class GetUnifiedIntegrationAuth {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUnifiedIntegrationAuthRequest, GetUnifiedIntegrationAuthResponse> {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUnifiedIntegrationAuthRequest, to.unified.unified_java_sdk.models.operations.async.GetUnifiedIntegrationAuthResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUnifiedIntegrationAuthRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUnifiedIntegrationAuthRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUnifiedIntegrationAuthRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetUnifiedIntegrationAuthResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetUnifiedIntegrationAuthResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetUnifiedIntegrationAuthResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetUnifiedIntegrationAuthResponse res = resBuilder.build();
