...
public class GetHrisDevice2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisDevice2Request, GetHrisDevice2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisDevice2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisDevice2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisDevice2Request request) {
        ...
        @Override
        public GetHrisDevice2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisDevice2Response.Builder resBuilder =
            ...
            GetHrisDevice2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisDevice2Request, to.unified.unified_java_sdk.models.operations.async.GetHrisDevice2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisDevice2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisDevice2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisDevice2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisDevice2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisDevice2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisDevice2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisDevice2Response res = resBuilder.build();
