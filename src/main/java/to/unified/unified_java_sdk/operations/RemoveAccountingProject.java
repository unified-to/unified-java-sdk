...
public class RemoveAccountingProject {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingProjectRequest, RemoveAccountingProjectResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingProjectRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingProjectRequest request) {
        ...
        @Override
        public RemoveAccountingProjectResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingProjectResponse.Builder resBuilder =
            ...
            RemoveAccountingProjectResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingProjectRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingProjectResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingProjectRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingProjectRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingProjectResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingProjectResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingProjectResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingProjectResponse res = resBuilder.build();
