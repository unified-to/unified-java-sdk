...
public class CreateLmsStudent {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateLmsStudentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsStudentRequest.class, new TypeReference<CreateLmsStudentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateLmsStudentRequest request) {
        ...
        @Override
        public CreateLmsStudentResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateLmsStudentRequest, to.unified.unified_java_sdk.models.operations.async.CreateLmsStudentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateLmsStudentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsStudentRequest.class, new TypeReference<CreateLmsStudentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateLmsStudentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateLmsStudentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateLmsStudentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateLmsStudentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateLmsStudentResponse res = resBuilder.build();
