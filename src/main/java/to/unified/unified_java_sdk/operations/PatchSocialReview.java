...
public class PatchSocialReview {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchSocialReviewRequest, PatchSocialReviewResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchSocialReviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchSocialReviewRequest.class, new TypeReference<PatchSocialReviewRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchSocialReviewRequest request) {
        ...
        @Override
        public PatchSocialReviewResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchSocialReviewResponse.Builder resBuilder =
            ...
            PatchSocialReviewResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchSocialReviewRequest, to.unified.unified_java_sdk.models.operations.async.PatchSocialReviewResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchSocialReviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchSocialReviewRequest.class, new TypeReference<PatchSocialReviewRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchSocialReviewRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchSocialReviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchSocialReviewResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchSocialReviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchSocialReviewResponse res = resBuilder.build();
