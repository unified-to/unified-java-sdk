...
public class ListCommerceInventories2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceInventories2Request, ListCommerceInventories2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommerceInventories2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceInventories2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceInventories2Request request) {
        ...
        @Override
        public ListCommerceInventories2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceInventories2Response.Builder resBuilder =
            ...
            ListCommerceInventories2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceInventories(Utils.unmarshal(response, new TypeReference<List<CommerceInventory>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceInventories2Request, to.unified.unified_java_sdk.models.operations.async.ListCommerceInventories2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceInventories2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceInventories2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceInventories2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceInventories2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceInventories2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceInventories2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceInventories2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CommerceInventory>>() {})
                            .thenApply(res::withCommerceInventories);
                } else {
