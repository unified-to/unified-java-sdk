...
public class CreateRepoCommitOperation implements RequestOperation<CreateRepoCommitRequest, CreateRepoCommitResponse> {
    ...
    public CreateRepoCommitOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateRepoCommitRequest request) throws Exception {
