...
public class ListCalendarRecordings {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCalendarRecordingsRequest, ListCalendarRecordingsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCalendarRecordingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarRecordingsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarRecordingsRequest request) {
        ...
        @Override
        public ListCalendarRecordingsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCalendarRecordingsResponse.Builder resBuilder =
            ...
            ListCalendarRecordingsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCalendarRecordingsRequest, to.unified.unified_java_sdk.models.operations.async.ListCalendarRecordingsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCalendarRecordingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarRecordingsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCalendarRecordingsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCalendarRecordingsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCalendarRecordingsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCalendarRecordingsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCalendarRecordingsResponse res = resBuilder.build();
