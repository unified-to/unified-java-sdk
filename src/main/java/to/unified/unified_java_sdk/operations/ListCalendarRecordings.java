...
public class ListCalendarRecordings {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarRecordingsRequest request) throws Exception {
        ...
        @Override
        public ListCalendarRecordingsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CalendarRecording> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCalendarRecordings(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
