...
public class UpdateFormsForm2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateFormsForm2Request, UpdateFormsForm2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateFormsForm2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateFormsForm2Request.class, new TypeReference<UpdateFormsForm2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateFormsForm2Request request) {
        ...
        @Override
        public UpdateFormsForm2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateFormsForm2Response.Builder resBuilder =
            ...
            UpdateFormsForm2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFormsForm(Utils.unmarshal(response, new TypeReference<FormsForm>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateFormsForm2Request, to.unified.unified_java_sdk.models.operations.async.UpdateFormsForm2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateFormsForm2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateFormsForm2Request.class, new TypeReference<UpdateFormsForm2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateFormsForm2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateFormsForm2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateFormsForm2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateFormsForm2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateFormsForm2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FormsForm>() {})
                            .thenApply(res::withFormsForm);
                } else {
