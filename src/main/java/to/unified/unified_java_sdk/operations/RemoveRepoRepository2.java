...
public class RemoveRepoRepository2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveRepoRepository2Request, RemoveRepoRepository2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveRepoRepository2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoRepository2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveRepoRepository2Request request) {
        ...
        @Override
        public RemoveRepoRepository2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveRepoRepository2Response.Builder resBuilder =
            ...
            RemoveRepoRepository2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveRepoRepository2Request, to.unified.unified_java_sdk.models.operations.async.RemoveRepoRepository2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveRepoRepository2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoRepository2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveRepoRepository2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveRepoRepository2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveRepoRepository2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveRepoRepository2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveRepoRepository2Response res = resBuilder.build();
