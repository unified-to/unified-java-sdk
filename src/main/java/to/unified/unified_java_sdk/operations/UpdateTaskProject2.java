...
public class UpdateTaskProject2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTaskProject2Request, UpdateTaskProject2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTaskProject2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTaskProject2Request.class, new TypeReference<UpdateTaskProject2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTaskProject2Request request) {
        ...
        @Override
        public UpdateTaskProject2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTaskProject2Response.Builder resBuilder =
            ...
            UpdateTaskProject2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateTaskProject2Request, to.unified.unified_java_sdk.models.operations.async.UpdateTaskProject2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateTaskProject2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTaskProject2Request.class, new TypeReference<UpdateTaskProject2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateTaskProject2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateTaskProject2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateTaskProject2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateTaskProject2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateTaskProject2Response res = resBuilder.build();
