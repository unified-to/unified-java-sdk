...
public class CreateAdsCampaign {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAdsCampaignRequest, CreateAdsCampaignResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAdsCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsCampaignRequest.class, new TypeReference<CreateAdsCampaignRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAdsCampaignRequest request) {
        ...
        @Override
        public CreateAdsCampaignResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAdsCampaignResponse.Builder resBuilder =
            ...
            CreateAdsCampaignResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAdsCampaignRequest, to.unified.unified_java_sdk.models.operations.async.CreateAdsCampaignResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAdsCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsCampaignRequest.class, new TypeReference<CreateAdsCampaignRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAdsCampaignRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAdsCampaignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAdsCampaignResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAdsCampaignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAdsCampaignResponse res = resBuilder.build();
