...
public class GetAtsJob2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAtsJob2Request, GetAtsJob2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAtsJob2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsJob2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAtsJob2Request request) {
        ...
        @Override
        public GetAtsJob2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAtsJob2Response.Builder resBuilder =
                    GetAtsJob2Response
                            .builder()
            ...
            GetAtsJob2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAtsJob2Request, to.unified.unified_java_sdk.models.operations.async.GetAtsJob2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAtsJob2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsJob2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAtsJob2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAtsJob2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAtsJob2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAtsJob2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAtsJob2Response res = resBuilder.build();
