...
public class GetAccountingOrder2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingOrder2Request, GetAccountingOrder2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingOrder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingOrder2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingOrder2Request request) {
        ...
        @Override
        public GetAccountingOrder2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingOrder2Response.Builder resBuilder =
            ...
            GetAccountingOrder2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingOrder2Request, to.unified.unified_java_sdk.models.operations.async.GetAccountingOrder2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingOrder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingOrder2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingOrder2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingOrder2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingOrder2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingOrder2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingOrder2Response res = resBuilder.build();
