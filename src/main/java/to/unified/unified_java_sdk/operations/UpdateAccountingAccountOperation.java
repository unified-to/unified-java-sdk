...
public class UpdateAccountingAccountOperation implements RequestOperation<UpdateAccountingAccountRequest, UpdateAccountingAccountResponse> {
    ...
    public UpdateAccountingAccountOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAccountingAccountRequest request) throws Exception {
    ...
    @Override
    public HttpResponse<InputStream> doRequest(UpdateAccountingAccountRequest request) throws Exception {
    ...
    @Override
    public UpdateAccountingAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
