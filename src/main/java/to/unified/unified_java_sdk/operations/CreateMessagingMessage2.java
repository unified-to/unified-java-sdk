...
public class CreateMessagingMessage2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateMessagingMessage2Request, CreateMessagingMessage2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateMessagingMessage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMessagingMessage2Request.class, new TypeReference<CreateMessagingMessage2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMessagingMessage2Request request) {
        ...
        @Override
        public CreateMessagingMessage2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateMessagingMessage2Response.Builder resBuilder =
            ...
            CreateMessagingMessage2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMessagingMessage(Utils.unmarshal(response, new TypeReference<MessagingMessage>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateMessagingMessage2Request, to.unified.unified_java_sdk.models.operations.async.CreateMessagingMessage2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateMessagingMessage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMessagingMessage2Request.class, new TypeReference<CreateMessagingMessage2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateMessagingMessage2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateMessagingMessage2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateMessagingMessage2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateMessagingMessage2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateMessagingMessage2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MessagingMessage>() {})
                            .thenApply(res::withMessagingMessage);
                } else {
