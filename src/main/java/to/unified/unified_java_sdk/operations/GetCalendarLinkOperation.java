...
public class GetCalendarLinkOperation implements RequestOperation<GetCalendarLinkRequest, GetCalendarLinkResponse> {
    ...
    public GetCalendarLinkOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetCalendarLinkRequest request) throws Exception {
