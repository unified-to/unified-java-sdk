...
public class GetCalendarLink {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCalendarLinkRequest, GetCalendarLinkResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCalendarLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarLinkRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCalendarLinkRequest request) {
        ...
        @Override
        public GetCalendarLinkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCalendarLinkResponse.Builder resBuilder =
            ...
            GetCalendarLinkResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCalendarLinkRequest, to.unified.unified_java_sdk.models.operations.async.GetCalendarLinkResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCalendarLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarLinkRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCalendarLinkRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCalendarLinkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCalendarLinkResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCalendarLinkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCalendarLinkResponse res = resBuilder.build();
