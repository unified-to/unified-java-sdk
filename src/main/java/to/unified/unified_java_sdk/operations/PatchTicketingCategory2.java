...
public class PatchTicketingCategory2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchTicketingCategory2Request, PatchTicketingCategory2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchTicketingCategory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTicketingCategory2Request.class, new TypeReference<PatchTicketingCategory2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchTicketingCategory2Request request) {
        ...
        @Override
        public PatchTicketingCategory2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchTicketingCategory2Response.Builder resBuilder =
            ...
            PatchTicketingCategory2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchTicketingCategory2Request, to.unified.unified_java_sdk.models.operations.async.PatchTicketingCategory2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchTicketingCategory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTicketingCategory2Request.class, new TypeReference<PatchTicketingCategory2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchTicketingCategory2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchTicketingCategory2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchTicketingCategory2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchTicketingCategory2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchTicketingCategory2Response res = resBuilder.build();
