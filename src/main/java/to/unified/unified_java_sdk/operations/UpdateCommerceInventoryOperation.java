...
public class UpdateCommerceInventoryOperation implements RequestOperation<UpdateCommerceInventoryRequest, UpdateCommerceInventoryResponse> {
    ...
    public UpdateCommerceInventoryOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateCommerceInventoryRequest request) throws Exception {
