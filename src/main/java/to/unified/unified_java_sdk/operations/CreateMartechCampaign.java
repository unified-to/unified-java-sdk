...
public class CreateMartechCampaign {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateMartechCampaignRequest, CreateMartechCampaignResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateMartechCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMartechCampaignRequest.class, new TypeReference<CreateMartechCampaignRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMartechCampaignRequest request) {
        ...
        @Override
        public CreateMartechCampaignResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateMartechCampaignResponse.Builder resBuilder =
            ...
            CreateMartechCampaignResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateMartechCampaignRequest, to.unified.unified_java_sdk.models.operations.async.CreateMartechCampaignResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateMartechCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMartechCampaignRequest.class, new TypeReference<CreateMartechCampaignRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateMartechCampaignRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateMartechCampaignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateMartechCampaignResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateMartechCampaignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateMartechCampaignResponse res = resBuilder.build();
