...
public class ListAnalyticsProperties {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAnalyticsPropertiesRequest, ListAnalyticsPropertiesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAnalyticsPropertiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAnalyticsPropertiesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAnalyticsPropertiesRequest request) {
        ...
        @Override
        public ListAnalyticsPropertiesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAnalyticsPropertiesResponse.Builder resBuilder =
            ...
            ListAnalyticsPropertiesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAnalyticsPropertiesRequest, to.unified.unified_java_sdk.models.operations.async.ListAnalyticsPropertiesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAnalyticsPropertiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAnalyticsPropertiesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAnalyticsPropertiesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAnalyticsPropertiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAnalyticsPropertiesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAnalyticsPropertiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAnalyticsPropertiesResponse res = resBuilder.build();
