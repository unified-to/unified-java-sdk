...
public class ListKmsCommentsOperation implements RequestOperation<ListKmsCommentsRequest, ListKmsCommentsResponse> {
    ...
    public ListKmsCommentsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListKmsCommentsRequest request) throws Exception {
