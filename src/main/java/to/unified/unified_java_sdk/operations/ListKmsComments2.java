...
public class ListKmsComments2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListKmsComments2Request, ListKmsComments2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListKmsComments2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListKmsComments2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListKmsComments2Request request) {
        ...
        @Override
        public ListKmsComments2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListKmsComments2Response.Builder resBuilder =
            ...
            ListKmsComments2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withKmsComments(Utils.unmarshal(response, new TypeReference<List<KmsComment>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListKmsComments2Request, to.unified.unified_java_sdk.models.operations.async.ListKmsComments2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListKmsComments2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListKmsComments2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListKmsComments2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListKmsComments2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListKmsComments2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListKmsComments2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListKmsComments2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<KmsComment>>() {})
                            .thenApply(res::withKmsComments);
                } else {
