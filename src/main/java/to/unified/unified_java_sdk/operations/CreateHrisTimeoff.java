...
public class CreateHrisTimeoff {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisTimeoffRequest, CreateHrisTimeoffResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisTimeoffRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisTimeoffRequest.class, new TypeReference<CreateHrisTimeoffRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisTimeoffRequest request) {
        ...
        @Override
        public CreateHrisTimeoffResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisTimeoffResponse.Builder resBuilder =
            ...
            CreateHrisTimeoffResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisTimeoffRequest, to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeoffResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisTimeoffRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisTimeoffRequest.class, new TypeReference<CreateHrisTimeoffRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisTimeoffRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeoffResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeoffResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeoffResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeoffResponse res = resBuilder.build();
