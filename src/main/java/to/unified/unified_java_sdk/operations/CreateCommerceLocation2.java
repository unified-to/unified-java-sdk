...
public class CreateCommerceLocation2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommerceLocation2Request, CreateCommerceLocation2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommerceLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceLocation2Request.class, new TypeReference<CreateCommerceLocation2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceLocation2Request request) {
        ...
        @Override
        public CreateCommerceLocation2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommerceLocation2Response.Builder resBuilder =
            ...
            CreateCommerceLocation2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommerceLocation2Request, to.unified.unified_java_sdk.models.operations.async.CreateCommerceLocation2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommerceLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceLocation2Request.class, new TypeReference<CreateCommerceLocation2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommerceLocation2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCommerceLocation2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCommerceLocation2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCommerceLocation2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCommerceLocation2Response res = resBuilder.build();
