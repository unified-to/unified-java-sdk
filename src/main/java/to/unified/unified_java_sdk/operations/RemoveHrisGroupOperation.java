...
public class RemoveHrisGroupOperation implements RequestOperation<RemoveHrisGroupRequest, RemoveHrisGroupResponse> {
    ...
    public RemoveHrisGroupOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveHrisGroupRequest request) throws Exception {
