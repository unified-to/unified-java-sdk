...
public class GetAtsCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAtsCompanyRequest, GetAtsCompanyResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAtsCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsCompanyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAtsCompanyRequest request) {
        ...
        @Override
        public GetAtsCompanyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAtsCompanyResponse.Builder resBuilder =
            ...
            GetAtsCompanyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAtsCompanyRequest, to.unified.unified_java_sdk.models.operations.async.GetAtsCompanyResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAtsCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsCompanyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAtsCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAtsCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAtsCompanyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAtsCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAtsCompanyResponse res = resBuilder.build();
