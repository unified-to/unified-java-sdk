...
public class ListPerformanceCycles {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPerformanceCyclesRequest, ListPerformanceCyclesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPerformanceCyclesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPerformanceCyclesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPerformanceCyclesRequest request) {
        ...
        @Override
        public ListPerformanceCyclesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPerformanceCyclesResponse.Builder resBuilder =
            ...
            ListPerformanceCyclesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPerformanceCycles(Utils.unmarshal(response, new TypeReference<List<PerformanceCycle>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPerformanceCyclesRequest, to.unified.unified_java_sdk.models.operations.async.ListPerformanceCyclesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPerformanceCyclesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPerformanceCyclesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPerformanceCyclesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListPerformanceCyclesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListPerformanceCyclesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListPerformanceCyclesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListPerformanceCyclesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<PerformanceCycle>>() {})
                            .thenApply(res::withPerformanceCycles);
                } else {
