...
public class PatchRepoBranch2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchRepoBranch2Request, PatchRepoBranch2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchRepoBranch2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoBranch2Request.class, new TypeReference<PatchRepoBranch2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchRepoBranch2Request request) {
        ...
        @Override
        public PatchRepoBranch2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchRepoBranch2Response.Builder resBuilder =
            ...
            PatchRepoBranch2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchRepoBranch2Request, to.unified.unified_java_sdk.models.operations.async.PatchRepoBranch2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchRepoBranch2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoBranch2Request.class, new TypeReference<PatchRepoBranch2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchRepoBranch2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchRepoBranch2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchRepoBranch2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchRepoBranch2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchRepoBranch2Response res = resBuilder.build();
