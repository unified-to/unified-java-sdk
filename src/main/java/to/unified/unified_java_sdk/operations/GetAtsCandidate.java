...
public class GetAtsCandidate {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAtsCandidateRequest, GetAtsCandidateResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAtsCandidateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsCandidateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAtsCandidateRequest request) {
        ...
        @Override
        public GetAtsCandidateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAtsCandidateResponse.Builder resBuilder =
            ...
            GetAtsCandidateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAtsCandidateRequest, to.unified.unified_java_sdk.models.operations.async.GetAtsCandidateResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAtsCandidateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsCandidateRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAtsCandidateRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAtsCandidateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAtsCandidateResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAtsCandidateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAtsCandidateResponse res = resBuilder.build();
