...
public class PatchLmsCourseOperation implements RequestOperation<PatchLmsCourseRequest, PatchLmsCourseResponse> {
    ...
    public PatchLmsCourseOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchLmsCourseRequest request) throws Exception {
