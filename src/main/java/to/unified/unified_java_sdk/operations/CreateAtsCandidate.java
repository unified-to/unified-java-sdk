...
public class CreateAtsCandidate {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAtsCandidateRequest, CreateAtsCandidateResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsCandidateRequest request) {
        ...
        @Override
        public CreateAtsCandidateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAtsCandidateResponse.Builder resBuilder =
            ...
            CreateAtsCandidateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAtsCandidateRequest, to.unified.unified_java_sdk.models.operations.async.CreateAtsCandidateResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAtsCandidateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsCandidateRequest.class, new TypeReference<CreateAtsCandidateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAtsCandidateRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAtsCandidateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAtsCandidateResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAtsCandidateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAtsCandidateResponse res = resBuilder.build();
