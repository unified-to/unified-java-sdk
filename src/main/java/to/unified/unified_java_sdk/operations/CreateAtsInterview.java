...
public class CreateAtsInterview {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsInterviewRequest request) throws Exception {
        ...
        @Override
        public CreateAtsInterviewResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AtsInterview out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAtsInterview(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
