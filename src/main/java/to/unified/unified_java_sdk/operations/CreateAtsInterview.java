...
public class CreateAtsInterview {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAtsInterviewRequest, CreateAtsInterviewResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAtsInterviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsInterviewRequest.class, new TypeReference<CreateAtsInterviewRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsInterviewRequest request) {
        ...
        @Override
        public CreateAtsInterviewResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAtsInterviewResponse.Builder resBuilder =
            ...
            CreateAtsInterviewResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAtsInterviewRequest, to.unified.unified_java_sdk.models.operations.async.CreateAtsInterviewResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAtsInterviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsInterviewRequest.class, new TypeReference<CreateAtsInterviewRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAtsInterviewRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAtsInterviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAtsInterviewResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAtsInterviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAtsInterviewResponse res = resBuilder.build();
