...
public class RemovePerformanceGoal {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemovePerformanceGoalRequest, RemovePerformanceGoalResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemovePerformanceGoalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePerformanceGoalRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemovePerformanceGoalRequest request) {
        ...
        @Override
        public RemovePerformanceGoalResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemovePerformanceGoalResponse.Builder resBuilder =
            ...
            RemovePerformanceGoalResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemovePerformanceGoalRequest, to.unified.unified_java_sdk.models.operations.async.RemovePerformanceGoalResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemovePerformanceGoalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePerformanceGoalRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemovePerformanceGoalRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemovePerformanceGoalResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemovePerformanceGoalResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemovePerformanceGoalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemovePerformanceGoalResponse res = resBuilder.build();
