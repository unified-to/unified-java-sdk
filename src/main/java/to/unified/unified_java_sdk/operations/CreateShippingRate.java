...
public class CreateShippingRate {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateShippingRateRequest, CreateShippingRateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateShippingRateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateShippingRateRequest.class, new TypeReference<CreateShippingRateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateShippingRateRequest request) {
        ...
        @Override
        public CreateShippingRateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateShippingRateResponse.Builder resBuilder =
            ...
            CreateShippingRateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateShippingRateRequest, to.unified.unified_java_sdk.models.operations.async.CreateShippingRateResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateShippingRateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateShippingRateRequest.class, new TypeReference<CreateShippingRateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateShippingRateRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateShippingRateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateShippingRateResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateShippingRateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateShippingRateResponse res = resBuilder.build();
