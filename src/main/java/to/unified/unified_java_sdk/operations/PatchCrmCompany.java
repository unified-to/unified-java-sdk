...
public class PatchCrmCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCrmCompanyRequest, PatchCrmCompanyResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCrmCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmCompanyRequest.class, new TypeReference<PatchCrmCompanyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCrmCompanyRequest request) {
        ...
        @Override
        public PatchCrmCompanyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCrmCompanyResponse.Builder resBuilder =
            ...
            PatchCrmCompanyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCrmCompanyRequest, to.unified.unified_java_sdk.models.operations.async.PatchCrmCompanyResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCrmCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmCompanyRequest.class, new TypeReference<PatchCrmCompanyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCrmCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCrmCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCrmCompanyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCrmCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCrmCompanyResponse res = resBuilder.build();
