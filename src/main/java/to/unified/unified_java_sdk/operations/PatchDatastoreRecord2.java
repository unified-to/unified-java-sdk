...
public class PatchDatastoreRecord2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchDatastoreRecord2Request, PatchDatastoreRecord2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchDatastoreRecord2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchDatastoreRecord2Request.class, new TypeReference<PatchDatastoreRecord2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchDatastoreRecord2Request request) {
        ...
        @Override
        public PatchDatastoreRecord2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchDatastoreRecord2Response.Builder resBuilder =
            ...
            PatchDatastoreRecord2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchDatastoreRecord2Request, to.unified.unified_java_sdk.models.operations.async.PatchDatastoreRecord2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchDatastoreRecord2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchDatastoreRecord2Request.class, new TypeReference<PatchDatastoreRecord2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchDatastoreRecord2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchDatastoreRecord2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchDatastoreRecord2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchDatastoreRecord2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchDatastoreRecord2Response res = resBuilder.build();
