...
public class UpdatePassthrough2Raw {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatePassthrough2RawRequest, UpdatePassthrough2RawResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdatePassthrough2RawRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePassthrough2RawRequest.class, new TypeReference<UpdatePassthrough2RawRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePassthrough2RawRequest request) {
        ...
        @Override
        public UpdatePassthrough2RawResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatePassthrough2RawResponse.Builder resBuilder =
            ...
            UpdatePassthrough2RawResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatePassthrough2RawRequest, to.unified.unified_java_sdk.models.operations.async.UpdatePassthrough2RawResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePassthrough2RawRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePassthrough2RawRequest.class, new TypeReference<UpdatePassthrough2RawRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatePassthrough2RawRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdatePassthrough2RawResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdatePassthrough2RawResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdatePassthrough2RawResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            to.unified.unified_java_sdk.models.operations.async.UpdatePassthrough2RawResponse res = resBuilder.build();
