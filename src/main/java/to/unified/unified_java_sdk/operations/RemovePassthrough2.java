...
public class RemovePassthrough2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemovePassthrough2Request, RemovePassthrough2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemovePassthrough2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePassthrough2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemovePassthrough2Request request) {
        ...
        @Override
        public RemovePassthrough2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemovePassthrough2Response.Builder resBuilder =
            ...
            RemovePassthrough2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemovePassthrough2Request, to.unified.unified_java_sdk.models.operations.async.RemovePassthrough2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemovePassthrough2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePassthrough2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemovePassthrough2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemovePassthrough2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemovePassthrough2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemovePassthrough2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            to.unified.unified_java_sdk.models.operations.async.RemovePassthrough2Response res = resBuilder.build();
