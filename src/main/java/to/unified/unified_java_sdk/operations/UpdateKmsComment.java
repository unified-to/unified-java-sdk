...
public class UpdateKmsComment {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateKmsCommentRequest request) throws Exception {
        ...
        @Override
        public UpdateKmsCommentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    KmsComment out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withKmsComment(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
