...
public class UpdateKmsComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateKmsCommentRequest, UpdateKmsCommentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateKmsCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateKmsCommentRequest.class, new TypeReference<UpdateKmsCommentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateKmsCommentRequest request) {
        ...
        @Override
        public UpdateKmsCommentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateKmsCommentResponse.Builder resBuilder =
            ...
            UpdateKmsCommentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateKmsCommentRequest, to.unified.unified_java_sdk.models.operations.async.UpdateKmsCommentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateKmsCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateKmsCommentRequest.class, new TypeReference<UpdateKmsCommentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateKmsCommentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateKmsCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateKmsCommentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateKmsCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateKmsCommentResponse res = resBuilder.build();
