...
public class RemoveShippingLabel {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveShippingLabelRequest, RemoveShippingLabelResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveShippingLabelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveShippingLabelRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveShippingLabelRequest request) {
        ...
        @Override
        public RemoveShippingLabelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveShippingLabelResponse.Builder resBuilder =
            ...
            RemoveShippingLabelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveShippingLabelRequest, to.unified.unified_java_sdk.models.operations.async.RemoveShippingLabelResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveShippingLabelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveShippingLabelRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveShippingLabelRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveShippingLabelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveShippingLabelResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveShippingLabelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveShippingLabelResponse res = resBuilder.build();
