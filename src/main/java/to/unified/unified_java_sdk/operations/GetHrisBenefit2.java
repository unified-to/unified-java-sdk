...
public class GetHrisBenefit2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisBenefit2Request, GetHrisBenefit2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisBenefit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisBenefit2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisBenefit2Request request) {
        ...
        @Override
        public GetHrisBenefit2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisBenefit2Response.Builder resBuilder =
            ...
            GetHrisBenefit2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisBenefit2Request, to.unified.unified_java_sdk.models.operations.async.GetHrisBenefit2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisBenefit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisBenefit2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisBenefit2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisBenefit2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisBenefit2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisBenefit2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisBenefit2Response res = resBuilder.build();
