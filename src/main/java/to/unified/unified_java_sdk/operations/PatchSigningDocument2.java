...
public class PatchSigningDocument2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchSigningDocument2Request, PatchSigningDocument2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchSigningDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchSigningDocument2Request.class, new TypeReference<PatchSigningDocument2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchSigningDocument2Request request) {
        ...
        @Override
        public PatchSigningDocument2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchSigningDocument2Response.Builder resBuilder =
            ...
            PatchSigningDocument2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchSigningDocument2Request, to.unified.unified_java_sdk.models.operations.async.PatchSigningDocument2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchSigningDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchSigningDocument2Request.class, new TypeReference<PatchSigningDocument2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchSigningDocument2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchSigningDocument2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchSigningDocument2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchSigningDocument2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchSigningDocument2Response res = resBuilder.build();
