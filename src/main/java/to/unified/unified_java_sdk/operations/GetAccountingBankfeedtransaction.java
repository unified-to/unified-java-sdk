...
public class GetAccountingBankfeedtransaction {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingBankfeedtransactionRequest, GetAccountingBankfeedtransactionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingBankfeedtransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingBankfeedtransactionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingBankfeedtransactionRequest request) {
        ...
        @Override
        public GetAccountingBankfeedtransactionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingBankfeedtransactionResponse.Builder resBuilder =
                    GetAccountingBankfeedtransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetAccountingBankfeedtransactionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingBankfeedtransactionRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingBankfeedtransactionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingBankfeedtransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingBankfeedtransactionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingBankfeedtransactionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingBankfeedtransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingBankfeedtransactionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingBankfeedtransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingBankfeedtransactionResponse res = resBuilder.build();
