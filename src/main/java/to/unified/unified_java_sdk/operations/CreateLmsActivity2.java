...
public class CreateLmsActivity2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateLmsActivity2Request, CreateLmsActivity2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateLmsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsActivity2Request.class, new TypeReference<CreateLmsActivity2Request>() {});
        ...
        @Override
        public CreateLmsActivity2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateLmsActivity2Response.Builder resBuilder =
            ...
            CreateLmsActivity2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateLmsActivity2Request, to.unified.unified_java_sdk.models.operations.async.CreateLmsActivity2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateLmsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsActivity2Request.class, new TypeReference<CreateLmsActivity2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateLmsActivity2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateLmsActivity2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateLmsActivity2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateLmsActivity2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateLmsActivity2Response res = resBuilder.build();
