...
public class RemoveCrmLead {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCrmLeadRequest, RemoveCrmLeadResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCrmLeadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmLeadRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCrmLeadRequest request) throws Exception {
        ...
        @Override
        public RemoveCrmLeadResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCrmLeadResponse.Builder resBuilder =
            ...
            RemoveCrmLeadResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCrmLeadRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCrmLeadResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCrmLeadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmLeadRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCrmLeadRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCrmLeadResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCrmLeadResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCrmLeadResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCrmLeadResponse res = resBuilder.build();
