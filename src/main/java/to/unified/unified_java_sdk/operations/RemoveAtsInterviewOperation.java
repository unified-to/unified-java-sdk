...
public class RemoveAtsInterviewOperation implements RequestOperation<RemoveAtsInterviewRequest, RemoveAtsInterviewResponse> {
    ...
    public RemoveAtsInterviewOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAtsInterviewRequest request) throws Exception {
