...
public class GetAccountingTrialbalance {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingTrialbalanceRequest request) throws Exception {
        ...
        @Override
        public GetAccountingTrialbalanceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingTrialbalance out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingTrialbalance(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
