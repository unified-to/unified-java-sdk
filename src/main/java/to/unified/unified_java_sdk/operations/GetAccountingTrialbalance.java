...
public class GetAccountingTrialbalance {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingTrialbalanceRequest, GetAccountingTrialbalanceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingTrialbalanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingTrialbalanceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingTrialbalanceRequest request) {
        ...
        @Override
        public GetAccountingTrialbalanceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingTrialbalanceResponse.Builder resBuilder =
            ...
            GetAccountingTrialbalanceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingTrialbalanceRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingTrialbalanceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingTrialbalanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingTrialbalanceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingTrialbalanceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingTrialbalanceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingTrialbalanceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingTrialbalanceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingTrialbalanceResponse res = resBuilder.build();
