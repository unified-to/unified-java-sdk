...
public class PatchKmsPage {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchKmsPageRequest, PatchKmsPageResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchKmsPageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchKmsPageRequest.class, new TypeReference<PatchKmsPageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchKmsPageRequest request) {
        ...
        @Override
        public PatchKmsPageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchKmsPageResponse.Builder resBuilder =
            ...
            PatchKmsPageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchKmsPageRequest, to.unified.unified_java_sdk.models.operations.async.PatchKmsPageResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchKmsPageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchKmsPageRequest.class, new TypeReference<PatchKmsPageRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchKmsPageRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchKmsPageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchKmsPageResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchKmsPageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchKmsPageResponse res = resBuilder.build();
