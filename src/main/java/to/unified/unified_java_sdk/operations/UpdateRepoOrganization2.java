...
public class UpdateRepoOrganization2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateRepoOrganization2Request, UpdateRepoOrganization2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateRepoOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoOrganization2Request.class, new TypeReference<UpdateRepoOrganization2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateRepoOrganization2Request request) {
        ...
        @Override
        public UpdateRepoOrganization2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateRepoOrganization2Response.Builder resBuilder =
            ...
            UpdateRepoOrganization2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRepoOrganization(Utils.unmarshal(response, new TypeReference<RepoOrganization>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateRepoOrganization2Request, to.unified.unified_java_sdk.models.operations.async.UpdateRepoOrganization2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateRepoOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoOrganization2Request.class, new TypeReference<UpdateRepoOrganization2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateRepoOrganization2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateRepoOrganization2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateRepoOrganization2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateRepoOrganization2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateRepoOrganization2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RepoOrganization>() {})
                            .thenApply(res::withRepoOrganization);
                } else {
