...
public class UpdateUnifiedWebhookTriggerOperation implements RequestOperation<UpdateUnifiedWebhookTriggerRequest, UpdateUnifiedWebhookTriggerResponse> {
    ...
    public UpdateUnifiedWebhookTriggerOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateUnifiedWebhookTriggerRequest request) throws Exception {
