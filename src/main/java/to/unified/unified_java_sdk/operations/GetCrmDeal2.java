...
public class GetCrmDeal2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCrmDeal2Request, GetCrmDeal2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCrmDeal2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmDeal2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCrmDeal2Request request) {
        ...
        @Override
        public GetCrmDeal2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCrmDeal2Response.Builder resBuilder =
                    GetCrmDeal2Response
                            .builder()
            ...
            GetCrmDeal2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCrmDeal2Request, to.unified.unified_java_sdk.models.operations.async.GetCrmDeal2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCrmDeal2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmDeal2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCrmDeal2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCrmDeal2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCrmDeal2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCrmDeal2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCrmDeal2Response res = resBuilder.build();
