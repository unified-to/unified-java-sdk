...
public class GetHrisCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisCompanyRequest, GetHrisCompanyResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisCompanyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisCompanyRequest request) {
        ...
        @Override
        public GetHrisCompanyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisCompanyResponse.Builder resBuilder =
            ...
            GetHrisCompanyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisCompanyRequest, to.unified.unified_java_sdk.models.operations.async.GetHrisCompanyResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisCompanyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisCompanyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisCompanyResponse res = resBuilder.build();
