...
public class PatchDatastoreDatabase2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchDatastoreDatabase2Request, PatchDatastoreDatabase2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchDatastoreDatabase2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchDatastoreDatabase2Request.class, new TypeReference<PatchDatastoreDatabase2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchDatastoreDatabase2Request request) {
        ...
        @Override
        public PatchDatastoreDatabase2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchDatastoreDatabase2Response.Builder resBuilder =
            ...
            PatchDatastoreDatabase2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchDatastoreDatabase2Request, to.unified.unified_java_sdk.models.operations.async.PatchDatastoreDatabase2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchDatastoreDatabase2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchDatastoreDatabase2Request.class, new TypeReference<PatchDatastoreDatabase2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchDatastoreDatabase2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchDatastoreDatabase2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchDatastoreDatabase2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchDatastoreDatabase2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchDatastoreDatabase2Response res = resBuilder.build();
