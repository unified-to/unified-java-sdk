...
public class PatchCrmContactOperation implements RequestOperation<PatchCrmContactRequest, PatchCrmContactResponse> {
    ...
    public PatchCrmContactOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchCrmContactRequest request) throws Exception {
