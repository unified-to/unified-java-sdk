...
public class CreateAdsInsertionorder2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAdsInsertionorder2Request, CreateAdsInsertionorder2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAdsInsertionorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsInsertionorder2Request.class, new TypeReference<CreateAdsInsertionorder2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAdsInsertionorder2Request request) {
        ...
        @Override
        public CreateAdsInsertionorder2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAdsInsertionorder2Response.Builder resBuilder =
            ...
            CreateAdsInsertionorder2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAdsInsertionorder2Request, to.unified.unified_java_sdk.models.operations.async.CreateAdsInsertionorder2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAdsInsertionorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsInsertionorder2Request.class, new TypeReference<CreateAdsInsertionorder2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAdsInsertionorder2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAdsInsertionorder2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAdsInsertionorder2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAdsInsertionorder2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAdsInsertionorder2Response res = resBuilder.build();
