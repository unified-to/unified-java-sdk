...
public class RemoveAccountingVendorcredit {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingVendorcreditRequest, RemoveAccountingVendorcreditResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingVendorcreditRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingVendorcreditRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingVendorcreditRequest request) {
        ...
        @Override
        public RemoveAccountingVendorcreditResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingVendorcreditResponse.Builder resBuilder =
            ...
            RemoveAccountingVendorcreditResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingVendorcreditRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingVendorcreditResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingVendorcreditRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingVendorcreditRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingVendorcreditRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingVendorcreditResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingVendorcreditResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingVendorcreditResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingVendorcreditResponse res = resBuilder.build();
