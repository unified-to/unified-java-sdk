...
public class PatchAccountingContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingContactRequest, PatchAccountingContactResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingContactRequest.class, new TypeReference<PatchAccountingContactRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingContactRequest request) {
        ...
        @Override
        public PatchAccountingContactResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingContactResponse.Builder resBuilder =
            ...
            PatchAccountingContactResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingContactRequest, to.unified.unified_java_sdk.models.operations.async.PatchAccountingContactResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingContactRequest.class, new TypeReference<PatchAccountingContactRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingContactRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingContactResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingContactResponse res = resBuilder.build();
