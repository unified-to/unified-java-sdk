...
public class UpdateHrisDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisDocumentRequest, UpdateHrisDocumentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisDocumentRequest.class, new TypeReference<UpdateHrisDocumentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisDocumentRequest request) {
        ...
        @Override
        public UpdateHrisDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisDocumentResponse.Builder resBuilder =
            ...
            UpdateHrisDocumentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisDocument(Utils.unmarshal(response, new TypeReference<HrisDocument>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisDocumentRequest, to.unified.unified_java_sdk.models.operations.async.UpdateHrisDocumentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisDocumentRequest.class, new TypeReference<UpdateHrisDocumentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisDocumentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisDocumentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HrisDocument>() {})
                            .thenApply(res::withHrisDocument);
                } else {
