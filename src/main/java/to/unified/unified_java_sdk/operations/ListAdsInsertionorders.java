...
public class ListAdsInsertionorders {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsInsertionordersRequest, ListAdsInsertionordersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsInsertionordersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsInsertionordersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsInsertionordersRequest request) {
        ...
        @Override
        public ListAdsInsertionordersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsInsertionordersResponse.Builder resBuilder =
            ...
            ListAdsInsertionordersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsInsertionordersRequest, to.unified.unified_java_sdk.models.operations.async.ListAdsInsertionordersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsInsertionordersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsInsertionordersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsInsertionordersRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsInsertionordersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsInsertionordersResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsInsertionordersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsInsertionordersResponse res = resBuilder.build();
