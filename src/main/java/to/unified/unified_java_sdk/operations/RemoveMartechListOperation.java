...
public class RemoveMartechListOperation implements RequestOperation<RemoveMartechListRequest, RemoveMartechListResponse> {
    ...
    public RemoveMartechListOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveMartechListRequest request) throws Exception {
