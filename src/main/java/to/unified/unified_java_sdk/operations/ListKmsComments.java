...
public class ListKmsComments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListKmsCommentsRequest request) throws Exception {
        ...
        @Override
        public ListKmsCommentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<KmsComment> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withKmsComments(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
