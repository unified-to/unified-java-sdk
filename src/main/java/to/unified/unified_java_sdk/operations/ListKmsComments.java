...
public class ListKmsComments {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListKmsCommentsRequest, ListKmsCommentsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListKmsCommentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListKmsCommentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListKmsCommentsRequest request) {
        ...
        @Override
        public ListKmsCommentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListKmsCommentsResponse.Builder resBuilder =
            ...
            ListKmsCommentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListKmsCommentsRequest, to.unified.unified_java_sdk.models.operations.async.ListKmsCommentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListKmsCommentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListKmsCommentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListKmsCommentsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListKmsCommentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListKmsCommentsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListKmsCommentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListKmsCommentsResponse res = resBuilder.build();
