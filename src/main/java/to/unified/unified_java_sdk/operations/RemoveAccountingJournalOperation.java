...
public class RemoveAccountingJournalOperation implements RequestOperation<RemoveAccountingJournalRequest, RemoveAccountingJournalResponse> {
    ...
    public RemoveAccountingJournalOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAccountingJournalRequest request) throws Exception {
