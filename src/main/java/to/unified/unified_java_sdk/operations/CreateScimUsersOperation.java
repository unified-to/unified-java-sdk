...
public class CreateScimUsersOperation implements RequestOperation<CreateScimUsersRequest, CreateScimUsersResponse> {
    ...
    public CreateScimUsersOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateScimUsersRequest request) throws Exception {
