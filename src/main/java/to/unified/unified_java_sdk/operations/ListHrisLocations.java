...
public class ListHrisLocations {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisLocationsRequest, ListHrisLocationsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisLocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisLocationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisLocationsRequest request) {
        ...
        @Override
        public ListHrisLocationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisLocationsResponse.Builder resBuilder =
            ...
            ListHrisLocationsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisLocationsRequest, to.unified.unified_java_sdk.models.operations.async.ListHrisLocationsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisLocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisLocationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisLocationsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisLocationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisLocationsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisLocationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisLocationsResponse res = resBuilder.build();
