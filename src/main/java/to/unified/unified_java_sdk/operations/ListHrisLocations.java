...
public class ListHrisLocations {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisLocationsRequest request) throws Exception {
        ...
        @Override
        public ListHrisLocationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<HrisLocation> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHrisLocations(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
