...
public class PatchScimGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchScimGroupsRequest, PatchScimGroupsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchScimGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchScimGroupsRequest.class, new TypeReference<PatchScimGroupsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchScimGroupsRequest request) {
        ...
        @Override
        public PatchScimGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchScimGroupsResponse.Builder resBuilder =
            ...
            PatchScimGroupsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchScimGroupsRequest, to.unified.unified_java_sdk.models.operations.async.PatchScimGroupsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchScimGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchScimGroupsRequest.class, new TypeReference<PatchScimGroupsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchScimGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchScimGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchScimGroupsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchScimGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchScimGroupsResponse res = resBuilder.build();
