...
public class UpdateAtsCompany2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAtsCompany2Request, UpdateAtsCompany2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAtsCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsCompany2Request.class, new TypeReference<UpdateAtsCompany2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsCompany2Request request) {
        ...
        @Override
        public UpdateAtsCompany2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAtsCompany2Response.Builder resBuilder =
            ...
            UpdateAtsCompany2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsCompany(Utils.unmarshal(response, new TypeReference<AtsCompany>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAtsCompany2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAtsCompany2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAtsCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsCompany2Request.class, new TypeReference<UpdateAtsCompany2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAtsCompany2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAtsCompany2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAtsCompany2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAtsCompany2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAtsCompany2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AtsCompany>() {})
                            .thenApply(res::withAtsCompany);
                } else {
