...
public class RemovePaymentLink {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemovePaymentLinkRequest, RemovePaymentLinkResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemovePaymentLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePaymentLinkRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemovePaymentLinkRequest request) throws Exception {
        ...
        @Override
        public RemovePaymentLinkResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemovePaymentLinkResponse.Builder resBuilder =
            ...
            RemovePaymentLinkResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemovePaymentLinkRequest, to.unified.unified_java_sdk.models.operations.async.RemovePaymentLinkResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemovePaymentLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePaymentLinkRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemovePaymentLinkRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemovePaymentLinkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemovePaymentLinkResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemovePaymentLinkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemovePaymentLinkResponse res = resBuilder.build();
