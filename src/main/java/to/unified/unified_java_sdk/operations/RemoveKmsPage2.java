...
public class RemoveKmsPage2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveKmsPage2Request, RemoveKmsPage2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveKmsPage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveKmsPage2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveKmsPage2Request request) {
        ...
        @Override
        public RemoveKmsPage2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveKmsPage2Response.Builder resBuilder =
            ...
            RemoveKmsPage2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveKmsPage2Request, to.unified.unified_java_sdk.models.operations.async.RemoveKmsPage2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveKmsPage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveKmsPage2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveKmsPage2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveKmsPage2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveKmsPage2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveKmsPage2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveKmsPage2Response res = resBuilder.build();
