...
public class GetCrmCompanyOperation implements RequestOperation<GetCrmCompanyRequest, GetCrmCompanyResponse> {
    ...
    public GetCrmCompanyOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetCrmCompanyRequest request) throws Exception {
