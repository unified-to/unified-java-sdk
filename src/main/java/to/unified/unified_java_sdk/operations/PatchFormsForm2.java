...
public class PatchFormsForm2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchFormsForm2Request, PatchFormsForm2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchFormsForm2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchFormsForm2Request.class, new TypeReference<PatchFormsForm2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchFormsForm2Request request) {
        ...
        @Override
        public PatchFormsForm2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchFormsForm2Response.Builder resBuilder =
            ...
            PatchFormsForm2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchFormsForm2Request, to.unified.unified_java_sdk.models.operations.async.PatchFormsForm2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchFormsForm2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchFormsForm2Request.class, new TypeReference<PatchFormsForm2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchFormsForm2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchFormsForm2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchFormsForm2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchFormsForm2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchFormsForm2Response res = resBuilder.build();
