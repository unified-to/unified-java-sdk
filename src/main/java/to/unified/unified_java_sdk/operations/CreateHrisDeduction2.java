...
public class CreateHrisDeduction2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisDeduction2Request, CreateHrisDeduction2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisDeduction2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisDeduction2Request.class, new TypeReference<CreateHrisDeduction2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisDeduction2Request request) {
        ...
        @Override
        public CreateHrisDeduction2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisDeduction2Response.Builder resBuilder =
            ...
            CreateHrisDeduction2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisDeduction2Request, to.unified.unified_java_sdk.models.operations.async.CreateHrisDeduction2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisDeduction2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisDeduction2Request.class, new TypeReference<CreateHrisDeduction2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisDeduction2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisDeduction2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisDeduction2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisDeduction2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisDeduction2Response res = resBuilder.build();
