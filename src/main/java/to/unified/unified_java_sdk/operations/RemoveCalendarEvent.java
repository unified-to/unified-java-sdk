...
public class RemoveCalendarEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCalendarEventRequest, RemoveCalendarEventResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCalendarEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCalendarEventRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCalendarEventRequest request) throws Exception {
        ...
        @Override
        public RemoveCalendarEventResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCalendarEventResponse.Builder resBuilder =
            ...
            RemoveCalendarEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCalendarEventRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCalendarEventResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCalendarEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCalendarEventRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCalendarEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCalendarEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCalendarEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCalendarEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCalendarEventResponse res = resBuilder.build();
