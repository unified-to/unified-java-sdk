...
public class PatchAdsCampaign {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAdsCampaignRequest, PatchAdsCampaignResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAdsCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsCampaignRequest.class, new TypeReference<PatchAdsCampaignRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAdsCampaignRequest request) {
        ...
        @Override
        public PatchAdsCampaignResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAdsCampaignResponse.Builder resBuilder =
            ...
            PatchAdsCampaignResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAdsCampaignRequest, to.unified.unified_java_sdk.models.operations.async.PatchAdsCampaignResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAdsCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsCampaignRequest.class, new TypeReference<PatchAdsCampaignRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAdsCampaignRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAdsCampaignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAdsCampaignResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAdsCampaignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAdsCampaignResponse res = resBuilder.build();
