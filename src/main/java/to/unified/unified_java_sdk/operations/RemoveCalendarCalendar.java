...
public class RemoveCalendarCalendar {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCalendarCalendarRequest, RemoveCalendarCalendarResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCalendarCalendarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCalendarCalendarRequest.class);
        ...
        public RemoveCalendarCalendarResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            RemoveCalendarCalendarResponse.Builder resBuilder =
            ...
            RemoveCalendarCalendarResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCalendarCalendarRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCalendarCalendarResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCalendarCalendarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCalendarCalendarRequest.class);
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCalendarCalendarResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCalendarCalendarResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCalendarCalendarResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCalendarCalendarResponse res = resBuilder.build();
