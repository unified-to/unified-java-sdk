...
public class CreateUcRecordingOperation implements RequestOperation<CreateUcRecordingRequest, CreateUcRecordingResponse> {
    ...
    public CreateUcRecordingOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateUcRecordingRequest request) throws Exception {
