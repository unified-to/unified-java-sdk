...
public class GetCrmDeal {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCrmDealRequest, GetCrmDealResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCrmDealRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmDealRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCrmDealRequest request) {
        ...
        @Override
        public GetCrmDealResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCrmDealRequest, to.unified.unified_java_sdk.models.operations.async.GetCrmDealResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCrmDealRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmDealRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCrmDealRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCrmDealResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCrmDealResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCrmDealResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCrmDealResponse res = resBuilder.build();
