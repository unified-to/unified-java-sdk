...
public class ListPaymentPayouts2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPaymentPayouts2Request, ListPaymentPayouts2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPaymentPayouts2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentPayouts2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentPayouts2Request request) {
        ...
        @Override
        public ListPaymentPayouts2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPaymentPayouts2Response.Builder resBuilder =
            ...
            ListPaymentPayouts2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentPayouts(Utils.unmarshal(response, new TypeReference<List<PaymentPayout>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentPayouts2Request, to.unified.unified_java_sdk.models.operations.async.ListPaymentPayouts2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPaymentPayouts2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentPayouts2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPaymentPayouts2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListPaymentPayouts2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListPaymentPayouts2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListPaymentPayouts2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListPaymentPayouts2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<PaymentPayout>>() {})
                            .thenApply(res::withPaymentPayouts);
                } else {
