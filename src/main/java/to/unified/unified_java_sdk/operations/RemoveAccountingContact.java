...
public class RemoveAccountingContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingContactRequest, RemoveAccountingContactResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingContactRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingContactRequest request) throws Exception {
        ...
        @Override
        public RemoveAccountingContactResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingContactResponse.Builder resBuilder =
            ...
            RemoveAccountingContactResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingContactRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingContactResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingContactRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingContactRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingContactResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingContactResponse res = resBuilder.build();
