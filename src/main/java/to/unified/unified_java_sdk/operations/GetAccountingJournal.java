...
public class GetAccountingJournal {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingJournalRequest, GetAccountingJournalResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingJournalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingJournalRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingJournalRequest request) {
        ...
        @Override
        public GetAccountingJournalResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingJournalResponse.Builder resBuilder =
            ...
            GetAccountingJournalResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingJournalRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingJournalResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingJournalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingJournalRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingJournalRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingJournalResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingJournalResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingJournalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingJournalResponse res = resBuilder.build();
