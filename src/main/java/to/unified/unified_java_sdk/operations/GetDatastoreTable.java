...
public class GetDatastoreTable {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDatastoreTableRequest, GetDatastoreTableResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDatastoreTableRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDatastoreTableRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDatastoreTableRequest request) {
        ...
        @Override
        public GetDatastoreTableResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDatastoreTableResponse.Builder resBuilder =
            ...
            GetDatastoreTableResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDatastoreTableRequest, to.unified.unified_java_sdk.models.operations.async.GetDatastoreTableResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetDatastoreTableRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDatastoreTableRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDatastoreTableRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetDatastoreTableResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetDatastoreTableResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetDatastoreTableResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetDatastoreTableResponse res = resBuilder.build();
