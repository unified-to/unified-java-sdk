...
public class RemoveRepoRepository {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveRepoRepositoryRequest, RemoveRepoRepositoryResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveRepoRepositoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoRepositoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveRepoRepositoryRequest request) {
        ...
        @Override
        public RemoveRepoRepositoryResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveRepoRepositoryRequest, to.unified.unified_java_sdk.models.operations.async.RemoveRepoRepositoryResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveRepoRepositoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoRepositoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveRepoRepositoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveRepoRepositoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveRepoRepositoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveRepoRepositoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveRepoRepositoryResponse res = resBuilder.build();
