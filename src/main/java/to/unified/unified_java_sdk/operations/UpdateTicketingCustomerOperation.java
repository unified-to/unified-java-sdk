...
public class UpdateTicketingCustomerOperation implements RequestOperation<UpdateTicketingCustomerRequest, UpdateTicketingCustomerResponse> {
    ...
    public UpdateTicketingCustomerOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateTicketingCustomerRequest request) throws Exception {
