...
public class GetTaskChange2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTaskChange2Request, GetTaskChange2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTaskChange2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskChange2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTaskChange2Request request) {
        ...
        @Override
        public GetTaskChange2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTaskChange2Response.Builder resBuilder =
            ...
            GetTaskChange2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTaskChange(Utils.unmarshal(response, new TypeReference<TaskChange>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTaskChange2Request, to.unified.unified_java_sdk.models.operations.async.GetTaskChange2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTaskChange2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskChange2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTaskChange2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetTaskChange2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetTaskChange2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetTaskChange2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetTaskChange2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TaskChange>() {})
                            .thenApply(res::withTaskChange);
                } else {
