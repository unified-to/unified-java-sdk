...
public class GetCommerceLocation {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceLocationRequest, GetCommerceLocationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommerceLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceLocationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceLocationRequest request) {
        ...
        @Override
        public GetCommerceLocationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommerceLocationResponse.Builder resBuilder =
            ...
            GetCommerceLocationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommerceLocationRequest, to.unified.unified_java_sdk.models.operations.async.GetCommerceLocationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommerceLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceLocationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommerceLocationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCommerceLocationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCommerceLocationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCommerceLocationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCommerceLocationResponse res = resBuilder.build();
