...
public class RemoveUcComment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveUcComment2Request, RemoveUcComment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveUcComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUcComment2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveUcComment2Request request) {
        ...
        @Override
        public RemoveUcComment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveUcComment2Response.Builder resBuilder =
            ...
            RemoveUcComment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveUcComment2Request, to.unified.unified_java_sdk.models.operations.async.RemoveUcComment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveUcComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUcComment2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveUcComment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveUcComment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveUcComment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveUcComment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveUcComment2Response res = resBuilder.build();
