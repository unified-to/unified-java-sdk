...
public class RemoveVerificationRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveVerificationRequestRequest, RemoveVerificationRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveVerificationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveVerificationRequestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveVerificationRequestRequest request) throws Exception {
        ...
        @Override
        public RemoveVerificationRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveVerificationRequestResponse.Builder resBuilder =
            ...
            RemoveVerificationRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveVerificationRequestRequest, to.unified.unified_java_sdk.models.operations.async.RemoveVerificationRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveVerificationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveVerificationRequestRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveVerificationRequestRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveVerificationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveVerificationRequestResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveVerificationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveVerificationRequestResponse res = resBuilder.build();
