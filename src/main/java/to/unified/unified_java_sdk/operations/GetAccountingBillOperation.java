...
public class GetAccountingBillOperation implements RequestOperation<GetAccountingBillRequest, GetAccountingBillResponse> {
    ...
    public GetAccountingBillOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountingBillRequest request) throws Exception {
