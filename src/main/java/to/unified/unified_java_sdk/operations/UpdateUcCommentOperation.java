...
public class UpdateUcCommentOperation implements RequestOperation<UpdateUcCommentRequest, UpdateUcCommentResponse> {
    ...
    public UpdateUcCommentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateUcCommentRequest request) throws Exception {
