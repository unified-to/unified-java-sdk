...
public class RemoveHrisTimeoff2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisTimeoff2Request, RemoveHrisTimeoff2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisTimeoff2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisTimeoff2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisTimeoff2Request request) {
        ...
        @Override
        public RemoveHrisTimeoff2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisTimeoff2Response.Builder resBuilder =
            ...
            RemoveHrisTimeoff2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisTimeoff2Request, to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeoff2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisTimeoff2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisTimeoff2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisTimeoff2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeoff2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeoff2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeoff2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeoff2Response res = resBuilder.build();
