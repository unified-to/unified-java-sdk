...
public class ListLmsCollections2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListLmsCollections2Request, ListLmsCollections2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListLmsCollections2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsCollections2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsCollections2Request request) {
        ...
        @Override
        public ListLmsCollections2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListLmsCollections2Response.Builder resBuilder =
            ...
            ListLmsCollections2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLmsCollections(Utils.unmarshal(response, new TypeReference<List<LmsCollection>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLmsCollections2Request, to.unified.unified_java_sdk.models.operations.async.ListLmsCollections2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListLmsCollections2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsCollections2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListLmsCollections2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListLmsCollections2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListLmsCollections2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListLmsCollections2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListLmsCollections2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<LmsCollection>>() {})
                            .thenApply(res::withLmsCollections);
                } else {
