...
public class ListAccountingCategoriesOperation implements RequestOperation<ListAccountingCategoriesRequest, ListAccountingCategoriesResponse> {
    ...
    public ListAccountingCategoriesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAccountingCategoriesRequest request) throws Exception {
        String url = Utils.generateURL(
                ListAccountingCategoriesRequest.class,
                this.baseUrl,
