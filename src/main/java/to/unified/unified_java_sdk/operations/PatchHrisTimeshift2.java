...
public class PatchHrisTimeshift2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisTimeshift2Request, PatchHrisTimeshift2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisTimeshift2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisTimeshift2Request.class, new TypeReference<PatchHrisTimeshift2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisTimeshift2Request request) {
        ...
        @Override
        public PatchHrisTimeshift2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisTimeshift2Response.Builder resBuilder =
            ...
            PatchHrisTimeshift2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisTimeshift2Request, to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeshift2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisTimeshift2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisTimeshift2Request.class, new TypeReference<PatchHrisTimeshift2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisTimeshift2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeshift2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeshift2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeshift2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeshift2Response res = resBuilder.build();
