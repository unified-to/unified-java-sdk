...
public class PatchAdsAd {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAdsAdRequest, PatchAdsAdResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAdsAdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsAdRequest.class, new TypeReference<PatchAdsAdRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAdsAdRequest request) {
        ...
        @Override
        public PatchAdsAdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAdsAdResponse.Builder resBuilder =
                    PatchAdsAdResponse
                            .builder()
            ...
            PatchAdsAdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAdsAdRequest, to.unified.unified_java_sdk.models.operations.async.PatchAdsAdResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAdsAdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsAdRequest.class, new TypeReference<PatchAdsAdRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAdsAdRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAdsAdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAdsAdResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAdsAdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAdsAdResponse res = resBuilder.build();
