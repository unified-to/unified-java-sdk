...
public class ListUcCalls2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUcCalls2Request, ListUcCalls2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListUcCalls2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListUcCalls2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUcCalls2Request request) {
        ...
        @Override
        public ListUcCalls2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUcCalls2Response.Builder resBuilder =
            ...
            ListUcCalls2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUcCalls(Utils.unmarshal(response, new TypeReference<List<UcCall>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUcCalls2Request, to.unified.unified_java_sdk.models.operations.async.ListUcCalls2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListUcCalls2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListUcCalls2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUcCalls2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListUcCalls2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListUcCalls2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListUcCalls2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListUcCalls2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<UcCall>>() {})
                            .thenApply(res::withUcCalls);
                } else {
