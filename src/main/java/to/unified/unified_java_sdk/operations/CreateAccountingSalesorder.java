...
public class CreateAccountingSalesorder {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingSalesorderRequest request) throws Exception {
        ...
        @Override
        public CreateAccountingSalesorderResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingSalesorder out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingSalesorder(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
