...
public class PatchAtsDocument2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAtsDocument2Request, PatchAtsDocument2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAtsDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsDocument2Request.class, new TypeReference<PatchAtsDocument2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAtsDocument2Request request) {
        ...
        @Override
        public PatchAtsDocument2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAtsDocument2Response.Builder resBuilder =
            ...
            PatchAtsDocument2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAtsDocument2Request, to.unified.unified_java_sdk.models.operations.async.PatchAtsDocument2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAtsDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsDocument2Request.class, new TypeReference<PatchAtsDocument2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAtsDocument2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAtsDocument2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAtsDocument2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAtsDocument2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAtsDocument2Response res = resBuilder.build();
