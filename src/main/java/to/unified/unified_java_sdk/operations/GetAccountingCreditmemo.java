...
public class GetAccountingCreditmemo {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingCreditmemoRequest, GetAccountingCreditmemoResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingCreditmemoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingCreditmemoRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingCreditmemoRequest request) {
        ...
        @Override
        public GetAccountingCreditmemoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingCreditmemoResponse.Builder resBuilder =
            ...
            GetAccountingCreditmemoResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingCreditmemoRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingCreditmemoResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingCreditmemoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingCreditmemoRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingCreditmemoRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingCreditmemoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingCreditmemoResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingCreditmemoResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingCreditmemoResponse res = resBuilder.build();
