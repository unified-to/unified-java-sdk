...
public class RemoveAccountingPurchaseorder2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingPurchaseorder2Request, RemoveAccountingPurchaseorder2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingPurchaseorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingPurchaseorder2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingPurchaseorder2Request request) {
        ...
        @Override
        public RemoveAccountingPurchaseorder2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingPurchaseorder2Response.Builder resBuilder =
            ...
            RemoveAccountingPurchaseorder2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingPurchaseorder2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingPurchaseorder2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingPurchaseorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingPurchaseorder2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingPurchaseorder2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingPurchaseorder2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingPurchaseorder2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingPurchaseorder2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingPurchaseorder2Response res = resBuilder.build();
