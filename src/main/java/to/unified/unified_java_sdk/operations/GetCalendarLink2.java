...
public class GetCalendarLink2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCalendarLink2Request, GetCalendarLink2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCalendarLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarLink2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCalendarLink2Request request) {
        ...
        @Override
        public GetCalendarLink2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCalendarLink2Response.Builder resBuilder =
            ...
            GetCalendarLink2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCalendarLink2Request, to.unified.unified_java_sdk.models.operations.async.GetCalendarLink2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCalendarLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarLink2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCalendarLink2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCalendarLink2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCalendarLink2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCalendarLink2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCalendarLink2Response res = resBuilder.build();
