...
public class GetMessagingMessage {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMessagingMessageRequest, GetMessagingMessageResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetMessagingMessageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMessagingMessageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMessagingMessageRequest request) {
        ...
        @Override
        public GetMessagingMessageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMessagingMessageResponse.Builder resBuilder =
            ...
            GetMessagingMessageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMessagingMessageRequest, to.unified.unified_java_sdk.models.operations.async.GetMessagingMessageResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMessagingMessageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMessagingMessageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMessagingMessageRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetMessagingMessageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetMessagingMessageResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetMessagingMessageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetMessagingMessageResponse res = resBuilder.build();
