...
public class GetMessagingChannel2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMessagingChannel2Request, GetMessagingChannel2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetMessagingChannel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetMessagingChannel2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMessagingChannel2Request request) {
        ...
        @Override
        public GetMessagingChannel2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMessagingChannel2Response.Builder resBuilder =
            ...
            GetMessagingChannel2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMessagingChannel2Request, to.unified.unified_java_sdk.models.operations.async.GetMessagingChannel2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMessagingChannel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetMessagingChannel2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMessagingChannel2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetMessagingChannel2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetMessagingChannel2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetMessagingChannel2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetMessagingChannel2Response res = resBuilder.build();
