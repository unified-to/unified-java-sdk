...
public class RemoveAtsCompany2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAtsCompany2Request, RemoveAtsCompany2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAtsCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsCompany2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAtsCompany2Request request) {
        ...
        @Override
        public RemoveAtsCompany2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAtsCompany2Response.Builder resBuilder =
            ...
            RemoveAtsCompany2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAtsCompany2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAtsCompany2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAtsCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsCompany2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAtsCompany2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAtsCompany2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAtsCompany2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAtsCompany2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAtsCompany2Response res = resBuilder.build();
