...
public class GetHrisEmployeeOperation implements RequestOperation<GetHrisEmployeeRequest, GetHrisEmployeeResponse> {
    ...
    public GetHrisEmployeeOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetHrisEmployeeRequest request) throws Exception {
