...
public class ListAdsPromoteds2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsPromoteds2Request, ListAdsPromoteds2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsPromoteds2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsPromoteds2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsPromoteds2Request request) {
        ...
        @Override
        public ListAdsPromoteds2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsPromoteds2Response.Builder resBuilder =
            ...
            ListAdsPromoteds2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsPromoteds2Request, to.unified.unified_java_sdk.models.operations.async.ListAdsPromoteds2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsPromoteds2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsPromoteds2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsPromoteds2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsPromoteds2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsPromoteds2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsPromoteds2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsPromoteds2Response res = resBuilder.build();
