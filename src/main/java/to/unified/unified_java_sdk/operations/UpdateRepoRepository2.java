...
public class UpdateRepoRepository2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateRepoRepository2Request, UpdateRepoRepository2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateRepoRepository2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoRepository2Request.class, new TypeReference<UpdateRepoRepository2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateRepoRepository2Request request) {
        ...
        @Override
        public UpdateRepoRepository2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateRepoRepository2Response.Builder resBuilder =
            ...
            UpdateRepoRepository2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateRepoRepository2Request, to.unified.unified_java_sdk.models.operations.async.UpdateRepoRepository2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateRepoRepository2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoRepository2Request.class, new TypeReference<UpdateRepoRepository2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateRepoRepository2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateRepoRepository2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateRepoRepository2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateRepoRepository2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateRepoRepository2Response res = resBuilder.build();
