...
public class GetLmsCourse {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLmsCourseRequest, GetLmsCourseResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLmsCourseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsCourseRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLmsCourseRequest request) {
        ...
        @Override
        public GetLmsCourseResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLmsCourseResponse.Builder resBuilder =
            ...
            GetLmsCourseResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLmsCourseRequest, to.unified.unified_java_sdk.models.operations.async.GetLmsCourseResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLmsCourseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsCourseRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLmsCourseRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetLmsCourseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetLmsCourseResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetLmsCourseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetLmsCourseResponse res = resBuilder.build();
