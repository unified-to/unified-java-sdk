...
public class CreateLmsClassOperation implements RequestOperation<CreateLmsClassRequest, CreateLmsClassResponse> {
    ...
    public CreateLmsClassOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateLmsClassRequest request) throws Exception {
