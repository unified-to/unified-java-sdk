...
public class CreateLmsInstructorOperation implements RequestOperation<CreateLmsInstructorRequest, CreateLmsInstructorResponse> {
    ...
    public CreateLmsInstructorOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateLmsInstructorRequest request) throws Exception {
