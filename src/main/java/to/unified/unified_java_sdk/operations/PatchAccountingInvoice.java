...
public class PatchAccountingInvoice {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingInvoiceRequest, PatchAccountingInvoiceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingInvoiceRequest.class, new TypeReference<PatchAccountingInvoiceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingInvoiceRequest request) {
        ...
        @Override
        public PatchAccountingInvoiceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingInvoiceResponse.Builder resBuilder =
            ...
            PatchAccountingInvoiceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingInvoiceRequest, to.unified.unified_java_sdk.models.operations.async.PatchAccountingInvoiceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingInvoiceRequest.class, new TypeReference<PatchAccountingInvoiceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingInvoiceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingInvoiceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingInvoiceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingInvoiceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingInvoiceResponse res = resBuilder.build();
