...
public class CreateRepoRepository {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateRepoRepositoryRequest, CreateRepoRepositoryResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateRepoRepositoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoRepositoryRequest.class, new TypeReference<CreateRepoRepositoryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateRepoRepositoryRequest request) {
        ...
        @Override
        public CreateRepoRepositoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateRepoRepositoryResponse.Builder resBuilder =
            ...
            CreateRepoRepositoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateRepoRepositoryRequest, to.unified.unified_java_sdk.models.operations.async.CreateRepoRepositoryResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateRepoRepositoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoRepositoryRequest.class, new TypeReference<CreateRepoRepositoryRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateRepoRepositoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateRepoRepositoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateRepoRepositoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateRepoRepositoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateRepoRepositoryResponse res = resBuilder.build();
