...
public class GetShippingCarrier {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetShippingCarrierRequest, GetShippingCarrierResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetShippingCarrierRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingCarrierRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetShippingCarrierRequest request) {
        ...
        @Override
        public GetShippingCarrierResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetShippingCarrierResponse.Builder resBuilder =
            ...
            GetShippingCarrierResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetShippingCarrierRequest, to.unified.unified_java_sdk.models.operations.async.GetShippingCarrierResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetShippingCarrierRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingCarrierRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetShippingCarrierRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetShippingCarrierResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetShippingCarrierResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetShippingCarrierResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetShippingCarrierResponse res = resBuilder.build();
