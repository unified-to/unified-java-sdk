...
public class PatchMartechMember {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchMartechMemberRequest, PatchMartechMemberResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchMartechMemberRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMartechMemberRequest.class, new TypeReference<PatchMartechMemberRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchMartechMemberRequest request) {
        ...
        @Override
        public PatchMartechMemberResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchMartechMemberResponse.Builder resBuilder =
            ...
            PatchMartechMemberResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchMartechMemberRequest, to.unified.unified_java_sdk.models.operations.async.PatchMartechMemberResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchMartechMemberRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMartechMemberRequest.class, new TypeReference<PatchMartechMemberRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchMartechMemberRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchMartechMemberResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchMartechMemberResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchMartechMemberResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchMartechMemberResponse res = resBuilder.build();
