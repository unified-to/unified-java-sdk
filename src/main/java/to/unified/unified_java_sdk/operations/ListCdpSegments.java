...
public class ListCdpSegments {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCdpSegmentsRequest, ListCdpSegmentsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCdpSegmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCdpSegmentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCdpSegmentsRequest request) {
        ...
        @Override
        public ListCdpSegmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCdpSegmentsResponse.Builder resBuilder =
            ...
            ListCdpSegmentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCdpSegments(Utils.unmarshal(response, new TypeReference<List<CdpSegment>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCdpSegmentsRequest, to.unified.unified_java_sdk.models.operations.async.ListCdpSegmentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCdpSegmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCdpSegmentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCdpSegmentsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCdpSegmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCdpSegmentsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCdpSegmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCdpSegmentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CdpSegment>>() {})
                            .thenApply(res::withCdpSegments);
                } else {
