...
public class RemoveAdsCreative {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAdsCreativeRequest, RemoveAdsCreativeResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAdsCreativeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsCreativeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAdsCreativeRequest request) {
        ...
        @Override
        public RemoveAdsCreativeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAdsCreativeResponse.Builder resBuilder =
            ...
            RemoveAdsCreativeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAdsCreativeRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAdsCreativeResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAdsCreativeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsCreativeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAdsCreativeRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAdsCreativeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAdsCreativeResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAdsCreativeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAdsCreativeResponse res = resBuilder.build();
