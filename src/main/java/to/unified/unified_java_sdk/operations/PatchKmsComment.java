...
public class PatchKmsComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchKmsCommentRequest, PatchKmsCommentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchKmsCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchKmsCommentRequest.class, new TypeReference<PatchKmsCommentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchKmsCommentRequest request) {
        ...
        @Override
        public PatchKmsCommentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchKmsCommentResponse.Builder resBuilder =
            ...
            PatchKmsCommentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchKmsCommentRequest, to.unified.unified_java_sdk.models.operations.async.PatchKmsCommentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchKmsCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchKmsCommentRequest.class, new TypeReference<PatchKmsCommentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchKmsCommentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchKmsCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchKmsCommentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchKmsCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchKmsCommentResponse res = resBuilder.build();
