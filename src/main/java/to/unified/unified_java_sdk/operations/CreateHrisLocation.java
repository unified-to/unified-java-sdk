...
public class CreateHrisLocation {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisLocationRequest, CreateHrisLocationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisLocationRequest.class, new TypeReference<CreateHrisLocationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisLocationRequest request) {
        ...
        @Override
        public CreateHrisLocationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisLocationResponse.Builder resBuilder =
            ...
            CreateHrisLocationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisLocationRequest, to.unified.unified_java_sdk.models.operations.async.CreateHrisLocationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisLocationRequest.class, new TypeReference<CreateHrisLocationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisLocationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisLocationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisLocationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisLocationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisLocationResponse res = resBuilder.build();
