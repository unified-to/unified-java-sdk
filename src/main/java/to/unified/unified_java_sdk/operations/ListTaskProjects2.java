...
public class ListTaskProjects2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTaskProjects2Request, ListTaskProjects2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListTaskProjects2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaskProjects2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTaskProjects2Request request) {
        ...
        @Override
        public ListTaskProjects2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTaskProjects2Response.Builder resBuilder =
            ...
            ListTaskProjects2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTaskProjects(Utils.unmarshal(response, new TypeReference<List<TaskProject>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTaskProjects2Request, to.unified.unified_java_sdk.models.operations.async.ListTaskProjects2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListTaskProjects2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaskProjects2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTaskProjects2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListTaskProjects2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListTaskProjects2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListTaskProjects2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListTaskProjects2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<TaskProject>>() {})
                            .thenApply(res::withTaskProjects);
                } else {
