...
public class RemoveDatastoreTable2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveDatastoreTable2Request, RemoveDatastoreTable2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveDatastoreTable2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDatastoreTable2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveDatastoreTable2Request request) {
        ...
        @Override
        public RemoveDatastoreTable2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveDatastoreTable2Response.Builder resBuilder =
            ...
            RemoveDatastoreTable2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveDatastoreTable2Request, to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreTable2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveDatastoreTable2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDatastoreTable2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveDatastoreTable2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreTable2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreTable2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreTable2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreTable2Response res = resBuilder.build();
