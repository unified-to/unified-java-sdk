...
public class PatchCrmCompany2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCrmCompany2Request, PatchCrmCompany2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCrmCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmCompany2Request.class, new TypeReference<PatchCrmCompany2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCrmCompany2Request request) {
        ...
        @Override
        public PatchCrmCompany2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCrmCompany2Response.Builder resBuilder =
            ...
            PatchCrmCompany2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCrmCompany2Request, to.unified.unified_java_sdk.models.operations.async.PatchCrmCompany2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCrmCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmCompany2Request.class, new TypeReference<PatchCrmCompany2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCrmCompany2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCrmCompany2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCrmCompany2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCrmCompany2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCrmCompany2Response res = resBuilder.build();
