...
public class UpdateAdsCampaign2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAdsCampaign2Request, UpdateAdsCampaign2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAdsCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsCampaign2Request.class, new TypeReference<UpdateAdsCampaign2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAdsCampaign2Request request) {
        ...
        @Override
        public UpdateAdsCampaign2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAdsCampaign2Response.Builder resBuilder =
            ...
            UpdateAdsCampaign2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAdsCampaign2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAdsCampaign2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAdsCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsCampaign2Request.class, new TypeReference<UpdateAdsCampaign2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAdsCampaign2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAdsCampaign2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAdsCampaign2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAdsCampaign2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAdsCampaign2Response res = resBuilder.build();
