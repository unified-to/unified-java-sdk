...
public class CreateHrisDeduction {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisDeductionRequest, CreateHrisDeductionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisDeductionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisDeductionRequest.class, new TypeReference<CreateHrisDeductionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisDeductionRequest request) {
        ...
        @Override
        public CreateHrisDeductionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisDeductionResponse.Builder resBuilder =
            ...
            CreateHrisDeductionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisDeductionRequest, to.unified.unified_java_sdk.models.operations.async.CreateHrisDeductionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisDeductionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisDeductionRequest.class, new TypeReference<CreateHrisDeductionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisDeductionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisDeductionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisDeductionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisDeductionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisDeductionResponse res = resBuilder.build();
