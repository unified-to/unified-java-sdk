...
public class GetUcRecording {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUcRecordingRequest, GetUcRecordingResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUcRecordingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUcRecordingRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUcRecordingRequest request) {
        ...
        @Override
        public GetUcRecordingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUcRecordingResponse.Builder resBuilder =
            ...
            GetUcRecordingResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUcRecordingRequest, to.unified.unified_java_sdk.models.operations.async.GetUcRecordingResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUcRecordingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUcRecordingRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUcRecordingRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetUcRecordingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetUcRecordingResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetUcRecordingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetUcRecordingResponse res = resBuilder.build();
