...
public class GetRepoBranchOperation implements RequestOperation<GetRepoBranchRequest, GetRepoBranchResponse> {
    ...
    public GetRepoBranchOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetRepoBranchRequest request) throws Exception {
