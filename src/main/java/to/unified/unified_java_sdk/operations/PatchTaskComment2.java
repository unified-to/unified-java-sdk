...
public class PatchTaskComment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchTaskComment2Request, PatchTaskComment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchTaskComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTaskComment2Request.class, new TypeReference<PatchTaskComment2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchTaskComment2Request request) {
        ...
        @Override
        public PatchTaskComment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchTaskComment2Response.Builder resBuilder =
            ...
            PatchTaskComment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchTaskComment2Request, to.unified.unified_java_sdk.models.operations.async.PatchTaskComment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchTaskComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTaskComment2Request.class, new TypeReference<PatchTaskComment2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchTaskComment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchTaskComment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchTaskComment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchTaskComment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchTaskComment2Response res = resBuilder.build();
