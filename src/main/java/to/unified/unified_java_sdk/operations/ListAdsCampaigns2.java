...
public class ListAdsCampaigns2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsCampaigns2Request, ListAdsCampaigns2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsCampaigns2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsCampaigns2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsCampaigns2Request request) {
        ...
        @Override
        public ListAdsCampaigns2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsCampaigns2Response.Builder resBuilder =
            ...
            ListAdsCampaigns2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdsCampaigns(Utils.unmarshal(response, new TypeReference<List<AdsCampaign>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsCampaigns2Request, to.unified.unified_java_sdk.models.operations.async.ListAdsCampaigns2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsCampaigns2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsCampaigns2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsCampaigns2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsCampaigns2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsCampaigns2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsCampaigns2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsCampaigns2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AdsCampaign>>() {})
                            .thenApply(res::withAdsCampaigns);
                } else {
