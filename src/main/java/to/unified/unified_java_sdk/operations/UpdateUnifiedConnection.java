...
public class UpdateUnifiedConnection {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateUnifiedConnectionRequest, UpdateUnifiedConnectionResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateUnifiedConnectionRequest request) {
        ...
        @Override
        public UpdateUnifiedConnectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateUnifiedConnectionResponse.Builder resBuilder =
            ...
            UpdateUnifiedConnectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateUnifiedConnectionRequest, to.unified.unified_java_sdk.models.operations.async.UpdateUnifiedConnectionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateUnifiedConnectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUnifiedConnectionRequest.class, new TypeReference<UpdateUnifiedConnectionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateUnifiedConnectionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateUnifiedConnectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateUnifiedConnectionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateUnifiedConnectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateUnifiedConnectionResponse res = resBuilder.build();
