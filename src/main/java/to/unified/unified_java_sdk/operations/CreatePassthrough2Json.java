...
public class CreatePassthrough2Json {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePassthrough2JsonRequest, CreatePassthrough2JsonResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreatePassthrough2JsonRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePassthrough2JsonRequest.class, new TypeReference<CreatePassthrough2JsonRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePassthrough2JsonRequest request) {
        ...
        @Override
        public CreatePassthrough2JsonResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePassthrough2JsonResponse.Builder resBuilder =
            ...
            CreatePassthrough2JsonResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePassthrough2JsonRequest, to.unified.unified_java_sdk.models.operations.async.CreatePassthrough2JsonResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreatePassthrough2JsonRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePassthrough2JsonRequest.class, new TypeReference<CreatePassthrough2JsonRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePassthrough2JsonRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreatePassthrough2JsonResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreatePassthrough2JsonResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreatePassthrough2JsonResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            to.unified.unified_java_sdk.models.operations.async.CreatePassthrough2JsonResponse res = resBuilder.build();
