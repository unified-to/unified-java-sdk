...
public class ListAdsInsertionorders2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsInsertionorders2Request, ListAdsInsertionorders2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsInsertionorders2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsInsertionorders2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsInsertionorders2Request request) {
        ...
        @Override
        public ListAdsInsertionorders2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsInsertionorders2Response.Builder resBuilder =
            ...
            ListAdsInsertionorders2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdsInsertionorders(Utils.unmarshal(response, new TypeReference<List<AdsInsertionorder>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsInsertionorders2Request, to.unified.unified_java_sdk.models.operations.async.ListAdsInsertionorders2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsInsertionorders2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsInsertionorders2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsInsertionorders2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsInsertionorders2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsInsertionorders2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsInsertionorders2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsInsertionorders2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AdsInsertionorder>>() {})
                            .thenApply(res::withAdsInsertionorders);
                } else {
