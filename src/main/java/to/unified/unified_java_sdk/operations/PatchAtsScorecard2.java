...
public class PatchAtsScorecard2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAtsScorecard2Request, PatchAtsScorecard2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAtsScorecard2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsScorecard2Request.class, new TypeReference<PatchAtsScorecard2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAtsScorecard2Request request) {
        ...
        @Override
        public PatchAtsScorecard2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAtsScorecard2Response.Builder resBuilder =
            ...
            PatchAtsScorecard2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAtsScorecard2Request, to.unified.unified_java_sdk.models.operations.async.PatchAtsScorecard2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAtsScorecard2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsScorecard2Request.class, new TypeReference<PatchAtsScorecard2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAtsScorecard2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAtsScorecard2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAtsScorecard2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAtsScorecard2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAtsScorecard2Response res = resBuilder.build();
