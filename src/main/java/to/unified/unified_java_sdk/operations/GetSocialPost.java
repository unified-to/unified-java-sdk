...
public class GetSocialPost {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSocialPostRequest, GetSocialPostResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSocialPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSocialPostRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSocialPostRequest request) {
        ...
        @Override
        public GetSocialPostResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSocialPostResponse.Builder resBuilder =
            ...
            GetSocialPostResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSocialPostRequest, to.unified.unified_java_sdk.models.operations.async.GetSocialPostResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSocialPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSocialPostRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSocialPostRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetSocialPostResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetSocialPostResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetSocialPostResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetSocialPostResponse res = resBuilder.build();
