...
public class ListHrisTimeoffs {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisTimeoffsRequest request) throws Exception {
        ...
        @Override
        public ListHrisTimeoffsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<HrisTimeoff> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHrisTimeoffs(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
