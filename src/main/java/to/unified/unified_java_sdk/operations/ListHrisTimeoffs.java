...
public class ListHrisTimeoffs {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisTimeoffsRequest, ListHrisTimeoffsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisTimeoffsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisTimeoffsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisTimeoffsRequest request) {
        ...
        @Override
        public ListHrisTimeoffsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisTimeoffsResponse.Builder resBuilder =
            ...
            ListHrisTimeoffsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisTimeoffsRequest, to.unified.unified_java_sdk.models.operations.async.ListHrisTimeoffsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisTimeoffsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisTimeoffsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisTimeoffsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisTimeoffsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisTimeoffsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisTimeoffsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisTimeoffsResponse res = resBuilder.build();
