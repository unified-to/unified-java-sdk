...
public class ListAtsDocuments {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListAtsDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsDocumentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsDocumentsRequest request) {
        ...
        @Override
        public ListAtsDocumentsResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsDocumentsRequest, to.unified.unified_java_sdk.models.operations.async.ListAtsDocumentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsDocumentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsDocumentsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsDocumentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsDocumentsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsDocumentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsDocumentsResponse res = resBuilder.build();
