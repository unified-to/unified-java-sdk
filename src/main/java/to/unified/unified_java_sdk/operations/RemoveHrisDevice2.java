...
public class RemoveHrisDevice2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisDevice2Request, RemoveHrisDevice2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisDevice2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisDevice2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisDevice2Request request) {
        ...
        @Override
        public RemoveHrisDevice2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisDevice2Response.Builder resBuilder =
            ...
            RemoveHrisDevice2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisDevice2Request, to.unified.unified_java_sdk.models.operations.async.RemoveHrisDevice2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisDevice2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisDevice2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisDevice2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisDevice2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisDevice2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisDevice2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisDevice2Response res = resBuilder.build();
