...
public class ListCrmEventsOperation implements RequestOperation<ListCrmEventsRequest, ListCrmEventsResponse> {
    ...
    public ListCrmEventsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCrmEventsRequest request) throws Exception {
