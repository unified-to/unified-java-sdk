...
public class ListAtsCompaniesOperation implements RequestOperation<ListAtsCompaniesRequest, ListAtsCompaniesResponse> {
    ...
    public ListAtsCompaniesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAtsCompaniesRequest request) throws Exception {
