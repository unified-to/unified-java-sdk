...
public class GetAccountingInvoiceOperation implements RequestOperation<GetAccountingInvoiceRequest, GetAccountingInvoiceResponse> {
    ...
    public GetAccountingInvoiceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountingInvoiceRequest request) throws Exception {
