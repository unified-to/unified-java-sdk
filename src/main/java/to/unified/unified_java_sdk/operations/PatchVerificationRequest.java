...
public class PatchVerificationRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchVerificationRequestRequest, PatchVerificationRequestResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchVerificationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchVerificationRequestRequest.class, new TypeReference<PatchVerificationRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchVerificationRequestRequest request) {
        ...
        @Override
        public PatchVerificationRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchVerificationRequestResponse.Builder resBuilder =
            ...
            PatchVerificationRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchVerificationRequestRequest, to.unified.unified_java_sdk.models.operations.async.PatchVerificationRequestResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchVerificationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchVerificationRequestRequest.class, new TypeReference<PatchVerificationRequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchVerificationRequestRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchVerificationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchVerificationRequestResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchVerificationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchVerificationRequestResponse res = resBuilder.build();
