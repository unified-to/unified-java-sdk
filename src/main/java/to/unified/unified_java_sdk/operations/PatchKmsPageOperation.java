...
public class PatchKmsPageOperation implements RequestOperation<PatchKmsPageRequest, PatchKmsPageResponse> {
    ...
    public PatchKmsPageOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchKmsPageRequest request) throws Exception {
