...
public class RemoveLmsContent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveLmsContent2Request, RemoveLmsContent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveLmsContent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsContent2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveLmsContent2Request request) {
        ...
        @Override
        public RemoveLmsContent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveLmsContent2Response.Builder resBuilder =
            ...
            RemoveLmsContent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveLmsContent2Request, to.unified.unified_java_sdk.models.operations.async.RemoveLmsContent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveLmsContent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsContent2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveLmsContent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveLmsContent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveLmsContent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveLmsContent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveLmsContent2Response res = resBuilder.build();
