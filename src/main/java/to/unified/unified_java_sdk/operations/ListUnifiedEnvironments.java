...
public class ListUnifiedEnvironments {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<ListUnifiedEnvironmentsResponse> {
        ...
        @Override
        public ListUnifiedEnvironmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUnifiedEnvironmentsResponse.Builder resBuilder =
            ...
            ListUnifiedEnvironmentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<to.unified.unified_java_sdk.models.operations.async.ListUnifiedEnvironmentsResponse> {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListUnifiedEnvironmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListUnifiedEnvironmentsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListUnifiedEnvironmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListUnifiedEnvironmentsResponse res = resBuilder.build();
