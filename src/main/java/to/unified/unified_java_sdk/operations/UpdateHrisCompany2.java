...
public class UpdateHrisCompany2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisCompany2Request, UpdateHrisCompany2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisCompany2Request.class, new TypeReference<UpdateHrisCompany2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisCompany2Request request) {
        ...
        @Override
        public UpdateHrisCompany2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisCompany2Response.Builder resBuilder =
            ...
            UpdateHrisCompany2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisCompany(Utils.unmarshal(response, new TypeReference<HrisCompany>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisCompany2Request, to.unified.unified_java_sdk.models.operations.async.UpdateHrisCompany2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisCompany2Request.class, new TypeReference<UpdateHrisCompany2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisCompany2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisCompany2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisCompany2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisCompany2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisCompany2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HrisCompany>() {})
                            .thenApply(res::withHrisCompany);
                } else {
