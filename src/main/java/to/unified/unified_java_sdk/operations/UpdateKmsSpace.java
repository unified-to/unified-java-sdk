...
public class UpdateKmsSpace {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateKmsSpaceRequest, UpdateKmsSpaceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateKmsSpaceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateKmsSpaceRequest.class, new TypeReference<UpdateKmsSpaceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateKmsSpaceRequest request) {
        ...
        @Override
        public UpdateKmsSpaceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateKmsSpaceResponse.Builder resBuilder =
            ...
            UpdateKmsSpaceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateKmsSpaceRequest, to.unified.unified_java_sdk.models.operations.async.UpdateKmsSpaceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateKmsSpaceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateKmsSpaceRequest.class, new TypeReference<UpdateKmsSpaceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateKmsSpaceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateKmsSpaceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateKmsSpaceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateKmsSpaceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateKmsSpaceResponse res = resBuilder.build();
