...
public class UpdateKmsSpace {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateKmsSpaceRequest request) throws Exception {
        ...
        @Override
        public UpdateKmsSpaceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    KmsSpace out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withKmsSpace(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
