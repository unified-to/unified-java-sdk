...
public class ListMessagingChannels {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMessagingChannelsRequest, ListMessagingChannelsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListMessagingChannelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMessagingChannelsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMessagingChannelsRequest request) {
        ...
        @Override
        public ListMessagingChannelsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMessagingChannelsResponse.Builder resBuilder =
            ...
            ListMessagingChannelsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMessagingChannelsRequest, to.unified.unified_java_sdk.models.operations.async.ListMessagingChannelsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMessagingChannelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMessagingChannelsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMessagingChannelsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListMessagingChannelsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListMessagingChannelsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListMessagingChannelsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListMessagingChannelsResponse res = resBuilder.build();
