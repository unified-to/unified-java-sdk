...
public class ListFormsForms2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListFormsForms2Request, ListFormsForms2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListFormsForms2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListFormsForms2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListFormsForms2Request request) {
        ...
        @Override
        public ListFormsForms2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListFormsForms2Response.Builder resBuilder =
            ...
            ListFormsForms2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFormsForms(Utils.unmarshal(response, new TypeReference<List<FormsForm>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListFormsForms2Request, to.unified.unified_java_sdk.models.operations.async.ListFormsForms2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListFormsForms2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListFormsForms2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListFormsForms2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListFormsForms2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListFormsForms2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListFormsForms2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListFormsForms2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<FormsForm>>() {})
                            .thenApply(res::withFormsForms);
                } else {
