...
public class RemoveAccountingCreditmemo {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingCreditmemoRequest, RemoveAccountingCreditmemoResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingCreditmemoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingCreditmemoRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingCreditmemoRequest request) throws Exception {
        ...
        @Override
        public RemoveAccountingCreditmemoResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingCreditmemoResponse.Builder resBuilder =
            ...
            RemoveAccountingCreditmemoResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingCreditmemoRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingCreditmemoResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingCreditmemoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingCreditmemoRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingCreditmemoRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingCreditmemoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingCreditmemoResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingCreditmemoResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingCreditmemoResponse res = resBuilder.build();
