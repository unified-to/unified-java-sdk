...
public class PatchAccountingBankfeedaccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingBankfeedaccountRequest, PatchAccountingBankfeedaccountResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingBankfeedaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingBankfeedaccountRequest.class, new TypeReference<PatchAccountingBankfeedaccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingBankfeedaccountRequest request) {
        ...
        @Override
        public PatchAccountingBankfeedaccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingBankfeedaccountResponse.Builder resBuilder =
                    PatchAccountingBankfeedaccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            PatchAccountingBankfeedaccountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingBankfeedaccountRequest, to.unified.unified_java_sdk.models.operations.async.PatchAccountingBankfeedaccountResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingBankfeedaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingBankfeedaccountRequest.class, new TypeReference<PatchAccountingBankfeedaccountRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingBankfeedaccountRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingBankfeedaccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingBankfeedaccountResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingBankfeedaccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingBankfeedaccountResponse res = resBuilder.build();
