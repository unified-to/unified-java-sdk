...
public class UpdateCdpActivation {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCdpActivationRequest, UpdateCdpActivationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCdpActivationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCdpActivationRequest.class, new TypeReference<UpdateCdpActivationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCdpActivationRequest request) {
        ...
        @Override
        public UpdateCdpActivationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCdpActivationResponse.Builder resBuilder =
            ...
            UpdateCdpActivationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCdpActivation(Utils.unmarshal(response, new TypeReference<CdpActivation>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCdpActivationRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCdpActivationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCdpActivationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCdpActivationRequest.class, new TypeReference<UpdateCdpActivationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCdpActivationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCdpActivationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCdpActivationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCdpActivationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCdpActivationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CdpActivation>() {})
                            .thenApply(res::withCdpActivation);
                } else {
