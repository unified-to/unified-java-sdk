...
public class ListMartechCampaigns {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMartechCampaignsRequest, ListMartechCampaignsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListMartechCampaignsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMartechCampaignsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMartechCampaignsRequest request) {
        ...
        @Override
        public ListMartechCampaignsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMartechCampaignsResponse.Builder resBuilder =
            ...
            ListMartechCampaignsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMartechCampaignsRequest, to.unified.unified_java_sdk.models.operations.async.ListMartechCampaignsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMartechCampaignsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMartechCampaignsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMartechCampaignsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListMartechCampaignsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListMartechCampaignsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListMartechCampaignsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListMartechCampaignsResponse res = resBuilder.build();
