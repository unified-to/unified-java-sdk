...
public class CreateHrisBenefit2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisBenefit2Request, CreateHrisBenefit2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisBenefit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisBenefit2Request.class, new TypeReference<CreateHrisBenefit2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisBenefit2Request request) {
        ...
        @Override
        public CreateHrisBenefit2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisBenefit2Response.Builder resBuilder =
            ...
            CreateHrisBenefit2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisBenefit2Request, to.unified.unified_java_sdk.models.operations.async.CreateHrisBenefit2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisBenefit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisBenefit2Request.class, new TypeReference<CreateHrisBenefit2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisBenefit2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisBenefit2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisBenefit2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisBenefit2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisBenefit2Response res = resBuilder.build();
