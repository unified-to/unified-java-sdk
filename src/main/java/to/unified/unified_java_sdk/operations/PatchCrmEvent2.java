...
public class PatchCrmEvent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCrmEvent2Request, PatchCrmEvent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCrmEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmEvent2Request.class, new TypeReference<PatchCrmEvent2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCrmEvent2Request request) {
        ...
        @Override
        public PatchCrmEvent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCrmEvent2Response.Builder resBuilder =
            ...
            PatchCrmEvent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCrmEvent2Request, to.unified.unified_java_sdk.models.operations.async.PatchCrmEvent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCrmEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmEvent2Request.class, new TypeReference<PatchCrmEvent2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCrmEvent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCrmEvent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCrmEvent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCrmEvent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCrmEvent2Response res = resBuilder.build();
