...
public class GetHrisTimeoffOperation implements RequestOperation<GetHrisTimeoffRequest, GetHrisTimeoffResponse> {
    ...
    public GetHrisTimeoffOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetHrisTimeoffRequest request) throws Exception {
