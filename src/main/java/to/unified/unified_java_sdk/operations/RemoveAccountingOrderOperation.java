...
public class RemoveAccountingOrderOperation implements RequestOperation<RemoveAccountingOrderRequest, RemoveAccountingOrderResponse> {
    ...
    public RemoveAccountingOrderOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAccountingOrderRequest request) throws Exception {
