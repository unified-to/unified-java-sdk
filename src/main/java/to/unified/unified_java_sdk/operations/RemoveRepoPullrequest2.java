...
public class RemoveRepoPullrequest2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveRepoPullrequest2Request, RemoveRepoPullrequest2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveRepoPullrequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoPullrequest2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveRepoPullrequest2Request request) {
        ...
        @Override
        public RemoveRepoPullrequest2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveRepoPullrequest2Response.Builder resBuilder =
            ...
            RemoveRepoPullrequest2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveRepoPullrequest2Request, to.unified.unified_java_sdk.models.operations.async.RemoveRepoPullrequest2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveRepoPullrequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoPullrequest2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveRepoPullrequest2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveRepoPullrequest2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveRepoPullrequest2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveRepoPullrequest2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveRepoPullrequest2Response res = resBuilder.build();
