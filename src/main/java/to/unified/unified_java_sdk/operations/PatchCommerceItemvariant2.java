...
public class PatchCommerceItemvariant2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCommerceItemvariant2Request, PatchCommerceItemvariant2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCommerceItemvariant2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceItemvariant2Request.class, new TypeReference<PatchCommerceItemvariant2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCommerceItemvariant2Request request) {
        ...
        @Override
        public PatchCommerceItemvariant2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCommerceItemvariant2Response.Builder resBuilder =
            ...
            PatchCommerceItemvariant2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCommerceItemvariant2Request, to.unified.unified_java_sdk.models.operations.async.PatchCommerceItemvariant2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCommerceItemvariant2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceItemvariant2Request.class, new TypeReference<PatchCommerceItemvariant2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCommerceItemvariant2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCommerceItemvariant2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCommerceItemvariant2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCommerceItemvariant2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCommerceItemvariant2Response res = resBuilder.build();
