...
public class CreateCommerceReviewOperation implements RequestOperation<CreateCommerceReviewRequest, CreateCommerceReviewResponse> {
    ...
    public CreateCommerceReviewOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateCommerceReviewRequest request) throws Exception {
