...
public class RemoveAnalyticsProperty {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAnalyticsPropertyRequest, RemoveAnalyticsPropertyResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAnalyticsPropertyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAnalyticsPropertyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAnalyticsPropertyRequest request) {
        ...
        @Override
        public RemoveAnalyticsPropertyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAnalyticsPropertyResponse.Builder resBuilder =
            ...
            RemoveAnalyticsPropertyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAnalyticsPropertyRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsPropertyResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAnalyticsPropertyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAnalyticsPropertyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAnalyticsPropertyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsPropertyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsPropertyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsPropertyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsPropertyResponse res = resBuilder.build();
