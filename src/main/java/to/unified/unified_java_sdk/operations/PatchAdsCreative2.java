...
public class PatchAdsCreative2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAdsCreative2Request, PatchAdsCreative2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAdsCreative2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsCreative2Request.class, new TypeReference<PatchAdsCreative2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAdsCreative2Request request) {
        ...
        @Override
        public PatchAdsCreative2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAdsCreative2Response.Builder resBuilder =
            ...
            PatchAdsCreative2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAdsCreative2Request, to.unified.unified_java_sdk.models.operations.async.PatchAdsCreative2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAdsCreative2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsCreative2Request.class, new TypeReference<PatchAdsCreative2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAdsCreative2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAdsCreative2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAdsCreative2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAdsCreative2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAdsCreative2Response res = resBuilder.build();
