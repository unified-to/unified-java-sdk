...
public class RemoveHrisCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisCompanyRequest, RemoveHrisCompanyResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisCompanyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisCompanyRequest request) throws Exception {
        ...
        @Override
        public RemoveHrisCompanyResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisCompanyResponse.Builder resBuilder =
            ...
            RemoveHrisCompanyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisCompanyRequest, to.unified.unified_java_sdk.models.operations.async.RemoveHrisCompanyResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisCompanyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisCompanyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisCompanyResponse res = resBuilder.build();
