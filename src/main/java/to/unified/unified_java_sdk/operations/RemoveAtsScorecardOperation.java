...
public class RemoveAtsScorecardOperation implements RequestOperation<RemoveAtsScorecardRequest, RemoveAtsScorecardResponse> {
    ...
    public RemoveAtsScorecardOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAtsScorecardRequest request) throws Exception {
