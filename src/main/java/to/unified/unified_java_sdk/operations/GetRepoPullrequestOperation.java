...
public class GetRepoPullrequestOperation implements RequestOperation<GetRepoPullrequestRequest, GetRepoPullrequestResponse> {
    ...
    public GetRepoPullrequestOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetRepoPullrequestRequest request) throws Exception {
