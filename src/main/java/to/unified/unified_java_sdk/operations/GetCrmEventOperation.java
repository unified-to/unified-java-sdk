...
public class GetCrmEventOperation implements RequestOperation<GetCrmEventRequest, GetCrmEventResponse> {
    ...
    public GetCrmEventOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetCrmEventRequest request) throws Exception {
