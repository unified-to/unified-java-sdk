...
public class RemoveCalendarEventOperation implements RequestOperation<RemoveCalendarEventRequest, RemoveCalendarEventResponse> {
    ...
    public RemoveCalendarEventOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveCalendarEventRequest request) throws Exception {
