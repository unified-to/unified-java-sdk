...
public class RemoveMessagingMessage {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveMessagingMessageRequest, RemoveMessagingMessageResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveMessagingMessageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMessagingMessageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveMessagingMessageRequest request) throws Exception {
        ...
        @Override
        public RemoveMessagingMessageResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveMessagingMessageResponse.Builder resBuilder =
            ...
            RemoveMessagingMessageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveMessagingMessageRequest, to.unified.unified_java_sdk.models.operations.async.RemoveMessagingMessageResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveMessagingMessageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMessagingMessageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveMessagingMessageRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveMessagingMessageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveMessagingMessageResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveMessagingMessageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveMessagingMessageResponse res = resBuilder.build();
