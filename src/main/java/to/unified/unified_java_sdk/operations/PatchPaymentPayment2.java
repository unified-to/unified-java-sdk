...
public class PatchPaymentPayment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchPaymentPayment2Request, PatchPaymentPayment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchPaymentPayment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPaymentPayment2Request.class, new TypeReference<PatchPaymentPayment2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchPaymentPayment2Request request) {
        ...
        @Override
        public PatchPaymentPayment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchPaymentPayment2Response.Builder resBuilder =
            ...
            PatchPaymentPayment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchPaymentPayment2Request, to.unified.unified_java_sdk.models.operations.async.PatchPaymentPayment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchPaymentPayment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPaymentPayment2Request.class, new TypeReference<PatchPaymentPayment2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchPaymentPayment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchPaymentPayment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchPaymentPayment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchPaymentPayment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchPaymentPayment2Response res = resBuilder.build();
