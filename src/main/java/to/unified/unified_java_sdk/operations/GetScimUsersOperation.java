...
public class GetScimUsersOperation implements RequestOperation<GetScimUsersRequest, GetScimUsersResponse> {
    ...
    public GetScimUsersOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetScimUsersRequest request) throws Exception {
