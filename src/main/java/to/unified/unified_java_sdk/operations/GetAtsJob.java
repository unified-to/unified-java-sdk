...
public class GetAtsJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAtsJobRequest, GetAtsJobResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAtsJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsJobRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAtsJobRequest request) {
        ...
        @Override
        public GetAtsJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAtsJobResponse.Builder resBuilder =
                    GetAtsJobResponse
                            .builder()
            ...
            GetAtsJobResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAtsJobRequest, to.unified.unified_java_sdk.models.operations.async.GetAtsJobResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAtsJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsJobRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAtsJobRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAtsJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAtsJobResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAtsJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAtsJobResponse res = resBuilder.build();
