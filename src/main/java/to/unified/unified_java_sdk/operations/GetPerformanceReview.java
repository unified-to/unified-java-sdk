...
public class GetPerformanceReview {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPerformanceReviewRequest, GetPerformanceReviewResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPerformanceReviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPerformanceReviewRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPerformanceReviewRequest request) {
        ...
        @Override
        public GetPerformanceReviewResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPerformanceReviewResponse.Builder resBuilder =
            ...
            GetPerformanceReviewResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPerformanceReview(Utils.unmarshal(response, new TypeReference<PerformanceReview>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPerformanceReviewRequest, to.unified.unified_java_sdk.models.operations.async.GetPerformanceReviewResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPerformanceReviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPerformanceReviewRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPerformanceReviewRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetPerformanceReviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetPerformanceReviewResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetPerformanceReviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetPerformanceReviewResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PerformanceReview>() {})
                            .thenApply(res::withPerformanceReview);
                } else {
