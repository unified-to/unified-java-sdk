...
public class PatchCommerceItemOperation implements RequestOperation<PatchCommerceItemRequest, PatchCommerceItemResponse> {
    ...
    public PatchCommerceItemOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchCommerceItemRequest request) throws Exception {
