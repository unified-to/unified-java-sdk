...
public class ListUnifiedIntegrationWorkspaces {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUnifiedIntegrationWorkspacesRequest, ListUnifiedIntegrationWorkspacesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListUnifiedIntegrationWorkspacesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUnifiedIntegrationWorkspacesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUnifiedIntegrationWorkspacesRequest request) {
        ...
        @Override
        public ListUnifiedIntegrationWorkspacesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUnifiedIntegrationWorkspacesResponse.Builder resBuilder =
            ...
            ListUnifiedIntegrationWorkspacesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withIntegrations(Utils.unmarshal(response, new TypeReference<List<Integration>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUnifiedIntegrationWorkspacesRequest, to.unified.unified_java_sdk.models.operations.async.ListUnifiedIntegrationWorkspacesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListUnifiedIntegrationWorkspacesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUnifiedIntegrationWorkspacesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUnifiedIntegrationWorkspacesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListUnifiedIntegrationWorkspacesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListUnifiedIntegrationWorkspacesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListUnifiedIntegrationWorkspacesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListUnifiedIntegrationWorkspacesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<Integration>>() {})
                            .thenApply(res::withIntegrations);
                } else {
