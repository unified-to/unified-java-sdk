...
public class ListUnifiedIntegrationWorkspaces {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUnifiedIntegrationWorkspacesRequest request) throws Exception {
        ...
        @Override
        public ListUnifiedIntegrationWorkspacesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Integration> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withIntegrations(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
