...
public class ListAccountingInvoicesOperation implements RequestOperation<ListAccountingInvoicesRequest, ListAccountingInvoicesResponse> {
    ...
    public ListAccountingInvoicesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAccountingInvoicesRequest request) throws Exception {
