...
public class CreateAtsCompany2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAtsCompany2Request, CreateAtsCompany2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAtsCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsCompany2Request.class, new TypeReference<CreateAtsCompany2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsCompany2Request request) {
        ...
        @Override
        public CreateAtsCompany2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAtsCompany2Response.Builder resBuilder =
            ...
            CreateAtsCompany2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAtsCompany2Request, to.unified.unified_java_sdk.models.operations.async.CreateAtsCompany2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAtsCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsCompany2Request.class, new TypeReference<CreateAtsCompany2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAtsCompany2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAtsCompany2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAtsCompany2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAtsCompany2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAtsCompany2Response res = resBuilder.build();
