...
public class ListClubsEvents {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListClubsEventsRequest, ListClubsEventsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListClubsEventsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsEventsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListClubsEventsRequest request) {
        ...
        @Override
        public ListClubsEventsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListClubsEventsResponse.Builder resBuilder =
            ...
            ListClubsEventsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListClubsEventsRequest, to.unified.unified_java_sdk.models.operations.async.ListClubsEventsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListClubsEventsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsEventsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListClubsEventsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListClubsEventsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListClubsEventsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListClubsEventsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListClubsEventsResponse res = resBuilder.build();
