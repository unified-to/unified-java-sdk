...
public class UpdateTicketingNote {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTicketingNoteRequest, UpdateTicketingNoteResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTicketingNoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketingNoteRequest.class, new TypeReference<UpdateTicketingNoteRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTicketingNoteRequest request) {
        ...
        @Override
        public UpdateTicketingNoteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTicketingNoteResponse.Builder resBuilder =
            ...
            UpdateTicketingNoteResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateTicketingNoteRequest, to.unified.unified_java_sdk.models.operations.async.UpdateTicketingNoteResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateTicketingNoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketingNoteRequest.class, new TypeReference<UpdateTicketingNoteRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateTicketingNoteRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateTicketingNoteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateTicketingNoteResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateTicketingNoteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateTicketingNoteResponse res = resBuilder.build();
