...
public class ListHrisLocationsOperation implements RequestOperation<ListHrisLocationsRequest, ListHrisLocationsResponse> {
    ...
    public ListHrisLocationsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListHrisLocationsRequest request) throws Exception {
