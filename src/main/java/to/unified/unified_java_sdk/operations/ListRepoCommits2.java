...
public class ListRepoCommits2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRepoCommits2Request, ListRepoCommits2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListRepoCommits2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoCommits2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRepoCommits2Request request) {
        ...
        @Override
        public ListRepoCommits2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListRepoCommits2Response.Builder resBuilder =
            ...
            ListRepoCommits2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRepoCommits(Utils.unmarshal(response, new TypeReference<List<RepoCommit>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListRepoCommits2Request, to.unified.unified_java_sdk.models.operations.async.ListRepoCommits2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListRepoCommits2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoCommits2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRepoCommits2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListRepoCommits2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListRepoCommits2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListRepoCommits2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListRepoCommits2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<RepoCommit>>() {})
                            .thenApply(res::withRepoCommits);
                } else {
