...
public class RemoveAccountingTransactionOperation implements RequestOperation<RemoveAccountingTransactionRequest, RemoveAccountingTransactionResponse> {
    ...
    public RemoveAccountingTransactionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAccountingTransactionRequest request) throws Exception {
