...
public class ListAtsActivities {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsActivitiesRequest request) throws Exception {
        ...
        @Override
        public ListAtsActivitiesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AtsActivity> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAtsActivities(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
