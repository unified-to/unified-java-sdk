...
public class ListAtsActivities {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAtsActivitiesRequest, ListAtsActivitiesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAtsActivitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsActivitiesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsActivitiesRequest request) {
        ...
        @Override
        public ListAtsActivitiesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsActivitiesResponse.Builder resBuilder =
            ...
            ListAtsActivitiesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsActivitiesRequest, to.unified.unified_java_sdk.models.operations.async.ListAtsActivitiesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsActivitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsActivitiesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsActivitiesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsActivitiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsActivitiesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsActivitiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsActivitiesResponse res = resBuilder.build();
