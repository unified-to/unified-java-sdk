...
public class GetAccountingAccountOperation implements RequestOperation<GetAccountingAccountRequest, GetAccountingAccountResponse> {
    ...
    public GetAccountingAccountOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountingAccountRequest request) throws Exception {
