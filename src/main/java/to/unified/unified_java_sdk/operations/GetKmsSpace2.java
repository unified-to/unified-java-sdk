...
public class GetKmsSpace2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetKmsSpace2Request, GetKmsSpace2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetKmsSpace2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetKmsSpace2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetKmsSpace2Request request) {
        ...
        @Override
        public GetKmsSpace2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetKmsSpace2Response.Builder resBuilder =
            ...
            GetKmsSpace2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetKmsSpace2Request, to.unified.unified_java_sdk.models.operations.async.GetKmsSpace2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetKmsSpace2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetKmsSpace2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetKmsSpace2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetKmsSpace2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetKmsSpace2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetKmsSpace2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetKmsSpace2Response res = resBuilder.build();
