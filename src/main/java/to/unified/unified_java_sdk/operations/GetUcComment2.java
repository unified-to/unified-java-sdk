...
public class GetUcComment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUcComment2Request, GetUcComment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUcComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetUcComment2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUcComment2Request request) {
        ...
        @Override
        public GetUcComment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUcComment2Response.Builder resBuilder =
            ...
            GetUcComment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUcComment2Request, to.unified.unified_java_sdk.models.operations.async.GetUcComment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUcComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetUcComment2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUcComment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetUcComment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetUcComment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetUcComment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetUcComment2Response res = resBuilder.build();
