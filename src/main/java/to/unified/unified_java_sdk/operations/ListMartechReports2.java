...
public class ListMartechReports2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMartechReports2Request, ListMartechReports2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListMartechReports2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListMartechReports2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMartechReports2Request request) {
        ...
        @Override
        public ListMartechReports2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMartechReports2Response.Builder resBuilder =
            ...
            ListMartechReports2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMarketingReports(Utils.unmarshal(response, new TypeReference<List<MarketingReport>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMartechReports2Request, to.unified.unified_java_sdk.models.operations.async.ListMartechReports2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMartechReports2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListMartechReports2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMartechReports2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListMartechReports2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListMartechReports2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListMartechReports2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListMartechReports2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<MarketingReport>>() {})
                            .thenApply(res::withMarketingReports);
                } else {
