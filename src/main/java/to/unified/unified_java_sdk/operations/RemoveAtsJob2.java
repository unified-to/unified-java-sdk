...
public class RemoveAtsJob2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAtsJob2Request, RemoveAtsJob2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAtsJob2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsJob2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAtsJob2Request request) {
        ...
        @Override
        public RemoveAtsJob2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAtsJob2Response.Builder resBuilder =
            ...
            RemoveAtsJob2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAtsJob2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAtsJob2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAtsJob2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsJob2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAtsJob2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAtsJob2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAtsJob2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAtsJob2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAtsJob2Response res = resBuilder.build();
