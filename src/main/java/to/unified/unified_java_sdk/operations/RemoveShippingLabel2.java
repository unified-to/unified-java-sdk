...
public class RemoveShippingLabel2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveShippingLabel2Request, RemoveShippingLabel2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveShippingLabel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveShippingLabel2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveShippingLabel2Request request) {
        ...
        @Override
        public RemoveShippingLabel2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveShippingLabel2Response.Builder resBuilder =
            ...
            RemoveShippingLabel2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveShippingLabel2Request, to.unified.unified_java_sdk.models.operations.async.RemoveShippingLabel2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveShippingLabel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveShippingLabel2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveShippingLabel2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveShippingLabel2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveShippingLabel2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveShippingLabel2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveShippingLabel2Response res = resBuilder.build();
