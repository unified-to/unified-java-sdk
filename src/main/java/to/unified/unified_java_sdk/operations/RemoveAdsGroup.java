...
public class RemoveAdsGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAdsGroupRequest, RemoveAdsGroupResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAdsGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAdsGroupRequest request) {
        ...
        @Override
        public RemoveAdsGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAdsGroupResponse.Builder resBuilder =
            ...
            RemoveAdsGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAdsGroupRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAdsGroupResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAdsGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAdsGroupRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAdsGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAdsGroupResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAdsGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAdsGroupResponse res = resBuilder.build();
