...
public class ListTicketingNotes2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTicketingNotes2Request, ListTicketingNotes2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListTicketingNotes2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListTicketingNotes2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTicketingNotes2Request request) {
        ...
        @Override
        public ListTicketingNotes2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTicketingNotes2Response.Builder resBuilder =
            ...
            ListTicketingNotes2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingNotes(Utils.unmarshal(response, new TypeReference<List<TicketingNote>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTicketingNotes2Request, to.unified.unified_java_sdk.models.operations.async.ListTicketingNotes2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListTicketingNotes2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListTicketingNotes2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTicketingNotes2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListTicketingNotes2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListTicketingNotes2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListTicketingNotes2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListTicketingNotes2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<TicketingNote>>() {})
                            .thenApply(res::withTicketingNotes);
                } else {
