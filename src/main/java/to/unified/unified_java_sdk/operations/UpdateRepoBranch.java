...
public class UpdateRepoBranch {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateRepoBranchRequest, UpdateRepoBranchResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateRepoBranchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoBranchRequest.class, new TypeReference<UpdateRepoBranchRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateRepoBranchRequest request) {
        ...
        @Override
        public UpdateRepoBranchResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateRepoBranchResponse.Builder resBuilder =
            ...
            UpdateRepoBranchResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateRepoBranchRequest, to.unified.unified_java_sdk.models.operations.async.UpdateRepoBranchResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateRepoBranchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoBranchRequest.class, new TypeReference<UpdateRepoBranchRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateRepoBranchRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateRepoBranchResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateRepoBranchResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateRepoBranchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateRepoBranchResponse res = resBuilder.build();
