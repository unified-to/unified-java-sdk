...
public class PatchAccountingInvoiceOperation implements RequestOperation<PatchAccountingInvoiceRequest, PatchAccountingInvoiceResponse> {
    ...
    public PatchAccountingInvoiceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchAccountingInvoiceRequest request) throws Exception {
