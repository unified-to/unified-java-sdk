...
public class GetAccountingBill2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingBill2Request, GetAccountingBill2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingBill2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingBill2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingBill2Request request) {
        ...
        @Override
        public GetAccountingBill2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingBill2Response.Builder resBuilder =
            ...
            GetAccountingBill2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingBill2Request, to.unified.unified_java_sdk.models.operations.async.GetAccountingBill2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingBill2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingBill2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingBill2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingBill2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingBill2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingBill2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingBill2Response res = resBuilder.build();
