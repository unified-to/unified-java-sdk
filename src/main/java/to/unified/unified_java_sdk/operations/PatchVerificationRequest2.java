...
public class PatchVerificationRequest2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchVerificationRequest2Request, PatchVerificationRequest2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchVerificationRequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchVerificationRequest2Request.class, new TypeReference<PatchVerificationRequest2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchVerificationRequest2Request request) {
        ...
        @Override
        public PatchVerificationRequest2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchVerificationRequest2Response.Builder resBuilder =
            ...
            PatchVerificationRequest2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchVerificationRequest2Request, to.unified.unified_java_sdk.models.operations.async.PatchVerificationRequest2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchVerificationRequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchVerificationRequest2Request.class, new TypeReference<PatchVerificationRequest2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchVerificationRequest2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchVerificationRequest2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchVerificationRequest2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchVerificationRequest2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchVerificationRequest2Response res = resBuilder.build();
