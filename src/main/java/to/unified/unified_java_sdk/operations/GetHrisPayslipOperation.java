...
public class GetHrisPayslipOperation implements RequestOperation<GetHrisPayslipRequest, GetHrisPayslipResponse> {
    ...
    public GetHrisPayslipOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetHrisPayslipRequest request) throws Exception {
