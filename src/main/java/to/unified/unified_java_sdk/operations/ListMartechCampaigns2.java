...
public class ListMartechCampaigns2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMartechCampaigns2Request, ListMartechCampaigns2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListMartechCampaigns2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListMartechCampaigns2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMartechCampaigns2Request request) {
        ...
        @Override
        public ListMartechCampaigns2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMartechCampaigns2Response.Builder resBuilder =
            ...
            ListMartechCampaigns2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMarketingCampaigns(Utils.unmarshal(response, new TypeReference<List<MarketingCampaign>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMartechCampaigns2Request, to.unified.unified_java_sdk.models.operations.async.ListMartechCampaigns2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMartechCampaigns2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListMartechCampaigns2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMartechCampaigns2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListMartechCampaigns2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListMartechCampaigns2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListMartechCampaigns2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListMartechCampaigns2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<MarketingCampaign>>() {})
                            .thenApply(res::withMarketingCampaigns);
                } else {
