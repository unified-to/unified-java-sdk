...
public class RemoveHrisBenefit2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisBenefit2Request, RemoveHrisBenefit2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisBenefit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisBenefit2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisBenefit2Request request) {
        ...
        @Override
        public RemoveHrisBenefit2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisBenefit2Response.Builder resBuilder =
            ...
            RemoveHrisBenefit2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisBenefit2Request, to.unified.unified_java_sdk.models.operations.async.RemoveHrisBenefit2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisBenefit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisBenefit2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisBenefit2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisBenefit2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisBenefit2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisBenefit2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisBenefit2Response res = resBuilder.build();
