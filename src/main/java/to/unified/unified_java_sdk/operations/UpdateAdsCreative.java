...
public class UpdateAdsCreative {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAdsCreativeRequest, UpdateAdsCreativeResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAdsCreativeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsCreativeRequest.class, new TypeReference<UpdateAdsCreativeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAdsCreativeRequest request) {
        ...
        @Override
        public UpdateAdsCreativeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAdsCreativeResponse.Builder resBuilder =
            ...
            UpdateAdsCreativeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAdsCreativeRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAdsCreativeResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAdsCreativeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsCreativeRequest.class, new TypeReference<UpdateAdsCreativeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAdsCreativeRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAdsCreativeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAdsCreativeResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAdsCreativeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAdsCreativeResponse res = resBuilder.build();
