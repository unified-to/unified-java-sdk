...
public class CreateAccountingAccountOperation implements RequestOperation<CreateAccountingAccountRequest, CreateAccountingAccountResponse> {
    ...
    public CreateAccountingAccountOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAccountingAccountRequest request) throws Exception {
