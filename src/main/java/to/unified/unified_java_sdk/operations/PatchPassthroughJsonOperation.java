...
public class PatchPassthroughJsonOperation implements RequestOperation<PatchPassthroughJsonRequest, PatchPassthroughJsonResponse> {
    ...
    public PatchPassthroughJsonOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchPassthroughJsonRequest request) throws Exception {
