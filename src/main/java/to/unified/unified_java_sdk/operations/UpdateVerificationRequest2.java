...
public class UpdateVerificationRequest2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateVerificationRequest2Request, UpdateVerificationRequest2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateVerificationRequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateVerificationRequest2Request.class, new TypeReference<UpdateVerificationRequest2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateVerificationRequest2Request request) {
        ...
        @Override
        public UpdateVerificationRequest2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateVerificationRequest2Response.Builder resBuilder =
            ...
            UpdateVerificationRequest2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateVerificationRequest2Request, to.unified.unified_java_sdk.models.operations.async.UpdateVerificationRequest2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateVerificationRequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateVerificationRequest2Request.class, new TypeReference<UpdateVerificationRequest2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateVerificationRequest2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateVerificationRequest2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateVerificationRequest2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateVerificationRequest2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateVerificationRequest2Response res = resBuilder.build();
