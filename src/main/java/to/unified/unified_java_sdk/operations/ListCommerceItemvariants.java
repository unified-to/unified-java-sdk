...
public class ListCommerceItemvariants {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceItemvariantsRequest, ListCommerceItemvariantsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommerceItemvariantsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceItemvariantsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceItemvariantsRequest request) {
        ...
        @Override
        public ListCommerceItemvariantsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceItemvariantsResponse.Builder resBuilder =
            ...
            ListCommerceItemvariantsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceItemvariants(Utils.unmarshal(response, new TypeReference<List<CommerceItemvariant1>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceItemvariantsRequest, to.unified.unified_java_sdk.models.operations.async.ListCommerceItemvariantsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceItemvariantsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceItemvariantsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceItemvariantsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceItemvariantsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceItemvariantsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceItemvariantsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceItemvariantsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CommerceItemvariant1>>() {})
