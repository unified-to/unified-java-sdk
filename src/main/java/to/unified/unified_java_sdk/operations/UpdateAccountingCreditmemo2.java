...
public class UpdateAccountingCreditmemo2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAccountingCreditmemo2Request, UpdateAccountingCreditmemo2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAccountingCreditmemo2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingCreditmemo2Request.class, new TypeReference<UpdateAccountingCreditmemo2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAccountingCreditmemo2Request request) {
        ...
        @Override
        public UpdateAccountingCreditmemo2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAccountingCreditmemo2Response.Builder resBuilder =
            ...
            UpdateAccountingCreditmemo2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountingCreditmemo(Utils.unmarshal(response, new TypeReference<AccountingCreditmemo>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAccountingCreditmemo2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAccountingCreditmemo2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAccountingCreditmemo2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingCreditmemo2Request.class, new TypeReference<UpdateAccountingCreditmemo2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAccountingCreditmemo2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAccountingCreditmemo2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingCreditmemo2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAccountingCreditmemo2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingCreditmemo2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountingCreditmemo>() {})
                            .thenApply(res::withAccountingCreditmemo);
                } else {
