...
public class ListSigningSignatories2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSigningSignatories2Request, ListSigningSignatories2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSigningSignatories2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListSigningSignatories2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSigningSignatories2Request request) {
        ...
        @Override
        public ListSigningSignatories2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSigningSignatories2Response.Builder resBuilder =
            ...
            ListSigningSignatories2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSigningSignatories(Utils.unmarshal(response, new TypeReference<List<SigningSignatory>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSigningSignatories2Request, to.unified.unified_java_sdk.models.operations.async.ListSigningSignatories2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSigningSignatories2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListSigningSignatories2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSigningSignatories2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListSigningSignatories2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListSigningSignatories2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListSigningSignatories2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListSigningSignatories2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<SigningSignatory>>() {})
                            .thenApply(res::withSigningSignatories);
                } else {
