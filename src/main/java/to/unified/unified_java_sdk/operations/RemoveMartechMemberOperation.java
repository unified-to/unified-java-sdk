...
public class RemoveMartechMemberOperation implements RequestOperation<RemoveMartechMemberRequest, RemoveMartechMemberResponse> {
    ...
    public RemoveMartechMemberOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveMartechMemberRequest request) throws Exception {
