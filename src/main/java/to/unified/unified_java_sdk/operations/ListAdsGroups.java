...
public class ListAdsGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsGroupsRequest, ListAdsGroupsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsGroupsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsGroupsRequest request) {
        ...
        @Override
        public ListAdsGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsGroupsResponse.Builder resBuilder =
            ...
            ListAdsGroupsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsGroupsRequest, to.unified.unified_java_sdk.models.operations.async.ListAdsGroupsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsGroupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsGroupsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsGroupsResponse res = resBuilder.build();
