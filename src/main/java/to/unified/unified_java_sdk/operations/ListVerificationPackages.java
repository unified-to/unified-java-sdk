...
public class ListVerificationPackages {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListVerificationPackagesRequest, ListVerificationPackagesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListVerificationPackagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVerificationPackagesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListVerificationPackagesRequest request) {
        ...
        @Override
        public ListVerificationPackagesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListVerificationPackagesResponse.Builder resBuilder =
            ...
            ListVerificationPackagesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListVerificationPackagesRequest, to.unified.unified_java_sdk.models.operations.async.ListVerificationPackagesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListVerificationPackagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVerificationPackagesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListVerificationPackagesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListVerificationPackagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListVerificationPackagesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListVerificationPackagesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListVerificationPackagesResponse res = resBuilder.build();
