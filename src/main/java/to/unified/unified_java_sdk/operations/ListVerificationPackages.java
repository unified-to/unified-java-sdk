...
public class ListVerificationPackages {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListVerificationPackagesRequest request) throws Exception {
        ...
        @Override
        public ListVerificationPackagesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<VerificationPackage> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withVerificationPackages(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
