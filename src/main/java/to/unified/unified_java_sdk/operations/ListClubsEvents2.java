...
public class ListClubsEvents2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListClubsEvents2Request, ListClubsEvents2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListClubsEvents2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsEvents2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListClubsEvents2Request request) {
        ...
        @Override
        public ListClubsEvents2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListClubsEvents2Response.Builder resBuilder =
            ...
            ListClubsEvents2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClubsEvents(Utils.unmarshal(response, new TypeReference<List<ClubsEvent>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListClubsEvents2Request, to.unified.unified_java_sdk.models.operations.async.ListClubsEvents2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListClubsEvents2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsEvents2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListClubsEvents2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListClubsEvents2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListClubsEvents2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListClubsEvents2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListClubsEvents2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ClubsEvent>>() {})
                            .thenApply(res::withClubsEvents);
                } else {
