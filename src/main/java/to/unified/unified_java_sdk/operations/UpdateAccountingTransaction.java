...
public class UpdateAccountingTransaction {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAccountingTransactionRequest, UpdateAccountingTransactionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAccountingTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingTransactionRequest.class, new TypeReference<UpdateAccountingTransactionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAccountingTransactionRequest request) {
        ...
        @Override
        public UpdateAccountingTransactionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAccountingTransactionResponse.Builder resBuilder =
            ...
            UpdateAccountingTransactionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAccountingTransactionRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAccountingTransactionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAccountingTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingTransactionRequest.class, new TypeReference<UpdateAccountingTransactionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAccountingTransactionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAccountingTransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingTransactionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAccountingTransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingTransactionResponse res = resBuilder.build();
