...
public class CreateCrmCompany2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCrmCompany2Request, CreateCrmCompany2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCrmCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmCompany2Request.class, new TypeReference<CreateCrmCompany2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCrmCompany2Request request) {
        ...
        @Override
        public CreateCrmCompany2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCrmCompany2Response.Builder resBuilder =
            ...
            CreateCrmCompany2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCrmCompany2Request, to.unified.unified_java_sdk.models.operations.async.CreateCrmCompany2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCrmCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmCompany2Request.class, new TypeReference<CreateCrmCompany2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCrmCompany2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCrmCompany2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCrmCompany2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCrmCompany2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCrmCompany2Response res = resBuilder.build();
