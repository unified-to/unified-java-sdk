...
public class ListMessagingChannels2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMessagingChannels2Request, ListMessagingChannels2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListMessagingChannels2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListMessagingChannels2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMessagingChannels2Request request) {
        ...
        @Override
        public ListMessagingChannels2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMessagingChannels2Response.Builder resBuilder =
            ...
            ListMessagingChannels2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMessagingChannels(Utils.unmarshal(response, new TypeReference<List<MessagingChannel>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMessagingChannels2Request, to.unified.unified_java_sdk.models.operations.async.ListMessagingChannels2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMessagingChannels2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListMessagingChannels2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMessagingChannels2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListMessagingChannels2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListMessagingChannels2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListMessagingChannels2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListMessagingChannels2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<MessagingChannel>>() {})
                            .thenApply(res::withMessagingChannels);
                } else {
