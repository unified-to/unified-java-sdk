...
public class GetAccountingContactOperation implements RequestOperation<GetAccountingContactRequest, GetAccountingContactResponse> {
    ...
    public GetAccountingContactOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountingContactRequest request) throws Exception {
