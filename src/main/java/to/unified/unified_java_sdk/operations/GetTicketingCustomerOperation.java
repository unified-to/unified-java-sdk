...
public class GetTicketingCustomerOperation implements RequestOperation<GetTicketingCustomerRequest, GetTicketingCustomerResponse> {
    ...
    public GetTicketingCustomerOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetTicketingCustomerRequest request) throws Exception {
