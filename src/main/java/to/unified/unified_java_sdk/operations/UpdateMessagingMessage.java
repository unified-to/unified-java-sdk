...
public class UpdateMessagingMessage {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMessagingMessageRequest, UpdateMessagingMessageResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateMessagingMessageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMessagingMessageRequest.class, new TypeReference<UpdateMessagingMessageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMessagingMessageRequest request) {
        ...
        @Override
        public UpdateMessagingMessageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMessagingMessageResponse.Builder resBuilder =
            ...
            UpdateMessagingMessageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMessagingMessageRequest, to.unified.unified_java_sdk.models.operations.async.UpdateMessagingMessageResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMessagingMessageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMessagingMessageRequest.class, new TypeReference<UpdateMessagingMessageRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMessagingMessageRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateMessagingMessageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateMessagingMessageResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateMessagingMessageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateMessagingMessageResponse res = resBuilder.build();
