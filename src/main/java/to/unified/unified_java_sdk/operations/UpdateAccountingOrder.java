...
public class UpdateAccountingOrder {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAccountingOrderRequest, UpdateAccountingOrderResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAccountingOrderRequest request) {
        ...
        @Override
        public UpdateAccountingOrderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAccountingOrderResponse.Builder resBuilder =
            ...
            UpdateAccountingOrderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAccountingOrderRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAccountingOrderResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAccountingOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingOrderRequest.class, new TypeReference<UpdateAccountingOrderRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAccountingOrderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAccountingOrderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingOrderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAccountingOrderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingOrderResponse res = resBuilder.build();
