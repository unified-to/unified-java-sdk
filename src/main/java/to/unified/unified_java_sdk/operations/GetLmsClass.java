...
public class GetLmsClass {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLmsClassRequest, GetLmsClassResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLmsClassRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsClassRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLmsClassRequest request) {
        ...
        @Override
        public GetLmsClassResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLmsClassResponse.Builder resBuilder =
                    GetLmsClassResponse
                            .builder()
            ...
            GetLmsClassResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLmsClassRequest, to.unified.unified_java_sdk.models.operations.async.GetLmsClassResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLmsClassRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsClassRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLmsClassRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetLmsClassResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetLmsClassResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetLmsClassResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetLmsClassResponse res = resBuilder.build();
