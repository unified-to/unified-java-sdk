...
public class GetAccountingPaymentterm {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingPaymenttermRequest, GetAccountingPaymenttermResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingPaymenttermRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingPaymenttermRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingPaymenttermRequest request) {
        ...
        @Override
        public GetAccountingPaymenttermResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingPaymenttermResponse.Builder resBuilder =
            ...
            GetAccountingPaymenttermResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingPaymenttermRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingPaymenttermResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingPaymenttermRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingPaymenttermRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingPaymenttermRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingPaymenttermResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingPaymenttermResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingPaymenttermResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingPaymenttermResponse res = resBuilder.build();
