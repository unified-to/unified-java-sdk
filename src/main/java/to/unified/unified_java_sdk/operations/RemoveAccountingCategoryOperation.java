...
public class RemoveAccountingCategoryOperation implements RequestOperation<RemoveAccountingCategoryRequest, RemoveAccountingCategoryResponse> {
    ...
    public RemoveAccountingCategoryOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAccountingCategoryRequest request) throws Exception {
