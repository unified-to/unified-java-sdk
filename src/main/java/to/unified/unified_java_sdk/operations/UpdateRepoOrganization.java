...
public class UpdateRepoOrganization {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateRepoOrganizationRequest request) {
        ...
        @Override
        public UpdateRepoOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateRepoOrganizationRequest, to.unified.unified_java_sdk.models.operations.async.UpdateRepoOrganizationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateRepoOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoOrganizationRequest.class, new TypeReference<UpdateRepoOrganizationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateRepoOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateRepoOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateRepoOrganizationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateRepoOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateRepoOrganizationResponse res = resBuilder.build();
