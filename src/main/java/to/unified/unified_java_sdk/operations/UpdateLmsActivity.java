...
public class UpdateLmsActivity {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLmsActivityRequest, UpdateLmsActivityResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateLmsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsActivityRequest.class, new TypeReference<UpdateLmsActivityRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLmsActivityRequest request) {
        ...
        @Override
        public UpdateLmsActivityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateLmsActivityResponse.Builder resBuilder =
            ...
            UpdateLmsActivityResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLmsActivityRequest, to.unified.unified_java_sdk.models.operations.async.UpdateLmsActivityResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLmsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsActivityRequest.class, new TypeReference<UpdateLmsActivityRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLmsActivityRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateLmsActivityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateLmsActivityResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateLmsActivityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateLmsActivityResponse res = resBuilder.build();
