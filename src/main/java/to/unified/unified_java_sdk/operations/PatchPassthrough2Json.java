...
public class PatchPassthrough2Json {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchPassthrough2JsonRequest, PatchPassthrough2JsonResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchPassthrough2JsonRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPassthrough2JsonRequest.class, new TypeReference<PatchPassthrough2JsonRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchPassthrough2JsonRequest request) {
        ...
        @Override
        public PatchPassthrough2JsonResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchPassthrough2JsonResponse.Builder resBuilder =
            ...
            PatchPassthrough2JsonResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchPassthrough2JsonRequest, to.unified.unified_java_sdk.models.operations.async.PatchPassthrough2JsonResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchPassthrough2JsonRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPassthrough2JsonRequest.class, new TypeReference<PatchPassthrough2JsonRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchPassthrough2JsonRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchPassthrough2JsonResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchPassthrough2JsonResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchPassthrough2JsonResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            to.unified.unified_java_sdk.models.operations.async.PatchPassthrough2JsonResponse res = resBuilder.build();
