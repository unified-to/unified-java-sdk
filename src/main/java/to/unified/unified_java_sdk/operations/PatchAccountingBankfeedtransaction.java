...
public class PatchAccountingBankfeedtransaction {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingBankfeedtransactionRequest, PatchAccountingBankfeedtransactionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingBankfeedtransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingBankfeedtransactionRequest.class, new TypeReference<PatchAccountingBankfeedtransactionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingBankfeedtransactionRequest request) {
        ...
        @Override
        public PatchAccountingBankfeedtransactionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingBankfeedtransactionResponse.Builder resBuilder =
                    PatchAccountingBankfeedtransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            PatchAccountingBankfeedtransactionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingBankfeedtransactionRequest, to.unified.unified_java_sdk.models.operations.async.PatchAccountingBankfeedtransactionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingBankfeedtransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingBankfeedtransactionRequest.class, new TypeReference<PatchAccountingBankfeedtransactionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingBankfeedtransactionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingBankfeedtransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingBankfeedtransactionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingBankfeedtransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingBankfeedtransactionResponse res = resBuilder.build();
