...
public class RemoveAccountingContactOperation implements RequestOperation<RemoveAccountingContactRequest, RemoveAccountingContactResponse> {
    ...
    public RemoveAccountingContactOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAccountingContactRequest request) throws Exception {
