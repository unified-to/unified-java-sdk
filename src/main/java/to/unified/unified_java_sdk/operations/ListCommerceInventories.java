...
public class ListCommerceInventories {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceInventoriesRequest request) throws Exception {
        ...
        @Override
        public ListCommerceInventoriesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CommerceInventory> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCommerceInventories(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
