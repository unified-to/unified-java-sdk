...
public class ListCommerceInventories {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceInventoriesRequest, ListCommerceInventoriesResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceInventoriesRequest request) {
        ...
        @Override
        public ListCommerceInventoriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceInventoriesResponse.Builder resBuilder =
            ...
            ListCommerceInventoriesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceInventoriesRequest, to.unified.unified_java_sdk.models.operations.async.ListCommerceInventoriesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceInventoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceInventoriesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceInventoriesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceInventoriesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceInventoriesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceInventoriesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceInventoriesResponse res = resBuilder.build();
