...
public class GetVerificationRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetVerificationRequestRequest, GetVerificationRequestResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetVerificationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetVerificationRequestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetVerificationRequestRequest request) {
        ...
        @Override
        public GetVerificationRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetVerificationRequestResponse.Builder resBuilder =
            ...
            GetVerificationRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetVerificationRequestRequest, to.unified.unified_java_sdk.models.operations.async.GetVerificationRequestResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetVerificationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetVerificationRequestRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetVerificationRequestRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetVerificationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetVerificationRequestResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetVerificationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetVerificationRequestResponse res = resBuilder.build();
