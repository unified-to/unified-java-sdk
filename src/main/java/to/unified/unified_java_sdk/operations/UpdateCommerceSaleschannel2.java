...
public class UpdateCommerceSaleschannel2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommerceSaleschannel2Request, UpdateCommerceSaleschannel2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCommerceSaleschannel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceSaleschannel2Request.class, new TypeReference<UpdateCommerceSaleschannel2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceSaleschannel2Request request) {
        ...
        @Override
        public UpdateCommerceSaleschannel2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommerceSaleschannel2Response.Builder resBuilder =
            ...
            UpdateCommerceSaleschannel2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommerceSaleschannel2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCommerceSaleschannel2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommerceSaleschannel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceSaleschannel2Request.class, new TypeReference<UpdateCommerceSaleschannel2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommerceSaleschannel2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCommerceSaleschannel2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceSaleschannel2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCommerceSaleschannel2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceSaleschannel2Response res = resBuilder.build();
