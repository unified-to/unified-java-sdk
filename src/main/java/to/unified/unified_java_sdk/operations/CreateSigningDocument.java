...
public class CreateSigningDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateSigningDocumentRequest, CreateSigningDocumentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateSigningDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSigningDocumentRequest.class, new TypeReference<CreateSigningDocumentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSigningDocumentRequest request) {
        ...
        @Override
        public CreateSigningDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSigningDocumentResponse.Builder resBuilder =
            ...
            CreateSigningDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateSigningDocumentRequest, to.unified.unified_java_sdk.models.operations.async.CreateSigningDocumentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateSigningDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSigningDocumentRequest.class, new TypeReference<CreateSigningDocumentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateSigningDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateSigningDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateSigningDocumentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateSigningDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateSigningDocumentResponse res = resBuilder.build();
