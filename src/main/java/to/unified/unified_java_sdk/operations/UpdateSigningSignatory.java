...
public class UpdateSigningSignatory {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateSigningSignatoryRequest, UpdateSigningSignatoryResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateSigningSignatoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSigningSignatoryRequest.class, new TypeReference<UpdateSigningSignatoryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateSigningSignatoryRequest request) {
        ...
        @Override
        public UpdateSigningSignatoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateSigningSignatoryResponse.Builder resBuilder =
            ...
            UpdateSigningSignatoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateSigningSignatoryRequest, to.unified.unified_java_sdk.models.operations.async.UpdateSigningSignatoryResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateSigningSignatoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSigningSignatoryRequest.class, new TypeReference<UpdateSigningSignatoryRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateSigningSignatoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateSigningSignatoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateSigningSignatoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateSigningSignatoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateSigningSignatoryResponse res = resBuilder.build();
