...
public class ListKmsSpacesOperation implements RequestOperation<ListKmsSpacesRequest, ListKmsSpacesResponse> {
    ...
    public ListKmsSpacesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListKmsSpacesRequest request) throws Exception {
