...
public class PatchMartechList2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchMartechList2Request, PatchMartechList2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchMartechList2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMartechList2Request.class, new TypeReference<PatchMartechList2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchMartechList2Request request) {
        ...
        @Override
        public PatchMartechList2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchMartechList2Response.Builder resBuilder =
            ...
            PatchMartechList2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchMartechList2Request, to.unified.unified_java_sdk.models.operations.async.PatchMartechList2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchMartechList2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMartechList2Request.class, new TypeReference<PatchMartechList2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchMartechList2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchMartechList2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchMartechList2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchMartechList2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchMartechList2Response res = resBuilder.build();
