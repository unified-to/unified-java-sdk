...
public class UpdateCommerceReview2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommerceReview2Request, UpdateCommerceReview2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCommerceReview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceReview2Request.class, new TypeReference<UpdateCommerceReview2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceReview2Request request) {
        ...
        @Override
        public UpdateCommerceReview2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommerceReview2Response.Builder resBuilder =
            ...
            UpdateCommerceReview2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommerceReview2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReview2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommerceReview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceReview2Request.class, new TypeReference<UpdateCommerceReview2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommerceReview2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReview2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReview2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReview2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReview2Response res = resBuilder.build();
