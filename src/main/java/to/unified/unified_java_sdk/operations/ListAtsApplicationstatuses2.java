...
public class ListAtsApplicationstatuses2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAtsApplicationstatuses2Request, ListAtsApplicationstatuses2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAtsApplicationstatuses2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsApplicationstatuses2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsApplicationstatuses2Request request) {
        ...
        @Override
        public ListAtsApplicationstatuses2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsApplicationstatuses2Response.Builder resBuilder =
            ...
            ListAtsApplicationstatuses2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsStatuses(Utils.unmarshal(response, new TypeReference<List<AtsStatus>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsApplicationstatuses2Request, to.unified.unified_java_sdk.models.operations.async.ListAtsApplicationstatuses2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsApplicationstatuses2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsApplicationstatuses2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsApplicationstatuses2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsApplicationstatuses2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsApplicationstatuses2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsApplicationstatuses2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsApplicationstatuses2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AtsStatus>>() {})
                            .thenApply(res::withAtsStatuses);
                } else {
