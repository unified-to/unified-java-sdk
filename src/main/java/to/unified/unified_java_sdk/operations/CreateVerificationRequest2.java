...
public class CreateVerificationRequest2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateVerificationRequest2Request, CreateVerificationRequest2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateVerificationRequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateVerificationRequest2Request.class, new TypeReference<CreateVerificationRequest2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateVerificationRequest2Request request) {
        ...
        @Override
        public CreateVerificationRequest2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateVerificationRequest2Response.Builder resBuilder =
            ...
            CreateVerificationRequest2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withVerificationRequest(Utils.unmarshal(response, new TypeReference<VerificationRequest>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateVerificationRequest2Request, to.unified.unified_java_sdk.models.operations.async.CreateVerificationRequest2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateVerificationRequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateVerificationRequest2Request.class, new TypeReference<CreateVerificationRequest2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateVerificationRequest2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateVerificationRequest2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateVerificationRequest2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateVerificationRequest2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateVerificationRequest2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<VerificationRequest>() {})
                            .thenApply(res::withVerificationRequest);
                } else {
