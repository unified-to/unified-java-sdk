...
public class PatchAtsApplication {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAtsApplicationRequest, PatchAtsApplicationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAtsApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsApplicationRequest.class, new TypeReference<PatchAtsApplicationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAtsApplicationRequest request) {
        ...
        @Override
        public PatchAtsApplicationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAtsApplicationResponse.Builder resBuilder =
            ...
            PatchAtsApplicationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAtsApplicationRequest, to.unified.unified_java_sdk.models.operations.async.PatchAtsApplicationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAtsApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsApplicationRequest.class, new TypeReference<PatchAtsApplicationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAtsApplicationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAtsApplicationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAtsApplicationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAtsApplicationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAtsApplicationResponse res = resBuilder.build();
