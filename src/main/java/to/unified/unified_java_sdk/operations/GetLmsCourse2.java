...
public class GetLmsCourse2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLmsCourse2Request, GetLmsCourse2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLmsCourse2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsCourse2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLmsCourse2Request request) {
        ...
        @Override
        public GetLmsCourse2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLmsCourse2Response.Builder resBuilder =
            ...
            GetLmsCourse2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLmsCourse2Request, to.unified.unified_java_sdk.models.operations.async.GetLmsCourse2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLmsCourse2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsCourse2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLmsCourse2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetLmsCourse2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetLmsCourse2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetLmsCourse2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetLmsCourse2Response res = resBuilder.build();
