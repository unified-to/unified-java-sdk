...
public class CreateCrmContactOperation implements RequestOperation<CreateCrmContactRequest, CreateCrmContactResponse> {
    ...
    public CreateCrmContactOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateCrmContactRequest request) throws Exception {
