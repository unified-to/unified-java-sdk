...
public class CreateCommerceInventoryOperation implements RequestOperation<CreateCommerceInventoryRequest, CreateCommerceInventoryResponse> {
    ...
    public CreateCommerceInventoryOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateCommerceInventoryRequest request) throws Exception {
