...
public class ListCommerceCollectionsOperation implements RequestOperation<ListCommerceCollectionsRequest, ListCommerceCollectionsResponse> {
    ...
    public ListCommerceCollectionsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCommerceCollectionsRequest request) throws Exception {
