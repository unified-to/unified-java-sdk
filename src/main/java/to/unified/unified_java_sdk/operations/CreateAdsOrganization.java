...
public class CreateAdsOrganization {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAdsOrganizationRequest, CreateAdsOrganizationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAdsOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsOrganizationRequest.class, new TypeReference<CreateAdsOrganizationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAdsOrganizationRequest request) {
        ...
        @Override
        public CreateAdsOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAdsOrganizationResponse.Builder resBuilder =
            ...
            CreateAdsOrganizationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAdsOrganizationRequest, to.unified.unified_java_sdk.models.operations.async.CreateAdsOrganizationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAdsOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsOrganizationRequest.class, new TypeReference<CreateAdsOrganizationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAdsOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAdsOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAdsOrganizationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAdsOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAdsOrganizationResponse res = resBuilder.build();
