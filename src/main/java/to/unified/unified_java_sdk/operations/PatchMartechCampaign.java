...
public class PatchMartechCampaign {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchMartechCampaignRequest, PatchMartechCampaignResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchMartechCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMartechCampaignRequest.class, new TypeReference<PatchMartechCampaignRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchMartechCampaignRequest request) {
        ...
        @Override
        public PatchMartechCampaignResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchMartechCampaignResponse.Builder resBuilder =
            ...
            PatchMartechCampaignResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchMartechCampaignRequest, to.unified.unified_java_sdk.models.operations.async.PatchMartechCampaignResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchMartechCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMartechCampaignRequest.class, new TypeReference<PatchMartechCampaignRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchMartechCampaignRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchMartechCampaignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchMartechCampaignResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchMartechCampaignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchMartechCampaignResponse res = resBuilder.build();
