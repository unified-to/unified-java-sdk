...
public class GetUcCall {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUcCallRequest, GetUcCallResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUcCallRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUcCallRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUcCallRequest request) {
        ...
        @Override
        public GetUcCallResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUcCallResponse.Builder resBuilder =
                    GetUcCallResponse
                            .builder()
            ...
            GetUcCallResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUcCallRequest, to.unified.unified_java_sdk.models.operations.async.GetUcCallResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUcCallRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUcCallRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUcCallRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetUcCallResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetUcCallResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetUcCallResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetUcCallResponse res = resBuilder.build();
