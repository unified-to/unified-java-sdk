...
public class GetPaymentRefundOperation implements RequestOperation<GetPaymentRefundRequest, GetPaymentRefundResponse> {
    ...
    public GetPaymentRefundOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetPaymentRefundRequest request) throws Exception {
