...
public class ListScimUsersOperation implements RequestOperation<ListScimUsersRequest, ListScimUsersResponse> {
    ...
    public ListScimUsersOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListScimUsersRequest request) throws Exception {
