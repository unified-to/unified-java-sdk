...
public class GetRepoPullrequest2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRepoPullrequest2Request, GetRepoPullrequest2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRepoPullrequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoPullrequest2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRepoPullrequest2Request request) {
        ...
        @Override
        public GetRepoPullrequest2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRepoPullrequest2Response.Builder resBuilder =
            ...
            GetRepoPullrequest2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRepoPullrequest2Request, to.unified.unified_java_sdk.models.operations.async.GetRepoPullrequest2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRepoPullrequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoPullrequest2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRepoPullrequest2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetRepoPullrequest2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetRepoPullrequest2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetRepoPullrequest2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetRepoPullrequest2Response res = resBuilder.build();
