...
public class RemoveAccountingQuote {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingQuoteRequest, RemoveAccountingQuoteResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingQuoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingQuoteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingQuoteRequest request) {
        ...
        @Override
        public RemoveAccountingQuoteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingQuoteResponse.Builder resBuilder =
            ...
            RemoveAccountingQuoteResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingQuoteRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingQuoteResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingQuoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingQuoteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingQuoteRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingQuoteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingQuoteResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingQuoteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingQuoteResponse res = resBuilder.build();
