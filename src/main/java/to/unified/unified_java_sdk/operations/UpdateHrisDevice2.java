...
public class UpdateHrisDevice2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisDevice2Request, UpdateHrisDevice2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisDevice2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisDevice2Request.class, new TypeReference<UpdateHrisDevice2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisDevice2Request request) {
        ...
        @Override
        public UpdateHrisDevice2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisDevice2Response.Builder resBuilder =
            ...
            UpdateHrisDevice2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisDevice2Request, to.unified.unified_java_sdk.models.operations.async.UpdateHrisDevice2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisDevice2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisDevice2Request.class, new TypeReference<UpdateHrisDevice2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisDevice2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisDevice2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisDevice2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisDevice2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisDevice2Response res = resBuilder.build();
