...
public class GetAccountingPurchaseorder2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingPurchaseorder2Request, GetAccountingPurchaseorder2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingPurchaseorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingPurchaseorder2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingPurchaseorder2Request request) {
        ...
        @Override
        public GetAccountingPurchaseorder2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingPurchaseorder2Response.Builder resBuilder =
            ...
            GetAccountingPurchaseorder2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingPurchaseorder2Request, to.unified.unified_java_sdk.models.operations.async.GetAccountingPurchaseorder2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingPurchaseorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingPurchaseorder2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingPurchaseorder2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingPurchaseorder2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingPurchaseorder2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingPurchaseorder2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingPurchaseorder2Response res = resBuilder.build();
