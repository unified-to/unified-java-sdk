...
public class UpdateScimUsers {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateScimUsersRequest, UpdateScimUsersResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateScimUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateScimUsersRequest.class, new TypeReference<UpdateScimUsersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateScimUsersRequest request) {
        ...
        @Override
        public UpdateScimUsersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateScimUsersResponse.Builder resBuilder =
            ...
            UpdateScimUsersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateScimUsersRequest, to.unified.unified_java_sdk.models.operations.async.UpdateScimUsersResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateScimUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateScimUsersRequest.class, new TypeReference<UpdateScimUsersRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateScimUsersRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateScimUsersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateScimUsersResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateScimUsersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateScimUsersResponse res = resBuilder.build();
