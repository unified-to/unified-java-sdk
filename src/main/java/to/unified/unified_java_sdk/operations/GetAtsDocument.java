...
public class GetAtsDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAtsDocumentRequest, GetAtsDocumentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAtsDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsDocumentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAtsDocumentRequest request) {
        ...
        @Override
        public GetAtsDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAtsDocumentResponse.Builder resBuilder =
            ...
            GetAtsDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAtsDocumentRequest, to.unified.unified_java_sdk.models.operations.async.GetAtsDocumentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAtsDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsDocumentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAtsDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAtsDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAtsDocumentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAtsDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAtsDocumentResponse res = resBuilder.build();
