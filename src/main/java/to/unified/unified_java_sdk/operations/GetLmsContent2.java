...
public class GetLmsContent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLmsContent2Request, GetLmsContent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLmsContent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsContent2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLmsContent2Request request) {
        ...
        @Override
        public GetLmsContent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLmsContent2Response.Builder resBuilder =
            ...
            GetLmsContent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLmsContent2Request, to.unified.unified_java_sdk.models.operations.async.GetLmsContent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLmsContent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsContent2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLmsContent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetLmsContent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetLmsContent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetLmsContent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetLmsContent2Response res = resBuilder.build();
