...
public class CreateRepoRepository2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateRepoRepository2Request, CreateRepoRepository2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateRepoRepository2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoRepository2Request.class, new TypeReference<CreateRepoRepository2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateRepoRepository2Request request) {
        ...
        @Override
        public CreateRepoRepository2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateRepoRepository2Response.Builder resBuilder =
            ...
            CreateRepoRepository2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRepoRepository(Utils.unmarshal(response, new TypeReference<RepoRepository>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateRepoRepository2Request, to.unified.unified_java_sdk.models.operations.async.CreateRepoRepository2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateRepoRepository2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoRepository2Request.class, new TypeReference<CreateRepoRepository2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateRepoRepository2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateRepoRepository2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateRepoRepository2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateRepoRepository2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateRepoRepository2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RepoRepository>() {})
                            .thenApply(res::withRepoRepository);
                } else {
