...
public class PatchHrisCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisCompanyRequest, PatchHrisCompanyResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisCompanyRequest.class, new TypeReference<PatchHrisCompanyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisCompanyRequest request) {
        ...
        @Override
        public PatchHrisCompanyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisCompanyResponse.Builder resBuilder =
            ...
            PatchHrisCompanyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisCompanyRequest, to.unified.unified_java_sdk.models.operations.async.PatchHrisCompanyResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisCompanyRequest.class, new TypeReference<PatchHrisCompanyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisCompanyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisCompanyResponse res = resBuilder.build();
