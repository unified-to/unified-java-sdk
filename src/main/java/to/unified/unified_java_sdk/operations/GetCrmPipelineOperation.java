...
public class GetCrmPipelineOperation implements RequestOperation<GetCrmPipelineRequest, GetCrmPipelineResponse> {
    ...
    public GetCrmPipelineOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetCrmPipelineRequest request) throws Exception {
