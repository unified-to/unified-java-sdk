...
public class ListDatastoreDatabases {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDatastoreDatabasesRequest, ListDatastoreDatabasesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListDatastoreDatabasesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDatastoreDatabasesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDatastoreDatabasesRequest request) {
        ...
        @Override
        public ListDatastoreDatabasesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListDatastoreDatabasesResponse.Builder resBuilder =
            ...
            ListDatastoreDatabasesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListDatastoreDatabasesRequest, to.unified.unified_java_sdk.models.operations.async.ListDatastoreDatabasesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListDatastoreDatabasesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDatastoreDatabasesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDatastoreDatabasesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListDatastoreDatabasesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListDatastoreDatabasesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListDatastoreDatabasesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListDatastoreDatabasesResponse res = resBuilder.build();
