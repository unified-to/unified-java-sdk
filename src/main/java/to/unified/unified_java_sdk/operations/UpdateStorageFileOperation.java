...
public class UpdateStorageFileOperation implements RequestOperation<UpdateStorageFileRequest, UpdateStorageFileResponse> {
    ...
    public UpdateStorageFileOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateStorageFileRequest request) throws Exception {
