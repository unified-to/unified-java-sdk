...
public class UpdateMartechMember2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMartechMember2Request, UpdateMartechMember2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateMartechMember2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMartechMember2Request.class, new TypeReference<UpdateMartechMember2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMartechMember2Request request) {
        ...
        @Override
        public UpdateMartechMember2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMartechMember2Response.Builder resBuilder =
            ...
            UpdateMartechMember2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMartechMember2Request, to.unified.unified_java_sdk.models.operations.async.UpdateMartechMember2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMartechMember2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMartechMember2Request.class, new TypeReference<UpdateMartechMember2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMartechMember2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateMartechMember2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateMartechMember2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateMartechMember2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateMartechMember2Response res = resBuilder.build();
