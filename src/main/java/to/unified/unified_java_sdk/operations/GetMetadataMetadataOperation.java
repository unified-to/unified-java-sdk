...
public class GetMetadataMetadataOperation implements RequestOperation<GetMetadataMetadataRequest, GetMetadataMetadataResponse> {
    ...
    public GetMetadataMetadataOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetMetadataMetadataRequest request) throws Exception {
