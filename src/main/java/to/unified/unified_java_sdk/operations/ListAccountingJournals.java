...
public class ListAccountingJournals {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAccountingJournalsRequest, ListAccountingJournalsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAccountingJournalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAccountingJournalsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountingJournalsRequest request) {
        ...
        @Override
        public ListAccountingJournalsResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAccountingJournalsRequest, to.unified.unified_java_sdk.models.operations.async.ListAccountingJournalsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAccountingJournalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAccountingJournalsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAccountingJournalsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAccountingJournalsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAccountingJournalsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAccountingJournalsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAccountingJournalsResponse res = resBuilder.build();
