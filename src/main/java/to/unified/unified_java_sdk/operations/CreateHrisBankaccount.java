...
public class CreateHrisBankaccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisBankaccountRequest, CreateHrisBankaccountResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisBankaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisBankaccountRequest.class, new TypeReference<CreateHrisBankaccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisBankaccountRequest request) {
        ...
        @Override
        public CreateHrisBankaccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisBankaccountResponse.Builder resBuilder =
            ...
            CreateHrisBankaccountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisBankaccountRequest, to.unified.unified_java_sdk.models.operations.async.CreateHrisBankaccountResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisBankaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisBankaccountRequest.class, new TypeReference<CreateHrisBankaccountRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisBankaccountRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisBankaccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisBankaccountResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisBankaccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisBankaccountResponse res = resBuilder.build();
