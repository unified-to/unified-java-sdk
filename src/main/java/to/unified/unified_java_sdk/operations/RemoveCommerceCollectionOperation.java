...
public class RemoveCommerceCollectionOperation implements RequestOperation<RemoveCommerceCollectionRequest, RemoveCommerceCollectionResponse> {
    ...
    public RemoveCommerceCollectionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveCommerceCollectionRequest request) throws Exception {
