...
public class GetCrmLead2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCrmLead2Request, GetCrmLead2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCrmLead2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmLead2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCrmLead2Request request) {
        ...
        @Override
        public GetCrmLead2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCrmLead2Response.Builder resBuilder =
                    GetCrmLead2Response
                            .builder()
            ...
            GetCrmLead2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCrmLead2Request, to.unified.unified_java_sdk.models.operations.async.GetCrmLead2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCrmLead2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmLead2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCrmLead2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCrmLead2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCrmLead2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCrmLead2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCrmLead2Response res = resBuilder.build();
