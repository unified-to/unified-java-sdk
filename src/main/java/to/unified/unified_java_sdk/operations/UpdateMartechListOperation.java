...
public class UpdateMartechListOperation implements RequestOperation<UpdateMartechListRequest, UpdateMartechListResponse> {
    ...
    public UpdateMartechListOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateMartechListRequest request) throws Exception {
