...
public class UpdateAccountingTransactionOperation implements RequestOperation<UpdateAccountingTransactionRequest, UpdateAccountingTransactionResponse> {
    ...
    public UpdateAccountingTransactionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAccountingTransactionRequest request) throws Exception {
