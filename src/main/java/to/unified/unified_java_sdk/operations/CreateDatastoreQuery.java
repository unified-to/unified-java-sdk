...
public class CreateDatastoreQuery {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateDatastoreQueryRequest, CreateDatastoreQueryResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateDatastoreQueryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDatastoreQueryRequest.class, new TypeReference<CreateDatastoreQueryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDatastoreQueryRequest request) {
        ...
        @Override
        public CreateDatastoreQueryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDatastoreQueryResponse.Builder resBuilder =
            ...
            CreateDatastoreQueryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateDatastoreQueryRequest, to.unified.unified_java_sdk.models.operations.async.CreateDatastoreQueryResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateDatastoreQueryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDatastoreQueryRequest.class, new TypeReference<CreateDatastoreQueryRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateDatastoreQueryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateDatastoreQueryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateDatastoreQueryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateDatastoreQueryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateDatastoreQueryResponse res = resBuilder.build();
