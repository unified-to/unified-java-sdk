...
public class GetTaskTask {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetTaskTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskTaskRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTaskTaskRequest request) {
        ...
        @Override
        public GetTaskTaskResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTaskTaskResponse.Builder resBuilder =
                    GetTaskTaskResponse
                            .builder()
            ...
            GetTaskTaskResponse res = resBuilder.build();
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTaskTaskRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetTaskTaskResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetTaskTaskResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetTaskTaskResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetTaskTaskResponse res = resBuilder.build();
