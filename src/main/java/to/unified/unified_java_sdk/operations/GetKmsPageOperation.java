...
public class GetKmsPageOperation implements RequestOperation<GetKmsPageRequest, GetKmsPageResponse> {
    ...
    public GetKmsPageOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetKmsPageRequest request) throws Exception {
