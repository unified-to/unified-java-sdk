...
public class ListCrmContacts {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCrmContactsRequest, ListCrmContactsResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmContactsRequest request) {
        ...
        @Override
        public ListCrmContactsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCrmContactsResponse.Builder resBuilder =
            ...
            ListCrmContactsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCrmContactsRequest, to.unified.unified_java_sdk.models.operations.async.ListCrmContactsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCrmContactsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmContactsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCrmContactsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCrmContactsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCrmContactsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCrmContactsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCrmContactsResponse res = resBuilder.build();
