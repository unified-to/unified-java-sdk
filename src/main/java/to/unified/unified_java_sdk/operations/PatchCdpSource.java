...
public class PatchCdpSource {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCdpSourceRequest, PatchCdpSourceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCdpSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCdpSourceRequest.class, new TypeReference<PatchCdpSourceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCdpSourceRequest request) {
        ...
        @Override
        public PatchCdpSourceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCdpSourceResponse.Builder resBuilder =
            ...
            PatchCdpSourceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCdpSourceRequest, to.unified.unified_java_sdk.models.operations.async.PatchCdpSourceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCdpSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCdpSourceRequest.class, new TypeReference<PatchCdpSourceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCdpSourceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCdpSourceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCdpSourceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCdpSourceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCdpSourceResponse res = resBuilder.build();
