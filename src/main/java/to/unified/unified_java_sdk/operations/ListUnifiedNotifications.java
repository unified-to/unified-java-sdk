...
public class ListUnifiedNotifications {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUnifiedNotificationsRequest, ListUnifiedNotificationsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListUnifiedNotificationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUnifiedNotificationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUnifiedNotificationsRequest request) {
        ...
        @Override
        public ListUnifiedNotificationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUnifiedNotificationsResponse.Builder resBuilder =
            ...
            ListUnifiedNotificationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withNotifications(Utils.unmarshal(response, new TypeReference<List<Notification>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUnifiedNotificationsRequest, to.unified.unified_java_sdk.models.operations.async.ListUnifiedNotificationsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListUnifiedNotificationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUnifiedNotificationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUnifiedNotificationsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListUnifiedNotificationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListUnifiedNotificationsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListUnifiedNotificationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListUnifiedNotificationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<Notification>>() {})
                            .thenApply(res::withNotifications);
                } else {
