...
public class GetMartechList {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMartechListRequest, GetMartechListResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetMartechListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMartechListRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMartechListRequest request) {
        ...
        @Override
        public GetMartechListResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMartechListRequest, to.unified.unified_java_sdk.models.operations.async.GetMartechListResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMartechListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMartechListRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMartechListRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetMartechListResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetMartechListResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetMartechListResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetMartechListResponse res = resBuilder.build();
