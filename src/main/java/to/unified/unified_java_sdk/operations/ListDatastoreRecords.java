...
public class ListDatastoreRecords {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDatastoreRecordsRequest, ListDatastoreRecordsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListDatastoreRecordsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDatastoreRecordsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDatastoreRecordsRequest request) {
        ...
        @Override
        public ListDatastoreRecordsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListDatastoreRecordsResponse.Builder resBuilder =
            ...
            ListDatastoreRecordsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListDatastoreRecordsRequest, to.unified.unified_java_sdk.models.operations.async.ListDatastoreRecordsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListDatastoreRecordsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDatastoreRecordsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDatastoreRecordsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListDatastoreRecordsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListDatastoreRecordsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListDatastoreRecordsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListDatastoreRecordsResponse res = resBuilder.build();
