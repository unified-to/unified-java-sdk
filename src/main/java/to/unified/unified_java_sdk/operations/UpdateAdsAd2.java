...
public class UpdateAdsAd2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAdsAd2Request, UpdateAdsAd2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAdsAd2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsAd2Request.class, new TypeReference<UpdateAdsAd2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAdsAd2Request request) {
        ...
        @Override
        public UpdateAdsAd2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAdsAd2Response.Builder resBuilder =
            ...
            UpdateAdsAd2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdsAd(Utils.unmarshal(response, new TypeReference<AdsAd>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAdsAd2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAdsAd2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAdsAd2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsAd2Request.class, new TypeReference<UpdateAdsAd2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAdsAd2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAdsAd2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAdsAd2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAdsAd2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAdsAd2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AdsAd>() {})
                            .thenApply(res::withAdsAd);
                } else {
