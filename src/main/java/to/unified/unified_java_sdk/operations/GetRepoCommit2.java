...
public class GetRepoCommit2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRepoCommit2Request, GetRepoCommit2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRepoCommit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoCommit2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRepoCommit2Request request) {
        ...
        @Override
        public GetRepoCommit2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRepoCommit2Response.Builder resBuilder =
            ...
            GetRepoCommit2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRepoCommit2Request, to.unified.unified_java_sdk.models.operations.async.GetRepoCommit2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRepoCommit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoCommit2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRepoCommit2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetRepoCommit2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetRepoCommit2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetRepoCommit2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetRepoCommit2Response res = resBuilder.build();
