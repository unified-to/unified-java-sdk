...
public class GetMartechMemberOperation implements RequestOperation<GetMartechMemberRequest, GetMartechMemberResponse> {
    ...
    public GetMartechMemberOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetMartechMemberRequest request) throws Exception {
