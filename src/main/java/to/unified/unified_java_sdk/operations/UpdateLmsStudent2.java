...
public class UpdateLmsStudent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLmsStudent2Request, UpdateLmsStudent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateLmsStudent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsStudent2Request.class, new TypeReference<UpdateLmsStudent2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLmsStudent2Request request) {
        ...
        @Override
        public UpdateLmsStudent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateLmsStudent2Response.Builder resBuilder =
            ...
            UpdateLmsStudent2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLmsStudent(Utils.unmarshal(response, new TypeReference<LmsStudent>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLmsStudent2Request, to.unified.unified_java_sdk.models.operations.async.UpdateLmsStudent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLmsStudent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsStudent2Request.class, new TypeReference<UpdateLmsStudent2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLmsStudent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateLmsStudent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateLmsStudent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateLmsStudent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateLmsStudent2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<LmsStudent>() {})
                            .thenApply(res::withLmsStudent);
                } else {
