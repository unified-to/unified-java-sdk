...
public class ListPassthroughsOperation implements RequestOperation<ListPassthroughsRequest, ListPassthroughsResponse> {
    ...
    public ListPassthroughsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListPassthroughsRequest request) throws Exception {
