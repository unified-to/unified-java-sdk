...
public class GetAssessmentOrder {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAssessmentOrderRequest, GetAssessmentOrderResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAssessmentOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAssessmentOrderRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAssessmentOrderRequest request) {
        ...
        @Override
        public GetAssessmentOrderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAssessmentOrderResponse.Builder resBuilder =
            ...
            GetAssessmentOrderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAssessmentOrderRequest, to.unified.unified_java_sdk.models.operations.async.GetAssessmentOrderResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAssessmentOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAssessmentOrderRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAssessmentOrderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAssessmentOrderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAssessmentOrderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAssessmentOrderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAssessmentOrderResponse res = resBuilder.build();
