...
public class UpdateAccountingBill2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAccountingBill2Request, UpdateAccountingBill2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAccountingBill2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingBill2Request.class, new TypeReference<UpdateAccountingBill2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAccountingBill2Request request) {
        ...
        @Override
        public UpdateAccountingBill2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAccountingBill2Response.Builder resBuilder =
            ...
            UpdateAccountingBill2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAccountingBill2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAccountingBill2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAccountingBill2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingBill2Request.class, new TypeReference<UpdateAccountingBill2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAccountingBill2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAccountingBill2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingBill2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAccountingBill2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingBill2Response res = resBuilder.build();
