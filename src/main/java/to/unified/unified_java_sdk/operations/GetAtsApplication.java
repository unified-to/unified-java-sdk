...
public class GetAtsApplication {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAtsApplicationRequest, GetAtsApplicationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAtsApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsApplicationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAtsApplicationRequest request) {
        ...
        @Override
        public GetAtsApplicationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAtsApplicationResponse.Builder resBuilder =
            ...
            GetAtsApplicationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAtsApplicationRequest, to.unified.unified_java_sdk.models.operations.async.GetAtsApplicationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAtsApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsApplicationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAtsApplicationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAtsApplicationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAtsApplicationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAtsApplicationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAtsApplicationResponse res = resBuilder.build();
