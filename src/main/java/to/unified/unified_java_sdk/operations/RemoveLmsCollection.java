...
public class RemoveLmsCollection {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveLmsCollectionRequest, RemoveLmsCollectionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveLmsCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsCollectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveLmsCollectionRequest request) {
        ...
        @Override
        public RemoveLmsCollectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveLmsCollectionResponse.Builder resBuilder =
            ...
            RemoveLmsCollectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveLmsCollectionRequest, to.unified.unified_java_sdk.models.operations.async.RemoveLmsCollectionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveLmsCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsCollectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveLmsCollectionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveLmsCollectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveLmsCollectionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveLmsCollectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveLmsCollectionResponse res = resBuilder.build();
