...
public class PatchKmsSpace {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchKmsSpaceRequest, PatchKmsSpaceResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchKmsSpaceRequest request) {
        ...
        @Override
        public PatchKmsSpaceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchKmsSpaceResponse.Builder resBuilder =
            ...
            PatchKmsSpaceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchKmsSpaceRequest, to.unified.unified_java_sdk.models.operations.async.PatchKmsSpaceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchKmsSpaceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchKmsSpaceRequest.class, new TypeReference<PatchKmsSpaceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchKmsSpaceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchKmsSpaceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchKmsSpaceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchKmsSpaceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchKmsSpaceResponse res = resBuilder.build();
