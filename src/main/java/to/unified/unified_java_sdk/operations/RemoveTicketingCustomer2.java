...
public class RemoveTicketingCustomer2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveTicketingCustomer2Request, RemoveTicketingCustomer2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveTicketingCustomer2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTicketingCustomer2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveTicketingCustomer2Request request) {
        ...
        @Override
        public RemoveTicketingCustomer2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveTicketingCustomer2Response.Builder resBuilder =
            ...
            RemoveTicketingCustomer2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveTicketingCustomer2Request, to.unified.unified_java_sdk.models.operations.async.RemoveTicketingCustomer2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveTicketingCustomer2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTicketingCustomer2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveTicketingCustomer2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveTicketingCustomer2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveTicketingCustomer2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveTicketingCustomer2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveTicketingCustomer2Response res = resBuilder.build();
