...
public class UpdateUcRecordingOperation implements RequestOperation<UpdateUcRecordingRequest, UpdateUcRecordingResponse> {
    ...
    public UpdateUcRecordingOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateUcRecordingRequest request) throws Exception {
