...
public class UpdateCalendarWebinar {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCalendarWebinarRequest, UpdateCalendarWebinarResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCalendarWebinarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCalendarWebinarRequest.class, new TypeReference<UpdateCalendarWebinarRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCalendarWebinarRequest request) {
        ...
        @Override
        public UpdateCalendarWebinarResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCalendarWebinarResponse.Builder resBuilder =
            ...
            UpdateCalendarWebinarResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCalendarWebinarRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCalendarWebinarResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCalendarWebinarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCalendarWebinarRequest.class, new TypeReference<UpdateCalendarWebinarRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCalendarWebinarRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCalendarWebinarResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCalendarWebinarResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCalendarWebinarResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCalendarWebinarResponse res = resBuilder.build();
