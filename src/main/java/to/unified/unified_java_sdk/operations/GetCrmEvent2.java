...
public class GetCrmEvent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCrmEvent2Request, GetCrmEvent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCrmEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmEvent2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCrmEvent2Request request) {
        ...
        @Override
        public GetCrmEvent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCrmEvent2Response.Builder resBuilder =
            ...
            GetCrmEvent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCrmEvent2Request, to.unified.unified_java_sdk.models.operations.async.GetCrmEvent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCrmEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmEvent2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCrmEvent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCrmEvent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCrmEvent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCrmEvent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCrmEvent2Response res = resBuilder.build();
