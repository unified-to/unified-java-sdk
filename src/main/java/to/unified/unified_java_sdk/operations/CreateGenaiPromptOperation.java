...
public class CreateGenaiPromptOperation implements RequestOperation<CreateGenaiPromptRequest, CreateGenaiPromptResponse> {
    ...
    public CreateGenaiPromptOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateGenaiPromptRequest request) throws Exception {
