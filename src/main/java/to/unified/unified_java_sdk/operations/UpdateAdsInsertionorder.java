...
public class UpdateAdsInsertionorder {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAdsInsertionorderRequest, UpdateAdsInsertionorderResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAdsInsertionorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsInsertionorderRequest.class, new TypeReference<UpdateAdsInsertionorderRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAdsInsertionorderRequest request) {
        ...
        @Override
        public UpdateAdsInsertionorderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAdsInsertionorderResponse.Builder resBuilder =
            ...
            UpdateAdsInsertionorderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAdsInsertionorderRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAdsInsertionorderResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAdsInsertionorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsInsertionorderRequest.class, new TypeReference<UpdateAdsInsertionorderRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAdsInsertionorderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAdsInsertionorderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAdsInsertionorderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAdsInsertionorderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAdsInsertionorderResponse res = resBuilder.build();
