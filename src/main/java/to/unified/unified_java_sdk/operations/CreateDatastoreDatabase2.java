...
public class CreateDatastoreDatabase2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateDatastoreDatabase2Request, CreateDatastoreDatabase2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateDatastoreDatabase2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDatastoreDatabase2Request.class, new TypeReference<CreateDatastoreDatabase2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDatastoreDatabase2Request request) {
        ...
        @Override
        public CreateDatastoreDatabase2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDatastoreDatabase2Response.Builder resBuilder =
            ...
            CreateDatastoreDatabase2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateDatastoreDatabase2Request, to.unified.unified_java_sdk.models.operations.async.CreateDatastoreDatabase2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateDatastoreDatabase2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDatastoreDatabase2Request.class, new TypeReference<CreateDatastoreDatabase2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateDatastoreDatabase2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateDatastoreDatabase2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateDatastoreDatabase2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateDatastoreDatabase2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateDatastoreDatabase2Response res = resBuilder.build();
