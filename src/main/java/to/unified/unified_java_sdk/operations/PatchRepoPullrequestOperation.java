...
public class PatchRepoPullrequestOperation implements RequestOperation<PatchRepoPullrequestRequest, PatchRepoPullrequestResponse> {
    ...
    public PatchRepoPullrequestOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchRepoPullrequestRequest request) throws Exception {
