...
public class RemoveAtsDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAtsDocumentRequest, RemoveAtsDocumentResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAtsDocumentRequest request) throws Exception {
        ...
        @Override
        public RemoveAtsDocumentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAtsDocumentResponse.Builder resBuilder =
            ...
            RemoveAtsDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAtsDocumentRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAtsDocumentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAtsDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsDocumentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAtsDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAtsDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAtsDocumentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAtsDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAtsDocumentResponse res = resBuilder.build();
