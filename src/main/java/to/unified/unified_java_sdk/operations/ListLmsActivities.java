...
public class ListLmsActivities {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListLmsActivitiesRequest, ListLmsActivitiesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListLmsActivitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsActivitiesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsActivitiesRequest request) {
        ...
        @Override
        public ListLmsActivitiesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListLmsActivitiesResponse.Builder resBuilder =
            ...
            ListLmsActivitiesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLmsActivitiesRequest, to.unified.unified_java_sdk.models.operations.async.ListLmsActivitiesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListLmsActivitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsActivitiesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListLmsActivitiesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListLmsActivitiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListLmsActivitiesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListLmsActivitiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListLmsActivitiesResponse res = resBuilder.build();
