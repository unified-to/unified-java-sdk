...
public class UpdateAdsInsertionorder2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAdsInsertionorder2Request, UpdateAdsInsertionorder2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAdsInsertionorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsInsertionorder2Request.class, new TypeReference<UpdateAdsInsertionorder2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAdsInsertionorder2Request request) {
        ...
        @Override
        public UpdateAdsInsertionorder2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAdsInsertionorder2Response.Builder resBuilder =
            ...
            UpdateAdsInsertionorder2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdsInsertionorder(Utils.unmarshal(response, new TypeReference<AdsInsertionorder>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAdsInsertionorder2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAdsInsertionorder2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAdsInsertionorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsInsertionorder2Request.class, new TypeReference<UpdateAdsInsertionorder2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAdsInsertionorder2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAdsInsertionorder2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAdsInsertionorder2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAdsInsertionorder2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAdsInsertionorder2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AdsInsertionorder>() {})
                            .thenApply(res::withAdsInsertionorder);
                } else {
