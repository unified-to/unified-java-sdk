...
public class GetAnalyticsProperty {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAnalyticsPropertyRequest, GetAnalyticsPropertyResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAnalyticsPropertyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAnalyticsPropertyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAnalyticsPropertyRequest request) {
        ...
        @Override
        public GetAnalyticsPropertyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAnalyticsPropertyResponse.Builder resBuilder =
            ...
            GetAnalyticsPropertyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAnalyticsPropertyRequest, to.unified.unified_java_sdk.models.operations.async.GetAnalyticsPropertyResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAnalyticsPropertyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAnalyticsPropertyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAnalyticsPropertyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAnalyticsPropertyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAnalyticsPropertyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAnalyticsPropertyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAnalyticsPropertyResponse res = resBuilder.build();
