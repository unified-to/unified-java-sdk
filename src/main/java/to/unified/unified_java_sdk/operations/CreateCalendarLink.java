...
public class CreateCalendarLink {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCalendarLinkRequest, CreateCalendarLinkResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCalendarLinkRequest request) {
        ...
        @Override
        public CreateCalendarLinkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCalendarLinkResponse.Builder resBuilder =
            ...
            CreateCalendarLinkResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCalendarLinkRequest, to.unified.unified_java_sdk.models.operations.async.CreateCalendarLinkResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCalendarLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCalendarLinkRequest.class, new TypeReference<CreateCalendarLinkRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCalendarLinkRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCalendarLinkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCalendarLinkResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCalendarLinkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCalendarLinkResponse res = resBuilder.build();
