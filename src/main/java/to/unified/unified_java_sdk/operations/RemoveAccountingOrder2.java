...
public class RemoveAccountingOrder2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingOrder2Request, RemoveAccountingOrder2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingOrder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingOrder2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingOrder2Request request) {
        ...
        @Override
        public RemoveAccountingOrder2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingOrder2Response.Builder resBuilder =
            ...
            RemoveAccountingOrder2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingOrder2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingOrder2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingOrder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingOrder2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingOrder2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingOrder2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingOrder2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingOrder2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingOrder2Response res = resBuilder.build();
