...
public class UpdatePaymentPayment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatePaymentPayment2Request, UpdatePaymentPayment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdatePaymentPayment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePaymentPayment2Request.class, new TypeReference<UpdatePaymentPayment2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePaymentPayment2Request request) {
        ...
        @Override
        public UpdatePaymentPayment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatePaymentPayment2Response.Builder resBuilder =
            ...
            UpdatePaymentPayment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatePaymentPayment2Request, to.unified.unified_java_sdk.models.operations.async.UpdatePaymentPayment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePaymentPayment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePaymentPayment2Request.class, new TypeReference<UpdatePaymentPayment2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatePaymentPayment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdatePaymentPayment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdatePaymentPayment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdatePaymentPayment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdatePaymentPayment2Response res = resBuilder.build();
