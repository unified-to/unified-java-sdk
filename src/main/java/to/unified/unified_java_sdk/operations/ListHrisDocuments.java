...
public class ListHrisDocuments {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisDocumentsRequest, ListHrisDocumentsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisDocumentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisDocumentsRequest request) {
        ...
        @Override
        public ListHrisDocumentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisDocumentsResponse.Builder resBuilder =
            ...
            ListHrisDocumentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisDocuments(Utils.unmarshal(response, new TypeReference<List<HrisDocument>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisDocumentsRequest, to.unified.unified_java_sdk.models.operations.async.ListHrisDocumentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisDocumentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisDocumentsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisDocumentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisDocumentsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisDocumentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisDocumentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<HrisDocument>>() {})
                            .thenApply(res::withHrisDocuments);
                } else {
