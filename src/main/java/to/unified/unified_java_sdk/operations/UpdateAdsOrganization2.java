...
public class UpdateAdsOrganization2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAdsOrganization2Request, UpdateAdsOrganization2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAdsOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsOrganization2Request.class, new TypeReference<UpdateAdsOrganization2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAdsOrganization2Request request) {
        ...
        @Override
        public UpdateAdsOrganization2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAdsOrganization2Response.Builder resBuilder =
            ...
            UpdateAdsOrganization2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdsOrganization(Utils.unmarshal(response, new TypeReference<AdsOrganization>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAdsOrganization2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAdsOrganization2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAdsOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsOrganization2Request.class, new TypeReference<UpdateAdsOrganization2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAdsOrganization2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAdsOrganization2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAdsOrganization2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAdsOrganization2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAdsOrganization2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AdsOrganization>() {})
                            .thenApply(res::withAdsOrganization);
                } else {
