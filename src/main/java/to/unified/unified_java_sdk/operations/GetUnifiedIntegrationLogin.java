...
public class GetUnifiedIntegrationLogin {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetUnifiedIntegrationLoginRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUnifiedIntegrationLoginRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUnifiedIntegrationLoginRequest request) throws Exception {
        ...
        @Override
        public GetUnifiedIntegrationLoginResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUnifiedIntegrationLoginResponse.Builder resBuilder =
            ...
            GetUnifiedIntegrationLoginResponse res = resBuilder.build();
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUnifiedIntegrationLoginRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetUnifiedIntegrationLoginResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetUnifiedIntegrationLoginResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetUnifiedIntegrationLoginResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetUnifiedIntegrationLoginResponse res = resBuilder.build();
