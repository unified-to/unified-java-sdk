...
public class GetCalendarWebinar2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCalendarWebinar2Request, GetCalendarWebinar2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCalendarWebinar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarWebinar2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCalendarWebinar2Request request) {
        ...
        @Override
        public GetCalendarWebinar2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCalendarWebinar2Response.Builder resBuilder =
            ...
            GetCalendarWebinar2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCalendarWebinar2Request, to.unified.unified_java_sdk.models.operations.async.GetCalendarWebinar2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCalendarWebinar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarWebinar2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCalendarWebinar2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCalendarWebinar2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCalendarWebinar2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCalendarWebinar2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCalendarWebinar2Response res = resBuilder.build();
