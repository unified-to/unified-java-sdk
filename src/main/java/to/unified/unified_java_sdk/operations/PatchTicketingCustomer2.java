...
public class PatchTicketingCustomer2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchTicketingCustomer2Request, PatchTicketingCustomer2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchTicketingCustomer2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTicketingCustomer2Request.class, new TypeReference<PatchTicketingCustomer2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchTicketingCustomer2Request request) {
        ...
        @Override
        public PatchTicketingCustomer2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchTicketingCustomer2Response.Builder resBuilder =
            ...
            PatchTicketingCustomer2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchTicketingCustomer2Request, to.unified.unified_java_sdk.models.operations.async.PatchTicketingCustomer2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchTicketingCustomer2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTicketingCustomer2Request.class, new TypeReference<PatchTicketingCustomer2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchTicketingCustomer2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchTicketingCustomer2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchTicketingCustomer2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchTicketingCustomer2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchTicketingCustomer2Response res = resBuilder.build();
