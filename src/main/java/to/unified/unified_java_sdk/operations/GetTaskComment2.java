...
public class GetTaskComment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTaskComment2Request, GetTaskComment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTaskComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskComment2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTaskComment2Request request) {
        ...
        @Override
        public GetTaskComment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTaskComment2Response.Builder resBuilder =
            ...
            GetTaskComment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTaskComment2Request, to.unified.unified_java_sdk.models.operations.async.GetTaskComment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTaskComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskComment2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTaskComment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetTaskComment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetTaskComment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetTaskComment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetTaskComment2Response res = resBuilder.build();
