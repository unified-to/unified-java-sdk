...
public class GetHrisDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisDocumentRequest, GetHrisDocumentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisDocumentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisDocumentRequest request) {
        ...
        @Override
        public GetHrisDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisDocumentResponse.Builder resBuilder =
            ...
            GetHrisDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisDocumentRequest, to.unified.unified_java_sdk.models.operations.async.GetHrisDocumentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisDocumentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisDocumentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisDocumentResponse res = resBuilder.build();
