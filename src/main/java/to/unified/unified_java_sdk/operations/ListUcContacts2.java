...
public class ListUcContacts2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUcContacts2Request, ListUcContacts2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListUcContacts2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListUcContacts2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUcContacts2Request request) {
        ...
        @Override
        public ListUcContacts2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUcContacts2Response.Builder resBuilder =
            ...
            ListUcContacts2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUcContacts(Utils.unmarshal(response, new TypeReference<List<UcContact>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUcContacts2Request, to.unified.unified_java_sdk.models.operations.async.ListUcContacts2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListUcContacts2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListUcContacts2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUcContacts2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListUcContacts2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListUcContacts2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListUcContacts2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListUcContacts2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<UcContact>>() {})
                            .thenApply(res::withUcContacts);
                } else {
