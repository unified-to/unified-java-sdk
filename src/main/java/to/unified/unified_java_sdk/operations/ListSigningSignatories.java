...
public class ListSigningSignatories {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSigningSignatoriesRequest, ListSigningSignatoriesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSigningSignatoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSigningSignatoriesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSigningSignatoriesRequest request) {
        ...
        @Override
        public ListSigningSignatoriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSigningSignatoriesResponse.Builder resBuilder =
            ...
            ListSigningSignatoriesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSigningSignatoriesRequest, to.unified.unified_java_sdk.models.operations.async.ListSigningSignatoriesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSigningSignatoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSigningSignatoriesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSigningSignatoriesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListSigningSignatoriesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListSigningSignatoriesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListSigningSignatoriesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListSigningSignatoriesResponse res = resBuilder.build();
