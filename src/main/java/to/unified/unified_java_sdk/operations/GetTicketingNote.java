...
public class GetTicketingNote {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTicketingNoteRequest, GetTicketingNoteResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTicketingNoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTicketingNoteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTicketingNoteRequest request) {
        ...
        @Override
        public GetTicketingNoteResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTicketingNoteRequest, to.unified.unified_java_sdk.models.operations.async.GetTicketingNoteResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTicketingNoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTicketingNoteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTicketingNoteRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetTicketingNoteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetTicketingNoteResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetTicketingNoteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetTicketingNoteResponse res = resBuilder.build();
