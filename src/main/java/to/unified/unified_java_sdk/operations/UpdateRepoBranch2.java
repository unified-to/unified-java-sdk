...
public class UpdateRepoBranch2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateRepoBranch2Request, UpdateRepoBranch2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateRepoBranch2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoBranch2Request.class, new TypeReference<UpdateRepoBranch2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateRepoBranch2Request request) {
        ...
        @Override
        public UpdateRepoBranch2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateRepoBranch2Response.Builder resBuilder =
            ...
            UpdateRepoBranch2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRepoBranch(Utils.unmarshal(response, new TypeReference<RepoBranch>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateRepoBranch2Request, to.unified.unified_java_sdk.models.operations.async.UpdateRepoBranch2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateRepoBranch2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoBranch2Request.class, new TypeReference<UpdateRepoBranch2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateRepoBranch2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateRepoBranch2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateRepoBranch2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateRepoBranch2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateRepoBranch2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RepoBranch>() {})
                            .thenApply(res::withRepoBranch);
                } else {
