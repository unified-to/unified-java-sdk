...
public class RemoveDatastoreRecord {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveDatastoreRecordRequest, RemoveDatastoreRecordResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveDatastoreRecordRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDatastoreRecordRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveDatastoreRecordRequest request) {
        ...
        @Override
        public RemoveDatastoreRecordResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveDatastoreRecordResponse.Builder resBuilder =
            ...
            RemoveDatastoreRecordResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveDatastoreRecordRequest, to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreRecordResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveDatastoreRecordRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDatastoreRecordRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveDatastoreRecordRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreRecordResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreRecordResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreRecordResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreRecordResponse res = resBuilder.build();
