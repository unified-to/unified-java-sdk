...
public class RemoveMartechList2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveMartechList2Request, RemoveMartechList2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveMartechList2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMartechList2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveMartechList2Request request) {
        ...
        @Override
        public RemoveMartechList2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveMartechList2Response.Builder resBuilder =
            ...
            RemoveMartechList2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveMartechList2Request, to.unified.unified_java_sdk.models.operations.async.RemoveMartechList2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveMartechList2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMartechList2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveMartechList2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveMartechList2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveMartechList2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveMartechList2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveMartechList2Response res = resBuilder.build();
