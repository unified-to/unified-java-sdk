...
public class GetAccountingQuote {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingQuoteRequest, GetAccountingQuoteResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingQuoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingQuoteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingQuoteRequest request) {
        ...
        @Override
        public GetAccountingQuoteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingQuoteResponse.Builder resBuilder =
            ...
            GetAccountingQuoteResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingQuoteRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingQuoteResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingQuoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingQuoteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingQuoteRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingQuoteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingQuoteResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingQuoteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingQuoteResponse res = resBuilder.build();
