...
public class UpdatePerformanceGoal {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatePerformanceGoalRequest, UpdatePerformanceGoalResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdatePerformanceGoalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePerformanceGoalRequest.class, new TypeReference<UpdatePerformanceGoalRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePerformanceGoalRequest request) {
        ...
        @Override
        public UpdatePerformanceGoalResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatePerformanceGoalResponse.Builder resBuilder =
            ...
            UpdatePerformanceGoalResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatePerformanceGoalRequest, to.unified.unified_java_sdk.models.operations.async.UpdatePerformanceGoalResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePerformanceGoalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePerformanceGoalRequest.class, new TypeReference<UpdatePerformanceGoalRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatePerformanceGoalRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdatePerformanceGoalResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdatePerformanceGoalResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdatePerformanceGoalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdatePerformanceGoalResponse res = resBuilder.build();
