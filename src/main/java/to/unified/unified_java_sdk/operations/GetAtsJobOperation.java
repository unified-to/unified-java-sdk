...
public class GetAtsJobOperation implements RequestOperation<GetAtsJobRequest, GetAtsJobResponse> {
    ...
    public GetAtsJobOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAtsJobRequest request) throws Exception {
