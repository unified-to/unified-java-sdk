...
public class RemoveAtsCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAtsCompanyRequest, RemoveAtsCompanyResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(RemoveAtsCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsCompanyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAtsCompanyRequest request) throws Exception {
        ...
        @Override
        public RemoveAtsCompanyResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAtsCompanyResponse.Builder resBuilder =
            ...
            RemoveAtsCompanyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAtsCompanyRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAtsCompanyResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAtsCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsCompanyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAtsCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAtsCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAtsCompanyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAtsCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAtsCompanyResponse res = resBuilder.build();
