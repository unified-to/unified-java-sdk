...
public class UpdateLmsClass {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLmsClassRequest, UpdateLmsClassResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateLmsClassRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsClassRequest.class, new TypeReference<UpdateLmsClassRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLmsClassRequest request) {
        ...
        @Override
        public UpdateLmsClassResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateLmsClassResponse.Builder resBuilder =
            ...
            UpdateLmsClassResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLmsClassRequest, to.unified.unified_java_sdk.models.operations.async.UpdateLmsClassResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLmsClassRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsClassRequest.class, new TypeReference<UpdateLmsClassRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLmsClassRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateLmsClassResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateLmsClassResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateLmsClassResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateLmsClassResponse res = resBuilder.build();
