...
public class GetMartechMember {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMartechMemberRequest, GetMartechMemberResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetMartechMemberRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMartechMemberRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMartechMemberRequest request) {
        ...
        @Override
        public GetMartechMemberResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMartechMemberResponse.Builder resBuilder =
            ...
            GetMartechMemberResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMartechMemberRequest, to.unified.unified_java_sdk.models.operations.async.GetMartechMemberResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMartechMemberRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMartechMemberRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMartechMemberRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetMartechMemberResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetMartechMemberResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetMartechMemberResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetMartechMemberResponse res = resBuilder.build();
