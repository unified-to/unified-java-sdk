...
public class PatchPaymentSubscription {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchPaymentSubscriptionRequest request) throws Exception {
        ...
        @Override
        public PatchPaymentSubscriptionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaymentSubscription out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentSubscription(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
