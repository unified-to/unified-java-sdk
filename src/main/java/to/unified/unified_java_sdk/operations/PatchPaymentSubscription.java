...
public class PatchPaymentSubscription {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchPaymentSubscriptionRequest, PatchPaymentSubscriptionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchPaymentSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPaymentSubscriptionRequest.class, new TypeReference<PatchPaymentSubscriptionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchPaymentSubscriptionRequest request) {
        ...
        @Override
        public PatchPaymentSubscriptionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchPaymentSubscriptionResponse.Builder resBuilder =
            ...
            PatchPaymentSubscriptionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchPaymentSubscriptionRequest, to.unified.unified_java_sdk.models.operations.async.PatchPaymentSubscriptionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchPaymentSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPaymentSubscriptionRequest.class, new TypeReference<PatchPaymentSubscriptionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchPaymentSubscriptionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchPaymentSubscriptionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchPaymentSubscriptionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchPaymentSubscriptionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchPaymentSubscriptionResponse res = resBuilder.build();
