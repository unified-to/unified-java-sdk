...
public class ListTaskComments {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTaskCommentsRequest, ListTaskCommentsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListTaskCommentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaskCommentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTaskCommentsRequest request) {
        ...
        @Override
        public ListTaskCommentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTaskCommentsResponse.Builder resBuilder =
            ...
            ListTaskCommentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTaskCommentsRequest, to.unified.unified_java_sdk.models.operations.async.ListTaskCommentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListTaskCommentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaskCommentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTaskCommentsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListTaskCommentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListTaskCommentsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListTaskCommentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListTaskCommentsResponse res = resBuilder.build();
