...
public class ListTaskComments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTaskCommentsRequest request) throws Exception {
        ...
        @Override
        public ListTaskCommentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<TaskComment> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTaskComments(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
