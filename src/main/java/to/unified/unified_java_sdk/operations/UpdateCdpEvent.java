...
public class UpdateCdpEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCdpEventRequest, UpdateCdpEventResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCdpEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCdpEventRequest.class, new TypeReference<UpdateCdpEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCdpEventRequest request) {
        ...
        @Override
        public UpdateCdpEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCdpEventResponse.Builder resBuilder =
            ...
            UpdateCdpEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCdpEventRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCdpEventResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCdpEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCdpEventRequest.class, new TypeReference<UpdateCdpEventRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCdpEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCdpEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCdpEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCdpEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCdpEventResponse res = resBuilder.build();
