...
public class UpdateAtsDocumentOperation implements RequestOperation<UpdateAtsDocumentRequest, UpdateAtsDocumentResponse> {
    ...
    public UpdateAtsDocumentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAtsDocumentRequest request) throws Exception {
