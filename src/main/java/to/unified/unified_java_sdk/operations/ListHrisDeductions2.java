...
public class ListHrisDeductions2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisDeductions2Request, ListHrisDeductions2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisDeductions2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisDeductions2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisDeductions2Request request) {
        ...
        @Override
        public ListHrisDeductions2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisDeductions2Response.Builder resBuilder =
            ...
            ListHrisDeductions2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisDeductions(Utils.unmarshal(response, new TypeReference<List<HrisDeduction>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisDeductions2Request, to.unified.unified_java_sdk.models.operations.async.ListHrisDeductions2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisDeductions2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisDeductions2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisDeductions2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisDeductions2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisDeductions2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisDeductions2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisDeductions2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<HrisDeduction>>() {})
                            .thenApply(res::withHrisDeductions);
                } else {
