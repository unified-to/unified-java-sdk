...
public class PatchShippingLabel2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchShippingLabel2Request, PatchShippingLabel2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchShippingLabel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchShippingLabel2Request.class, new TypeReference<PatchShippingLabel2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchShippingLabel2Request request) {
        ...
        @Override
        public PatchShippingLabel2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchShippingLabel2Response.Builder resBuilder =
            ...
            PatchShippingLabel2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchShippingLabel2Request, to.unified.unified_java_sdk.models.operations.async.PatchShippingLabel2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchShippingLabel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchShippingLabel2Request.class, new TypeReference<PatchShippingLabel2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchShippingLabel2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchShippingLabel2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchShippingLabel2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchShippingLabel2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchShippingLabel2Response res = resBuilder.build();
