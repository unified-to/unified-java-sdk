...
public class PatchCdpActivation {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCdpActivationRequest, PatchCdpActivationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCdpActivationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCdpActivationRequest.class, new TypeReference<PatchCdpActivationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCdpActivationRequest request) {
        ...
        @Override
        public PatchCdpActivationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCdpActivationResponse.Builder resBuilder =
            ...
            PatchCdpActivationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCdpActivationRequest, to.unified.unified_java_sdk.models.operations.async.PatchCdpActivationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCdpActivationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCdpActivationRequest.class, new TypeReference<PatchCdpActivationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCdpActivationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCdpActivationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCdpActivationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCdpActivationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCdpActivationResponse res = resBuilder.build();
