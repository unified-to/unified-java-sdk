...
public class UpdateLmsInstructor {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLmsInstructorRequest, UpdateLmsInstructorResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateLmsInstructorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsInstructorRequest.class, new TypeReference<UpdateLmsInstructorRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLmsInstructorRequest request) {
        ...
        @Override
        public UpdateLmsInstructorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateLmsInstructorResponse.Builder resBuilder =
            ...
            UpdateLmsInstructorResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLmsInstructorRequest, to.unified.unified_java_sdk.models.operations.async.UpdateLmsInstructorResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLmsInstructorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsInstructorRequest.class, new TypeReference<UpdateLmsInstructorRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLmsInstructorRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateLmsInstructorResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateLmsInstructorResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateLmsInstructorResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateLmsInstructorResponse res = resBuilder.build();
