...
public class UpdateLmsInstructor {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLmsInstructorRequest request) throws Exception {
        ...
        @Override
        public UpdateLmsInstructorResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    LmsInstructor out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withLmsInstructor(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
