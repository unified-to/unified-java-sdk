...
public class ListUnifiedWebhooksOperation implements RequestOperation<ListUnifiedWebhooksRequest, ListUnifiedWebhooksResponse> {
    ...
    public ListUnifiedWebhooksOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListUnifiedWebhooksRequest request) throws Exception {
