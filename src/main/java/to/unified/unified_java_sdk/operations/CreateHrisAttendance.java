...
public class CreateHrisAttendance {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisAttendanceRequest, CreateHrisAttendanceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisAttendanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisAttendanceRequest.class, new TypeReference<CreateHrisAttendanceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisAttendanceRequest request) {
        ...
        @Override
        public CreateHrisAttendanceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisAttendanceResponse.Builder resBuilder =
            ...
            CreateHrisAttendanceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisAttendanceRequest, to.unified.unified_java_sdk.models.operations.async.CreateHrisAttendanceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisAttendanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisAttendanceRequest.class, new TypeReference<CreateHrisAttendanceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisAttendanceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisAttendanceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisAttendanceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisAttendanceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisAttendanceResponse res = resBuilder.build();
