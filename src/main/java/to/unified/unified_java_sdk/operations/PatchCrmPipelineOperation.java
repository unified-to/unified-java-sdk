...
public class PatchCrmPipelineOperation implements RequestOperation<PatchCrmPipelineRequest, PatchCrmPipelineResponse> {
    ...
    public PatchCrmPipelineOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchCrmPipelineRequest request) throws Exception {
