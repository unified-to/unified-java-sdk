...
public class PatchHrisDeduction {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisDeductionRequest, PatchHrisDeductionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisDeductionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisDeductionRequest.class, new TypeReference<PatchHrisDeductionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisDeductionRequest request) {
        ...
        @Override
        public PatchHrisDeductionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisDeductionResponse.Builder resBuilder =
            ...
            PatchHrisDeductionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisDeductionRequest, to.unified.unified_java_sdk.models.operations.async.PatchHrisDeductionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisDeductionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisDeductionRequest.class, new TypeReference<PatchHrisDeductionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisDeductionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisDeductionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisDeductionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisDeductionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisDeductionResponse res = resBuilder.build();
