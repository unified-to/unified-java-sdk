...
public class GetCommerceReservation {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceReservationRequest, GetCommerceReservationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommerceReservationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceReservationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceReservationRequest request) {
        ...
        @Override
        public GetCommerceReservationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommerceReservationResponse.Builder resBuilder =
                    GetCommerceReservationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetCommerceReservationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommerceReservationRequest, to.unified.unified_java_sdk.models.operations.async.GetCommerceReservationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommerceReservationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceReservationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommerceReservationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCommerceReservationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCommerceReservationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCommerceReservationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCommerceReservationResponse res = resBuilder.build();
