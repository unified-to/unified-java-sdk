...
public class PatchUcCommentOperation implements RequestOperation<PatchUcCommentRequest, PatchUcCommentResponse> {
    ...
    public PatchUcCommentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchUcCommentRequest request) throws Exception {
