...
public class ListAccountingTaxratesOperation implements RequestOperation<ListAccountingTaxratesRequest, ListAccountingTaxratesResponse> {
    ...
    public ListAccountingTaxratesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAccountingTaxratesRequest request) throws Exception {
