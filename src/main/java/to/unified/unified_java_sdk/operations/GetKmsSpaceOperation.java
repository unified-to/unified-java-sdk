...
public class GetKmsSpaceOperation implements RequestOperation<GetKmsSpaceRequest, GetKmsSpaceResponse> {
    ...
    public GetKmsSpaceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetKmsSpaceRequest request) throws Exception {
