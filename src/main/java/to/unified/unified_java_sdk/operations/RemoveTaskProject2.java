...
public class RemoveTaskProject2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveTaskProject2Request, RemoveTaskProject2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveTaskProject2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTaskProject2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveTaskProject2Request request) {
        ...
        @Override
        public RemoveTaskProject2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveTaskProject2Response.Builder resBuilder =
            ...
            RemoveTaskProject2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveTaskProject2Request, to.unified.unified_java_sdk.models.operations.async.RemoveTaskProject2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveTaskProject2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTaskProject2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveTaskProject2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveTaskProject2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveTaskProject2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveTaskProject2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveTaskProject2Response res = resBuilder.build();
