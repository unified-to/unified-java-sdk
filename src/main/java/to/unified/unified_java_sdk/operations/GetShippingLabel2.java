...
public class GetShippingLabel2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetShippingLabel2Request, GetShippingLabel2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetShippingLabel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingLabel2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetShippingLabel2Request request) {
        ...
        @Override
        public GetShippingLabel2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetShippingLabel2Response.Builder resBuilder =
            ...
            GetShippingLabel2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetShippingLabel2Request, to.unified.unified_java_sdk.models.operations.async.GetShippingLabel2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetShippingLabel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingLabel2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetShippingLabel2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetShippingLabel2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetShippingLabel2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetShippingLabel2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetShippingLabel2Response res = resBuilder.build();
