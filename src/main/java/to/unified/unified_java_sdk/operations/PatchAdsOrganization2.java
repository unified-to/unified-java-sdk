...
public class PatchAdsOrganization2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAdsOrganization2Request, PatchAdsOrganization2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAdsOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsOrganization2Request.class, new TypeReference<PatchAdsOrganization2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAdsOrganization2Request request) {
        ...
        @Override
        public PatchAdsOrganization2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAdsOrganization2Response.Builder resBuilder =
            ...
            PatchAdsOrganization2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAdsOrganization2Request, to.unified.unified_java_sdk.models.operations.async.PatchAdsOrganization2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAdsOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsOrganization2Request.class, new TypeReference<PatchAdsOrganization2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAdsOrganization2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAdsOrganization2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAdsOrganization2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAdsOrganization2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAdsOrganization2Response res = resBuilder.build();
