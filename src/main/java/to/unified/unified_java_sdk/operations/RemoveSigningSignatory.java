...
public class RemoveSigningSignatory {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveSigningSignatoryRequest, RemoveSigningSignatoryResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveSigningSignatoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveSigningSignatoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveSigningSignatoryRequest request) {
        ...
        @Override
        public RemoveSigningSignatoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveSigningSignatoryResponse.Builder resBuilder =
            ...
            RemoveSigningSignatoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveSigningSignatoryRequest, to.unified.unified_java_sdk.models.operations.async.RemoveSigningSignatoryResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveSigningSignatoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveSigningSignatoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveSigningSignatoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveSigningSignatoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveSigningSignatoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveSigningSignatoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveSigningSignatoryResponse res = resBuilder.build();
