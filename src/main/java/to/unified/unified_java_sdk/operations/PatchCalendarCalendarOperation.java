...
public class PatchCalendarCalendarOperation implements RequestOperation<PatchCalendarCalendarRequest, PatchCalendarCalendarResponse> {
    ...
    public PatchCalendarCalendarOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchCalendarCalendarRequest request) throws Exception {
