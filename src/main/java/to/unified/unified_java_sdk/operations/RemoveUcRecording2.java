...
public class RemoveUcRecording2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveUcRecording2Request, RemoveUcRecording2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveUcRecording2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUcRecording2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveUcRecording2Request request) {
        ...
        @Override
        public RemoveUcRecording2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveUcRecording2Response.Builder resBuilder =
            ...
            RemoveUcRecording2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveUcRecording2Request, to.unified.unified_java_sdk.models.operations.async.RemoveUcRecording2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveUcRecording2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUcRecording2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveUcRecording2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveUcRecording2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveUcRecording2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveUcRecording2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveUcRecording2Response res = resBuilder.build();
