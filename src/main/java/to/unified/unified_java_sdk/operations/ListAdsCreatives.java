...
public class ListAdsCreatives {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsCreativesRequest, ListAdsCreativesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsCreativesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsCreativesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsCreativesRequest request) {
        ...
        @Override
        public ListAdsCreativesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsCreativesResponse.Builder resBuilder =
            ...
            ListAdsCreativesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsCreativesRequest, to.unified.unified_java_sdk.models.operations.async.ListAdsCreativesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsCreativesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsCreativesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsCreativesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsCreativesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsCreativesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsCreativesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsCreativesResponse res = resBuilder.build();
