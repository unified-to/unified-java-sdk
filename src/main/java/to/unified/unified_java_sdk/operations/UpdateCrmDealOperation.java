...
public class UpdateCrmDealOperation implements RequestOperation<UpdateCrmDealRequest, UpdateCrmDealResponse> {
    ...
    public UpdateCrmDealOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateCrmDealRequest request) throws Exception {
