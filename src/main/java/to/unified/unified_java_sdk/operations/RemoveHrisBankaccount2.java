...
public class RemoveHrisBankaccount2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisBankaccount2Request, RemoveHrisBankaccount2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisBankaccount2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisBankaccount2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisBankaccount2Request request) {
        ...
        @Override
        public RemoveHrisBankaccount2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisBankaccount2Response.Builder resBuilder =
            ...
            RemoveHrisBankaccount2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisBankaccount2Request, to.unified.unified_java_sdk.models.operations.async.RemoveHrisBankaccount2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisBankaccount2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisBankaccount2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisBankaccount2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisBankaccount2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisBankaccount2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisBankaccount2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisBankaccount2Response res = resBuilder.build();
