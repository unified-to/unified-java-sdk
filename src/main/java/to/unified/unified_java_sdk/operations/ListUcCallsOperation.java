...
public class ListUcCallsOperation implements RequestOperation<ListUcCallsRequest, ListUcCallsResponse> {
    ...
    public ListUcCallsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListUcCallsRequest request) throws Exception {
