...
public class CreateMartechCampaign2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateMartechCampaign2Request, CreateMartechCampaign2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateMartechCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMartechCampaign2Request.class, new TypeReference<CreateMartechCampaign2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMartechCampaign2Request request) {
        ...
        @Override
        public CreateMartechCampaign2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateMartechCampaign2Response.Builder resBuilder =
            ...
            CreateMartechCampaign2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMarketingCampaign(Utils.unmarshal(response, new TypeReference<MarketingCampaign>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateMartechCampaign2Request, to.unified.unified_java_sdk.models.operations.async.CreateMartechCampaign2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateMartechCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMartechCampaign2Request.class, new TypeReference<CreateMartechCampaign2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateMartechCampaign2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateMartechCampaign2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateMartechCampaign2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateMartechCampaign2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateMartechCampaign2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MarketingCampaign>() {})
                            .thenApply(res::withMarketingCampaign);
                } else {
