...
public class GetHrisTimeshiftOperation implements RequestOperation<GetHrisTimeshiftRequest, GetHrisTimeshiftResponse> {
    ...
    public GetHrisTimeshiftOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetHrisTimeshiftRequest request) throws Exception {
