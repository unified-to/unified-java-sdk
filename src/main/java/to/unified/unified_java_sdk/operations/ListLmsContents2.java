...
public class ListLmsContents2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListLmsContents2Request, ListLmsContents2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListLmsContents2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsContents2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsContents2Request request) {
        ...
        @Override
        public ListLmsContents2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListLmsContents2Response.Builder resBuilder =
            ...
            ListLmsContents2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLmsContents(Utils.unmarshal(response, new TypeReference<List<LmsContent>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLmsContents2Request, to.unified.unified_java_sdk.models.operations.async.ListLmsContents2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListLmsContents2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsContents2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListLmsContents2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListLmsContents2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListLmsContents2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListLmsContents2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListLmsContents2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<LmsContent>>() {})
                            .thenApply(res::withLmsContents);
                } else {
