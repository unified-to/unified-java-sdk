...
public class GetAdsGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAdsGroupRequest, GetAdsGroupResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAdsGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAdsGroupRequest request) {
        ...
        @Override
        public GetAdsGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAdsGroupResponse.Builder resBuilder =
                    GetAdsGroupResponse
                            .builder()
            ...
            GetAdsGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAdsGroupRequest, to.unified.unified_java_sdk.models.operations.async.GetAdsGroupResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAdsGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAdsGroupRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAdsGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAdsGroupResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAdsGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAdsGroupResponse res = resBuilder.build();
