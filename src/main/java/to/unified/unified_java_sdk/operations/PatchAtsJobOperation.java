...
public class PatchAtsJobOperation implements RequestOperation<PatchAtsJobRequest, PatchAtsJobResponse> {
    ...
    public PatchAtsJobOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchAtsJobRequest request) throws Exception {
