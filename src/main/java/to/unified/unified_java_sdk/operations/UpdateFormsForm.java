...
public class UpdateFormsForm {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateFormsFormRequest, UpdateFormsFormResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateFormsFormRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateFormsFormRequest.class, new TypeReference<UpdateFormsFormRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateFormsFormRequest request) {
        ...
        @Override
        public UpdateFormsFormResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateFormsFormResponse.Builder resBuilder =
            ...
            UpdateFormsFormResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateFormsFormRequest, to.unified.unified_java_sdk.models.operations.async.UpdateFormsFormResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateFormsFormRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateFormsFormRequest.class, new TypeReference<UpdateFormsFormRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateFormsFormRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateFormsFormResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateFormsFormResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateFormsFormResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateFormsFormResponse res = resBuilder.build();
