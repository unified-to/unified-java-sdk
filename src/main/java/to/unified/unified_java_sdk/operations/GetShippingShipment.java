...
public class GetShippingShipment {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetShippingShipmentRequest, GetShippingShipmentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetShippingShipmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingShipmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetShippingShipmentRequest request) {
        ...
        @Override
        public GetShippingShipmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetShippingShipmentResponse.Builder resBuilder =
            ...
            GetShippingShipmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetShippingShipmentRequest, to.unified.unified_java_sdk.models.operations.async.GetShippingShipmentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetShippingShipmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingShipmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetShippingShipmentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetShippingShipmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetShippingShipmentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetShippingShipmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetShippingShipmentResponse res = resBuilder.build();
