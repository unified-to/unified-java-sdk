...
public class ListHrisDevices {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisDevicesRequest, ListHrisDevicesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisDevicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisDevicesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisDevicesRequest request) {
        ...
        @Override
        public ListHrisDevicesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisDevicesResponse.Builder resBuilder =
            ...
            ListHrisDevicesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisDevicesRequest, to.unified.unified_java_sdk.models.operations.async.ListHrisDevicesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisDevicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisDevicesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisDevicesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisDevicesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisDevicesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisDevicesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisDevicesResponse res = resBuilder.build();
