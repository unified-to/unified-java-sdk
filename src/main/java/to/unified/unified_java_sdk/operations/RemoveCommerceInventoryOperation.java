...
public class RemoveCommerceInventoryOperation implements RequestOperation<RemoveCommerceInventoryRequest, RemoveCommerceInventoryResponse> {
    ...
    public RemoveCommerceInventoryOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveCommerceInventoryRequest request) throws Exception {
