...
public class CreatePerformanceGoal {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePerformanceGoalRequest, CreatePerformanceGoalResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreatePerformanceGoalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePerformanceGoalRequest.class, new TypeReference<CreatePerformanceGoalRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePerformanceGoalRequest request) {
        ...
        @Override
        public CreatePerformanceGoalResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePerformanceGoalResponse.Builder resBuilder =
            ...
            CreatePerformanceGoalResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPerformanceGoal(Utils.unmarshal(response, new TypeReference<PerformanceGoal>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePerformanceGoalRequest, to.unified.unified_java_sdk.models.operations.async.CreatePerformanceGoalResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreatePerformanceGoalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePerformanceGoalRequest.class, new TypeReference<CreatePerformanceGoalRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePerformanceGoalRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreatePerformanceGoalResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreatePerformanceGoalResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreatePerformanceGoalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreatePerformanceGoalResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PerformanceGoal>() {})
                            .thenApply(res::withPerformanceGoal);
                } else {
