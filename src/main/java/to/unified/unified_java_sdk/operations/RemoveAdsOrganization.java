...
public class RemoveAdsOrganization {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAdsOrganizationRequest, RemoveAdsOrganizationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAdsOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsOrganizationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAdsOrganizationRequest request) {
        ...
        @Override
        public RemoveAdsOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAdsOrganizationResponse.Builder resBuilder =
            ...
            RemoveAdsOrganizationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAdsOrganizationRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAdsOrganizationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAdsOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsOrganizationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAdsOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAdsOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAdsOrganizationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAdsOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAdsOrganizationResponse res = resBuilder.build();
