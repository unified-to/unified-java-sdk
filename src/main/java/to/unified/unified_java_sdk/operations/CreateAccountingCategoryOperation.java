...
public class CreateAccountingCategoryOperation implements RequestOperation<CreateAccountingCategoryRequest, CreateAccountingCategoryResponse> {
    ...
    public CreateAccountingCategoryOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAccountingCategoryRequest request) throws Exception {
