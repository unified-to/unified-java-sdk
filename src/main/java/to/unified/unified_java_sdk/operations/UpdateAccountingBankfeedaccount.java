...
public class UpdateAccountingBankfeedaccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAccountingBankfeedaccountRequest, UpdateAccountingBankfeedaccountResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAccountingBankfeedaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingBankfeedaccountRequest.class, new TypeReference<UpdateAccountingBankfeedaccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAccountingBankfeedaccountRequest request) {
        ...
        @Override
        public UpdateAccountingBankfeedaccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAccountingBankfeedaccountResponse.Builder resBuilder =
                    UpdateAccountingBankfeedaccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            UpdateAccountingBankfeedaccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountingBankfeedaccount(Utils.unmarshal(response, new TypeReference<AccountingBankfeedaccount>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAccountingBankfeedaccountRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAccountingBankfeedaccountResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAccountingBankfeedaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingBankfeedaccountRequest.class, new TypeReference<UpdateAccountingBankfeedaccountRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAccountingBankfeedaccountRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAccountingBankfeedaccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingBankfeedaccountResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAccountingBankfeedaccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingBankfeedaccountResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountingBankfeedaccount>() {})
                            .thenApply(res::withAccountingBankfeedaccount);
                } else {
