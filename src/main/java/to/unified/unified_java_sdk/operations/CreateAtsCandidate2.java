...
public class CreateAtsCandidate2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAtsCandidate2Request, CreateAtsCandidate2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAtsCandidate2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsCandidate2Request.class, new TypeReference<CreateAtsCandidate2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsCandidate2Request request) {
        ...
        @Override
        public CreateAtsCandidate2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAtsCandidate2Response.Builder resBuilder =
            ...
            CreateAtsCandidate2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAtsCandidate2Request, to.unified.unified_java_sdk.models.operations.async.CreateAtsCandidate2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAtsCandidate2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsCandidate2Request.class, new TypeReference<CreateAtsCandidate2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAtsCandidate2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAtsCandidate2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAtsCandidate2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAtsCandidate2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAtsCandidate2Response res = resBuilder.build();
