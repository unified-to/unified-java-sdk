...
public class ListAtsCompanies2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAtsCompanies2Request, ListAtsCompanies2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAtsCompanies2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsCompanies2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsCompanies2Request request) {
        ...
        @Override
        public ListAtsCompanies2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsCompanies2Response.Builder resBuilder =
            ...
            ListAtsCompanies2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsCompanies(Utils.unmarshal(response, new TypeReference<List<AtsCompany>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsCompanies2Request, to.unified.unified_java_sdk.models.operations.async.ListAtsCompanies2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsCompanies2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsCompanies2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsCompanies2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsCompanies2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsCompanies2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsCompanies2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsCompanies2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AtsCompany>>() {})
                            .thenApply(res::withAtsCompanies);
                } else {
