...
public class PatchLmsCollection {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchLmsCollectionRequest, PatchLmsCollectionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchLmsCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsCollectionRequest.class, new TypeReference<PatchLmsCollectionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchLmsCollectionRequest request) {
        ...
        @Override
        public PatchLmsCollectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchLmsCollectionResponse.Builder resBuilder =
            ...
            PatchLmsCollectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchLmsCollectionRequest, to.unified.unified_java_sdk.models.operations.async.PatchLmsCollectionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchLmsCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsCollectionRequest.class, new TypeReference<PatchLmsCollectionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchLmsCollectionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchLmsCollectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchLmsCollectionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchLmsCollectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchLmsCollectionResponse res = resBuilder.build();
