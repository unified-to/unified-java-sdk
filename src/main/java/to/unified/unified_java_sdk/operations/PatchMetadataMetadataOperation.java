...
public class PatchMetadataMetadataOperation implements RequestOperation<PatchMetadataMetadataRequest, PatchMetadataMetadataResponse> {
    ...
    public PatchMetadataMetadataOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchMetadataMetadataRequest request) throws Exception {
