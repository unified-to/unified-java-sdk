...
public class UpdateDatastoreTable2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateDatastoreTable2Request, UpdateDatastoreTable2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateDatastoreTable2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDatastoreTable2Request.class, new TypeReference<UpdateDatastoreTable2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateDatastoreTable2Request request) {
        ...
        @Override
        public UpdateDatastoreTable2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateDatastoreTable2Response.Builder resBuilder =
            ...
            UpdateDatastoreTable2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateDatastoreTable2Request, to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreTable2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateDatastoreTable2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDatastoreTable2Request.class, new TypeReference<UpdateDatastoreTable2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateDatastoreTable2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreTable2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreTable2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreTable2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreTable2Response res = resBuilder.build();
