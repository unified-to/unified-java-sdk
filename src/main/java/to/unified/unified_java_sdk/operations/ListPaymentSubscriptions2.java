...
public class ListPaymentSubscriptions2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPaymentSubscriptions2Request, ListPaymentSubscriptions2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPaymentSubscriptions2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentSubscriptions2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentSubscriptions2Request request) {
        ...
        @Override
        public ListPaymentSubscriptions2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPaymentSubscriptions2Response.Builder resBuilder =
            ...
            ListPaymentSubscriptions2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentSubscriptions(Utils.unmarshal(response, new TypeReference<List<PaymentSubscription>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentSubscriptions2Request, to.unified.unified_java_sdk.models.operations.async.ListPaymentSubscriptions2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPaymentSubscriptions2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentSubscriptions2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPaymentSubscriptions2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListPaymentSubscriptions2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListPaymentSubscriptions2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListPaymentSubscriptions2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListPaymentSubscriptions2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<PaymentSubscription>>() {})
                            .thenApply(res::withPaymentSubscriptions);
                } else {
