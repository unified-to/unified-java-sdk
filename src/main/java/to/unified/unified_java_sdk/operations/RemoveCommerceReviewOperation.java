...
public class RemoveCommerceReviewOperation implements RequestOperation<RemoveCommerceReviewRequest, RemoveCommerceReviewResponse> {
    ...
    public RemoveCommerceReviewOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveCommerceReviewRequest request) throws Exception {
