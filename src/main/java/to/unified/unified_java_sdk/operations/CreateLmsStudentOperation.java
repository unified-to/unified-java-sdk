...
public class CreateLmsStudentOperation implements RequestOperation<CreateLmsStudentRequest, CreateLmsStudentResponse> {
    ...
    public CreateLmsStudentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateLmsStudentRequest request) throws Exception {
