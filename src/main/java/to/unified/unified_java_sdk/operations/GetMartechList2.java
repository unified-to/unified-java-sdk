...
public class GetMartechList2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMartechList2Request, GetMartechList2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetMartechList2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetMartechList2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMartechList2Request request) {
        ...
        @Override
        public GetMartechList2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMartechList2Response.Builder resBuilder =
            ...
            GetMartechList2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMartechList2Request, to.unified.unified_java_sdk.models.operations.async.GetMartechList2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMartechList2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetMartechList2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMartechList2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetMartechList2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetMartechList2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetMartechList2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetMartechList2Response res = resBuilder.build();
