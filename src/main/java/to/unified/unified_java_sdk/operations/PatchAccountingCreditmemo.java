...
public class PatchAccountingCreditmemo {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingCreditmemoRequest, PatchAccountingCreditmemoResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingCreditmemoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingCreditmemoRequest.class, new TypeReference<PatchAccountingCreditmemoRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingCreditmemoRequest request) {
        ...
        @Override
        public PatchAccountingCreditmemoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingCreditmemoResponse.Builder resBuilder =
            ...
            PatchAccountingCreditmemoResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingCreditmemoRequest, to.unified.unified_java_sdk.models.operations.async.PatchAccountingCreditmemoResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingCreditmemoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingCreditmemoRequest.class, new TypeReference<PatchAccountingCreditmemoRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingCreditmemoRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingCreditmemoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingCreditmemoResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingCreditmemoResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingCreditmemoResponse res = resBuilder.build();
