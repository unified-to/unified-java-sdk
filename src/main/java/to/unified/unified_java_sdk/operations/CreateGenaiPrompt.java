...
public class CreateGenaiPrompt {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateGenaiPromptRequest request) throws Exception {
        ...
        @Override
        public CreateGenaiPromptResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GenaiPrompt out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGenaiPrompt(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
