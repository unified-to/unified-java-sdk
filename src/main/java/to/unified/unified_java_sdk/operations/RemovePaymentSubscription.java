...
public class RemovePaymentSubscription {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemovePaymentSubscriptionRequest, RemovePaymentSubscriptionResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(RemovePaymentSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePaymentSubscriptionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemovePaymentSubscriptionRequest request) throws Exception {
        ...
        @Override
        public RemovePaymentSubscriptionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemovePaymentSubscriptionResponse.Builder resBuilder =
            ...
            RemovePaymentSubscriptionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemovePaymentSubscriptionRequest, to.unified.unified_java_sdk.models.operations.async.RemovePaymentSubscriptionResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemovePaymentSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePaymentSubscriptionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemovePaymentSubscriptionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemovePaymentSubscriptionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemovePaymentSubscriptionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemovePaymentSubscriptionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemovePaymentSubscriptionResponse res = resBuilder.build();
