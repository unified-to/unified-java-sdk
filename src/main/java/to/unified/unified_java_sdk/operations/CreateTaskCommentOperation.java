...
public class CreateTaskCommentOperation implements RequestOperation<CreateTaskCommentRequest, CreateTaskCommentResponse> {
    ...
    public CreateTaskCommentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateTaskCommentRequest request) throws Exception {
