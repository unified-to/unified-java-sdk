...
public class GetKmsComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetKmsCommentRequest, GetKmsCommentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetKmsCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetKmsCommentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetKmsCommentRequest request) {
        ...
        @Override
        public GetKmsCommentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetKmsCommentResponse.Builder resBuilder =
            ...
            GetKmsCommentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetKmsCommentRequest, to.unified.unified_java_sdk.models.operations.async.GetKmsCommentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetKmsCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetKmsCommentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetKmsCommentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetKmsCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetKmsCommentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetKmsCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetKmsCommentResponse res = resBuilder.build();
