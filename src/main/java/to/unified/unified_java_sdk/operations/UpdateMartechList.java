...
public class UpdateMartechList {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMartechListRequest, UpdateMartechListResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateMartechListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMartechListRequest.class, new TypeReference<UpdateMartechListRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMartechListRequest request) {
        ...
        @Override
        public UpdateMartechListResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMartechListResponse.Builder resBuilder =
            ...
            UpdateMartechListResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMartechListRequest, to.unified.unified_java_sdk.models.operations.async.UpdateMartechListResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMartechListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMartechListRequest.class, new TypeReference<UpdateMartechListRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMartechListRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateMartechListResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateMartechListResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateMartechListResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateMartechListResponse res = resBuilder.build();
