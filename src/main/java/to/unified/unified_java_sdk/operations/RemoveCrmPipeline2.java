...
public class RemoveCrmPipeline2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCrmPipeline2Request, RemoveCrmPipeline2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCrmPipeline2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmPipeline2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCrmPipeline2Request request) {
        ...
        @Override
        public RemoveCrmPipeline2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCrmPipeline2Response.Builder resBuilder =
            ...
            RemoveCrmPipeline2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCrmPipeline2Request, to.unified.unified_java_sdk.models.operations.async.RemoveCrmPipeline2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCrmPipeline2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmPipeline2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCrmPipeline2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCrmPipeline2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCrmPipeline2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCrmPipeline2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCrmPipeline2Response res = resBuilder.build();
