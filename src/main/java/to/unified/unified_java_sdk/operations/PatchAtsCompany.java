...
public class PatchAtsCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAtsCompanyRequest, PatchAtsCompanyResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAtsCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsCompanyRequest.class, new TypeReference<PatchAtsCompanyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAtsCompanyRequest request) {
        ...
        @Override
        public PatchAtsCompanyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAtsCompanyResponse.Builder resBuilder =
            ...
            PatchAtsCompanyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAtsCompanyRequest, to.unified.unified_java_sdk.models.operations.async.PatchAtsCompanyResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAtsCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsCompanyRequest.class, new TypeReference<PatchAtsCompanyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAtsCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAtsCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAtsCompanyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAtsCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAtsCompanyResponse res = resBuilder.build();
