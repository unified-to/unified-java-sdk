...
public class ListScimUsers {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListScimUsersRequest, ListScimUsersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListScimUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListScimUsersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListScimUsersRequest request) {
        ...
        @Override
        public ListScimUsersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListScimUsersResponse.Builder resBuilder =
            ...
            ListScimUsersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withScimUsers(Utils.unmarshal(response, new TypeReference<List<ScimUser>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListScimUsersRequest, to.unified.unified_java_sdk.models.operations.async.ListScimUsersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListScimUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListScimUsersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListScimUsersRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListScimUsersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListScimUsersResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListScimUsersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListScimUsersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ScimUser>>() {})
                            .thenApply(res::withScimUsers);
                } else {
