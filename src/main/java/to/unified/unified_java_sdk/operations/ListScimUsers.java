...
public class ListScimUsers {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListScimUsersRequest request) throws Exception {
        ...
        @Override
        public ListScimUsersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<ScimUser> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withScimUsers(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
