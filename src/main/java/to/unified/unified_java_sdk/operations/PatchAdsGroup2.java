...
public class PatchAdsGroup2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAdsGroup2Request, PatchAdsGroup2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAdsGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsGroup2Request.class, new TypeReference<PatchAdsGroup2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAdsGroup2Request request) {
        ...
        @Override
        public PatchAdsGroup2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAdsGroup2Response.Builder resBuilder =
            ...
            PatchAdsGroup2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAdsGroup2Request, to.unified.unified_java_sdk.models.operations.async.PatchAdsGroup2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAdsGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsGroup2Request.class, new TypeReference<PatchAdsGroup2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAdsGroup2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAdsGroup2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAdsGroup2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAdsGroup2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAdsGroup2Response res = resBuilder.build();
