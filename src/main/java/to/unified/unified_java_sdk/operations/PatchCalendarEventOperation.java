...
public class PatchCalendarEventOperation implements RequestOperation<PatchCalendarEventRequest, PatchCalendarEventResponse> {
    ...
    public PatchCalendarEventOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchCalendarEventRequest request) throws Exception {
