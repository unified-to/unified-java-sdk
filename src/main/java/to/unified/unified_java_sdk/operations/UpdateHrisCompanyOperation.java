...
public class UpdateHrisCompanyOperation implements RequestOperation<UpdateHrisCompanyRequest, UpdateHrisCompanyResponse> {
    ...
    public UpdateHrisCompanyOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateHrisCompanyRequest request) throws Exception {
