...
public class GetAccountingSalesorder {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingSalesorderRequest, GetAccountingSalesorderResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingSalesorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingSalesorderRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingSalesorderRequest request) {
        ...
        @Override
        public GetAccountingSalesorderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingSalesorderResponse.Builder resBuilder =
            ...
            GetAccountingSalesorderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingSalesorderRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingSalesorderResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingSalesorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingSalesorderRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingSalesorderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingSalesorderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingSalesorderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingSalesorderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingSalesorderResponse res = resBuilder.build();
