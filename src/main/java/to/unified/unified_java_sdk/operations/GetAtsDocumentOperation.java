...
public class GetAtsDocumentOperation implements RequestOperation<GetAtsDocumentRequest, GetAtsDocumentResponse> {
    ...
    public GetAtsDocumentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAtsDocumentRequest request) throws Exception {
