...
public class PatchAccountingTransaction {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingTransactionRequest, PatchAccountingTransactionResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingTransactionRequest request) {
        ...
        @Override
        public PatchAccountingTransactionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingTransactionResponse.Builder resBuilder =
            ...
            PatchAccountingTransactionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingTransactionRequest, to.unified.unified_java_sdk.models.operations.async.PatchAccountingTransactionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingTransactionRequest.class, new TypeReference<PatchAccountingTransactionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingTransactionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingTransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingTransactionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingTransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingTransactionResponse res = resBuilder.build();
