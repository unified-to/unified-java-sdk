...
public class UpdateLmsClass2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLmsClass2Request, UpdateLmsClass2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateLmsClass2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsClass2Request.class, new TypeReference<UpdateLmsClass2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLmsClass2Request request) {
        ...
        @Override
        public UpdateLmsClass2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateLmsClass2Response.Builder resBuilder =
            ...
            UpdateLmsClass2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLmsClass2Request, to.unified.unified_java_sdk.models.operations.async.UpdateLmsClass2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLmsClass2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsClass2Request.class, new TypeReference<UpdateLmsClass2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLmsClass2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateLmsClass2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateLmsClass2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateLmsClass2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateLmsClass2Response res = resBuilder.build();
