...
public class GetAdsPromoted2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAdsPromoted2Request, GetAdsPromoted2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAdsPromoted2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsPromoted2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAdsPromoted2Request request) {
        ...
        @Override
        public GetAdsPromoted2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAdsPromoted2Response.Builder resBuilder =
            ...
            GetAdsPromoted2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdsPromoted(Utils.unmarshal(response, new TypeReference<AdsPromoted>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAdsPromoted2Request, to.unified.unified_java_sdk.models.operations.async.GetAdsPromoted2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAdsPromoted2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsPromoted2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAdsPromoted2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAdsPromoted2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAdsPromoted2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAdsPromoted2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAdsPromoted2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AdsPromoted>() {})
                            .thenApply(res::withAdsPromoted);
                } else {
