...
public class UpdateAtsCandidateOperation implements RequestOperation<UpdateAtsCandidateRequest, UpdateAtsCandidateResponse> {
    ...
    public UpdateAtsCandidateOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAtsCandidateRequest request) throws Exception {
