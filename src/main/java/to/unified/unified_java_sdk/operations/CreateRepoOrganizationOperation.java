...
public class CreateRepoOrganizationOperation implements RequestOperation<CreateRepoOrganizationRequest, CreateRepoOrganizationResponse> {
    ...
    public CreateRepoOrganizationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateRepoOrganizationRequest request) throws Exception {
