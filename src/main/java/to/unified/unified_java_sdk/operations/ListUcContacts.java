...
public class ListUcContacts {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUcContactsRequest, ListUcContactsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListUcContactsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUcContactsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUcContactsRequest request) {
        ...
        @Override
        public ListUcContactsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUcContactsResponse.Builder resBuilder =
            ...
            ListUcContactsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUcContactsRequest, to.unified.unified_java_sdk.models.operations.async.ListUcContactsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListUcContactsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUcContactsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUcContactsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListUcContactsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListUcContactsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListUcContactsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListUcContactsResponse res = resBuilder.build();
