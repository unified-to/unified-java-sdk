...
public class ListUcContacts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUcContactsRequest request) throws Exception {
        ...
        @Override
        public ListUcContactsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<UcContact> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUcContacts(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
