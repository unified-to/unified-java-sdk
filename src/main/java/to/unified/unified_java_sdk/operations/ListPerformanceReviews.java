...
public class ListPerformanceReviews {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPerformanceReviewsRequest, ListPerformanceReviewsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPerformanceReviewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPerformanceReviewsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPerformanceReviewsRequest request) {
        ...
        @Override
        public ListPerformanceReviewsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPerformanceReviewsResponse.Builder resBuilder =
            ...
            ListPerformanceReviewsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPerformanceReviews(Utils.unmarshal(response, new TypeReference<List<PerformanceReview>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPerformanceReviewsRequest, to.unified.unified_java_sdk.models.operations.async.ListPerformanceReviewsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPerformanceReviewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPerformanceReviewsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPerformanceReviewsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListPerformanceReviewsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListPerformanceReviewsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListPerformanceReviewsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListPerformanceReviewsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<PerformanceReview>>() {})
                            .thenApply(res::withPerformanceReviews);
                } else {
