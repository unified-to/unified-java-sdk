...
public class ListShippingLabels2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListShippingLabels2Request, ListShippingLabels2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListShippingLabels2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListShippingLabels2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListShippingLabels2Request request) {
        ...
        @Override
        public ListShippingLabels2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListShippingLabels2Response.Builder resBuilder =
            ...
            ListShippingLabels2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withShippingLabels(Utils.unmarshal(response, new TypeReference<List<ShippingLabel>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListShippingLabels2Request, to.unified.unified_java_sdk.models.operations.async.ListShippingLabels2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListShippingLabels2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListShippingLabels2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListShippingLabels2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListShippingLabels2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListShippingLabels2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListShippingLabels2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListShippingLabels2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ShippingLabel>>() {})
                            .thenApply(res::withShippingLabels);
                } else {
