...
public class RemoveUcCommentOperation implements RequestOperation<RemoveUcCommentRequest, RemoveUcCommentResponse> {
    ...
    public RemoveUcCommentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveUcCommentRequest request) throws Exception {
