...
public class PatchAssessmentPackage {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAssessmentPackageRequest, PatchAssessmentPackageResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAssessmentPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAssessmentPackageRequest.class, new TypeReference<PatchAssessmentPackageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAssessmentPackageRequest request) {
        ...
        @Override
        public PatchAssessmentPackageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAssessmentPackageResponse.Builder resBuilder =
            ...
            PatchAssessmentPackageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAssessmentPackageRequest, to.unified.unified_java_sdk.models.operations.async.PatchAssessmentPackageResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAssessmentPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAssessmentPackageRequest.class, new TypeReference<PatchAssessmentPackageRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAssessmentPackageRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAssessmentPackageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAssessmentPackageResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAssessmentPackageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAssessmentPackageResponse res = resBuilder.build();
