...
public class GetAccountingCashflow {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingCashflowRequest, GetAccountingCashflowResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingCashflowRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingCashflowRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingCashflowRequest request) {
        ...
        @Override
        public GetAccountingCashflowResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingCashflowResponse.Builder resBuilder =
            ...
            GetAccountingCashflowResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingCashflowRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingCashflowResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingCashflowRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingCashflowRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingCashflowRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingCashflowResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingCashflowResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingCashflowResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingCashflowResponse res = resBuilder.build();
