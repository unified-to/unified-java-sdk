...
public class PatchHrisDeviceOperation implements RequestOperation<PatchHrisDeviceRequest, PatchHrisDeviceResponse> {
    ...
    public PatchHrisDeviceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchHrisDeviceRequest request) throws Exception {
