...
public class PatchTicketingCustomer {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchTicketingCustomerRequest, PatchTicketingCustomerResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchTicketingCustomerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTicketingCustomerRequest.class, new TypeReference<PatchTicketingCustomerRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchTicketingCustomerRequest request) {
        ...
        @Override
        public PatchTicketingCustomerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchTicketingCustomerResponse.Builder resBuilder =
            ...
            PatchTicketingCustomerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchTicketingCustomerRequest, to.unified.unified_java_sdk.models.operations.async.PatchTicketingCustomerResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchTicketingCustomerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTicketingCustomerRequest.class, new TypeReference<PatchTicketingCustomerRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchTicketingCustomerRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchTicketingCustomerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchTicketingCustomerResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchTicketingCustomerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchTicketingCustomerResponse res = resBuilder.build();
