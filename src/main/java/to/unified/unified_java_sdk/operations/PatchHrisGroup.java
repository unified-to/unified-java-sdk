...
public class PatchHrisGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisGroupRequest, PatchHrisGroupResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisGroupRequest.class, new TypeReference<PatchHrisGroupRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisGroupRequest request) {
        ...
        @Override
        public PatchHrisGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisGroupResponse.Builder resBuilder =
            ...
            PatchHrisGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisGroupRequest, to.unified.unified_java_sdk.models.operations.async.PatchHrisGroupResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisGroupRequest.class, new TypeReference<PatchHrisGroupRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisGroupRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisGroupResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisGroupResponse res = resBuilder.build();
