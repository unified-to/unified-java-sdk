...
public class UpdateRepoCommit {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateRepoCommitRequest, UpdateRepoCommitResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateRepoCommitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoCommitRequest.class, new TypeReference<UpdateRepoCommitRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateRepoCommitRequest request) {
        ...
        @Override
        public UpdateRepoCommitResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateRepoCommitResponse.Builder resBuilder =
            ...
            UpdateRepoCommitResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateRepoCommitRequest, to.unified.unified_java_sdk.models.operations.async.UpdateRepoCommitResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateRepoCommitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoCommitRequest.class, new TypeReference<UpdateRepoCommitRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateRepoCommitRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateRepoCommitResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateRepoCommitResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateRepoCommitResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateRepoCommitResponse res = resBuilder.build();
