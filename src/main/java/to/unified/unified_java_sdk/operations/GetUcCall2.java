...
public class GetUcCall2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUcCall2Request, GetUcCall2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUcCall2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetUcCall2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUcCall2Request request) {
        ...
        @Override
        public GetUcCall2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUcCall2Response.Builder resBuilder =
                    GetUcCall2Response
                            .builder()
            ...
            GetUcCall2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUcCall(Utils.unmarshal(response, new TypeReference<UcCall>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUcCall2Request, to.unified.unified_java_sdk.models.operations.async.GetUcCall2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUcCall2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetUcCall2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUcCall2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetUcCall2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetUcCall2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetUcCall2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetUcCall2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UcCall>() {})
                            .thenApply(res::withUcCall);
                } else {
