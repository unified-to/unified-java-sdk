...
public class PatchHrisDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisDocumentRequest, PatchHrisDocumentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisDocumentRequest.class, new TypeReference<PatchHrisDocumentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisDocumentRequest request) {
        ...
        @Override
        public PatchHrisDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisDocumentResponse.Builder resBuilder =
            ...
            PatchHrisDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisDocumentRequest, to.unified.unified_java_sdk.models.operations.async.PatchHrisDocumentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisDocumentRequest.class, new TypeReference<PatchHrisDocumentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisDocumentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisDocumentResponse res = resBuilder.build();
