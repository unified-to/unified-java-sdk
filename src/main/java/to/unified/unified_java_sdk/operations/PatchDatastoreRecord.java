...
public class PatchDatastoreRecord {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchDatastoreRecordRequest, PatchDatastoreRecordResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchDatastoreRecordRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchDatastoreRecordRequest.class, new TypeReference<PatchDatastoreRecordRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchDatastoreRecordRequest request) {
        ...
        @Override
        public PatchDatastoreRecordResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchDatastoreRecordResponse.Builder resBuilder =
            ...
            PatchDatastoreRecordResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchDatastoreRecordRequest, to.unified.unified_java_sdk.models.operations.async.PatchDatastoreRecordResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchDatastoreRecordRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchDatastoreRecordRequest.class, new TypeReference<PatchDatastoreRecordRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchDatastoreRecordRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchDatastoreRecordResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchDatastoreRecordResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchDatastoreRecordResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchDatastoreRecordResponse res = resBuilder.build();
