...
public class ListTicketingCustomers {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTicketingCustomersRequest request) throws Exception {
        ...
        @Override
        public ListTicketingCustomersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<TicketingCustomer> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTicketingCustomers(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
