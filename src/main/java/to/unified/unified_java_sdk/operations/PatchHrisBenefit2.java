...
public class PatchHrisBenefit2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisBenefit2Request, PatchHrisBenefit2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisBenefit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisBenefit2Request.class, new TypeReference<PatchHrisBenefit2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisBenefit2Request request) {
        ...
        @Override
        public PatchHrisBenefit2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisBenefit2Response.Builder resBuilder =
            ...
            PatchHrisBenefit2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisBenefit2Request, to.unified.unified_java_sdk.models.operations.async.PatchHrisBenefit2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisBenefit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisBenefit2Request.class, new TypeReference<PatchHrisBenefit2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisBenefit2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisBenefit2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisBenefit2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisBenefit2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisBenefit2Response res = resBuilder.build();
