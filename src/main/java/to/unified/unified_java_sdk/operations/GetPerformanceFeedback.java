...
public class GetPerformanceFeedback {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPerformanceFeedbackRequest, GetPerformanceFeedbackResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPerformanceFeedbackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPerformanceFeedbackRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPerformanceFeedbackRequest request) {
        ...
        @Override
        public GetPerformanceFeedbackResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPerformanceFeedbackResponse.Builder resBuilder =
                    GetPerformanceFeedbackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetPerformanceFeedbackResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPerformanceFeedbackRequest, to.unified.unified_java_sdk.models.operations.async.GetPerformanceFeedbackResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPerformanceFeedbackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPerformanceFeedbackRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPerformanceFeedbackRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetPerformanceFeedbackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetPerformanceFeedbackResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetPerformanceFeedbackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetPerformanceFeedbackResponse res = resBuilder.build();
