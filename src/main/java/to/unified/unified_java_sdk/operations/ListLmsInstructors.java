...
public class ListLmsInstructors {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsInstructorsRequest request) throws Exception {
        ...
        @Override
        public ListLmsInstructorsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<LmsInstructor> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withLmsInstructors(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
