...
public class ListLmsInstructors {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListLmsInstructorsRequest, ListLmsInstructorsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListLmsInstructorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsInstructorsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsInstructorsRequest request) {
        ...
        @Override
        public ListLmsInstructorsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListLmsInstructorsResponse.Builder resBuilder =
            ...
            ListLmsInstructorsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLmsInstructorsRequest, to.unified.unified_java_sdk.models.operations.async.ListLmsInstructorsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListLmsInstructorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsInstructorsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListLmsInstructorsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListLmsInstructorsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListLmsInstructorsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListLmsInstructorsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListLmsInstructorsResponse res = resBuilder.build();
