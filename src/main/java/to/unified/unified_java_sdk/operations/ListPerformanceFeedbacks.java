...
public class ListPerformanceFeedbacks {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPerformanceFeedbacksRequest, ListPerformanceFeedbacksResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPerformanceFeedbacksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPerformanceFeedbacksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPerformanceFeedbacksRequest request) {
        ...
        @Override
        public ListPerformanceFeedbacksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPerformanceFeedbacksResponse.Builder resBuilder =
                    ListPerformanceFeedbacksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListPerformanceFeedbacksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPerformanceFeedbacks(Utils.unmarshal(response, new TypeReference<List<PerformanceFeedback>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPerformanceFeedbacksRequest, to.unified.unified_java_sdk.models.operations.async.ListPerformanceFeedbacksResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPerformanceFeedbacksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPerformanceFeedbacksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPerformanceFeedbacksRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListPerformanceFeedbacksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListPerformanceFeedbacksResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListPerformanceFeedbacksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListPerformanceFeedbacksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<PerformanceFeedback>>() {})
                            .thenApply(res::withPerformanceFeedbacks);
                } else {
