...
public class PatchAccountingAccountOperation implements RequestOperation<PatchAccountingAccountRequest, PatchAccountingAccountResponse> {
    ...
    public PatchAccountingAccountOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchAccountingAccountRequest request) throws Exception {
