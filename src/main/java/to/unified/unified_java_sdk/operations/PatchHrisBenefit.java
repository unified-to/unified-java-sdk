...
public class PatchHrisBenefit {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisBenefitRequest, PatchHrisBenefitResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisBenefitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisBenefitRequest.class, new TypeReference<PatchHrisBenefitRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisBenefitRequest request) {
        ...
        @Override
        public PatchHrisBenefitResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisBenefitResponse.Builder resBuilder =
            ...
            PatchHrisBenefitResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisBenefitRequest, to.unified.unified_java_sdk.models.operations.async.PatchHrisBenefitResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisBenefitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisBenefitRequest.class, new TypeReference<PatchHrisBenefitRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisBenefitRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisBenefitResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisBenefitResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisBenefitResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisBenefitResponse res = resBuilder.build();
