...
public class CreateSocialPost {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateSocialPostRequest, CreateSocialPostResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateSocialPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSocialPostRequest.class, new TypeReference<CreateSocialPostRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSocialPostRequest request) {
        ...
        @Override
        public CreateSocialPostResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSocialPostResponse.Builder resBuilder =
            ...
            CreateSocialPostResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateSocialPostRequest, to.unified.unified_java_sdk.models.operations.async.CreateSocialPostResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateSocialPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSocialPostRequest.class, new TypeReference<CreateSocialPostRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateSocialPostRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateSocialPostResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateSocialPostResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateSocialPostResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateSocialPostResponse res = resBuilder.build();
