...
public class PatchRepoPullrequest2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchRepoPullrequest2Request, PatchRepoPullrequest2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchRepoPullrequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoPullrequest2Request.class, new TypeReference<PatchRepoPullrequest2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchRepoPullrequest2Request request) {
        ...
        @Override
        public PatchRepoPullrequest2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchRepoPullrequest2Response.Builder resBuilder =
            ...
            PatchRepoPullrequest2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchRepoPullrequest2Request, to.unified.unified_java_sdk.models.operations.async.PatchRepoPullrequest2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchRepoPullrequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoPullrequest2Request.class, new TypeReference<PatchRepoPullrequest2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchRepoPullrequest2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchRepoPullrequest2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchRepoPullrequest2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchRepoPullrequest2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchRepoPullrequest2Response res = resBuilder.build();
