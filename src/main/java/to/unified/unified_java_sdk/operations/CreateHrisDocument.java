...
public class CreateHrisDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisDocumentRequest, CreateHrisDocumentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisDocumentRequest.class, new TypeReference<CreateHrisDocumentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisDocumentRequest request) {
        ...
        @Override
        public CreateHrisDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisDocumentResponse.Builder resBuilder =
            ...
            CreateHrisDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisDocumentRequest, to.unified.unified_java_sdk.models.operations.async.CreateHrisDocumentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisDocumentRequest.class, new TypeReference<CreateHrisDocumentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisDocumentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisDocumentResponse res = resBuilder.build();
