...
public class PatchCalendarWebinar2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCalendarWebinar2Request, PatchCalendarWebinar2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCalendarWebinar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCalendarWebinar2Request.class, new TypeReference<PatchCalendarWebinar2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCalendarWebinar2Request request) {
        ...
        @Override
        public PatchCalendarWebinar2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCalendarWebinar2Response.Builder resBuilder =
            ...
            PatchCalendarWebinar2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCalendarWebinar2Request, to.unified.unified_java_sdk.models.operations.async.PatchCalendarWebinar2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCalendarWebinar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCalendarWebinar2Request.class, new TypeReference<PatchCalendarWebinar2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCalendarWebinar2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCalendarWebinar2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCalendarWebinar2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCalendarWebinar2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCalendarWebinar2Response res = resBuilder.build();
