...
public class ListAccountingCreditmemoesOperation implements RequestOperation<ListAccountingCreditmemoesRequest, ListAccountingCreditmemoesResponse> {
    ...
    public ListAccountingCreditmemoesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAccountingCreditmemoesRequest request) throws Exception {
