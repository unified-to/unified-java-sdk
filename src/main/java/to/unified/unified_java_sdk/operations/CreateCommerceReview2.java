...
public class CreateCommerceReview2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommerceReview2Request, CreateCommerceReview2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommerceReview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceReview2Request.class, new TypeReference<CreateCommerceReview2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceReview2Request request) {
        ...
        @Override
        public CreateCommerceReview2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommerceReview2Response.Builder resBuilder =
            ...
            CreateCommerceReview2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceReview(Utils.unmarshal(response, new TypeReference<CommerceReview>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommerceReview2Request, to.unified.unified_java_sdk.models.operations.async.CreateCommerceReview2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommerceReview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceReview2Request.class, new TypeReference<CreateCommerceReview2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommerceReview2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCommerceReview2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCommerceReview2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCommerceReview2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCommerceReview2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CommerceReview>() {})
                            .thenApply(res::withCommerceReview);
                } else {
