...
public class ListRepoRepositories {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRepoRepositoriesRequest, ListRepoRepositoriesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListRepoRepositoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoRepositoriesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRepoRepositoriesRequest request) {
        ...
        @Override
        public ListRepoRepositoriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListRepoRepositoriesResponse.Builder resBuilder =
            ...
            ListRepoRepositoriesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListRepoRepositoriesRequest, to.unified.unified_java_sdk.models.operations.async.ListRepoRepositoriesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListRepoRepositoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoRepositoriesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRepoRepositoriesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListRepoRepositoriesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListRepoRepositoriesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListRepoRepositoriesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListRepoRepositoriesResponse res = resBuilder.build();
