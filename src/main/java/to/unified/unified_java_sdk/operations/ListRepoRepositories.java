...
public class ListRepoRepositories {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRepoRepositoriesRequest request) throws Exception {
        ...
        @Override
        public ListRepoRepositoriesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<RepoRepository> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withRepoRepositories(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
