...
public class CreateSigningDocument2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateSigningDocument2Request, CreateSigningDocument2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateSigningDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSigningDocument2Request.class, new TypeReference<CreateSigningDocument2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSigningDocument2Request request) {
        ...
        @Override
        public CreateSigningDocument2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSigningDocument2Response.Builder resBuilder =
            ...
            CreateSigningDocument2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSigningDocument(Utils.unmarshal(response, new TypeReference<SigningDocument>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateSigningDocument2Request, to.unified.unified_java_sdk.models.operations.async.CreateSigningDocument2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateSigningDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSigningDocument2Request.class, new TypeReference<CreateSigningDocument2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateSigningDocument2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateSigningDocument2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateSigningDocument2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateSigningDocument2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateSigningDocument2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SigningDocument>() {})
                            .thenApply(res::withSigningDocument);
                } else {
