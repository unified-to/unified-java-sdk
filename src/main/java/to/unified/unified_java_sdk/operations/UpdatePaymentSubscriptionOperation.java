...
public class UpdatePaymentSubscriptionOperation implements RequestOperation<UpdatePaymentSubscriptionRequest, UpdatePaymentSubscriptionResponse> {
    ...
    public UpdatePaymentSubscriptionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdatePaymentSubscriptionRequest request) throws Exception {
