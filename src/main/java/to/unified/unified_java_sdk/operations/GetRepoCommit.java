...
public class GetRepoCommit {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRepoCommitRequest, GetRepoCommitResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRepoCommitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoCommitRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRepoCommitRequest request) {
        ...
        @Override
        public GetRepoCommitResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRepoCommitRequest, to.unified.unified_java_sdk.models.operations.async.GetRepoCommitResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRepoCommitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoCommitRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRepoCommitRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetRepoCommitResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetRepoCommitResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetRepoCommitResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetRepoCommitResponse res = resBuilder.build();
