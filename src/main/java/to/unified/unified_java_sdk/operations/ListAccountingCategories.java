...
public class ListAccountingCategories {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountingCategoriesRequest request) throws Exception {
        ...
        @Override
        public ListAccountingCategoriesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AccountingCategory> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingCategories(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
