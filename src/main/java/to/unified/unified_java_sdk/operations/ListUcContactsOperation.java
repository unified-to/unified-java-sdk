...
public class ListUcContactsOperation implements RequestOperation<ListUcContactsRequest, ListUcContactsResponse> {
    ...
    public ListUcContactsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListUcContactsRequest request) throws Exception {
