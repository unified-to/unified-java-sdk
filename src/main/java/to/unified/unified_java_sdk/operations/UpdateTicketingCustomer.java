...
public class UpdateTicketingCustomer {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTicketingCustomerRequest request) throws Exception {
        ...
        @Override
        public UpdateTicketingCustomerResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TicketingCustomer out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTicketingCustomer(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
