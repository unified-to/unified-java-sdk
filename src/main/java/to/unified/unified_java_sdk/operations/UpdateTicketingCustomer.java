...
public class UpdateTicketingCustomer {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTicketingCustomerRequest, UpdateTicketingCustomerResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTicketingCustomerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketingCustomerRequest.class, new TypeReference<UpdateTicketingCustomerRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTicketingCustomerRequest request) {
        ...
        @Override
        public UpdateTicketingCustomerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTicketingCustomerResponse.Builder resBuilder =
            ...
            UpdateTicketingCustomerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateTicketingCustomerRequest, to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCustomerResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateTicketingCustomerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketingCustomerRequest.class, new TypeReference<UpdateTicketingCustomerRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateTicketingCustomerRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCustomerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCustomerResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCustomerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCustomerResponse res = resBuilder.build();
