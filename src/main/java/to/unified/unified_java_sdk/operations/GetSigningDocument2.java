...
public class GetSigningDocument2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSigningDocument2Request, GetSigningDocument2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSigningDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetSigningDocument2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSigningDocument2Request request) {
        ...
        @Override
        public GetSigningDocument2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSigningDocument2Response.Builder resBuilder =
            ...
            GetSigningDocument2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSigningDocument2Request, to.unified.unified_java_sdk.models.operations.async.GetSigningDocument2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSigningDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetSigningDocument2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSigningDocument2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetSigningDocument2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetSigningDocument2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetSigningDocument2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetSigningDocument2Response res = resBuilder.build();
