...
public class GetCommerceInventory2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceInventory2Request, GetCommerceInventory2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommerceInventory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceInventory2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceInventory2Request request) {
        ...
        @Override
        public GetCommerceInventory2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommerceInventory2Response.Builder resBuilder =
            ...
            GetCommerceInventory2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommerceInventory2Request, to.unified.unified_java_sdk.models.operations.async.GetCommerceInventory2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommerceInventory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceInventory2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommerceInventory2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCommerceInventory2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCommerceInventory2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCommerceInventory2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCommerceInventory2Response res = resBuilder.build();
