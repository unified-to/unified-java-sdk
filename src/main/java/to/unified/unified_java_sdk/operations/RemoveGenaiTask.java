...
public class RemoveGenaiTask {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveGenaiTaskRequest, RemoveGenaiTaskResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveGenaiTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveGenaiTaskRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveGenaiTaskRequest request) {
        ...
        @Override
        public RemoveGenaiTaskResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveGenaiTaskResponse.Builder resBuilder =
            ...
            RemoveGenaiTaskResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveGenaiTaskRequest, to.unified.unified_java_sdk.models.operations.async.RemoveGenaiTaskResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveGenaiTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveGenaiTaskRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveGenaiTaskRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveGenaiTaskResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveGenaiTaskResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveGenaiTaskResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveGenaiTaskResponse res = resBuilder.build();
