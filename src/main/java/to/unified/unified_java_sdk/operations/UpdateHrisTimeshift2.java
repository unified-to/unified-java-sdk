...
public class UpdateHrisTimeshift2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisTimeshift2Request, UpdateHrisTimeshift2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisTimeshift2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisTimeshift2Request.class, new TypeReference<UpdateHrisTimeshift2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisTimeshift2Request request) {
        ...
        @Override
        public UpdateHrisTimeshift2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisTimeshift2Response.Builder resBuilder =
            ...
            UpdateHrisTimeshift2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisTimeshift(Utils.unmarshal(response, new TypeReference<HrisTimeshift>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisTimeshift2Request, to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeshift2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisTimeshift2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisTimeshift2Request.class, new TypeReference<UpdateHrisTimeshift2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisTimeshift2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeshift2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeshift2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeshift2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeshift2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HrisTimeshift>() {})
                            .thenApply(res::withHrisTimeshift);
                } else {
