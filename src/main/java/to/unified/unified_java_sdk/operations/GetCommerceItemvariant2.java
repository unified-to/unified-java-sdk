...
public class GetCommerceItemvariant2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceItemvariant2Request, GetCommerceItemvariant2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommerceItemvariant2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceItemvariant2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceItemvariant2Request request) {
        ...
        @Override
        public GetCommerceItemvariant2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommerceItemvariant2Response.Builder resBuilder =
            ...
            GetCommerceItemvariant2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommerceItemvariant2Request, to.unified.unified_java_sdk.models.operations.async.GetCommerceItemvariant2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommerceItemvariant2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceItemvariant2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommerceItemvariant2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCommerceItemvariant2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCommerceItemvariant2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCommerceItemvariant2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCommerceItemvariant2Response res = resBuilder.build();
