...
public class CreateAtsJob2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAtsJob2Request, CreateAtsJob2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAtsJob2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsJob2Request.class, new TypeReference<CreateAtsJob2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsJob2Request request) {
        ...
        @Override
        public CreateAtsJob2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAtsJob2Response.Builder resBuilder =
            ...
            CreateAtsJob2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsJob(Utils.unmarshal(response, new TypeReference<AtsJob>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAtsJob2Request, to.unified.unified_java_sdk.models.operations.async.CreateAtsJob2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAtsJob2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsJob2Request.class, new TypeReference<CreateAtsJob2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAtsJob2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAtsJob2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAtsJob2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAtsJob2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAtsJob2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AtsJob>() {})
                            .thenApply(res::withAtsJob);
                } else {
