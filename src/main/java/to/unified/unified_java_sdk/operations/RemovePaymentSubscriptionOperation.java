...
public class RemovePaymentSubscriptionOperation implements RequestOperation<RemovePaymentSubscriptionRequest, RemovePaymentSubscriptionResponse> {
    ...
    public RemovePaymentSubscriptionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemovePaymentSubscriptionRequest request) throws Exception {
