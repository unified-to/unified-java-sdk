...
public class CreateCrmLeadOperation implements RequestOperation<CreateCrmLeadRequest, CreateCrmLeadResponse> {
    ...
    public CreateCrmLeadOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateCrmLeadRequest request) throws Exception {
