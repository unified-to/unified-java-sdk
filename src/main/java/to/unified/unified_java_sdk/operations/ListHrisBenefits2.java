...
public class ListHrisBenefits2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisBenefits2Request, ListHrisBenefits2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisBenefits2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisBenefits2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisBenefits2Request request) {
        ...
        @Override
        public ListHrisBenefits2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisBenefits2Response.Builder resBuilder =
            ...
            ListHrisBenefits2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisBenefits(Utils.unmarshal(response, new TypeReference<List<HrisBenefit>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisBenefits2Request, to.unified.unified_java_sdk.models.operations.async.ListHrisBenefits2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisBenefits2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisBenefits2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisBenefits2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisBenefits2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisBenefits2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisBenefits2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisBenefits2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<HrisBenefit>>() {})
                            .thenApply(res::withHrisBenefits);
                } else {
