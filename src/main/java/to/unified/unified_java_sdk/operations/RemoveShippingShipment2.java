...
public class RemoveShippingShipment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveShippingShipment2Request, RemoveShippingShipment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveShippingShipment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveShippingShipment2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveShippingShipment2Request request) {
        ...
        @Override
        public RemoveShippingShipment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveShippingShipment2Response.Builder resBuilder =
            ...
            RemoveShippingShipment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveShippingShipment2Request, to.unified.unified_java_sdk.models.operations.async.RemoveShippingShipment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveShippingShipment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveShippingShipment2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveShippingShipment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveShippingShipment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveShippingShipment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveShippingShipment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveShippingShipment2Response res = resBuilder.build();
