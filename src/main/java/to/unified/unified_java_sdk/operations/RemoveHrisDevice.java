...
public class RemoveHrisDevice {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisDeviceRequest, RemoveHrisDeviceResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(RemoveHrisDeviceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisDeviceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisDeviceRequest request) throws Exception {
        ...
        @Override
        public RemoveHrisDeviceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisDeviceResponse.Builder resBuilder =
            ...
            RemoveHrisDeviceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisDeviceRequest, to.unified.unified_java_sdk.models.operations.async.RemoveHrisDeviceResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisDeviceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisDeviceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisDeviceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisDeviceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisDeviceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisDeviceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisDeviceResponse res = resBuilder.build();
