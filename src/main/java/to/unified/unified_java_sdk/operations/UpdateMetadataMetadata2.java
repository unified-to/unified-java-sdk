...
public class UpdateMetadataMetadata2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMetadataMetadata2Request, UpdateMetadataMetadata2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateMetadataMetadata2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMetadataMetadata2Request.class, new TypeReference<UpdateMetadataMetadata2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMetadataMetadata2Request request) {
        ...
        @Override
        public UpdateMetadataMetadata2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMetadataMetadata2Response.Builder resBuilder =
            ...
            UpdateMetadataMetadata2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMetadataMetadata(Utils.unmarshal(response, new TypeReference<MetadataMetadata>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMetadataMetadata2Request, to.unified.unified_java_sdk.models.operations.async.UpdateMetadataMetadata2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMetadataMetadata2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMetadataMetadata2Request.class, new TypeReference<UpdateMetadataMetadata2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMetadataMetadata2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateMetadataMetadata2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateMetadataMetadata2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateMetadataMetadata2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateMetadataMetadata2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MetadataMetadata>() {})
                            .thenApply(res::withMetadataMetadata);
                } else {
