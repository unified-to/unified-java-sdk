...
public class PatchTicketingCustomerOperation implements RequestOperation<PatchTicketingCustomerRequest, PatchTicketingCustomerResponse> {
    ...
    public PatchTicketingCustomerOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchTicketingCustomerRequest request) throws Exception {
