...
public class RemoveCalendarWebinar {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCalendarWebinarRequest, RemoveCalendarWebinarResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCalendarWebinarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCalendarWebinarRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCalendarWebinarRequest request) {
        ...
        @Override
        public RemoveCalendarWebinarResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCalendarWebinarResponse.Builder resBuilder =
            ...
            RemoveCalendarWebinarResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCalendarWebinarRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCalendarWebinarResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCalendarWebinarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCalendarWebinarRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCalendarWebinarRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCalendarWebinarResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCalendarWebinarResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCalendarWebinarResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCalendarWebinarResponse res = resBuilder.build();
