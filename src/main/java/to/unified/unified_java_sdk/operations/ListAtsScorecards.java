...
public class ListAtsScorecards {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAtsScorecardsRequest, ListAtsScorecardsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAtsScorecardsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsScorecardsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsScorecardsRequest request) {
        ...
        @Override
        public ListAtsScorecardsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsScorecardsResponse.Builder resBuilder =
            ...
            ListAtsScorecardsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsScorecardsRequest, to.unified.unified_java_sdk.models.operations.async.ListAtsScorecardsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsScorecardsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsScorecardsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsScorecardsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsScorecardsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsScorecardsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsScorecardsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsScorecardsResponse res = resBuilder.build();
