...
public class ListAtsScorecards {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsScorecardsRequest request) throws Exception {
        ...
        @Override
        public ListAtsScorecardsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AtsScorecard> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAtsScorecards(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
