...
public class PatchSigningSignatory2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchSigningSignatory2Request, PatchSigningSignatory2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchSigningSignatory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchSigningSignatory2Request.class, new TypeReference<PatchSigningSignatory2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchSigningSignatory2Request request) {
        ...
        @Override
        public PatchSigningSignatory2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchSigningSignatory2Response.Builder resBuilder =
            ...
            PatchSigningSignatory2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchSigningSignatory2Request, to.unified.unified_java_sdk.models.operations.async.PatchSigningSignatory2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchSigningSignatory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchSigningSignatory2Request.class, new TypeReference<PatchSigningSignatory2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchSigningSignatory2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchSigningSignatory2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchSigningSignatory2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchSigningSignatory2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchSigningSignatory2Response res = resBuilder.build();
