...
public class CreateCrmEvent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCrmEvent2Request, CreateCrmEvent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCrmEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmEvent2Request.class, new TypeReference<CreateCrmEvent2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCrmEvent2Request request) {
        ...
        @Override
        public CreateCrmEvent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCrmEvent2Response.Builder resBuilder =
            ...
            CreateCrmEvent2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCrmEvent(Utils.unmarshal(response, new TypeReference<CrmEvent>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCrmEvent2Request, to.unified.unified_java_sdk.models.operations.async.CreateCrmEvent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCrmEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmEvent2Request.class, new TypeReference<CreateCrmEvent2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCrmEvent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCrmEvent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCrmEvent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCrmEvent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCrmEvent2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CrmEvent>() {})
                            .thenApply(res::withCrmEvent);
                } else {
