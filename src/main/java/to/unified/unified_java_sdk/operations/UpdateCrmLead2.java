...
public class UpdateCrmLead2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCrmLead2Request, UpdateCrmLead2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCrmLead2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmLead2Request.class, new TypeReference<UpdateCrmLead2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCrmLead2Request request) {
        ...
        @Override
        public UpdateCrmLead2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCrmLead2Response.Builder resBuilder =
            ...
            UpdateCrmLead2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCrmLead(Utils.unmarshal(response, new TypeReference<CrmLead>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCrmLead2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCrmLead2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCrmLead2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmLead2Request.class, new TypeReference<UpdateCrmLead2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCrmLead2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCrmLead2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCrmLead2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCrmLead2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCrmLead2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CrmLead>() {})
                            .thenApply(res::withCrmLead);
                } else {
