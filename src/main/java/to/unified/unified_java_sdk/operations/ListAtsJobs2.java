...
public class ListAtsJobs2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAtsJobs2Request, ListAtsJobs2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAtsJobs2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsJobs2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsJobs2Request request) {
        ...
        @Override
        public ListAtsJobs2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsJobs2Response.Builder resBuilder =
            ...
            ListAtsJobs2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsJobs(Utils.unmarshal(response, new TypeReference<List<AtsJob>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsJobs2Request, to.unified.unified_java_sdk.models.operations.async.ListAtsJobs2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsJobs2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsJobs2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsJobs2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsJobs2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsJobs2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsJobs2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsJobs2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AtsJob>>() {})
                            .thenApply(res::withAtsJobs);
                } else {
