...
public class CreateAccountingCreditmemo {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAccountingCreditmemoRequest, CreateAccountingCreditmemoResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingCreditmemoRequest request) {
        ...
        @Override
        public CreateAccountingCreditmemoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAccountingCreditmemoResponse.Builder resBuilder =
            ...
            CreateAccountingCreditmemoResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAccountingCreditmemoRequest, to.unified.unified_java_sdk.models.operations.async.CreateAccountingCreditmemoResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAccountingCreditmemoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingCreditmemoRequest.class, new TypeReference<CreateAccountingCreditmemoRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAccountingCreditmemoRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAccountingCreditmemoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAccountingCreditmemoResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAccountingCreditmemoResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAccountingCreditmemoResponse res = resBuilder.build();
