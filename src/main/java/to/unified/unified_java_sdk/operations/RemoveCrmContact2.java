...
public class RemoveCrmContact2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCrmContact2Request, RemoveCrmContact2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCrmContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmContact2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCrmContact2Request request) {
        ...
        @Override
        public RemoveCrmContact2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCrmContact2Response.Builder resBuilder =
            ...
            RemoveCrmContact2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCrmContact2Request, to.unified.unified_java_sdk.models.operations.async.RemoveCrmContact2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCrmContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmContact2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCrmContact2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCrmContact2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCrmContact2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCrmContact2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCrmContact2Response res = resBuilder.build();
