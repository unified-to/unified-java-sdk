...
public class GetShippingLabel {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetShippingLabelRequest, GetShippingLabelResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetShippingLabelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingLabelRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetShippingLabelRequest request) {
        ...
        @Override
        public GetShippingLabelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetShippingLabelResponse.Builder resBuilder =
            ...
            GetShippingLabelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetShippingLabelRequest, to.unified.unified_java_sdk.models.operations.async.GetShippingLabelResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetShippingLabelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingLabelRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetShippingLabelRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetShippingLabelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetShippingLabelResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetShippingLabelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetShippingLabelResponse res = resBuilder.build();
