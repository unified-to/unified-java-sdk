...
public class UpdateCommerceItemOperation implements RequestOperation<UpdateCommerceItemRequest, UpdateCommerceItemResponse> {
    ...
    public UpdateCommerceItemOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateCommerceItemRequest request) throws Exception {
