...
public class UpdateScimUsersOperation implements RequestOperation<UpdateScimUsersRequest, UpdateScimUsersResponse> {
    ...
    public UpdateScimUsersOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateScimUsersRequest request) throws Exception {
