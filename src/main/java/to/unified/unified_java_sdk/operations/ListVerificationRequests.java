...
public class ListVerificationRequests {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListVerificationRequestsRequest, ListVerificationRequestsResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(ListVerificationRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVerificationRequestsRequest.class);
        ...
        public ListVerificationRequestsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            ListVerificationRequestsResponse.Builder resBuilder =
            ...
            ListVerificationRequestsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListVerificationRequestsRequest, to.unified.unified_java_sdk.models.operations.async.ListVerificationRequestsResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListVerificationRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVerificationRequestsRequest.class);
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListVerificationRequestsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListVerificationRequestsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListVerificationRequestsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListVerificationRequestsResponse res = resBuilder.build();
