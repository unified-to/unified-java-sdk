...
public class PatchPaymentLink2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchPaymentLink2Request, PatchPaymentLink2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchPaymentLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPaymentLink2Request.class, new TypeReference<PatchPaymentLink2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchPaymentLink2Request request) {
        ...
        @Override
        public PatchPaymentLink2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchPaymentLink2Response.Builder resBuilder =
            ...
            PatchPaymentLink2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchPaymentLink2Request, to.unified.unified_java_sdk.models.operations.async.PatchPaymentLink2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchPaymentLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPaymentLink2Request.class, new TypeReference<PatchPaymentLink2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchPaymentLink2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchPaymentLink2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchPaymentLink2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchPaymentLink2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchPaymentLink2Response res = resBuilder.build();
