...
public class CreateAssessmentPackage {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAssessmentPackageRequest, CreateAssessmentPackageResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAssessmentPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAssessmentPackageRequest.class, new TypeReference<CreateAssessmentPackageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAssessmentPackageRequest request) {
        ...
        @Override
        public CreateAssessmentPackageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAssessmentPackageResponse.Builder resBuilder =
            ...
            CreateAssessmentPackageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAssessmentPackageRequest, to.unified.unified_java_sdk.models.operations.async.CreateAssessmentPackageResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAssessmentPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAssessmentPackageRequest.class, new TypeReference<CreateAssessmentPackageRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAssessmentPackageRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAssessmentPackageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAssessmentPackageResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAssessmentPackageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAssessmentPackageResponse res = resBuilder.build();
