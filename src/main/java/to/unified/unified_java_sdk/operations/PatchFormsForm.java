...
public class PatchFormsForm {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchFormsFormRequest, PatchFormsFormResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchFormsFormRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchFormsFormRequest.class, new TypeReference<PatchFormsFormRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchFormsFormRequest request) {
        ...
        @Override
        public PatchFormsFormResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchFormsFormResponse.Builder resBuilder =
            ...
            PatchFormsFormResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchFormsFormRequest, to.unified.unified_java_sdk.models.operations.async.PatchFormsFormResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchFormsFormRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchFormsFormRequest.class, new TypeReference<PatchFormsFormRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchFormsFormRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchFormsFormResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchFormsFormResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchFormsFormResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchFormsFormResponse res = resBuilder.build();
