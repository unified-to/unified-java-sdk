...
public class GetCdpSource {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCdpSourceRequest, GetCdpSourceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCdpSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCdpSourceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCdpSourceRequest request) {
        ...
        @Override
        public GetCdpSourceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCdpSourceResponse.Builder resBuilder =
            ...
            GetCdpSourceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCdpSourceRequest, to.unified.unified_java_sdk.models.operations.async.GetCdpSourceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCdpSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCdpSourceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCdpSourceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCdpSourceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCdpSourceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCdpSourceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCdpSourceResponse res = resBuilder.build();
