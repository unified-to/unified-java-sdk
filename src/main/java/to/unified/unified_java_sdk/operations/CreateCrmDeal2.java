...
public class CreateCrmDeal2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCrmDeal2Request, CreateCrmDeal2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCrmDeal2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmDeal2Request.class, new TypeReference<CreateCrmDeal2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCrmDeal2Request request) {
        ...
        @Override
        public CreateCrmDeal2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCrmDeal2Response.Builder resBuilder =
            ...
            CreateCrmDeal2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCrmDeal2Request, to.unified.unified_java_sdk.models.operations.async.CreateCrmDeal2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCrmDeal2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmDeal2Request.class, new TypeReference<CreateCrmDeal2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCrmDeal2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCrmDeal2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCrmDeal2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCrmDeal2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCrmDeal2Response res = resBuilder.build();
