...
public class RemoveSigningDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveSigningDocumentRequest, RemoveSigningDocumentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveSigningDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveSigningDocumentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveSigningDocumentRequest request) {
        ...
        @Override
        public RemoveSigningDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveSigningDocumentResponse.Builder resBuilder =
            ...
            RemoveSigningDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveSigningDocumentRequest, to.unified.unified_java_sdk.models.operations.async.RemoveSigningDocumentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveSigningDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveSigningDocumentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveSigningDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveSigningDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveSigningDocumentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveSigningDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveSigningDocumentResponse res = resBuilder.build();
