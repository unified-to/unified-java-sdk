...
public class GetCalendarEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCalendarEventRequest, GetCalendarEventResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCalendarEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarEventRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCalendarEventRequest request) {
        ...
        @Override
        public GetCalendarEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCalendarEventResponse.Builder resBuilder =
            ...
            GetCalendarEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCalendarEventRequest, to.unified.unified_java_sdk.models.operations.async.GetCalendarEventResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCalendarEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarEventRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCalendarEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCalendarEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCalendarEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCalendarEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCalendarEventResponse res = resBuilder.build();
