...
public class RemoveAccountingSalesorder2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingSalesorder2Request, RemoveAccountingSalesorder2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingSalesorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingSalesorder2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingSalesorder2Request request) {
        ...
        @Override
        public RemoveAccountingSalesorder2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingSalesorder2Response.Builder resBuilder =
            ...
            RemoveAccountingSalesorder2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingSalesorder2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingSalesorder2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingSalesorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingSalesorder2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingSalesorder2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingSalesorder2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingSalesorder2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingSalesorder2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingSalesorder2Response res = resBuilder.build();
