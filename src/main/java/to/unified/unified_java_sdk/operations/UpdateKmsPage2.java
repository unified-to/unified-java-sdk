...
public class UpdateKmsPage2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateKmsPage2Request, UpdateKmsPage2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateKmsPage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateKmsPage2Request.class, new TypeReference<UpdateKmsPage2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateKmsPage2Request request) {
        ...
        @Override
        public UpdateKmsPage2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateKmsPage2Response.Builder resBuilder =
            ...
            UpdateKmsPage2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateKmsPage2Request, to.unified.unified_java_sdk.models.operations.async.UpdateKmsPage2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateKmsPage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateKmsPage2Request.class, new TypeReference<UpdateKmsPage2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateKmsPage2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateKmsPage2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateKmsPage2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateKmsPage2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateKmsPage2Response res = resBuilder.build();
