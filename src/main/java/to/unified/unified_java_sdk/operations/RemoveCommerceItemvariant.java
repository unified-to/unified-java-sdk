...
public class RemoveCommerceItemvariant {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCommerceItemvariantRequest, RemoveCommerceItemvariantResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCommerceItemvariantRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceItemvariantRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCommerceItemvariantRequest request) {
        ...
        @Override
        public RemoveCommerceItemvariantResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCommerceItemvariantResponse.Builder resBuilder =
            ...
            RemoveCommerceItemvariantResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCommerceItemvariantRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCommerceItemvariantResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCommerceItemvariantRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceItemvariantRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCommerceItemvariantRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCommerceItemvariantResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceItemvariantResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCommerceItemvariantResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceItemvariantResponse res = resBuilder.build();
