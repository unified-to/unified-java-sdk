...
public class RemoveCrmLead2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCrmLead2Request, RemoveCrmLead2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCrmLead2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmLead2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCrmLead2Request request) {
        ...
        @Override
        public RemoveCrmLead2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCrmLead2Response.Builder resBuilder =
            ...
            RemoveCrmLead2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCrmLead2Request, to.unified.unified_java_sdk.models.operations.async.RemoveCrmLead2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCrmLead2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmLead2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCrmLead2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCrmLead2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCrmLead2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCrmLead2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCrmLead2Response res = resBuilder.build();
