...
public class CreateAnalyticsProperty {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAnalyticsPropertyRequest, CreateAnalyticsPropertyResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAnalyticsPropertyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAnalyticsPropertyRequest.class, new TypeReference<CreateAnalyticsPropertyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAnalyticsPropertyRequest request) {
        ...
        @Override
        public CreateAnalyticsPropertyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAnalyticsPropertyResponse.Builder resBuilder =
            ...
            CreateAnalyticsPropertyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAnalyticsPropertyRequest, to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsPropertyResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAnalyticsPropertyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAnalyticsPropertyRequest.class, new TypeReference<CreateAnalyticsPropertyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAnalyticsPropertyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsPropertyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsPropertyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsPropertyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsPropertyResponse res = resBuilder.build();
