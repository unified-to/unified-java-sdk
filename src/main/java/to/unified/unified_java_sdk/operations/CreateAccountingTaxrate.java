...
public class CreateAccountingTaxrate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingTaxrateRequest request) throws Exception {
        ...
        @Override
        public CreateAccountingTaxrateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingTaxrate out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingTaxrate(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
