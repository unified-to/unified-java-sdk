...
public class GetClubsGroup2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetClubsGroup2Request, GetClubsGroup2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetClubsGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsGroup2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClubsGroup2Request request) {
        ...
        @Override
        public GetClubsGroup2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetClubsGroup2Response.Builder resBuilder =
            ...
            GetClubsGroup2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClubsGroup(Utils.unmarshal(response, new TypeReference<ClubsGroup>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetClubsGroup2Request, to.unified.unified_java_sdk.models.operations.async.GetClubsGroup2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetClubsGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsGroup2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetClubsGroup2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetClubsGroup2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetClubsGroup2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetClubsGroup2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetClubsGroup2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ClubsGroup>() {})
                            .thenApply(res::withClubsGroup);
                } else {
