...
public class GetCommerceReview2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceReview2Request, GetCommerceReview2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommerceReview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceReview2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceReview2Request request) {
        ...
        @Override
        public GetCommerceReview2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommerceReview2Response.Builder resBuilder =
            ...
            GetCommerceReview2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommerceReview2Request, to.unified.unified_java_sdk.models.operations.async.GetCommerceReview2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommerceReview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceReview2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommerceReview2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCommerceReview2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCommerceReview2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCommerceReview2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCommerceReview2Response res = resBuilder.build();
