...
public class CreateGenaiEmbedding {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateGenaiEmbeddingRequest request) throws Exception {
        ...
        @Override
        public CreateGenaiEmbeddingResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GenaiEmbedding out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGenaiEmbedding(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
