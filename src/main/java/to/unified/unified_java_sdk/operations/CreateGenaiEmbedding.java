...
public class CreateGenaiEmbedding {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateGenaiEmbeddingRequest, CreateGenaiEmbeddingResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateGenaiEmbeddingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateGenaiEmbeddingRequest.class, new TypeReference<CreateGenaiEmbeddingRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateGenaiEmbeddingRequest request) {
        ...
        @Override
        public CreateGenaiEmbeddingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateGenaiEmbeddingResponse.Builder resBuilder =
            ...
            CreateGenaiEmbeddingResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateGenaiEmbeddingRequest, to.unified.unified_java_sdk.models.operations.async.CreateGenaiEmbeddingResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateGenaiEmbeddingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateGenaiEmbeddingRequest.class, new TypeReference<CreateGenaiEmbeddingRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateGenaiEmbeddingRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateGenaiEmbeddingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateGenaiEmbeddingResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateGenaiEmbeddingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateGenaiEmbeddingResponse res = resBuilder.build();
