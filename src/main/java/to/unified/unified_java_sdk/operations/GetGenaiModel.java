...
public class GetGenaiModel {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetGenaiModelRequest, GetGenaiModelResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetGenaiModelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetGenaiModelRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetGenaiModelRequest request) {
        ...
        @Override
        public GetGenaiModelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetGenaiModelResponse.Builder resBuilder =
            ...
            GetGenaiModelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetGenaiModelRequest, to.unified.unified_java_sdk.models.operations.async.GetGenaiModelResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetGenaiModelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetGenaiModelRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetGenaiModelRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetGenaiModelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetGenaiModelResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetGenaiModelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetGenaiModelResponse res = resBuilder.build();
