...
public class GetGenaiModel {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetGenaiModelRequest request) throws Exception {
        ...
        @Override
        public GetGenaiModelResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GenaiModel out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGenaiModel(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
