...
public class RemoveCdpProfile {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCdpProfileRequest, RemoveCdpProfileResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCdpProfileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCdpProfileRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCdpProfileRequest request) {
        ...
        @Override
        public RemoveCdpProfileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCdpProfileResponse.Builder resBuilder =
            ...
            RemoveCdpProfileResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCdpProfileRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCdpProfileResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCdpProfileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCdpProfileRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCdpProfileRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCdpProfileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCdpProfileResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCdpProfileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCdpProfileResponse res = resBuilder.build();
