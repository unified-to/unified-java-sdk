...
public class PatchAccountingPurchaseorder {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingPurchaseorderRequest, PatchAccountingPurchaseorderResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingPurchaseorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingPurchaseorderRequest.class, new TypeReference<PatchAccountingPurchaseorderRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingPurchaseorderRequest request) {
        ...
        @Override
        public PatchAccountingPurchaseorderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingPurchaseorderResponse.Builder resBuilder =
            ...
            PatchAccountingPurchaseorderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingPurchaseorderRequest, to.unified.unified_java_sdk.models.operations.async.PatchAccountingPurchaseorderResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingPurchaseorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingPurchaseorderRequest.class, new TypeReference<PatchAccountingPurchaseorderRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingPurchaseorderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingPurchaseorderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingPurchaseorderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingPurchaseorderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingPurchaseorderResponse res = resBuilder.build();
