...
public class PatchRepoCommit {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchRepoCommitRequest, PatchRepoCommitResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchRepoCommitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoCommitRequest.class, new TypeReference<PatchRepoCommitRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchRepoCommitRequest request) {
        ...
        @Override
        public PatchRepoCommitResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchRepoCommitResponse.Builder resBuilder =
            ...
            PatchRepoCommitResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchRepoCommitRequest, to.unified.unified_java_sdk.models.operations.async.PatchRepoCommitResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchRepoCommitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoCommitRequest.class, new TypeReference<PatchRepoCommitRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchRepoCommitRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchRepoCommitResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchRepoCommitResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchRepoCommitResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchRepoCommitResponse res = resBuilder.build();
