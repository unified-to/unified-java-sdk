...
public class ListAtsJobs {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAtsJobsRequest, ListAtsJobsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAtsJobsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsJobsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsJobsRequest request) {
        ...
        @Override
        public ListAtsJobsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsJobsResponse.Builder resBuilder =
                    ListAtsJobsResponse
                            .builder()
            ...
            ListAtsJobsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsJobsRequest, to.unified.unified_java_sdk.models.operations.async.ListAtsJobsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsJobsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsJobsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsJobsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsJobsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsJobsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsJobsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsJobsResponse res = resBuilder.build();
