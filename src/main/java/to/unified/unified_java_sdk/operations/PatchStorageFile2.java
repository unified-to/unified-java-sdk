...
public class PatchStorageFile2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchStorageFile2Request, PatchStorageFile2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchStorageFile2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchStorageFile2Request.class, new TypeReference<PatchStorageFile2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchStorageFile2Request request) {
        ...
        @Override
        public PatchStorageFile2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchStorageFile2Response.Builder resBuilder =
            ...
            PatchStorageFile2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchStorageFile2Request, to.unified.unified_java_sdk.models.operations.async.PatchStorageFile2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchStorageFile2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchStorageFile2Request.class, new TypeReference<PatchStorageFile2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchStorageFile2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchStorageFile2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchStorageFile2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchStorageFile2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchStorageFile2Response res = resBuilder.build();
