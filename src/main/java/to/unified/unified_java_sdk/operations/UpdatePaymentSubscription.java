...
public class UpdatePaymentSubscription {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatePaymentSubscriptionRequest, UpdatePaymentSubscriptionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdatePaymentSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePaymentSubscriptionRequest.class, new TypeReference<UpdatePaymentSubscriptionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePaymentSubscriptionRequest request) {
        ...
        @Override
        public UpdatePaymentSubscriptionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatePaymentSubscriptionResponse.Builder resBuilder =
            ...
            UpdatePaymentSubscriptionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatePaymentSubscriptionRequest, to.unified.unified_java_sdk.models.operations.async.UpdatePaymentSubscriptionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePaymentSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePaymentSubscriptionRequest.class, new TypeReference<UpdatePaymentSubscriptionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatePaymentSubscriptionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdatePaymentSubscriptionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdatePaymentSubscriptionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdatePaymentSubscriptionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdatePaymentSubscriptionResponse res = resBuilder.build();
