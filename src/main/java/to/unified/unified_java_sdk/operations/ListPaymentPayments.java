...
public class ListPaymentPayments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentPaymentsRequest request) throws Exception {
        ...
        @Override
        public ListPaymentPaymentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<PaymentPayment> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentPayments(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
