...
public class ListPaymentPayments {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPaymentPaymentsRequest, ListPaymentPaymentsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPaymentPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentPaymentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentPaymentsRequest request) {
        ...
        @Override
        public ListPaymentPaymentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPaymentPaymentsResponse.Builder resBuilder =
            ...
            ListPaymentPaymentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentPaymentsRequest, to.unified.unified_java_sdk.models.operations.async.ListPaymentPaymentsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPaymentPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentPaymentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPaymentPaymentsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListPaymentPaymentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListPaymentPaymentsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListPaymentPaymentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListPaymentPaymentsResponse res = resBuilder.build();
