...
public class CreateAtsInterviewOperation implements RequestOperation<CreateAtsInterviewRequest, CreateAtsInterviewResponse> {
    ...
    public CreateAtsInterviewOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAtsInterviewRequest request) throws Exception {
