...
public class CreateLmsCollection {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateLmsCollectionRequest, CreateLmsCollectionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateLmsCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsCollectionRequest.class, new TypeReference<CreateLmsCollectionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateLmsCollectionRequest request) {
        ...
        @Override
        public CreateLmsCollectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateLmsCollectionResponse.Builder resBuilder =
            ...
            CreateLmsCollectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateLmsCollectionRequest, to.unified.unified_java_sdk.models.operations.async.CreateLmsCollectionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateLmsCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsCollectionRequest.class, new TypeReference<CreateLmsCollectionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateLmsCollectionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateLmsCollectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateLmsCollectionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateLmsCollectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateLmsCollectionResponse res = resBuilder.build();
