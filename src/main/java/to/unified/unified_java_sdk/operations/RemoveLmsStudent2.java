...
public class RemoveLmsStudent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveLmsStudent2Request, RemoveLmsStudent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveLmsStudent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsStudent2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveLmsStudent2Request request) {
        ...
        @Override
        public RemoveLmsStudent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveLmsStudent2Response.Builder resBuilder =
            ...
            RemoveLmsStudent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveLmsStudent2Request, to.unified.unified_java_sdk.models.operations.async.RemoveLmsStudent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveLmsStudent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsStudent2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveLmsStudent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveLmsStudent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveLmsStudent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveLmsStudent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveLmsStudent2Response res = resBuilder.build();
