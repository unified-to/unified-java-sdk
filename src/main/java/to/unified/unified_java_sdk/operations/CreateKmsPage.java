...
public class CreateKmsPage {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateKmsPageRequest, CreateKmsPageResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateKmsPageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateKmsPageRequest.class, new TypeReference<CreateKmsPageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateKmsPageRequest request) {
        ...
        @Override
        public CreateKmsPageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateKmsPageResponse.Builder resBuilder =
            ...
            CreateKmsPageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateKmsPageRequest, to.unified.unified_java_sdk.models.operations.async.CreateKmsPageResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateKmsPageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateKmsPageRequest.class, new TypeReference<CreateKmsPageRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateKmsPageRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateKmsPageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateKmsPageResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateKmsPageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateKmsPageResponse res = resBuilder.build();
