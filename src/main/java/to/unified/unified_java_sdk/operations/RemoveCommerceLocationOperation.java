...
public class RemoveCommerceLocationOperation implements RequestOperation<RemoveCommerceLocationRequest, RemoveCommerceLocationResponse> {
    ...
    public RemoveCommerceLocationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveCommerceLocationRequest request) throws Exception {
