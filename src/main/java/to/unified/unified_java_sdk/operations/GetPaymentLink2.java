...
public class GetPaymentLink2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPaymentLink2Request, GetPaymentLink2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPaymentLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentLink2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentLink2Request request) {
        ...
        @Override
        public GetPaymentLink2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPaymentLink2Response.Builder resBuilder =
            ...
            GetPaymentLink2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentLink2Request, to.unified.unified_java_sdk.models.operations.async.GetPaymentLink2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPaymentLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentLink2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPaymentLink2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetPaymentLink2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetPaymentLink2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetPaymentLink2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetPaymentLink2Response res = resBuilder.build();
