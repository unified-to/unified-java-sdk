...
public class PatchCommerceInventory2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCommerceInventory2Request, PatchCommerceInventory2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCommerceInventory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceInventory2Request.class, new TypeReference<PatchCommerceInventory2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCommerceInventory2Request request) {
        ...
        @Override
        public PatchCommerceInventory2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCommerceInventory2Response.Builder resBuilder =
            ...
            PatchCommerceInventory2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCommerceInventory2Request, to.unified.unified_java_sdk.models.operations.async.PatchCommerceInventory2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCommerceInventory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceInventory2Request.class, new TypeReference<PatchCommerceInventory2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCommerceInventory2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCommerceInventory2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCommerceInventory2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCommerceInventory2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCommerceInventory2Response res = resBuilder.build();
