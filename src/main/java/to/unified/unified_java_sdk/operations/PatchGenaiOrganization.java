...
public class PatchGenaiOrganization {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchGenaiOrganizationRequest, PatchGenaiOrganizationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchGenaiOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchGenaiOrganizationRequest.class, new TypeReference<PatchGenaiOrganizationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchGenaiOrganizationRequest request) {
        ...
        @Override
        public PatchGenaiOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchGenaiOrganizationResponse.Builder resBuilder =
                    PatchGenaiOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            PatchGenaiOrganizationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchGenaiOrganizationRequest, to.unified.unified_java_sdk.models.operations.async.PatchGenaiOrganizationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchGenaiOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchGenaiOrganizationRequest.class, new TypeReference<PatchGenaiOrganizationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchGenaiOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchGenaiOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchGenaiOrganizationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchGenaiOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchGenaiOrganizationResponse res = resBuilder.build();
