...
public class PatchTicketingTicketOperation implements RequestOperation<PatchTicketingTicketRequest, PatchTicketingTicketResponse> {
    ...
    public PatchTicketingTicketOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchTicketingTicketRequest request) throws Exception {
