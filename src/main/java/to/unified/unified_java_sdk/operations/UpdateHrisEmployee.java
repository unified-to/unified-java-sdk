...
public class UpdateHrisEmployee {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisEmployeeRequest, UpdateHrisEmployeeResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisEmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisEmployeeRequest.class, new TypeReference<UpdateHrisEmployeeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisEmployeeRequest request) {
        ...
        @Override
        public UpdateHrisEmployeeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisEmployeeResponse.Builder resBuilder =
            ...
            UpdateHrisEmployeeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisEmployeeRequest, to.unified.unified_java_sdk.models.operations.async.UpdateHrisEmployeeResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisEmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisEmployeeRequest.class, new TypeReference<UpdateHrisEmployeeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisEmployeeRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisEmployeeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisEmployeeResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisEmployeeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisEmployeeResponse res = resBuilder.build();
