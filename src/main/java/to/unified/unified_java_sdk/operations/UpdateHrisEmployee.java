...
public class UpdateHrisEmployee {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisEmployeeRequest request) throws Exception {
        ...
        @Override
        public UpdateHrisEmployeeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HrisEmployee out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHrisEmployee(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
