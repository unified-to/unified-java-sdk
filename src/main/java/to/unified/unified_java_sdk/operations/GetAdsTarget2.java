...
public class GetAdsTarget2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAdsTarget2Request, GetAdsTarget2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAdsTarget2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsTarget2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAdsTarget2Request request) {
        ...
        @Override
        public GetAdsTarget2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAdsTarget2Response.Builder resBuilder =
            ...
            GetAdsTarget2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdsTarget(Utils.unmarshal(response, new TypeReference<AdsTarget>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAdsTarget2Request, to.unified.unified_java_sdk.models.operations.async.GetAdsTarget2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAdsTarget2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsTarget2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAdsTarget2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAdsTarget2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAdsTarget2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAdsTarget2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAdsTarget2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AdsTarget>() {})
                            .thenApply(res::withAdsTarget);
                } else {
