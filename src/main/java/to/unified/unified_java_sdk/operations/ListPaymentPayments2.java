...
public class ListPaymentPayments2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPaymentPayments2Request, ListPaymentPayments2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPaymentPayments2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentPayments2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentPayments2Request request) {
        ...
        @Override
        public ListPaymentPayments2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPaymentPayments2Response.Builder resBuilder =
            ...
            ListPaymentPayments2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentPayments(Utils.unmarshal(response, new TypeReference<List<PaymentPayment>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentPayments2Request, to.unified.unified_java_sdk.models.operations.async.ListPaymentPayments2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPaymentPayments2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentPayments2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPaymentPayments2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListPaymentPayments2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListPaymentPayments2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListPaymentPayments2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListPaymentPayments2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<PaymentPayment>>() {})
                            .thenApply(res::withPaymentPayments);
                } else {
