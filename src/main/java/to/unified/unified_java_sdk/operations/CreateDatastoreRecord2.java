...
public class CreateDatastoreRecord2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateDatastoreRecord2Request, CreateDatastoreRecord2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateDatastoreRecord2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDatastoreRecord2Request.class, new TypeReference<CreateDatastoreRecord2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDatastoreRecord2Request request) {
        ...
        @Override
        public CreateDatastoreRecord2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDatastoreRecord2Response.Builder resBuilder =
            ...
            CreateDatastoreRecord2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDatastoreRecord(Utils.unmarshal(response, new TypeReference<DatastoreRecord>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateDatastoreRecord2Request, to.unified.unified_java_sdk.models.operations.async.CreateDatastoreRecord2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateDatastoreRecord2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDatastoreRecord2Request.class, new TypeReference<CreateDatastoreRecord2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateDatastoreRecord2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateDatastoreRecord2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateDatastoreRecord2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateDatastoreRecord2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateDatastoreRecord2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DatastoreRecord>() {})
                            .thenApply(res::withDatastoreRecord);
                } else {
