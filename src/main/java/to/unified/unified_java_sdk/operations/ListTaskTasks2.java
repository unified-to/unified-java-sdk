...
public class ListTaskTasks2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTaskTasks2Request, ListTaskTasks2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListTaskTasks2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaskTasks2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTaskTasks2Request request) {
        ...
        @Override
        public ListTaskTasks2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTaskTasks2Response.Builder resBuilder =
            ...
            ListTaskTasks2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTaskTasks(Utils.unmarshal(response, new TypeReference<List<TaskTask>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTaskTasks2Request, to.unified.unified_java_sdk.models.operations.async.ListTaskTasks2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListTaskTasks2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaskTasks2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTaskTasks2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListTaskTasks2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListTaskTasks2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListTaskTasks2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListTaskTasks2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<TaskTask>>() {})
                            .thenApply(res::withTaskTasks);
                } else {
