...
public class UpdateCalendarLink2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCalendarLink2Request, UpdateCalendarLink2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCalendarLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCalendarLink2Request.class, new TypeReference<UpdateCalendarLink2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCalendarLink2Request request) {
        ...
        @Override
        public UpdateCalendarLink2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCalendarLink2Response.Builder resBuilder =
            ...
            UpdateCalendarLink2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCalendarLink2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCalendarLink2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCalendarLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCalendarLink2Request.class, new TypeReference<UpdateCalendarLink2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCalendarLink2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCalendarLink2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCalendarLink2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCalendarLink2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCalendarLink2Response res = resBuilder.build();
