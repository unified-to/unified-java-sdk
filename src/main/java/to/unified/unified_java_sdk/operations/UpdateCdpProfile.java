...
public class UpdateCdpProfile {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCdpProfileRequest, UpdateCdpProfileResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCdpProfileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCdpProfileRequest.class, new TypeReference<UpdateCdpProfileRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCdpProfileRequest request) {
        ...
        @Override
        public UpdateCdpProfileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCdpProfileResponse.Builder resBuilder =
            ...
            UpdateCdpProfileResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCdpProfile(Utils.unmarshal(response, new TypeReference<CdpProfile>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCdpProfileRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCdpProfileResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCdpProfileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCdpProfileRequest.class, new TypeReference<UpdateCdpProfileRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCdpProfileRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCdpProfileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCdpProfileResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCdpProfileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCdpProfileResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CdpProfile>() {})
                            .thenApply(res::withCdpProfile);
                } else {
