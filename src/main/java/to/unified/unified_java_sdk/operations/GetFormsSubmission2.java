...
public class GetFormsSubmission2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFormsSubmission2Request, GetFormsSubmission2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetFormsSubmission2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetFormsSubmission2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFormsSubmission2Request request) {
        ...
        @Override
        public GetFormsSubmission2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFormsSubmission2Response.Builder resBuilder =
            ...
            GetFormsSubmission2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFormsSubmission(Utils.unmarshal(response, new TypeReference<FormsSubmission>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFormsSubmission2Request, to.unified.unified_java_sdk.models.operations.async.GetFormsSubmission2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetFormsSubmission2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetFormsSubmission2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFormsSubmission2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetFormsSubmission2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetFormsSubmission2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetFormsSubmission2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetFormsSubmission2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FormsSubmission>() {})
                            .thenApply(res::withFormsSubmission);
                } else {
