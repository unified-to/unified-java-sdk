...
public class UpdateCommerceItemvariant {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommerceItemvariantRequest, UpdateCommerceItemvariantResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCommerceItemvariantRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceItemvariantRequest.class, new TypeReference<UpdateCommerceItemvariantRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceItemvariantRequest request) {
        ...
        @Override
        public UpdateCommerceItemvariantResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommerceItemvariantResponse.Builder resBuilder =
            ...
            UpdateCommerceItemvariantResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommerceItemvariantRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCommerceItemvariantResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommerceItemvariantRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceItemvariantRequest.class, new TypeReference<UpdateCommerceItemvariantRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommerceItemvariantRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCommerceItemvariantResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceItemvariantResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCommerceItemvariantResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceItemvariantResponse res = resBuilder.build();
