...
public class CreateCommerceSaleschannel2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommerceSaleschannel2Request, CreateCommerceSaleschannel2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommerceSaleschannel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceSaleschannel2Request.class, new TypeReference<CreateCommerceSaleschannel2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceSaleschannel2Request request) {
        ...
        @Override
        public CreateCommerceSaleschannel2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommerceSaleschannel2Response.Builder resBuilder =
            ...
            CreateCommerceSaleschannel2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceSaleschannel(Utils.unmarshal(response, new TypeReference<CommerceSaleschannel>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommerceSaleschannel2Request, to.unified.unified_java_sdk.models.operations.async.CreateCommerceSaleschannel2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommerceSaleschannel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceSaleschannel2Request.class, new TypeReference<CreateCommerceSaleschannel2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommerceSaleschannel2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCommerceSaleschannel2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCommerceSaleschannel2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCommerceSaleschannel2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCommerceSaleschannel2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CommerceSaleschannel>() {})
                            .thenApply(res::withCommerceSaleschannel);
                } else {
