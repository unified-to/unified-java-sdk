...
public class ListAdsOrganizations2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsOrganizations2Request, ListAdsOrganizations2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsOrganizations2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsOrganizations2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsOrganizations2Request request) {
        ...
        @Override
        public ListAdsOrganizations2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsOrganizations2Response.Builder resBuilder =
            ...
            ListAdsOrganizations2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdsOrganizations(Utils.unmarshal(response, new TypeReference<List<AdsOrganization>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsOrganizations2Request, to.unified.unified_java_sdk.models.operations.async.ListAdsOrganizations2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsOrganizations2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsOrganizations2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsOrganizations2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsOrganizations2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsOrganizations2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsOrganizations2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsOrganizations2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AdsOrganization>>() {})
                            .thenApply(res::withAdsOrganizations);
                } else {
