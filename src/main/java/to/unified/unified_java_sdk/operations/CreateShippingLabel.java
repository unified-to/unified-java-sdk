...
public class CreateShippingLabel {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateShippingLabelRequest, CreateShippingLabelResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateShippingLabelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateShippingLabelRequest.class, new TypeReference<CreateShippingLabelRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateShippingLabelRequest request) {
        ...
        @Override
        public CreateShippingLabelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateShippingLabelResponse.Builder resBuilder =
            ...
            CreateShippingLabelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateShippingLabelRequest, to.unified.unified_java_sdk.models.operations.async.CreateShippingLabelResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateShippingLabelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateShippingLabelRequest.class, new TypeReference<CreateShippingLabelRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateShippingLabelRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateShippingLabelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateShippingLabelResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateShippingLabelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateShippingLabelResponse res = resBuilder.build();
