...
public class GetShippingShipment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetShippingShipment2Request, GetShippingShipment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetShippingShipment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingShipment2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetShippingShipment2Request request) {
        ...
        @Override
        public GetShippingShipment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetShippingShipment2Response.Builder resBuilder =
            ...
            GetShippingShipment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetShippingShipment2Request, to.unified.unified_java_sdk.models.operations.async.GetShippingShipment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetShippingShipment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingShipment2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetShippingShipment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetShippingShipment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetShippingShipment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetShippingShipment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetShippingShipment2Response res = resBuilder.build();
