...
public class ListLmsCollections {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListLmsCollectionsRequest, ListLmsCollectionsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListLmsCollectionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsCollectionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsCollectionsRequest request) {
        ...
        @Override
        public ListLmsCollectionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListLmsCollectionsResponse.Builder resBuilder =
            ...
            ListLmsCollectionsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLmsCollectionsRequest, to.unified.unified_java_sdk.models.operations.async.ListLmsCollectionsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListLmsCollectionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsCollectionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListLmsCollectionsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListLmsCollectionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListLmsCollectionsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListLmsCollectionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListLmsCollectionsResponse res = resBuilder.build();
