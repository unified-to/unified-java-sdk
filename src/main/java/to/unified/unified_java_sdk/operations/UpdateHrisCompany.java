...
public class UpdateHrisCompany {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisCompanyRequest request) throws Exception {
        ...
        @Override
        public UpdateHrisCompanyResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HrisCompany out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHrisCompany(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
