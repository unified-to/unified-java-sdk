...
public class UpdateHrisCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisCompanyRequest, UpdateHrisCompanyResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisCompanyRequest.class, new TypeReference<UpdateHrisCompanyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisCompanyRequest request) {
        ...
        @Override
        public UpdateHrisCompanyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisCompanyResponse.Builder resBuilder =
            ...
            UpdateHrisCompanyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisCompanyRequest, to.unified.unified_java_sdk.models.operations.async.UpdateHrisCompanyResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisCompanyRequest.class, new TypeReference<UpdateHrisCompanyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisCompanyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisCompanyResponse res = resBuilder.build();
