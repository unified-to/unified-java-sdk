...
public class PatchCrmContact2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCrmContact2Request, PatchCrmContact2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCrmContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmContact2Request.class, new TypeReference<PatchCrmContact2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCrmContact2Request request) {
        ...
        @Override
        public PatchCrmContact2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCrmContact2Response.Builder resBuilder =
            ...
            PatchCrmContact2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCrmContact2Request, to.unified.unified_java_sdk.models.operations.async.PatchCrmContact2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCrmContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmContact2Request.class, new TypeReference<PatchCrmContact2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCrmContact2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCrmContact2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCrmContact2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCrmContact2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCrmContact2Response res = resBuilder.build();
