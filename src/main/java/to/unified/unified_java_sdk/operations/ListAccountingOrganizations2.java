...
public class ListAccountingOrganizations2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAccountingOrganizations2Request, ListAccountingOrganizations2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAccountingOrganizations2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAccountingOrganizations2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountingOrganizations2Request request) {
        ...
        @Override
        public ListAccountingOrganizations2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAccountingOrganizations2Response.Builder resBuilder =
            ...
            ListAccountingOrganizations2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountingOrganizations(Utils.unmarshal(response, new TypeReference<List<AccountingOrganization>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAccountingOrganizations2Request, to.unified.unified_java_sdk.models.operations.async.ListAccountingOrganizations2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAccountingOrganizations2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAccountingOrganizations2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAccountingOrganizations2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAccountingOrganizations2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAccountingOrganizations2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAccountingOrganizations2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAccountingOrganizations2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AccountingOrganization>>() {})
                            .thenApply(res::withAccountingOrganizations);
                } else {
