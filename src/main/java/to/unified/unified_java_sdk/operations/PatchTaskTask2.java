...
public class PatchTaskTask2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchTaskTask2Request, PatchTaskTask2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchTaskTask2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTaskTask2Request.class, new TypeReference<PatchTaskTask2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchTaskTask2Request request) {
        ...
        @Override
        public PatchTaskTask2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchTaskTask2Response.Builder resBuilder =
            ...
            PatchTaskTask2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchTaskTask2Request, to.unified.unified_java_sdk.models.operations.async.PatchTaskTask2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchTaskTask2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTaskTask2Request.class, new TypeReference<PatchTaskTask2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchTaskTask2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchTaskTask2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchTaskTask2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchTaskTask2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchTaskTask2Response res = resBuilder.build();
