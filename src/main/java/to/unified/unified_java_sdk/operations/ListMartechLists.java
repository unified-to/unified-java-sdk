...
public class ListMartechLists {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMartechListsRequest request) throws Exception {
        ...
        @Override
        public ListMartechListsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<MarketingList> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMarketingLists(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
