...
public class ListMartechLists {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMartechListsRequest, ListMartechListsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListMartechListsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMartechListsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMartechListsRequest request) {
        ...
        @Override
        public ListMartechListsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMartechListsResponse.Builder resBuilder =
            ...
            ListMartechListsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMartechListsRequest, to.unified.unified_java_sdk.models.operations.async.ListMartechListsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMartechListsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMartechListsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMartechListsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListMartechListsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListMartechListsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListMartechListsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListMartechListsResponse res = resBuilder.build();
