...
public class PatchCrmEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCrmEventRequest, PatchCrmEventResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCrmEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmEventRequest.class, new TypeReference<PatchCrmEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCrmEventRequest request) {
        ...
        @Override
        public PatchCrmEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCrmEventResponse.Builder resBuilder =
            ...
            PatchCrmEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCrmEventRequest, to.unified.unified_java_sdk.models.operations.async.PatchCrmEventResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCrmEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmEventRequest.class, new TypeReference<PatchCrmEventRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCrmEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCrmEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCrmEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCrmEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCrmEventResponse res = resBuilder.build();
