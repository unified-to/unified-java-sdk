...
public class CreateUnifiedConnectionOperation implements RequestOperation<Connection, CreateUnifiedConnectionResponse> {
    ...
    public CreateUnifiedConnectionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(Connection request) throws Exception {
