...
public class GetAdsInsertionorder {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAdsInsertionorderRequest, GetAdsInsertionorderResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAdsInsertionorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsInsertionorderRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAdsInsertionorderRequest request) {
        ...
        @Override
        public GetAdsInsertionorderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAdsInsertionorderResponse.Builder resBuilder =
            ...
            GetAdsInsertionorderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAdsInsertionorderRequest, to.unified.unified_java_sdk.models.operations.async.GetAdsInsertionorderResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAdsInsertionorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsInsertionorderRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAdsInsertionorderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAdsInsertionorderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAdsInsertionorderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAdsInsertionorderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAdsInsertionorderResponse res = resBuilder.build();
