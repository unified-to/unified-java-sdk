...
public class PatchAtsDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAtsDocumentRequest, PatchAtsDocumentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAtsDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsDocumentRequest.class, new TypeReference<PatchAtsDocumentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAtsDocumentRequest request) {
        ...
        @Override
        public PatchAtsDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAtsDocumentResponse.Builder resBuilder =
            ...
            PatchAtsDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAtsDocumentRequest, to.unified.unified_java_sdk.models.operations.async.PatchAtsDocumentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAtsDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsDocumentRequest.class, new TypeReference<PatchAtsDocumentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAtsDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAtsDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAtsDocumentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAtsDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAtsDocumentResponse res = resBuilder.build();
