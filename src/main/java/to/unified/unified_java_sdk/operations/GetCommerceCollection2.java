...
public class GetCommerceCollection2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceCollection2Request, GetCommerceCollection2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommerceCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceCollection2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceCollection2Request request) {
        ...
        @Override
        public GetCommerceCollection2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommerceCollection2Response.Builder resBuilder =
            ...
            GetCommerceCollection2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommerceCollection2Request, to.unified.unified_java_sdk.models.operations.async.GetCommerceCollection2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommerceCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceCollection2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommerceCollection2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCommerceCollection2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCommerceCollection2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCommerceCollection2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCommerceCollection2Response res = resBuilder.build();
