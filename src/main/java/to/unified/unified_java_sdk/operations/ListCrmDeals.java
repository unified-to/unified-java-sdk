...
public class ListCrmDeals {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCrmDealsRequest, ListCrmDealsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCrmDealsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmDealsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmDealsRequest request) {
        ...
        @Override
        public ListCrmDealsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCrmDealsResponse.Builder resBuilder =
            ...
            ListCrmDealsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCrmDealsRequest, to.unified.unified_java_sdk.models.operations.async.ListCrmDealsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCrmDealsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmDealsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCrmDealsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCrmDealsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCrmDealsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCrmDealsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCrmDealsResponse res = resBuilder.build();
