...
public class GetCrmPipeline {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCrmPipelineRequest, GetCrmPipelineResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCrmPipelineRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmPipelineRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCrmPipelineRequest request) {
        ...
        @Override
        public GetCrmPipelineResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCrmPipelineResponse.Builder resBuilder =
            ...
            GetCrmPipelineResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCrmPipelineRequest, to.unified.unified_java_sdk.models.operations.async.GetCrmPipelineResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCrmPipelineRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmPipelineRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCrmPipelineRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCrmPipelineResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCrmPipelineResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCrmPipelineResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCrmPipelineResponse res = resBuilder.build();
