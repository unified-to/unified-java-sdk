...
public class UpdateMartechCampaign {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMartechCampaignRequest, UpdateMartechCampaignResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateMartechCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMartechCampaignRequest.class, new TypeReference<UpdateMartechCampaignRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMartechCampaignRequest request) {
        ...
        @Override
        public UpdateMartechCampaignResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMartechCampaignResponse.Builder resBuilder =
            ...
            UpdateMartechCampaignResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMartechCampaignRequest, to.unified.unified_java_sdk.models.operations.async.UpdateMartechCampaignResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMartechCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMartechCampaignRequest.class, new TypeReference<UpdateMartechCampaignRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMartechCampaignRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateMartechCampaignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateMartechCampaignResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateMartechCampaignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateMartechCampaignResponse res = resBuilder.build();
