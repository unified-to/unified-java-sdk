...
public class ListTicketingTickets2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTicketingTickets2Request, ListTicketingTickets2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListTicketingTickets2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListTicketingTickets2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTicketingTickets2Request request) {
        ...
        @Override
        public ListTicketingTickets2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTicketingTickets2Response.Builder resBuilder =
            ...
            ListTicketingTickets2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingTickets(Utils.unmarshal(response, new TypeReference<List<TicketingTicket>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTicketingTickets2Request, to.unified.unified_java_sdk.models.operations.async.ListTicketingTickets2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListTicketingTickets2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListTicketingTickets2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTicketingTickets2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListTicketingTickets2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListTicketingTickets2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListTicketingTickets2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListTicketingTickets2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<TicketingTicket>>() {})
                            .thenApply(res::withTicketingTickets);
                } else {
