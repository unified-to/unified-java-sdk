...
public class CreateAnalyticsEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAnalyticsEventRequest, CreateAnalyticsEventResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAnalyticsEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAnalyticsEventRequest.class, new TypeReference<CreateAnalyticsEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAnalyticsEventRequest request) {
        ...
        @Override
        public CreateAnalyticsEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAnalyticsEventResponse.Builder resBuilder =
            ...
            CreateAnalyticsEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAnalyticsEventRequest, to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsEventResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAnalyticsEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAnalyticsEventRequest.class, new TypeReference<CreateAnalyticsEventRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAnalyticsEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsEventResponse res = resBuilder.build();
