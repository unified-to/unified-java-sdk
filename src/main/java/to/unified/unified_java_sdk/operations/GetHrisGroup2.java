...
public class GetHrisGroup2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisGroup2Request, GetHrisGroup2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisGroup2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisGroup2Request request) {
        ...
        @Override
        public GetHrisGroup2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisGroup2Response.Builder resBuilder =
            ...
            GetHrisGroup2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisGroup2Request, to.unified.unified_java_sdk.models.operations.async.GetHrisGroup2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisGroup2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisGroup2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisGroup2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisGroup2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisGroup2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisGroup2Response res = resBuilder.build();
