...
public class CreateTicketingCustomer {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTicketingCustomerRequest, CreateTicketingCustomerResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTicketingCustomerRequest request) {
        ...
        @Override
        public CreateTicketingCustomerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTicketingCustomerResponse.Builder resBuilder =
            ...
            CreateTicketingCustomerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTicketingCustomerRequest, to.unified.unified_java_sdk.models.operations.async.CreateTicketingCustomerResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTicketingCustomerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTicketingCustomerRequest.class, new TypeReference<CreateTicketingCustomerRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTicketingCustomerRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateTicketingCustomerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateTicketingCustomerResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateTicketingCustomerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateTicketingCustomerResponse res = resBuilder.build();
