...
public class UpdateCalendarEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCalendarEventRequest, UpdateCalendarEventResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCalendarEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCalendarEventRequest.class, new TypeReference<UpdateCalendarEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCalendarEventRequest request) {
        ...
        @Override
        public UpdateCalendarEventResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCalendarEventRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCalendarEventResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCalendarEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCalendarEventRequest.class, new TypeReference<UpdateCalendarEventRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCalendarEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCalendarEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCalendarEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCalendarEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCalendarEventResponse res = resBuilder.build();
