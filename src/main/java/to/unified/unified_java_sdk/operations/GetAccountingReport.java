...
public class GetAccountingReport {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingReportRequest, GetAccountingReportResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingReportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingReportRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingReportRequest request) {
        ...
        @Override
        public GetAccountingReportResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingReportResponse.Builder resBuilder =
            ...
            GetAccountingReportResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingReportRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingReportResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingReportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingReportRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingReportRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingReportResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingReportResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingReportResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingReportResponse res = resBuilder.build();
