...
public class CreatePaymentPayment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePaymentPayment2Request, CreatePaymentPayment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreatePaymentPayment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentPayment2Request.class, new TypeReference<CreatePaymentPayment2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePaymentPayment2Request request) {
        ...
        @Override
        public CreatePaymentPayment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePaymentPayment2Response.Builder resBuilder =
            ...
            CreatePaymentPayment2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentPayment(Utils.unmarshal(response, new TypeReference<PaymentPayment>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePaymentPayment2Request, to.unified.unified_java_sdk.models.operations.async.CreatePaymentPayment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreatePaymentPayment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentPayment2Request.class, new TypeReference<CreatePaymentPayment2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePaymentPayment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreatePaymentPayment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreatePaymentPayment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreatePaymentPayment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreatePaymentPayment2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaymentPayment>() {})
                            .thenApply(res::withPaymentPayment);
                } else {
