...
public class RemoveHrisCompany2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisCompany2Request, RemoveHrisCompany2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisCompany2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisCompany2Request request) {
        ...
        @Override
        public RemoveHrisCompany2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisCompany2Response.Builder resBuilder =
            ...
            RemoveHrisCompany2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisCompany2Request, to.unified.unified_java_sdk.models.operations.async.RemoveHrisCompany2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisCompany2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisCompany2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisCompany2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisCompany2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisCompany2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisCompany2Response res = resBuilder.build();
