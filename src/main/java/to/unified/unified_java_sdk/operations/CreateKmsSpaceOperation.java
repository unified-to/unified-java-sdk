...
public class CreateKmsSpaceOperation implements RequestOperation<CreateKmsSpaceRequest, CreateKmsSpaceResponse> {
    ...
    public CreateKmsSpaceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateKmsSpaceRequest request) throws Exception {
