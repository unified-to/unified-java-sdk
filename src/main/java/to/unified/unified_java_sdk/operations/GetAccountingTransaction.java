...
public class GetAccountingTransaction {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingTransactionRequest, GetAccountingTransactionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingTransactionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingTransactionRequest request) {
        ...
        @Override
        public GetAccountingTransactionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingTransactionResponse.Builder resBuilder =
            ...
            GetAccountingTransactionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingTransactionRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingTransactionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingTransactionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingTransactionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingTransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingTransactionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingTransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingTransactionResponse res = resBuilder.build();
