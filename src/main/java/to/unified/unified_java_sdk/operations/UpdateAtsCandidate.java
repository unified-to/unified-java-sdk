...
public class UpdateAtsCandidate {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAtsCandidateRequest, UpdateAtsCandidateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAtsCandidateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsCandidateRequest.class, new TypeReference<UpdateAtsCandidateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsCandidateRequest request) {
        ...
        @Override
        public UpdateAtsCandidateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAtsCandidateResponse.Builder resBuilder =
            ...
            UpdateAtsCandidateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAtsCandidateRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAtsCandidateResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAtsCandidateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsCandidateRequest.class, new TypeReference<UpdateAtsCandidateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAtsCandidateRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAtsCandidateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAtsCandidateResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAtsCandidateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAtsCandidateResponse res = resBuilder.build();
