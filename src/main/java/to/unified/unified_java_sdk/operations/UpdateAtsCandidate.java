...
public class UpdateAtsCandidate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsCandidateRequest request) throws Exception {
        ...
        @Override
        public UpdateAtsCandidateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AtsCandidate out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAtsCandidate(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
