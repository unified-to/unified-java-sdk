...
public class RemoveLmsCourse {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveLmsCourseRequest, RemoveLmsCourseResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveLmsCourseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsCourseRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveLmsCourseRequest request) throws Exception {
        ...
        @Override
        public RemoveLmsCourseResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveLmsCourseResponse.Builder resBuilder =
            ...
            RemoveLmsCourseResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveLmsCourseRequest, to.unified.unified_java_sdk.models.operations.async.RemoveLmsCourseResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveLmsCourseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsCourseRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveLmsCourseRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveLmsCourseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveLmsCourseResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveLmsCourseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveLmsCourseResponse res = resBuilder.build();
