...
public class GetClubsEvent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetClubsEvent2Request, GetClubsEvent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetClubsEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsEvent2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClubsEvent2Request request) {
        ...
        @Override
        public GetClubsEvent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetClubsEvent2Response.Builder resBuilder =
            ...
            GetClubsEvent2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClubsEvent(Utils.unmarshal(response, new TypeReference<ClubsEvent>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetClubsEvent2Request, to.unified.unified_java_sdk.models.operations.async.GetClubsEvent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetClubsEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsEvent2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetClubsEvent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetClubsEvent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetClubsEvent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetClubsEvent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetClubsEvent2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ClubsEvent>() {})
                            .thenApply(res::withClubsEvent);
                } else {
