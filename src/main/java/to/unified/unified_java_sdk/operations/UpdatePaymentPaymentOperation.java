...
public class UpdatePaymentPaymentOperation implements RequestOperation<UpdatePaymentPaymentRequest, UpdatePaymentPaymentResponse> {
    ...
    public UpdatePaymentPaymentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdatePaymentPaymentRequest request) throws Exception {
