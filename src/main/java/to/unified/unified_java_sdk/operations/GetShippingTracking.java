...
public class GetShippingTracking {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetShippingTrackingRequest, GetShippingTrackingResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetShippingTrackingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingTrackingRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetShippingTrackingRequest request) {
        ...
        @Override
        public GetShippingTrackingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetShippingTrackingResponse.Builder resBuilder =
            ...
            GetShippingTrackingResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetShippingTrackingRequest, to.unified.unified_java_sdk.models.operations.async.GetShippingTrackingResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetShippingTrackingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingTrackingRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetShippingTrackingRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetShippingTrackingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetShippingTrackingResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetShippingTrackingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetShippingTrackingResponse res = resBuilder.build();
