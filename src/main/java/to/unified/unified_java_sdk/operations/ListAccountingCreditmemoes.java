...
public class ListAccountingCreditmemoes {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountingCreditmemoesRequest request) throws Exception {
        ...
        @Override
        public ListAccountingCreditmemoesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AccountingCreditmemo> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingCreditmemoes(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
