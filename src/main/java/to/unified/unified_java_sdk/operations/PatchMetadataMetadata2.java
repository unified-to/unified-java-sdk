...
public class PatchMetadataMetadata2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchMetadataMetadata2Request, PatchMetadataMetadata2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchMetadataMetadata2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMetadataMetadata2Request.class, new TypeReference<PatchMetadataMetadata2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchMetadataMetadata2Request request) {
        ...
        @Override
        public PatchMetadataMetadata2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchMetadataMetadata2Response.Builder resBuilder =
            ...
            PatchMetadataMetadata2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchMetadataMetadata2Request, to.unified.unified_java_sdk.models.operations.async.PatchMetadataMetadata2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchMetadataMetadata2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMetadataMetadata2Request.class, new TypeReference<PatchMetadataMetadata2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchMetadataMetadata2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchMetadataMetadata2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchMetadataMetadata2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchMetadataMetadata2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchMetadataMetadata2Response res = resBuilder.build();
