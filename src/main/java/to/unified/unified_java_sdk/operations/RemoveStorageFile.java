...
public class RemoveStorageFile {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveStorageFileRequest, RemoveStorageFileResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(RemoveStorageFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveStorageFileRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveStorageFileRequest request) throws Exception {
        ...
        @Override
        public RemoveStorageFileResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveStorageFileResponse.Builder resBuilder =
            ...
            RemoveStorageFileResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveStorageFileRequest, to.unified.unified_java_sdk.models.operations.async.RemoveStorageFileResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveStorageFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveStorageFileRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveStorageFileRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveStorageFileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveStorageFileResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveStorageFileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveStorageFileResponse res = resBuilder.build();
