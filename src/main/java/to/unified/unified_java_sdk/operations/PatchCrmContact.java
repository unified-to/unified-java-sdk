...
public class PatchCrmContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCrmContactRequest, PatchCrmContactResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCrmContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmContactRequest.class, new TypeReference<PatchCrmContactRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCrmContactRequest request) {
        ...
        @Override
        public PatchCrmContactResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCrmContactResponse.Builder resBuilder =
            ...
            PatchCrmContactResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCrmContactRequest, to.unified.unified_java_sdk.models.operations.async.PatchCrmContactResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCrmContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmContactRequest.class, new TypeReference<PatchCrmContactRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCrmContactRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCrmContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCrmContactResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCrmContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCrmContactResponse res = resBuilder.build();
