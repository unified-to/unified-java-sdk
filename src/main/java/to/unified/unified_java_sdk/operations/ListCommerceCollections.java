...
public class ListCommerceCollections {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceCollectionsRequest request) throws Exception {
        ...
        @Override
        public ListCommerceCollectionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CommerceCollection> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCommerceCollections(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
