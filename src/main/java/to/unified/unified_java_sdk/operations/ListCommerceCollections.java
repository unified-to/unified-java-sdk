...
public class ListCommerceCollections {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceCollectionsRequest, ListCommerceCollectionsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommerceCollectionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceCollectionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceCollectionsRequest request) {
        ...
        @Override
        public ListCommerceCollectionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceCollectionsResponse.Builder resBuilder =
            ...
            ListCommerceCollectionsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceCollectionsRequest, to.unified.unified_java_sdk.models.operations.async.ListCommerceCollectionsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceCollectionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceCollectionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceCollectionsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceCollectionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceCollectionsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceCollectionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceCollectionsResponse res = resBuilder.build();
