...
public class CreateScimGroupsOperation implements RequestOperation<CreateScimGroupsRequest, CreateScimGroupsResponse> {
    ...
    public CreateScimGroupsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateScimGroupsRequest request) throws Exception {
