...
public class RemoveRepoPullrequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveRepoPullrequestRequest, RemoveRepoPullrequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveRepoPullrequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoPullrequestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveRepoPullrequestRequest request) throws Exception {
        ...
        @Override
        public RemoveRepoPullrequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveRepoPullrequestResponse.Builder resBuilder =
            ...
            RemoveRepoPullrequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveRepoPullrequestRequest, to.unified.unified_java_sdk.models.operations.async.RemoveRepoPullrequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveRepoPullrequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoPullrequestRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveRepoPullrequestRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveRepoPullrequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveRepoPullrequestResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveRepoPullrequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveRepoPullrequestResponse res = resBuilder.build();
