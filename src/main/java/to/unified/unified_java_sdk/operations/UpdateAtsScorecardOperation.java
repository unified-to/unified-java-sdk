...
public class UpdateAtsScorecardOperation implements RequestOperation<UpdateAtsScorecardRequest, UpdateAtsScorecardResponse> {
    ...
    public UpdateAtsScorecardOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAtsScorecardRequest request) throws Exception {
