...
public class RemoveTicketingNoteOperation implements RequestOperation<RemoveTicketingNoteRequest, RemoveTicketingNoteResponse> {
    ...
    public RemoveTicketingNoteOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveTicketingNoteRequest request) throws Exception {
