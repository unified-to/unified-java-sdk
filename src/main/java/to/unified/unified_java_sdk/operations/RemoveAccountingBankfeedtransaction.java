...
public class RemoveAccountingBankfeedtransaction {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingBankfeedtransactionRequest, RemoveAccountingBankfeedtransactionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingBankfeedtransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingBankfeedtransactionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingBankfeedtransactionRequest request) {
        ...
        @Override
        public RemoveAccountingBankfeedtransactionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingBankfeedtransactionResponse.Builder resBuilder =
            ...
            RemoveAccountingBankfeedtransactionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingBankfeedtransactionRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingBankfeedtransactionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingBankfeedtransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingBankfeedtransactionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingBankfeedtransactionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingBankfeedtransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingBankfeedtransactionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingBankfeedtransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingBankfeedtransactionResponse res = resBuilder.build();
