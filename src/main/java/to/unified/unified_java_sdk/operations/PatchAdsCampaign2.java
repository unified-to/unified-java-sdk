...
public class PatchAdsCampaign2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAdsCampaign2Request, PatchAdsCampaign2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAdsCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsCampaign2Request.class, new TypeReference<PatchAdsCampaign2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAdsCampaign2Request request) {
        ...
        @Override
        public PatchAdsCampaign2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAdsCampaign2Response.Builder resBuilder =
            ...
            PatchAdsCampaign2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAdsCampaign2Request, to.unified.unified_java_sdk.models.operations.async.PatchAdsCampaign2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAdsCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsCampaign2Request.class, new TypeReference<PatchAdsCampaign2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAdsCampaign2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAdsCampaign2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAdsCampaign2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAdsCampaign2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAdsCampaign2Response res = resBuilder.build();
