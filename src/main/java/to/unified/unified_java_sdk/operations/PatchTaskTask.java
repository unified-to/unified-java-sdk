...
public class PatchTaskTask {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchTaskTaskRequest, PatchTaskTaskResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchTaskTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTaskTaskRequest.class, new TypeReference<PatchTaskTaskRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchTaskTaskRequest request) {
        ...
        @Override
        public PatchTaskTaskResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchTaskTaskRequest, to.unified.unified_java_sdk.models.operations.async.PatchTaskTaskResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchTaskTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTaskTaskRequest.class, new TypeReference<PatchTaskTaskRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchTaskTaskRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchTaskTaskResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchTaskTaskResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchTaskTaskResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchTaskTaskResponse res = resBuilder.build();
