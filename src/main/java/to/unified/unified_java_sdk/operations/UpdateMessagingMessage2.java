...
public class UpdateMessagingMessage2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMessagingMessage2Request, UpdateMessagingMessage2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateMessagingMessage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMessagingMessage2Request.class, new TypeReference<UpdateMessagingMessage2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMessagingMessage2Request request) {
        ...
        @Override
        public UpdateMessagingMessage2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMessagingMessage2Response.Builder resBuilder =
            ...
            UpdateMessagingMessage2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMessagingMessage2Request, to.unified.unified_java_sdk.models.operations.async.UpdateMessagingMessage2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMessagingMessage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMessagingMessage2Request.class, new TypeReference<UpdateMessagingMessage2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMessagingMessage2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateMessagingMessage2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateMessagingMessage2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateMessagingMessage2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateMessagingMessage2Response res = resBuilder.build();
