...
public class GetStorageFile2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetStorageFile2Request, GetStorageFile2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetStorageFile2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetStorageFile2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetStorageFile2Request request) {
        ...
        @Override
        public GetStorageFile2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetStorageFile2Response.Builder resBuilder =
            ...
            GetStorageFile2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetStorageFile2Request, to.unified.unified_java_sdk.models.operations.async.GetStorageFile2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetStorageFile2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetStorageFile2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetStorageFile2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetStorageFile2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetStorageFile2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetStorageFile2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetStorageFile2Response res = resBuilder.build();
