...
public class GetPaymentPayout {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPaymentPayoutRequest, GetPaymentPayoutResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPaymentPayoutRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentPayoutRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentPayoutRequest request) {
        ...
        @Override
        public GetPaymentPayoutResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPaymentPayoutResponse.Builder resBuilder =
            ...
            GetPaymentPayoutResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentPayoutRequest, to.unified.unified_java_sdk.models.operations.async.GetPaymentPayoutResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPaymentPayoutRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentPayoutRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPaymentPayoutRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetPaymentPayoutResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetPaymentPayoutResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetPaymentPayoutResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetPaymentPayoutResponse res = resBuilder.build();
