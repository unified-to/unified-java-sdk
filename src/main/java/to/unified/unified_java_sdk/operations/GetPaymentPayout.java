...
public class GetPaymentPayout {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentPayoutRequest request) throws Exception {
        ...
        @Override
        public GetPaymentPayoutResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaymentPayout out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentPayout(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
