...
public class RemoveAtsScorecard2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAtsScorecard2Request, RemoveAtsScorecard2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAtsScorecard2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsScorecard2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAtsScorecard2Request request) {
        ...
        @Override
        public RemoveAtsScorecard2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAtsScorecard2Response.Builder resBuilder =
            ...
            RemoveAtsScorecard2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAtsScorecard2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAtsScorecard2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAtsScorecard2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsScorecard2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAtsScorecard2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAtsScorecard2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAtsScorecard2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAtsScorecard2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAtsScorecard2Response res = resBuilder.build();
