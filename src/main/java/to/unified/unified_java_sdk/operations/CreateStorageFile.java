...
public class CreateStorageFile {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateStorageFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateStorageFileRequest.class, new TypeReference<CreateStorageFileRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateStorageFileRequest request) {
        ...
        @Override
        public CreateStorageFileResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateStorageFileRequest, to.unified.unified_java_sdk.models.operations.async.CreateStorageFileResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateStorageFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateStorageFileRequest.class, new TypeReference<CreateStorageFileRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateStorageFileRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateStorageFileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateStorageFileResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateStorageFileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateStorageFileResponse res = resBuilder.build();
