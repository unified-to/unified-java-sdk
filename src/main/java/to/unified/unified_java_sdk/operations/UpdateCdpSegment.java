...
public class UpdateCdpSegment {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCdpSegmentRequest, UpdateCdpSegmentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCdpSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCdpSegmentRequest.class, new TypeReference<UpdateCdpSegmentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCdpSegmentRequest request) {
        ...
        @Override
        public UpdateCdpSegmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCdpSegmentResponse.Builder resBuilder =
            ...
            UpdateCdpSegmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCdpSegmentRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCdpSegmentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCdpSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCdpSegmentRequest.class, new TypeReference<UpdateCdpSegmentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCdpSegmentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCdpSegmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCdpSegmentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCdpSegmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCdpSegmentResponse res = resBuilder.build();
