...
public class RemoveCdpSegment {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCdpSegmentRequest, RemoveCdpSegmentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCdpSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCdpSegmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCdpSegmentRequest request) {
        ...
        @Override
        public RemoveCdpSegmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCdpSegmentResponse.Builder resBuilder =
            ...
            RemoveCdpSegmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCdpSegmentRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCdpSegmentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCdpSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCdpSegmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCdpSegmentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCdpSegmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCdpSegmentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCdpSegmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCdpSegmentResponse res = resBuilder.build();
