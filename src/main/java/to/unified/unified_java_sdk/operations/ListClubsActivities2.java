...
public class ListClubsActivities2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListClubsActivities2Request, ListClubsActivities2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListClubsActivities2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsActivities2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListClubsActivities2Request request) {
        ...
        @Override
        public ListClubsActivities2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListClubsActivities2Response.Builder resBuilder =
            ...
            ListClubsActivities2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClubsActivities(Utils.unmarshal(response, new TypeReference<List<ClubsActivity>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListClubsActivities2Request, to.unified.unified_java_sdk.models.operations.async.ListClubsActivities2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListClubsActivities2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsActivities2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListClubsActivities2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListClubsActivities2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListClubsActivities2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListClubsActivities2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListClubsActivities2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ClubsActivity>>() {})
                            .thenApply(res::withClubsActivities);
                } else {
