...
public class RemoveAccountingBankfeedaccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingBankfeedaccountRequest, RemoveAccountingBankfeedaccountResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingBankfeedaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingBankfeedaccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingBankfeedaccountRequest request) {
        ...
        @Override
        public RemoveAccountingBankfeedaccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingBankfeedaccountResponse.Builder resBuilder =
            ...
            RemoveAccountingBankfeedaccountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingBankfeedaccountRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingBankfeedaccountResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingBankfeedaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingBankfeedaccountRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingBankfeedaccountRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingBankfeedaccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingBankfeedaccountResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingBankfeedaccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingBankfeedaccountResponse res = resBuilder.build();
