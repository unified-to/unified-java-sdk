...
public class RemoveCrmEvent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCrmEvent2Request, RemoveCrmEvent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCrmEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmEvent2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCrmEvent2Request request) {
        ...
        @Override
        public RemoveCrmEvent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCrmEvent2Response.Builder resBuilder =
            ...
            RemoveCrmEvent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCrmEvent2Request, to.unified.unified_java_sdk.models.operations.async.RemoveCrmEvent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCrmEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmEvent2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCrmEvent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCrmEvent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCrmEvent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCrmEvent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCrmEvent2Response res = resBuilder.build();
