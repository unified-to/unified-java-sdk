...
public class PatchMessagingEvent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchMessagingEvent2Request, PatchMessagingEvent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchMessagingEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMessagingEvent2Request.class, new TypeReference<PatchMessagingEvent2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchMessagingEvent2Request request) {
        ...
        @Override
        public PatchMessagingEvent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchMessagingEvent2Response.Builder resBuilder =
            ...
            PatchMessagingEvent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchMessagingEvent2Request, to.unified.unified_java_sdk.models.operations.async.PatchMessagingEvent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchMessagingEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMessagingEvent2Request.class, new TypeReference<PatchMessagingEvent2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchMessagingEvent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchMessagingEvent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchMessagingEvent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchMessagingEvent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchMessagingEvent2Response res = resBuilder.build();
