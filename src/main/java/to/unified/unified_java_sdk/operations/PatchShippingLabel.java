...
public class PatchShippingLabel {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchShippingLabelRequest, PatchShippingLabelResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchShippingLabelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchShippingLabelRequest.class, new TypeReference<PatchShippingLabelRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchShippingLabelRequest request) {
        ...
        @Override
        public PatchShippingLabelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchShippingLabelResponse.Builder resBuilder =
            ...
            PatchShippingLabelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchShippingLabelRequest, to.unified.unified_java_sdk.models.operations.async.PatchShippingLabelResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchShippingLabelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchShippingLabelRequest.class, new TypeReference<PatchShippingLabelRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchShippingLabelRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchShippingLabelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchShippingLabelResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchShippingLabelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchShippingLabelResponse res = resBuilder.build();
