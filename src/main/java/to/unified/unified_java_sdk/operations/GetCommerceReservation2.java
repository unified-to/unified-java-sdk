...
public class GetCommerceReservation2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceReservation2Request, GetCommerceReservation2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommerceReservation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceReservation2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceReservation2Request request) {
        ...
        @Override
        public GetCommerceReservation2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommerceReservation2Response.Builder resBuilder =
            ...
            GetCommerceReservation2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommerceReservation2Request, to.unified.unified_java_sdk.models.operations.async.GetCommerceReservation2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommerceReservation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceReservation2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommerceReservation2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCommerceReservation2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCommerceReservation2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCommerceReservation2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCommerceReservation2Response res = resBuilder.build();
