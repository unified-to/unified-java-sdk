...
public class CreateCrmContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCrmContactRequest, CreateCrmContactResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCrmContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmContactRequest.class, new TypeReference<CreateCrmContactRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCrmContactRequest request) {
        ...
        @Override
        public CreateCrmContactResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCrmContactResponse.Builder resBuilder =
            ...
            CreateCrmContactResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCrmContactRequest, to.unified.unified_java_sdk.models.operations.async.CreateCrmContactResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCrmContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmContactRequest.class, new TypeReference<CreateCrmContactRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCrmContactRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCrmContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCrmContactResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCrmContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCrmContactResponse res = resBuilder.build();
