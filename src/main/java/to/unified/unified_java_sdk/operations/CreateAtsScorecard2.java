...
public class CreateAtsScorecard2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAtsScorecard2Request, CreateAtsScorecard2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAtsScorecard2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsScorecard2Request.class, new TypeReference<CreateAtsScorecard2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsScorecard2Request request) {
        ...
        @Override
        public CreateAtsScorecard2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAtsScorecard2Response.Builder resBuilder =
            ...
            CreateAtsScorecard2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAtsScorecard2Request, to.unified.unified_java_sdk.models.operations.async.CreateAtsScorecard2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAtsScorecard2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsScorecard2Request.class, new TypeReference<CreateAtsScorecard2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAtsScorecard2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAtsScorecard2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAtsScorecard2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAtsScorecard2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAtsScorecard2Response res = resBuilder.build();
