...
public class RemoveTaskTask2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveTaskTask2Request, RemoveTaskTask2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveTaskTask2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTaskTask2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveTaskTask2Request request) {
        ...
        @Override
        public RemoveTaskTask2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveTaskTask2Response.Builder resBuilder =
            ...
            RemoveTaskTask2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveTaskTask2Request, to.unified.unified_java_sdk.models.operations.async.RemoveTaskTask2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveTaskTask2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTaskTask2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveTaskTask2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveTaskTask2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveTaskTask2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveTaskTask2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveTaskTask2Response res = resBuilder.build();
