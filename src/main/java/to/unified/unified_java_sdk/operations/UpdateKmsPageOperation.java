...
public class UpdateKmsPageOperation implements RequestOperation<UpdateKmsPageRequest, UpdateKmsPageResponse> {
    ...
    public UpdateKmsPageOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateKmsPageRequest request) throws Exception {
