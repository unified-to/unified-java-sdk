...
public class ListMetadataMetadatas2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMetadataMetadatas2Request, ListMetadataMetadatas2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListMetadataMetadatas2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListMetadataMetadatas2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMetadataMetadatas2Request request) {
        ...
        @Override
        public ListMetadataMetadatas2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMetadataMetadatas2Response.Builder resBuilder =
            ...
            ListMetadataMetadatas2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMetadataMetadatas2Request, to.unified.unified_java_sdk.models.operations.async.ListMetadataMetadatas2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMetadataMetadatas2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListMetadataMetadatas2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMetadataMetadatas2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListMetadataMetadatas2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListMetadataMetadatas2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListMetadataMetadatas2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListMetadataMetadatas2Response res = resBuilder.build();
