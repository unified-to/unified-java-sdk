...
public class GetAccountingProfitloss {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingProfitlossRequest request) throws Exception {
        ...
        @Override
        public GetAccountingProfitlossResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingProfitloss out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingProfitloss(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
