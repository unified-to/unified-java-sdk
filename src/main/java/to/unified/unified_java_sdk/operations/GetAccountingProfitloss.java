...
public class GetAccountingProfitloss {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingProfitlossRequest, GetAccountingProfitlossResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingProfitlossRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingProfitlossRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingProfitlossRequest request) {
        ...
        @Override
        public GetAccountingProfitlossResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingProfitlossResponse.Builder resBuilder =
            ...
            GetAccountingProfitlossResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingProfitlossRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingProfitlossResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingProfitlossRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingProfitlossRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingProfitlossRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingProfitlossResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingProfitlossResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingProfitlossResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingProfitlossResponse res = resBuilder.build();
