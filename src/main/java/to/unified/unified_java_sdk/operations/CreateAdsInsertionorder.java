...
public class CreateAdsInsertionorder {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAdsInsertionorderRequest, CreateAdsInsertionorderResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAdsInsertionorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsInsertionorderRequest.class, new TypeReference<CreateAdsInsertionorderRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAdsInsertionorderRequest request) {
        ...
        @Override
        public CreateAdsInsertionorderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAdsInsertionorderResponse.Builder resBuilder =
            ...
            CreateAdsInsertionorderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAdsInsertionorderRequest, to.unified.unified_java_sdk.models.operations.async.CreateAdsInsertionorderResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAdsInsertionorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsInsertionorderRequest.class, new TypeReference<CreateAdsInsertionorderRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAdsInsertionorderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAdsInsertionorderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAdsInsertionorderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAdsInsertionorderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAdsInsertionorderResponse res = resBuilder.build();
