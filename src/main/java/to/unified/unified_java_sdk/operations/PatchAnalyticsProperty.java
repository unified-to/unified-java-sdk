...
public class PatchAnalyticsProperty {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAnalyticsPropertyRequest, PatchAnalyticsPropertyResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAnalyticsPropertyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAnalyticsPropertyRequest.class, new TypeReference<PatchAnalyticsPropertyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAnalyticsPropertyRequest request) {
        ...
        @Override
        public PatchAnalyticsPropertyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAnalyticsPropertyResponse.Builder resBuilder =
            ...
            PatchAnalyticsPropertyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAnalyticsPropertyRequest, to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsPropertyResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAnalyticsPropertyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAnalyticsPropertyRequest.class, new TypeReference<PatchAnalyticsPropertyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAnalyticsPropertyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsPropertyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsPropertyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsPropertyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsPropertyResponse res = resBuilder.build();
