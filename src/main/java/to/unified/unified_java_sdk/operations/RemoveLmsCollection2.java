...
public class RemoveLmsCollection2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveLmsCollection2Request, RemoveLmsCollection2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveLmsCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsCollection2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveLmsCollection2Request request) {
        ...
        @Override
        public RemoveLmsCollection2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveLmsCollection2Response.Builder resBuilder =
            ...
            RemoveLmsCollection2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveLmsCollection2Request, to.unified.unified_java_sdk.models.operations.async.RemoveLmsCollection2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveLmsCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsCollection2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveLmsCollection2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveLmsCollection2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveLmsCollection2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveLmsCollection2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveLmsCollection2Response res = resBuilder.build();
