...
public class UpdateSocialReview {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateSocialReviewRequest, UpdateSocialReviewResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateSocialReviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSocialReviewRequest.class, new TypeReference<UpdateSocialReviewRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateSocialReviewRequest request) {
        ...
        @Override
        public UpdateSocialReviewResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateSocialReviewResponse.Builder resBuilder =
            ...
            UpdateSocialReviewResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSocialReview(Utils.unmarshal(response, new TypeReference<SocialReview>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateSocialReviewRequest, to.unified.unified_java_sdk.models.operations.async.UpdateSocialReviewResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateSocialReviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSocialReviewRequest.class, new TypeReference<UpdateSocialReviewRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateSocialReviewRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateSocialReviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateSocialReviewResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateSocialReviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateSocialReviewResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SocialReview>() {})
                            .thenApply(res::withSocialReview);
                } else {
