...
public class CreateAccountingBankfeedtransaction {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAccountingBankfeedtransactionRequest, CreateAccountingBankfeedtransactionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAccountingBankfeedtransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingBankfeedtransactionRequest.class, new TypeReference<CreateAccountingBankfeedtransactionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingBankfeedtransactionRequest request) {
        ...
        @Override
        public CreateAccountingBankfeedtransactionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAccountingBankfeedtransactionResponse.Builder resBuilder =
                    CreateAccountingBankfeedtransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateAccountingBankfeedtransactionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAccountingBankfeedtransactionRequest, to.unified.unified_java_sdk.models.operations.async.CreateAccountingBankfeedtransactionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAccountingBankfeedtransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingBankfeedtransactionRequest.class, new TypeReference<CreateAccountingBankfeedtransactionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAccountingBankfeedtransactionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAccountingBankfeedtransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAccountingBankfeedtransactionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAccountingBankfeedtransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAccountingBankfeedtransactionResponse res = resBuilder.build();
