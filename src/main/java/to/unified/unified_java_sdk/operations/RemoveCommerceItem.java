...
public class RemoveCommerceItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCommerceItemRequest, RemoveCommerceItemResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCommerceItemRequest request) throws Exception {
        ...
        @Override
        public RemoveCommerceItemResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCommerceItemResponse.Builder resBuilder =
            ...
            RemoveCommerceItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCommerceItemRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCommerceItemResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCommerceItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCommerceItemRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCommerceItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceItemResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCommerceItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceItemResponse res = resBuilder.build();
