...
public class GetStorageFileOperation implements RequestOperation<GetStorageFileRequest, GetStorageFileResponse> {
    ...
    public GetStorageFileOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetStorageFileRequest request) throws Exception {
