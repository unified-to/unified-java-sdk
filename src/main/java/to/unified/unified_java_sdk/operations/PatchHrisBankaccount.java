...
public class PatchHrisBankaccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisBankaccountRequest, PatchHrisBankaccountResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisBankaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisBankaccountRequest.class, new TypeReference<PatchHrisBankaccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisBankaccountRequest request) {
        ...
        @Override
        public PatchHrisBankaccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisBankaccountResponse.Builder resBuilder =
            ...
            PatchHrisBankaccountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisBankaccountRequest, to.unified.unified_java_sdk.models.operations.async.PatchHrisBankaccountResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisBankaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisBankaccountRequest.class, new TypeReference<PatchHrisBankaccountRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisBankaccountRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisBankaccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisBankaccountResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisBankaccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisBankaccountResponse res = resBuilder.build();
