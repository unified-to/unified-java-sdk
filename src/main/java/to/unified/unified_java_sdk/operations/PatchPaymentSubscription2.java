...
public class PatchPaymentSubscription2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchPaymentSubscription2Request, PatchPaymentSubscription2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchPaymentSubscription2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPaymentSubscription2Request.class, new TypeReference<PatchPaymentSubscription2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchPaymentSubscription2Request request) {
        ...
        @Override
        public PatchPaymentSubscription2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchPaymentSubscription2Response.Builder resBuilder =
            ...
            PatchPaymentSubscription2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchPaymentSubscription2Request, to.unified.unified_java_sdk.models.operations.async.PatchPaymentSubscription2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchPaymentSubscription2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPaymentSubscription2Request.class, new TypeReference<PatchPaymentSubscription2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchPaymentSubscription2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchPaymentSubscription2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchPaymentSubscription2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchPaymentSubscription2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchPaymentSubscription2Response res = resBuilder.build();
