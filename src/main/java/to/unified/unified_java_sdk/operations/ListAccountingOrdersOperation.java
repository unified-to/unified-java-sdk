...
public class ListAccountingOrdersOperation implements RequestOperation<ListAccountingOrdersRequest, ListAccountingOrdersResponse> {
    ...
    public ListAccountingOrdersOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAccountingOrdersRequest request) throws Exception {
