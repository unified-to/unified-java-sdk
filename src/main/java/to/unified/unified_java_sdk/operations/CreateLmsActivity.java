...
public class CreateLmsActivity {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateLmsActivityRequest, CreateLmsActivityResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateLmsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsActivityRequest.class, new TypeReference<CreateLmsActivityRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateLmsActivityRequest request) {
        ...
        @Override
        public CreateLmsActivityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateLmsActivityResponse.Builder resBuilder =
            ...
            CreateLmsActivityResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateLmsActivityRequest, to.unified.unified_java_sdk.models.operations.async.CreateLmsActivityResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateLmsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsActivityRequest.class, new TypeReference<CreateLmsActivityRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateLmsActivityRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateLmsActivityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateLmsActivityResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateLmsActivityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateLmsActivityResponse res = resBuilder.build();
