...
public class UpdateCrmPipeline2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCrmPipeline2Request, UpdateCrmPipeline2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCrmPipeline2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmPipeline2Request.class, new TypeReference<UpdateCrmPipeline2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCrmPipeline2Request request) {
        ...
        @Override
        public UpdateCrmPipeline2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCrmPipeline2Response.Builder resBuilder =
            ...
            UpdateCrmPipeline2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCrmPipeline2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCrmPipeline2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCrmPipeline2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmPipeline2Request.class, new TypeReference<UpdateCrmPipeline2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCrmPipeline2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCrmPipeline2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCrmPipeline2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCrmPipeline2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCrmPipeline2Response res = resBuilder.build();
