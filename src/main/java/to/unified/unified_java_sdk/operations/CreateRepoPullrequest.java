...
public class CreateRepoPullrequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateRepoPullrequestRequest, CreateRepoPullrequestResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateRepoPullrequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoPullrequestRequest.class, new TypeReference<CreateRepoPullrequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateRepoPullrequestRequest request) {
        ...
        @Override
        public CreateRepoPullrequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateRepoPullrequestResponse.Builder resBuilder =
            ...
            CreateRepoPullrequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateRepoPullrequestRequest, to.unified.unified_java_sdk.models.operations.async.CreateRepoPullrequestResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateRepoPullrequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoPullrequestRequest.class, new TypeReference<CreateRepoPullrequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateRepoPullrequestRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateRepoPullrequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateRepoPullrequestResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateRepoPullrequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateRepoPullrequestResponse res = resBuilder.build();
