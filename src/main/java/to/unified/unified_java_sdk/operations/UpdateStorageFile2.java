...
public class UpdateStorageFile2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateStorageFile2Request, UpdateStorageFile2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateStorageFile2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateStorageFile2Request.class, new TypeReference<UpdateStorageFile2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateStorageFile2Request request) {
        ...
        @Override
        public UpdateStorageFile2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateStorageFile2Response.Builder resBuilder =
            ...
            UpdateStorageFile2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateStorageFile2Request, to.unified.unified_java_sdk.models.operations.async.UpdateStorageFile2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateStorageFile2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateStorageFile2Request.class, new TypeReference<UpdateStorageFile2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateStorageFile2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateStorageFile2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateStorageFile2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateStorageFile2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateStorageFile2Response res = resBuilder.build();
