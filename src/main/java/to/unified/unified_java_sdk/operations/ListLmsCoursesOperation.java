...
public class ListLmsCoursesOperation implements RequestOperation<ListLmsCoursesRequest, ListLmsCoursesResponse> {
    ...
    public ListLmsCoursesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListLmsCoursesRequest request) throws Exception {
