...
public class CreateAdsCreative {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAdsCreativeRequest, CreateAdsCreativeResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAdsCreativeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsCreativeRequest.class, new TypeReference<CreateAdsCreativeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAdsCreativeRequest request) {
        ...
        @Override
        public CreateAdsCreativeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAdsCreativeResponse.Builder resBuilder =
            ...
            CreateAdsCreativeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAdsCreativeRequest, to.unified.unified_java_sdk.models.operations.async.CreateAdsCreativeResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAdsCreativeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsCreativeRequest.class, new TypeReference<CreateAdsCreativeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAdsCreativeRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAdsCreativeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAdsCreativeResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAdsCreativeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAdsCreativeResponse res = resBuilder.build();
