...
public class PatchCalendarLink {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCalendarLinkRequest, PatchCalendarLinkResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCalendarLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCalendarLinkRequest.class, new TypeReference<PatchCalendarLinkRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCalendarLinkRequest request) {
        ...
        @Override
        public PatchCalendarLinkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCalendarLinkResponse.Builder resBuilder =
            ...
            PatchCalendarLinkResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCalendarLinkRequest, to.unified.unified_java_sdk.models.operations.async.PatchCalendarLinkResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCalendarLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCalendarLinkRequest.class, new TypeReference<PatchCalendarLinkRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCalendarLinkRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCalendarLinkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCalendarLinkResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCalendarLinkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCalendarLinkResponse res = resBuilder.build();
