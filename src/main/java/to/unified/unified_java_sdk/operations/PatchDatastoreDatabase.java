...
public class PatchDatastoreDatabase {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchDatastoreDatabaseRequest, PatchDatastoreDatabaseResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchDatastoreDatabaseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchDatastoreDatabaseRequest.class, new TypeReference<PatchDatastoreDatabaseRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchDatastoreDatabaseRequest request) {
        ...
        @Override
        public PatchDatastoreDatabaseResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchDatastoreDatabaseResponse.Builder resBuilder =
            ...
            PatchDatastoreDatabaseResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchDatastoreDatabaseRequest, to.unified.unified_java_sdk.models.operations.async.PatchDatastoreDatabaseResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchDatastoreDatabaseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchDatastoreDatabaseRequest.class, new TypeReference<PatchDatastoreDatabaseRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchDatastoreDatabaseRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchDatastoreDatabaseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchDatastoreDatabaseResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchDatastoreDatabaseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchDatastoreDatabaseResponse res = resBuilder.build();
