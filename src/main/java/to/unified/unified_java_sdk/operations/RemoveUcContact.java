...
public class RemoveUcContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveUcContactRequest, RemoveUcContactResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(RemoveUcContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUcContactRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveUcContactRequest request) throws Exception {
        ...
        @Override
        public RemoveUcContactResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveUcContactResponse.Builder resBuilder =
            ...
            RemoveUcContactResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveUcContactRequest, to.unified.unified_java_sdk.models.operations.async.RemoveUcContactResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveUcContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUcContactRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveUcContactRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveUcContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveUcContactResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveUcContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveUcContactResponse res = resBuilder.build();
