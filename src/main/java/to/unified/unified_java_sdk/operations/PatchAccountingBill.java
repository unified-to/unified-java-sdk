...
public class PatchAccountingBill {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingBillRequest, PatchAccountingBillResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingBillRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingBillRequest.class, new TypeReference<PatchAccountingBillRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingBillRequest request) {
        ...
        @Override
        public PatchAccountingBillResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingBillResponse.Builder resBuilder =
            ...
            PatchAccountingBillResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingBillRequest, to.unified.unified_java_sdk.models.operations.async.PatchAccountingBillResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingBillRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingBillRequest.class, new TypeReference<PatchAccountingBillRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingBillRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingBillResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingBillResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingBillResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingBillResponse res = resBuilder.build();
