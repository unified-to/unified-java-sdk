...
public class ListAnalyticsEvents2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAnalyticsEvents2Request, ListAnalyticsEvents2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAnalyticsEvents2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAnalyticsEvents2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAnalyticsEvents2Request request) {
        ...
        @Override
        public ListAnalyticsEvents2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAnalyticsEvents2Response.Builder resBuilder =
            ...
            ListAnalyticsEvents2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAnalyticsEvents(Utils.unmarshal(response, new TypeReference<List<AnalyticsEvent>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAnalyticsEvents2Request, to.unified.unified_java_sdk.models.operations.async.ListAnalyticsEvents2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAnalyticsEvents2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAnalyticsEvents2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAnalyticsEvents2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAnalyticsEvents2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAnalyticsEvents2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAnalyticsEvents2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAnalyticsEvents2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AnalyticsEvent>>() {})
                            .thenApply(res::withAnalyticsEvents);
                } else {
