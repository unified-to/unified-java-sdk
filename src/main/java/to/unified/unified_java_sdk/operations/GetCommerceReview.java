...
public class GetCommerceReview {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceReviewRequest, GetCommerceReviewResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommerceReviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceReviewRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceReviewRequest request) {
        ...
        @Override
        public GetCommerceReviewResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommerceReviewResponse.Builder resBuilder =
            ...
            GetCommerceReviewResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommerceReviewRequest, to.unified.unified_java_sdk.models.operations.async.GetCommerceReviewResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommerceReviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceReviewRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommerceReviewRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCommerceReviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCommerceReviewResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCommerceReviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCommerceReviewResponse res = resBuilder.build();
