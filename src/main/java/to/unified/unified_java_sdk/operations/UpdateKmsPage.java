...
public class UpdateKmsPage {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateKmsPageRequest, UpdateKmsPageResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateKmsPageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateKmsPageRequest.class, new TypeReference<UpdateKmsPageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateKmsPageRequest request) {
        ...
        @Override
        public UpdateKmsPageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateKmsPageResponse.Builder resBuilder =
            ...
            UpdateKmsPageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateKmsPageRequest, to.unified.unified_java_sdk.models.operations.async.UpdateKmsPageResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateKmsPageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateKmsPageRequest.class, new TypeReference<UpdateKmsPageRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateKmsPageRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateKmsPageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateKmsPageResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateKmsPageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateKmsPageResponse res = resBuilder.build();
