...
public class CreatePerformanceFeedback {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePerformanceFeedbackRequest, CreatePerformanceFeedbackResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreatePerformanceFeedbackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePerformanceFeedbackRequest.class, new TypeReference<CreatePerformanceFeedbackRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePerformanceFeedbackRequest request) {
        ...
        @Override
        public CreatePerformanceFeedbackResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePerformanceFeedbackResponse.Builder resBuilder =
                    CreatePerformanceFeedbackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreatePerformanceFeedbackResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPerformanceFeedback(Utils.unmarshal(response, new TypeReference<PerformanceFeedback>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePerformanceFeedbackRequest, to.unified.unified_java_sdk.models.operations.async.CreatePerformanceFeedbackResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreatePerformanceFeedbackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePerformanceFeedbackRequest.class, new TypeReference<CreatePerformanceFeedbackRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePerformanceFeedbackRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreatePerformanceFeedbackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreatePerformanceFeedbackResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreatePerformanceFeedbackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreatePerformanceFeedbackResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PerformanceFeedback>() {})
                            .thenApply(res::withPerformanceFeedback);
                } else {
