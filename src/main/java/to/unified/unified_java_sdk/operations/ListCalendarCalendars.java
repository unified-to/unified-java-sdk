...
public class ListCalendarCalendars {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCalendarCalendarsRequest, ListCalendarCalendarsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCalendarCalendarsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarCalendarsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarCalendarsRequest request) {
        ...
        @Override
        public ListCalendarCalendarsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCalendarCalendarsResponse.Builder resBuilder =
            ...
            ListCalendarCalendarsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCalendarCalendarsRequest, to.unified.unified_java_sdk.models.operations.async.ListCalendarCalendarsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCalendarCalendarsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarCalendarsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCalendarCalendarsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCalendarCalendarsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCalendarCalendarsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCalendarCalendarsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCalendarCalendarsResponse res = resBuilder.build();
