...
public class ListCalendarCalendars {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarCalendarsRequest request) throws Exception {
        ...
        @Override
        public ListCalendarCalendarsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CalendarCalendar> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCalendarCalendars(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
