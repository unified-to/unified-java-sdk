...
public class PatchCommerceSaleschannel {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCommerceSaleschannelRequest, PatchCommerceSaleschannelResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCommerceSaleschannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceSaleschannelRequest.class, new TypeReference<PatchCommerceSaleschannelRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCommerceSaleschannelRequest request) {
        ...
        @Override
        public PatchCommerceSaleschannelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCommerceSaleschannelResponse.Builder resBuilder =
            ...
            PatchCommerceSaleschannelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCommerceSaleschannelRequest, to.unified.unified_java_sdk.models.operations.async.PatchCommerceSaleschannelResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCommerceSaleschannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceSaleschannelRequest.class, new TypeReference<PatchCommerceSaleschannelRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCommerceSaleschannelRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCommerceSaleschannelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCommerceSaleschannelResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCommerceSaleschannelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCommerceSaleschannelResponse res = resBuilder.build();
