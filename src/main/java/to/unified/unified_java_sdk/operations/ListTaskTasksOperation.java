...
public class ListTaskTasksOperation implements RequestOperation<ListTaskTasksRequest, ListTaskTasksResponse> {
    ...
    public ListTaskTasksOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListTaskTasksRequest request) throws Exception {
