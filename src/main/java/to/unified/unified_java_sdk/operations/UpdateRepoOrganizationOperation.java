...
public class UpdateRepoOrganizationOperation implements RequestOperation<UpdateRepoOrganizationRequest, UpdateRepoOrganizationResponse> {
    ...
    public UpdateRepoOrganizationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateRepoOrganizationRequest request) throws Exception {
