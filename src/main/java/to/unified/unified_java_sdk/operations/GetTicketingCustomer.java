...
public class GetTicketingCustomer {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTicketingCustomerRequest, GetTicketingCustomerResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTicketingCustomerRequest request) {
        ...
        @Override
        public GetTicketingCustomerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTicketingCustomerResponse.Builder resBuilder =
            ...
            GetTicketingCustomerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTicketingCustomerRequest, to.unified.unified_java_sdk.models.operations.async.GetTicketingCustomerResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTicketingCustomerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTicketingCustomerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTicketingCustomerRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetTicketingCustomerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetTicketingCustomerResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetTicketingCustomerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetTicketingCustomerResponse res = resBuilder.build();
