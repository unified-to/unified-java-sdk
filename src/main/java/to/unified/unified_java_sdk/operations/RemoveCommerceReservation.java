...
public class RemoveCommerceReservation {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCommerceReservationRequest, RemoveCommerceReservationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCommerceReservationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceReservationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCommerceReservationRequest request) {
        ...
        @Override
        public RemoveCommerceReservationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCommerceReservationResponse.Builder resBuilder =
            ...
            RemoveCommerceReservationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCommerceReservationRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCommerceReservationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCommerceReservationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceReservationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCommerceReservationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCommerceReservationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceReservationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCommerceReservationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceReservationResponse res = resBuilder.build();
