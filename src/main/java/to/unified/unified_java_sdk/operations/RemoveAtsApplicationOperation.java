...
public class RemoveAtsApplicationOperation implements RequestOperation<RemoveAtsApplicationRequest, RemoveAtsApplicationResponse> {
    ...
    public RemoveAtsApplicationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAtsApplicationRequest request) throws Exception {
