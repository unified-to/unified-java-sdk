...
public class RemoveRepoOrganization {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveRepoOrganizationRequest, RemoveRepoOrganizationResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveRepoOrganizationRequest request) throws Exception {
        ...
        @Override
        public RemoveRepoOrganizationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveRepoOrganizationResponse.Builder resBuilder =
            ...
            RemoveRepoOrganizationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveRepoOrganizationRequest, to.unified.unified_java_sdk.models.operations.async.RemoveRepoOrganizationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveRepoOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoOrganizationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveRepoOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveRepoOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveRepoOrganizationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveRepoOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveRepoOrganizationResponse res = resBuilder.build();
