...
public class CreateAnalyticsProperty2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAnalyticsProperty2Request, CreateAnalyticsProperty2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAnalyticsProperty2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAnalyticsProperty2Request.class, new TypeReference<CreateAnalyticsProperty2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAnalyticsProperty2Request request) {
        ...
        @Override
        public CreateAnalyticsProperty2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAnalyticsProperty2Response.Builder resBuilder =
            ...
            CreateAnalyticsProperty2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAnalyticsProperty2Request, to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsProperty2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAnalyticsProperty2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAnalyticsProperty2Request.class, new TypeReference<CreateAnalyticsProperty2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAnalyticsProperty2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsProperty2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsProperty2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsProperty2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsProperty2Response res = resBuilder.build();
