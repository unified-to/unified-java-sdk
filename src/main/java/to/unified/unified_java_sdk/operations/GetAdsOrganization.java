...
public class GetAdsOrganization {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAdsOrganizationRequest, GetAdsOrganizationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAdsOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsOrganizationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAdsOrganizationRequest request) {
        ...
        @Override
        public GetAdsOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAdsOrganizationResponse.Builder resBuilder =
            ...
            GetAdsOrganizationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAdsOrganizationRequest, to.unified.unified_java_sdk.models.operations.async.GetAdsOrganizationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAdsOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsOrganizationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAdsOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAdsOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAdsOrganizationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAdsOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAdsOrganizationResponse res = resBuilder.build();
