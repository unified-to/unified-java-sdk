...
public class GetFormsSubmission {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFormsSubmissionRequest, GetFormsSubmissionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetFormsSubmissionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFormsSubmissionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFormsSubmissionRequest request) {
        ...
        @Override
        public GetFormsSubmissionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFormsSubmissionResponse.Builder resBuilder =
            ...
            GetFormsSubmissionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFormsSubmissionRequest, to.unified.unified_java_sdk.models.operations.async.GetFormsSubmissionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetFormsSubmissionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFormsSubmissionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFormsSubmissionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetFormsSubmissionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetFormsSubmissionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetFormsSubmissionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetFormsSubmissionResponse res = resBuilder.build();
