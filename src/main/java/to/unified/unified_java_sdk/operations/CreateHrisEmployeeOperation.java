...
public class CreateHrisEmployeeOperation implements RequestOperation<CreateHrisEmployeeRequest, CreateHrisEmployeeResponse> {
    ...
    public CreateHrisEmployeeOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateHrisEmployeeRequest request) throws Exception {
