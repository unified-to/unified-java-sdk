...
public class ListCdpActivations {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCdpActivationsRequest, ListCdpActivationsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCdpActivationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCdpActivationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCdpActivationsRequest request) {
        ...
        @Override
        public ListCdpActivationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCdpActivationsResponse.Builder resBuilder =
            ...
            ListCdpActivationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCdpActivations(Utils.unmarshal(response, new TypeReference<List<CdpActivation>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCdpActivationsRequest, to.unified.unified_java_sdk.models.operations.async.ListCdpActivationsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCdpActivationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCdpActivationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCdpActivationsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCdpActivationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCdpActivationsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCdpActivationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCdpActivationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CdpActivation>>() {})
                            .thenApply(res::withCdpActivations);
                } else {
