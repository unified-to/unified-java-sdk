...
public class CreateCrmDealOperation implements RequestOperation<CreateCrmDealRequest, CreateCrmDealResponse> {
    ...
    public CreateCrmDealOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateCrmDealRequest request) throws Exception {
