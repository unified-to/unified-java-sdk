...
public class GetUcComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUcCommentRequest, GetUcCommentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUcCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUcCommentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUcCommentRequest request) {
        ...
        @Override
        public GetUcCommentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUcCommentResponse.Builder resBuilder =
            ...
            GetUcCommentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUcCommentRequest, to.unified.unified_java_sdk.models.operations.async.GetUcCommentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUcCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUcCommentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUcCommentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetUcCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetUcCommentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetUcCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetUcCommentResponse res = resBuilder.build();
