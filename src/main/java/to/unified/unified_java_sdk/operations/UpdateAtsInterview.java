...
public class UpdateAtsInterview {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAtsInterviewRequest, UpdateAtsInterviewResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAtsInterviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsInterviewRequest.class, new TypeReference<UpdateAtsInterviewRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsInterviewRequest request) {
        ...
        @Override
        public UpdateAtsInterviewResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAtsInterviewResponse.Builder resBuilder =
            ...
            UpdateAtsInterviewResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAtsInterviewRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAtsInterviewResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAtsInterviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsInterviewRequest.class, new TypeReference<UpdateAtsInterviewRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAtsInterviewRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAtsInterviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAtsInterviewResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAtsInterviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAtsInterviewResponse res = resBuilder.build();
