...
public class GetHrisBenefit {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisBenefitRequest, GetHrisBenefitResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisBenefitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisBenefitRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisBenefitRequest request) {
        ...
        @Override
        public GetHrisBenefitResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisBenefitResponse.Builder resBuilder =
            ...
            GetHrisBenefitResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisBenefitRequest, to.unified.unified_java_sdk.models.operations.async.GetHrisBenefitResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisBenefitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisBenefitRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisBenefitRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisBenefitResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisBenefitResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisBenefitResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisBenefitResponse res = resBuilder.build();
