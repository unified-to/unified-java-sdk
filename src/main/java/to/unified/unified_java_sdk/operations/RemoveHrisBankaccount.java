...
public class RemoveHrisBankaccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisBankaccountRequest, RemoveHrisBankaccountResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisBankaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisBankaccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisBankaccountRequest request) {
        ...
        @Override
        public RemoveHrisBankaccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisBankaccountResponse.Builder resBuilder =
            ...
            RemoveHrisBankaccountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisBankaccountRequest, to.unified.unified_java_sdk.models.operations.async.RemoveHrisBankaccountResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisBankaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisBankaccountRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisBankaccountRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisBankaccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisBankaccountResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisBankaccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisBankaccountResponse res = resBuilder.build();
