...
public class GetAtsScorecard {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAtsScorecardRequest, GetAtsScorecardResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAtsScorecardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsScorecardRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAtsScorecardRequest request) {
        ...
        @Override
        public GetAtsScorecardResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAtsScorecardResponse.Builder resBuilder =
            ...
            GetAtsScorecardResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAtsScorecardRequest, to.unified.unified_java_sdk.models.operations.async.GetAtsScorecardResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAtsScorecardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsScorecardRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAtsScorecardRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAtsScorecardResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAtsScorecardResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAtsScorecardResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAtsScorecardResponse res = resBuilder.build();
