...
public class RemoveFormsForm {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveFormsFormRequest, RemoveFormsFormResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveFormsFormRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveFormsFormRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveFormsFormRequest request) {
        ...
        @Override
        public RemoveFormsFormResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveFormsFormResponse.Builder resBuilder =
            ...
            RemoveFormsFormResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveFormsFormRequest, to.unified.unified_java_sdk.models.operations.async.RemoveFormsFormResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveFormsFormRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveFormsFormRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveFormsFormRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveFormsFormResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveFormsFormResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveFormsFormResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveFormsFormResponse res = resBuilder.build();
