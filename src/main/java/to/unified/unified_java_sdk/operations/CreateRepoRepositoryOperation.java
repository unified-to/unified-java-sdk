...
public class CreateRepoRepositoryOperation implements RequestOperation<CreateRepoRepositoryRequest, CreateRepoRepositoryResponse> {
    ...
    public CreateRepoRepositoryOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateRepoRepositoryRequest request) throws Exception {
