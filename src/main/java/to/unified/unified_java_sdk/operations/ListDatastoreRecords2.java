...
public class ListDatastoreRecords2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDatastoreRecords2Request, ListDatastoreRecords2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListDatastoreRecords2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListDatastoreRecords2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDatastoreRecords2Request request) {
        ...
        @Override
        public ListDatastoreRecords2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListDatastoreRecords2Response.Builder resBuilder =
            ...
            ListDatastoreRecords2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDatastoreRecords(Utils.unmarshal(response, new TypeReference<List<DatastoreRecord>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListDatastoreRecords2Request, to.unified.unified_java_sdk.models.operations.async.ListDatastoreRecords2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListDatastoreRecords2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListDatastoreRecords2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDatastoreRecords2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListDatastoreRecords2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListDatastoreRecords2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListDatastoreRecords2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListDatastoreRecords2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<DatastoreRecord>>() {})
                            .thenApply(res::withDatastoreRecords);
                } else {
