...
public class UpdateCrmEvent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCrmEvent2Request, UpdateCrmEvent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCrmEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmEvent2Request.class, new TypeReference<UpdateCrmEvent2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCrmEvent2Request request) {
        ...
        @Override
        public UpdateCrmEvent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCrmEvent2Response.Builder resBuilder =
            ...
            UpdateCrmEvent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCrmEvent2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCrmEvent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCrmEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmEvent2Request.class, new TypeReference<UpdateCrmEvent2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCrmEvent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCrmEvent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCrmEvent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCrmEvent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCrmEvent2Response res = resBuilder.build();
