...
public class PatchPerformanceGoal {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchPerformanceGoalRequest, PatchPerformanceGoalResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchPerformanceGoalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPerformanceGoalRequest.class, new TypeReference<PatchPerformanceGoalRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchPerformanceGoalRequest request) {
        ...
        @Override
        public PatchPerformanceGoalResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchPerformanceGoalResponse.Builder resBuilder =
            ...
            PatchPerformanceGoalResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchPerformanceGoalRequest, to.unified.unified_java_sdk.models.operations.async.PatchPerformanceGoalResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchPerformanceGoalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPerformanceGoalRequest.class, new TypeReference<PatchPerformanceGoalRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchPerformanceGoalRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchPerformanceGoalResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchPerformanceGoalResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchPerformanceGoalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchPerformanceGoalResponse res = resBuilder.build();
