...
public class UpdateHrisAttendance {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisAttendanceRequest, UpdateHrisAttendanceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisAttendanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisAttendanceRequest.class, new TypeReference<UpdateHrisAttendanceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisAttendanceRequest request) {
        ...
        @Override
        public UpdateHrisAttendanceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisAttendanceResponse.Builder resBuilder =
            ...
            UpdateHrisAttendanceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisAttendance(Utils.unmarshal(response, new TypeReference<HrisAttendance>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisAttendanceRequest, to.unified.unified_java_sdk.models.operations.async.UpdateHrisAttendanceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisAttendanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisAttendanceRequest.class, new TypeReference<UpdateHrisAttendanceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisAttendanceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisAttendanceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisAttendanceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisAttendanceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisAttendanceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HrisAttendance>() {})
                            .thenApply(res::withHrisAttendance);
                } else {
