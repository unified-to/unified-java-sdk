...
public class RemovePaymentPaymentOperation implements RequestOperation<RemovePaymentPaymentRequest, RemovePaymentPaymentResponse> {
    ...
    public RemovePaymentPaymentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemovePaymentPaymentRequest request) throws Exception {
