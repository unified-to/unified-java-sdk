...
public class ListSigningDocuments {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSigningDocumentsRequest, ListSigningDocumentsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSigningDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSigningDocumentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSigningDocumentsRequest request) {
        ...
        @Override
        public ListSigningDocumentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSigningDocumentsResponse.Builder resBuilder =
            ...
            ListSigningDocumentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSigningDocumentsRequest, to.unified.unified_java_sdk.models.operations.async.ListSigningDocumentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSigningDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSigningDocumentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSigningDocumentsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListSigningDocumentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListSigningDocumentsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListSigningDocumentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListSigningDocumentsResponse res = resBuilder.build();
