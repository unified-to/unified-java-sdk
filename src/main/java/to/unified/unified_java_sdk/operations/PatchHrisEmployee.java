...
public class PatchHrisEmployee {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisEmployeeRequest, PatchHrisEmployeeResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisEmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisEmployeeRequest.class, new TypeReference<PatchHrisEmployeeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisEmployeeRequest request) {
        ...
        @Override
        public PatchHrisEmployeeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisEmployeeResponse.Builder resBuilder =
            ...
            PatchHrisEmployeeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisEmployeeRequest, to.unified.unified_java_sdk.models.operations.async.PatchHrisEmployeeResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisEmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisEmployeeRequest.class, new TypeReference<PatchHrisEmployeeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisEmployeeRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisEmployeeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisEmployeeResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisEmployeeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisEmployeeResponse res = resBuilder.build();
