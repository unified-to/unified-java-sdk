...
public class GetUcContact2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUcContact2Request, GetUcContact2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUcContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetUcContact2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUcContact2Request request) {
        ...
        @Override
        public GetUcContact2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUcContact2Response.Builder resBuilder =
            ...
            GetUcContact2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUcContact2Request, to.unified.unified_java_sdk.models.operations.async.GetUcContact2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUcContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetUcContact2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUcContact2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetUcContact2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetUcContact2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetUcContact2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetUcContact2Response res = resBuilder.build();
