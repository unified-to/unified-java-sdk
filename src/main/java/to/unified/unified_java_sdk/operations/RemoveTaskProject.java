...
public class RemoveTaskProject {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveTaskProjectRequest, RemoveTaskProjectResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(RemoveTaskProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTaskProjectRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveTaskProjectRequest request) throws Exception {
        ...
        @Override
        public RemoveTaskProjectResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveTaskProjectResponse.Builder resBuilder =
            ...
            RemoveTaskProjectResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveTaskProjectRequest, to.unified.unified_java_sdk.models.operations.async.RemoveTaskProjectResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveTaskProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTaskProjectRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveTaskProjectRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveTaskProjectResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveTaskProjectResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveTaskProjectResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveTaskProjectResponse res = resBuilder.build();
