...
public class PatchAtsInterviewOperation implements RequestOperation<PatchAtsInterviewRequest, PatchAtsInterviewResponse> {
    ...
    public PatchAtsInterviewOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchAtsInterviewRequest request) throws Exception {
