...
public class ListHrisDeductions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisDeductionsRequest, ListHrisDeductionsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisDeductionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisDeductionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisDeductionsRequest request) {
        ...
        @Override
        public ListHrisDeductionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisDeductionsResponse.Builder resBuilder =
            ...
            ListHrisDeductionsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisDeductionsRequest, to.unified.unified_java_sdk.models.operations.async.ListHrisDeductionsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisDeductionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisDeductionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisDeductionsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisDeductionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisDeductionsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisDeductionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisDeductionsResponse res = resBuilder.build();
