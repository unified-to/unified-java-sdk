...
public class PatchCommerceInventoryOperation implements RequestOperation<PatchCommerceInventoryRequest, PatchCommerceInventoryResponse> {
    ...
    public PatchCommerceInventoryOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchCommerceInventoryRequest request) throws Exception {
