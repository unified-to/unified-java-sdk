...
public class UpdateAtsJobOperation implements RequestOperation<UpdateAtsJobRequest, UpdateAtsJobResponse> {
    ...
    public UpdateAtsJobOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAtsJobRequest request) throws Exception {
