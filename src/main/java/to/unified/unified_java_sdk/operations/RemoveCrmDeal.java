...
public class RemoveCrmDeal {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCrmDealRequest, RemoveCrmDealResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCrmDealRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmDealRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCrmDealRequest request) throws Exception {
        ...
        @Override
        public RemoveCrmDealResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCrmDealResponse.Builder resBuilder =
            ...
            RemoveCrmDealResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCrmDealRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCrmDealResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCrmDealRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmDealRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCrmDealRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCrmDealResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCrmDealResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCrmDealResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCrmDealResponse res = resBuilder.build();
