...
public class GetSigningDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSigningDocumentRequest, GetSigningDocumentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSigningDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSigningDocumentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSigningDocumentRequest request) {
        ...
        @Override
        public GetSigningDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSigningDocumentResponse.Builder resBuilder =
            ...
            GetSigningDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSigningDocumentRequest, to.unified.unified_java_sdk.models.operations.async.GetSigningDocumentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSigningDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSigningDocumentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSigningDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetSigningDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetSigningDocumentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetSigningDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetSigningDocumentResponse res = resBuilder.build();
