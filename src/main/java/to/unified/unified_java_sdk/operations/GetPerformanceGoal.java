...
public class GetPerformanceGoal {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPerformanceGoalRequest, GetPerformanceGoalResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPerformanceGoalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPerformanceGoalRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPerformanceGoalRequest request) {
        ...
        @Override
        public GetPerformanceGoalResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPerformanceGoalResponse.Builder resBuilder =
            ...
            GetPerformanceGoalResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPerformanceGoalRequest, to.unified.unified_java_sdk.models.operations.async.GetPerformanceGoalResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPerformanceGoalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPerformanceGoalRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPerformanceGoalRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetPerformanceGoalResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetPerformanceGoalResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetPerformanceGoalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetPerformanceGoalResponse res = resBuilder.build();
