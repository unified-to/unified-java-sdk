...
public class UpdateAdsGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAdsGroupRequest, UpdateAdsGroupResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAdsGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsGroupRequest.class, new TypeReference<UpdateAdsGroupRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAdsGroupRequest request) {
        ...
        @Override
        public UpdateAdsGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAdsGroupResponse.Builder resBuilder =
            ...
            UpdateAdsGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAdsGroupRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAdsGroupResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAdsGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsGroupRequest.class, new TypeReference<UpdateAdsGroupRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAdsGroupRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAdsGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAdsGroupResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAdsGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAdsGroupResponse res = resBuilder.build();
