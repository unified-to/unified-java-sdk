...
public class ListTaskChanges {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTaskChangesRequest, ListTaskChangesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListTaskChangesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaskChangesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTaskChangesRequest request) {
        ...
        @Override
        public ListTaskChangesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTaskChangesResponse.Builder resBuilder =
            ...
            ListTaskChangesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTaskChangesRequest, to.unified.unified_java_sdk.models.operations.async.ListTaskChangesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListTaskChangesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaskChangesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTaskChangesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListTaskChangesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListTaskChangesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListTaskChangesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListTaskChangesResponse res = resBuilder.build();
