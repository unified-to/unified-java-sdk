...
public class ListTaskChanges {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTaskChangesRequest request) throws Exception {
        ...
        @Override
        public ListTaskChangesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<TaskChange> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTaskChanges(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
