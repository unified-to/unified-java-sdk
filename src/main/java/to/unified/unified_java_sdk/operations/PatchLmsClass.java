...
public class PatchLmsClass {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(PatchLmsClassRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsClassRequest.class, new TypeReference<PatchLmsClassRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchLmsClassRequest request) {
        ...
        @Override
        public PatchLmsClassResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchLmsClassRequest, to.unified.unified_java_sdk.models.operations.async.PatchLmsClassResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchLmsClassRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsClassRequest.class, new TypeReference<PatchLmsClassRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchLmsClassRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchLmsClassResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchLmsClassResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchLmsClassResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchLmsClassResponse res = resBuilder.build();
