...
public class UpdateMessagingEvent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMessagingEvent2Request, UpdateMessagingEvent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateMessagingEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMessagingEvent2Request.class, new TypeReference<UpdateMessagingEvent2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMessagingEvent2Request request) {
        ...
        @Override
        public UpdateMessagingEvent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMessagingEvent2Response.Builder resBuilder =
            ...
            UpdateMessagingEvent2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMessagingEvent(Utils.unmarshal(response, new TypeReference<MessagingEvent>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMessagingEvent2Request, to.unified.unified_java_sdk.models.operations.async.UpdateMessagingEvent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMessagingEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMessagingEvent2Request.class, new TypeReference<UpdateMessagingEvent2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMessagingEvent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateMessagingEvent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateMessagingEvent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateMessagingEvent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateMessagingEvent2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MessagingEvent>() {})
                            .thenApply(res::withMessagingEvent);
                } else {
