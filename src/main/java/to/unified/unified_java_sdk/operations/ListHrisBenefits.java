...
public class ListHrisBenefits {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisBenefitsRequest, ListHrisBenefitsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisBenefitsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisBenefitsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisBenefitsRequest request) {
        ...
        @Override
        public ListHrisBenefitsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisBenefitsResponse.Builder resBuilder =
            ...
            ListHrisBenefitsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisBenefitsRequest, to.unified.unified_java_sdk.models.operations.async.ListHrisBenefitsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisBenefitsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisBenefitsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisBenefitsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisBenefitsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisBenefitsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisBenefitsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisBenefitsResponse res = resBuilder.build();
