...
public class CreateRepoCommit2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateRepoCommit2Request, CreateRepoCommit2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateRepoCommit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoCommit2Request.class, new TypeReference<CreateRepoCommit2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateRepoCommit2Request request) {
        ...
        @Override
        public CreateRepoCommit2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateRepoCommit2Response.Builder resBuilder =
            ...
            CreateRepoCommit2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRepoCommit(Utils.unmarshal(response, new TypeReference<RepoCommit>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateRepoCommit2Request, to.unified.unified_java_sdk.models.operations.async.CreateRepoCommit2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateRepoCommit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoCommit2Request.class, new TypeReference<CreateRepoCommit2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateRepoCommit2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateRepoCommit2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateRepoCommit2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateRepoCommit2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateRepoCommit2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RepoCommit>() {})
                            .thenApply(res::withRepoCommit);
                } else {
