...
public class GetTaskProjectOperation implements RequestOperation<GetTaskProjectRequest, GetTaskProjectResponse> {
    ...
    public GetTaskProjectOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetTaskProjectRequest request) throws Exception {
