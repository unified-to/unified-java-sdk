...
public class PatchKmsComment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchKmsComment2Request, PatchKmsComment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchKmsComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchKmsComment2Request.class, new TypeReference<PatchKmsComment2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchKmsComment2Request request) {
        ...
        @Override
        public PatchKmsComment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchKmsComment2Response.Builder resBuilder =
            ...
            PatchKmsComment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchKmsComment2Request, to.unified.unified_java_sdk.models.operations.async.PatchKmsComment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchKmsComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchKmsComment2Request.class, new TypeReference<PatchKmsComment2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchKmsComment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchKmsComment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchKmsComment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchKmsComment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchKmsComment2Response res = resBuilder.build();
