...
public class GetAdsAd2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAdsAd2Request, GetAdsAd2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAdsAd2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsAd2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAdsAd2Request request) {
        ...
        @Override
        public GetAdsAd2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAdsAd2Response.Builder resBuilder =
                    GetAdsAd2Response
                            .builder()
            ...
            GetAdsAd2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAdsAd2Request, to.unified.unified_java_sdk.models.operations.async.GetAdsAd2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAdsAd2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsAd2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAdsAd2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAdsAd2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAdsAd2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAdsAd2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAdsAd2Response res = resBuilder.build();
