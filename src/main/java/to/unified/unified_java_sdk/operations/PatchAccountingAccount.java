...
public class PatchAccountingAccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingAccountRequest, PatchAccountingAccountResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingAccountRequest.class, new TypeReference<PatchAccountingAccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingAccountRequest request) throws Exception {
        ...
        @Override
        public PatchAccountingAccountResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingAccountResponse.Builder resBuilder =
            ...
            PatchAccountingAccountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingAccountRequest, to.unified.unified_java_sdk.models.operations.async.PatchAccountingAccountResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingAccountRequest.class, new TypeReference<PatchAccountingAccountRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingAccountRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingAccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingAccountResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingAccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingAccountResponse res = resBuilder.build();
