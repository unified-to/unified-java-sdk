...
public class ListHrisEmployeesOperation implements RequestOperation<ListHrisEmployeesRequest, ListHrisEmployeesResponse> {
    ...
    public ListHrisEmployeesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListHrisEmployeesRequest request) throws Exception {
