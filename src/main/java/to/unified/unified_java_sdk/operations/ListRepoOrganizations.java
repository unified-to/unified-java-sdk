...
public class ListRepoOrganizations {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRepoOrganizationsRequest, ListRepoOrganizationsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListRepoOrganizationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoOrganizationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRepoOrganizationsRequest request) {
        ...
        @Override
        public ListRepoOrganizationsResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListRepoOrganizationsRequest, to.unified.unified_java_sdk.models.operations.async.ListRepoOrganizationsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListRepoOrganizationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoOrganizationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRepoOrganizationsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListRepoOrganizationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListRepoOrganizationsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListRepoOrganizationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListRepoOrganizationsResponse res = resBuilder.build();
