...
public class UpdateDatastoreRecord {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateDatastoreRecordRequest, UpdateDatastoreRecordResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateDatastoreRecordRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDatastoreRecordRequest.class, new TypeReference<UpdateDatastoreRecordRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateDatastoreRecordRequest request) {
        ...
        @Override
        public UpdateDatastoreRecordResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateDatastoreRecordResponse.Builder resBuilder =
            ...
            UpdateDatastoreRecordResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateDatastoreRecordRequest, to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreRecordResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateDatastoreRecordRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDatastoreRecordRequest.class, new TypeReference<UpdateDatastoreRecordRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateDatastoreRecordRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreRecordResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreRecordResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreRecordResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateDatastoreRecordResponse res = resBuilder.build();
