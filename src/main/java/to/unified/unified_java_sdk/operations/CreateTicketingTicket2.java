...
public class CreateTicketingTicket2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTicketingTicket2Request, CreateTicketingTicket2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateTicketingTicket2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTicketingTicket2Request.class, new TypeReference<CreateTicketingTicket2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTicketingTicket2Request request) {
        ...
        @Override
        public CreateTicketingTicket2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTicketingTicket2Response.Builder resBuilder =
            ...
            CreateTicketingTicket2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTicketingTicket2Request, to.unified.unified_java_sdk.models.operations.async.CreateTicketingTicket2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTicketingTicket2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTicketingTicket2Request.class, new TypeReference<CreateTicketingTicket2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTicketingTicket2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateTicketingTicket2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateTicketingTicket2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateTicketingTicket2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateTicketingTicket2Response res = resBuilder.build();
