...
public class RemoveAdsCreative2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAdsCreative2Request, RemoveAdsCreative2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAdsCreative2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsCreative2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAdsCreative2Request request) {
        ...
        @Override
        public RemoveAdsCreative2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAdsCreative2Response.Builder resBuilder =
            ...
            RemoveAdsCreative2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAdsCreative2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAdsCreative2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAdsCreative2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsCreative2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAdsCreative2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAdsCreative2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAdsCreative2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAdsCreative2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAdsCreative2Response res = resBuilder.build();
