...
public class CreateMartechMember {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateMartechMemberRequest, CreateMartechMemberResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateMartechMemberRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMartechMemberRequest.class, new TypeReference<CreateMartechMemberRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMartechMemberRequest request) {
        ...
        @Override
        public CreateMartechMemberResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateMartechMemberResponse.Builder resBuilder =
            ...
            CreateMartechMemberResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateMartechMemberRequest, to.unified.unified_java_sdk.models.operations.async.CreateMartechMemberResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateMartechMemberRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMartechMemberRequest.class, new TypeReference<CreateMartechMemberRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateMartechMemberRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateMartechMemberResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateMartechMemberResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateMartechMemberResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateMartechMemberResponse res = resBuilder.build();
