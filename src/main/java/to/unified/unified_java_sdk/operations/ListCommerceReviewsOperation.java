...
public class ListCommerceReviewsOperation implements RequestOperation<ListCommerceReviewsRequest, ListCommerceReviewsResponse> {
    ...
    public ListCommerceReviewsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCommerceReviewsRequest request) throws Exception {
