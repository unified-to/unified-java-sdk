...
public class ListTaskTasks {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTaskTasksRequest request) throws Exception {
        ...
        @Override
        public ListTaskTasksResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<TaskTask> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTaskTasks(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
