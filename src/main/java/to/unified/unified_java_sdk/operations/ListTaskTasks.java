...
public class ListTaskTasks {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTaskTasksRequest, ListTaskTasksResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListTaskTasksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaskTasksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTaskTasksRequest request) {
        ...
        @Override
        public ListTaskTasksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTaskTasksResponse.Builder resBuilder =
            ...
            ListTaskTasksResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTaskTasksRequest, to.unified.unified_java_sdk.models.operations.async.ListTaskTasksResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListTaskTasksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaskTasksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTaskTasksRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListTaskTasksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListTaskTasksResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListTaskTasksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListTaskTasksResponse res = resBuilder.build();
