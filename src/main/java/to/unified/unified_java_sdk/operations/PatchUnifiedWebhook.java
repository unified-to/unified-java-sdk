...
public class PatchUnifiedWebhook {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchUnifiedWebhookRequest, PatchUnifiedWebhookResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchUnifiedWebhookRequest request) throws Exception {
        ...
        @Override
        public PatchUnifiedWebhookResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchUnifiedWebhookResponse.Builder resBuilder =
            ...
            PatchUnifiedWebhookResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchUnifiedWebhookRequest, to.unified.unified_java_sdk.models.operations.async.PatchUnifiedWebhookResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchUnifiedWebhookRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUnifiedWebhookRequest.class, new TypeReference<PatchUnifiedWebhookRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchUnifiedWebhookRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchUnifiedWebhookResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchUnifiedWebhookResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchUnifiedWebhookResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchUnifiedWebhookResponse res = resBuilder.build();
