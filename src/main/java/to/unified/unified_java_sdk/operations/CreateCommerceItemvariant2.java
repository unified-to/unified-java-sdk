...
public class CreateCommerceItemvariant2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommerceItemvariant2Request, CreateCommerceItemvariant2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommerceItemvariant2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceItemvariant2Request.class, new TypeReference<CreateCommerceItemvariant2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceItemvariant2Request request) {
        ...
        @Override
        public CreateCommerceItemvariant2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommerceItemvariant2Response.Builder resBuilder =
            ...
            CreateCommerceItemvariant2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommerceItemvariant2Request, to.unified.unified_java_sdk.models.operations.async.CreateCommerceItemvariant2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommerceItemvariant2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceItemvariant2Request.class, new TypeReference<CreateCommerceItemvariant2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommerceItemvariant2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCommerceItemvariant2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCommerceItemvariant2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCommerceItemvariant2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCommerceItemvariant2Response res = resBuilder.build();
