...
public class GetAdsCreative2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAdsCreative2Request, GetAdsCreative2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAdsCreative2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsCreative2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAdsCreative2Request request) {
        ...
        @Override
        public GetAdsCreative2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAdsCreative2Response.Builder resBuilder =
            ...
            GetAdsCreative2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAdsCreative2Request, to.unified.unified_java_sdk.models.operations.async.GetAdsCreative2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAdsCreative2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsCreative2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAdsCreative2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAdsCreative2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAdsCreative2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAdsCreative2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAdsCreative2Response res = resBuilder.build();
