...
public class GetAtsApplication2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAtsApplication2Request, GetAtsApplication2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAtsApplication2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsApplication2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAtsApplication2Request request) {
        ...
        @Override
        public GetAtsApplication2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAtsApplication2Response.Builder resBuilder =
            ...
            GetAtsApplication2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAtsApplication2Request, to.unified.unified_java_sdk.models.operations.async.GetAtsApplication2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAtsApplication2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsApplication2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAtsApplication2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAtsApplication2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAtsApplication2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAtsApplication2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAtsApplication2Response res = resBuilder.build();
