...
public class RemoveSigningSignatory2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveSigningSignatory2Request, RemoveSigningSignatory2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveSigningSignatory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveSigningSignatory2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveSigningSignatory2Request request) {
        ...
        @Override
        public RemoveSigningSignatory2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveSigningSignatory2Response.Builder resBuilder =
            ...
            RemoveSigningSignatory2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveSigningSignatory2Request, to.unified.unified_java_sdk.models.operations.async.RemoveSigningSignatory2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveSigningSignatory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveSigningSignatory2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveSigningSignatory2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveSigningSignatory2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveSigningSignatory2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveSigningSignatory2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveSigningSignatory2Response res = resBuilder.build();
