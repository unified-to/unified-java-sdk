...
public class PatchAccountingTaxrate {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingTaxrateRequest, PatchAccountingTaxrateResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingTaxrateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingTaxrateRequest.class, new TypeReference<PatchAccountingTaxrateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingTaxrateRequest request) {
        ...
        @Override
        public PatchAccountingTaxrateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingTaxrateResponse.Builder resBuilder =
            ...
            PatchAccountingTaxrateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingTaxrateRequest, to.unified.unified_java_sdk.models.operations.async.PatchAccountingTaxrateResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingTaxrateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingTaxrateRequest.class, new TypeReference<PatchAccountingTaxrateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingTaxrateRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingTaxrateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingTaxrateResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingTaxrateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingTaxrateResponse res = resBuilder.build();
