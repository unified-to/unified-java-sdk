...
public class PatchPaymentLink {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchPaymentLinkRequest, PatchPaymentLinkResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(PatchPaymentLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPaymentLinkRequest.class, new TypeReference<PatchPaymentLinkRequest>() {});
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchPaymentLinkRequest, to.unified.unified_java_sdk.models.operations.async.PatchPaymentLinkResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchPaymentLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPaymentLinkRequest.class, new TypeReference<PatchPaymentLinkRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchPaymentLinkRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchPaymentLinkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchPaymentLinkResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchPaymentLinkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchPaymentLinkResponse res = resBuilder.build();
