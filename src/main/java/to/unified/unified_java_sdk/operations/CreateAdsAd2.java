...
public class CreateAdsAd2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAdsAd2Request, CreateAdsAd2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAdsAd2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsAd2Request.class, new TypeReference<CreateAdsAd2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAdsAd2Request request) {
        ...
        @Override
        public CreateAdsAd2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAdsAd2Response.Builder resBuilder =
            ...
            CreateAdsAd2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAdsAd2Request, to.unified.unified_java_sdk.models.operations.async.CreateAdsAd2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAdsAd2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsAd2Request.class, new TypeReference<CreateAdsAd2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAdsAd2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAdsAd2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAdsAd2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAdsAd2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAdsAd2Response res = resBuilder.build();
