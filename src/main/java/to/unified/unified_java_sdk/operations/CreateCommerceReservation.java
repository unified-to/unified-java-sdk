...
public class CreateCommerceReservation {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommerceReservationRequest, CreateCommerceReservationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommerceReservationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceReservationRequest.class, new TypeReference<CreateCommerceReservationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceReservationRequest request) {
        ...
        @Override
        public CreateCommerceReservationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommerceReservationResponse.Builder resBuilder =
                    CreateCommerceReservationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateCommerceReservationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceReservation(Utils.unmarshal(response, new TypeReference<CommerceReservation>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommerceReservationRequest, to.unified.unified_java_sdk.models.operations.async.CreateCommerceReservationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommerceReservationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceReservationRequest.class, new TypeReference<CreateCommerceReservationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommerceReservationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCommerceReservationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCommerceReservationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCommerceReservationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCommerceReservationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CommerceReservation>() {})
                            .thenApply(res::withCommerceReservation);
                } else {
