...
public class UpdateLmsStudent {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLmsStudentRequest, UpdateLmsStudentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateLmsStudentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsStudentRequest.class, new TypeReference<UpdateLmsStudentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLmsStudentRequest request) {
        ...
        @Override
        public UpdateLmsStudentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateLmsStudentResponse.Builder resBuilder =
            ...
            UpdateLmsStudentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLmsStudentRequest, to.unified.unified_java_sdk.models.operations.async.UpdateLmsStudentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLmsStudentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsStudentRequest.class, new TypeReference<UpdateLmsStudentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLmsStudentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateLmsStudentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateLmsStudentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateLmsStudentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateLmsStudentResponse res = resBuilder.build();
