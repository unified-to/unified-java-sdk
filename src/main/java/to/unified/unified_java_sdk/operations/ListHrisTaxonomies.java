...
public class ListHrisTaxonomies {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisTaxonomiesRequest, ListHrisTaxonomiesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisTaxonomiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisTaxonomiesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisTaxonomiesRequest request) {
        ...
        @Override
        public ListHrisTaxonomiesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisTaxonomiesResponse.Builder resBuilder =
            ...
            ListHrisTaxonomiesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisTaxonomies(Utils.unmarshal(response, new TypeReference<List<HrisTaxonomy>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisTaxonomiesRequest, to.unified.unified_java_sdk.models.operations.async.ListHrisTaxonomiesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisTaxonomiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisTaxonomiesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisTaxonomiesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisTaxonomiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisTaxonomiesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisTaxonomiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisTaxonomiesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<HrisTaxonomy>>() {})
                            .thenApply(res::withHrisTaxonomies);
                } else {
