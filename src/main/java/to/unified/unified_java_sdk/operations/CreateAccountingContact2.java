...
public class CreateAccountingContact2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAccountingContact2Request, CreateAccountingContact2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAccountingContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingContact2Request.class, new TypeReference<CreateAccountingContact2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingContact2Request request) {
        ...
        @Override
        public CreateAccountingContact2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAccountingContact2Response.Builder resBuilder =
            ...
            CreateAccountingContact2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountingContact(Utils.unmarshal(response, new TypeReference<AccountingContact>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAccountingContact2Request, to.unified.unified_java_sdk.models.operations.async.CreateAccountingContact2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAccountingContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingContact2Request.class, new TypeReference<CreateAccountingContact2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAccountingContact2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAccountingContact2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAccountingContact2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAccountingContact2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAccountingContact2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountingContact>() {})
                            .thenApply(res::withAccountingContact);
                } else {
