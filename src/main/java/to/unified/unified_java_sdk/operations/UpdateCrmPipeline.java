...
public class UpdateCrmPipeline {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCrmPipelineRequest, UpdateCrmPipelineResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCrmPipelineRequest request) {
        ...
        @Override
        public UpdateCrmPipelineResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCrmPipelineResponse.Builder resBuilder =
            ...
            UpdateCrmPipelineResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCrmPipelineRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCrmPipelineResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCrmPipelineRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmPipelineRequest.class, new TypeReference<UpdateCrmPipelineRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCrmPipelineRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCrmPipelineResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCrmPipelineResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCrmPipelineResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCrmPipelineResponse res = resBuilder.build();
