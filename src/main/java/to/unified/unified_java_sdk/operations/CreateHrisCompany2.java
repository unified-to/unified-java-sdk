...
public class CreateHrisCompany2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisCompany2Request, CreateHrisCompany2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisCompany2Request.class, new TypeReference<CreateHrisCompany2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisCompany2Request request) {
        ...
        @Override
        public CreateHrisCompany2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisCompany2Response.Builder resBuilder =
            ...
            CreateHrisCompany2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisCompany2Request, to.unified.unified_java_sdk.models.operations.async.CreateHrisCompany2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisCompany2Request.class, new TypeReference<CreateHrisCompany2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisCompany2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisCompany2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisCompany2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisCompany2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisCompany2Response res = resBuilder.build();
