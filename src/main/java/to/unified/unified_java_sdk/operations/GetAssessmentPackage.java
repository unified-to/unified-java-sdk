...
public class GetAssessmentPackage {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAssessmentPackageRequest, GetAssessmentPackageResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAssessmentPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAssessmentPackageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAssessmentPackageRequest request) {
        ...
        @Override
        public GetAssessmentPackageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAssessmentPackageResponse.Builder resBuilder =
            ...
            GetAssessmentPackageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAssessmentPackageRequest, to.unified.unified_java_sdk.models.operations.async.GetAssessmentPackageResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAssessmentPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAssessmentPackageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAssessmentPackageRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAssessmentPackageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAssessmentPackageResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAssessmentPackageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAssessmentPackageResponse res = resBuilder.build();
