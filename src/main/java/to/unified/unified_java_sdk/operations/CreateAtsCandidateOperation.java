...
public class CreateAtsCandidateOperation implements RequestOperation<CreateAtsCandidateRequest, CreateAtsCandidateResponse> {
    ...
    public CreateAtsCandidateOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAtsCandidateRequest request) throws Exception {
