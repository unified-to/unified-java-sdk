...
public class UpdatePaymentLink {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatePaymentLinkRequest, to.unified.unified_java_sdk.models.operations.async.UpdatePaymentLinkResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePaymentLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePaymentLinkRequest.class, new TypeReference<UpdatePaymentLinkRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatePaymentLinkRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdatePaymentLinkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdatePaymentLinkResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdatePaymentLinkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdatePaymentLinkResponse res = resBuilder.build();
