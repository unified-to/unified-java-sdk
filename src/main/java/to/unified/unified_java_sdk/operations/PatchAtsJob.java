...
public class PatchAtsJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAtsJobRequest, PatchAtsJobResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAtsJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsJobRequest.class, new TypeReference<PatchAtsJobRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAtsJobRequest request) {
        ...
        @Override
        public PatchAtsJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAtsJobResponse.Builder resBuilder =
                    PatchAtsJobResponse
                            .builder()
            ...
            PatchAtsJobResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAtsJobRequest, to.unified.unified_java_sdk.models.operations.async.PatchAtsJobResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAtsJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsJobRequest.class, new TypeReference<PatchAtsJobRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAtsJobRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAtsJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAtsJobResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAtsJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAtsJobResponse res = resBuilder.build();
