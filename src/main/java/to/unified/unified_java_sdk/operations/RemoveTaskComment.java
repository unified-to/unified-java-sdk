...
public class RemoveTaskComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveTaskCommentRequest, RemoveTaskCommentResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(RemoveTaskCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTaskCommentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveTaskCommentRequest request) throws Exception {
        ...
        @Override
        public RemoveTaskCommentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveTaskCommentResponse.Builder resBuilder =
            ...
            RemoveTaskCommentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveTaskCommentRequest, to.unified.unified_java_sdk.models.operations.async.RemoveTaskCommentResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveTaskCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTaskCommentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveTaskCommentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveTaskCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveTaskCommentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveTaskCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveTaskCommentResponse res = resBuilder.build();
