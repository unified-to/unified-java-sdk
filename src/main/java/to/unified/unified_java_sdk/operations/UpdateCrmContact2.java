...
public class UpdateCrmContact2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCrmContact2Request, UpdateCrmContact2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCrmContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmContact2Request.class, new TypeReference<UpdateCrmContact2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCrmContact2Request request) {
        ...
        @Override
        public UpdateCrmContact2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCrmContact2Response.Builder resBuilder =
            ...
            UpdateCrmContact2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCrmContact(Utils.unmarshal(response, new TypeReference<CrmContact>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCrmContact2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCrmContact2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCrmContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmContact2Request.class, new TypeReference<UpdateCrmContact2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCrmContact2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCrmContact2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCrmContact2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCrmContact2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCrmContact2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CrmContact>() {})
                            .thenApply(res::withCrmContact);
                } else {
