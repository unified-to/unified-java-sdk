...
public class RemoveCalendarCalendar2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCalendarCalendar2Request, RemoveCalendarCalendar2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCalendarCalendar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCalendarCalendar2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCalendarCalendar2Request request) {
        ...
        @Override
        public RemoveCalendarCalendar2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCalendarCalendar2Response.Builder resBuilder =
            ...
            RemoveCalendarCalendar2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCalendarCalendar2Request, to.unified.unified_java_sdk.models.operations.async.RemoveCalendarCalendar2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCalendarCalendar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCalendarCalendar2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCalendarCalendar2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCalendarCalendar2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCalendarCalendar2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCalendarCalendar2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCalendarCalendar2Response res = resBuilder.build();
