...
public class GetCommerceSaleschannel2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceSaleschannel2Request, GetCommerceSaleschannel2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommerceSaleschannel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceSaleschannel2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceSaleschannel2Request request) {
        ...
        @Override
        public GetCommerceSaleschannel2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommerceSaleschannel2Response.Builder resBuilder =
            ...
            GetCommerceSaleschannel2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommerceSaleschannel2Request, to.unified.unified_java_sdk.models.operations.async.GetCommerceSaleschannel2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommerceSaleschannel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceSaleschannel2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommerceSaleschannel2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCommerceSaleschannel2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCommerceSaleschannel2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCommerceSaleschannel2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCommerceSaleschannel2Response res = resBuilder.build();
