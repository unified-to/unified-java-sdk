...
public class PatchPassthroughRaw {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchPassthroughRawRequest, PatchPassthroughRawResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchPassthroughRawRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPassthroughRawRequest.class, new TypeReference<PatchPassthroughRawRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchPassthroughRawRequest request) {
        ...
        @Override
        public PatchPassthroughRawResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchPassthroughRawRequest, to.unified.unified_java_sdk.models.operations.async.PatchPassthroughRawResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchPassthroughRawRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPassthroughRawRequest.class, new TypeReference<PatchPassthroughRawRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchPassthroughRawRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchPassthroughRawResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchPassthroughRawResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchPassthroughRawResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            to.unified.unified_java_sdk.models.operations.async.PatchPassthroughRawResponse res = resBuilder.build();
