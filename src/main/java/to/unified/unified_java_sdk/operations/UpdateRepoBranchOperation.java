...
public class UpdateRepoBranchOperation implements RequestOperation<UpdateRepoBranchRequest, UpdateRepoBranchResponse> {
    ...
    public UpdateRepoBranchOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateRepoBranchRequest request) throws Exception {
