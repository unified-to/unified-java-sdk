...
public class GetScimGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetScimGroupsRequest, GetScimGroupsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetScimGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetScimGroupsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetScimGroupsRequest request) {
        ...
        @Override
        public GetScimGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetScimGroupsResponse.Builder resBuilder =
            ...
            GetScimGroupsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetScimGroupsRequest, to.unified.unified_java_sdk.models.operations.async.GetScimGroupsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetScimGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetScimGroupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetScimGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetScimGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetScimGroupsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetScimGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetScimGroupsResponse res = resBuilder.build();
