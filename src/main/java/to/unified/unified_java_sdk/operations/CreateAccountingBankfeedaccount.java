...
public class CreateAccountingBankfeedaccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAccountingBankfeedaccountRequest, CreateAccountingBankfeedaccountResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAccountingBankfeedaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingBankfeedaccountRequest.class, new TypeReference<CreateAccountingBankfeedaccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingBankfeedaccountRequest request) {
        ...
        @Override
        public CreateAccountingBankfeedaccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAccountingBankfeedaccountResponse.Builder resBuilder =
                    CreateAccountingBankfeedaccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateAccountingBankfeedaccountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAccountingBankfeedaccountRequest, to.unified.unified_java_sdk.models.operations.async.CreateAccountingBankfeedaccountResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAccountingBankfeedaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingBankfeedaccountRequest.class, new TypeReference<CreateAccountingBankfeedaccountRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAccountingBankfeedaccountRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAccountingBankfeedaccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAccountingBankfeedaccountResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAccountingBankfeedaccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAccountingBankfeedaccountResponse res = resBuilder.build();
