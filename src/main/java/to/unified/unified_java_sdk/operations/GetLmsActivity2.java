...
public class GetLmsActivity2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLmsActivity2Request, GetLmsActivity2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLmsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsActivity2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLmsActivity2Request request) {
        ...
        @Override
        public GetLmsActivity2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLmsActivity2Response.Builder resBuilder =
            ...
            GetLmsActivity2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLmsActivity2Request, to.unified.unified_java_sdk.models.operations.async.GetLmsActivity2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLmsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsActivity2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLmsActivity2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetLmsActivity2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetLmsActivity2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetLmsActivity2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetLmsActivity2Response res = resBuilder.build();
