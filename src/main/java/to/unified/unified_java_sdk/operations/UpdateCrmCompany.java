...
public class UpdateCrmCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCrmCompanyRequest, UpdateCrmCompanyResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCrmCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmCompanyRequest.class, new TypeReference<UpdateCrmCompanyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCrmCompanyRequest request) {
        ...
        @Override
        public UpdateCrmCompanyResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCrmCompanyRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCrmCompanyResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCrmCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmCompanyRequest.class, new TypeReference<UpdateCrmCompanyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCrmCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCrmCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCrmCompanyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCrmCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCrmCompanyResponse res = resBuilder.build();
