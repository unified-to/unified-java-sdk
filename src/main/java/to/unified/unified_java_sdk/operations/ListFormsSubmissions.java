...
public class ListFormsSubmissions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListFormsSubmissionsRequest, ListFormsSubmissionsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListFormsSubmissionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListFormsSubmissionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListFormsSubmissionsRequest request) {
        ...
        @Override
        public ListFormsSubmissionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListFormsSubmissionsResponse.Builder resBuilder =
            ...
            ListFormsSubmissionsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListFormsSubmissionsRequest, to.unified.unified_java_sdk.models.operations.async.ListFormsSubmissionsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListFormsSubmissionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListFormsSubmissionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListFormsSubmissionsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListFormsSubmissionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListFormsSubmissionsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListFormsSubmissionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListFormsSubmissionsResponse res = resBuilder.build();
