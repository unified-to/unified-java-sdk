...
public class RemoveLmsStudent {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveLmsStudentRequest, RemoveLmsStudentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveLmsStudentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsStudentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveLmsStudentRequest request) throws Exception {
        ...
        @Override
        public RemoveLmsStudentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveLmsStudentResponse.Builder resBuilder =
            ...
            RemoveLmsStudentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveLmsStudentRequest, to.unified.unified_java_sdk.models.operations.async.RemoveLmsStudentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveLmsStudentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsStudentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveLmsStudentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveLmsStudentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveLmsStudentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveLmsStudentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveLmsStudentResponse res = resBuilder.build();
