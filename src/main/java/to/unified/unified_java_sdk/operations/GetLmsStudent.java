...
public class GetLmsStudent {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLmsStudentRequest, GetLmsStudentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLmsStudentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsStudentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLmsStudentRequest request) {
        ...
        @Override
        public GetLmsStudentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLmsStudentResponse.Builder resBuilder =
            ...
            GetLmsStudentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLmsStudentRequest, to.unified.unified_java_sdk.models.operations.async.GetLmsStudentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLmsStudentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsStudentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLmsStudentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetLmsStudentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetLmsStudentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetLmsStudentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetLmsStudentResponse res = resBuilder.build();
