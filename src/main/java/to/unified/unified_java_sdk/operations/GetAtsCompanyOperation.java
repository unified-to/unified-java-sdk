...
public class GetAtsCompanyOperation implements RequestOperation<GetAtsCompanyRequest, GetAtsCompanyResponse> {
    ...
    public GetAtsCompanyOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAtsCompanyRequest request) throws Exception {
