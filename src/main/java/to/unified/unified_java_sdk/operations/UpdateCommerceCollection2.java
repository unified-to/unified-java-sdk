...
public class UpdateCommerceCollection2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommerceCollection2Request, UpdateCommerceCollection2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCommerceCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceCollection2Request.class, new TypeReference<UpdateCommerceCollection2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceCollection2Request request) {
        ...
        @Override
        public UpdateCommerceCollection2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommerceCollection2Response.Builder resBuilder =
            ...
            UpdateCommerceCollection2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommerceCollection2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCommerceCollection2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommerceCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceCollection2Request.class, new TypeReference<UpdateCommerceCollection2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommerceCollection2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCommerceCollection2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceCollection2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCommerceCollection2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceCollection2Response res = resBuilder.build();
