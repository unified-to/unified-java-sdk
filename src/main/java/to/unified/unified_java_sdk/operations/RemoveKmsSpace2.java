...
public class RemoveKmsSpace2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveKmsSpace2Request, RemoveKmsSpace2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveKmsSpace2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveKmsSpace2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveKmsSpace2Request request) {
        ...
        @Override
        public RemoveKmsSpace2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveKmsSpace2Response.Builder resBuilder =
            ...
            RemoveKmsSpace2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveKmsSpace2Request, to.unified.unified_java_sdk.models.operations.async.RemoveKmsSpace2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveKmsSpace2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveKmsSpace2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveKmsSpace2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveKmsSpace2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveKmsSpace2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveKmsSpace2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveKmsSpace2Response res = resBuilder.build();
