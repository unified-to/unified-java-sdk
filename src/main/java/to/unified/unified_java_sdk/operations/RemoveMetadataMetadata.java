...
public class RemoveMetadataMetadata {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveMetadataMetadataRequest, RemoveMetadataMetadataResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveMetadataMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMetadataMetadataRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveMetadataMetadataRequest request) throws Exception {
        ...
        @Override
        public RemoveMetadataMetadataResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveMetadataMetadataResponse.Builder resBuilder =
            ...
            RemoveMetadataMetadataResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveMetadataMetadataRequest, to.unified.unified_java_sdk.models.operations.async.RemoveMetadataMetadataResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveMetadataMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMetadataMetadataRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveMetadataMetadataRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveMetadataMetadataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveMetadataMetadataResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveMetadataMetadataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveMetadataMetadataResponse res = resBuilder.build();
