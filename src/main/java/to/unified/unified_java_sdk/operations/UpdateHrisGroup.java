...
public class UpdateHrisGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisGroupRequest, UpdateHrisGroupResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisGroupRequest.class, new TypeReference<UpdateHrisGroupRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisGroupRequest request) {
        ...
        @Override
        public UpdateHrisGroupResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisGroupRequest, to.unified.unified_java_sdk.models.operations.async.UpdateHrisGroupResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisGroupRequest.class, new TypeReference<UpdateHrisGroupRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisGroupRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisGroupResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisGroupResponse res = resBuilder.build();
