...
public class ListPaymentRefunds2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPaymentRefunds2Request, ListPaymentRefunds2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPaymentRefunds2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentRefunds2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentRefunds2Request request) {
        ...
        @Override
        public ListPaymentRefunds2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPaymentRefunds2Response.Builder resBuilder =
            ...
            ListPaymentRefunds2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentRefunds(Utils.unmarshal(response, new TypeReference<List<PaymentRefund>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentRefunds2Request, to.unified.unified_java_sdk.models.operations.async.ListPaymentRefunds2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPaymentRefunds2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentRefunds2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPaymentRefunds2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListPaymentRefunds2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListPaymentRefunds2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListPaymentRefunds2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListPaymentRefunds2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<PaymentRefund>>() {})
                            .thenApply(res::withPaymentRefunds);
                } else {
