...
public class PatchCalendarLinkOperation implements RequestOperation<PatchCalendarLinkRequest, PatchCalendarLinkResponse> {
    ...
    public PatchCalendarLinkOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchCalendarLinkRequest request) throws Exception {
