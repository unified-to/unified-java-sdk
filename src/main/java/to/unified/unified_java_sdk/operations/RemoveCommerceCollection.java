...
public class RemoveCommerceCollection {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCommerceCollectionRequest, RemoveCommerceCollectionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCommerceCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceCollectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCommerceCollectionRequest request) throws Exception {
        ...
        @Override
        public RemoveCommerceCollectionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCommerceCollectionResponse.Builder resBuilder =
            ...
            RemoveCommerceCollectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCommerceCollectionRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCommerceCollectionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCommerceCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceCollectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCommerceCollectionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCommerceCollectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceCollectionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCommerceCollectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceCollectionResponse res = resBuilder.build();
