...
public class GetCdpActivation {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCdpActivationRequest, GetCdpActivationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCdpActivationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCdpActivationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCdpActivationRequest request) {
        ...
        @Override
        public GetCdpActivationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCdpActivationResponse.Builder resBuilder =
            ...
            GetCdpActivationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCdpActivationRequest, to.unified.unified_java_sdk.models.operations.async.GetCdpActivationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCdpActivationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCdpActivationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCdpActivationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCdpActivationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCdpActivationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCdpActivationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCdpActivationResponse res = resBuilder.build();
