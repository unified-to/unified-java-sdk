...
public class ListAccountingProfitlossesOperation implements RequestOperation<ListAccountingProfitlossesRequest, ListAccountingProfitlossesResponse> {
    ...
    public ListAccountingProfitlossesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAccountingProfitlossesRequest request) throws Exception {
        String url = Utils.generateURL(
                ListAccountingProfitlossesRequest.class,
                this.baseUrl,
