...
public class GetAccountingExpense2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingExpense2Request, GetAccountingExpense2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingExpense2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingExpense2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingExpense2Request request) {
        ...
        @Override
        public GetAccountingExpense2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingExpense2Response.Builder resBuilder =
            ...
            GetAccountingExpense2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingExpense2Request, to.unified.unified_java_sdk.models.operations.async.GetAccountingExpense2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingExpense2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingExpense2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingExpense2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingExpense2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingExpense2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingExpense2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingExpense2Response res = resBuilder.build();
