...
public class RemoveCalendarCalendarOperation implements RequestOperation<RemoveCalendarCalendarRequest, RemoveCalendarCalendarResponse> {
    ...
    public RemoveCalendarCalendarOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveCalendarCalendarRequest request) throws Exception {
