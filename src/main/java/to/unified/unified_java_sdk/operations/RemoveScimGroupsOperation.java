...
public class RemoveScimGroupsOperation implements RequestOperation<RemoveScimGroupsRequest, RemoveScimGroupsResponse> {
    ...
    public RemoveScimGroupsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveScimGroupsRequest request) throws Exception {
