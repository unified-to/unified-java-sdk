...
public class GetHrisPayslip {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisPayslipRequest, GetHrisPayslipResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisPayslipRequest request) {
        ...
        @Override
        public GetHrisPayslipResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisPayslipResponse.Builder resBuilder =
            ...
            GetHrisPayslipResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisPayslipRequest, to.unified.unified_java_sdk.models.operations.async.GetHrisPayslipResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisPayslipRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisPayslipRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisPayslipRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisPayslipResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisPayslipResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisPayslipResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisPayslipResponse res = resBuilder.build();
