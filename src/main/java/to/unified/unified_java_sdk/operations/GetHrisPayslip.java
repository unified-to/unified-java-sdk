...
public class GetHrisPayslip {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisPayslipRequest request) throws Exception {
        ...
        @Override
        public GetHrisPayslipResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HrisPayslip out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHrisPayslip(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
