...
public class CreateHrisGroup2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisGroup2Request, CreateHrisGroup2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisGroup2Request.class, new TypeReference<CreateHrisGroup2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisGroup2Request request) {
        ...
        @Override
        public CreateHrisGroup2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisGroup2Response.Builder resBuilder =
            ...
            CreateHrisGroup2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisGroup(Utils.unmarshal(response, new TypeReference<HrisGroup>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisGroup2Request, to.unified.unified_java_sdk.models.operations.async.CreateHrisGroup2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisGroup2Request.class, new TypeReference<CreateHrisGroup2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisGroup2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisGroup2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisGroup2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisGroup2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisGroup2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HrisGroup>() {})
                            .thenApply(res::withHrisGroup);
                } else {
