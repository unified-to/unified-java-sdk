...
public class CreateGenaiAgent {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateGenaiAgentRequest, CreateGenaiAgentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateGenaiAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateGenaiAgentRequest.class, new TypeReference<CreateGenaiAgentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateGenaiAgentRequest request) {
        ...
        @Override
        public CreateGenaiAgentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateGenaiAgentResponse.Builder resBuilder =
            ...
            CreateGenaiAgentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGenaiAgent(Utils.unmarshal(response, new TypeReference<GenaiAgent>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateGenaiAgentRequest, to.unified.unified_java_sdk.models.operations.async.CreateGenaiAgentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateGenaiAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateGenaiAgentRequest.class, new TypeReference<CreateGenaiAgentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateGenaiAgentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateGenaiAgentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateGenaiAgentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateGenaiAgentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateGenaiAgentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GenaiAgent>() {})
                            .thenApply(res::withGenaiAgent);
                } else {
