...
public class PatchCdpSegment {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCdpSegmentRequest, PatchCdpSegmentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCdpSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCdpSegmentRequest.class, new TypeReference<PatchCdpSegmentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCdpSegmentRequest request) {
        ...
        @Override
        public PatchCdpSegmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCdpSegmentResponse.Builder resBuilder =
            ...
            PatchCdpSegmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCdpSegmentRequest, to.unified.unified_java_sdk.models.operations.async.PatchCdpSegmentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCdpSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCdpSegmentRequest.class, new TypeReference<PatchCdpSegmentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCdpSegmentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCdpSegmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCdpSegmentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCdpSegmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCdpSegmentResponse res = resBuilder.build();
