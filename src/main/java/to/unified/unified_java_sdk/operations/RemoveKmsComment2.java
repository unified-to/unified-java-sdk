...
public class RemoveKmsComment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveKmsComment2Request, RemoveKmsComment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveKmsComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveKmsComment2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveKmsComment2Request request) {
        ...
        @Override
        public RemoveKmsComment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveKmsComment2Response.Builder resBuilder =
            ...
            RemoveKmsComment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveKmsComment2Request, to.unified.unified_java_sdk.models.operations.async.RemoveKmsComment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveKmsComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveKmsComment2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveKmsComment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveKmsComment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveKmsComment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveKmsComment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveKmsComment2Response res = resBuilder.build();
