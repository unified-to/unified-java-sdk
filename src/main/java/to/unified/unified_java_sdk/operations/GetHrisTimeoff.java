...
public class GetHrisTimeoff {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisTimeoffRequest request) throws Exception {
        ...
        @Override
        public GetHrisTimeoffResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HrisTimeoff out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHrisTimeoff(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
