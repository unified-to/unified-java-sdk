...
public class PatchLmsContent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchLmsContent2Request, PatchLmsContent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchLmsContent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsContent2Request.class, new TypeReference<PatchLmsContent2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchLmsContent2Request request) {
        ...
        @Override
        public PatchLmsContent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchLmsContent2Response.Builder resBuilder =
            ...
            PatchLmsContent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchLmsContent2Request, to.unified.unified_java_sdk.models.operations.async.PatchLmsContent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchLmsContent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsContent2Request.class, new TypeReference<PatchLmsContent2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchLmsContent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchLmsContent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchLmsContent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchLmsContent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchLmsContent2Response res = resBuilder.build();
