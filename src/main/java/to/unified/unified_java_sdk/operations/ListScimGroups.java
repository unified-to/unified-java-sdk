...
public class ListScimGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListScimGroupsRequest, ListScimGroupsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListScimGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListScimGroupsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListScimGroupsRequest request) {
        ...
        @Override
        public ListScimGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListScimGroupsResponse.Builder resBuilder =
            ...
            ListScimGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withScimGroups(Utils.unmarshal(response, new TypeReference<List<ScimGroup>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListScimGroupsRequest, to.unified.unified_java_sdk.models.operations.async.ListScimGroupsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListScimGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListScimGroupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListScimGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListScimGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListScimGroupsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListScimGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListScimGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ScimGroup>>() {})
                            .thenApply(res::withScimGroups);
                } else {
