...
public class GetAccountingCategory {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingCategoryRequest, GetAccountingCategoryResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingCategoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingCategoryRequest request) {
        ...
        @Override
        public GetAccountingCategoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingCategoryResponse.Builder resBuilder =
            ...
            GetAccountingCategoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingCategoryRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingCategoryResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingCategoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingCategoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingCategoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingCategoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingCategoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingCategoryResponse res = resBuilder.build();
