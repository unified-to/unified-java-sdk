...
public class PatchAtsActivity {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAtsActivityRequest, PatchAtsActivityResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAtsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsActivityRequest.class, new TypeReference<PatchAtsActivityRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAtsActivityRequest request) {
        ...
        @Override
        public PatchAtsActivityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAtsActivityResponse.Builder resBuilder =
            ...
            PatchAtsActivityResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAtsActivityRequest, to.unified.unified_java_sdk.models.operations.async.PatchAtsActivityResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAtsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsActivityRequest.class, new TypeReference<PatchAtsActivityRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAtsActivityRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAtsActivityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAtsActivityResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAtsActivityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAtsActivityResponse res = resBuilder.build();
