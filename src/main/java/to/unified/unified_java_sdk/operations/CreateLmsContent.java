...
public class CreateLmsContent {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateLmsContentRequest, CreateLmsContentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateLmsContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsContentRequest.class, new TypeReference<CreateLmsContentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateLmsContentRequest request) {
        ...
        @Override
        public CreateLmsContentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateLmsContentResponse.Builder resBuilder =
            ...
            CreateLmsContentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateLmsContentRequest, to.unified.unified_java_sdk.models.operations.async.CreateLmsContentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateLmsContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsContentRequest.class, new TypeReference<CreateLmsContentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateLmsContentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateLmsContentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateLmsContentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateLmsContentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateLmsContentResponse res = resBuilder.build();
