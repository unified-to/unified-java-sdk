...
public class ListCommerceLocations {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceLocationsRequest request) throws Exception {
        ...
        @Override
        public ListCommerceLocationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CommerceLocation> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCommerceLocations(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
