...
public class ListCommerceLocations {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceLocationsRequest, ListCommerceLocationsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommerceLocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceLocationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceLocationsRequest request) {
        ...
        @Override
        public ListCommerceLocationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceLocationsResponse.Builder resBuilder =
            ...
            ListCommerceLocationsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceLocationsRequest, to.unified.unified_java_sdk.models.operations.async.ListCommerceLocationsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceLocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceLocationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceLocationsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceLocationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceLocationsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceLocationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceLocationsResponse res = resBuilder.build();
