...
public class ListTaskProjectsOperation implements RequestOperation<ListTaskProjectsRequest, ListTaskProjectsResponse> {
    ...
    public ListTaskProjectsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListTaskProjectsRequest request) throws Exception {
