...
public class PatchAccountingTaxrateOperation implements RequestOperation<PatchAccountingTaxrateRequest, PatchAccountingTaxrateResponse> {
    ...
    public PatchAccountingTaxrateOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchAccountingTaxrateRequest request) throws Exception {
