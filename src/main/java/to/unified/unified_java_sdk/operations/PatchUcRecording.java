...
public class PatchUcRecording {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchUcRecordingRequest, PatchUcRecordingResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchUcRecordingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUcRecordingRequest.class, new TypeReference<PatchUcRecordingRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchUcRecordingRequest request) {
        ...
        @Override
        public PatchUcRecordingResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchUcRecordingRequest, to.unified.unified_java_sdk.models.operations.async.PatchUcRecordingResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchUcRecordingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUcRecordingRequest.class, new TypeReference<PatchUcRecordingRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchUcRecordingRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchUcRecordingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchUcRecordingResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchUcRecordingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchUcRecordingResponse res = resBuilder.build();
