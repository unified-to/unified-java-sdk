...
public class RemoveAnalyticsVisitor {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAnalyticsVisitorRequest, RemoveAnalyticsVisitorResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAnalyticsVisitorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAnalyticsVisitorRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAnalyticsVisitorRequest request) {
        ...
        @Override
        public RemoveAnalyticsVisitorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAnalyticsVisitorResponse.Builder resBuilder =
            ...
            RemoveAnalyticsVisitorResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAnalyticsVisitorRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsVisitorResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAnalyticsVisitorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAnalyticsVisitorRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAnalyticsVisitorRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsVisitorResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsVisitorResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsVisitorResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsVisitorResponse res = resBuilder.build();
