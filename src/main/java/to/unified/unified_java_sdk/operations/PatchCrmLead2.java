...
public class PatchCrmLead2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCrmLead2Request, PatchCrmLead2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCrmLead2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmLead2Request.class, new TypeReference<PatchCrmLead2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCrmLead2Request request) {
        ...
        @Override
        public PatchCrmLead2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCrmLead2Response.Builder resBuilder =
            ...
            PatchCrmLead2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCrmLead2Request, to.unified.unified_java_sdk.models.operations.async.PatchCrmLead2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCrmLead2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmLead2Request.class, new TypeReference<PatchCrmLead2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCrmLead2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCrmLead2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCrmLead2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCrmLead2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCrmLead2Response res = resBuilder.build();
