...
public class ListScimGroupsOperation implements RequestOperation<ListScimGroupsRequest, ListScimGroupsResponse> {
    ...
    public ListScimGroupsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListScimGroupsRequest request) throws Exception {
