...
public class PatchLmsInstructor {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchLmsInstructorRequest, PatchLmsInstructorResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchLmsInstructorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsInstructorRequest.class, new TypeReference<PatchLmsInstructorRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchLmsInstructorRequest request) {
        ...
        @Override
        public PatchLmsInstructorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchLmsInstructorResponse.Builder resBuilder =
            ...
            PatchLmsInstructorResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchLmsInstructorRequest, to.unified.unified_java_sdk.models.operations.async.PatchLmsInstructorResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchLmsInstructorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsInstructorRequest.class, new TypeReference<PatchLmsInstructorRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchLmsInstructorRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchLmsInstructorResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchLmsInstructorResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchLmsInstructorResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchLmsInstructorResponse res = resBuilder.build();
