...
public class PatchAtsJob2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAtsJob2Request, PatchAtsJob2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAtsJob2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsJob2Request.class, new TypeReference<PatchAtsJob2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAtsJob2Request request) {
        ...
        @Override
        public PatchAtsJob2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAtsJob2Response.Builder resBuilder =
            ...
            PatchAtsJob2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAtsJob2Request, to.unified.unified_java_sdk.models.operations.async.PatchAtsJob2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAtsJob2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsJob2Request.class, new TypeReference<PatchAtsJob2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAtsJob2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAtsJob2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAtsJob2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAtsJob2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAtsJob2Response res = resBuilder.build();
