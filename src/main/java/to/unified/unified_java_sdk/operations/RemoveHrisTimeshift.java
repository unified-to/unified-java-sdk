...
public class RemoveHrisTimeshift {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisTimeshiftRequest, RemoveHrisTimeshiftResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisTimeshiftRequest request) throws Exception {
        ...
        @Override
        public RemoveHrisTimeshiftResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisTimeshiftResponse.Builder resBuilder =
            ...
            RemoveHrisTimeshiftResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisTimeshiftRequest, to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeshiftResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisTimeshiftRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisTimeshiftRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisTimeshiftRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeshiftResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeshiftResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeshiftResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeshiftResponse res = resBuilder.build();
