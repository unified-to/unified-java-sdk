...
public class ListCdpDestinations {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCdpDestinationsRequest, ListCdpDestinationsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCdpDestinationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCdpDestinationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCdpDestinationsRequest request) {
        ...
        @Override
        public ListCdpDestinationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCdpDestinationsResponse.Builder resBuilder =
            ...
            ListCdpDestinationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCdpDestinations(Utils.unmarshal(response, new TypeReference<List<CdpDestination>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCdpDestinationsRequest, to.unified.unified_java_sdk.models.operations.async.ListCdpDestinationsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCdpDestinationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCdpDestinationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCdpDestinationsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCdpDestinationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCdpDestinationsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCdpDestinationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCdpDestinationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CdpDestination>>() {})
                            .thenApply(res::withCdpDestinations);
                } else {
