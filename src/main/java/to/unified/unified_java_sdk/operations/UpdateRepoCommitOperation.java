...
public class UpdateRepoCommitOperation implements RequestOperation<UpdateRepoCommitRequest, UpdateRepoCommitResponse> {
    ...
    public UpdateRepoCommitOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateRepoCommitRequest request) throws Exception {
