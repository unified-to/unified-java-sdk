...
public class ListCalendarWebinars {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCalendarWebinarsRequest, ListCalendarWebinarsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCalendarWebinarsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarWebinarsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarWebinarsRequest request) {
        ...
        @Override
        public ListCalendarWebinarsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCalendarWebinarsResponse.Builder resBuilder =
            ...
            ListCalendarWebinarsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCalendarWebinarsRequest, to.unified.unified_java_sdk.models.operations.async.ListCalendarWebinarsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCalendarWebinarsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarWebinarsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCalendarWebinarsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCalendarWebinarsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCalendarWebinarsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCalendarWebinarsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCalendarWebinarsResponse res = resBuilder.build();
