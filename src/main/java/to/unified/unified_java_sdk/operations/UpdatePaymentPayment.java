...
public class UpdatePaymentPayment {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UpdatePaymentPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePaymentPaymentRequest.class, new TypeReference<UpdatePaymentPaymentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePaymentPaymentRequest request) {
        ...
        @Override
        public UpdatePaymentPaymentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatePaymentPaymentResponse.Builder resBuilder =
            ...
            UpdatePaymentPaymentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePaymentPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePaymentPaymentRequest.class, new TypeReference<UpdatePaymentPaymentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatePaymentPaymentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdatePaymentPaymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdatePaymentPaymentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdatePaymentPaymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdatePaymentPaymentResponse res = resBuilder.build();
