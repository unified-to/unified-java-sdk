...
public class ListLmsStudents {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsStudentsRequest request) throws Exception {
        ...
        @Override
        public ListLmsStudentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<LmsStudent> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withLmsStudents(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
