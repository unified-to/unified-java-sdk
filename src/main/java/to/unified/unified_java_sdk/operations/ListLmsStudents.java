...
public class ListLmsStudents {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListLmsStudentsRequest, ListLmsStudentsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListLmsStudentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsStudentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsStudentsRequest request) {
        ...
        @Override
        public ListLmsStudentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListLmsStudentsResponse.Builder resBuilder =
            ...
            ListLmsStudentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLmsStudentsRequest, to.unified.unified_java_sdk.models.operations.async.ListLmsStudentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListLmsStudentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsStudentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListLmsStudentsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListLmsStudentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListLmsStudentsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListLmsStudentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListLmsStudentsResponse res = resBuilder.build();
