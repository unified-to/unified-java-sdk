...
public class RemoveAtsDocumentOperation implements RequestOperation<RemoveAtsDocumentRequest, RemoveAtsDocumentResponse> {
    ...
    public RemoveAtsDocumentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAtsDocumentRequest request) throws Exception {
