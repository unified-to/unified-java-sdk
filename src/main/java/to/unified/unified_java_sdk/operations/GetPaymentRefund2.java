...
public class GetPaymentRefund2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPaymentRefund2Request, GetPaymentRefund2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPaymentRefund2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentRefund2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentRefund2Request request) {
        ...
        @Override
        public GetPaymentRefund2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPaymentRefund2Response.Builder resBuilder =
            ...
            GetPaymentRefund2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentRefund(Utils.unmarshal(response, new TypeReference<PaymentRefund>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentRefund2Request, to.unified.unified_java_sdk.models.operations.async.GetPaymentRefund2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPaymentRefund2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentRefund2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPaymentRefund2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetPaymentRefund2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetPaymentRefund2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetPaymentRefund2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetPaymentRefund2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaymentRefund>() {})
                            .thenApply(res::withPaymentRefund);
                } else {
