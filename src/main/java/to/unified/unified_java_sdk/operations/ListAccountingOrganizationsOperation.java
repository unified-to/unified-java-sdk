...
public class ListAccountingOrganizationsOperation implements RequestOperation<ListAccountingOrganizationsRequest, ListAccountingOrganizationsResponse> {
    ...
    public ListAccountingOrganizationsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAccountingOrganizationsRequest request) throws Exception {
