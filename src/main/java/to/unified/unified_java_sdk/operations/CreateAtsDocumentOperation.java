...
public class CreateAtsDocumentOperation implements RequestOperation<CreateAtsDocumentRequest, CreateAtsDocumentResponse> {
    ...
    public CreateAtsDocumentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAtsDocumentRequest request) throws Exception {
