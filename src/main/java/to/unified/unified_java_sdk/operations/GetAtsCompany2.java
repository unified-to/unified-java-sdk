...
public class GetAtsCompany2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAtsCompany2Request, GetAtsCompany2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAtsCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsCompany2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAtsCompany2Request request) {
        ...
        @Override
        public GetAtsCompany2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAtsCompany2Response.Builder resBuilder =
            ...
            GetAtsCompany2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAtsCompany2Request, to.unified.unified_java_sdk.models.operations.async.GetAtsCompany2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAtsCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsCompany2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAtsCompany2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAtsCompany2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAtsCompany2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAtsCompany2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAtsCompany2Response res = resBuilder.build();
