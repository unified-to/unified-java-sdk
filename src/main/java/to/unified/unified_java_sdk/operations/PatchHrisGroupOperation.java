...
public class PatchHrisGroupOperation implements RequestOperation<PatchHrisGroupRequest, PatchHrisGroupResponse> {
    ...
    public PatchHrisGroupOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchHrisGroupRequest request) throws Exception {
