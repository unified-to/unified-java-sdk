...
public class ListLmsInstructors2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListLmsInstructors2Request, ListLmsInstructors2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListLmsInstructors2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsInstructors2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsInstructors2Request request) {
        ...
        @Override
        public ListLmsInstructors2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListLmsInstructors2Response.Builder resBuilder =
            ...
            ListLmsInstructors2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLmsInstructors(Utils.unmarshal(response, new TypeReference<List<LmsInstructor>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLmsInstructors2Request, to.unified.unified_java_sdk.models.operations.async.ListLmsInstructors2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListLmsInstructors2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsInstructors2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListLmsInstructors2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListLmsInstructors2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListLmsInstructors2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListLmsInstructors2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListLmsInstructors2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<LmsInstructor>>() {})
                            .thenApply(res::withLmsInstructors);
                } else {
