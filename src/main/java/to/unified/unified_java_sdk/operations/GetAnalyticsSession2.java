...
public class GetAnalyticsSession2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAnalyticsSession2Request, GetAnalyticsSession2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAnalyticsSession2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAnalyticsSession2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAnalyticsSession2Request request) {
        ...
        @Override
        public GetAnalyticsSession2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAnalyticsSession2Response.Builder resBuilder =
            ...
            GetAnalyticsSession2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAnalyticsSession2Request, to.unified.unified_java_sdk.models.operations.async.GetAnalyticsSession2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAnalyticsSession2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAnalyticsSession2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAnalyticsSession2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAnalyticsSession2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAnalyticsSession2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAnalyticsSession2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAnalyticsSession2Response res = resBuilder.build();
