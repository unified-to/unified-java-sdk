...
public class RemoveRepoCommit {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveRepoCommitRequest, RemoveRepoCommitResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveRepoCommitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoCommitRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveRepoCommitRequest request) throws Exception {
        ...
        @Override
        public RemoveRepoCommitResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveRepoCommitResponse.Builder resBuilder =
            ...
            RemoveRepoCommitResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveRepoCommitRequest, to.unified.unified_java_sdk.models.operations.async.RemoveRepoCommitResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveRepoCommitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoCommitRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveRepoCommitRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveRepoCommitResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveRepoCommitResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveRepoCommitResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveRepoCommitResponse res = resBuilder.build();
