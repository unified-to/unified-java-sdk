...
public class CreateHrisBankaccount2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisBankaccount2Request, CreateHrisBankaccount2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisBankaccount2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisBankaccount2Request.class, new TypeReference<CreateHrisBankaccount2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisBankaccount2Request request) {
        ...
        @Override
        public CreateHrisBankaccount2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisBankaccount2Response.Builder resBuilder =
            ...
            CreateHrisBankaccount2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisBankaccount2Request, to.unified.unified_java_sdk.models.operations.async.CreateHrisBankaccount2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisBankaccount2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisBankaccount2Request.class, new TypeReference<CreateHrisBankaccount2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisBankaccount2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisBankaccount2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisBankaccount2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisBankaccount2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisBankaccount2Response res = resBuilder.build();
