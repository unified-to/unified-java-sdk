...
public class GetPerformanceCycle {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPerformanceCycleRequest, GetPerformanceCycleResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPerformanceCycleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPerformanceCycleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPerformanceCycleRequest request) {
        ...
        @Override
        public GetPerformanceCycleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPerformanceCycleResponse.Builder resBuilder =
            ...
            GetPerformanceCycleResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPerformanceCycle(Utils.unmarshal(response, new TypeReference<PerformanceCycle>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPerformanceCycleRequest, to.unified.unified_java_sdk.models.operations.async.GetPerformanceCycleResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPerformanceCycleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPerformanceCycleRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPerformanceCycleRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetPerformanceCycleResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetPerformanceCycleResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetPerformanceCycleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetPerformanceCycleResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PerformanceCycle>() {})
                            .thenApply(res::withPerformanceCycle);
                } else {
