...
public class GetCalendarWebinar {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCalendarWebinarRequest, GetCalendarWebinarResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCalendarWebinarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarWebinarRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCalendarWebinarRequest request) {
        ...
        @Override
        public GetCalendarWebinarResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCalendarWebinarResponse.Builder resBuilder =
            ...
            GetCalendarWebinarResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCalendarWebinarRequest, to.unified.unified_java_sdk.models.operations.async.GetCalendarWebinarResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCalendarWebinarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarWebinarRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCalendarWebinarRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCalendarWebinarResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCalendarWebinarResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCalendarWebinarResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCalendarWebinarResponse res = resBuilder.build();
