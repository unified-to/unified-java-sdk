...
public class RemoveAtsActivity {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAtsActivityRequest, RemoveAtsActivityResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAtsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsActivityRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAtsActivityRequest request) throws Exception {
        ...
        @Override
        public RemoveAtsActivityResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAtsActivityResponse.Builder resBuilder =
            ...
            RemoveAtsActivityResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAtsActivityRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAtsActivityResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAtsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsActivityRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAtsActivityRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAtsActivityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAtsActivityResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAtsActivityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAtsActivityResponse res = resBuilder.build();
