...
public class UpdateAtsInterviewOperation implements RequestOperation<UpdateAtsInterviewRequest, UpdateAtsInterviewResponse> {
    ...
    public UpdateAtsInterviewOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAtsInterviewRequest request) throws Exception {
