...
public class RemoveCrmPipeline {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCrmPipelineRequest, RemoveCrmPipelineResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCrmPipelineRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmPipelineRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCrmPipelineRequest request) throws Exception {
        ...
        @Override
        public RemoveCrmPipelineResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCrmPipelineResponse.Builder resBuilder =
            ...
            RemoveCrmPipelineResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCrmPipelineRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCrmPipelineResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCrmPipelineRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmPipelineRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCrmPipelineRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCrmPipelineResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCrmPipelineResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCrmPipelineResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCrmPipelineResponse res = resBuilder.build();
