...
public class CreateAtsJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAtsJobRequest, CreateAtsJobResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAtsJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsJobRequest.class, new TypeReference<CreateAtsJobRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsJobRequest request) {
        ...
        @Override
        public CreateAtsJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAtsJobResponse.Builder resBuilder =
            ...
            CreateAtsJobResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAtsJobRequest, to.unified.unified_java_sdk.models.operations.async.CreateAtsJobResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAtsJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsJobRequest.class, new TypeReference<CreateAtsJobRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAtsJobRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAtsJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAtsJobResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAtsJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAtsJobResponse res = resBuilder.build();
