...
public class RemoveKmsSpace {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveKmsSpaceRequest, RemoveKmsSpaceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveKmsSpaceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveKmsSpaceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveKmsSpaceRequest request) throws Exception {
        ...
        @Override
        public RemoveKmsSpaceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveKmsSpaceResponse.Builder resBuilder =
            ...
            RemoveKmsSpaceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveKmsSpaceRequest, to.unified.unified_java_sdk.models.operations.async.RemoveKmsSpaceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveKmsSpaceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveKmsSpaceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveKmsSpaceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveKmsSpaceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveKmsSpaceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveKmsSpaceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveKmsSpaceResponse res = resBuilder.build();
