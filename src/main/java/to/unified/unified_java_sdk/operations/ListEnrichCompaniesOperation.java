...
public class ListEnrichCompaniesOperation implements RequestOperation<ListEnrichCompaniesRequest, ListEnrichCompaniesResponse> {
    ...
    public ListEnrichCompaniesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListEnrichCompaniesRequest request) throws Exception {
