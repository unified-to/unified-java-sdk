...
public class RemoveUcContact2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveUcContact2Request, RemoveUcContact2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveUcContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUcContact2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveUcContact2Request request) {
        ...
        @Override
        public RemoveUcContact2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveUcContact2Response.Builder resBuilder =
            ...
            RemoveUcContact2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveUcContact2Request, to.unified.unified_java_sdk.models.operations.async.RemoveUcContact2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveUcContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUcContact2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveUcContact2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveUcContact2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveUcContact2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveUcContact2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveUcContact2Response res = resBuilder.build();
