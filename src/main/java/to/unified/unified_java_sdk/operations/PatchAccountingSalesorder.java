...
public class PatchAccountingSalesorder {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingSalesorderRequest, PatchAccountingSalesorderResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingSalesorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingSalesorderRequest.class, new TypeReference<PatchAccountingSalesorderRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingSalesorderRequest request) {
        ...
        @Override
        public PatchAccountingSalesorderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingSalesorderResponse.Builder resBuilder =
            ...
            PatchAccountingSalesorderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingSalesorderRequest, to.unified.unified_java_sdk.models.operations.async.PatchAccountingSalesorderResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingSalesorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingSalesorderRequest.class, new TypeReference<PatchAccountingSalesorderRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingSalesorderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingSalesorderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingSalesorderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingSalesorderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingSalesorderResponse res = resBuilder.build();
