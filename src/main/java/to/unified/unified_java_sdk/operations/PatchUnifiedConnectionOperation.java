...
public class PatchUnifiedConnectionOperation implements RequestOperation<PatchUnifiedConnectionRequest, PatchUnifiedConnectionResponse> {
    ...
    public PatchUnifiedConnectionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchUnifiedConnectionRequest request) throws Exception {
