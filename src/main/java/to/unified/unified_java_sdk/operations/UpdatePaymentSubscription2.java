...
public class UpdatePaymentSubscription2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatePaymentSubscription2Request, UpdatePaymentSubscription2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdatePaymentSubscription2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePaymentSubscription2Request.class, new TypeReference<UpdatePaymentSubscription2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePaymentSubscription2Request request) {
        ...
        @Override
        public UpdatePaymentSubscription2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatePaymentSubscription2Response.Builder resBuilder =
            ...
            UpdatePaymentSubscription2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatePaymentSubscription2Request, to.unified.unified_java_sdk.models.operations.async.UpdatePaymentSubscription2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePaymentSubscription2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePaymentSubscription2Request.class, new TypeReference<UpdatePaymentSubscription2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatePaymentSubscription2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdatePaymentSubscription2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdatePaymentSubscription2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdatePaymentSubscription2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdatePaymentSubscription2Response res = resBuilder.build();
