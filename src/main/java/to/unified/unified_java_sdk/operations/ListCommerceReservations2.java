...
public class ListCommerceReservations2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceReservations2Request, ListCommerceReservations2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommerceReservations2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceReservations2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceReservations2Request request) {
        ...
        @Override
        public ListCommerceReservations2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceReservations2Response.Builder resBuilder =
            ...
            ListCommerceReservations2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceReservations2Request, to.unified.unified_java_sdk.models.operations.async.ListCommerceReservations2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceReservations2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceReservations2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceReservations2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceReservations2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceReservations2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceReservations2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceReservations2Response res = resBuilder.build();
