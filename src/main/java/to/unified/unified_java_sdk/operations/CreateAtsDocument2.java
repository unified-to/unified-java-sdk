...
public class CreateAtsDocument2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAtsDocument2Request, CreateAtsDocument2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAtsDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsDocument2Request.class, new TypeReference<CreateAtsDocument2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsDocument2Request request) {
        ...
        @Override
        public CreateAtsDocument2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAtsDocument2Response.Builder resBuilder =
            ...
            CreateAtsDocument2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAtsDocument2Request, to.unified.unified_java_sdk.models.operations.async.CreateAtsDocument2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAtsDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsDocument2Request.class, new TypeReference<CreateAtsDocument2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAtsDocument2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAtsDocument2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAtsDocument2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAtsDocument2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAtsDocument2Response res = resBuilder.build();
