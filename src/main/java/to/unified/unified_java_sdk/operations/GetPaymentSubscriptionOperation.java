...
public class GetPaymentSubscriptionOperation implements RequestOperation<GetPaymentSubscriptionRequest, GetPaymentSubscriptionResponse> {
    ...
    public GetPaymentSubscriptionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetPaymentSubscriptionRequest request) throws Exception {
