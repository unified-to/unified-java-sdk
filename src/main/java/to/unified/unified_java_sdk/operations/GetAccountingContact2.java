...
public class GetAccountingContact2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingContact2Request, GetAccountingContact2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingContact2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingContact2Request request) {
        ...
        @Override
        public GetAccountingContact2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingContact2Response.Builder resBuilder =
            ...
            GetAccountingContact2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingContact2Request, to.unified.unified_java_sdk.models.operations.async.GetAccountingContact2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingContact2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingContact2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingContact2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingContact2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingContact2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingContact2Response res = resBuilder.build();
