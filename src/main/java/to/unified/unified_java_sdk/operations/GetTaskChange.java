...
public class GetTaskChange {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTaskChangeRequest, GetTaskChangeResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTaskChangeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskChangeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTaskChangeRequest request) {
        ...
        @Override
        public GetTaskChangeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTaskChangeResponse.Builder resBuilder =
            ...
            GetTaskChangeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTaskChangeRequest, to.unified.unified_java_sdk.models.operations.async.GetTaskChangeResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTaskChangeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskChangeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTaskChangeRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetTaskChangeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetTaskChangeResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetTaskChangeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetTaskChangeResponse res = resBuilder.build();
