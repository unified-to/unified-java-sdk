...
public class GetTaskChange {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTaskChangeRequest request) throws Exception {
        ...
        @Override
        public GetTaskChangeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TaskChange out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTaskChange(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
