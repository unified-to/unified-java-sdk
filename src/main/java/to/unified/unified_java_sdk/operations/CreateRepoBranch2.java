...
public class CreateRepoBranch2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateRepoBranch2Request, CreateRepoBranch2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateRepoBranch2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoBranch2Request.class, new TypeReference<CreateRepoBranch2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateRepoBranch2Request request) {
        ...
        @Override
        public CreateRepoBranch2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateRepoBranch2Response.Builder resBuilder =
            ...
            CreateRepoBranch2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateRepoBranch2Request, to.unified.unified_java_sdk.models.operations.async.CreateRepoBranch2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateRepoBranch2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoBranch2Request.class, new TypeReference<CreateRepoBranch2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateRepoBranch2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateRepoBranch2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateRepoBranch2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateRepoBranch2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateRepoBranch2Response res = resBuilder.build();
