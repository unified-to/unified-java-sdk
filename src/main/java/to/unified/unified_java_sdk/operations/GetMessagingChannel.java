...
public class GetMessagingChannel {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMessagingChannelRequest request) throws Exception {
        ...
        @Override
        public GetMessagingChannelResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MessagingChannel out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMessagingChannel(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
