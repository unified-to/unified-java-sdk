...
public class GetMessagingChannel {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMessagingChannelRequest, GetMessagingChannelResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMessagingChannelRequest request) {
        ...
        @Override
        public GetMessagingChannelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMessagingChannelResponse.Builder resBuilder =
            ...
            GetMessagingChannelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMessagingChannelRequest, to.unified.unified_java_sdk.models.operations.async.GetMessagingChannelResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMessagingChannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMessagingChannelRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMessagingChannelRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetMessagingChannelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetMessagingChannelResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetMessagingChannelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetMessagingChannelResponse res = resBuilder.build();
