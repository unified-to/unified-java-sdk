...
public class GetClubsActivity2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetClubsActivity2Request, GetClubsActivity2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetClubsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsActivity2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClubsActivity2Request request) {
        ...
        @Override
        public GetClubsActivity2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetClubsActivity2Response.Builder resBuilder =
            ...
            GetClubsActivity2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClubsActivity(Utils.unmarshal(response, new TypeReference<ClubsActivity>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetClubsActivity2Request, to.unified.unified_java_sdk.models.operations.async.GetClubsActivity2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetClubsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsActivity2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetClubsActivity2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetClubsActivity2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetClubsActivity2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetClubsActivity2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetClubsActivity2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ClubsActivity>() {})
                            .thenApply(res::withClubsActivity);
                } else {
