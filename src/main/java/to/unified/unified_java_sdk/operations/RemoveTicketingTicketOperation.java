...
public class RemoveTicketingTicketOperation implements RequestOperation<RemoveTicketingTicketRequest, RemoveTicketingTicketResponse> {
    ...
    public RemoveTicketingTicketOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveTicketingTicketRequest request) throws Exception {
