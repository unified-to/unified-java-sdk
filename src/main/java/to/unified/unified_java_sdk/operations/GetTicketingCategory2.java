...
public class GetTicketingCategory2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTicketingCategory2Request, GetTicketingCategory2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTicketingCategory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetTicketingCategory2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTicketingCategory2Request request) {
        ...
        @Override
        public GetTicketingCategory2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTicketingCategory2Response.Builder resBuilder =
            ...
            GetTicketingCategory2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTicketingCategory2Request, to.unified.unified_java_sdk.models.operations.async.GetTicketingCategory2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTicketingCategory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetTicketingCategory2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTicketingCategory2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetTicketingCategory2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetTicketingCategory2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetTicketingCategory2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetTicketingCategory2Response res = resBuilder.build();
