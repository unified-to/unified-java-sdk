...
public class GetLmsStudentOperation implements RequestOperation<GetLmsStudentRequest, GetLmsStudentResponse> {
    ...
    public GetLmsStudentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetLmsStudentRequest request) throws Exception {
