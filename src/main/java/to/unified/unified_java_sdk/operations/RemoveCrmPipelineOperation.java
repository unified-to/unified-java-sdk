...
public class RemoveCrmPipelineOperation implements RequestOperation<RemoveCrmPipelineRequest, RemoveCrmPipelineResponse> {
    ...
    public RemoveCrmPipelineOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveCrmPipelineRequest request) throws Exception {
