...
public class UpdateHrisLocation2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisLocation2Request, UpdateHrisLocation2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisLocation2Request.class, new TypeReference<UpdateHrisLocation2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisLocation2Request request) {
        ...
        @Override
        public UpdateHrisLocation2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisLocation2Response.Builder resBuilder =
            ...
            UpdateHrisLocation2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisLocation(Utils.unmarshal(response, new TypeReference<HrisLocation>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisLocation2Request, to.unified.unified_java_sdk.models.operations.async.UpdateHrisLocation2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisLocation2Request.class, new TypeReference<UpdateHrisLocation2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisLocation2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisLocation2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisLocation2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisLocation2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisLocation2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HrisLocation>() {})
                            .thenApply(res::withHrisLocation);
                } else {
