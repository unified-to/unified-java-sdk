...
public class RemoveAtsJobOperation implements RequestOperation<RemoveAtsJobRequest, RemoveAtsJobResponse> {
    ...
    public RemoveAtsJobOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAtsJobRequest request) throws Exception {
