...
public class GetAtsCandidate2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAtsCandidate2Request, GetAtsCandidate2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAtsCandidate2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsCandidate2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAtsCandidate2Request request) {
        ...
        @Override
        public GetAtsCandidate2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAtsCandidate2Response.Builder resBuilder =
            ...
            GetAtsCandidate2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAtsCandidate2Request, to.unified.unified_java_sdk.models.operations.async.GetAtsCandidate2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAtsCandidate2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsCandidate2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAtsCandidate2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAtsCandidate2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAtsCandidate2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAtsCandidate2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAtsCandidate2Response res = resBuilder.build();
