...
public class ListHrisBankaccounts {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisBankaccountsRequest, ListHrisBankaccountsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisBankaccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisBankaccountsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisBankaccountsRequest request) {
        ...
        @Override
        public ListHrisBankaccountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisBankaccountsResponse.Builder resBuilder =
            ...
            ListHrisBankaccountsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisBankaccountsRequest, to.unified.unified_java_sdk.models.operations.async.ListHrisBankaccountsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisBankaccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisBankaccountsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisBankaccountsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisBankaccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisBankaccountsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisBankaccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisBankaccountsResponse res = resBuilder.build();
