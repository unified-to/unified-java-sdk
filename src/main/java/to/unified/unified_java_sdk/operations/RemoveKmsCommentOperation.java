...
public class RemoveKmsCommentOperation implements RequestOperation<RemoveKmsCommentRequest, RemoveKmsCommentResponse> {
    ...
    public RemoveKmsCommentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveKmsCommentRequest request) throws Exception {
