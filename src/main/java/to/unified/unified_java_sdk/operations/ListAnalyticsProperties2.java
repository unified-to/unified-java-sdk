...
public class ListAnalyticsProperties2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAnalyticsProperties2Request, ListAnalyticsProperties2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAnalyticsProperties2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAnalyticsProperties2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAnalyticsProperties2Request request) {
        ...
        @Override
        public ListAnalyticsProperties2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAnalyticsProperties2Response.Builder resBuilder =
            ...
            ListAnalyticsProperties2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAnalyticsProperties(Utils.unmarshal(response, new TypeReference<List<AnalyticsProperty>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAnalyticsProperties2Request, to.unified.unified_java_sdk.models.operations.async.ListAnalyticsProperties2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAnalyticsProperties2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAnalyticsProperties2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAnalyticsProperties2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAnalyticsProperties2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAnalyticsProperties2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAnalyticsProperties2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAnalyticsProperties2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AnalyticsProperty>>() {})
                            .thenApply(res::withAnalyticsProperties);
                } else {
