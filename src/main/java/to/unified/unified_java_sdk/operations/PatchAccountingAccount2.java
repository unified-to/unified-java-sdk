...
public class PatchAccountingAccount2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingAccount2Request, PatchAccountingAccount2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingAccount2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingAccount2Request.class, new TypeReference<PatchAccountingAccount2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingAccount2Request request) {
        ...
        @Override
        public PatchAccountingAccount2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingAccount2Response.Builder resBuilder =
            ...
            PatchAccountingAccount2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingAccount2Request, to.unified.unified_java_sdk.models.operations.async.PatchAccountingAccount2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingAccount2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingAccount2Request.class, new TypeReference<PatchAccountingAccount2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingAccount2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingAccount2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingAccount2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingAccount2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingAccount2Response res = resBuilder.build();
