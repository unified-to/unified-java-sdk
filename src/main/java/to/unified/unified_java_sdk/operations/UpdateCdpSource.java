...
public class UpdateCdpSource {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCdpSourceRequest, UpdateCdpSourceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCdpSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCdpSourceRequest.class, new TypeReference<UpdateCdpSourceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCdpSourceRequest request) {
        ...
        @Override
        public UpdateCdpSourceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCdpSourceResponse.Builder resBuilder =
            ...
            UpdateCdpSourceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCdpSource(Utils.unmarshal(response, new TypeReference<CdpSource>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCdpSourceRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCdpSourceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCdpSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCdpSourceRequest.class, new TypeReference<UpdateCdpSourceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCdpSourceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCdpSourceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCdpSourceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCdpSourceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCdpSourceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CdpSource>() {})
                            .thenApply(res::withCdpSource);
                } else {
