...
public class RemoveMetadataMetadataOperation implements RequestOperation<RemoveMetadataMetadataRequest, RemoveMetadataMetadataResponse> {
    ...
    public RemoveMetadataMetadataOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveMetadataMetadataRequest request) throws Exception {
