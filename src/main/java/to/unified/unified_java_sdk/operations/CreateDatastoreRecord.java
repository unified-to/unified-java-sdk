...
public class CreateDatastoreRecord {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateDatastoreRecordRequest, CreateDatastoreRecordResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateDatastoreRecordRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDatastoreRecordRequest.class, new TypeReference<CreateDatastoreRecordRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDatastoreRecordRequest request) {
        ...
        @Override
        public CreateDatastoreRecordResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDatastoreRecordResponse.Builder resBuilder =
            ...
            CreateDatastoreRecordResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateDatastoreRecordRequest, to.unified.unified_java_sdk.models.operations.async.CreateDatastoreRecordResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateDatastoreRecordRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDatastoreRecordRequest.class, new TypeReference<CreateDatastoreRecordRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateDatastoreRecordRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateDatastoreRecordResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateDatastoreRecordResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateDatastoreRecordResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateDatastoreRecordResponse res = resBuilder.build();
