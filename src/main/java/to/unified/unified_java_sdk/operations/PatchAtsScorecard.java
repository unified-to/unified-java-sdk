...
public class PatchAtsScorecard {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAtsScorecardRequest, PatchAtsScorecardResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAtsScorecardRequest request) {
        ...
        @Override
        public PatchAtsScorecardResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAtsScorecardResponse.Builder resBuilder =
            ...
            PatchAtsScorecardResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAtsScorecardRequest, to.unified.unified_java_sdk.models.operations.async.PatchAtsScorecardResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAtsScorecardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsScorecardRequest.class, new TypeReference<PatchAtsScorecardRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAtsScorecardRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAtsScorecardResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAtsScorecardResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAtsScorecardResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAtsScorecardResponse res = resBuilder.build();
