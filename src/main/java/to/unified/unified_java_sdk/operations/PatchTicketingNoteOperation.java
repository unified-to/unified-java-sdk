...
public class PatchTicketingNoteOperation implements RequestOperation<PatchTicketingNoteRequest, PatchTicketingNoteResponse> {
    ...
    public PatchTicketingNoteOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchTicketingNoteRequest request) throws Exception {
