...
public class ListAccountingContactsOperation implements RequestOperation<ListAccountingContactsRequest, ListAccountingContactsResponse> {
    ...
    public ListAccountingContactsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAccountingContactsRequest request) throws Exception {
