...
public class PatchUnifiedWebhookOperation implements RequestOperation<PatchUnifiedWebhookRequest, PatchUnifiedWebhookResponse> {
    ...
    public PatchUnifiedWebhookOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchUnifiedWebhookRequest request) throws Exception {
