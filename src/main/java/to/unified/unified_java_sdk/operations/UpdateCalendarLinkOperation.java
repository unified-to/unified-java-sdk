...
public class UpdateCalendarLinkOperation implements RequestOperation<UpdateCalendarLinkRequest, UpdateCalendarLinkResponse> {
    ...
    public UpdateCalendarLinkOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateCalendarLinkRequest request) throws Exception {
