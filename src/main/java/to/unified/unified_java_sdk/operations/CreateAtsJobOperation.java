...
public class CreateAtsJobOperation implements RequestOperation<CreateAtsJobRequest, CreateAtsJobResponse> {
    ...
    public CreateAtsJobOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAtsJobRequest request) throws Exception {
