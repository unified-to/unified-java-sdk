...
public class ListCalendarRecordingsOperation implements RequestOperation<ListCalendarRecordingsRequest, ListCalendarRecordingsResponse> {
    ...
    public ListCalendarRecordingsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCalendarRecordingsRequest request) throws Exception {
