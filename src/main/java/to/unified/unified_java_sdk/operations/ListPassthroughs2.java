...
public class ListPassthroughs2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPassthroughs2Request, ListPassthroughs2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPassthroughs2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListPassthroughs2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPassthroughs2Request request) {
        ...
        @Override
        public ListPassthroughs2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPassthroughs2Response.Builder resBuilder =
            ...
            ListPassthroughs2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPassthroughs2Request, to.unified.unified_java_sdk.models.operations.async.ListPassthroughs2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPassthroughs2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListPassthroughs2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPassthroughs2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListPassthroughs2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListPassthroughs2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListPassthroughs2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            to.unified.unified_java_sdk.models.operations.async.ListPassthroughs2Response res = resBuilder.build();
