...
public class PatchAccountingExpense {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingExpenseRequest, PatchAccountingExpenseResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingExpenseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingExpenseRequest.class, new TypeReference<PatchAccountingExpenseRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingExpenseRequest request) {
        ...
        @Override
        public PatchAccountingExpenseResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingExpenseResponse.Builder resBuilder =
            ...
            PatchAccountingExpenseResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingExpenseRequest, to.unified.unified_java_sdk.models.operations.async.PatchAccountingExpenseResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingExpenseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingExpenseRequest.class, new TypeReference<PatchAccountingExpenseRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingExpenseRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingExpenseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingExpenseResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingExpenseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingExpenseResponse res = resBuilder.build();
