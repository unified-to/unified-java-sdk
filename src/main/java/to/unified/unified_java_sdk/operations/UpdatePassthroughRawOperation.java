...
public class UpdatePassthroughRawOperation implements RequestOperation<UpdatePassthroughRawRequest, UpdatePassthroughRawResponse> {
    ...
    public UpdatePassthroughRawOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdatePassthroughRawRequest request) throws Exception {
