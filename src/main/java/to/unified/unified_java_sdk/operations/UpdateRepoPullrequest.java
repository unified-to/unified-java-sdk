...
public class UpdateRepoPullrequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateRepoPullrequestRequest, UpdateRepoPullrequestResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateRepoPullrequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoPullrequestRequest.class, new TypeReference<UpdateRepoPullrequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateRepoPullrequestRequest request) {
        ...
        @Override
        public UpdateRepoPullrequestResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateRepoPullrequestRequest, to.unified.unified_java_sdk.models.operations.async.UpdateRepoPullrequestResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateRepoPullrequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoPullrequestRequest.class, new TypeReference<UpdateRepoPullrequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateRepoPullrequestRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateRepoPullrequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateRepoPullrequestResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateRepoPullrequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateRepoPullrequestResponse res = resBuilder.build();
