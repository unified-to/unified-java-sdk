...
public class UpdateHrisBankaccount2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisBankaccount2Request, UpdateHrisBankaccount2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisBankaccount2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisBankaccount2Request.class, new TypeReference<UpdateHrisBankaccount2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisBankaccount2Request request) {
        ...
        @Override
        public UpdateHrisBankaccount2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisBankaccount2Response.Builder resBuilder =
            ...
            UpdateHrisBankaccount2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisBankaccount(Utils.unmarshal(response, new TypeReference<HrisBankaccount>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisBankaccount2Request, to.unified.unified_java_sdk.models.operations.async.UpdateHrisBankaccount2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisBankaccount2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisBankaccount2Request.class, new TypeReference<UpdateHrisBankaccount2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisBankaccount2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisBankaccount2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisBankaccount2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisBankaccount2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisBankaccount2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HrisBankaccount>() {})
                            .thenApply(res::withHrisBankaccount);
                } else {
