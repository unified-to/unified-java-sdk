...
public class UpdateAtsApplication {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAtsApplicationRequest, UpdateAtsApplicationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAtsApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsApplicationRequest.class, new TypeReference<UpdateAtsApplicationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsApplicationRequest request) {
        ...
        @Override
        public UpdateAtsApplicationResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAtsApplicationRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAtsApplicationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAtsApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsApplicationRequest.class, new TypeReference<UpdateAtsApplicationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAtsApplicationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAtsApplicationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAtsApplicationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAtsApplicationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAtsApplicationResponse res = resBuilder.build();
