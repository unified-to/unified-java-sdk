...
public class PatchAccountingJournal2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingJournal2Request, PatchAccountingJournal2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingJournal2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingJournal2Request.class, new TypeReference<PatchAccountingJournal2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingJournal2Request request) {
        ...
        @Override
        public PatchAccountingJournal2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingJournal2Response.Builder resBuilder =
            ...
            PatchAccountingJournal2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingJournal2Request, to.unified.unified_java_sdk.models.operations.async.PatchAccountingJournal2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingJournal2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingJournal2Request.class, new TypeReference<PatchAccountingJournal2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingJournal2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingJournal2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingJournal2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingJournal2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingJournal2Response res = resBuilder.build();
