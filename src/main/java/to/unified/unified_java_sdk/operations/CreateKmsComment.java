...
public class CreateKmsComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateKmsCommentRequest, CreateKmsCommentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateKmsCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateKmsCommentRequest.class, new TypeReference<CreateKmsCommentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateKmsCommentRequest request) {
        ...
        @Override
        public CreateKmsCommentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateKmsCommentResponse.Builder resBuilder =
            ...
            CreateKmsCommentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateKmsCommentRequest, to.unified.unified_java_sdk.models.operations.async.CreateKmsCommentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateKmsCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateKmsCommentRequest.class, new TypeReference<CreateKmsCommentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateKmsCommentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateKmsCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateKmsCommentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateKmsCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateKmsCommentResponse res = resBuilder.build();
