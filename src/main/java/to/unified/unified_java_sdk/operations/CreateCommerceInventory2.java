...
public class CreateCommerceInventory2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommerceInventory2Request, CreateCommerceInventory2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommerceInventory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceInventory2Request.class, new TypeReference<CreateCommerceInventory2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceInventory2Request request) {
        ...
        @Override
        public CreateCommerceInventory2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommerceInventory2Response.Builder resBuilder =
            ...
            CreateCommerceInventory2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommerceInventory2Request, to.unified.unified_java_sdk.models.operations.async.CreateCommerceInventory2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommerceInventory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceInventory2Request.class, new TypeReference<CreateCommerceInventory2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommerceInventory2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCommerceInventory2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCommerceInventory2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCommerceInventory2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCommerceInventory2Response res = resBuilder.build();
