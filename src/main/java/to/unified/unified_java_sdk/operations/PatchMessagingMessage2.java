...
public class PatchMessagingMessage2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchMessagingMessage2Request, PatchMessagingMessage2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchMessagingMessage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMessagingMessage2Request.class, new TypeReference<PatchMessagingMessage2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchMessagingMessage2Request request) {
        ...
        @Override
        public PatchMessagingMessage2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchMessagingMessage2Response.Builder resBuilder =
            ...
            PatchMessagingMessage2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchMessagingMessage2Request, to.unified.unified_java_sdk.models.operations.async.PatchMessagingMessage2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchMessagingMessage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMessagingMessage2Request.class, new TypeReference<PatchMessagingMessage2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchMessagingMessage2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchMessagingMessage2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchMessagingMessage2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchMessagingMessage2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchMessagingMessage2Response res = resBuilder.build();
