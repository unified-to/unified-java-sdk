...
public class UpdateTicketingNoteOperation implements RequestOperation<UpdateTicketingNoteRequest, UpdateTicketingNoteResponse> {
    ...
    public UpdateTicketingNoteOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateTicketingNoteRequest request) throws Exception {
