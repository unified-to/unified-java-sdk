...
public class CreateRepoPullrequest2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateRepoPullrequest2Request, CreateRepoPullrequest2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateRepoPullrequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoPullrequest2Request.class, new TypeReference<CreateRepoPullrequest2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateRepoPullrequest2Request request) {
        ...
        @Override
        public CreateRepoPullrequest2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateRepoPullrequest2Response.Builder resBuilder =
            ...
            CreateRepoPullrequest2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateRepoPullrequest2Request, to.unified.unified_java_sdk.models.operations.async.CreateRepoPullrequest2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateRepoPullrequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoPullrequest2Request.class, new TypeReference<CreateRepoPullrequest2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateRepoPullrequest2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateRepoPullrequest2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateRepoPullrequest2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateRepoPullrequest2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateRepoPullrequest2Response res = resBuilder.build();
