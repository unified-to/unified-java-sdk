...
public class UpdateHrisEmployee2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisEmployee2Request, UpdateHrisEmployee2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisEmployee2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisEmployee2Request.class, new TypeReference<UpdateHrisEmployee2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisEmployee2Request request) {
        ...
        @Override
        public UpdateHrisEmployee2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisEmployee2Response.Builder resBuilder =
            ...
            UpdateHrisEmployee2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisEmployee(Utils.unmarshal(response, new TypeReference<HrisEmployee>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisEmployee2Request, to.unified.unified_java_sdk.models.operations.async.UpdateHrisEmployee2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisEmployee2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisEmployee2Request.class, new TypeReference<UpdateHrisEmployee2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisEmployee2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisEmployee2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisEmployee2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisEmployee2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisEmployee2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HrisEmployee>() {})
                            .thenApply(res::withHrisEmployee);
                } else {
