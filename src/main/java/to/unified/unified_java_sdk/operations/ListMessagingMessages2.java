...
public class ListMessagingMessages2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMessagingMessages2Request, ListMessagingMessages2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListMessagingMessages2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListMessagingMessages2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMessagingMessages2Request request) {
        ...
        @Override
        public ListMessagingMessages2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMessagingMessages2Response.Builder resBuilder =
            ...
            ListMessagingMessages2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMessagingMessages(Utils.unmarshal(response, new TypeReference<List<MessagingMessage>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMessagingMessages2Request, to.unified.unified_java_sdk.models.operations.async.ListMessagingMessages2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMessagingMessages2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListMessagingMessages2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMessagingMessages2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListMessagingMessages2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListMessagingMessages2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListMessagingMessages2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListMessagingMessages2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<MessagingMessage>>() {})
                            .thenApply(res::withMessagingMessages);
                } else {
