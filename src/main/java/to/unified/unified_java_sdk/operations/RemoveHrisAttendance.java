...
public class RemoveHrisAttendance {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisAttendanceRequest, RemoveHrisAttendanceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisAttendanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisAttendanceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisAttendanceRequest request) {
        ...
        @Override
        public RemoveHrisAttendanceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisAttendanceResponse.Builder resBuilder =
            ...
            RemoveHrisAttendanceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisAttendanceRequest, to.unified.unified_java_sdk.models.operations.async.RemoveHrisAttendanceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisAttendanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisAttendanceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisAttendanceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisAttendanceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisAttendanceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisAttendanceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisAttendanceResponse res = resBuilder.build();
