...
public class PatchSigningSignatory {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchSigningSignatoryRequest, PatchSigningSignatoryResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchSigningSignatoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchSigningSignatoryRequest.class, new TypeReference<PatchSigningSignatoryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchSigningSignatoryRequest request) {
        ...
        @Override
        public PatchSigningSignatoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchSigningSignatoryResponse.Builder resBuilder =
            ...
            PatchSigningSignatoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchSigningSignatoryRequest, to.unified.unified_java_sdk.models.operations.async.PatchSigningSignatoryResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchSigningSignatoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchSigningSignatoryRequest.class, new TypeReference<PatchSigningSignatoryRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchSigningSignatoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchSigningSignatoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchSigningSignatoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchSigningSignatoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchSigningSignatoryResponse res = resBuilder.build();
