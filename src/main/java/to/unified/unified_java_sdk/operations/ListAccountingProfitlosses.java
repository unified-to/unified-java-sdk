...
public class ListAccountingProfitlosses {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountingProfitlossesRequest request) throws Exception {
        ...
        @Override
        public ListAccountingProfitlossesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AccountingProfitloss> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingProfitlosses(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
