...
public class UpdateTaskTask2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTaskTask2Request, UpdateTaskTask2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTaskTask2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTaskTask2Request.class, new TypeReference<UpdateTaskTask2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTaskTask2Request request) {
        ...
        @Override
        public UpdateTaskTask2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTaskTask2Response.Builder resBuilder =
            ...
            UpdateTaskTask2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateTaskTask2Request, to.unified.unified_java_sdk.models.operations.async.UpdateTaskTask2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateTaskTask2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTaskTask2Request.class, new TypeReference<UpdateTaskTask2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateTaskTask2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateTaskTask2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateTaskTask2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateTaskTask2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateTaskTask2Response res = resBuilder.build();
