...
public class ListAccountingBalancesheets {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountingBalancesheetsRequest request) throws Exception {
        ...
        @Override
        public ListAccountingBalancesheetsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AccountingBalancesheet> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingBalancesheets(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
