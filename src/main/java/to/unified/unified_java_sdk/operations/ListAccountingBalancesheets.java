...
public class ListAccountingBalancesheets {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAccountingBalancesheetsRequest, ListAccountingBalancesheetsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAccountingBalancesheetsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAccountingBalancesheetsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountingBalancesheetsRequest request) {
        ...
        @Override
        public ListAccountingBalancesheetsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAccountingBalancesheetsResponse.Builder resBuilder =
            ...
            ListAccountingBalancesheetsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAccountingBalancesheetsRequest, to.unified.unified_java_sdk.models.operations.async.ListAccountingBalancesheetsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAccountingBalancesheetsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAccountingBalancesheetsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAccountingBalancesheetsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAccountingBalancesheetsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAccountingBalancesheetsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAccountingBalancesheetsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAccountingBalancesheetsResponse res = resBuilder.build();
