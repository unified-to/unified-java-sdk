...
public class GetCommerceSaleschannel {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceSaleschannelRequest, GetCommerceSaleschannelResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommerceSaleschannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceSaleschannelRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceSaleschannelRequest request) {
        ...
        @Override
        public GetCommerceSaleschannelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommerceSaleschannelResponse.Builder resBuilder =
            ...
            GetCommerceSaleschannelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommerceSaleschannelRequest, to.unified.unified_java_sdk.models.operations.async.GetCommerceSaleschannelResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommerceSaleschannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceSaleschannelRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommerceSaleschannelRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCommerceSaleschannelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCommerceSaleschannelResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCommerceSaleschannelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCommerceSaleschannelResponse res = resBuilder.build();
