...
public class ListCrmCompanies2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCrmCompanies2Request, ListCrmCompanies2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCrmCompanies2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmCompanies2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmCompanies2Request request) {
        ...
        @Override
        public ListCrmCompanies2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCrmCompanies2Response.Builder resBuilder =
            ...
            ListCrmCompanies2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCrmCompanies(Utils.unmarshal(response, new TypeReference<List<CrmCompany>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCrmCompanies2Request, to.unified.unified_java_sdk.models.operations.async.ListCrmCompanies2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCrmCompanies2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmCompanies2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCrmCompanies2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCrmCompanies2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCrmCompanies2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCrmCompanies2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCrmCompanies2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CrmCompany>>() {})
                            .thenApply(res::withCrmCompanies);
                } else {
