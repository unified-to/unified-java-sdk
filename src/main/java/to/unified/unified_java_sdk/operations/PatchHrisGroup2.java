...
public class PatchHrisGroup2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisGroup2Request, PatchHrisGroup2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisGroup2Request.class, new TypeReference<PatchHrisGroup2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisGroup2Request request) {
        ...
        @Override
        public PatchHrisGroup2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisGroup2Response.Builder resBuilder =
            ...
            PatchHrisGroup2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisGroup2Request, to.unified.unified_java_sdk.models.operations.async.PatchHrisGroup2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisGroup2Request.class, new TypeReference<PatchHrisGroup2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisGroup2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisGroup2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisGroup2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisGroup2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisGroup2Response res = resBuilder.build();
