...
public class PatchStorageFile {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchStorageFileRequest, PatchStorageFileResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchStorageFileRequest request) {
        ...
        @Override
        public PatchStorageFileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchStorageFileResponse.Builder resBuilder =
            ...
            PatchStorageFileResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchStorageFileRequest, to.unified.unified_java_sdk.models.operations.async.PatchStorageFileResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchStorageFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchStorageFileRequest.class, new TypeReference<PatchStorageFileRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchStorageFileRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchStorageFileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchStorageFileResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchStorageFileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchStorageFileResponse res = resBuilder.build();
