...
public class CreateCrmLead2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCrmLead2Request, CreateCrmLead2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCrmLead2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmLead2Request.class, new TypeReference<CreateCrmLead2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCrmLead2Request request) {
        ...
        @Override
        public CreateCrmLead2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCrmLead2Response.Builder resBuilder =
            ...
            CreateCrmLead2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCrmLead2Request, to.unified.unified_java_sdk.models.operations.async.CreateCrmLead2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCrmLead2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmLead2Request.class, new TypeReference<CreateCrmLead2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCrmLead2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCrmLead2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCrmLead2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCrmLead2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCrmLead2Response res = resBuilder.build();
