...
public class ListRepoPullrequests2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRepoPullrequests2Request, ListRepoPullrequests2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListRepoPullrequests2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoPullrequests2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRepoPullrequests2Request request) {
        ...
        @Override
        public ListRepoPullrequests2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListRepoPullrequests2Response.Builder resBuilder =
            ...
            ListRepoPullrequests2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRepoPullrequests(Utils.unmarshal(response, new TypeReference<List<RepoPullrequest>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListRepoPullrequests2Request, to.unified.unified_java_sdk.models.operations.async.ListRepoPullrequests2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListRepoPullrequests2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoPullrequests2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRepoPullrequests2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListRepoPullrequests2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListRepoPullrequests2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListRepoPullrequests2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListRepoPullrequests2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<RepoPullrequest>>() {})
                            .thenApply(res::withRepoPullrequests);
                } else {
