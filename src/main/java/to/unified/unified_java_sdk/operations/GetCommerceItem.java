...
public class GetCommerceItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceItemRequest, GetCommerceItemResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommerceItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceItemRequest request) {
        ...
        @Override
        public GetCommerceItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommerceItemResponse.Builder resBuilder =
            ...
            GetCommerceItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommerceItemRequest, to.unified.unified_java_sdk.models.operations.async.GetCommerceItemResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommerceItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommerceItemRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCommerceItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCommerceItemResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCommerceItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCommerceItemResponse res = resBuilder.build();
