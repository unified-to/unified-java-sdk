...
public class RemoveLmsInstructor2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveLmsInstructor2Request, RemoveLmsInstructor2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveLmsInstructor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsInstructor2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveLmsInstructor2Request request) {
        ...
        @Override
        public RemoveLmsInstructor2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveLmsInstructor2Response.Builder resBuilder =
            ...
            RemoveLmsInstructor2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveLmsInstructor2Request, to.unified.unified_java_sdk.models.operations.async.RemoveLmsInstructor2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveLmsInstructor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsInstructor2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveLmsInstructor2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveLmsInstructor2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveLmsInstructor2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveLmsInstructor2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveLmsInstructor2Response res = resBuilder.build();
