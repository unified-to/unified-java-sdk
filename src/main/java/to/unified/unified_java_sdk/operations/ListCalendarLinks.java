...
public class ListCalendarLinks {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarLinksRequest request) throws Exception {
        ...
        @Override
        public ListCalendarLinksResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CalendarLink> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCalendarLinks(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
