...
public class ListCalendarLinks {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCalendarLinksRequest, ListCalendarLinksResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCalendarLinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarLinksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarLinksRequest request) {
        ...
        @Override
        public ListCalendarLinksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCalendarLinksResponse.Builder resBuilder =
            ...
            ListCalendarLinksResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCalendarLinksRequest, to.unified.unified_java_sdk.models.operations.async.ListCalendarLinksResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCalendarLinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarLinksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCalendarLinksRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCalendarLinksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCalendarLinksResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCalendarLinksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCalendarLinksResponse res = resBuilder.build();
