...
public class RemoveAtsCandidateOperation implements RequestOperation<RemoveAtsCandidateRequest, RemoveAtsCandidateResponse> {
    ...
    public RemoveAtsCandidateOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAtsCandidateRequest request) throws Exception {
