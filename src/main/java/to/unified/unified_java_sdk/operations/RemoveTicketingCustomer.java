...
public class RemoveTicketingCustomer {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveTicketingCustomerRequest, RemoveTicketingCustomerResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveTicketingCustomerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTicketingCustomerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveTicketingCustomerRequest request) throws Exception {
        ...
        @Override
        public RemoveTicketingCustomerResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveTicketingCustomerResponse.Builder resBuilder =
            ...
            RemoveTicketingCustomerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveTicketingCustomerRequest, to.unified.unified_java_sdk.models.operations.async.RemoveTicketingCustomerResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveTicketingCustomerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTicketingCustomerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveTicketingCustomerRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveTicketingCustomerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveTicketingCustomerResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveTicketingCustomerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveTicketingCustomerResponse res = resBuilder.build();
