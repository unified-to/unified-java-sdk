...
public class CreateKmsPageOperation implements RequestOperation<CreateKmsPageRequest, CreateKmsPageResponse> {
    ...
    public CreateKmsPageOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateKmsPageRequest request) throws Exception {
