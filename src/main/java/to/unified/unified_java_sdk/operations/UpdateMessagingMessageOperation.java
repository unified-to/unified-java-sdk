...
public class UpdateMessagingMessageOperation implements RequestOperation<UpdateMessagingMessageRequest, UpdateMessagingMessageResponse> {
    ...
    public UpdateMessagingMessageOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateMessagingMessageRequest request) throws Exception {
