...
public class GetClubsActivity {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetClubsActivityRequest, GetClubsActivityResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetClubsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsActivityRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClubsActivityRequest request) {
        ...
        @Override
        public GetClubsActivityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetClubsActivityResponse.Builder resBuilder =
            ...
            GetClubsActivityResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetClubsActivityRequest, to.unified.unified_java_sdk.models.operations.async.GetClubsActivityResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetClubsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsActivityRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetClubsActivityRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetClubsActivityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetClubsActivityResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetClubsActivityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetClubsActivityResponse res = resBuilder.build();
