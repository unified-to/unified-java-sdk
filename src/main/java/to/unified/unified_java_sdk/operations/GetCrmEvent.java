...
public class GetCrmEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCrmEventRequest, GetCrmEventResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCrmEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmEventRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCrmEventRequest request) {
        ...
        @Override
        public GetCrmEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCrmEventResponse.Builder resBuilder =
                    GetCrmEventResponse
                            .builder()
            ...
            GetCrmEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCrmEventRequest, to.unified.unified_java_sdk.models.operations.async.GetCrmEventResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCrmEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmEventRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCrmEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCrmEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCrmEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCrmEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCrmEventResponse res = resBuilder.build();
