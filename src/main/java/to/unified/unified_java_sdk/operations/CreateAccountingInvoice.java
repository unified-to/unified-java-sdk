...
public class CreateAccountingInvoice {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAccountingInvoiceRequest, CreateAccountingInvoiceResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingInvoiceRequest request) {
        ...
        @Override
        public CreateAccountingInvoiceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAccountingInvoiceResponse.Builder resBuilder =
            ...
            CreateAccountingInvoiceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAccountingInvoiceRequest, to.unified.unified_java_sdk.models.operations.async.CreateAccountingInvoiceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAccountingInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingInvoiceRequest.class, new TypeReference<CreateAccountingInvoiceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAccountingInvoiceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAccountingInvoiceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAccountingInvoiceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAccountingInvoiceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAccountingInvoiceResponse res = resBuilder.build();
