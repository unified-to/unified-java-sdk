...
public class CreateAnalyticsEvent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAnalyticsEvent2Request, CreateAnalyticsEvent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAnalyticsEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAnalyticsEvent2Request.class, new TypeReference<CreateAnalyticsEvent2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAnalyticsEvent2Request request) {
        ...
        @Override
        public CreateAnalyticsEvent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAnalyticsEvent2Response.Builder resBuilder =
            ...
            CreateAnalyticsEvent2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAnalyticsEvent(Utils.unmarshal(response, new TypeReference<AnalyticsEvent>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAnalyticsEvent2Request, to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsEvent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAnalyticsEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAnalyticsEvent2Request.class, new TypeReference<CreateAnalyticsEvent2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAnalyticsEvent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsEvent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsEvent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsEvent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAnalyticsEvent2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AnalyticsEvent>() {})
                            .thenApply(res::withAnalyticsEvent);
                } else {
