...
public class UpdateAccountingContactOperation implements RequestOperation<UpdateAccountingContactRequest, UpdateAccountingContactResponse> {
    ...
    public UpdateAccountingContactOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAccountingContactRequest request) throws Exception {
