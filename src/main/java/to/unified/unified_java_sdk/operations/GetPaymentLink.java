...
public class GetPaymentLink {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentLinkRequest, to.unified.unified_java_sdk.models.operations.async.GetPaymentLinkResponse> {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetPaymentLinkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetPaymentLinkResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetPaymentLinkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetPaymentLinkResponse res = resBuilder.build();
