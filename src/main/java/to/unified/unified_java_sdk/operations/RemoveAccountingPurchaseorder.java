...
public class RemoveAccountingPurchaseorder {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingPurchaseorderRequest, RemoveAccountingPurchaseorderResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingPurchaseorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingPurchaseorderRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingPurchaseorderRequest request) throws Exception {
        ...
        @Override
        public RemoveAccountingPurchaseorderResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingPurchaseorderResponse.Builder resBuilder =
            ...
            RemoveAccountingPurchaseorderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingPurchaseorderRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingPurchaseorderResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingPurchaseorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingPurchaseorderRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingPurchaseorderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingPurchaseorderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingPurchaseorderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingPurchaseorderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingPurchaseorderResponse res = resBuilder.build();
