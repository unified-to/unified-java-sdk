...
public class ListCrmLeads2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCrmLeads2Request, ListCrmLeads2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCrmLeads2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmLeads2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmLeads2Request request) {
        ...
        @Override
        public ListCrmLeads2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCrmLeads2Response.Builder resBuilder =
            ...
            ListCrmLeads2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCrmLeads(Utils.unmarshal(response, new TypeReference<List<CrmLead>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCrmLeads2Request, to.unified.unified_java_sdk.models.operations.async.ListCrmLeads2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCrmLeads2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmLeads2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCrmLeads2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCrmLeads2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCrmLeads2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCrmLeads2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCrmLeads2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CrmLead>>() {})
                            .thenApply(res::withCrmLeads);
                } else {
