...
public class PatchCommerceReviewOperation implements RequestOperation<PatchCommerceReviewRequest, PatchCommerceReviewResponse> {
    ...
    public PatchCommerceReviewOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchCommerceReviewRequest request) throws Exception {
