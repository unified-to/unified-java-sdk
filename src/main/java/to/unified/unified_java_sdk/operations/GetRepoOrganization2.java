...
public class GetRepoOrganization2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRepoOrganization2Request, GetRepoOrganization2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRepoOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoOrganization2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRepoOrganization2Request request) {
        ...
        @Override
        public GetRepoOrganization2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRepoOrganization2Response.Builder resBuilder =
            ...
            GetRepoOrganization2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRepoOrganization2Request, to.unified.unified_java_sdk.models.operations.async.GetRepoOrganization2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRepoOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoOrganization2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRepoOrganization2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetRepoOrganization2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetRepoOrganization2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetRepoOrganization2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetRepoOrganization2Response res = resBuilder.build();
