...
public class GetAccountingPurchaseorder {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingPurchaseorderRequest, GetAccountingPurchaseorderResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingPurchaseorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingPurchaseorderRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingPurchaseorderRequest request) {
        ...
        @Override
        public GetAccountingPurchaseorderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingPurchaseorderResponse.Builder resBuilder =
            ...
            GetAccountingPurchaseorderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingPurchaseorderRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingPurchaseorderResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingPurchaseorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingPurchaseorderRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingPurchaseorderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingPurchaseorderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingPurchaseorderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingPurchaseorderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingPurchaseorderResponse res = resBuilder.build();
