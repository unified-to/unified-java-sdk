...
public class CreateCrmEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCrmEventRequest, CreateCrmEventResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCrmEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmEventRequest.class, new TypeReference<CreateCrmEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCrmEventRequest request) {
        ...
        @Override
        public CreateCrmEventResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCrmEventRequest, to.unified.unified_java_sdk.models.operations.async.CreateCrmEventResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCrmEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmEventRequest.class, new TypeReference<CreateCrmEventRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCrmEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCrmEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCrmEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCrmEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCrmEventResponse res = resBuilder.build();
