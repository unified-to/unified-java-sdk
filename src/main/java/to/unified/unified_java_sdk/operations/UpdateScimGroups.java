...
public class UpdateScimGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateScimGroupsRequest, UpdateScimGroupsResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateScimGroupsRequest request) {
        ...
        @Override
        public UpdateScimGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateScimGroupsResponse.Builder resBuilder =
            ...
            UpdateScimGroupsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateScimGroupsRequest, to.unified.unified_java_sdk.models.operations.async.UpdateScimGroupsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateScimGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateScimGroupsRequest.class, new TypeReference<UpdateScimGroupsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateScimGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateScimGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateScimGroupsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateScimGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateScimGroupsResponse res = resBuilder.build();
