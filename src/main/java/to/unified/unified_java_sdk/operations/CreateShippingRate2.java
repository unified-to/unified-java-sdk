...
public class CreateShippingRate2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateShippingRate2Request, CreateShippingRate2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateShippingRate2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateShippingRate2Request.class, new TypeReference<CreateShippingRate2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateShippingRate2Request request) {
        ...
        @Override
        public CreateShippingRate2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateShippingRate2Response.Builder resBuilder =
            ...
            CreateShippingRate2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withShippingRate(Utils.unmarshal(response, new TypeReference<ShippingRate>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateShippingRate2Request, to.unified.unified_java_sdk.models.operations.async.CreateShippingRate2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateShippingRate2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateShippingRate2Request.class, new TypeReference<CreateShippingRate2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateShippingRate2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateShippingRate2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateShippingRate2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateShippingRate2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateShippingRate2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ShippingRate>() {})
                            .thenApply(res::withShippingRate);
                } else {
