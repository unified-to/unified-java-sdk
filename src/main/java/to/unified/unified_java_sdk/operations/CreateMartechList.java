...
public class CreateMartechList {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateMartechListRequest, CreateMartechListResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateMartechListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMartechListRequest.class, new TypeReference<CreateMartechListRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMartechListRequest request) {
        ...
        @Override
        public CreateMartechListResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateMartechListRequest, to.unified.unified_java_sdk.models.operations.async.CreateMartechListResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateMartechListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMartechListRequest.class, new TypeReference<CreateMartechListRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateMartechListRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateMartechListResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateMartechListResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateMartechListResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateMartechListResponse res = resBuilder.build();
