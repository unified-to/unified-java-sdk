...
public class UpdateSigningSignatory2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateSigningSignatory2Request, UpdateSigningSignatory2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateSigningSignatory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSigningSignatory2Request.class, new TypeReference<UpdateSigningSignatory2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateSigningSignatory2Request request) {
        ...
        @Override
        public UpdateSigningSignatory2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateSigningSignatory2Response.Builder resBuilder =
            ...
            UpdateSigningSignatory2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateSigningSignatory2Request, to.unified.unified_java_sdk.models.operations.async.UpdateSigningSignatory2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateSigningSignatory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSigningSignatory2Request.class, new TypeReference<UpdateSigningSignatory2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateSigningSignatory2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateSigningSignatory2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateSigningSignatory2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateSigningSignatory2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateSigningSignatory2Response res = resBuilder.build();
