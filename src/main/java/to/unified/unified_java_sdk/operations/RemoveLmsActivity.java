...
public class RemoveLmsActivity {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveLmsActivityRequest, RemoveLmsActivityResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveLmsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsActivityRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveLmsActivityRequest request) {
        ...
        @Override
        public RemoveLmsActivityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveLmsActivityResponse.Builder resBuilder =
            ...
            RemoveLmsActivityResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveLmsActivityRequest, to.unified.unified_java_sdk.models.operations.async.RemoveLmsActivityResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveLmsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsActivityRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveLmsActivityRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveLmsActivityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveLmsActivityResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveLmsActivityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveLmsActivityResponse res = resBuilder.build();
