...
public class CreateAtsCompany {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsCompanyRequest request) throws Exception {
        ...
        @Override
        public CreateAtsCompanyResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AtsCompany out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAtsCompany(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
