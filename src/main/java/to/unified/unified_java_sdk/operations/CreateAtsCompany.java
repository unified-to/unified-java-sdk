...
public class CreateAtsCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAtsCompanyRequest, CreateAtsCompanyResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAtsCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsCompanyRequest.class, new TypeReference<CreateAtsCompanyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsCompanyRequest request) {
        ...
        @Override
        public CreateAtsCompanyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAtsCompanyResponse.Builder resBuilder =
            ...
            CreateAtsCompanyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAtsCompanyRequest, to.unified.unified_java_sdk.models.operations.async.CreateAtsCompanyResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAtsCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsCompanyRequest.class, new TypeReference<CreateAtsCompanyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAtsCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAtsCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAtsCompanyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAtsCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAtsCompanyResponse res = resBuilder.build();
