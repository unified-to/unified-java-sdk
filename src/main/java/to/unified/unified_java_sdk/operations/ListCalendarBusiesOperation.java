...
public class ListCalendarBusiesOperation implements RequestOperation<ListCalendarBusiesRequest, ListCalendarBusiesResponse> {
    ...
    public ListCalendarBusiesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCalendarBusiesRequest request) throws Exception {
