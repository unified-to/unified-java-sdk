...
public class GetAccountingVendorcredit {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingVendorcreditRequest, GetAccountingVendorcreditResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingVendorcreditRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingVendorcreditRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingVendorcreditRequest request) {
        ...
        @Override
        public GetAccountingVendorcreditResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingVendorcreditResponse.Builder resBuilder =
                    GetAccountingVendorcreditResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetAccountingVendorcreditResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingVendorcreditRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingVendorcreditResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingVendorcreditRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingVendorcreditRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingVendorcreditRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingVendorcreditResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingVendorcreditResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingVendorcreditResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingVendorcreditResponse res = resBuilder.build();
