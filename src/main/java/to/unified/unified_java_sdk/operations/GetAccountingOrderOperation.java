...
public class GetAccountingOrderOperation implements RequestOperation<GetAccountingOrderRequest, GetAccountingOrderResponse> {
    ...
    public GetAccountingOrderOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountingOrderRequest request) throws Exception {
