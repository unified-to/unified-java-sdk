...
public class GetRepoRepositoryOperation implements RequestOperation<GetRepoRepositoryRequest, GetRepoRepositoryResponse> {
    ...
    public GetRepoRepositoryOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetRepoRepositoryRequest request) throws Exception {
