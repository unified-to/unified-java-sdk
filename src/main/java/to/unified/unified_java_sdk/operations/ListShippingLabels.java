...
public class ListShippingLabels {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListShippingLabelsRequest, ListShippingLabelsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListShippingLabelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListShippingLabelsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListShippingLabelsRequest request) {
        ...
        @Override
        public ListShippingLabelsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListShippingLabelsResponse.Builder resBuilder =
            ...
            ListShippingLabelsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListShippingLabelsRequest, to.unified.unified_java_sdk.models.operations.async.ListShippingLabelsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListShippingLabelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListShippingLabelsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListShippingLabelsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListShippingLabelsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListShippingLabelsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListShippingLabelsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListShippingLabelsResponse res = resBuilder.build();
