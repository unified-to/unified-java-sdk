...
public class ListCommerceInventoriesOperation implements RequestOperation<ListCommerceInventoriesRequest, ListCommerceInventoriesResponse> {
    ...
    public ListCommerceInventoriesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCommerceInventoriesRequest request) throws Exception {
