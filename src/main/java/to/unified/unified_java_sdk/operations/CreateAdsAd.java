...
public class CreateAdsAd {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAdsAdRequest, CreateAdsAdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAdsAdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsAdRequest.class, new TypeReference<CreateAdsAdRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAdsAdRequest request) {
        ...
        @Override
        public CreateAdsAdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAdsAdResponse.Builder resBuilder =
                    CreateAdsAdResponse
                            .builder()
            ...
            CreateAdsAdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAdsAdRequest, to.unified.unified_java_sdk.models.operations.async.CreateAdsAdResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAdsAdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsAdRequest.class, new TypeReference<CreateAdsAdRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAdsAdRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAdsAdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAdsAdResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAdsAdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAdsAdResponse res = resBuilder.build();
