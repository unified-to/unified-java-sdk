...
public class PatchAtsCandidateOperation implements RequestOperation<PatchAtsCandidateRequest, PatchAtsCandidateResponse> {
    ...
    public PatchAtsCandidateOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchAtsCandidateRequest request) throws Exception {
