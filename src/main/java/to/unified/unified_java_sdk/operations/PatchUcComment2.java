...
public class PatchUcComment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchUcComment2Request, PatchUcComment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchUcComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUcComment2Request.class, new TypeReference<PatchUcComment2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchUcComment2Request request) {
        ...
        @Override
        public PatchUcComment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchUcComment2Response.Builder resBuilder =
            ...
            PatchUcComment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchUcComment2Request, to.unified.unified_java_sdk.models.operations.async.PatchUcComment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchUcComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUcComment2Request.class, new TypeReference<PatchUcComment2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchUcComment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchUcComment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchUcComment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchUcComment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchUcComment2Response res = resBuilder.build();
