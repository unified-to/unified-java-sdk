...
public class UpdateHrisEmployeeOperation implements RequestOperation<UpdateHrisEmployeeRequest, UpdateHrisEmployeeResponse> {
    ...
    public UpdateHrisEmployeeOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateHrisEmployeeRequest request) throws Exception {
