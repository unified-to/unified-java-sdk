...
public class RemoveAtsCandidate2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAtsCandidate2Request, RemoveAtsCandidate2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAtsCandidate2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsCandidate2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAtsCandidate2Request request) {
        ...
        @Override
        public RemoveAtsCandidate2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAtsCandidate2Response.Builder resBuilder =
            ...
            RemoveAtsCandidate2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAtsCandidate2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAtsCandidate2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAtsCandidate2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsCandidate2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAtsCandidate2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAtsCandidate2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAtsCandidate2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAtsCandidate2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAtsCandidate2Response res = resBuilder.build();
