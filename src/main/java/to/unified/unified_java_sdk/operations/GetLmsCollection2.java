...
public class GetLmsCollection2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLmsCollection2Request, GetLmsCollection2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLmsCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsCollection2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLmsCollection2Request request) {
        ...
        @Override
        public GetLmsCollection2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLmsCollection2Response.Builder resBuilder =
            ...
            GetLmsCollection2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLmsCollection2Request, to.unified.unified_java_sdk.models.operations.async.GetLmsCollection2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLmsCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsCollection2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLmsCollection2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetLmsCollection2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetLmsCollection2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetLmsCollection2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetLmsCollection2Response res = resBuilder.build();
