...
public class GetCommerceInventory {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceInventoryRequest, GetCommerceInventoryResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommerceInventoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceInventoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceInventoryRequest request) {
        ...
        @Override
        public GetCommerceInventoryResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommerceInventoryRequest, to.unified.unified_java_sdk.models.operations.async.GetCommerceInventoryResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommerceInventoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceInventoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommerceInventoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCommerceInventoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCommerceInventoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCommerceInventoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCommerceInventoryResponse res = resBuilder.build();
