...
public class CreateKmsPage2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateKmsPage2Request, CreateKmsPage2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateKmsPage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateKmsPage2Request.class, new TypeReference<CreateKmsPage2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateKmsPage2Request request) {
        ...
        @Override
        public CreateKmsPage2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateKmsPage2Response.Builder resBuilder =
            ...
            CreateKmsPage2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withKmsPage(Utils.unmarshal(response, new TypeReference<KmsPage>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateKmsPage2Request, to.unified.unified_java_sdk.models.operations.async.CreateKmsPage2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateKmsPage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateKmsPage2Request.class, new TypeReference<CreateKmsPage2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateKmsPage2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateKmsPage2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateKmsPage2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateKmsPage2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateKmsPage2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<KmsPage>() {})
                            .thenApply(res::withKmsPage);
                } else {
