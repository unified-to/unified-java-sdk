...
public class ListCommerceItems2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceItems2Request, ListCommerceItems2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommerceItems2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceItems2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceItems2Request request) {
        ...
        @Override
        public ListCommerceItems2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceItems2Response.Builder resBuilder =
            ...
            ListCommerceItems2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceItems(Utils.unmarshal(response, new TypeReference<List<CommerceItem>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceItems2Request, to.unified.unified_java_sdk.models.operations.async.ListCommerceItems2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceItems2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceItems2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceItems2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceItems2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceItems2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceItems2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceItems2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CommerceItem>>() {})
                            .thenApply(res::withCommerceItems);
                } else {
