...
public class UpdateCommerceLocation {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceLocationRequest request) throws Exception {
        ...
        @Override
        public UpdateCommerceLocationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CommerceLocation out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCommerceLocation(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
