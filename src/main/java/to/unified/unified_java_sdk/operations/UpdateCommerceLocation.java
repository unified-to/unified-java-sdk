...
public class UpdateCommerceLocation {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommerceLocationRequest, UpdateCommerceLocationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCommerceLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceLocationRequest.class, new TypeReference<UpdateCommerceLocationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceLocationRequest request) {
        ...
        @Override
        public UpdateCommerceLocationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommerceLocationResponse.Builder resBuilder =
            ...
            UpdateCommerceLocationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommerceLocationRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCommerceLocationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommerceLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceLocationRequest.class, new TypeReference<UpdateCommerceLocationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommerceLocationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCommerceLocationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceLocationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCommerceLocationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceLocationResponse res = resBuilder.build();
