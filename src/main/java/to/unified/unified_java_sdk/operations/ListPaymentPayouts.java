...
public class ListPaymentPayouts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentPayoutsRequest request) throws Exception {
        ...
        @Override
        public ListPaymentPayoutsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<PaymentPayout> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentPayouts(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
