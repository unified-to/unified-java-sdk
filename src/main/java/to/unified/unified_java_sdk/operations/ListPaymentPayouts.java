...
public class ListPaymentPayouts {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPaymentPayoutsRequest, ListPaymentPayoutsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPaymentPayoutsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentPayoutsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentPayoutsRequest request) {
        ...
        @Override
        public ListPaymentPayoutsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPaymentPayoutsResponse.Builder resBuilder =
            ...
            ListPaymentPayoutsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentPayoutsRequest, to.unified.unified_java_sdk.models.operations.async.ListPaymentPayoutsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPaymentPayoutsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentPayoutsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPaymentPayoutsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListPaymentPayoutsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListPaymentPayoutsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListPaymentPayoutsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListPaymentPayoutsResponse res = resBuilder.build();
