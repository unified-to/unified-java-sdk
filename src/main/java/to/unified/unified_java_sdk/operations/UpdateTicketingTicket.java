...
public class UpdateTicketingTicket {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTicketingTicketRequest, UpdateTicketingTicketResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTicketingTicketRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketingTicketRequest.class, new TypeReference<UpdateTicketingTicketRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTicketingTicketRequest request) {
        ...
        @Override
        public UpdateTicketingTicketResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateTicketingTicketRequest, to.unified.unified_java_sdk.models.operations.async.UpdateTicketingTicketResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateTicketingTicketRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketingTicketRequest.class, new TypeReference<UpdateTicketingTicketRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateTicketingTicketRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateTicketingTicketResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateTicketingTicketResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateTicketingTicketResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateTicketingTicketResponse res = resBuilder.build();
