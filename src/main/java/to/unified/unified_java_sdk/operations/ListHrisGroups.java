...
public class ListHrisGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisGroupsRequest, ListHrisGroupsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisGroupsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisGroupsRequest request) {
        ...
        @Override
        public ListHrisGroupsResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisGroupsRequest, to.unified.unified_java_sdk.models.operations.async.ListHrisGroupsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisGroupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisGroupsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisGroupsResponse res = resBuilder.build();
