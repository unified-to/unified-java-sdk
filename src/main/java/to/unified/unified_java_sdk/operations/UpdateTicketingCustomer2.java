...
public class UpdateTicketingCustomer2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTicketingCustomer2Request, UpdateTicketingCustomer2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTicketingCustomer2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketingCustomer2Request.class, new TypeReference<UpdateTicketingCustomer2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTicketingCustomer2Request request) {
        ...
        @Override
        public UpdateTicketingCustomer2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTicketingCustomer2Response.Builder resBuilder =
            ...
            UpdateTicketingCustomer2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateTicketingCustomer2Request, to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCustomer2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateTicketingCustomer2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketingCustomer2Request.class, new TypeReference<UpdateTicketingCustomer2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateTicketingCustomer2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCustomer2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCustomer2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCustomer2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCustomer2Response res = resBuilder.build();
