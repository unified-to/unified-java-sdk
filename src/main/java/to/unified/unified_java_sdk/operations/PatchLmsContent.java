...
public class PatchLmsContent {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchLmsContentRequest, PatchLmsContentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchLmsContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsContentRequest.class, new TypeReference<PatchLmsContentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchLmsContentRequest request) {
        ...
        @Override
        public PatchLmsContentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchLmsContentResponse.Builder resBuilder =
            ...
            PatchLmsContentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchLmsContentRequest, to.unified.unified_java_sdk.models.operations.async.PatchLmsContentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchLmsContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsContentRequest.class, new TypeReference<PatchLmsContentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchLmsContentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchLmsContentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchLmsContentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchLmsContentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchLmsContentResponse res = resBuilder.build();
