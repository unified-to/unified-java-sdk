...
public class CreateTaskTask {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTaskTaskRequest, CreateTaskTaskResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateTaskTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTaskTaskRequest.class, new TypeReference<CreateTaskTaskRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTaskTaskRequest request) {
        ...
        @Override
        public CreateTaskTaskResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTaskTaskResponse.Builder resBuilder =
            ...
            CreateTaskTaskResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTaskTaskRequest, to.unified.unified_java_sdk.models.operations.async.CreateTaskTaskResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTaskTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTaskTaskRequest.class, new TypeReference<CreateTaskTaskRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTaskTaskRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateTaskTaskResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateTaskTaskResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateTaskTaskResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateTaskTaskResponse res = resBuilder.build();
