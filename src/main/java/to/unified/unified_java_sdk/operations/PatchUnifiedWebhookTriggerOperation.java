...
public class PatchUnifiedWebhookTriggerOperation implements RequestOperation<PatchUnifiedWebhookTriggerRequest, PatchUnifiedWebhookTriggerResponse> {
    ...
    public PatchUnifiedWebhookTriggerOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchUnifiedWebhookTriggerRequest request) throws Exception {
