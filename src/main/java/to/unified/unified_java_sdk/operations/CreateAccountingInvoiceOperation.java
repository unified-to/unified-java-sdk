...
public class CreateAccountingInvoiceOperation implements RequestOperation<CreateAccountingInvoiceRequest, CreateAccountingInvoiceResponse> {
    ...
    public CreateAccountingInvoiceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAccountingInvoiceRequest request) throws Exception {
