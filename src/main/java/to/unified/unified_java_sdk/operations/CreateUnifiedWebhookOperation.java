...
public class CreateUnifiedWebhookOperation implements RequestOperation<CreateUnifiedWebhookRequest, CreateUnifiedWebhookResponse> {
    ...
    public CreateUnifiedWebhookOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateUnifiedWebhookRequest request) throws Exception {
