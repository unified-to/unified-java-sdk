...
public class UpdateUcComment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateUcComment2Request, UpdateUcComment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateUcComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUcComment2Request.class, new TypeReference<UpdateUcComment2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateUcComment2Request request) {
        ...
        @Override
        public UpdateUcComment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateUcComment2Response.Builder resBuilder =
            ...
            UpdateUcComment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateUcComment2Request, to.unified.unified_java_sdk.models.operations.async.UpdateUcComment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateUcComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUcComment2Request.class, new TypeReference<UpdateUcComment2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateUcComment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateUcComment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateUcComment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateUcComment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateUcComment2Response res = resBuilder.build();
