...
public class GetAccountingOrder {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingOrderRequest, GetAccountingOrderResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingOrderRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingOrderRequest request) {
        ...
        @Override
        public GetAccountingOrderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingOrderResponse.Builder resBuilder =
            ...
            GetAccountingOrderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingOrderRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingOrderResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingOrderRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingOrderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingOrderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingOrderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingOrderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingOrderResponse res = resBuilder.build();
