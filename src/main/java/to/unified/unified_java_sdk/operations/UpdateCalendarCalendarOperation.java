...
public class UpdateCalendarCalendarOperation implements RequestOperation<UpdateCalendarCalendarRequest, UpdateCalendarCalendarResponse> {
    ...
    public UpdateCalendarCalendarOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateCalendarCalendarRequest request) throws Exception {
