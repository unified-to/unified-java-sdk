...
public class GetHrisTaxonomy {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisTaxonomyRequest, GetHrisTaxonomyResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisTaxonomyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisTaxonomyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisTaxonomyRequest request) {
        ...
        @Override
        public GetHrisTaxonomyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisTaxonomyResponse.Builder resBuilder =
            ...
            GetHrisTaxonomyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisTaxonomyRequest, to.unified.unified_java_sdk.models.operations.async.GetHrisTaxonomyResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisTaxonomyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisTaxonomyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisTaxonomyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisTaxonomyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisTaxonomyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisTaxonomyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisTaxonomyResponse res = resBuilder.build();
