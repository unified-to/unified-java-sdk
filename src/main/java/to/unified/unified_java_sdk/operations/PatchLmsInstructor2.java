...
public class PatchLmsInstructor2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchLmsInstructor2Request, PatchLmsInstructor2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchLmsInstructor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsInstructor2Request.class, new TypeReference<PatchLmsInstructor2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchLmsInstructor2Request request) {
        ...
        @Override
        public PatchLmsInstructor2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchLmsInstructor2Response.Builder resBuilder =
            ...
            PatchLmsInstructor2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchLmsInstructor2Request, to.unified.unified_java_sdk.models.operations.async.PatchLmsInstructor2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchLmsInstructor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsInstructor2Request.class, new TypeReference<PatchLmsInstructor2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchLmsInstructor2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchLmsInstructor2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchLmsInstructor2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchLmsInstructor2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchLmsInstructor2Response res = resBuilder.build();
