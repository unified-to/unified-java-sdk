...
public class ListTicketingCategories2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTicketingCategories2Request, ListTicketingCategories2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListTicketingCategories2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListTicketingCategories2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTicketingCategories2Request request) {
        ...
        @Override
        public ListTicketingCategories2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTicketingCategories2Response.Builder resBuilder =
            ...
            ListTicketingCategories2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingCategories(Utils.unmarshal(response, new TypeReference<List<TicketingCategory>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTicketingCategories2Request, to.unified.unified_java_sdk.models.operations.async.ListTicketingCategories2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListTicketingCategories2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListTicketingCategories2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTicketingCategories2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListTicketingCategories2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListTicketingCategories2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListTicketingCategories2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListTicketingCategories2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<TicketingCategory>>() {})
                            .thenApply(res::withTicketingCategories);
                } else {
