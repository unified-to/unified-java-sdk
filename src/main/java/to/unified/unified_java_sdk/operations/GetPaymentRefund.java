...
public class GetPaymentRefund {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPaymentRefundRequest, GetPaymentRefundResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPaymentRefundRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentRefundRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentRefundRequest request) {
        ...
        @Override
        public GetPaymentRefundResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPaymentRefundResponse.Builder resBuilder =
            ...
            GetPaymentRefundResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentRefundRequest, to.unified.unified_java_sdk.models.operations.async.GetPaymentRefundResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPaymentRefundRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentRefundRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPaymentRefundRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetPaymentRefundResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetPaymentRefundResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetPaymentRefundResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetPaymentRefundResponse res = resBuilder.build();
