...
public class GetPaymentRefund {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentRefundRequest request) throws Exception {
        ...
        @Override
        public GetPaymentRefundResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaymentRefund out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentRefund(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
