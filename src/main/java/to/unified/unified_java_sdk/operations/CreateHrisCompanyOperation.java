...
public class CreateHrisCompanyOperation implements RequestOperation<CreateHrisCompanyRequest, CreateHrisCompanyResponse> {
    ...
    public CreateHrisCompanyOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateHrisCompanyRequest request) throws Exception {
