...
public class GetAtsInterviewOperation implements RequestOperation<GetAtsInterviewRequest, GetAtsInterviewResponse> {
    ...
    public GetAtsInterviewOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAtsInterviewRequest request) throws Exception {
