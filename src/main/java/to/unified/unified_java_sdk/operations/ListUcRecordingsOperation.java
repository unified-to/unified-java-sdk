...
public class ListUcRecordingsOperation implements RequestOperation<ListUcRecordingsRequest, ListUcRecordingsResponse> {
    ...
    public ListUcRecordingsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListUcRecordingsRequest request) throws Exception {
