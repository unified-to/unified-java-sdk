...
public class GetCdpSegment {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCdpSegmentRequest, GetCdpSegmentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCdpSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCdpSegmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCdpSegmentRequest request) {
        ...
        @Override
        public GetCdpSegmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCdpSegmentResponse.Builder resBuilder =
            ...
            GetCdpSegmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCdpSegmentRequest, to.unified.unified_java_sdk.models.operations.async.GetCdpSegmentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCdpSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCdpSegmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCdpSegmentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCdpSegmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCdpSegmentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCdpSegmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCdpSegmentResponse res = resBuilder.build();
