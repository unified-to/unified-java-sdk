...
public class CreateTaskTask2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTaskTask2Request, CreateTaskTask2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateTaskTask2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTaskTask2Request.class, new TypeReference<CreateTaskTask2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTaskTask2Request request) {
        ...
        @Override
        public CreateTaskTask2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTaskTask2Response.Builder resBuilder =
            ...
            CreateTaskTask2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTaskTask(Utils.unmarshal(response, new TypeReference<TaskTask>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTaskTask2Request, to.unified.unified_java_sdk.models.operations.async.CreateTaskTask2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTaskTask2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTaskTask2Request.class, new TypeReference<CreateTaskTask2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTaskTask2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateTaskTask2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateTaskTask2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateTaskTask2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateTaskTask2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TaskTask>() {})
                            .thenApply(res::withTaskTask);
                } else {
