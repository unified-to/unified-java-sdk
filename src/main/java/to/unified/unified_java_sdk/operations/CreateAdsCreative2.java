...
public class CreateAdsCreative2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAdsCreative2Request, CreateAdsCreative2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAdsCreative2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsCreative2Request.class, new TypeReference<CreateAdsCreative2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAdsCreative2Request request) {
        ...
        @Override
        public CreateAdsCreative2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAdsCreative2Response.Builder resBuilder =
            ...
            CreateAdsCreative2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAdsCreative2Request, to.unified.unified_java_sdk.models.operations.async.CreateAdsCreative2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAdsCreative2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsCreative2Request.class, new TypeReference<CreateAdsCreative2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAdsCreative2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAdsCreative2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAdsCreative2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAdsCreative2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAdsCreative2Response res = resBuilder.build();
