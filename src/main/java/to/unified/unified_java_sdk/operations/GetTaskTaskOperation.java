...
public class GetTaskTaskOperation implements RequestOperation<GetTaskTaskRequest, GetTaskTaskResponse> {
    ...
    public GetTaskTaskOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetTaskTaskRequest request) throws Exception {
