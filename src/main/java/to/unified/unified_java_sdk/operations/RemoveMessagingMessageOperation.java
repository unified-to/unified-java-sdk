...
public class RemoveMessagingMessageOperation implements RequestOperation<RemoveMessagingMessageRequest, RemoveMessagingMessageResponse> {
    ...
    public RemoveMessagingMessageOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveMessagingMessageRequest request) throws Exception {
