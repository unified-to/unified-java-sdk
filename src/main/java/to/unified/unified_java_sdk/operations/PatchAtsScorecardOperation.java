...
public class PatchAtsScorecardOperation implements RequestOperation<PatchAtsScorecardRequest, PatchAtsScorecardResponse> {
    ...
    public PatchAtsScorecardOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchAtsScorecardRequest request) throws Exception {
