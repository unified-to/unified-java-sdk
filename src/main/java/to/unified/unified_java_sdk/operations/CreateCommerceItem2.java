...
public class CreateCommerceItem2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommerceItem2Request, CreateCommerceItem2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommerceItem2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceItem2Request.class, new TypeReference<CreateCommerceItem2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceItem2Request request) {
        ...
        @Override
        public CreateCommerceItem2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommerceItem2Response.Builder resBuilder =
            ...
            CreateCommerceItem2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommerceItem2Request, to.unified.unified_java_sdk.models.operations.async.CreateCommerceItem2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommerceItem2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceItem2Request.class, new TypeReference<CreateCommerceItem2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommerceItem2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCommerceItem2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCommerceItem2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCommerceItem2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCommerceItem2Response res = resBuilder.build();
