...
public class PatchAnalyticsVisitor {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAnalyticsVisitorRequest, PatchAnalyticsVisitorResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAnalyticsVisitorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAnalyticsVisitorRequest.class, new TypeReference<PatchAnalyticsVisitorRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAnalyticsVisitorRequest request) {
        ...
        @Override
        public PatchAnalyticsVisitorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAnalyticsVisitorResponse.Builder resBuilder =
            ...
            PatchAnalyticsVisitorResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAnalyticsVisitorRequest, to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsVisitorResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAnalyticsVisitorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAnalyticsVisitorRequest.class, new TypeReference<PatchAnalyticsVisitorRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAnalyticsVisitorRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsVisitorResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsVisitorResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsVisitorResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsVisitorResponse res = resBuilder.build();
