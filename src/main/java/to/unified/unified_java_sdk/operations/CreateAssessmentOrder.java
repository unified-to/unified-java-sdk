...
public class CreateAssessmentOrder {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAssessmentOrderRequest, CreateAssessmentOrderResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAssessmentOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAssessmentOrderRequest.class, new TypeReference<CreateAssessmentOrderRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAssessmentOrderRequest request) {
        ...
        @Override
        public CreateAssessmentOrderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAssessmentOrderResponse.Builder resBuilder =
            ...
            CreateAssessmentOrderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAssessmentOrderRequest, to.unified.unified_java_sdk.models.operations.async.CreateAssessmentOrderResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAssessmentOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAssessmentOrderRequest.class, new TypeReference<CreateAssessmentOrderRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAssessmentOrderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAssessmentOrderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAssessmentOrderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAssessmentOrderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAssessmentOrderResponse res = resBuilder.build();
