...
public class CreateCalendarLinkOperation implements RequestOperation<CreateCalendarLinkRequest, CreateCalendarLinkResponse> {
    ...
    public CreateCalendarLinkOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateCalendarLinkRequest request) throws Exception {
