...
public class UpdateAccountingCreditmemo {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAccountingCreditmemoRequest, UpdateAccountingCreditmemoResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAccountingCreditmemoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingCreditmemoRequest.class, new TypeReference<UpdateAccountingCreditmemoRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAccountingCreditmemoRequest request) {
        ...
        @Override
        public UpdateAccountingCreditmemoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAccountingCreditmemoResponse.Builder resBuilder =
            ...
            UpdateAccountingCreditmemoResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAccountingCreditmemoRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAccountingCreditmemoResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAccountingCreditmemoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingCreditmemoRequest.class, new TypeReference<UpdateAccountingCreditmemoRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAccountingCreditmemoRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAccountingCreditmemoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingCreditmemoResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAccountingCreditmemoResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingCreditmemoResponse res = resBuilder.build();
