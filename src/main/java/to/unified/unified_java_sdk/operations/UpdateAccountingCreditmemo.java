...
public class UpdateAccountingCreditmemo {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAccountingCreditmemoRequest request) throws Exception {
        ...
        @Override
        public UpdateAccountingCreditmemoResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingCreditmemo out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingCreditmemo(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
