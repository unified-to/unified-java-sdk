...
public class ListUnifiedApicalls {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUnifiedApicallsRequest request) throws Exception {
        ...
        @Override
        public ListUnifiedApicallsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<ApiCall> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withApiCalls(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
