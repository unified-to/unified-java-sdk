...
public class ListUnifiedApicalls {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUnifiedApicallsRequest, ListUnifiedApicallsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListUnifiedApicallsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUnifiedApicallsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUnifiedApicallsRequest request) {
        ...
        @Override
        public ListUnifiedApicallsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUnifiedApicallsResponse.Builder resBuilder =
            ...
            ListUnifiedApicallsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withApiCalls(Utils.unmarshal(response, new TypeReference<List<ApiCall>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUnifiedApicallsRequest, to.unified.unified_java_sdk.models.operations.async.ListUnifiedApicallsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListUnifiedApicallsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUnifiedApicallsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUnifiedApicallsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListUnifiedApicallsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListUnifiedApicallsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListUnifiedApicallsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListUnifiedApicallsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ApiCall>>() {})
                            .thenApply(res::withApiCalls);
                } else {
