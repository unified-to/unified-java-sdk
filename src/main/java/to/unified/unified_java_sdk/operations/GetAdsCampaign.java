...
public class GetAdsCampaign {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAdsCampaignRequest, GetAdsCampaignResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAdsCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsCampaignRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAdsCampaignRequest request) {
        ...
        @Override
        public GetAdsCampaignResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAdsCampaignResponse.Builder resBuilder =
            ...
            GetAdsCampaignResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAdsCampaignRequest, to.unified.unified_java_sdk.models.operations.async.GetAdsCampaignResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAdsCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsCampaignRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAdsCampaignRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAdsCampaignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAdsCampaignResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAdsCampaignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAdsCampaignResponse res = resBuilder.build();
