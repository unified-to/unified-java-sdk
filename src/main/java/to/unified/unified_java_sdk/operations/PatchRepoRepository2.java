...
public class PatchRepoRepository2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchRepoRepository2Request, PatchRepoRepository2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchRepoRepository2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoRepository2Request.class, new TypeReference<PatchRepoRepository2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchRepoRepository2Request request) {
        ...
        @Override
        public PatchRepoRepository2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchRepoRepository2Response.Builder resBuilder =
            ...
            PatchRepoRepository2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchRepoRepository2Request, to.unified.unified_java_sdk.models.operations.async.PatchRepoRepository2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchRepoRepository2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoRepository2Request.class, new TypeReference<PatchRepoRepository2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchRepoRepository2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchRepoRepository2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchRepoRepository2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchRepoRepository2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchRepoRepository2Response res = resBuilder.build();
