...
public class ListAtsApplicationstatusesOperation implements RequestOperation<ListAtsApplicationstatusesRequest, ListAtsApplicationstatusesResponse> {
    ...
    public ListAtsApplicationstatusesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAtsApplicationstatusesRequest request) throws Exception {
