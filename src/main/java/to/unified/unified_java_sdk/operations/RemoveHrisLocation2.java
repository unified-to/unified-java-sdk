...
public class RemoveHrisLocation2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisLocation2Request, RemoveHrisLocation2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisLocation2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisLocation2Request request) {
        ...
        @Override
        public RemoveHrisLocation2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisLocation2Response.Builder resBuilder =
            ...
            RemoveHrisLocation2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisLocation2Request, to.unified.unified_java_sdk.models.operations.async.RemoveHrisLocation2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisLocation2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisLocation2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisLocation2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisLocation2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisLocation2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisLocation2Response res = resBuilder.build();
