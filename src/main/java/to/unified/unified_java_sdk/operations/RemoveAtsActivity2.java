...
public class RemoveAtsActivity2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAtsActivity2Request, RemoveAtsActivity2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAtsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsActivity2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAtsActivity2Request request) {
        ...
        @Override
        public RemoveAtsActivity2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAtsActivity2Response.Builder resBuilder =
            ...
            RemoveAtsActivity2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAtsActivity2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAtsActivity2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAtsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsActivity2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAtsActivity2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAtsActivity2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAtsActivity2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAtsActivity2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAtsActivity2Response res = resBuilder.build();
