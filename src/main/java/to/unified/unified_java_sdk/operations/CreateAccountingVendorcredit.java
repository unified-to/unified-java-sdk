...
public class CreateAccountingVendorcredit {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAccountingVendorcreditRequest, CreateAccountingVendorcreditResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAccountingVendorcreditRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingVendorcreditRequest.class, new TypeReference<CreateAccountingVendorcreditRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingVendorcreditRequest request) {
        ...
        @Override
        public CreateAccountingVendorcreditResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAccountingVendorcreditResponse.Builder resBuilder =
                    CreateAccountingVendorcreditResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateAccountingVendorcreditResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAccountingVendorcreditRequest, to.unified.unified_java_sdk.models.operations.async.CreateAccountingVendorcreditResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAccountingVendorcreditRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingVendorcreditRequest.class, new TypeReference<CreateAccountingVendorcreditRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAccountingVendorcreditRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAccountingVendorcreditResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAccountingVendorcreditResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAccountingVendorcreditResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAccountingVendorcreditResponse res = resBuilder.build();
