...
public class UpdateCrmCompany2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCrmCompany2Request, UpdateCrmCompany2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCrmCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmCompany2Request.class, new TypeReference<UpdateCrmCompany2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCrmCompany2Request request) {
        ...
        @Override
        public UpdateCrmCompany2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCrmCompany2Response.Builder resBuilder =
            ...
            UpdateCrmCompany2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCrmCompany(Utils.unmarshal(response, new TypeReference<CrmCompany>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCrmCompany2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCrmCompany2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCrmCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmCompany2Request.class, new TypeReference<UpdateCrmCompany2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCrmCompany2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCrmCompany2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCrmCompany2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCrmCompany2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCrmCompany2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CrmCompany>() {})
                            .thenApply(res::withCrmCompany);
                } else {
