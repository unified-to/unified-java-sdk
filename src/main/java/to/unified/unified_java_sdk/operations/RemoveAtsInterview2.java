...
public class RemoveAtsInterview2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAtsInterview2Request, RemoveAtsInterview2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAtsInterview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsInterview2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAtsInterview2Request request) {
        ...
        @Override
        public RemoveAtsInterview2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAtsInterview2Response.Builder resBuilder =
            ...
            RemoveAtsInterview2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAtsInterview2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAtsInterview2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAtsInterview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsInterview2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAtsInterview2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAtsInterview2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAtsInterview2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAtsInterview2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAtsInterview2Response res = resBuilder.build();
