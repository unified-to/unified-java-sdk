...
public class PatchAtsActivityOperation implements RequestOperation<PatchAtsActivityRequest, PatchAtsActivityResponse> {
    ...
    public PatchAtsActivityOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchAtsActivityRequest request) throws Exception {
