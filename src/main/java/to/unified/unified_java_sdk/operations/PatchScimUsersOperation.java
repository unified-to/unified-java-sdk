...
public class PatchScimUsersOperation implements RequestOperation<PatchScimUsersRequest, PatchScimUsersResponse> {
    ...
    public PatchScimUsersOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchScimUsersRequest request) throws Exception {
