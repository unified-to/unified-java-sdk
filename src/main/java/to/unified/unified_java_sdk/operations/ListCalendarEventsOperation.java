...
public class ListCalendarEventsOperation implements RequestOperation<ListCalendarEventsRequest, ListCalendarEventsResponse> {
    ...
    public ListCalendarEventsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCalendarEventsRequest request) throws Exception {
