...
public class UpdateAssessmentOrder {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAssessmentOrderRequest, UpdateAssessmentOrderResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAssessmentOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAssessmentOrderRequest.class, new TypeReference<UpdateAssessmentOrderRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAssessmentOrderRequest request) {
        ...
        @Override
        public UpdateAssessmentOrderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAssessmentOrderResponse.Builder resBuilder =
            ...
            UpdateAssessmentOrderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAssessmentOrderRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentOrderResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAssessmentOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAssessmentOrderRequest.class, new TypeReference<UpdateAssessmentOrderRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAssessmentOrderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentOrderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentOrderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentOrderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentOrderResponse res = resBuilder.build();
