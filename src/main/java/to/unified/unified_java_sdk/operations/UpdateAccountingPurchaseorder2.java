...
public class UpdateAccountingPurchaseorder2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAccountingPurchaseorder2Request, UpdateAccountingPurchaseorder2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAccountingPurchaseorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingPurchaseorder2Request.class, new TypeReference<UpdateAccountingPurchaseorder2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAccountingPurchaseorder2Request request) {
        ...
        @Override
        public UpdateAccountingPurchaseorder2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAccountingPurchaseorder2Response.Builder resBuilder =
            ...
            UpdateAccountingPurchaseorder2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAccountingPurchaseorder2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAccountingPurchaseorder2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAccountingPurchaseorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingPurchaseorder2Request.class, new TypeReference<UpdateAccountingPurchaseorder2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAccountingPurchaseorder2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAccountingPurchaseorder2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingPurchaseorder2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAccountingPurchaseorder2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingPurchaseorder2Response res = resBuilder.build();
