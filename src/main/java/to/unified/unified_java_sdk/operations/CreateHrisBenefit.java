...
public class CreateHrisBenefit {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisBenefitRequest, CreateHrisBenefitResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisBenefitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisBenefitRequest.class, new TypeReference<CreateHrisBenefitRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisBenefitRequest request) {
        ...
        @Override
        public CreateHrisBenefitResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisBenefitResponse.Builder resBuilder =
            ...
            CreateHrisBenefitResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisBenefitRequest, to.unified.unified_java_sdk.models.operations.async.CreateHrisBenefitResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisBenefitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisBenefitRequest.class, new TypeReference<CreateHrisBenefitRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisBenefitRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisBenefitResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisBenefitResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisBenefitResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisBenefitResponse res = resBuilder.build();
