...
public class CreateScimGroups {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateScimGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateScimGroupsRequest.class, new TypeReference<CreateScimGroupsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateScimGroupsRequest request) {
        ...
        @Override
        public CreateScimGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withScimGroup(Utils.unmarshal(response, new TypeReference<ScimGroup>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateScimGroupsRequest, to.unified.unified_java_sdk.models.operations.async.CreateScimGroupsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateScimGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateScimGroupsRequest.class, new TypeReference<CreateScimGroupsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateScimGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateScimGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateScimGroupsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateScimGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateScimGroupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ScimGroup>() {})
                            .thenApply(res::withScimGroup);
                } else {
