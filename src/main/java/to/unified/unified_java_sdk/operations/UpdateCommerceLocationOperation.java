...
public class UpdateCommerceLocationOperation implements RequestOperation<UpdateCommerceLocationRequest, UpdateCommerceLocationResponse> {
    ...
    public UpdateCommerceLocationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateCommerceLocationRequest request) throws Exception {
