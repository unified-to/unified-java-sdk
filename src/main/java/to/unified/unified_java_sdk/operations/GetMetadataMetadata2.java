...
public class GetMetadataMetadata2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMetadataMetadata2Request, GetMetadataMetadata2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetMetadataMetadata2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataMetadata2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMetadataMetadata2Request request) {
        ...
        @Override
        public GetMetadataMetadata2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMetadataMetadata2Response.Builder resBuilder =
            ...
            GetMetadataMetadata2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMetadataMetadata2Request, to.unified.unified_java_sdk.models.operations.async.GetMetadataMetadata2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMetadataMetadata2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataMetadata2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMetadataMetadata2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetMetadataMetadata2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetMetadataMetadata2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetMetadataMetadata2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetMetadataMetadata2Response res = resBuilder.build();
