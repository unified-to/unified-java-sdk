...
public class GetGenaiAgent {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetGenaiAgentRequest, GetGenaiAgentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetGenaiAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetGenaiAgentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetGenaiAgentRequest request) {
        ...
        @Override
        public GetGenaiAgentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetGenaiAgentResponse.Builder resBuilder =
            ...
            GetGenaiAgentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetGenaiAgentRequest, to.unified.unified_java_sdk.models.operations.async.GetGenaiAgentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetGenaiAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetGenaiAgentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetGenaiAgentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetGenaiAgentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetGenaiAgentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetGenaiAgentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetGenaiAgentResponse res = resBuilder.build();
