...
public class GetMessagingChannelOperation implements RequestOperation<GetMessagingChannelRequest, GetMessagingChannelResponse> {
    ...
    public GetMessagingChannelOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetMessagingChannelRequest request) throws Exception {
