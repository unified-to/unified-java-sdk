...
public class UpdateMessagingEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMessagingEventRequest, UpdateMessagingEventResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateMessagingEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMessagingEventRequest.class, new TypeReference<UpdateMessagingEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMessagingEventRequest request) {
        ...
        @Override
        public UpdateMessagingEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMessagingEventResponse.Builder resBuilder =
            ...
            UpdateMessagingEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMessagingEventRequest, to.unified.unified_java_sdk.models.operations.async.UpdateMessagingEventResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMessagingEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMessagingEventRequest.class, new TypeReference<UpdateMessagingEventRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMessagingEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateMessagingEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateMessagingEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateMessagingEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateMessagingEventResponse res = resBuilder.build();
