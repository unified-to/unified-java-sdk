...
public class UpdateCommerceInventory {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommerceInventoryRequest, UpdateCommerceInventoryResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCommerceInventoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceInventoryRequest.class, new TypeReference<UpdateCommerceInventoryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceInventoryRequest request) {
        ...
        @Override
        public UpdateCommerceInventoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommerceInventoryResponse.Builder resBuilder =
            ...
            UpdateCommerceInventoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommerceInventoryRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCommerceInventoryResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommerceInventoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceInventoryRequest.class, new TypeReference<UpdateCommerceInventoryRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommerceInventoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCommerceInventoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceInventoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCommerceInventoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceInventoryResponse res = resBuilder.build();
