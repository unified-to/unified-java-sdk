...
public class ListCommerceLocations2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceLocations2Request, ListCommerceLocations2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommerceLocations2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceLocations2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceLocations2Request request) {
        ...
        @Override
        public ListCommerceLocations2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceLocations2Response.Builder resBuilder =
            ...
            ListCommerceLocations2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceLocations(Utils.unmarshal(response, new TypeReference<List<CommerceLocation>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceLocations2Request, to.unified.unified_java_sdk.models.operations.async.ListCommerceLocations2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceLocations2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceLocations2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceLocations2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceLocations2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceLocations2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceLocations2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceLocations2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CommerceLocation>>() {})
                            .thenApply(res::withCommerceLocations);
                } else {
