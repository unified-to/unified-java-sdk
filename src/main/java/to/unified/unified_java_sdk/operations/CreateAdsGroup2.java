...
public class CreateAdsGroup2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAdsGroup2Request, CreateAdsGroup2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAdsGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsGroup2Request.class, new TypeReference<CreateAdsGroup2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAdsGroup2Request request) {
        ...
        @Override
        public CreateAdsGroup2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAdsGroup2Response.Builder resBuilder =
            ...
            CreateAdsGroup2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdsGroup(Utils.unmarshal(response, new TypeReference<AdsGroup>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAdsGroup2Request, to.unified.unified_java_sdk.models.operations.async.CreateAdsGroup2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAdsGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsGroup2Request.class, new TypeReference<CreateAdsGroup2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAdsGroup2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAdsGroup2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAdsGroup2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAdsGroup2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAdsGroup2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AdsGroup>() {})
                            .thenApply(res::withAdsGroup);
                } else {
