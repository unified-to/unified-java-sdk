...
public class PatchAtsApplicationOperation implements RequestOperation<PatchAtsApplicationRequest, PatchAtsApplicationResponse> {
    ...
    public PatchAtsApplicationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchAtsApplicationRequest request) throws Exception {
