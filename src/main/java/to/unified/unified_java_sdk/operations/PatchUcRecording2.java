...
public class PatchUcRecording2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchUcRecording2Request, PatchUcRecording2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchUcRecording2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUcRecording2Request.class, new TypeReference<PatchUcRecording2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchUcRecording2Request request) {
        ...
        @Override
        public PatchUcRecording2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchUcRecording2Response.Builder resBuilder =
            ...
            PatchUcRecording2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchUcRecording2Request, to.unified.unified_java_sdk.models.operations.async.PatchUcRecording2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchUcRecording2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUcRecording2Request.class, new TypeReference<PatchUcRecording2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchUcRecording2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchUcRecording2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchUcRecording2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchUcRecording2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchUcRecording2Response res = resBuilder.build();
