...
public class CreateCalendarEvent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCalendarEvent2Request, CreateCalendarEvent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCalendarEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCalendarEvent2Request.class, new TypeReference<CreateCalendarEvent2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCalendarEvent2Request request) {
        ...
        @Override
        public CreateCalendarEvent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCalendarEvent2Response.Builder resBuilder =
            ...
            CreateCalendarEvent2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCalendarEvent(Utils.unmarshal(response, new TypeReference<CalendarEvent>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCalendarEvent2Request, to.unified.unified_java_sdk.models.operations.async.CreateCalendarEvent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCalendarEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCalendarEvent2Request.class, new TypeReference<CreateCalendarEvent2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCalendarEvent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCalendarEvent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCalendarEvent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCalendarEvent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCalendarEvent2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CalendarEvent>() {})
                            .thenApply(res::withCalendarEvent);
                } else {
