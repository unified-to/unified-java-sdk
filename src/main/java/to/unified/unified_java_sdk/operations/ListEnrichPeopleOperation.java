...
public class ListEnrichPeopleOperation implements RequestOperation<ListEnrichPeopleRequest, ListEnrichPeopleResponse> {
    ...
    public ListEnrichPeopleOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListEnrichPeopleRequest request) throws Exception {
