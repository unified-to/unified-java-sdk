...
public class GetFormsForm2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFormsForm2Request, GetFormsForm2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetFormsForm2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetFormsForm2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFormsForm2Request request) {
        ...
        @Override
        public GetFormsForm2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFormsForm2Response.Builder resBuilder =
            ...
            GetFormsForm2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFormsForm2Request, to.unified.unified_java_sdk.models.operations.async.GetFormsForm2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetFormsForm2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetFormsForm2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFormsForm2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetFormsForm2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetFormsForm2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetFormsForm2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetFormsForm2Response res = resBuilder.build();
