...
public class CreateTicketingNote2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTicketingNote2Request, CreateTicketingNote2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateTicketingNote2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTicketingNote2Request.class, new TypeReference<CreateTicketingNote2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTicketingNote2Request request) {
        ...
        @Override
        public CreateTicketingNote2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTicketingNote2Response.Builder resBuilder =
            ...
            CreateTicketingNote2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTicketingNote2Request, to.unified.unified_java_sdk.models.operations.async.CreateTicketingNote2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTicketingNote2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTicketingNote2Request.class, new TypeReference<CreateTicketingNote2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTicketingNote2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateTicketingNote2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateTicketingNote2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateTicketingNote2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateTicketingNote2Response res = resBuilder.build();
