...
public class PatchCrmEventOperation implements RequestOperation<PatchCrmEventRequest, PatchCrmEventResponse> {
    ...
    public PatchCrmEventOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchCrmEventRequest request) throws Exception {
