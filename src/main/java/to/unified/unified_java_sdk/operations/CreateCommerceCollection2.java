...
public class CreateCommerceCollection2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommerceCollection2Request, CreateCommerceCollection2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommerceCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceCollection2Request.class, new TypeReference<CreateCommerceCollection2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceCollection2Request request) {
        ...
        @Override
        public CreateCommerceCollection2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommerceCollection2Response.Builder resBuilder =
            ...
            CreateCommerceCollection2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceCollection(Utils.unmarshal(response, new TypeReference<CommerceCollection>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommerceCollection2Request, to.unified.unified_java_sdk.models.operations.async.CreateCommerceCollection2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommerceCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceCollection2Request.class, new TypeReference<CreateCommerceCollection2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommerceCollection2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCommerceCollection2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCommerceCollection2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCommerceCollection2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCommerceCollection2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CommerceCollection>() {})
                            .thenApply(res::withCommerceCollection);
                } else {
