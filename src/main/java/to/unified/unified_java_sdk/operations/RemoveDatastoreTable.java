...
public class RemoveDatastoreTable {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveDatastoreTableRequest, RemoveDatastoreTableResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveDatastoreTableRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDatastoreTableRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveDatastoreTableRequest request) {
        ...
        @Override
        public RemoveDatastoreTableResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveDatastoreTableResponse.Builder resBuilder =
            ...
            RemoveDatastoreTableResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveDatastoreTableRequest, to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreTableResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveDatastoreTableRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDatastoreTableRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveDatastoreTableRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreTableResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreTableResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreTableResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreTableResponse res = resBuilder.build();
