...
public class PatchAtsInterview2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAtsInterview2Request, PatchAtsInterview2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAtsInterview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsInterview2Request.class, new TypeReference<PatchAtsInterview2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAtsInterview2Request request) {
        ...
        @Override
        public PatchAtsInterview2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAtsInterview2Response.Builder resBuilder =
            ...
            PatchAtsInterview2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAtsInterview2Request, to.unified.unified_java_sdk.models.operations.async.PatchAtsInterview2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAtsInterview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsInterview2Request.class, new TypeReference<PatchAtsInterview2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAtsInterview2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAtsInterview2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAtsInterview2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAtsInterview2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAtsInterview2Response res = resBuilder.build();
