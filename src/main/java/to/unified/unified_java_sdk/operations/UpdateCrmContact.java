...
public class UpdateCrmContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCrmContactRequest, UpdateCrmContactResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCrmContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmContactRequest.class, new TypeReference<UpdateCrmContactRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCrmContactRequest request) {
        ...
        @Override
        public UpdateCrmContactResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCrmContactRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCrmContactResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCrmContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmContactRequest.class, new TypeReference<UpdateCrmContactRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCrmContactRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCrmContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCrmContactResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCrmContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCrmContactResponse res = resBuilder.build();
