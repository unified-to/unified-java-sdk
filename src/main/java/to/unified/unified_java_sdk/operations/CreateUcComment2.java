...
public class CreateUcComment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateUcComment2Request, CreateUcComment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateUcComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateUcComment2Request.class, new TypeReference<CreateUcComment2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateUcComment2Request request) {
        ...
        @Override
        public CreateUcComment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateUcComment2Response.Builder resBuilder =
            ...
            CreateUcComment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateUcComment2Request, to.unified.unified_java_sdk.models.operations.async.CreateUcComment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateUcComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateUcComment2Request.class, new TypeReference<CreateUcComment2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateUcComment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateUcComment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateUcComment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateUcComment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateUcComment2Response res = resBuilder.build();
