...
public class CreateTaskProject2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTaskProject2Request, CreateTaskProject2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateTaskProject2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTaskProject2Request.class, new TypeReference<CreateTaskProject2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTaskProject2Request request) {
        ...
        @Override
        public CreateTaskProject2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTaskProject2Response.Builder resBuilder =
            ...
            CreateTaskProject2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTaskProject(Utils.unmarshal(response, new TypeReference<TaskProject>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTaskProject2Request, to.unified.unified_java_sdk.models.operations.async.CreateTaskProject2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTaskProject2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTaskProject2Request.class, new TypeReference<CreateTaskProject2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTaskProject2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateTaskProject2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateTaskProject2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateTaskProject2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateTaskProject2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TaskProject>() {})
                            .thenApply(res::withTaskProject);
                } else {
