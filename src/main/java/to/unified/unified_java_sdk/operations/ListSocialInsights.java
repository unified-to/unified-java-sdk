...
public class ListSocialInsights {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSocialInsightsRequest, ListSocialInsightsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSocialInsightsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSocialInsightsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSocialInsightsRequest request) {
        ...
        @Override
        public ListSocialInsightsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSocialInsightsResponse.Builder resBuilder =
            ...
            ListSocialInsightsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSocialInsights(Utils.unmarshal(response, new TypeReference<List<SocialInsight>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSocialInsightsRequest, to.unified.unified_java_sdk.models.operations.async.ListSocialInsightsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSocialInsightsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSocialInsightsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSocialInsightsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListSocialInsightsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListSocialInsightsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListSocialInsightsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListSocialInsightsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<SocialInsight>>() {})
                            .thenApply(res::withSocialInsights);
                } else {
