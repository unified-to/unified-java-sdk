...
public class GetUnifiedApicall {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUnifiedApicallRequest request) {
        ...
        @Override
        public GetUnifiedApicallResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withApiCall(Utils.unmarshal(response, new TypeReference<ApiCall>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetUnifiedApicallResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ApiCall>() {})
                            .thenApply(res::withApiCall);
                } else {
