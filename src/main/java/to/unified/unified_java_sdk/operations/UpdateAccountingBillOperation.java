...
public class UpdateAccountingBillOperation implements RequestOperation<UpdateAccountingBillRequest, UpdateAccountingBillResponse> {
    ...
    public UpdateAccountingBillOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAccountingBillRequest request) throws Exception {
