...
public class PatchLmsInstructorOperation implements RequestOperation<PatchLmsInstructorRequest, PatchLmsInstructorResponse> {
    ...
    public PatchLmsInstructorOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchLmsInstructorRequest request) throws Exception {
