...
public class UpdateAccountingTaxrateOperation implements RequestOperation<UpdateAccountingTaxrateRequest, UpdateAccountingTaxrateResponse> {
    ...
    public UpdateAccountingTaxrateOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAccountingTaxrateRequest request) throws Exception {
