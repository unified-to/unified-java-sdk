...
public class CreateTicketingCustomerOperation implements RequestOperation<CreateTicketingCustomerRequest, CreateTicketingCustomerResponse> {
    ...
    public CreateTicketingCustomerOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateTicketingCustomerRequest request) throws Exception {
