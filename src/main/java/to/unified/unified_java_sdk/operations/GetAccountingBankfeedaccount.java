...
public class GetAccountingBankfeedaccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingBankfeedaccountRequest, GetAccountingBankfeedaccountResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingBankfeedaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingBankfeedaccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingBankfeedaccountRequest request) {
        ...
        @Override
        public GetAccountingBankfeedaccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingBankfeedaccountResponse.Builder resBuilder =
                    GetAccountingBankfeedaccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetAccountingBankfeedaccountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingBankfeedaccountRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingBankfeedaccountResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingBankfeedaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingBankfeedaccountRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingBankfeedaccountRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingBankfeedaccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingBankfeedaccountResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingBankfeedaccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingBankfeedaccountResponse res = resBuilder.build();
