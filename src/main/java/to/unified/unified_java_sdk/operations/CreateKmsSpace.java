...
public class CreateKmsSpace {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateKmsSpaceRequest, CreateKmsSpaceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateKmsSpaceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateKmsSpaceRequest.class, new TypeReference<CreateKmsSpaceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateKmsSpaceRequest request) {
        ...
        @Override
        public CreateKmsSpaceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateKmsSpaceResponse.Builder resBuilder =
            ...
            CreateKmsSpaceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateKmsSpaceRequest, to.unified.unified_java_sdk.models.operations.async.CreateKmsSpaceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateKmsSpaceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateKmsSpaceRequest.class, new TypeReference<CreateKmsSpaceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateKmsSpaceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateKmsSpaceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateKmsSpaceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateKmsSpaceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateKmsSpaceResponse res = resBuilder.build();
