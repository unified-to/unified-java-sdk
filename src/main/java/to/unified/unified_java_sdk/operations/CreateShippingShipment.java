...
public class CreateShippingShipment {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateShippingShipmentRequest, CreateShippingShipmentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateShippingShipmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateShippingShipmentRequest.class, new TypeReference<CreateShippingShipmentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateShippingShipmentRequest request) {
        ...
        @Override
        public CreateShippingShipmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateShippingShipmentResponse.Builder resBuilder =
            ...
            CreateShippingShipmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateShippingShipmentRequest, to.unified.unified_java_sdk.models.operations.async.CreateShippingShipmentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateShippingShipmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateShippingShipmentRequest.class, new TypeReference<CreateShippingShipmentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateShippingShipmentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateShippingShipmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateShippingShipmentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateShippingShipmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateShippingShipmentResponse res = resBuilder.build();
