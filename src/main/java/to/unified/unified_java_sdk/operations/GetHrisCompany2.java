...
public class GetHrisCompany2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisCompany2Request, GetHrisCompany2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisCompany2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisCompany2Request request) {
        ...
        @Override
        public GetHrisCompany2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisCompany2Response.Builder resBuilder =
            ...
            GetHrisCompany2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisCompany2Request, to.unified.unified_java_sdk.models.operations.async.GetHrisCompany2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisCompany2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisCompany2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisCompany2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisCompany2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisCompany2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisCompany2Response res = resBuilder.build();
