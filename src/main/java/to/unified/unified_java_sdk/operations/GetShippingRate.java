...
public class GetShippingRate {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetShippingRateRequest, GetShippingRateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetShippingRateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingRateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetShippingRateRequest request) {
        ...
        @Override
        public GetShippingRateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetShippingRateResponse.Builder resBuilder =
            ...
            GetShippingRateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetShippingRateRequest, to.unified.unified_java_sdk.models.operations.async.GetShippingRateResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetShippingRateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingRateRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetShippingRateRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetShippingRateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetShippingRateResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetShippingRateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetShippingRateResponse res = resBuilder.build();
