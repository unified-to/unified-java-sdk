...
public class ListHrisGroups2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisGroups2Request, ListHrisGroups2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisGroups2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisGroups2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisGroups2Request request) {
        ...
        @Override
        public ListHrisGroups2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisGroups2Response.Builder resBuilder =
            ...
            ListHrisGroups2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisGroups(Utils.unmarshal(response, new TypeReference<List<HrisGroup>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisGroups2Request, to.unified.unified_java_sdk.models.operations.async.ListHrisGroups2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisGroups2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisGroups2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisGroups2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisGroups2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisGroups2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisGroups2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisGroups2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<HrisGroup>>() {})
                            .thenApply(res::withHrisGroups);
                } else {
