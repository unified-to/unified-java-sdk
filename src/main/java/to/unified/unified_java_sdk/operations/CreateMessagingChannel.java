...
public class CreateMessagingChannel {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateMessagingChannelRequest, CreateMessagingChannelResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateMessagingChannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMessagingChannelRequest.class, new TypeReference<CreateMessagingChannelRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMessagingChannelRequest request) {
        ...
        @Override
        public CreateMessagingChannelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateMessagingChannelResponse.Builder resBuilder =
            ...
            CreateMessagingChannelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateMessagingChannelRequest, to.unified.unified_java_sdk.models.operations.async.CreateMessagingChannelResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateMessagingChannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMessagingChannelRequest.class, new TypeReference<CreateMessagingChannelRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateMessagingChannelRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateMessagingChannelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateMessagingChannelResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateMessagingChannelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateMessagingChannelResponse res = resBuilder.build();
