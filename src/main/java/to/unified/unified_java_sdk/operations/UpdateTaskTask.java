...
public class UpdateTaskTask {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTaskTaskRequest, UpdateTaskTaskResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTaskTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTaskTaskRequest.class, new TypeReference<UpdateTaskTaskRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTaskTaskRequest request) {
        ...
        @Override
        public UpdateTaskTaskResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTaskTaskResponse.Builder resBuilder =
            ...
            UpdateTaskTaskResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateTaskTaskRequest, to.unified.unified_java_sdk.models.operations.async.UpdateTaskTaskResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateTaskTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTaskTaskRequest.class, new TypeReference<UpdateTaskTaskRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateTaskTaskRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateTaskTaskResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateTaskTaskResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateTaskTaskResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateTaskTaskResponse res = resBuilder.build();
