...
public class ListHrisDevices2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisDevices2Request, ListHrisDevices2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisDevices2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisDevices2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisDevices2Request request) {
        ...
        @Override
        public ListHrisDevices2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisDevices2Response.Builder resBuilder =
            ...
            ListHrisDevices2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisDevices(Utils.unmarshal(response, new TypeReference<List<HrisDevice>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisDevices2Request, to.unified.unified_java_sdk.models.operations.async.ListHrisDevices2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisDevices2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisDevices2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisDevices2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisDevices2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisDevices2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisDevices2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisDevices2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<HrisDevice>>() {})
                            .thenApply(res::withHrisDevices);
                } else {
