...
public class CreateHrisLocationOperation implements RequestOperation<CreateHrisLocationRequest, CreateHrisLocationResponse> {
    ...
    public CreateHrisLocationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateHrisLocationRequest request) throws Exception {
