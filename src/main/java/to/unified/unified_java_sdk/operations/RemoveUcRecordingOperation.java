...
public class RemoveUcRecordingOperation implements RequestOperation<RemoveUcRecordingRequest, RemoveUcRecordingResponse> {
    ...
    public RemoveUcRecordingOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveUcRecordingRequest request) throws Exception {
