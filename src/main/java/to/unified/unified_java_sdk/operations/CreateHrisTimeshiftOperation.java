...
public class CreateHrisTimeshiftOperation implements RequestOperation<CreateHrisTimeshiftRequest, CreateHrisTimeshiftResponse> {
    ...
    public CreateHrisTimeshiftOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateHrisTimeshiftRequest request) throws Exception {
