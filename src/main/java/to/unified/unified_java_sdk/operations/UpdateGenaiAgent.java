...
public class UpdateGenaiAgent {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateGenaiAgentRequest, UpdateGenaiAgentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateGenaiAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateGenaiAgentRequest.class, new TypeReference<UpdateGenaiAgentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateGenaiAgentRequest request) {
        ...
        @Override
        public UpdateGenaiAgentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateGenaiAgentResponse.Builder resBuilder =
            ...
            UpdateGenaiAgentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateGenaiAgentRequest, to.unified.unified_java_sdk.models.operations.async.UpdateGenaiAgentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateGenaiAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateGenaiAgentRequest.class, new TypeReference<UpdateGenaiAgentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateGenaiAgentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateGenaiAgentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateGenaiAgentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateGenaiAgentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateGenaiAgentResponse res = resBuilder.build();
