...
public class UpdateUnifiedConnectionOperation implements RequestOperation<UpdateUnifiedConnectionRequest, UpdateUnifiedConnectionResponse> {
    ...
    public UpdateUnifiedConnectionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateUnifiedConnectionRequest request) throws Exception {
