...
public class GetTicketingTicket {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTicketingTicketRequest, GetTicketingTicketResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTicketingTicketRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTicketingTicketRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTicketingTicketRequest request) {
        ...
        @Override
        public GetTicketingTicketResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTicketingTicketResponse.Builder resBuilder =
            ...
            GetTicketingTicketResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTicketingTicketRequest, to.unified.unified_java_sdk.models.operations.async.GetTicketingTicketResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTicketingTicketRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTicketingTicketRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTicketingTicketRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetTicketingTicketResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetTicketingTicketResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetTicketingTicketResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetTicketingTicketResponse res = resBuilder.build();
