...
public class RemoveCommerceSaleschannel2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCommerceSaleschannel2Request, RemoveCommerceSaleschannel2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCommerceSaleschannel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceSaleschannel2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCommerceSaleschannel2Request request) {
        ...
        @Override
        public RemoveCommerceSaleschannel2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCommerceSaleschannel2Response.Builder resBuilder =
            ...
            RemoveCommerceSaleschannel2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCommerceSaleschannel2Request, to.unified.unified_java_sdk.models.operations.async.RemoveCommerceSaleschannel2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCommerceSaleschannel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceSaleschannel2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCommerceSaleschannel2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCommerceSaleschannel2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceSaleschannel2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCommerceSaleschannel2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceSaleschannel2Response res = resBuilder.build();
