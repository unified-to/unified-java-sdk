...
public class CreatePaymentSubscriptionOperation implements RequestOperation<CreatePaymentSubscriptionRequest, CreatePaymentSubscriptionResponse> {
    ...
    public CreatePaymentSubscriptionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreatePaymentSubscriptionRequest request) throws Exception {
