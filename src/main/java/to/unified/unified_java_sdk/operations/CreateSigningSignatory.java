...
public class CreateSigningSignatory {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateSigningSignatoryRequest, CreateSigningSignatoryResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateSigningSignatoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSigningSignatoryRequest.class, new TypeReference<CreateSigningSignatoryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSigningSignatoryRequest request) {
        ...
        @Override
        public CreateSigningSignatoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSigningSignatoryResponse.Builder resBuilder =
            ...
            CreateSigningSignatoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateSigningSignatoryRequest, to.unified.unified_java_sdk.models.operations.async.CreateSigningSignatoryResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateSigningSignatoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSigningSignatoryRequest.class, new TypeReference<CreateSigningSignatoryRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateSigningSignatoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateSigningSignatoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateSigningSignatoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateSigningSignatoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateSigningSignatoryResponse res = resBuilder.build();
