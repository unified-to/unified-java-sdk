...
public class UpdateHrisTimeoff2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisTimeoff2Request, UpdateHrisTimeoff2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisTimeoff2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisTimeoff2Request.class, new TypeReference<UpdateHrisTimeoff2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisTimeoff2Request request) {
        ...
        @Override
        public UpdateHrisTimeoff2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisTimeoff2Response.Builder resBuilder =
            ...
            UpdateHrisTimeoff2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisTimeoff2Request, to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeoff2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisTimeoff2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisTimeoff2Request.class, new TypeReference<UpdateHrisTimeoff2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisTimeoff2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeoff2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeoff2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeoff2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisTimeoff2Response res = resBuilder.build();
