...
public class ListShippingTrackings {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListShippingTrackingsRequest, ListShippingTrackingsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListShippingTrackingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListShippingTrackingsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListShippingTrackingsRequest request) {
        ...
        @Override
        public ListShippingTrackingsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListShippingTrackingsResponse.Builder resBuilder =
            ...
            ListShippingTrackingsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListShippingTrackingsRequest, to.unified.unified_java_sdk.models.operations.async.ListShippingTrackingsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListShippingTrackingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListShippingTrackingsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListShippingTrackingsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListShippingTrackingsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListShippingTrackingsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListShippingTrackingsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListShippingTrackingsResponse res = resBuilder.build();
