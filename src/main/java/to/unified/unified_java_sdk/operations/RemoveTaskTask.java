...
public class RemoveTaskTask {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveTaskTaskRequest, RemoveTaskTaskResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveTaskTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTaskTaskRequest.class);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveTaskTaskRequest, to.unified.unified_java_sdk.models.operations.async.RemoveTaskTaskResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveTaskTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveTaskTaskRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveTaskTaskRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveTaskTaskResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveTaskTaskResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveTaskTaskResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveTaskTaskResponse res = resBuilder.build();
