...
public class PatchDatastoreTable {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchDatastoreTableRequest, PatchDatastoreTableResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchDatastoreTableRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchDatastoreTableRequest.class, new TypeReference<PatchDatastoreTableRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchDatastoreTableRequest request) {
        ...
        @Override
        public PatchDatastoreTableResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchDatastoreTableResponse.Builder resBuilder =
            ...
            PatchDatastoreTableResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchDatastoreTableRequest, to.unified.unified_java_sdk.models.operations.async.PatchDatastoreTableResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchDatastoreTableRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchDatastoreTableRequest.class, new TypeReference<PatchDatastoreTableRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchDatastoreTableRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchDatastoreTableResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchDatastoreTableResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchDatastoreTableResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchDatastoreTableResponse res = resBuilder.build();
