...
public class PatchLmsCourse2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchLmsCourse2Request, PatchLmsCourse2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchLmsCourse2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsCourse2Request.class, new TypeReference<PatchLmsCourse2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchLmsCourse2Request request) {
        ...
        @Override
        public PatchLmsCourse2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchLmsCourse2Response.Builder resBuilder =
            ...
            PatchLmsCourse2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchLmsCourse2Request, to.unified.unified_java_sdk.models.operations.async.PatchLmsCourse2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchLmsCourse2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsCourse2Request.class, new TypeReference<PatchLmsCourse2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchLmsCourse2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchLmsCourse2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchLmsCourse2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchLmsCourse2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchLmsCourse2Response res = resBuilder.build();
