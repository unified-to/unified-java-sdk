...
public class ListLmsStudents2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListLmsStudents2Request, ListLmsStudents2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListLmsStudents2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsStudents2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsStudents2Request request) {
        ...
        @Override
        public ListLmsStudents2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListLmsStudents2Response.Builder resBuilder =
            ...
            ListLmsStudents2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLmsStudents(Utils.unmarshal(response, new TypeReference<List<LmsStudent>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLmsStudents2Request, to.unified.unified_java_sdk.models.operations.async.ListLmsStudents2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListLmsStudents2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsStudents2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListLmsStudents2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListLmsStudents2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListLmsStudents2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListLmsStudents2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListLmsStudents2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<LmsStudent>>() {})
                            .thenApply(res::withLmsStudents);
                } else {
