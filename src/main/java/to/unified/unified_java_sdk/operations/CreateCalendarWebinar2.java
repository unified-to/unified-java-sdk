...
public class CreateCalendarWebinar2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCalendarWebinar2Request, CreateCalendarWebinar2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCalendarWebinar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCalendarWebinar2Request.class, new TypeReference<CreateCalendarWebinar2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCalendarWebinar2Request request) {
        ...
        @Override
        public CreateCalendarWebinar2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCalendarWebinar2Response.Builder resBuilder =
            ...
            CreateCalendarWebinar2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCalendarWebinar(Utils.unmarshal(response, new TypeReference<CalendarWebinar>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCalendarWebinar2Request, to.unified.unified_java_sdk.models.operations.async.CreateCalendarWebinar2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCalendarWebinar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCalendarWebinar2Request.class, new TypeReference<CreateCalendarWebinar2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCalendarWebinar2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCalendarWebinar2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCalendarWebinar2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCalendarWebinar2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCalendarWebinar2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CalendarWebinar>() {})
                            .thenApply(res::withCalendarWebinar);
                } else {
