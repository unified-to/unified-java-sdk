...
public class RemoveAssessmentPackage {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAssessmentPackageRequest, RemoveAssessmentPackageResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAssessmentPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAssessmentPackageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAssessmentPackageRequest request) {
        ...
        @Override
        public RemoveAssessmentPackageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAssessmentPackageResponse.Builder resBuilder =
            ...
            RemoveAssessmentPackageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAssessmentPackageRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAssessmentPackageResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAssessmentPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAssessmentPackageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAssessmentPackageRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAssessmentPackageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAssessmentPackageResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAssessmentPackageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAssessmentPackageResponse res = resBuilder.build();
