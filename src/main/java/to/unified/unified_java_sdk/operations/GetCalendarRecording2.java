...
public class GetCalendarRecording2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCalendarRecording2Request, GetCalendarRecording2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCalendarRecording2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarRecording2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCalendarRecording2Request request) {
        ...
        @Override
        public GetCalendarRecording2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCalendarRecording2Response.Builder resBuilder =
            ...
            GetCalendarRecording2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCalendarRecording2Request, to.unified.unified_java_sdk.models.operations.async.GetCalendarRecording2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCalendarRecording2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarRecording2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCalendarRecording2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCalendarRecording2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCalendarRecording2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCalendarRecording2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCalendarRecording2Response res = resBuilder.build();
