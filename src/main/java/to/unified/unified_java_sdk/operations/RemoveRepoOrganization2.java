...
public class RemoveRepoOrganization2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveRepoOrganization2Request, RemoveRepoOrganization2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveRepoOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoOrganization2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveRepoOrganization2Request request) {
        ...
        @Override
        public RemoveRepoOrganization2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveRepoOrganization2Response.Builder resBuilder =
            ...
            RemoveRepoOrganization2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveRepoOrganization2Request, to.unified.unified_java_sdk.models.operations.async.RemoveRepoOrganization2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveRepoOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoOrganization2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveRepoOrganization2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveRepoOrganization2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveRepoOrganization2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveRepoOrganization2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveRepoOrganization2Response res = resBuilder.build();
