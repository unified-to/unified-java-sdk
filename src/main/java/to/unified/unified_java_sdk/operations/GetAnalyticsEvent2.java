...
public class GetAnalyticsEvent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAnalyticsEvent2Request, GetAnalyticsEvent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAnalyticsEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAnalyticsEvent2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAnalyticsEvent2Request request) {
        ...
        @Override
        public GetAnalyticsEvent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAnalyticsEvent2Response.Builder resBuilder =
            ...
            GetAnalyticsEvent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAnalyticsEvent2Request, to.unified.unified_java_sdk.models.operations.async.GetAnalyticsEvent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAnalyticsEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAnalyticsEvent2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAnalyticsEvent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAnalyticsEvent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAnalyticsEvent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAnalyticsEvent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAnalyticsEvent2Response res = resBuilder.build();
