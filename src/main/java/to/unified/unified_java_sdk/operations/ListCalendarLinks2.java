...
public class ListCalendarLinks2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCalendarLinks2Request, ListCalendarLinks2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCalendarLinks2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarLinks2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarLinks2Request request) {
        ...
        @Override
        public ListCalendarLinks2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCalendarLinks2Response.Builder resBuilder =
            ...
            ListCalendarLinks2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCalendarLinks(Utils.unmarshal(response, new TypeReference<List<CalendarLink>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCalendarLinks2Request, to.unified.unified_java_sdk.models.operations.async.ListCalendarLinks2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCalendarLinks2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarLinks2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCalendarLinks2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCalendarLinks2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCalendarLinks2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCalendarLinks2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCalendarLinks2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CalendarLink>>() {})
                            .thenApply(res::withCalendarLinks);
                } else {
