...
public class PatchRepoCommit2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchRepoCommit2Request, PatchRepoCommit2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchRepoCommit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoCommit2Request.class, new TypeReference<PatchRepoCommit2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchRepoCommit2Request request) {
        ...
        @Override
        public PatchRepoCommit2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchRepoCommit2Response.Builder resBuilder =
            ...
            PatchRepoCommit2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchRepoCommit2Request, to.unified.unified_java_sdk.models.operations.async.PatchRepoCommit2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchRepoCommit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoCommit2Request.class, new TypeReference<PatchRepoCommit2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchRepoCommit2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchRepoCommit2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchRepoCommit2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchRepoCommit2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchRepoCommit2Response res = resBuilder.build();
