...
public class UpdateAtsScorecard {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAtsScorecardRequest, UpdateAtsScorecardResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAtsScorecardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsScorecardRequest.class, new TypeReference<UpdateAtsScorecardRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsScorecardRequest request) {
        ...
        @Override
        public UpdateAtsScorecardResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAtsScorecardResponse.Builder resBuilder =
            ...
            UpdateAtsScorecardResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAtsScorecardRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAtsScorecardResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAtsScorecardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsScorecardRequest.class, new TypeReference<UpdateAtsScorecardRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAtsScorecardRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAtsScorecardResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAtsScorecardResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAtsScorecardResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAtsScorecardResponse res = resBuilder.build();
