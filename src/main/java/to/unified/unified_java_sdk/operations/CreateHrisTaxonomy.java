...
public class CreateHrisTaxonomy {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisTaxonomyRequest, CreateHrisTaxonomyResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisTaxonomyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisTaxonomyRequest.class, new TypeReference<CreateHrisTaxonomyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisTaxonomyRequest request) {
        ...
        @Override
        public CreateHrisTaxonomyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisTaxonomyResponse.Builder resBuilder =
            ...
            CreateHrisTaxonomyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisTaxonomy(Utils.unmarshal(response, new TypeReference<HrisTaxonomy>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisTaxonomyRequest, to.unified.unified_java_sdk.models.operations.async.CreateHrisTaxonomyResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisTaxonomyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisTaxonomyRequest.class, new TypeReference<CreateHrisTaxonomyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisTaxonomyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisTaxonomyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisTaxonomyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisTaxonomyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisTaxonomyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HrisTaxonomy>() {})
                            .thenApply(res::withHrisTaxonomy);
                } else {
