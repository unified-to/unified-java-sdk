...
public class ListCdpSources {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCdpSourcesRequest, ListCdpSourcesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCdpSourcesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCdpSourcesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCdpSourcesRequest request) {
        ...
        @Override
        public ListCdpSourcesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCdpSourcesResponse.Builder resBuilder =
            ...
            ListCdpSourcesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCdpSources(Utils.unmarshal(response, new TypeReference<List<CdpSource>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCdpSourcesRequest, to.unified.unified_java_sdk.models.operations.async.ListCdpSourcesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCdpSourcesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCdpSourcesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCdpSourcesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCdpSourcesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCdpSourcesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCdpSourcesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCdpSourcesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CdpSource>>() {})
                            .thenApply(res::withCdpSources);
                } else {
