...
public class ListPerformanceGoals {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPerformanceGoalsRequest, ListPerformanceGoalsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPerformanceGoalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPerformanceGoalsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPerformanceGoalsRequest request) {
        ...
        @Override
        public ListPerformanceGoalsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPerformanceGoalsResponse.Builder resBuilder =
            ...
            ListPerformanceGoalsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPerformanceGoals(Utils.unmarshal(response, new TypeReference<List<PerformanceGoal>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPerformanceGoalsRequest, to.unified.unified_java_sdk.models.operations.async.ListPerformanceGoalsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPerformanceGoalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPerformanceGoalsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPerformanceGoalsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListPerformanceGoalsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListPerformanceGoalsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListPerformanceGoalsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListPerformanceGoalsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<PerformanceGoal>>() {})
                            .thenApply(res::withPerformanceGoals);
                } else {
