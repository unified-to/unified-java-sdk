...
public class GetShippingTracking2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetShippingTracking2Request, GetShippingTracking2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetShippingTracking2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingTracking2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetShippingTracking2Request request) {
        ...
        @Override
        public GetShippingTracking2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetShippingTracking2Response.Builder resBuilder =
            ...
            GetShippingTracking2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetShippingTracking2Request, to.unified.unified_java_sdk.models.operations.async.GetShippingTracking2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetShippingTracking2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingTracking2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetShippingTracking2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetShippingTracking2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetShippingTracking2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetShippingTracking2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetShippingTracking2Response res = resBuilder.build();
