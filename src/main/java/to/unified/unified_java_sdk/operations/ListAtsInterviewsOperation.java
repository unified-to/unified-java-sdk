...
public class ListAtsInterviewsOperation implements RequestOperation<ListAtsInterviewsRequest, ListAtsInterviewsResponse> {
    ...
    public ListAtsInterviewsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAtsInterviewsRequest request) throws Exception {
