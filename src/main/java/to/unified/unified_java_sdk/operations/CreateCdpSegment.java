...
public class CreateCdpSegment {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCdpSegmentRequest, CreateCdpSegmentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCdpSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCdpSegmentRequest.class, new TypeReference<CreateCdpSegmentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCdpSegmentRequest request) {
        ...
        @Override
        public CreateCdpSegmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCdpSegmentResponse.Builder resBuilder =
            ...
            CreateCdpSegmentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCdpSegment(Utils.unmarshal(response, new TypeReference<CdpSegment>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCdpSegmentRequest, to.unified.unified_java_sdk.models.operations.async.CreateCdpSegmentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCdpSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCdpSegmentRequest.class, new TypeReference<CreateCdpSegmentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCdpSegmentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCdpSegmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCdpSegmentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCdpSegmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCdpSegmentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CdpSegment>() {})
                            .thenApply(res::withCdpSegment);
                } else {
