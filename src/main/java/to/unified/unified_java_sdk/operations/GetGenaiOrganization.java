...
public class GetGenaiOrganization {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetGenaiOrganizationRequest, GetGenaiOrganizationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetGenaiOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetGenaiOrganizationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetGenaiOrganizationRequest request) {
        ...
        @Override
        public GetGenaiOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetGenaiOrganizationResponse.Builder resBuilder =
                    GetGenaiOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetGenaiOrganizationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetGenaiOrganizationRequest, to.unified.unified_java_sdk.models.operations.async.GetGenaiOrganizationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetGenaiOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetGenaiOrganizationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetGenaiOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetGenaiOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetGenaiOrganizationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetGenaiOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetGenaiOrganizationResponse res = resBuilder.build();
