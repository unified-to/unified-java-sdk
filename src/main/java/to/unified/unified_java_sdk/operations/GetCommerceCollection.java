...
public class GetCommerceCollection {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceCollectionRequest, GetCommerceCollectionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommerceCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceCollectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceCollectionRequest request) {
        ...
        @Override
        public GetCommerceCollectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommerceCollectionResponse.Builder resBuilder =
            ...
            GetCommerceCollectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommerceCollectionRequest, to.unified.unified_java_sdk.models.operations.async.GetCommerceCollectionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommerceCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceCollectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommerceCollectionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCommerceCollectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCommerceCollectionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCommerceCollectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCommerceCollectionResponse res = resBuilder.build();
