...
public class UpdateCrmDeal {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCrmDealRequest, UpdateCrmDealResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCrmDealRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmDealRequest.class, new TypeReference<UpdateCrmDealRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCrmDealRequest request) {
        ...
        @Override
        public UpdateCrmDealResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCrmDealResponse.Builder resBuilder =
            ...
            UpdateCrmDealResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCrmDealRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCrmDealResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCrmDealRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmDealRequest.class, new TypeReference<UpdateCrmDealRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCrmDealRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCrmDealResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCrmDealResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCrmDealResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCrmDealResponse res = resBuilder.build();
