...
public class PatchAccountingJournal {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingJournalRequest, PatchAccountingJournalResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingJournalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingJournalRequest.class, new TypeReference<PatchAccountingJournalRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingJournalRequest request) {
        ...
        @Override
        public PatchAccountingJournalResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingJournalResponse.Builder resBuilder =
            ...
            PatchAccountingJournalResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingJournalRequest, to.unified.unified_java_sdk.models.operations.async.PatchAccountingJournalResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingJournalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingJournalRequest.class, new TypeReference<PatchAccountingJournalRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingJournalRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingJournalResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingJournalResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingJournalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingJournalResponse res = resBuilder.build();
