...
public class RemoveScimGroups {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveScimGroupsRequest, RemoveScimGroupsResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveScimGroupsRequest request) throws Exception {
        ...
        @Override
        public RemoveScimGroupsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveScimGroupsResponse.Builder resBuilder =
            ...
            RemoveScimGroupsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveScimGroupsRequest, to.unified.unified_java_sdk.models.operations.async.RemoveScimGroupsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveScimGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveScimGroupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveScimGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveScimGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveScimGroupsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveScimGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveScimGroupsResponse res = resBuilder.build();
