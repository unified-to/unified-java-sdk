...
public class PatchHrisTimeoff2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisTimeoff2Request, PatchHrisTimeoff2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisTimeoff2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisTimeoff2Request.class, new TypeReference<PatchHrisTimeoff2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisTimeoff2Request request) {
        ...
        @Override
        public PatchHrisTimeoff2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisTimeoff2Response.Builder resBuilder =
            ...
            PatchHrisTimeoff2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisTimeoff2Request, to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeoff2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisTimeoff2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisTimeoff2Request.class, new TypeReference<PatchHrisTimeoff2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisTimeoff2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeoff2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeoff2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeoff2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeoff2Response res = resBuilder.build();
