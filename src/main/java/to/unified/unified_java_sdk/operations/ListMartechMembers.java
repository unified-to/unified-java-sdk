...
public class ListMartechMembers {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMartechMembersRequest, ListMartechMembersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListMartechMembersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMartechMembersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMartechMembersRequest request) {
        ...
        @Override
        public ListMartechMembersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMartechMembersResponse.Builder resBuilder =
            ...
            ListMartechMembersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMartechMembersRequest, to.unified.unified_java_sdk.models.operations.async.ListMartechMembersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMartechMembersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMartechMembersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMartechMembersRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListMartechMembersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListMartechMembersResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListMartechMembersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListMartechMembersResponse res = resBuilder.build();
