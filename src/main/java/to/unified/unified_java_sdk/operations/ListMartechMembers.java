...
public class ListMartechMembers {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMartechMembersRequest request) throws Exception {
        ...
        @Override
        public ListMartechMembersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<MarketingMember> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMarketingMembers(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
