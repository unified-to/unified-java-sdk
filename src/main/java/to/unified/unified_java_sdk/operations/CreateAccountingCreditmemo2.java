...
public class CreateAccountingCreditmemo2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAccountingCreditmemo2Request, CreateAccountingCreditmemo2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAccountingCreditmemo2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingCreditmemo2Request.class, new TypeReference<CreateAccountingCreditmemo2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingCreditmemo2Request request) {
        ...
        @Override
        public CreateAccountingCreditmemo2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAccountingCreditmemo2Response.Builder resBuilder =
            ...
            CreateAccountingCreditmemo2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAccountingCreditmemo2Request, to.unified.unified_java_sdk.models.operations.async.CreateAccountingCreditmemo2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAccountingCreditmemo2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingCreditmemo2Request.class, new TypeReference<CreateAccountingCreditmemo2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAccountingCreditmemo2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAccountingCreditmemo2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAccountingCreditmemo2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAccountingCreditmemo2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAccountingCreditmemo2Response res = resBuilder.build();
