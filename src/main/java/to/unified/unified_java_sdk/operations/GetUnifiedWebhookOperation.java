...
public class GetUnifiedWebhookOperation implements RequestOperation<GetUnifiedWebhookRequest, GetUnifiedWebhookResponse> {
    ...
    public GetUnifiedWebhookOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetUnifiedWebhookRequest request) throws Exception {
