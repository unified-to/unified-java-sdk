...
public class GetAccountingJournalOperation implements RequestOperation<GetAccountingJournalRequest, GetAccountingJournalResponse> {
    ...
    public GetAccountingJournalOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountingJournalRequest request) throws Exception {
