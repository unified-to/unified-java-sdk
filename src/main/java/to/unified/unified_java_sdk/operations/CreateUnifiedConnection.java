...
public class CreateUnifiedConnection {
    ...
    public static class Sync extends Base
            implements RequestOperation<Connection, CreateUnifiedConnectionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(Connection request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Connection>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Connection request) {
        ...
        @Override
        public CreateUnifiedConnectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateUnifiedConnectionResponse.Builder resBuilder =
            ...
            CreateUnifiedConnectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Connection, to.unified.unified_java_sdk.models.operations.async.CreateUnifiedConnectionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(Connection request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Connection>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Connection request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateUnifiedConnectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateUnifiedConnectionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateUnifiedConnectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateUnifiedConnectionResponse res = resBuilder.build();
