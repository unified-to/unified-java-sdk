...
public class PatchUcContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchUcContactRequest, PatchUcContactResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchUcContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUcContactRequest.class, new TypeReference<PatchUcContactRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchUcContactRequest request) {
        ...
        @Override
        public PatchUcContactResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchUcContactResponse.Builder resBuilder =
            ...
            PatchUcContactResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchUcContactRequest, to.unified.unified_java_sdk.models.operations.async.PatchUcContactResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchUcContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUcContactRequest.class, new TypeReference<PatchUcContactRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchUcContactRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchUcContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchUcContactResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchUcContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchUcContactResponse res = resBuilder.build();
