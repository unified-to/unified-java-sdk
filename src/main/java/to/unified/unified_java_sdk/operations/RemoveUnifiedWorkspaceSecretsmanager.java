...
public class RemoveUnifiedWorkspaceSecretsmanager {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveUnifiedWorkspaceSecretsmanagerRequest, RemoveUnifiedWorkspaceSecretsmanagerResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveUnifiedWorkspaceSecretsmanagerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUnifiedWorkspaceSecretsmanagerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveUnifiedWorkspaceSecretsmanagerRequest request) {
        ...
        @Override
        public RemoveUnifiedWorkspaceSecretsmanagerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveUnifiedWorkspaceSecretsmanagerResponse.Builder resBuilder =
            ...
            RemoveUnifiedWorkspaceSecretsmanagerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveUnifiedWorkspaceSecretsmanagerRequest, to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedWorkspaceSecretsmanagerResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveUnifiedWorkspaceSecretsmanagerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUnifiedWorkspaceSecretsmanagerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveUnifiedWorkspaceSecretsmanagerRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedWorkspaceSecretsmanagerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedWorkspaceSecretsmanagerResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedWorkspaceSecretsmanagerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedWorkspaceSecretsmanagerResponse res = resBuilder.build();
