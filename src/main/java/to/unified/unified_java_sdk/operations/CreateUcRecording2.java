...
public class CreateUcRecording2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateUcRecording2Request, CreateUcRecording2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateUcRecording2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateUcRecording2Request.class, new TypeReference<CreateUcRecording2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateUcRecording2Request request) {
        ...
        @Override
        public CreateUcRecording2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateUcRecording2Response.Builder resBuilder =
            ...
            CreateUcRecording2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateUcRecording2Request, to.unified.unified_java_sdk.models.operations.async.CreateUcRecording2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateUcRecording2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateUcRecording2Request.class, new TypeReference<CreateUcRecording2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateUcRecording2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateUcRecording2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateUcRecording2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateUcRecording2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateUcRecording2Response res = resBuilder.build();
