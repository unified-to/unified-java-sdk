...
public class CreatePaymentSubscription {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePaymentSubscriptionRequest, CreatePaymentSubscriptionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreatePaymentSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentSubscriptionRequest.class, new TypeReference<CreatePaymentSubscriptionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePaymentSubscriptionRequest request) {
        ...
        @Override
        public CreatePaymentSubscriptionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePaymentSubscriptionResponse.Builder resBuilder =
            ...
            CreatePaymentSubscriptionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePaymentSubscriptionRequest, to.unified.unified_java_sdk.models.operations.async.CreatePaymentSubscriptionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreatePaymentSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentSubscriptionRequest.class, new TypeReference<CreatePaymentSubscriptionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePaymentSubscriptionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreatePaymentSubscriptionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreatePaymentSubscriptionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreatePaymentSubscriptionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreatePaymentSubscriptionResponse res = resBuilder.build();
