...
public class GetTicketingTicket2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTicketingTicket2Request, GetTicketingTicket2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTicketingTicket2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetTicketingTicket2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTicketingTicket2Request request) {
        ...
        @Override
        public GetTicketingTicket2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTicketingTicket2Response.Builder resBuilder =
            ...
            GetTicketingTicket2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTicketingTicket2Request, to.unified.unified_java_sdk.models.operations.async.GetTicketingTicket2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTicketingTicket2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetTicketingTicket2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTicketingTicket2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetTicketingTicket2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetTicketingTicket2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetTicketingTicket2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetTicketingTicket2Response res = resBuilder.build();
