...
public class UpdateAdsOrganization {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAdsOrganizationRequest, UpdateAdsOrganizationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAdsOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsOrganizationRequest.class, new TypeReference<UpdateAdsOrganizationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAdsOrganizationRequest request) {
        ...
        @Override
        public UpdateAdsOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAdsOrganizationResponse.Builder resBuilder =
            ...
            UpdateAdsOrganizationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAdsOrganizationRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAdsOrganizationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAdsOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsOrganizationRequest.class, new TypeReference<UpdateAdsOrganizationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAdsOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAdsOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAdsOrganizationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAdsOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAdsOrganizationResponse res = resBuilder.build();
