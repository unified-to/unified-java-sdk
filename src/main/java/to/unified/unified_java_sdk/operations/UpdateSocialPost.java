...
public class UpdateSocialPost {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateSocialPostRequest, UpdateSocialPostResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateSocialPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSocialPostRequest.class, new TypeReference<UpdateSocialPostRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateSocialPostRequest request) {
        ...
        @Override
        public UpdateSocialPostResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateSocialPostResponse.Builder resBuilder =
            ...
            UpdateSocialPostResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSocialPost(Utils.unmarshal(response, new TypeReference<SocialPost>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateSocialPostRequest, to.unified.unified_java_sdk.models.operations.async.UpdateSocialPostResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateSocialPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSocialPostRequest.class, new TypeReference<UpdateSocialPostRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateSocialPostRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateSocialPostResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateSocialPostResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateSocialPostResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateSocialPostResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SocialPost>() {})
                            .thenApply(res::withSocialPost);
                } else {
