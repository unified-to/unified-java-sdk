...
public class PatchAtsCandidate2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAtsCandidate2Request, PatchAtsCandidate2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAtsCandidate2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsCandidate2Request.class, new TypeReference<PatchAtsCandidate2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAtsCandidate2Request request) {
        ...
        @Override
        public PatchAtsCandidate2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAtsCandidate2Response.Builder resBuilder =
            ...
            PatchAtsCandidate2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAtsCandidate2Request, to.unified.unified_java_sdk.models.operations.async.PatchAtsCandidate2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAtsCandidate2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsCandidate2Request.class, new TypeReference<PatchAtsCandidate2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAtsCandidate2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAtsCandidate2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAtsCandidate2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAtsCandidate2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAtsCandidate2Response res = resBuilder.build();
