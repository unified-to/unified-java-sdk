...
public class PatchHrisLocationOperation implements RequestOperation<PatchHrisLocationRequest, PatchHrisLocationResponse> {
    ...
    public PatchHrisLocationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchHrisLocationRequest request) throws Exception {
