...
public class CreateCommerceCollection {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommerceCollectionRequest, CreateCommerceCollectionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommerceCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceCollectionRequest.class, new TypeReference<CreateCommerceCollectionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceCollectionRequest request) {
        ...
        @Override
        public CreateCommerceCollectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommerceCollectionResponse.Builder resBuilder =
            ...
            CreateCommerceCollectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommerceCollectionRequest, to.unified.unified_java_sdk.models.operations.async.CreateCommerceCollectionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommerceCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceCollectionRequest.class, new TypeReference<CreateCommerceCollectionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommerceCollectionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCommerceCollectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCommerceCollectionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCommerceCollectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCommerceCollectionResponse res = resBuilder.build();
