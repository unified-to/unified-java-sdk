...
public class CreateHrisGroupOperation implements RequestOperation<CreateHrisGroupRequest, CreateHrisGroupResponse> {
    ...
    public CreateHrisGroupOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateHrisGroupRequest request) throws Exception {
