...
public class PatchAssessmentPackage2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAssessmentPackage2Request, PatchAssessmentPackage2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAssessmentPackage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAssessmentPackage2Request.class, new TypeReference<PatchAssessmentPackage2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAssessmentPackage2Request request) {
        ...
        @Override
        public PatchAssessmentPackage2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAssessmentPackage2Response.Builder resBuilder =
            ...
            PatchAssessmentPackage2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAssessmentPackage2Request, to.unified.unified_java_sdk.models.operations.async.PatchAssessmentPackage2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAssessmentPackage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAssessmentPackage2Request.class, new TypeReference<PatchAssessmentPackage2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAssessmentPackage2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAssessmentPackage2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAssessmentPackage2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAssessmentPackage2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAssessmentPackage2Response res = resBuilder.build();
