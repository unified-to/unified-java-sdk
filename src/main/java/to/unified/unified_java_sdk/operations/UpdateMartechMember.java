...
public class UpdateMartechMember {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMartechMemberRequest, UpdateMartechMemberResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateMartechMemberRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMartechMemberRequest.class, new TypeReference<UpdateMartechMemberRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMartechMemberRequest request) {
        ...
        @Override
        public UpdateMartechMemberResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMartechMemberRequest, to.unified.unified_java_sdk.models.operations.async.UpdateMartechMemberResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMartechMemberRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMartechMemberRequest.class, new TypeReference<UpdateMartechMemberRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMartechMemberRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateMartechMemberResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateMartechMemberResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateMartechMemberResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateMartechMemberResponse res = resBuilder.build();
