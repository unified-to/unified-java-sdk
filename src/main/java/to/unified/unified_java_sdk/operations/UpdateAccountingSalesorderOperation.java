...
public class UpdateAccountingSalesorderOperation implements RequestOperation<UpdateAccountingSalesorderRequest, UpdateAccountingSalesorderResponse> {
    ...
    public UpdateAccountingSalesorderOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAccountingSalesorderRequest request) throws Exception {
