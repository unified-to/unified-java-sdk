...
public class UpdateAdsAd {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAdsAdRequest, UpdateAdsAdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAdsAdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsAdRequest.class, new TypeReference<UpdateAdsAdRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAdsAdRequest request) {
        ...
        @Override
        public UpdateAdsAdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAdsAdResponse.Builder resBuilder =
                    UpdateAdsAdResponse
                            .builder()
            ...
            UpdateAdsAdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAdsAdRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAdsAdResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAdsAdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsAdRequest.class, new TypeReference<UpdateAdsAdRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAdsAdRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAdsAdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAdsAdResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAdsAdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAdsAdResponse res = resBuilder.build();
