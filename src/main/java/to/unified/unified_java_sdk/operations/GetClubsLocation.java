...
public class GetClubsLocation {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetClubsLocationRequest, GetClubsLocationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetClubsLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsLocationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClubsLocationRequest request) {
        ...
        @Override
        public GetClubsLocationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetClubsLocationResponse.Builder resBuilder =
            ...
            GetClubsLocationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetClubsLocationRequest, to.unified.unified_java_sdk.models.operations.async.GetClubsLocationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetClubsLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsLocationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetClubsLocationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetClubsLocationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetClubsLocationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetClubsLocationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetClubsLocationResponse res = resBuilder.build();
