...
public class RemovePaymentLink2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemovePaymentLink2Request, RemovePaymentLink2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemovePaymentLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePaymentLink2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemovePaymentLink2Request request) {
        ...
        @Override
        public RemovePaymentLink2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemovePaymentLink2Response.Builder resBuilder =
            ...
            RemovePaymentLink2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemovePaymentLink2Request, to.unified.unified_java_sdk.models.operations.async.RemovePaymentLink2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemovePaymentLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePaymentLink2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemovePaymentLink2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemovePaymentLink2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemovePaymentLink2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemovePaymentLink2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemovePaymentLink2Response res = resBuilder.build();
