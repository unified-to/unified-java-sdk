...
public class ListAdsOrganizations {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsOrganizationsRequest, ListAdsOrganizationsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsOrganizationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsOrganizationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsOrganizationsRequest request) {
        ...
        @Override
        public ListAdsOrganizationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsOrganizationsResponse.Builder resBuilder =
            ...
            ListAdsOrganizationsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsOrganizationsRequest, to.unified.unified_java_sdk.models.operations.async.ListAdsOrganizationsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsOrganizationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsOrganizationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsOrganizationsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsOrganizationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsOrganizationsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsOrganizationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsOrganizationsResponse res = resBuilder.build();
