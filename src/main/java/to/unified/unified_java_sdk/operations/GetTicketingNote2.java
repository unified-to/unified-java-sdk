...
public class GetTicketingNote2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTicketingNote2Request, GetTicketingNote2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTicketingNote2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetTicketingNote2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTicketingNote2Request request) {
        ...
        @Override
        public GetTicketingNote2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTicketingNote2Response.Builder resBuilder =
            ...
            GetTicketingNote2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTicketingNote2Request, to.unified.unified_java_sdk.models.operations.async.GetTicketingNote2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTicketingNote2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetTicketingNote2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTicketingNote2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetTicketingNote2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetTicketingNote2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetTicketingNote2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetTicketingNote2Response res = resBuilder.build();
