...
public class CreateTaskComment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTaskComment2Request, CreateTaskComment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateTaskComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTaskComment2Request.class, new TypeReference<CreateTaskComment2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTaskComment2Request request) {
        ...
        @Override
        public CreateTaskComment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTaskComment2Response.Builder resBuilder =
            ...
            CreateTaskComment2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTaskComment(Utils.unmarshal(response, new TypeReference<TaskComment>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTaskComment2Request, to.unified.unified_java_sdk.models.operations.async.CreateTaskComment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTaskComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTaskComment2Request.class, new TypeReference<CreateTaskComment2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTaskComment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateTaskComment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateTaskComment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateTaskComment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateTaskComment2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TaskComment>() {})
                            .thenApply(res::withTaskComment);
                } else {
