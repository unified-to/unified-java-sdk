...
public class ListCrmDeals2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCrmDeals2Request, ListCrmDeals2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCrmDeals2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmDeals2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmDeals2Request request) {
        ...
        @Override
        public ListCrmDeals2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCrmDeals2Response.Builder resBuilder =
            ...
            ListCrmDeals2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCrmDeals(Utils.unmarshal(response, new TypeReference<List<CrmDeal>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCrmDeals2Request, to.unified.unified_java_sdk.models.operations.async.ListCrmDeals2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCrmDeals2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmDeals2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCrmDeals2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCrmDeals2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCrmDeals2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCrmDeals2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCrmDeals2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CrmDeal>>() {})
                            .thenApply(res::withCrmDeals);
                } else {
