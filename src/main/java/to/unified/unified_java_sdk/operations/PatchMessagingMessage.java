...
public class PatchMessagingMessage {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchMessagingMessageRequest, PatchMessagingMessageResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchMessagingMessageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMessagingMessageRequest.class, new TypeReference<PatchMessagingMessageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchMessagingMessageRequest request) {
        ...
        @Override
        public PatchMessagingMessageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchMessagingMessageResponse.Builder resBuilder =
            ...
            PatchMessagingMessageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchMessagingMessageRequest, to.unified.unified_java_sdk.models.operations.async.PatchMessagingMessageResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchMessagingMessageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMessagingMessageRequest.class, new TypeReference<PatchMessagingMessageRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchMessagingMessageRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchMessagingMessageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchMessagingMessageResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchMessagingMessageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchMessagingMessageResponse res = resBuilder.build();
