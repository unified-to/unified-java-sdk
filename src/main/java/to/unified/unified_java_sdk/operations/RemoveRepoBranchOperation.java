...
public class RemoveRepoBranchOperation implements RequestOperation<RemoveRepoBranchRequest, RemoveRepoBranchResponse> {
    ...
    public RemoveRepoBranchOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveRepoBranchRequest request) throws Exception {
