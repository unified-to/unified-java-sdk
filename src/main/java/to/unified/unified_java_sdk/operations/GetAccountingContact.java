...
public class GetAccountingContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingContactRequest, GetAccountingContactResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingContactRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingContactRequest request) {
        ...
        @Override
        public GetAccountingContactResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingContactResponse.Builder resBuilder =
            ...
            GetAccountingContactResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingContactRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingContactResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingContactRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingContactRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingContactResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingContactResponse res = resBuilder.build();
