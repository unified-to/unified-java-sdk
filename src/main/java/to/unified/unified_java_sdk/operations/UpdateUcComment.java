...
public class UpdateUcComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateUcCommentRequest, UpdateUcCommentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateUcCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUcCommentRequest.class, new TypeReference<UpdateUcCommentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateUcCommentRequest request) {
        ...
        @Override
        public UpdateUcCommentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateUcCommentResponse.Builder resBuilder =
            ...
            UpdateUcCommentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateUcCommentRequest, to.unified.unified_java_sdk.models.operations.async.UpdateUcCommentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateUcCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUcCommentRequest.class, new TypeReference<UpdateUcCommentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateUcCommentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateUcCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateUcCommentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateUcCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateUcCommentResponse res = resBuilder.build();
