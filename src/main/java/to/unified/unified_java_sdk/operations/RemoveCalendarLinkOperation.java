...
public class RemoveCalendarLinkOperation implements RequestOperation<RemoveCalendarLinkRequest, RemoveCalendarLinkResponse> {
    ...
    public RemoveCalendarLinkOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveCalendarLinkRequest request) throws Exception {
