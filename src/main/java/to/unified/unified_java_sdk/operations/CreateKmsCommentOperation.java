...
public class CreateKmsCommentOperation implements RequestOperation<CreateKmsCommentRequest, CreateKmsCommentResponse> {
    ...
    public CreateKmsCommentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateKmsCommentRequest request) throws Exception {
