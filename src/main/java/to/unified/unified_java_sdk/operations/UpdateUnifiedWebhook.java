...
public class UpdateUnifiedWebhook {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateUnifiedWebhookRequest, UpdateUnifiedWebhookResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(UpdateUnifiedWebhookRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUnifiedWebhookRequest.class, new TypeReference<UpdateUnifiedWebhookRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateUnifiedWebhookRequest request) throws Exception {
        ...
        @Override
        public UpdateUnifiedWebhookResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateUnifiedWebhookResponse.Builder resBuilder =
            ...
            UpdateUnifiedWebhookResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Webhook out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withWebhook(out);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateUnifiedWebhookRequest, to.unified.unified_java_sdk.models.operations.async.UpdateUnifiedWebhookResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateUnifiedWebhookRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUnifiedWebhookRequest.class, new TypeReference<UpdateUnifiedWebhookRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateUnifiedWebhookRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateUnifiedWebhookResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateUnifiedWebhookResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateUnifiedWebhookResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateUnifiedWebhookResponse res = resBuilder.build();
