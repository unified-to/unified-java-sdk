...
public class ListHrisTimeshifts {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisTimeshiftsRequest, ListHrisTimeshiftsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisTimeshiftsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisTimeshiftsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisTimeshiftsRequest request) {
        ...
        @Override
        public ListHrisTimeshiftsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisTimeshiftsResponse.Builder resBuilder =
            ...
            ListHrisTimeshiftsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisTimeshiftsRequest, to.unified.unified_java_sdk.models.operations.async.ListHrisTimeshiftsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisTimeshiftsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisTimeshiftsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisTimeshiftsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisTimeshiftsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisTimeshiftsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisTimeshiftsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisTimeshiftsResponse res = resBuilder.build();
