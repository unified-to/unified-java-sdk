...
public class ListHrisTimeshifts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisTimeshiftsRequest request) throws Exception {
        ...
        @Override
        public ListHrisTimeshiftsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<HrisTimeshift> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHrisTimeshifts(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
