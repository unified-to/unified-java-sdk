...
public class PatchAdsInsertionorder {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAdsInsertionorderRequest, PatchAdsInsertionorderResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAdsInsertionorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsInsertionorderRequest.class, new TypeReference<PatchAdsInsertionorderRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAdsInsertionorderRequest request) {
        ...
        @Override
        public PatchAdsInsertionorderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAdsInsertionorderResponse.Builder resBuilder =
            ...
            PatchAdsInsertionorderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAdsInsertionorderRequest, to.unified.unified_java_sdk.models.operations.async.PatchAdsInsertionorderResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAdsInsertionorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsInsertionorderRequest.class, new TypeReference<PatchAdsInsertionorderRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAdsInsertionorderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAdsInsertionorderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAdsInsertionorderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAdsInsertionorderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAdsInsertionorderResponse res = resBuilder.build();
