...
public class PatchCrmLeadOperation implements RequestOperation<PatchCrmLeadRequest, PatchCrmLeadResponse> {
    ...
    public PatchCrmLeadOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchCrmLeadRequest request) throws Exception {
