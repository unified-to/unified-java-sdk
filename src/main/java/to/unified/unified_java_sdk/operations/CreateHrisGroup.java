...
public class CreateHrisGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisGroupRequest, CreateHrisGroupResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisGroupRequest.class, new TypeReference<CreateHrisGroupRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisGroupRequest request) {
        ...
        @Override
        public CreateHrisGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisGroupResponse.Builder resBuilder =
            ...
            CreateHrisGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisGroupRequest, to.unified.unified_java_sdk.models.operations.async.CreateHrisGroupResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisGroupRequest.class, new TypeReference<CreateHrisGroupRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisGroupRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisGroupResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisGroupResponse res = resBuilder.build();
