...
public class RemoveAtsApplication2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAtsApplication2Request, RemoveAtsApplication2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAtsApplication2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsApplication2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAtsApplication2Request request) {
        ...
        @Override
        public RemoveAtsApplication2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAtsApplication2Response.Builder resBuilder =
            ...
            RemoveAtsApplication2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAtsApplication2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAtsApplication2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAtsApplication2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsApplication2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAtsApplication2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAtsApplication2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAtsApplication2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAtsApplication2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAtsApplication2Response res = resBuilder.build();
