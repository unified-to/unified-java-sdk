...
public class GetAccountingTaxrateOperation implements RequestOperation<GetAccountingTaxrateRequest, GetAccountingTaxrateResponse> {
    ...
    public GetAccountingTaxrateOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountingTaxrateRequest request) throws Exception {
