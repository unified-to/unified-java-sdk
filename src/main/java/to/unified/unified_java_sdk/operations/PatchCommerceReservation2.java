...
public class PatchCommerceReservation2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCommerceReservation2Request, PatchCommerceReservation2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCommerceReservation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceReservation2Request.class, new TypeReference<PatchCommerceReservation2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCommerceReservation2Request request) {
        ...
        @Override
        public PatchCommerceReservation2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCommerceReservation2Response.Builder resBuilder =
            ...
            PatchCommerceReservation2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCommerceReservation2Request, to.unified.unified_java_sdk.models.operations.async.PatchCommerceReservation2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCommerceReservation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceReservation2Request.class, new TypeReference<PatchCommerceReservation2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCommerceReservation2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCommerceReservation2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCommerceReservation2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCommerceReservation2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCommerceReservation2Response res = resBuilder.build();
