...
public class PatchLmsStudent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchLmsStudent2Request, PatchLmsStudent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchLmsStudent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsStudent2Request.class, new TypeReference<PatchLmsStudent2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchLmsStudent2Request request) {
        ...
        @Override
        public PatchLmsStudent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchLmsStudent2Response.Builder resBuilder =
            ...
            PatchLmsStudent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchLmsStudent2Request, to.unified.unified_java_sdk.models.operations.async.PatchLmsStudent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchLmsStudent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsStudent2Request.class, new TypeReference<PatchLmsStudent2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchLmsStudent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchLmsStudent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchLmsStudent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchLmsStudent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchLmsStudent2Response res = resBuilder.build();
