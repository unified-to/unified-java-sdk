...
public class PatchCrmCompanyOperation implements RequestOperation<PatchCrmCompanyRequest, PatchCrmCompanyResponse> {
    ...
    public PatchCrmCompanyOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchCrmCompanyRequest request) throws Exception {
