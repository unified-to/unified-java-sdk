...
public class PatchMartechCampaign2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchMartechCampaign2Request, PatchMartechCampaign2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchMartechCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMartechCampaign2Request.class, new TypeReference<PatchMartechCampaign2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchMartechCampaign2Request request) {
        ...
        @Override
        public PatchMartechCampaign2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchMartechCampaign2Response.Builder resBuilder =
            ...
            PatchMartechCampaign2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchMartechCampaign2Request, to.unified.unified_java_sdk.models.operations.async.PatchMartechCampaign2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchMartechCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMartechCampaign2Request.class, new TypeReference<PatchMartechCampaign2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchMartechCampaign2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchMartechCampaign2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchMartechCampaign2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchMartechCampaign2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchMartechCampaign2Response res = resBuilder.build();
