...
public class PatchUnifiedConnection {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchUnifiedConnectionRequest, PatchUnifiedConnectionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchUnifiedConnectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUnifiedConnectionRequest.class, new TypeReference<PatchUnifiedConnectionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchUnifiedConnectionRequest request) {
        ...
        @Override
        public PatchUnifiedConnectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchUnifiedConnectionResponse.Builder resBuilder =
            ...
            PatchUnifiedConnectionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withConnection(Utils.unmarshal(response, new TypeReference<Connection>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchUnifiedConnectionRequest, to.unified.unified_java_sdk.models.operations.async.PatchUnifiedConnectionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchUnifiedConnectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUnifiedConnectionRequest.class, new TypeReference<PatchUnifiedConnectionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchUnifiedConnectionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchUnifiedConnectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchUnifiedConnectionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchUnifiedConnectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchUnifiedConnectionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Connection>() {})
                            .thenApply(res::withConnection);
                } else {
