...
public class PatchUnifiedConnection {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchUnifiedConnectionRequest request) throws Exception {
        ...
        @Override
        public PatchUnifiedConnectionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Connection out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withConnection(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
