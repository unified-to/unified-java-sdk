...
public class UpdateHrisBenefit {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisBenefitRequest, UpdateHrisBenefitResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisBenefitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisBenefitRequest.class, new TypeReference<UpdateHrisBenefitRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisBenefitRequest request) {
        ...
        @Override
        public UpdateHrisBenefitResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisBenefitResponse.Builder resBuilder =
            ...
            UpdateHrisBenefitResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisBenefitRequest, to.unified.unified_java_sdk.models.operations.async.UpdateHrisBenefitResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisBenefitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisBenefitRequest.class, new TypeReference<UpdateHrisBenefitRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisBenefitRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisBenefitResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisBenefitResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisBenefitResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisBenefitResponse res = resBuilder.build();
