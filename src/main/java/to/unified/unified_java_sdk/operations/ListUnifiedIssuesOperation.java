...
public class ListUnifiedIssuesOperation implements RequestOperation<ListUnifiedIssuesRequest, ListUnifiedIssuesResponse> {
    ...
    public ListUnifiedIssuesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListUnifiedIssuesRequest request) throws Exception {
