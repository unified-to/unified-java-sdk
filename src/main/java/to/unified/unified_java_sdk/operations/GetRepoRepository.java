...
public class GetRepoRepository {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRepoRepositoryRequest, GetRepoRepositoryResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRepoRepositoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoRepositoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRepoRepositoryRequest request) {
        ...
        @Override
        public GetRepoRepositoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRepoRepositoryResponse.Builder resBuilder =
            ...
            GetRepoRepositoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRepoRepositoryRequest, to.unified.unified_java_sdk.models.operations.async.GetRepoRepositoryResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRepoRepositoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoRepositoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRepoRepositoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetRepoRepositoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetRepoRepositoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetRepoRepositoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetRepoRepositoryResponse res = resBuilder.build();
