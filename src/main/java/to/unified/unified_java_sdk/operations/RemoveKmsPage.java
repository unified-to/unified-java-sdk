...
public class RemoveKmsPage {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveKmsPageRequest, RemoveKmsPageResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveKmsPageRequest request) throws Exception {
        ...
        @Override
        public RemoveKmsPageResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveKmsPageResponse.Builder resBuilder =
            ...
            RemoveKmsPageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveKmsPageRequest, to.unified.unified_java_sdk.models.operations.async.RemoveKmsPageResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveKmsPageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveKmsPageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveKmsPageRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveKmsPageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveKmsPageResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveKmsPageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveKmsPageResponse res = resBuilder.build();
