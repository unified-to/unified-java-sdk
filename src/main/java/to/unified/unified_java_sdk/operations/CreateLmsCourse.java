...
public class CreateLmsCourse {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateLmsCourseRequest, CreateLmsCourseResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateLmsCourseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsCourseRequest.class, new TypeReference<CreateLmsCourseRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateLmsCourseRequest request) {
        ...
        @Override
        public CreateLmsCourseResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateLmsCourseResponse.Builder resBuilder =
            ...
            CreateLmsCourseResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateLmsCourseRequest, to.unified.unified_java_sdk.models.operations.async.CreateLmsCourseResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateLmsCourseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsCourseRequest.class, new TypeReference<CreateLmsCourseRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateLmsCourseRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateLmsCourseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateLmsCourseResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateLmsCourseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateLmsCourseResponse res = resBuilder.build();
