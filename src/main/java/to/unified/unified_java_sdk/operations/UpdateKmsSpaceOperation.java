...
public class UpdateKmsSpaceOperation implements RequestOperation<UpdateKmsSpaceRequest, UpdateKmsSpaceResponse> {
    ...
    public UpdateKmsSpaceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateKmsSpaceRequest request) throws Exception {
