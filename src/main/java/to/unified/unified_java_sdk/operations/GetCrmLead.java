...
public class GetCrmLead {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCrmLeadRequest, GetCrmLeadResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCrmLeadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmLeadRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCrmLeadRequest request) {
        ...
        @Override
        public GetCrmLeadResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCrmLeadResponse.Builder resBuilder =
                    GetCrmLeadResponse
                            .builder()
            ...
            GetCrmLeadResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCrmLeadRequest, to.unified.unified_java_sdk.models.operations.async.GetCrmLeadResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCrmLeadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmLeadRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCrmLeadRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCrmLeadResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCrmLeadResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCrmLeadResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCrmLeadResponse res = resBuilder.build();
