...
public class UpdateCalendarLink {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCalendarLinkRequest request) throws Exception {
        ...
        @Override
        public UpdateCalendarLinkResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CalendarLink out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCalendarLink(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
