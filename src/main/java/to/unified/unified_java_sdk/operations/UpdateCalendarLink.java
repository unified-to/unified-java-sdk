...
public class UpdateCalendarLink {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCalendarLinkRequest, UpdateCalendarLinkResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCalendarLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCalendarLinkRequest.class, new TypeReference<UpdateCalendarLinkRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCalendarLinkRequest request) {
        ...
        @Override
        public UpdateCalendarLinkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCalendarLinkResponse.Builder resBuilder =
            ...
            UpdateCalendarLinkResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCalendarLinkRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCalendarLinkResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCalendarLinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCalendarLinkRequest.class, new TypeReference<UpdateCalendarLinkRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCalendarLinkRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCalendarLinkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCalendarLinkResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCalendarLinkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCalendarLinkResponse res = resBuilder.build();
