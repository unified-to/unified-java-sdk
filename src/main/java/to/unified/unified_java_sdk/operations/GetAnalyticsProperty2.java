...
public class GetAnalyticsProperty2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAnalyticsProperty2Request, GetAnalyticsProperty2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAnalyticsProperty2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAnalyticsProperty2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAnalyticsProperty2Request request) {
        ...
        @Override
        public GetAnalyticsProperty2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAnalyticsProperty2Response.Builder resBuilder =
            ...
            GetAnalyticsProperty2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAnalyticsProperty2Request, to.unified.unified_java_sdk.models.operations.async.GetAnalyticsProperty2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAnalyticsProperty2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAnalyticsProperty2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAnalyticsProperty2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAnalyticsProperty2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAnalyticsProperty2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAnalyticsProperty2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAnalyticsProperty2Response res = resBuilder.build();
