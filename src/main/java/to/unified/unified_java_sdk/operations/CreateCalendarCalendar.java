...
public class CreateCalendarCalendar {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCalendarCalendarRequest, CreateCalendarCalendarResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCalendarCalendarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCalendarCalendarRequest.class, new TypeReference<CreateCalendarCalendarRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCalendarCalendarRequest request) {
        ...
        @Override
        public CreateCalendarCalendarResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCalendarCalendarResponse.Builder resBuilder =
            ...
            CreateCalendarCalendarResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCalendarCalendarRequest, to.unified.unified_java_sdk.models.operations.async.CreateCalendarCalendarResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCalendarCalendarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCalendarCalendarRequest.class, new TypeReference<CreateCalendarCalendarRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCalendarCalendarRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCalendarCalendarResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCalendarCalendarResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCalendarCalendarResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCalendarCalendarResponse res = resBuilder.build();
