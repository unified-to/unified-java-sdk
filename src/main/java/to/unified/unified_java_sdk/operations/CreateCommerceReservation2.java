...
public class CreateCommerceReservation2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommerceReservation2Request, CreateCommerceReservation2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommerceReservation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceReservation2Request.class, new TypeReference<CreateCommerceReservation2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceReservation2Request request) {
        ...
        @Override
        public CreateCommerceReservation2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommerceReservation2Response.Builder resBuilder =
            ...
            CreateCommerceReservation2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommerceReservation2Request, to.unified.unified_java_sdk.models.operations.async.CreateCommerceReservation2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommerceReservation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceReservation2Request.class, new TypeReference<CreateCommerceReservation2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommerceReservation2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCommerceReservation2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCommerceReservation2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCommerceReservation2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCommerceReservation2Response res = resBuilder.build();
