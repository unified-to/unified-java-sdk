...
public class PatchCalendarCalendar {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCalendarCalendarRequest, PatchCalendarCalendarResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCalendarCalendarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCalendarCalendarRequest.class, new TypeReference<PatchCalendarCalendarRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCalendarCalendarRequest request) {
        ...
        @Override
        public PatchCalendarCalendarResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCalendarCalendarResponse.Builder resBuilder =
            ...
            PatchCalendarCalendarResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCalendarCalendarRequest, to.unified.unified_java_sdk.models.operations.async.PatchCalendarCalendarResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCalendarCalendarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCalendarCalendarRequest.class, new TypeReference<PatchCalendarCalendarRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCalendarCalendarRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCalendarCalendarResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCalendarCalendarResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCalendarCalendarResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCalendarCalendarResponse res = resBuilder.build();
