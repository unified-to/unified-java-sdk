...
public class UpdateCommerceCollectionOperation implements RequestOperation<UpdateCommerceCollectionRequest, UpdateCommerceCollectionResponse> {
    ...
    public UpdateCommerceCollectionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateCommerceCollectionRequest request) throws Exception {
