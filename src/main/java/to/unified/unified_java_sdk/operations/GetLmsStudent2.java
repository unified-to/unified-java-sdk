...
public class GetLmsStudent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLmsStudent2Request, GetLmsStudent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLmsStudent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsStudent2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLmsStudent2Request request) {
        ...
        @Override
        public GetLmsStudent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLmsStudent2Response.Builder resBuilder =
            ...
            GetLmsStudent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLmsStudent2Request, to.unified.unified_java_sdk.models.operations.async.GetLmsStudent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLmsStudent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsStudent2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLmsStudent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetLmsStudent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetLmsStudent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetLmsStudent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetLmsStudent2Response res = resBuilder.build();
