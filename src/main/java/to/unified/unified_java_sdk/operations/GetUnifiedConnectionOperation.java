...
public class GetUnifiedConnectionOperation implements RequestOperation<GetUnifiedConnectionRequest, GetUnifiedConnectionResponse> {
    ...
    public GetUnifiedConnectionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetUnifiedConnectionRequest request) throws Exception {
