...
public class PatchLmsClass2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchLmsClass2Request, PatchLmsClass2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchLmsClass2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsClass2Request.class, new TypeReference<PatchLmsClass2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchLmsClass2Request request) {
        ...
        @Override
        public PatchLmsClass2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchLmsClass2Response.Builder resBuilder =
            ...
            PatchLmsClass2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchLmsClass2Request, to.unified.unified_java_sdk.models.operations.async.PatchLmsClass2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchLmsClass2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsClass2Request.class, new TypeReference<PatchLmsClass2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchLmsClass2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchLmsClass2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchLmsClass2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchLmsClass2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchLmsClass2Response res = resBuilder.build();
