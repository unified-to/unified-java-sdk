...
public class CreateRepoCommit {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateRepoCommitRequest, CreateRepoCommitResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateRepoCommitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoCommitRequest.class, new TypeReference<CreateRepoCommitRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateRepoCommitRequest request) {
        ...
        @Override
        public CreateRepoCommitResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateRepoCommitResponse.Builder resBuilder =
            ...
            CreateRepoCommitResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateRepoCommitRequest, to.unified.unified_java_sdk.models.operations.async.CreateRepoCommitResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateRepoCommitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoCommitRequest.class, new TypeReference<CreateRepoCommitRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateRepoCommitRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateRepoCommitResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateRepoCommitResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateRepoCommitResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateRepoCommitResponse res = resBuilder.build();
