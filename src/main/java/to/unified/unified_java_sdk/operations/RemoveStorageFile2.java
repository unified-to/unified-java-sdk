...
public class RemoveStorageFile2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveStorageFile2Request, RemoveStorageFile2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveStorageFile2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveStorageFile2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveStorageFile2Request request) {
        ...
        @Override
        public RemoveStorageFile2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveStorageFile2Response.Builder resBuilder =
            ...
            RemoveStorageFile2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveStorageFile2Request, to.unified.unified_java_sdk.models.operations.async.RemoveStorageFile2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveStorageFile2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveStorageFile2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveStorageFile2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveStorageFile2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveStorageFile2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveStorageFile2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveStorageFile2Response res = resBuilder.build();
