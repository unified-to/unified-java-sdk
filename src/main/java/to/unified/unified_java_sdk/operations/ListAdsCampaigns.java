...
public class ListAdsCampaigns {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsCampaignsRequest, ListAdsCampaignsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsCampaignsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsCampaignsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsCampaignsRequest request) {
        ...
        @Override
        public ListAdsCampaignsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsCampaignsResponse.Builder resBuilder =
            ...
            ListAdsCampaignsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsCampaignsRequest, to.unified.unified_java_sdk.models.operations.async.ListAdsCampaignsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsCampaignsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsCampaignsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsCampaignsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsCampaignsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsCampaignsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsCampaignsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsCampaignsResponse res = resBuilder.build();
