...
public class ListGenaiModels2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListGenaiModels2Request, ListGenaiModels2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListGenaiModels2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListGenaiModels2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListGenaiModels2Request request) {
        ...
        @Override
        public ListGenaiModels2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListGenaiModels2Response.Builder resBuilder =
            ...
            ListGenaiModels2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGenaiModels(Utils.unmarshal(response, new TypeReference<List<GenaiModel>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListGenaiModels2Request, to.unified.unified_java_sdk.models.operations.async.ListGenaiModels2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListGenaiModels2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListGenaiModels2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListGenaiModels2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListGenaiModels2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListGenaiModels2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListGenaiModels2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListGenaiModels2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<GenaiModel>>() {})
                            .thenApply(res::withGenaiModels);
                } else {
