...
public class RemoveCommerceSaleschannel {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCommerceSaleschannelRequest, RemoveCommerceSaleschannelResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCommerceSaleschannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceSaleschannelRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCommerceSaleschannelRequest request) {
        ...
        @Override
        public RemoveCommerceSaleschannelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCommerceSaleschannelResponse.Builder resBuilder =
            ...
            RemoveCommerceSaleschannelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCommerceSaleschannelRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCommerceSaleschannelResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCommerceSaleschannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceSaleschannelRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCommerceSaleschannelRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCommerceSaleschannelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceSaleschannelResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCommerceSaleschannelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceSaleschannelResponse res = resBuilder.build();
