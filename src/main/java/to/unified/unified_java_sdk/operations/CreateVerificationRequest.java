...
public class CreateVerificationRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateVerificationRequestRequest, CreateVerificationRequestResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateVerificationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateVerificationRequestRequest.class, new TypeReference<CreateVerificationRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateVerificationRequestRequest request) {
        ...
        @Override
        public CreateVerificationRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateVerificationRequestResponse.Builder resBuilder =
            ...
            CreateVerificationRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateVerificationRequestRequest, to.unified.unified_java_sdk.models.operations.async.CreateVerificationRequestResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateVerificationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateVerificationRequestRequest.class, new TypeReference<CreateVerificationRequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateVerificationRequestRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateVerificationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateVerificationRequestResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateVerificationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateVerificationRequestResponse res = resBuilder.build();
