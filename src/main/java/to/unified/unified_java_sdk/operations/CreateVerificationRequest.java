...
public class CreateVerificationRequest {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateVerificationRequestRequest request) throws Exception {
        ...
        @Override
        public CreateVerificationRequestResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    VerificationRequest out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withVerificationRequest(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
