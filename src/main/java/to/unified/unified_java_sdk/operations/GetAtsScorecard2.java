...
public class GetAtsScorecard2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAtsScorecard2Request, GetAtsScorecard2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAtsScorecard2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsScorecard2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAtsScorecard2Request request) {
        ...
        @Override
        public GetAtsScorecard2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAtsScorecard2Response.Builder resBuilder =
            ...
            GetAtsScorecard2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAtsScorecard2Request, to.unified.unified_java_sdk.models.operations.async.GetAtsScorecard2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAtsScorecard2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsScorecard2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAtsScorecard2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAtsScorecard2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAtsScorecard2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAtsScorecard2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAtsScorecard2Response res = resBuilder.build();
