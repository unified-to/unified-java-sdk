...
public class GetAccountingCategoryOperation implements RequestOperation<GetAccountingCategoryRequest, GetAccountingCategoryResponse> {
    ...
    public GetAccountingCategoryOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountingCategoryRequest request) throws Exception {
