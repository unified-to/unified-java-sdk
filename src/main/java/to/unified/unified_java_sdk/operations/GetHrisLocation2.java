...
public class GetHrisLocation2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisLocation2Request, GetHrisLocation2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisLocation2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisLocation2Request request) {
        ...
        @Override
        public GetHrisLocation2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisLocation2Response.Builder resBuilder =
            ...
            GetHrisLocation2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisLocation2Request, to.unified.unified_java_sdk.models.operations.async.GetHrisLocation2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisLocation2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisLocation2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisLocation2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisLocation2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisLocation2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisLocation2Response res = resBuilder.build();
