...
public class UpdateScimGroupsOperation implements RequestOperation<UpdateScimGroupsRequest, UpdateScimGroupsResponse> {
    ...
    public UpdateScimGroupsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateScimGroupsRequest request) throws Exception {
