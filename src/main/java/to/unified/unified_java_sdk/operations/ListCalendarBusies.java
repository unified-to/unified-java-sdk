...
public class ListCalendarBusies {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCalendarBusiesRequest, ListCalendarBusiesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCalendarBusiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarBusiesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarBusiesRequest request) {
        ...
        @Override
        public ListCalendarBusiesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCalendarBusiesResponse.Builder resBuilder =
            ...
            ListCalendarBusiesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCalendarBusiesRequest, to.unified.unified_java_sdk.models.operations.async.ListCalendarBusiesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCalendarBusiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarBusiesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCalendarBusiesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCalendarBusiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCalendarBusiesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCalendarBusiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCalendarBusiesResponse res = resBuilder.build();
