...
public class ListCalendarBusies {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarBusiesRequest request) throws Exception {
        ...
        @Override
        public ListCalendarBusiesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CalendarBusy> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCalendarBusies(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
