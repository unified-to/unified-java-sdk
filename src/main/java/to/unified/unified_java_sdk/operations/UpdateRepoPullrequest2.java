...
public class UpdateRepoPullrequest2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateRepoPullrequest2Request, UpdateRepoPullrequest2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateRepoPullrequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoPullrequest2Request.class, new TypeReference<UpdateRepoPullrequest2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateRepoPullrequest2Request request) {
        ...
        @Override
        public UpdateRepoPullrequest2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateRepoPullrequest2Response.Builder resBuilder =
            ...
            UpdateRepoPullrequest2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRepoPullrequest(Utils.unmarshal(response, new TypeReference<RepoPullrequest>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateRepoPullrequest2Request, to.unified.unified_java_sdk.models.operations.async.UpdateRepoPullrequest2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateRepoPullrequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoPullrequest2Request.class, new TypeReference<UpdateRepoPullrequest2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateRepoPullrequest2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateRepoPullrequest2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateRepoPullrequest2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateRepoPullrequest2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateRepoPullrequest2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RepoPullrequest>() {})
                            .thenApply(res::withRepoPullrequest);
                } else {
