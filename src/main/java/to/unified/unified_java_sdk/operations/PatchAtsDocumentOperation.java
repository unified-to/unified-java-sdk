...
public class PatchAtsDocumentOperation implements RequestOperation<PatchAtsDocumentRequest, PatchAtsDocumentResponse> {
    ...
    public PatchAtsDocumentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchAtsDocumentRequest request) throws Exception {
