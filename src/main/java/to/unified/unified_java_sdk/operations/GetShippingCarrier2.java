...
public class GetShippingCarrier2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetShippingCarrier2Request, GetShippingCarrier2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetShippingCarrier2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingCarrier2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetShippingCarrier2Request request) {
        ...
        @Override
        public GetShippingCarrier2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetShippingCarrier2Response.Builder resBuilder =
            ...
            GetShippingCarrier2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withShippingCarrier(Utils.unmarshal(response, new TypeReference<ShippingCarrier>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetShippingCarrier2Request, to.unified.unified_java_sdk.models.operations.async.GetShippingCarrier2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetShippingCarrier2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetShippingCarrier2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetShippingCarrier2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetShippingCarrier2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetShippingCarrier2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetShippingCarrier2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetShippingCarrier2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ShippingCarrier>() {})
                            .thenApply(res::withShippingCarrier);
                } else {
