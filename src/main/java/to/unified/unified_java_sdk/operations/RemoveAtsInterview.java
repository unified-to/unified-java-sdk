...
public class RemoveAtsInterview {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAtsInterviewRequest, RemoveAtsInterviewResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(RemoveAtsInterviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsInterviewRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAtsInterviewRequest request) throws Exception {
        ...
        @Override
        public RemoveAtsInterviewResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAtsInterviewResponse.Builder resBuilder =
            ...
            RemoveAtsInterviewResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAtsInterviewRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAtsInterviewResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAtsInterviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsInterviewRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAtsInterviewRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAtsInterviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAtsInterviewResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAtsInterviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAtsInterviewResponse res = resBuilder.build();
