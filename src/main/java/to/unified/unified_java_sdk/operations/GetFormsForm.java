...
public class GetFormsForm {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFormsFormRequest, GetFormsFormResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetFormsFormRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFormsFormRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFormsFormRequest request) {
        ...
        @Override
        public GetFormsFormResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFormsFormResponse.Builder resBuilder =
            ...
            GetFormsFormResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFormsFormRequest, to.unified.unified_java_sdk.models.operations.async.GetFormsFormResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetFormsFormRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFormsFormRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFormsFormRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetFormsFormResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetFormsFormResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetFormsFormResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetFormsFormResponse res = resBuilder.build();
