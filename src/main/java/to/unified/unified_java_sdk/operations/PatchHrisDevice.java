...
public class PatchHrisDevice {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisDeviceRequest, PatchHrisDeviceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisDeviceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisDeviceRequest.class, new TypeReference<PatchHrisDeviceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisDeviceRequest request) {
        ...
        @Override
        public PatchHrisDeviceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisDeviceResponse.Builder resBuilder =
            ...
            PatchHrisDeviceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisDeviceRequest, to.unified.unified_java_sdk.models.operations.async.PatchHrisDeviceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisDeviceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisDeviceRequest.class, new TypeReference<PatchHrisDeviceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisDeviceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisDeviceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisDeviceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisDeviceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisDeviceResponse res = resBuilder.build();
