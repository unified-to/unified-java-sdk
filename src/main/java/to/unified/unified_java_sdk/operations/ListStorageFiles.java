...
public class ListStorageFiles {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListStorageFilesRequest request) throws Exception {
        ...
        @Override
        public ListStorageFilesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<StorageFile> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withStorageFiles(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
