...
public class ListStorageFiles {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListStorageFilesRequest, ListStorageFilesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListStorageFilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListStorageFilesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListStorageFilesRequest request) {
        ...
        @Override
        public ListStorageFilesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListStorageFilesResponse.Builder resBuilder =
            ...
            ListStorageFilesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListStorageFilesRequest, to.unified.unified_java_sdk.models.operations.async.ListStorageFilesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListStorageFilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListStorageFilesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListStorageFilesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListStorageFilesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListStorageFilesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListStorageFilesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListStorageFilesResponse res = resBuilder.build();
