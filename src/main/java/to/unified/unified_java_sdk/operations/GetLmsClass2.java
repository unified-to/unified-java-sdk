...
public class GetLmsClass2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLmsClass2Request, GetLmsClass2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLmsClass2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsClass2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLmsClass2Request request) {
        ...
        @Override
        public GetLmsClass2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLmsClass2Response.Builder resBuilder =
            ...
            GetLmsClass2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLmsClass2Request, to.unified.unified_java_sdk.models.operations.async.GetLmsClass2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLmsClass2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsClass2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLmsClass2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetLmsClass2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetLmsClass2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetLmsClass2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetLmsClass2Response res = resBuilder.build();
