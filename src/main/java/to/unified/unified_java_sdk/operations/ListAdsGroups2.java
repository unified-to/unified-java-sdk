...
public class ListAdsGroups2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsGroups2Request, ListAdsGroups2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsGroups2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsGroups2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsGroups2Request request) {
        ...
        @Override
        public ListAdsGroups2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsGroups2Response.Builder resBuilder =
            ...
            ListAdsGroups2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdsGroups(Utils.unmarshal(response, new TypeReference<List<AdsGroup>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsGroups2Request, to.unified.unified_java_sdk.models.operations.async.ListAdsGroups2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsGroups2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsGroups2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsGroups2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsGroups2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsGroups2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsGroups2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsGroups2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AdsGroup>>() {})
                            .thenApply(res::withAdsGroups);
                } else {
