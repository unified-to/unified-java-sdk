...
public class ListShippingShipments {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListShippingShipmentsRequest, ListShippingShipmentsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListShippingShipmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListShippingShipmentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListShippingShipmentsRequest request) {
        ...
        @Override
        public ListShippingShipmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListShippingShipmentsResponse.Builder resBuilder =
            ...
            ListShippingShipmentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListShippingShipmentsRequest, to.unified.unified_java_sdk.models.operations.async.ListShippingShipmentsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListShippingShipmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListShippingShipmentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListShippingShipmentsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListShippingShipmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListShippingShipmentsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListShippingShipmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListShippingShipmentsResponse res = resBuilder.build();
