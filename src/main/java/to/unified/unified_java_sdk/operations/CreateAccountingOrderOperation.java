...
public class CreateAccountingOrderOperation implements RequestOperation<CreateAccountingOrderRequest, CreateAccountingOrderResponse> {
    ...
    public CreateAccountingOrderOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAccountingOrderRequest request) throws Exception {
