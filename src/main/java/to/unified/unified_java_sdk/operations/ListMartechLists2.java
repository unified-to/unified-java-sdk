...
public class ListMartechLists2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMartechLists2Request, ListMartechLists2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListMartechLists2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListMartechLists2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMartechLists2Request request) {
        ...
        @Override
        public ListMartechLists2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMartechLists2Response.Builder resBuilder =
            ...
            ListMartechLists2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMarketingLists(Utils.unmarshal(response, new TypeReference<List<MarketingList>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMartechLists2Request, to.unified.unified_java_sdk.models.operations.async.ListMartechLists2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMartechLists2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListMartechLists2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMartechLists2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListMartechLists2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListMartechLists2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListMartechLists2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListMartechLists2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<MarketingList>>() {})
                            .thenApply(res::withMarketingLists);
                } else {
