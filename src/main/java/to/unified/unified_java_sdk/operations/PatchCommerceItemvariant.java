...
public class PatchCommerceItemvariant {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCommerceItemvariantRequest, PatchCommerceItemvariantResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCommerceItemvariantRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceItemvariantRequest.class, new TypeReference<PatchCommerceItemvariantRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCommerceItemvariantRequest request) {
        ...
        @Override
        public PatchCommerceItemvariantResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCommerceItemvariantResponse.Builder resBuilder =
            ...
            PatchCommerceItemvariantResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCommerceItemvariantRequest, to.unified.unified_java_sdk.models.operations.async.PatchCommerceItemvariantResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCommerceItemvariantRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceItemvariantRequest.class, new TypeReference<PatchCommerceItemvariantRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCommerceItemvariantRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCommerceItemvariantResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCommerceItemvariantResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCommerceItemvariantResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCommerceItemvariantResponse res = resBuilder.build();
