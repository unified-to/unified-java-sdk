...
public class PatchRepoOrganization2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchRepoOrganization2Request, PatchRepoOrganization2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchRepoOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoOrganization2Request.class, new TypeReference<PatchRepoOrganization2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchRepoOrganization2Request request) {
        ...
        @Override
        public PatchRepoOrganization2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchRepoOrganization2Response.Builder resBuilder =
            ...
            PatchRepoOrganization2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchRepoOrganization2Request, to.unified.unified_java_sdk.models.operations.async.PatchRepoOrganization2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchRepoOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoOrganization2Request.class, new TypeReference<PatchRepoOrganization2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchRepoOrganization2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchRepoOrganization2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchRepoOrganization2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchRepoOrganization2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchRepoOrganization2Response res = resBuilder.build();
