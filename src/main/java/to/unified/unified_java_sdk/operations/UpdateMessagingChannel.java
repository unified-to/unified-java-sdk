...
public class UpdateMessagingChannel {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMessagingChannelRequest, UpdateMessagingChannelResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateMessagingChannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMessagingChannelRequest.class, new TypeReference<UpdateMessagingChannelRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMessagingChannelRequest request) {
        ...
        @Override
        public UpdateMessagingChannelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMessagingChannelResponse.Builder resBuilder =
            ...
            UpdateMessagingChannelResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMessagingChannel(Utils.unmarshal(response, new TypeReference<MessagingChannel>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMessagingChannelRequest, to.unified.unified_java_sdk.models.operations.async.UpdateMessagingChannelResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMessagingChannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMessagingChannelRequest.class, new TypeReference<UpdateMessagingChannelRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMessagingChannelRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateMessagingChannelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateMessagingChannelResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateMessagingChannelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateMessagingChannelResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MessagingChannel>() {})
                            .thenApply(res::withMessagingChannel);
                } else {
