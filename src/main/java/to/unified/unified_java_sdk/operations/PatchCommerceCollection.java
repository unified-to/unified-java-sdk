...
public class PatchCommerceCollection {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCommerceCollectionRequest, PatchCommerceCollectionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCommerceCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceCollectionRequest.class, new TypeReference<PatchCommerceCollectionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCommerceCollectionRequest request) {
        ...
        @Override
        public PatchCommerceCollectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCommerceCollectionResponse.Builder resBuilder =
            ...
            PatchCommerceCollectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCommerceCollectionRequest, to.unified.unified_java_sdk.models.operations.async.PatchCommerceCollectionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCommerceCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceCollectionRequest.class, new TypeReference<PatchCommerceCollectionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCommerceCollectionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCommerceCollectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCommerceCollectionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCommerceCollectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCommerceCollectionResponse res = resBuilder.build();
