...
public class RemoveUnifiedConnection {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveUnifiedConnectionRequest, RemoveUnifiedConnectionResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(RemoveUnifiedConnectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUnifiedConnectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveUnifiedConnectionRequest request) throws Exception {
        ...
        @Override
        public RemoveUnifiedConnectionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveUnifiedConnectionResponse.Builder resBuilder =
            ...
            RemoveUnifiedConnectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveUnifiedConnectionRequest, to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedConnectionResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveUnifiedConnectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUnifiedConnectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveUnifiedConnectionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedConnectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedConnectionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedConnectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedConnectionResponse res = resBuilder.build();
