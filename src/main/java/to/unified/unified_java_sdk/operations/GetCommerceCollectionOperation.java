...
public class GetCommerceCollectionOperation implements RequestOperation<GetCommerceCollectionRequest, GetCommerceCollectionResponse> {
    ...
    public GetCommerceCollectionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetCommerceCollectionRequest request) throws Exception {
