...
public class PatchLmsStudent {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchLmsStudentRequest, PatchLmsStudentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchLmsStudentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsStudentRequest.class, new TypeReference<PatchLmsStudentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchLmsStudentRequest request) {
        ...
        @Override
        public PatchLmsStudentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchLmsStudentResponse.Builder resBuilder =
            ...
            PatchLmsStudentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchLmsStudentRequest, to.unified.unified_java_sdk.models.operations.async.PatchLmsStudentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchLmsStudentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsStudentRequest.class, new TypeReference<PatchLmsStudentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchLmsStudentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchLmsStudentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchLmsStudentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchLmsStudentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchLmsStudentResponse res = resBuilder.build();
