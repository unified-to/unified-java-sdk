...
public class GetAtsApplicationOperation implements RequestOperation<GetAtsApplicationRequest, GetAtsApplicationResponse> {
    ...
    public GetAtsApplicationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAtsApplicationRequest request) throws Exception {
