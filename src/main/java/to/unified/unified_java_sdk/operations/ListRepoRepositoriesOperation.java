...
public class ListRepoRepositoriesOperation implements RequestOperation<ListRepoRepositoriesRequest, ListRepoRepositoriesResponse> {
    ...
    public ListRepoRepositoriesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListRepoRepositoriesRequest request) throws Exception {
