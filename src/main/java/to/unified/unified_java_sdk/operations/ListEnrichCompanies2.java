...
public class ListEnrichCompanies2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListEnrichCompanies2Request, ListEnrichCompanies2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListEnrichCompanies2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListEnrichCompanies2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListEnrichCompanies2Request request) {
        ...
        @Override
        public ListEnrichCompanies2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListEnrichCompanies2Response.Builder resBuilder =
            ...
            ListEnrichCompanies2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEnrichCompany(Utils.unmarshal(response, new TypeReference<EnrichCompany>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListEnrichCompanies2Request, to.unified.unified_java_sdk.models.operations.async.ListEnrichCompanies2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListEnrichCompanies2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListEnrichCompanies2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListEnrichCompanies2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListEnrichCompanies2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListEnrichCompanies2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListEnrichCompanies2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListEnrichCompanies2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EnrichCompany>() {})
                            .thenApply(res::withEnrichCompany);
                } else {
