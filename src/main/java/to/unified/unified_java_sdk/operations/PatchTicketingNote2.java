...
public class PatchTicketingNote2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchTicketingNote2Request, PatchTicketingNote2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchTicketingNote2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTicketingNote2Request.class, new TypeReference<PatchTicketingNote2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchTicketingNote2Request request) {
        ...
        @Override
        public PatchTicketingNote2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchTicketingNote2Response.Builder resBuilder =
            ...
            PatchTicketingNote2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchTicketingNote2Request, to.unified.unified_java_sdk.models.operations.async.PatchTicketingNote2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchTicketingNote2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTicketingNote2Request.class, new TypeReference<PatchTicketingNote2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchTicketingNote2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchTicketingNote2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchTicketingNote2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchTicketingNote2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchTicketingNote2Response res = resBuilder.build();
