...
public class ListUcCommentsOperation implements RequestOperation<ListUcCommentsRequest, ListUcCommentsResponse> {
    ...
    public ListUcCommentsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListUcCommentsRequest request) throws Exception {
