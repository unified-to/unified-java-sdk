...
public class RemoveCommerceLocation2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCommerceLocation2Request, RemoveCommerceLocation2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCommerceLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceLocation2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCommerceLocation2Request request) {
        ...
        @Override
        public RemoveCommerceLocation2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCommerceLocation2Response.Builder resBuilder =
            ...
            RemoveCommerceLocation2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCommerceLocation2Request, to.unified.unified_java_sdk.models.operations.async.RemoveCommerceLocation2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCommerceLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceLocation2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCommerceLocation2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCommerceLocation2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceLocation2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCommerceLocation2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceLocation2Response res = resBuilder.build();
