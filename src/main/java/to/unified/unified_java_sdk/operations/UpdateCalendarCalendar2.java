...
public class UpdateCalendarCalendar2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCalendarCalendar2Request, UpdateCalendarCalendar2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCalendarCalendar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCalendarCalendar2Request.class, new TypeReference<UpdateCalendarCalendar2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCalendarCalendar2Request request) {
        ...
        @Override
        public UpdateCalendarCalendar2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCalendarCalendar2Response.Builder resBuilder =
            ...
            UpdateCalendarCalendar2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCalendarCalendar(Utils.unmarshal(response, new TypeReference<CalendarCalendar>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCalendarCalendar2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCalendarCalendar2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCalendarCalendar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCalendarCalendar2Request.class, new TypeReference<UpdateCalendarCalendar2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCalendarCalendar2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCalendarCalendar2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCalendarCalendar2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCalendarCalendar2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCalendarCalendar2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CalendarCalendar>() {})
                            .thenApply(res::withCalendarCalendar);
                } else {
