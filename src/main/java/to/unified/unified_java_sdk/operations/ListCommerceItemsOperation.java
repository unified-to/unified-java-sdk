...
public class ListCommerceItemsOperation implements RequestOperation<ListCommerceItemsRequest, ListCommerceItemsResponse> {
    ...
    public ListCommerceItemsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCommerceItemsRequest request) throws Exception {
