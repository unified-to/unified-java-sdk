...
public class RemoveLmsClass {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveLmsClassRequest, RemoveLmsClassResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveLmsClassRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsClassRequest.class);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveLmsClassRequest, to.unified.unified_java_sdk.models.operations.async.RemoveLmsClassResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveLmsClassRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsClassRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveLmsClassRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveLmsClassResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveLmsClassResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveLmsClassResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveLmsClassResponse res = resBuilder.build();
