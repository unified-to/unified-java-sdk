...
public class ListAssessmentPackages {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAssessmentPackagesRequest, ListAssessmentPackagesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAssessmentPackagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAssessmentPackagesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAssessmentPackagesRequest request) {
        ...
        @Override
        public ListAssessmentPackagesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAssessmentPackagesResponse.Builder resBuilder =
            ...
            ListAssessmentPackagesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAssessmentPackagesRequest, to.unified.unified_java_sdk.models.operations.async.ListAssessmentPackagesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAssessmentPackagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAssessmentPackagesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAssessmentPackagesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAssessmentPackagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAssessmentPackagesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAssessmentPackagesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAssessmentPackagesResponse res = resBuilder.build();
