...
public class PatchPaymentPaymentOperation implements RequestOperation<PatchPaymentPaymentRequest, PatchPaymentPaymentResponse> {
    ...
    public PatchPaymentPaymentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchPaymentPaymentRequest request) throws Exception {
