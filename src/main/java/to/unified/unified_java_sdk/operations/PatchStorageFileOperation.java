...
public class PatchStorageFileOperation implements RequestOperation<PatchStorageFileRequest, PatchStorageFileResponse> {
    ...
    public PatchStorageFileOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchStorageFileRequest request) throws Exception {
