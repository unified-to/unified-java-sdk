...
public class GetLmsClassOperation implements RequestOperation<GetLmsClassRequest, GetLmsClassResponse> {
    ...
    public GetLmsClassOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetLmsClassRequest request) throws Exception {
