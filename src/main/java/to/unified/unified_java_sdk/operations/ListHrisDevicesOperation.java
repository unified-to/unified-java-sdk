...
public class ListHrisDevicesOperation implements RequestOperation<ListHrisDevicesRequest, ListHrisDevicesResponse> {
    ...
    public ListHrisDevicesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListHrisDevicesRequest request) throws Exception {
