...
public class ListAccountingBillsOperation implements RequestOperation<ListAccountingBillsRequest, ListAccountingBillsResponse> {
    ...
    public ListAccountingBillsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAccountingBillsRequest request) throws Exception {
