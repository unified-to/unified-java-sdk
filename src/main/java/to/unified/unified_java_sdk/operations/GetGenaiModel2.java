...
public class GetGenaiModel2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetGenaiModel2Request, GetGenaiModel2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetGenaiModel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetGenaiModel2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetGenaiModel2Request request) {
        ...
        @Override
        public GetGenaiModel2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetGenaiModel2Response.Builder resBuilder =
            ...
            GetGenaiModel2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGenaiModel(Utils.unmarshal(response, new TypeReference<GenaiModel>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetGenaiModel2Request, to.unified.unified_java_sdk.models.operations.async.GetGenaiModel2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetGenaiModel2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetGenaiModel2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetGenaiModel2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetGenaiModel2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetGenaiModel2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetGenaiModel2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetGenaiModel2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GenaiModel>() {})
                            .thenApply(res::withGenaiModel);
                } else {
