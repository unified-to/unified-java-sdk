...
public class PatchCalendarEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCalendarEventRequest, PatchCalendarEventResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCalendarEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCalendarEventRequest.class, new TypeReference<PatchCalendarEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCalendarEventRequest request) {
        ...
        @Override
        public PatchCalendarEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCalendarEventResponse.Builder resBuilder =
            ...
            PatchCalendarEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCalendarEventRequest, to.unified.unified_java_sdk.models.operations.async.PatchCalendarEventResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCalendarEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCalendarEventRequest.class, new TypeReference<PatchCalendarEventRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCalendarEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCalendarEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCalendarEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCalendarEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCalendarEventResponse res = resBuilder.build();
