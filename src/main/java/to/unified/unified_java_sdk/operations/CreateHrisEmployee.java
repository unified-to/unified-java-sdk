...
public class CreateHrisEmployee {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisEmployeeRequest, CreateHrisEmployeeResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisEmployeeRequest request) {
        ...
        @Override
        public CreateHrisEmployeeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisEmployeeResponse.Builder resBuilder =
            ...
            CreateHrisEmployeeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisEmployeeRequest, to.unified.unified_java_sdk.models.operations.async.CreateHrisEmployeeResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisEmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisEmployeeRequest.class, new TypeReference<CreateHrisEmployeeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisEmployeeRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisEmployeeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisEmployeeResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisEmployeeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisEmployeeResponse res = resBuilder.build();
