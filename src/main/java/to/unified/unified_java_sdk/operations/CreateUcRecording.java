...
public class CreateUcRecording {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateUcRecordingRequest, CreateUcRecordingResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateUcRecordingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateUcRecordingRequest.class, new TypeReference<CreateUcRecordingRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateUcRecordingRequest request) {
        ...
        @Override
        public CreateUcRecordingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateUcRecordingResponse.Builder resBuilder =
            ...
            CreateUcRecordingResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateUcRecordingRequest, to.unified.unified_java_sdk.models.operations.async.CreateUcRecordingResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateUcRecordingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateUcRecordingRequest.class, new TypeReference<CreateUcRecordingRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateUcRecordingRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateUcRecordingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateUcRecordingResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateUcRecordingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateUcRecordingResponse res = resBuilder.build();
