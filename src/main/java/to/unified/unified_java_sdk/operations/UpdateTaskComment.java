...
public class UpdateTaskComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTaskCommentRequest, UpdateTaskCommentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTaskCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTaskCommentRequest.class, new TypeReference<UpdateTaskCommentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTaskCommentRequest request) {
        ...
        @Override
        public UpdateTaskCommentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTaskCommentResponse.Builder resBuilder =
            ...
            UpdateTaskCommentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateTaskCommentRequest, to.unified.unified_java_sdk.models.operations.async.UpdateTaskCommentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateTaskCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTaskCommentRequest.class, new TypeReference<UpdateTaskCommentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateTaskCommentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateTaskCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateTaskCommentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateTaskCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateTaskCommentResponse res = resBuilder.build();
