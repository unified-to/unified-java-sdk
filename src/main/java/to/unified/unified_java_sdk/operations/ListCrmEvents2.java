...
public class ListCrmEvents2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCrmEvents2Request, ListCrmEvents2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCrmEvents2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmEvents2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmEvents2Request request) {
        ...
        @Override
        public ListCrmEvents2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCrmEvents2Response.Builder resBuilder =
            ...
            ListCrmEvents2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCrmEvents(Utils.unmarshal(response, new TypeReference<List<CrmEvent>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCrmEvents2Request, to.unified.unified_java_sdk.models.operations.async.ListCrmEvents2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCrmEvents2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmEvents2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCrmEvents2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCrmEvents2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCrmEvents2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCrmEvents2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCrmEvents2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CrmEvent>>() {})
                            .thenApply(res::withCrmEvents);
                } else {
