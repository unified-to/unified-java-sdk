...
public class RemoveCrmEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCrmEventRequest, RemoveCrmEventResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCrmEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmEventRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCrmEventRequest request) throws Exception {
        ...
        @Override
        public RemoveCrmEventResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCrmEventResponse.Builder resBuilder =
            ...
            RemoveCrmEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCrmEventRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCrmEventResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCrmEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmEventRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCrmEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCrmEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCrmEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCrmEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCrmEventResponse res = resBuilder.build();
