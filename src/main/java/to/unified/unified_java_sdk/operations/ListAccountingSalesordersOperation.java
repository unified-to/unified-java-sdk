...
public class ListAccountingSalesordersOperation implements RequestOperation<ListAccountingSalesordersRequest, ListAccountingSalesordersResponse> {
    ...
    public ListAccountingSalesordersOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAccountingSalesordersRequest request) throws Exception {
