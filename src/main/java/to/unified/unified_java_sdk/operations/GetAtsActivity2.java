...
public class GetAtsActivity2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAtsActivity2Request, GetAtsActivity2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAtsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsActivity2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAtsActivity2Request request) {
        ...
        @Override
        public GetAtsActivity2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAtsActivity2Response.Builder resBuilder =
            ...
            GetAtsActivity2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAtsActivity2Request, to.unified.unified_java_sdk.models.operations.async.GetAtsActivity2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAtsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsActivity2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAtsActivity2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAtsActivity2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAtsActivity2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAtsActivity2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAtsActivity2Response res = resBuilder.build();
