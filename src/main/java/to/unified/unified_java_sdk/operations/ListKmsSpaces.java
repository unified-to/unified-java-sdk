...
public class ListKmsSpaces {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListKmsSpacesRequest request) throws Exception {
        ...
        @Override
        public ListKmsSpacesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<KmsSpace> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withKmsSpaces(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
