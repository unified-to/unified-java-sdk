...
public class ListKmsSpaces {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListKmsSpacesRequest, ListKmsSpacesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListKmsSpacesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListKmsSpacesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListKmsSpacesRequest request) {
        ...
        @Override
        public ListKmsSpacesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListKmsSpacesResponse.Builder resBuilder =
            ...
            ListKmsSpacesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListKmsSpacesRequest, to.unified.unified_java_sdk.models.operations.async.ListKmsSpacesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListKmsSpacesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListKmsSpacesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListKmsSpacesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListKmsSpacesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListKmsSpacesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListKmsSpacesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListKmsSpacesResponse res = resBuilder.build();
