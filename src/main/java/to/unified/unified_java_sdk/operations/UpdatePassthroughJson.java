...
public class UpdatePassthroughJson {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatePassthroughJsonRequest, to.unified.unified_java_sdk.models.operations.async.UpdatePassthroughJsonResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePassthroughJsonRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePassthroughJsonRequest.class, new TypeReference<UpdatePassthroughJsonRequest>() {});
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdatePassthroughJsonResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdatePassthroughJsonResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdatePassthroughJsonResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            to.unified.unified_java_sdk.models.operations.async.UpdatePassthroughJsonResponse res = resBuilder.build();
