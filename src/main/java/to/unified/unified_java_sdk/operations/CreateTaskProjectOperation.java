...
public class CreateTaskProjectOperation implements RequestOperation<CreateTaskProjectRequest, CreateTaskProjectResponse> {
    ...
    public CreateTaskProjectOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateTaskProjectRequest request) throws Exception {
