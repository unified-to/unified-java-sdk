...
public class UpdateAnalyticsVisitor {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAnalyticsVisitorRequest, UpdateAnalyticsVisitorResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAnalyticsVisitorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAnalyticsVisitorRequest.class, new TypeReference<UpdateAnalyticsVisitorRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAnalyticsVisitorRequest request) {
        ...
        @Override
        public UpdateAnalyticsVisitorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAnalyticsVisitorResponse.Builder resBuilder =
            ...
            UpdateAnalyticsVisitorResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAnalyticsVisitorRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsVisitorResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAnalyticsVisitorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAnalyticsVisitorRequest.class, new TypeReference<UpdateAnalyticsVisitorRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAnalyticsVisitorRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsVisitorResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsVisitorResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsVisitorResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAnalyticsVisitorResponse res = resBuilder.build();
