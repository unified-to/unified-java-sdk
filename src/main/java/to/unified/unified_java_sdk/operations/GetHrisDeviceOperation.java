...
public class GetHrisDeviceOperation implements RequestOperation<GetHrisDeviceRequest, GetHrisDeviceResponse> {
    ...
    public GetHrisDeviceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetHrisDeviceRequest request) throws Exception {
