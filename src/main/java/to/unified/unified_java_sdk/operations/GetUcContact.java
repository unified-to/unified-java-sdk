...
public class GetUcContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUcContactRequest, GetUcContactResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUcContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUcContactRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUcContactRequest request) {
        ...
        @Override
        public GetUcContactResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUcContactResponse.Builder resBuilder =
            ...
            GetUcContactResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUcContactRequest, to.unified.unified_java_sdk.models.operations.async.GetUcContactResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUcContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUcContactRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUcContactRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetUcContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetUcContactResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetUcContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetUcContactResponse res = resBuilder.build();
