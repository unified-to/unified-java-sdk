...
public class GetLmsActivity {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLmsActivityRequest, GetLmsActivityResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLmsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsActivityRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLmsActivityRequest request) {
        ...
        @Override
        public GetLmsActivityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLmsActivityResponse.Builder resBuilder =
            ...
            GetLmsActivityResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLmsActivityRequest, to.unified.unified_java_sdk.models.operations.async.GetLmsActivityResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLmsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsActivityRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLmsActivityRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetLmsActivityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetLmsActivityResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetLmsActivityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetLmsActivityResponse res = resBuilder.build();
