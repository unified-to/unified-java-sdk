...
public class RemoveCrmDealOperation implements RequestOperation<RemoveCrmDealRequest, RemoveCrmDealResponse> {
    ...
    public RemoveCrmDealOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveCrmDealRequest request) throws Exception {
