...
public class GetAnalyticsVisitor2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAnalyticsVisitor2Request, GetAnalyticsVisitor2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAnalyticsVisitor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAnalyticsVisitor2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAnalyticsVisitor2Request request) {
        ...
        @Override
        public GetAnalyticsVisitor2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAnalyticsVisitor2Response.Builder resBuilder =
            ...
            GetAnalyticsVisitor2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAnalyticsVisitor2Request, to.unified.unified_java_sdk.models.operations.async.GetAnalyticsVisitor2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAnalyticsVisitor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAnalyticsVisitor2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAnalyticsVisitor2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAnalyticsVisitor2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAnalyticsVisitor2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAnalyticsVisitor2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAnalyticsVisitor2Response res = resBuilder.build();
