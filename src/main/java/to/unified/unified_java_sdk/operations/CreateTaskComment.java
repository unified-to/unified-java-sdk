...
public class CreateTaskComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTaskCommentRequest, CreateTaskCommentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateTaskCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTaskCommentRequest.class, new TypeReference<CreateTaskCommentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTaskCommentRequest request) {
        ...
        @Override
        public CreateTaskCommentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTaskCommentResponse.Builder resBuilder =
            ...
            CreateTaskCommentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTaskCommentRequest, to.unified.unified_java_sdk.models.operations.async.CreateTaskCommentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTaskCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTaskCommentRequest.class, new TypeReference<CreateTaskCommentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTaskCommentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateTaskCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateTaskCommentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateTaskCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateTaskCommentResponse res = resBuilder.build();
