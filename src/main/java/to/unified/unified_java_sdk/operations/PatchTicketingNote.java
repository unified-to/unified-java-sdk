...
public class PatchTicketingNote {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchTicketingNoteRequest, PatchTicketingNoteResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchTicketingNoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTicketingNoteRequest.class, new TypeReference<PatchTicketingNoteRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchTicketingNoteRequest request) {
        ...
        @Override
        public PatchTicketingNoteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchTicketingNoteResponse.Builder resBuilder =
            ...
            PatchTicketingNoteResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchTicketingNoteRequest, to.unified.unified_java_sdk.models.operations.async.PatchTicketingNoteResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchTicketingNoteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTicketingNoteRequest.class, new TypeReference<PatchTicketingNoteRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchTicketingNoteRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchTicketingNoteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchTicketingNoteResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchTicketingNoteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchTicketingNoteResponse res = resBuilder.build();
