...
public class GetCrmPipeline2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCrmPipeline2Request, GetCrmPipeline2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCrmPipeline2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmPipeline2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCrmPipeline2Request request) {
        ...
        @Override
        public GetCrmPipeline2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCrmPipeline2Response.Builder resBuilder =
            ...
            GetCrmPipeline2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCrmPipeline2Request, to.unified.unified_java_sdk.models.operations.async.GetCrmPipeline2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCrmPipeline2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmPipeline2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCrmPipeline2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCrmPipeline2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCrmPipeline2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCrmPipeline2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCrmPipeline2Response res = resBuilder.build();
