...
public class UpdateKmsSpace2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateKmsSpace2Request, UpdateKmsSpace2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateKmsSpace2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateKmsSpace2Request.class, new TypeReference<UpdateKmsSpace2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateKmsSpace2Request request) {
        ...
        @Override
        public UpdateKmsSpace2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateKmsSpace2Response.Builder resBuilder =
            ...
            UpdateKmsSpace2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withKmsSpace(Utils.unmarshal(response, new TypeReference<KmsSpace>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateKmsSpace2Request, to.unified.unified_java_sdk.models.operations.async.UpdateKmsSpace2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateKmsSpace2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateKmsSpace2Request.class, new TypeReference<UpdateKmsSpace2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateKmsSpace2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateKmsSpace2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateKmsSpace2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateKmsSpace2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateKmsSpace2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<KmsSpace>() {})
                            .thenApply(res::withKmsSpace);
                } else {
