...
public class UpdateCommerceReservation2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommerceReservation2Request, UpdateCommerceReservation2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCommerceReservation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceReservation2Request.class, new TypeReference<UpdateCommerceReservation2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceReservation2Request request) {
        ...
        @Override
        public UpdateCommerceReservation2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommerceReservation2Response.Builder resBuilder =
            ...
            UpdateCommerceReservation2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommerceReservation2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReservation2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommerceReservation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceReservation2Request.class, new TypeReference<UpdateCommerceReservation2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommerceReservation2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReservation2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReservation2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReservation2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReservation2Response res = resBuilder.build();
