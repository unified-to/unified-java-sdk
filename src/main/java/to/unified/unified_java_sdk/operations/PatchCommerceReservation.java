...
public class PatchCommerceReservation {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCommerceReservationRequest, PatchCommerceReservationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCommerceReservationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceReservationRequest.class, new TypeReference<PatchCommerceReservationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCommerceReservationRequest request) {
        ...
        @Override
        public PatchCommerceReservationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCommerceReservationResponse.Builder resBuilder =
                    PatchCommerceReservationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            PatchCommerceReservationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCommerceReservationRequest, to.unified.unified_java_sdk.models.operations.async.PatchCommerceReservationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCommerceReservationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceReservationRequest.class, new TypeReference<PatchCommerceReservationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCommerceReservationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCommerceReservationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCommerceReservationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCommerceReservationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCommerceReservationResponse res = resBuilder.build();
