...
public class GetAccountingInvoice {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingInvoiceRequest, GetAccountingInvoiceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingInvoiceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingInvoiceRequest request) {
        ...
        @Override
        public GetAccountingInvoiceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingInvoiceResponse.Builder resBuilder =
            ...
            GetAccountingInvoiceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingInvoiceRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingInvoiceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingInvoiceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingInvoiceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingInvoiceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingInvoiceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingInvoiceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingInvoiceResponse res = resBuilder.build();
