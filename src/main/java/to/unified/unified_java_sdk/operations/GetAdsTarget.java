...
public class GetAdsTarget {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAdsTargetRequest, GetAdsTargetResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAdsTargetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsTargetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAdsTargetRequest request) {
        ...
        @Override
        public GetAdsTargetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAdsTargetResponse.Builder resBuilder =
            ...
            GetAdsTargetResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAdsTargetRequest, to.unified.unified_java_sdk.models.operations.async.GetAdsTargetResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAdsTargetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsTargetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAdsTargetRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAdsTargetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAdsTargetResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAdsTargetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAdsTargetResponse res = resBuilder.build();
