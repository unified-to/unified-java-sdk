...
public class GetCalendarCalendar2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCalendarCalendar2Request, GetCalendarCalendar2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCalendarCalendar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarCalendar2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCalendarCalendar2Request request) {
        ...
        @Override
        public GetCalendarCalendar2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCalendarCalendar2Response.Builder resBuilder =
            ...
            GetCalendarCalendar2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCalendarCalendar2Request, to.unified.unified_java_sdk.models.operations.async.GetCalendarCalendar2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCalendarCalendar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarCalendar2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCalendarCalendar2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCalendarCalendar2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCalendarCalendar2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCalendarCalendar2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCalendarCalendar2Response res = resBuilder.build();
