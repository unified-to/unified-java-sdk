...
public class ListClubsGroups2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListClubsGroups2Request, ListClubsGroups2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListClubsGroups2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsGroups2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListClubsGroups2Request request) {
        ...
        @Override
        public ListClubsGroups2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListClubsGroups2Response.Builder resBuilder =
            ...
            ListClubsGroups2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClubsGroups(Utils.unmarshal(response, new TypeReference<List<ClubsGroup>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListClubsGroups2Request, to.unified.unified_java_sdk.models.operations.async.ListClubsGroups2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListClubsGroups2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsGroups2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListClubsGroups2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListClubsGroups2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListClubsGroups2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListClubsGroups2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListClubsGroups2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ClubsGroup>>() {})
                            .thenApply(res::withClubsGroups);
                } else {
