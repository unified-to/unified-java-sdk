...
public class ListAdsAssets {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsAssetsRequest, ListAdsAssetsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsAssetsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsAssetsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsAssetsRequest request) {
        ...
        @Override
        public ListAdsAssetsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsAssetsResponse.Builder resBuilder =
            ...
            ListAdsAssetsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdsAssets(Utils.unmarshal(response, new TypeReference<List<AdsAsset>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsAssetsRequest, to.unified.unified_java_sdk.models.operations.async.ListAdsAssetsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsAssetsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsAssetsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsAssetsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsAssetsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsAssetsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsAssetsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsAssetsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AdsAsset>>() {})
                            .thenApply(res::withAdsAssets);
                } else {
