...
public class RemoveAccountingCreditmemo2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingCreditmemo2Request, RemoveAccountingCreditmemo2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingCreditmemo2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingCreditmemo2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingCreditmemo2Request request) {
        ...
        @Override
        public RemoveAccountingCreditmemo2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingCreditmemo2Response.Builder resBuilder =
            ...
            RemoveAccountingCreditmemo2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingCreditmemo2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingCreditmemo2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingCreditmemo2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingCreditmemo2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingCreditmemo2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingCreditmemo2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingCreditmemo2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingCreditmemo2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingCreditmemo2Response res = resBuilder.build();
