...
public class GetClubsEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetClubsEventRequest, GetClubsEventResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetClubsEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsEventRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClubsEventRequest request) {
        ...
        @Override
        public GetClubsEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetClubsEventResponse.Builder resBuilder =
            ...
            GetClubsEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetClubsEventRequest, to.unified.unified_java_sdk.models.operations.async.GetClubsEventResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetClubsEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsEventRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetClubsEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetClubsEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetClubsEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetClubsEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetClubsEventResponse res = resBuilder.build();
