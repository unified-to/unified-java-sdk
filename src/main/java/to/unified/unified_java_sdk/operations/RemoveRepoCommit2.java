...
public class RemoveRepoCommit2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveRepoCommit2Request, RemoveRepoCommit2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveRepoCommit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoCommit2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveRepoCommit2Request request) {
        ...
        @Override
        public RemoveRepoCommit2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveRepoCommit2Response.Builder resBuilder =
            ...
            RemoveRepoCommit2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveRepoCommit2Request, to.unified.unified_java_sdk.models.operations.async.RemoveRepoCommit2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveRepoCommit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoCommit2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveRepoCommit2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveRepoCommit2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveRepoCommit2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveRepoCommit2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveRepoCommit2Response res = resBuilder.build();
