...
public class RemoveAccountingTaxrate {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingTaxrateRequest, RemoveAccountingTaxrateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingTaxrateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingTaxrateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingTaxrateRequest request) throws Exception {
        ...
        @Override
        public RemoveAccountingTaxrateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingTaxrateResponse.Builder resBuilder =
            ...
            RemoveAccountingTaxrateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingTaxrateRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingTaxrateResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingTaxrateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingTaxrateRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingTaxrateRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingTaxrateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingTaxrateResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingTaxrateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingTaxrateResponse res = resBuilder.build();
