...
public class PatchAccountingTransactionOperation implements RequestOperation<PatchAccountingTransactionRequest, PatchAccountingTransactionResponse> {
    ...
    public PatchAccountingTransactionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchAccountingTransactionRequest request) throws Exception {
