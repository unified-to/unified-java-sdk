...
public class ListCommerceLocationsOperation implements RequestOperation<ListCommerceLocationsRequest, ListCommerceLocationsResponse> {
    ...
    public ListCommerceLocationsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCommerceLocationsRequest request) throws Exception {
