...
public class PatchAccountingContactOperation implements RequestOperation<PatchAccountingContactRequest, PatchAccountingContactResponse> {
    ...
    public PatchAccountingContactOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchAccountingContactRequest request) throws Exception {
