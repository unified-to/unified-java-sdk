...
public class RemoveMetadataMetadata2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveMetadataMetadata2Request, RemoveMetadataMetadata2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveMetadataMetadata2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMetadataMetadata2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveMetadataMetadata2Request request) {
        ...
        @Override
        public RemoveMetadataMetadata2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveMetadataMetadata2Response.Builder resBuilder =
            ...
            RemoveMetadataMetadata2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveMetadataMetadata2Request, to.unified.unified_java_sdk.models.operations.async.RemoveMetadataMetadata2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveMetadataMetadata2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMetadataMetadata2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveMetadataMetadata2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveMetadataMetadata2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveMetadataMetadata2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveMetadataMetadata2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveMetadataMetadata2Response res = resBuilder.build();
