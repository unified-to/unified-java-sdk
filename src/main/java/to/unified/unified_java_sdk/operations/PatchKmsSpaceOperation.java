...
public class PatchKmsSpaceOperation implements RequestOperation<PatchKmsSpaceRequest, PatchKmsSpaceResponse> {
    ...
    public PatchKmsSpaceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchKmsSpaceRequest request) throws Exception {
