...
public class RemoveCdpSource {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCdpSourceRequest, RemoveCdpSourceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCdpSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCdpSourceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCdpSourceRequest request) {
        ...
        @Override
        public RemoveCdpSourceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCdpSourceResponse.Builder resBuilder =
            ...
            RemoveCdpSourceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCdpSourceRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCdpSourceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCdpSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCdpSourceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCdpSourceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCdpSourceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCdpSourceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCdpSourceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCdpSourceResponse res = resBuilder.build();
