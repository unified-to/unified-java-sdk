...
public class ListLmsClasses2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListLmsClasses2Request, ListLmsClasses2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListLmsClasses2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsClasses2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsClasses2Request request) {
        ...
        @Override
        public ListLmsClasses2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListLmsClasses2Response.Builder resBuilder =
            ...
            ListLmsClasses2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLmsClasses(Utils.unmarshal(response, new TypeReference<List<LmsClass>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLmsClasses2Request, to.unified.unified_java_sdk.models.operations.async.ListLmsClasses2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListLmsClasses2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsClasses2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListLmsClasses2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListLmsClasses2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListLmsClasses2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListLmsClasses2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListLmsClasses2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<LmsClass>>() {})
                            .thenApply(res::withLmsClasses);
                } else {
