...
public class UpdateTaskTaskOperation implements RequestOperation<UpdateTaskTaskRequest, UpdateTaskTaskResponse> {
    ...
    public UpdateTaskTaskOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateTaskTaskRequest request) throws Exception {
