...
public class UpdateTicketingTicket2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTicketingTicket2Request, UpdateTicketingTicket2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTicketingTicket2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketingTicket2Request.class, new TypeReference<UpdateTicketingTicket2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTicketingTicket2Request request) {
        ...
        @Override
        public UpdateTicketingTicket2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTicketingTicket2Response.Builder resBuilder =
            ...
            UpdateTicketingTicket2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateTicketingTicket2Request, to.unified.unified_java_sdk.models.operations.async.UpdateTicketingTicket2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateTicketingTicket2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketingTicket2Request.class, new TypeReference<UpdateTicketingTicket2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateTicketingTicket2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateTicketingTicket2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateTicketingTicket2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateTicketingTicket2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateTicketingTicket2Response res = resBuilder.build();
