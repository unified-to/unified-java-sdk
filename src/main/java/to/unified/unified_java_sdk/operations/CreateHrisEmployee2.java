...
public class CreateHrisEmployee2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisEmployee2Request, CreateHrisEmployee2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisEmployee2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisEmployee2Request.class, new TypeReference<CreateHrisEmployee2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisEmployee2Request request) {
        ...
        @Override
        public CreateHrisEmployee2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisEmployee2Response.Builder resBuilder =
            ...
            CreateHrisEmployee2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisEmployee2Request, to.unified.unified_java_sdk.models.operations.async.CreateHrisEmployee2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisEmployee2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisEmployee2Request.class, new TypeReference<CreateHrisEmployee2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisEmployee2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisEmployee2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisEmployee2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisEmployee2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisEmployee2Response res = resBuilder.build();
