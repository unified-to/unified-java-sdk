...
public class GetCrmContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCrmContactRequest, GetCrmContactResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCrmContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmContactRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCrmContactRequest request) {
        ...
        @Override
        public GetCrmContactResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCrmContactResponse.Builder resBuilder =
            ...
            GetCrmContactResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCrmContactRequest, to.unified.unified_java_sdk.models.operations.async.GetCrmContactResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCrmContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmContactRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCrmContactRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCrmContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCrmContactResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCrmContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCrmContactResponse res = resBuilder.build();
