...
public class RemoveAdsInsertionorder2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAdsInsertionorder2Request, RemoveAdsInsertionorder2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAdsInsertionorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsInsertionorder2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAdsInsertionorder2Request request) {
        ...
        @Override
        public RemoveAdsInsertionorder2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAdsInsertionorder2Response.Builder resBuilder =
            ...
            RemoveAdsInsertionorder2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAdsInsertionorder2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAdsInsertionorder2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAdsInsertionorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsInsertionorder2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAdsInsertionorder2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAdsInsertionorder2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAdsInsertionorder2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAdsInsertionorder2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAdsInsertionorder2Response res = resBuilder.build();
