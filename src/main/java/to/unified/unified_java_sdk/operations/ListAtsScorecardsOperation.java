...
public class ListAtsScorecardsOperation implements RequestOperation<ListAtsScorecardsRequest, ListAtsScorecardsResponse> {
    ...
    public ListAtsScorecardsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAtsScorecardsRequest request) throws Exception {
