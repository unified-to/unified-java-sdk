...
public class GetTaskTask2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTaskTask2Request, GetTaskTask2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTaskTask2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskTask2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTaskTask2Request request) {
        ...
        @Override
        public GetTaskTask2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTaskTask2Response.Builder resBuilder =
            ...
            GetTaskTask2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTaskTask2Request, to.unified.unified_java_sdk.models.operations.async.GetTaskTask2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTaskTask2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskTask2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTaskTask2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetTaskTask2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetTaskTask2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetTaskTask2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetTaskTask2Response res = resBuilder.build();
