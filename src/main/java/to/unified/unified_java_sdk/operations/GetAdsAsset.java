...
public class GetAdsAsset {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAdsAssetRequest, GetAdsAssetResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAdsAssetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsAssetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAdsAssetRequest request) {
        ...
        @Override
        public GetAdsAssetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAdsAssetResponse.Builder resBuilder =
                    GetAdsAssetResponse
                            .builder()
            ...
            GetAdsAssetResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAdsAssetRequest, to.unified.unified_java_sdk.models.operations.async.GetAdsAssetResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAdsAssetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsAssetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAdsAssetRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAdsAssetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAdsAssetResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAdsAssetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAdsAssetResponse res = resBuilder.build();
