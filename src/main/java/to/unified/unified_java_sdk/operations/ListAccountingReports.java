...
public class ListAccountingReports {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAccountingReportsRequest, ListAccountingReportsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAccountingReportsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAccountingReportsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountingReportsRequest request) {
        ...
        @Override
        public ListAccountingReportsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAccountingReportsResponse.Builder resBuilder =
            ...
            ListAccountingReportsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAccountingReportsRequest, to.unified.unified_java_sdk.models.operations.async.ListAccountingReportsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAccountingReportsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAccountingReportsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAccountingReportsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAccountingReportsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAccountingReportsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAccountingReportsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAccountingReportsResponse res = resBuilder.build();
