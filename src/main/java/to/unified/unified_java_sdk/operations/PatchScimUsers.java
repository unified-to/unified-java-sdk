...
public class PatchScimUsers {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchScimUsersRequest, PatchScimUsersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchScimUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchScimUsersRequest.class, new TypeReference<PatchScimUsersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchScimUsersRequest request) {
        ...
        @Override
        public PatchScimUsersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchScimUsersResponse.Builder resBuilder =
            ...
            PatchScimUsersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchScimUsersRequest, to.unified.unified_java_sdk.models.operations.async.PatchScimUsersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchScimUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchScimUsersRequest.class, new TypeReference<PatchScimUsersRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchScimUsersRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchScimUsersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchScimUsersResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchScimUsersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchScimUsersResponse res = resBuilder.build();
