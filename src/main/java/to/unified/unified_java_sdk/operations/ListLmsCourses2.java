...
public class ListLmsCourses2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListLmsCourses2Request, ListLmsCourses2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListLmsCourses2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsCourses2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsCourses2Request request) {
        ...
        @Override
        public ListLmsCourses2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListLmsCourses2Response.Builder resBuilder =
            ...
            ListLmsCourses2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLmsCourses(Utils.unmarshal(response, new TypeReference<List<LmsCourse>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLmsCourses2Request, to.unified.unified_java_sdk.models.operations.async.ListLmsCourses2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListLmsCourses2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsCourses2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListLmsCourses2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListLmsCourses2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListLmsCourses2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListLmsCourses2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListLmsCourses2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<LmsCourse>>() {})
                            .thenApply(res::withLmsCourses);
                } else {
