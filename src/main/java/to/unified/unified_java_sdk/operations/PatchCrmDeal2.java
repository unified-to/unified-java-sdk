...
public class PatchCrmDeal2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCrmDeal2Request, PatchCrmDeal2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCrmDeal2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmDeal2Request.class, new TypeReference<PatchCrmDeal2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCrmDeal2Request request) {
        ...
        @Override
        public PatchCrmDeal2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCrmDeal2Response.Builder resBuilder =
            ...
            PatchCrmDeal2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCrmDeal2Request, to.unified.unified_java_sdk.models.operations.async.PatchCrmDeal2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCrmDeal2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmDeal2Request.class, new TypeReference<PatchCrmDeal2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCrmDeal2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCrmDeal2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCrmDeal2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCrmDeal2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCrmDeal2Response res = resBuilder.build();
