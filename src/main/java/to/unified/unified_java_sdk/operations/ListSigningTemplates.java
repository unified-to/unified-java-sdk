...
public class ListSigningTemplates {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSigningTemplatesRequest, ListSigningTemplatesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSigningTemplatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSigningTemplatesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSigningTemplatesRequest request) {
        ...
        @Override
        public ListSigningTemplatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSigningTemplatesResponse.Builder resBuilder =
            ...
            ListSigningTemplatesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSigningTemplatesRequest, to.unified.unified_java_sdk.models.operations.async.ListSigningTemplatesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSigningTemplatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSigningTemplatesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSigningTemplatesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListSigningTemplatesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListSigningTemplatesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListSigningTemplatesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListSigningTemplatesResponse res = resBuilder.build();
