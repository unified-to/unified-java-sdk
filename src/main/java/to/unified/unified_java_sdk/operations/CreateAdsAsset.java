...
public class CreateAdsAsset {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAdsAssetRequest, CreateAdsAssetResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAdsAssetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsAssetRequest.class, new TypeReference<CreateAdsAssetRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAdsAssetRequest request) {
        ...
        @Override
        public CreateAdsAssetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAdsAssetResponse.Builder resBuilder =
            ...
            CreateAdsAssetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdsAsset(Utils.unmarshal(response, new TypeReference<AdsAsset>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAdsAssetRequest, to.unified.unified_java_sdk.models.operations.async.CreateAdsAssetResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAdsAssetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsAssetRequest.class, new TypeReference<CreateAdsAssetRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAdsAssetRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAdsAssetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAdsAssetResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAdsAssetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAdsAssetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AdsAsset>() {})
                            .thenApply(res::withAdsAsset);
                } else {
