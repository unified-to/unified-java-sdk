...
public class ListAccountingOrganizations {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountingOrganizationsRequest request) throws Exception {
        ...
        @Override
        public ListAccountingOrganizationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AccountingOrganization> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingOrganizations(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
