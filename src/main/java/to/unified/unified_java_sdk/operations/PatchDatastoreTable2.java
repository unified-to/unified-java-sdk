...
public class PatchDatastoreTable2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchDatastoreTable2Request, PatchDatastoreTable2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchDatastoreTable2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchDatastoreTable2Request.class, new TypeReference<PatchDatastoreTable2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchDatastoreTable2Request request) {
        ...
        @Override
        public PatchDatastoreTable2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchDatastoreTable2Response.Builder resBuilder =
            ...
            PatchDatastoreTable2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchDatastoreTable2Request, to.unified.unified_java_sdk.models.operations.async.PatchDatastoreTable2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchDatastoreTable2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchDatastoreTable2Request.class, new TypeReference<PatchDatastoreTable2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchDatastoreTable2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchDatastoreTable2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchDatastoreTable2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchDatastoreTable2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchDatastoreTable2Response res = resBuilder.build();
