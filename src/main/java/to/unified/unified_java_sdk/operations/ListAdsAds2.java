...
public class ListAdsAds2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsAds2Request, ListAdsAds2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsAds2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsAds2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsAds2Request request) {
        ...
        @Override
        public ListAdsAds2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsAds2Response.Builder resBuilder =
                    ListAdsAds2Response
                            .builder()
            ...
            ListAdsAds2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdsAds(Utils.unmarshal(response, new TypeReference<List<AdsAd>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsAds2Request, to.unified.unified_java_sdk.models.operations.async.ListAdsAds2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsAds2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsAds2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsAds2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsAds2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsAds2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsAds2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsAds2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AdsAd>>() {})
                            .thenApply(res::withAdsAds);
                } else {
