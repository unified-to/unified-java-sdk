...
public class ListRepoPullrequests {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRepoPullrequestsRequest, ListRepoPullrequestsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListRepoPullrequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoPullrequestsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRepoPullrequestsRequest request) {
        ...
        @Override
        public ListRepoPullrequestsResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListRepoPullrequestsRequest, to.unified.unified_java_sdk.models.operations.async.ListRepoPullrequestsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListRepoPullrequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoPullrequestsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRepoPullrequestsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListRepoPullrequestsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListRepoPullrequestsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListRepoPullrequestsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListRepoPullrequestsResponse res = resBuilder.build();
