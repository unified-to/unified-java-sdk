...
public class RemoveLmsContent {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveLmsContentRequest, RemoveLmsContentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveLmsContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsContentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveLmsContentRequest request) {
        ...
        @Override
        public RemoveLmsContentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveLmsContentResponse.Builder resBuilder =
            ...
            RemoveLmsContentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveLmsContentRequest, to.unified.unified_java_sdk.models.operations.async.RemoveLmsContentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveLmsContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsContentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveLmsContentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveLmsContentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveLmsContentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveLmsContentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveLmsContentResponse res = resBuilder.build();
