...
public class ListCdpEvents {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCdpEventsRequest, ListCdpEventsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCdpEventsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCdpEventsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCdpEventsRequest request) {
        ...
        @Override
        public ListCdpEventsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCdpEventsResponse.Builder resBuilder =
            ...
            ListCdpEventsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCdpEvents(Utils.unmarshal(response, new TypeReference<List<CdpEvent>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCdpEventsRequest, to.unified.unified_java_sdk.models.operations.async.ListCdpEventsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCdpEventsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCdpEventsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCdpEventsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCdpEventsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCdpEventsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCdpEventsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCdpEventsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CdpEvent>>() {})
                            .thenApply(res::withCdpEvents);
                } else {
