...
public class GetVerificationPackage {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetVerificationPackageRequest, GetVerificationPackageResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetVerificationPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetVerificationPackageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetVerificationPackageRequest request) {
        ...
        @Override
        public GetVerificationPackageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetVerificationPackageResponse.Builder resBuilder =
            ...
            GetVerificationPackageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetVerificationPackageRequest, to.unified.unified_java_sdk.models.operations.async.GetVerificationPackageResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetVerificationPackageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetVerificationPackageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetVerificationPackageRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetVerificationPackageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetVerificationPackageResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetVerificationPackageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetVerificationPackageResponse res = resBuilder.build();
