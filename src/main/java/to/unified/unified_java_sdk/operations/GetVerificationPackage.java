...
public class GetVerificationPackage {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetVerificationPackageRequest request) throws Exception {
        ...
        @Override
        public GetVerificationPackageResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    VerificationPackage out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withVerificationPackage(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
