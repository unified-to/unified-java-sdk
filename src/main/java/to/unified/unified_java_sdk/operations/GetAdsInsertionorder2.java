...
public class GetAdsInsertionorder2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAdsInsertionorder2Request, GetAdsInsertionorder2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAdsInsertionorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsInsertionorder2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAdsInsertionorder2Request request) {
        ...
        @Override
        public GetAdsInsertionorder2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAdsInsertionorder2Response.Builder resBuilder =
            ...
            GetAdsInsertionorder2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAdsInsertionorder2Request, to.unified.unified_java_sdk.models.operations.async.GetAdsInsertionorder2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAdsInsertionorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsInsertionorder2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAdsInsertionorder2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAdsInsertionorder2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAdsInsertionorder2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAdsInsertionorder2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAdsInsertionorder2Response res = resBuilder.build();
