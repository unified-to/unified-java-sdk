...
public class PatchAtsApplication2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAtsApplication2Request, PatchAtsApplication2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAtsApplication2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsApplication2Request.class, new TypeReference<PatchAtsApplication2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAtsApplication2Request request) {
        ...
        @Override
        public PatchAtsApplication2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAtsApplication2Response.Builder resBuilder =
            ...
            PatchAtsApplication2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAtsApplication2Request, to.unified.unified_java_sdk.models.operations.async.PatchAtsApplication2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAtsApplication2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsApplication2Request.class, new TypeReference<PatchAtsApplication2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAtsApplication2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAtsApplication2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAtsApplication2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAtsApplication2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAtsApplication2Response res = resBuilder.build();
