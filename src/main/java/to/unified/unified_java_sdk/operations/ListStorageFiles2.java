...
public class ListStorageFiles2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListStorageFiles2Request, ListStorageFiles2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListStorageFiles2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListStorageFiles2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListStorageFiles2Request request) {
        ...
        @Override
        public ListStorageFiles2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListStorageFiles2Response.Builder resBuilder =
            ...
            ListStorageFiles2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStorageFiles(Utils.unmarshal(response, new TypeReference<List<StorageFile>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListStorageFiles2Request, to.unified.unified_java_sdk.models.operations.async.ListStorageFiles2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListStorageFiles2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListStorageFiles2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListStorageFiles2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListStorageFiles2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListStorageFiles2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListStorageFiles2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListStorageFiles2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<StorageFile>>() {})
                            .thenApply(res::withStorageFiles);
                } else {
