...
public class UpdateAssessmentPackage2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAssessmentPackage2Request, UpdateAssessmentPackage2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAssessmentPackage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAssessmentPackage2Request.class, new TypeReference<UpdateAssessmentPackage2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAssessmentPackage2Request request) {
        ...
        @Override
        public UpdateAssessmentPackage2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAssessmentPackage2Response.Builder resBuilder =
            ...
            UpdateAssessmentPackage2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAssessmentPackage2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentPackage2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAssessmentPackage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAssessmentPackage2Request.class, new TypeReference<UpdateAssessmentPackage2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAssessmentPackage2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentPackage2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentPackage2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentPackage2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAssessmentPackage2Response res = resBuilder.build();
