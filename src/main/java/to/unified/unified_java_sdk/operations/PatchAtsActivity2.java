...
public class PatchAtsActivity2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAtsActivity2Request, PatchAtsActivity2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAtsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsActivity2Request.class, new TypeReference<PatchAtsActivity2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAtsActivity2Request request) {
        ...
        @Override
        public PatchAtsActivity2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAtsActivity2Response.Builder resBuilder =
            ...
            PatchAtsActivity2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAtsActivity2Request, to.unified.unified_java_sdk.models.operations.async.PatchAtsActivity2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAtsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsActivity2Request.class, new TypeReference<PatchAtsActivity2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAtsActivity2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAtsActivity2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAtsActivity2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAtsActivity2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAtsActivity2Response res = resBuilder.build();
