...
public class RemoveTaskProjectOperation implements RequestOperation<RemoveTaskProjectRequest, RemoveTaskProjectResponse> {
    ...
    public RemoveTaskProjectOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveTaskProjectRequest request) throws Exception {
