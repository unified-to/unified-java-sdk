...
public class UpdateCommerceInventory2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommerceInventory2Request, UpdateCommerceInventory2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCommerceInventory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceInventory2Request.class, new TypeReference<UpdateCommerceInventory2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceInventory2Request request) {
        ...
        @Override
        public UpdateCommerceInventory2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommerceInventory2Response.Builder resBuilder =
            ...
            UpdateCommerceInventory2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommerceInventory2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCommerceInventory2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommerceInventory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceInventory2Request.class, new TypeReference<UpdateCommerceInventory2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommerceInventory2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCommerceInventory2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceInventory2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCommerceInventory2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceInventory2Response res = resBuilder.build();
