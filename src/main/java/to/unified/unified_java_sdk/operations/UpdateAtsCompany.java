...
public class UpdateAtsCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAtsCompanyRequest, UpdateAtsCompanyResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAtsCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsCompanyRequest.class, new TypeReference<UpdateAtsCompanyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsCompanyRequest request) {
        ...
        @Override
        public UpdateAtsCompanyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAtsCompanyResponse.Builder resBuilder =
            ...
            UpdateAtsCompanyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAtsCompanyRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAtsCompanyResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAtsCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsCompanyRequest.class, new TypeReference<UpdateAtsCompanyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAtsCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAtsCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAtsCompanyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAtsCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAtsCompanyResponse res = resBuilder.build();
