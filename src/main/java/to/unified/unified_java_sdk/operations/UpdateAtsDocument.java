...
public class UpdateAtsDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAtsDocumentRequest, UpdateAtsDocumentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAtsDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsDocumentRequest.class, new TypeReference<UpdateAtsDocumentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsDocumentRequest request) {
        ...
        @Override
        public UpdateAtsDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAtsDocumentResponse.Builder resBuilder =
            ...
            UpdateAtsDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAtsDocumentRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAtsDocumentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAtsDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsDocumentRequest.class, new TypeReference<UpdateAtsDocumentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAtsDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAtsDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAtsDocumentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAtsDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAtsDocumentResponse res = resBuilder.build();
