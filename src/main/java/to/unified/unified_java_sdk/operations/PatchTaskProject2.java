...
public class PatchTaskProject2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchTaskProject2Request, PatchTaskProject2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchTaskProject2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTaskProject2Request.class, new TypeReference<PatchTaskProject2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchTaskProject2Request request) {
        ...
        @Override
        public PatchTaskProject2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchTaskProject2Response.Builder resBuilder =
            ...
            PatchTaskProject2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchTaskProject2Request, to.unified.unified_java_sdk.models.operations.async.PatchTaskProject2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchTaskProject2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTaskProject2Request.class, new TypeReference<PatchTaskProject2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchTaskProject2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchTaskProject2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchTaskProject2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchTaskProject2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchTaskProject2Response res = resBuilder.build();
