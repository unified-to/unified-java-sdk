...
public class CreateAccountingTransaction2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAccountingTransaction2Request, CreateAccountingTransaction2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAccountingTransaction2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingTransaction2Request.class, new TypeReference<CreateAccountingTransaction2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingTransaction2Request request) {
        ...
        @Override
        public CreateAccountingTransaction2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAccountingTransaction2Response.Builder resBuilder =
            ...
            CreateAccountingTransaction2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAccountingTransaction2Request, to.unified.unified_java_sdk.models.operations.async.CreateAccountingTransaction2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAccountingTransaction2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingTransaction2Request.class, new TypeReference<CreateAccountingTransaction2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAccountingTransaction2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAccountingTransaction2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAccountingTransaction2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAccountingTransaction2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAccountingTransaction2Response res = resBuilder.build();
