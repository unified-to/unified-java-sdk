...
public class CreatePassthroughJsonOperation implements RequestOperation<CreatePassthroughJsonRequest, CreatePassthroughJsonResponse> {
    ...
    public CreatePassthroughJsonOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreatePassthroughJsonRequest request) throws Exception {
