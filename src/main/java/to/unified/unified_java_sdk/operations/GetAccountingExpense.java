...
public class GetAccountingExpense {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingExpenseRequest, GetAccountingExpenseResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingExpenseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingExpenseRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingExpenseRequest request) {
        ...
        @Override
        public GetAccountingExpenseResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingExpenseResponse.Builder resBuilder =
            ...
            GetAccountingExpenseResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingExpenseRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingExpenseResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingExpenseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingExpenseRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingExpenseRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingExpenseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingExpenseResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingExpenseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingExpenseResponse res = resBuilder.build();
