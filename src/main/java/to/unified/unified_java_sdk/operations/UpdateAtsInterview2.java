...
public class UpdateAtsInterview2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAtsInterview2Request, UpdateAtsInterview2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAtsInterview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsInterview2Request.class, new TypeReference<UpdateAtsInterview2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsInterview2Request request) {
        ...
        @Override
        public UpdateAtsInterview2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAtsInterview2Response.Builder resBuilder =
            ...
            UpdateAtsInterview2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsInterview(Utils.unmarshal(response, new TypeReference<AtsInterview>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAtsInterview2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAtsInterview2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAtsInterview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsInterview2Request.class, new TypeReference<UpdateAtsInterview2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAtsInterview2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAtsInterview2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAtsInterview2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAtsInterview2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAtsInterview2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AtsInterview>() {})
                            .thenApply(res::withAtsInterview);
                } else {
