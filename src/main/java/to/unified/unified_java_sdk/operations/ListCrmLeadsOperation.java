...
public class ListCrmLeadsOperation implements RequestOperation<ListCrmLeadsRequest, ListCrmLeadsResponse> {
    ...
    public ListCrmLeadsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCrmLeadsRequest request) throws Exception {
