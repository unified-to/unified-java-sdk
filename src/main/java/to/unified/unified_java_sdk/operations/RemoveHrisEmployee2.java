...
public class RemoveHrisEmployee2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisEmployee2Request, RemoveHrisEmployee2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisEmployee2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisEmployee2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisEmployee2Request request) {
        ...
        @Override
        public RemoveHrisEmployee2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisEmployee2Response.Builder resBuilder =
            ...
            RemoveHrisEmployee2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisEmployee2Request, to.unified.unified_java_sdk.models.operations.async.RemoveHrisEmployee2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisEmployee2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisEmployee2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisEmployee2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisEmployee2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisEmployee2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisEmployee2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisEmployee2Response res = resBuilder.build();
