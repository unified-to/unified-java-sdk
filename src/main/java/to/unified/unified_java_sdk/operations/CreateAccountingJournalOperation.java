...
public class CreateAccountingJournalOperation implements RequestOperation<CreateAccountingJournalRequest, CreateAccountingJournalResponse> {
    ...
    public CreateAccountingJournalOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAccountingJournalRequest request) throws Exception {
