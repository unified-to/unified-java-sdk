...
public class ListGenaiTasks {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListGenaiTasksRequest, ListGenaiTasksResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListGenaiTasksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListGenaiTasksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListGenaiTasksRequest request) {
        ...
        @Override
        public ListGenaiTasksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListGenaiTasksResponse.Builder resBuilder =
            ...
            ListGenaiTasksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGenaiTasks(Utils.unmarshal(response, new TypeReference<List<GenaiTask>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListGenaiTasksRequest, to.unified.unified_java_sdk.models.operations.async.ListGenaiTasksResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListGenaiTasksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListGenaiTasksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListGenaiTasksRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListGenaiTasksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListGenaiTasksResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListGenaiTasksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListGenaiTasksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<GenaiTask>>() {})
                            .thenApply(res::withGenaiTasks);
                } else {
