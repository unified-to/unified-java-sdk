...
public class RemoveAtsCompanyOperation implements RequestOperation<RemoveAtsCompanyRequest, RemoveAtsCompanyResponse> {
    ...
    public RemoveAtsCompanyOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAtsCompanyRequest request) throws Exception {
        String url = Utils.generateURL(
                RemoveAtsCompanyRequest.class,
                this.baseUrl,
