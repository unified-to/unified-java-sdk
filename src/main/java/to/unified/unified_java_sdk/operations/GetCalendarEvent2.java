...
public class GetCalendarEvent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCalendarEvent2Request, GetCalendarEvent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCalendarEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarEvent2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCalendarEvent2Request request) {
        ...
        @Override
        public GetCalendarEvent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCalendarEvent2Response.Builder resBuilder =
            ...
            GetCalendarEvent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCalendarEvent2Request, to.unified.unified_java_sdk.models.operations.async.GetCalendarEvent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCalendarEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCalendarEvent2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCalendarEvent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCalendarEvent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCalendarEvent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCalendarEvent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCalendarEvent2Response res = resBuilder.build();
