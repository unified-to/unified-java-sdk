...
public class ListTaskProjects {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTaskProjectsRequest request) throws Exception {
        ...
        @Override
        public ListTaskProjectsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<TaskProject> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTaskProjects(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
