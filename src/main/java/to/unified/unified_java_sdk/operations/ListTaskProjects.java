...
public class ListTaskProjects {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTaskProjectsRequest, ListTaskProjectsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListTaskProjectsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaskProjectsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTaskProjectsRequest request) {
        ...
        @Override
        public ListTaskProjectsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTaskProjectsResponse.Builder resBuilder =
            ...
            ListTaskProjectsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTaskProjectsRequest, to.unified.unified_java_sdk.models.operations.async.ListTaskProjectsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListTaskProjectsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaskProjectsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTaskProjectsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListTaskProjectsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListTaskProjectsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListTaskProjectsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListTaskProjectsResponse res = resBuilder.build();
