...
public class ListUnifiedIntegrationWorkspacesOperation implements RequestOperation<ListUnifiedIntegrationWorkspacesRequest, ListUnifiedIntegrationWorkspacesResponse> {
    ...
    public ListUnifiedIntegrationWorkspacesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListUnifiedIntegrationWorkspacesRequest request) throws Exception {
