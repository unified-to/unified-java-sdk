...
public class GetAccountingProject {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingProjectRequest, GetAccountingProjectResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingProjectRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingProjectRequest request) {
        ...
        @Override
        public GetAccountingProjectResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingProjectResponse.Builder resBuilder =
            ...
            GetAccountingProjectResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingProjectRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingProjectResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingProjectRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingProjectRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingProjectResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingProjectResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingProjectResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingProjectResponse res = resBuilder.build();
