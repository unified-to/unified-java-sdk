...
public class PatchRepoOrganizationOperation implements RequestOperation<PatchRepoOrganizationRequest, PatchRepoOrganizationResponse> {
    ...
    public PatchRepoOrganizationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchRepoOrganizationRequest request) throws Exception {
