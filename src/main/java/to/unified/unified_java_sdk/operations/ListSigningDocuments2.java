...
public class ListSigningDocuments2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSigningDocuments2Request, ListSigningDocuments2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSigningDocuments2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListSigningDocuments2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSigningDocuments2Request request) {
        ...
        @Override
        public ListSigningDocuments2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSigningDocuments2Response.Builder resBuilder =
            ...
            ListSigningDocuments2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSigningDocuments(Utils.unmarshal(response, new TypeReference<List<SigningDocument>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSigningDocuments2Request, to.unified.unified_java_sdk.models.operations.async.ListSigningDocuments2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSigningDocuments2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListSigningDocuments2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSigningDocuments2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListSigningDocuments2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListSigningDocuments2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListSigningDocuments2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListSigningDocuments2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<SigningDocument>>() {})
                            .thenApply(res::withSigningDocuments);
                } else {
