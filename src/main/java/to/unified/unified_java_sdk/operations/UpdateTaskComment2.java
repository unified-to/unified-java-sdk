...
public class UpdateTaskComment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTaskComment2Request, UpdateTaskComment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTaskComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTaskComment2Request.class, new TypeReference<UpdateTaskComment2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTaskComment2Request request) {
        ...
        @Override
        public UpdateTaskComment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTaskComment2Response.Builder resBuilder =
            ...
            UpdateTaskComment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateTaskComment2Request, to.unified.unified_java_sdk.models.operations.async.UpdateTaskComment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateTaskComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTaskComment2Request.class, new TypeReference<UpdateTaskComment2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateTaskComment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateTaskComment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateTaskComment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateTaskComment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateTaskComment2Response res = resBuilder.build();
