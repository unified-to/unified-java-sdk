...
public class PatchHrisDevice2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisDevice2Request, PatchHrisDevice2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisDevice2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisDevice2Request.class, new TypeReference<PatchHrisDevice2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisDevice2Request request) {
        ...
        @Override
        public PatchHrisDevice2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisDevice2Response.Builder resBuilder =
            ...
            PatchHrisDevice2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisDevice2Request, to.unified.unified_java_sdk.models.operations.async.PatchHrisDevice2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisDevice2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisDevice2Request.class, new TypeReference<PatchHrisDevice2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisDevice2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisDevice2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisDevice2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisDevice2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisDevice2Response res = resBuilder.build();
