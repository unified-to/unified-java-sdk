...
public class ListSocialReviews {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSocialReviewsRequest, ListSocialReviewsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSocialReviewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSocialReviewsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSocialReviewsRequest request) {
        ...
        @Override
        public ListSocialReviewsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSocialReviewsResponse.Builder resBuilder =
            ...
            ListSocialReviewsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSocialReviews(Utils.unmarshal(response, new TypeReference<List<SocialReview>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSocialReviewsRequest, to.unified.unified_java_sdk.models.operations.async.ListSocialReviewsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSocialReviewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSocialReviewsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSocialReviewsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListSocialReviewsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListSocialReviewsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListSocialReviewsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListSocialReviewsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<SocialReview>>() {})
                            .thenApply(res::withSocialReviews);
                } else {
