...
public class RemoveHrisDeduction {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisDeductionRequest, RemoveHrisDeductionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisDeductionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisDeductionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisDeductionRequest request) {
        ...
        @Override
        public RemoveHrisDeductionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisDeductionResponse.Builder resBuilder =
            ...
            RemoveHrisDeductionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisDeductionRequest, to.unified.unified_java_sdk.models.operations.async.RemoveHrisDeductionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisDeductionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisDeductionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisDeductionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisDeductionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisDeductionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisDeductionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisDeductionResponse res = resBuilder.build();
