...
public class GetCdpEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCdpEventRequest, GetCdpEventResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCdpEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCdpEventRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCdpEventRequest request) {
        ...
        @Override
        public GetCdpEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCdpEventResponse.Builder resBuilder =
                    GetCdpEventResponse
                            .builder()
            ...
            GetCdpEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCdpEventRequest, to.unified.unified_java_sdk.models.operations.async.GetCdpEventResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCdpEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCdpEventRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCdpEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCdpEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCdpEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCdpEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCdpEventResponse res = resBuilder.build();
