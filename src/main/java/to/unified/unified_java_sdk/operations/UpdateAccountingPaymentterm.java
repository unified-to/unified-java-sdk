...
public class UpdateAccountingPaymentterm {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAccountingPaymenttermRequest, UpdateAccountingPaymenttermResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAccountingPaymenttermRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingPaymenttermRequest.class, new TypeReference<UpdateAccountingPaymenttermRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAccountingPaymenttermRequest request) {
        ...
        @Override
        public UpdateAccountingPaymenttermResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAccountingPaymenttermResponse.Builder resBuilder =
                    UpdateAccountingPaymenttermResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            UpdateAccountingPaymenttermResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAccountingPaymenttermRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAccountingPaymenttermResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAccountingPaymenttermRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingPaymenttermRequest.class, new TypeReference<UpdateAccountingPaymenttermRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAccountingPaymenttermRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAccountingPaymenttermResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingPaymenttermResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAccountingPaymenttermResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingPaymenttermResponse res = resBuilder.build();
