...
public class RemoveAnalyticsVisitor2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAnalyticsVisitor2Request, RemoveAnalyticsVisitor2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAnalyticsVisitor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAnalyticsVisitor2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAnalyticsVisitor2Request request) {
        ...
        @Override
        public RemoveAnalyticsVisitor2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAnalyticsVisitor2Response.Builder resBuilder =
            ...
            RemoveAnalyticsVisitor2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAnalyticsVisitor2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsVisitor2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAnalyticsVisitor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAnalyticsVisitor2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAnalyticsVisitor2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsVisitor2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsVisitor2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsVisitor2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsVisitor2Response res = resBuilder.build();
