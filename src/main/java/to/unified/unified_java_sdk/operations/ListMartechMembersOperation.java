...
public class ListMartechMembersOperation implements RequestOperation<ListMartechMembersRequest, ListMartechMembersResponse> {
    ...
    public ListMartechMembersOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListMartechMembersRequest request) throws Exception {
