...
public class RemoveAtsActivityOperation implements RequestOperation<RemoveAtsActivityRequest, RemoveAtsActivityResponse> {
    ...
    public RemoveAtsActivityOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAtsActivityRequest request) throws Exception {
