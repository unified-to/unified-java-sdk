...
public class GetUnifiedWebhook {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUnifiedWebhookRequest, GetUnifiedWebhookResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUnifiedWebhookRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUnifiedWebhookRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUnifiedWebhookRequest request) throws Exception {
        ...
        @Override
        public GetUnifiedWebhookResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUnifiedWebhookResponse.Builder resBuilder =
            ...
            GetUnifiedWebhookResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUnifiedWebhookRequest, to.unified.unified_java_sdk.models.operations.async.GetUnifiedWebhookResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUnifiedWebhookRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUnifiedWebhookRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUnifiedWebhookRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetUnifiedWebhookResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetUnifiedWebhookResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetUnifiedWebhookResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetUnifiedWebhookResponse res = resBuilder.build();
