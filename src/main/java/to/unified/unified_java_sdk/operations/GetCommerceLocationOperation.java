...
public class GetCommerceLocationOperation implements RequestOperation<GetCommerceLocationRequest, GetCommerceLocationResponse> {
    ...
    public GetCommerceLocationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetCommerceLocationRequest request) throws Exception {
