...
public class CreateMessagingMessage {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMessagingMessageRequest request) throws Exception {
        ...
        @Override
        public CreateMessagingMessageResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MessagingMessage out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMessagingMessage(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
