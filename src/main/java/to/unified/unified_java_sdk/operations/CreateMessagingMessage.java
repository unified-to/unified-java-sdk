...
public class CreateMessagingMessage {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateMessagingMessageRequest, CreateMessagingMessageResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateMessagingMessageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMessagingMessageRequest.class, new TypeReference<CreateMessagingMessageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMessagingMessageRequest request) {
        ...
        @Override
        public CreateMessagingMessageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateMessagingMessageResponse.Builder resBuilder =
            ...
            CreateMessagingMessageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateMessagingMessageRequest, to.unified.unified_java_sdk.models.operations.async.CreateMessagingMessageResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateMessagingMessageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMessagingMessageRequest.class, new TypeReference<CreateMessagingMessageRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateMessagingMessageRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateMessagingMessageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateMessagingMessageResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateMessagingMessageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateMessagingMessageResponse res = resBuilder.build();
