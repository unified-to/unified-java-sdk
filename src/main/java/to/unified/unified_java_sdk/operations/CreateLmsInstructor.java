...
public class CreateLmsInstructor {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateLmsInstructorRequest, CreateLmsInstructorResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateLmsInstructorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsInstructorRequest.class, new TypeReference<CreateLmsInstructorRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateLmsInstructorRequest request) {
        ...
        @Override
        public CreateLmsInstructorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateLmsInstructorResponse.Builder resBuilder =
            ...
            CreateLmsInstructorResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateLmsInstructorRequest, to.unified.unified_java_sdk.models.operations.async.CreateLmsInstructorResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateLmsInstructorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsInstructorRequest.class, new TypeReference<CreateLmsInstructorRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateLmsInstructorRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateLmsInstructorResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateLmsInstructorResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateLmsInstructorResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateLmsInstructorResponse res = resBuilder.build();
