...
public class GetRepoBranch {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRepoBranchRequest, GetRepoBranchResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRepoBranchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoBranchRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRepoBranchRequest request) {
        ...
        @Override
        public GetRepoBranchResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRepoBranchResponse.Builder resBuilder =
            ...
            GetRepoBranchResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRepoBranchRequest, to.unified.unified_java_sdk.models.operations.async.GetRepoBranchResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRepoBranchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoBranchRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRepoBranchRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetRepoBranchResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetRepoBranchResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetRepoBranchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetRepoBranchResponse res = resBuilder.build();
