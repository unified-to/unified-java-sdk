...
public class RemoveRepoBranch2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveRepoBranch2Request, RemoveRepoBranch2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveRepoBranch2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoBranch2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveRepoBranch2Request request) {
        ...
        @Override
        public RemoveRepoBranch2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveRepoBranch2Response.Builder resBuilder =
            ...
            RemoveRepoBranch2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveRepoBranch2Request, to.unified.unified_java_sdk.models.operations.async.RemoveRepoBranch2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveRepoBranch2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoBranch2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveRepoBranch2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveRepoBranch2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveRepoBranch2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveRepoBranch2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveRepoBranch2Response res = resBuilder.build();
