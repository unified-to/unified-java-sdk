...
public class ListAtsScorecards2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAtsScorecards2Request, ListAtsScorecards2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAtsScorecards2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsScorecards2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsScorecards2Request request) {
        ...
        @Override
        public ListAtsScorecards2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsScorecards2Response.Builder resBuilder =
            ...
            ListAtsScorecards2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsScorecards(Utils.unmarshal(response, new TypeReference<List<AtsScorecard>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsScorecards2Request, to.unified.unified_java_sdk.models.operations.async.ListAtsScorecards2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsScorecards2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsScorecards2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsScorecards2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsScorecards2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsScorecards2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsScorecards2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsScorecards2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AtsScorecard>>() {})
                            .thenApply(res::withAtsScorecards);
                } else {
