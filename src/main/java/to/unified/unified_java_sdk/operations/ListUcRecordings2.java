...
public class ListUcRecordings2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUcRecordings2Request, ListUcRecordings2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListUcRecordings2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListUcRecordings2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUcRecordings2Request request) {
        ...
        @Override
        public ListUcRecordings2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUcRecordings2Response.Builder resBuilder =
            ...
            ListUcRecordings2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUcRecordings(Utils.unmarshal(response, new TypeReference<List<UcRecording>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUcRecordings2Request, to.unified.unified_java_sdk.models.operations.async.ListUcRecordings2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListUcRecordings2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListUcRecordings2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUcRecordings2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListUcRecordings2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListUcRecordings2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListUcRecordings2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListUcRecordings2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<UcRecording>>() {})
                            .thenApply(res::withUcRecordings);
                } else {
