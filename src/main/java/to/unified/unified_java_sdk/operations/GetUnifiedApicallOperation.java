...
public class GetUnifiedApicallOperation implements RequestOperation<GetUnifiedApicallRequest, GetUnifiedApicallResponse> {
    ...
    public GetUnifiedApicallOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetUnifiedApicallRequest request) throws Exception {
