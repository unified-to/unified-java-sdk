...
public class GetCommerceItemvariant {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceItemvariantRequest, GetCommerceItemvariantResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommerceItemvariantRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceItemvariantRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceItemvariantRequest request) {
        ...
        @Override
        public GetCommerceItemvariantResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommerceItemvariantResponse.Builder resBuilder =
            ...
            GetCommerceItemvariantResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommerceItemvariantRequest, to.unified.unified_java_sdk.models.operations.async.GetCommerceItemvariantResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommerceItemvariantRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceItemvariantRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommerceItemvariantRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCommerceItemvariantResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCommerceItemvariantResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCommerceItemvariantResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCommerceItemvariantResponse res = resBuilder.build();
