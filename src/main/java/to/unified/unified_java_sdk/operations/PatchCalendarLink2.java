...
public class PatchCalendarLink2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCalendarLink2Request, PatchCalendarLink2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCalendarLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCalendarLink2Request.class, new TypeReference<PatchCalendarLink2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCalendarLink2Request request) {
        ...
        @Override
        public PatchCalendarLink2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCalendarLink2Response.Builder resBuilder =
            ...
            PatchCalendarLink2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCalendarLink2Request, to.unified.unified_java_sdk.models.operations.async.PatchCalendarLink2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCalendarLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCalendarLink2Request.class, new TypeReference<PatchCalendarLink2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCalendarLink2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCalendarLink2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCalendarLink2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCalendarLink2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCalendarLink2Response res = resBuilder.build();
