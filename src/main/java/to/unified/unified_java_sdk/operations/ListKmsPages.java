...
public class ListKmsPages {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListKmsPagesRequest, ListKmsPagesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListKmsPagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListKmsPagesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListKmsPagesRequest request) {
        ...
        @Override
        public ListKmsPagesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListKmsPagesResponse.Builder resBuilder =
            ...
            ListKmsPagesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListKmsPagesRequest, to.unified.unified_java_sdk.models.operations.async.ListKmsPagesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListKmsPagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListKmsPagesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListKmsPagesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListKmsPagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListKmsPagesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListKmsPagesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListKmsPagesResponse res = resBuilder.build();
