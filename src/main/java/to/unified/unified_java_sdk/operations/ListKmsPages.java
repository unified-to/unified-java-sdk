...
public class ListKmsPages {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListKmsPagesRequest request) throws Exception {
        ...
        @Override
        public ListKmsPagesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<KmsPage> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withKmsPages(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
