...
public class UpdateCommerceReservation {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommerceReservationRequest, UpdateCommerceReservationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCommerceReservationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceReservationRequest.class, new TypeReference<UpdateCommerceReservationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceReservationRequest request) {
        ...
        @Override
        public UpdateCommerceReservationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommerceReservationResponse.Builder resBuilder =
                    UpdateCommerceReservationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            UpdateCommerceReservationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommerceReservationRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReservationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommerceReservationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceReservationRequest.class, new TypeReference<UpdateCommerceReservationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommerceReservationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReservationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReservationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReservationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceReservationResponse res = resBuilder.build();
