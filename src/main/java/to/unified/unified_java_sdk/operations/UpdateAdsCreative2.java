...
public class UpdateAdsCreative2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAdsCreative2Request, UpdateAdsCreative2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAdsCreative2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsCreative2Request.class, new TypeReference<UpdateAdsCreative2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAdsCreative2Request request) {
        ...
        @Override
        public UpdateAdsCreative2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAdsCreative2Response.Builder resBuilder =
            ...
            UpdateAdsCreative2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAdsCreative2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAdsCreative2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAdsCreative2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsCreative2Request.class, new TypeReference<UpdateAdsCreative2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAdsCreative2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAdsCreative2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAdsCreative2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAdsCreative2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAdsCreative2Response res = resBuilder.build();
