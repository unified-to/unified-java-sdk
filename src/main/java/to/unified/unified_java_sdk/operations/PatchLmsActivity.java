...
public class PatchLmsActivity {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchLmsActivityRequest, PatchLmsActivityResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchLmsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsActivityRequest.class, new TypeReference<PatchLmsActivityRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchLmsActivityRequest request) {
        ...
        @Override
        public PatchLmsActivityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchLmsActivityResponse.Builder resBuilder =
            ...
            PatchLmsActivityResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchLmsActivityRequest, to.unified.unified_java_sdk.models.operations.async.PatchLmsActivityResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchLmsActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsActivityRequest.class, new TypeReference<PatchLmsActivityRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchLmsActivityRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchLmsActivityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchLmsActivityResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchLmsActivityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchLmsActivityResponse res = resBuilder.build();
