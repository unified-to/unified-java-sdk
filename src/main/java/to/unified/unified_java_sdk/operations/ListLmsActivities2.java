...
public class ListLmsActivities2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListLmsActivities2Request, ListLmsActivities2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListLmsActivities2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsActivities2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsActivities2Request request) {
        ...
        @Override
        public ListLmsActivities2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListLmsActivities2Response.Builder resBuilder =
            ...
            ListLmsActivities2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLmsActivities(Utils.unmarshal(response, new TypeReference<List<LmsActivity>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLmsActivities2Request, to.unified.unified_java_sdk.models.operations.async.ListLmsActivities2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListLmsActivities2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsActivities2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListLmsActivities2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListLmsActivities2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListLmsActivities2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListLmsActivities2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListLmsActivities2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<LmsActivity>>() {})
                            .thenApply(res::withLmsActivities);
                } else {
