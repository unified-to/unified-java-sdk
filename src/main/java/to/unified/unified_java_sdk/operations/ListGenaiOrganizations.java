...
public class ListGenaiOrganizations {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListGenaiOrganizationsRequest, ListGenaiOrganizationsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListGenaiOrganizationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListGenaiOrganizationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListGenaiOrganizationsRequest request) {
        ...
        @Override
        public ListGenaiOrganizationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListGenaiOrganizationsResponse.Builder resBuilder =
                    ListGenaiOrganizationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ListGenaiOrganizationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGenaiOrganizations(Utils.unmarshal(response, new TypeReference<List<GenaiOrganization>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListGenaiOrganizationsRequest, to.unified.unified_java_sdk.models.operations.async.ListGenaiOrganizationsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListGenaiOrganizationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListGenaiOrganizationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListGenaiOrganizationsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListGenaiOrganizationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListGenaiOrganizationsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListGenaiOrganizationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListGenaiOrganizationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<GenaiOrganization>>() {})
                            .thenApply(res::withGenaiOrganizations);
                } else {
