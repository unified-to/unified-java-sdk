...
public class PatchMartechMember2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchMartechMember2Request, PatchMartechMember2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchMartechMember2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMartechMember2Request.class, new TypeReference<PatchMartechMember2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchMartechMember2Request request) {
        ...
        @Override
        public PatchMartechMember2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchMartechMember2Response.Builder resBuilder =
            ...
            PatchMartechMember2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchMartechMember2Request, to.unified.unified_java_sdk.models.operations.async.PatchMartechMember2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchMartechMember2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMartechMember2Request.class, new TypeReference<PatchMartechMember2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchMartechMember2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchMartechMember2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchMartechMember2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchMartechMember2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchMartechMember2Response res = resBuilder.build();
