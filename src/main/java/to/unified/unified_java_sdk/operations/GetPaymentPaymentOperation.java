...
public class GetPaymentPaymentOperation implements RequestOperation<GetPaymentPaymentRequest, GetPaymentPaymentResponse> {
    ...
    public GetPaymentPaymentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetPaymentPaymentRequest request) throws Exception {
