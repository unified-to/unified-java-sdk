...
public class CreateTicketingCustomer2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTicketingCustomer2Request, CreateTicketingCustomer2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateTicketingCustomer2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTicketingCustomer2Request.class, new TypeReference<CreateTicketingCustomer2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTicketingCustomer2Request request) {
        ...
        @Override
        public CreateTicketingCustomer2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTicketingCustomer2Response.Builder resBuilder =
            ...
            CreateTicketingCustomer2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingCustomer(Utils.unmarshal(response, new TypeReference<TicketingCustomer>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTicketingCustomer2Request, to.unified.unified_java_sdk.models.operations.async.CreateTicketingCustomer2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTicketingCustomer2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTicketingCustomer2Request.class, new TypeReference<CreateTicketingCustomer2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTicketingCustomer2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateTicketingCustomer2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateTicketingCustomer2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateTicketingCustomer2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateTicketingCustomer2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingCustomer>() {})
                            .thenApply(res::withTicketingCustomer);
                } else {
