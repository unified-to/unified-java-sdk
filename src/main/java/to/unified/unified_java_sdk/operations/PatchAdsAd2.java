...
public class PatchAdsAd2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAdsAd2Request, PatchAdsAd2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAdsAd2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsAd2Request.class, new TypeReference<PatchAdsAd2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAdsAd2Request request) {
        ...
        @Override
        public PatchAdsAd2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAdsAd2Response.Builder resBuilder =
                    PatchAdsAd2Response
                            .builder()
            ...
            PatchAdsAd2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAdsAd2Request, to.unified.unified_java_sdk.models.operations.async.PatchAdsAd2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAdsAd2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsAd2Request.class, new TypeReference<PatchAdsAd2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAdsAd2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAdsAd2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAdsAd2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAdsAd2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAdsAd2Response res = resBuilder.build();
