...
public class UpdateLmsClassOperation implements RequestOperation<UpdateLmsClassRequest, UpdateLmsClassResponse> {
    ...
    public UpdateLmsClassOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateLmsClassRequest request) throws Exception {
