...
public class UpdateTaskProject {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTaskProjectRequest, UpdateTaskProjectResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTaskProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTaskProjectRequest.class, new TypeReference<UpdateTaskProjectRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTaskProjectRequest request) {
        ...
        @Override
        public UpdateTaskProjectResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTaskProjectResponse.Builder resBuilder =
            ...
            UpdateTaskProjectResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateTaskProjectRequest, to.unified.unified_java_sdk.models.operations.async.UpdateTaskProjectResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateTaskProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTaskProjectRequest.class, new TypeReference<UpdateTaskProjectRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateTaskProjectRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateTaskProjectResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateTaskProjectResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateTaskProjectResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateTaskProjectResponse res = resBuilder.build();
