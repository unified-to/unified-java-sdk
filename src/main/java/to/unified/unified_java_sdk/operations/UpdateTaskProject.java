...
public class UpdateTaskProject {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTaskProjectRequest request) throws Exception {
        ...
        @Override
        public UpdateTaskProjectResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TaskProject out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTaskProject(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
