...
public class CreatePassthrough2Raw {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePassthrough2RawRequest, CreatePassthrough2RawResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreatePassthrough2RawRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePassthrough2RawRequest.class, new TypeReference<CreatePassthrough2RawRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePassthrough2RawRequest request) {
        ...
        @Override
        public CreatePassthrough2RawResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePassthrough2RawResponse.Builder resBuilder =
            ...
            CreatePassthrough2RawResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePassthrough2RawRequest, to.unified.unified_java_sdk.models.operations.async.CreatePassthrough2RawResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreatePassthrough2RawRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePassthrough2RawRequest.class, new TypeReference<CreatePassthrough2RawRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePassthrough2RawRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreatePassthrough2RawResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreatePassthrough2RawResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreatePassthrough2RawResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            to.unified.unified_java_sdk.models.operations.async.CreatePassthrough2RawResponse res = resBuilder.build();
