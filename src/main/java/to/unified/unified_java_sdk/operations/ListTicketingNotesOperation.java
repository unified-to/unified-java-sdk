...
public class ListTicketingNotesOperation implements RequestOperation<ListTicketingNotesRequest, ListTicketingNotesResponse> {
    ...
    public ListTicketingNotesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListTicketingNotesRequest request) throws Exception {
