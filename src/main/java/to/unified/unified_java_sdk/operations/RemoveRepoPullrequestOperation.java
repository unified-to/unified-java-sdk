...
public class RemoveRepoPullrequestOperation implements RequestOperation<RemoveRepoPullrequestRequest, RemoveRepoPullrequestResponse> {
    ...
    public RemoveRepoPullrequestOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveRepoPullrequestRequest request) throws Exception {
