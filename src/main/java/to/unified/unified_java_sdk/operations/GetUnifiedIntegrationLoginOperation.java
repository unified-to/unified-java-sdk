...
public class GetUnifiedIntegrationLoginOperation implements RequestOperation<GetUnifiedIntegrationLoginRequest, GetUnifiedIntegrationLoginResponse> {
    ...
    public GetUnifiedIntegrationLoginOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetUnifiedIntegrationLoginRequest request) throws Exception {
