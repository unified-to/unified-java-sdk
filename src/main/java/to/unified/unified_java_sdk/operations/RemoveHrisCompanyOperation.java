...
public class RemoveHrisCompanyOperation implements RequestOperation<RemoveHrisCompanyRequest, RemoveHrisCompanyResponse> {
    ...
    public RemoveHrisCompanyOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveHrisCompanyRequest request) throws Exception {
