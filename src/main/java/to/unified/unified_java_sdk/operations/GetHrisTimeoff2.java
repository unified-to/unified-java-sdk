...
public class GetHrisTimeoff2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisTimeoff2Request, GetHrisTimeoff2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisTimeoff2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisTimeoff2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisTimeoff2Request request) {
        ...
        @Override
        public GetHrisTimeoff2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisTimeoff2Response.Builder resBuilder =
            ...
            GetHrisTimeoff2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisTimeoff2Request, to.unified.unified_java_sdk.models.operations.async.GetHrisTimeoff2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisTimeoff2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisTimeoff2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisTimeoff2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisTimeoff2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisTimeoff2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisTimeoff2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisTimeoff2Response res = resBuilder.build();
