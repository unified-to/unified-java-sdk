...
public class ListAtsApplications2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAtsApplications2Request, ListAtsApplications2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAtsApplications2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsApplications2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsApplications2Request request) {
        ...
        @Override
        public ListAtsApplications2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsApplications2Response.Builder resBuilder =
            ...
            ListAtsApplications2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsApplications(Utils.unmarshal(response, new TypeReference<List<AtsApplication>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsApplications2Request, to.unified.unified_java_sdk.models.operations.async.ListAtsApplications2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsApplications2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsApplications2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsApplications2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsApplications2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsApplications2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsApplications2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsApplications2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AtsApplication>>() {})
                            .thenApply(res::withAtsApplications);
                } else {
