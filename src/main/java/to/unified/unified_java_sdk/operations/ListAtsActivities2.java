...
public class ListAtsActivities2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAtsActivities2Request, ListAtsActivities2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAtsActivities2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsActivities2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsActivities2Request request) {
        ...
        @Override
        public ListAtsActivities2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsActivities2Response.Builder resBuilder =
            ...
            ListAtsActivities2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsActivities(Utils.unmarshal(response, new TypeReference<List<AtsActivity>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsActivities2Request, to.unified.unified_java_sdk.models.operations.async.ListAtsActivities2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsActivities2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsActivities2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsActivities2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsActivities2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsActivities2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsActivities2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsActivities2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AtsActivity>>() {})
                            .thenApply(res::withAtsActivities);
                } else {
