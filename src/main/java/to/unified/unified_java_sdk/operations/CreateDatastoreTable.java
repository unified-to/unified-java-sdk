...
public class CreateDatastoreTable {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateDatastoreTableRequest, CreateDatastoreTableResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateDatastoreTableRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDatastoreTableRequest.class, new TypeReference<CreateDatastoreTableRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDatastoreTableRequest request) {
        ...
        @Override
        public CreateDatastoreTableResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDatastoreTableResponse.Builder resBuilder =
            ...
            CreateDatastoreTableResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateDatastoreTableRequest, to.unified.unified_java_sdk.models.operations.async.CreateDatastoreTableResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateDatastoreTableRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDatastoreTableRequest.class, new TypeReference<CreateDatastoreTableRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateDatastoreTableRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateDatastoreTableResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateDatastoreTableResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateDatastoreTableResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateDatastoreTableResponse res = resBuilder.build();
