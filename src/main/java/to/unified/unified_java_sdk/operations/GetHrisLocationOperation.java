...
public class GetHrisLocationOperation implements RequestOperation<GetHrisLocationRequest, GetHrisLocationResponse> {
    ...
    public GetHrisLocationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetHrisLocationRequest request) throws Exception {
