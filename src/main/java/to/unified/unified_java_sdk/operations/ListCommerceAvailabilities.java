...
public class ListCommerceAvailabilities {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceAvailabilitiesRequest, ListCommerceAvailabilitiesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommerceAvailabilitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceAvailabilitiesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceAvailabilitiesRequest request) {
        ...
        @Override
        public ListCommerceAvailabilitiesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceAvailabilitiesResponse.Builder resBuilder =
            ...
            ListCommerceAvailabilitiesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceAvailabilitiesRequest, to.unified.unified_java_sdk.models.operations.async.ListCommerceAvailabilitiesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceAvailabilitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceAvailabilitiesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceAvailabilitiesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceAvailabilitiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceAvailabilitiesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceAvailabilitiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceAvailabilitiesResponse res = resBuilder.build();
