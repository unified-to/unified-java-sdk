...
public class RemoveCalendarEvent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCalendarEvent2Request, RemoveCalendarEvent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCalendarEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCalendarEvent2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCalendarEvent2Request request) {
        ...
        @Override
        public RemoveCalendarEvent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCalendarEvent2Response.Builder resBuilder =
            ...
            RemoveCalendarEvent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCalendarEvent2Request, to.unified.unified_java_sdk.models.operations.async.RemoveCalendarEvent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCalendarEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCalendarEvent2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCalendarEvent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCalendarEvent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCalendarEvent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCalendarEvent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCalendarEvent2Response res = resBuilder.build();
