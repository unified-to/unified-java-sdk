...
public class RemoveTicketingCustomerOperation implements RequestOperation<RemoveTicketingCustomerRequest, RemoveTicketingCustomerResponse> {
    ...
    public RemoveTicketingCustomerOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveTicketingCustomerRequest request) throws Exception {
