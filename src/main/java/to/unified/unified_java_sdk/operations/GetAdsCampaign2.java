...
public class GetAdsCampaign2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAdsCampaign2Request, GetAdsCampaign2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAdsCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsCampaign2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAdsCampaign2Request request) {
        ...
        @Override
        public GetAdsCampaign2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAdsCampaign2Response.Builder resBuilder =
            ...
            GetAdsCampaign2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAdsCampaign2Request, to.unified.unified_java_sdk.models.operations.async.GetAdsCampaign2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAdsCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsCampaign2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAdsCampaign2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAdsCampaign2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAdsCampaign2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAdsCampaign2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAdsCampaign2Response res = resBuilder.build();
