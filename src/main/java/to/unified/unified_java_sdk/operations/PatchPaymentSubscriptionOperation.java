...
public class PatchPaymentSubscriptionOperation implements RequestOperation<PatchPaymentSubscriptionRequest, PatchPaymentSubscriptionResponse> {
    ...
    public PatchPaymentSubscriptionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchPaymentSubscriptionRequest request) throws Exception {
