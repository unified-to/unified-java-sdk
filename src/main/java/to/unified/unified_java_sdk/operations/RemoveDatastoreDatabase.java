...
public class RemoveDatastoreDatabase {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveDatastoreDatabaseRequest, RemoveDatastoreDatabaseResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveDatastoreDatabaseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDatastoreDatabaseRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveDatastoreDatabaseRequest request) {
        ...
        @Override
        public RemoveDatastoreDatabaseResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveDatastoreDatabaseResponse.Builder resBuilder =
            ...
            RemoveDatastoreDatabaseResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveDatastoreDatabaseRequest, to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreDatabaseResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveDatastoreDatabaseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDatastoreDatabaseRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveDatastoreDatabaseRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreDatabaseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreDatabaseResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreDatabaseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreDatabaseResponse res = resBuilder.build();
