...
public class GetHrisAttendance {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisAttendanceRequest, GetHrisAttendanceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisAttendanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisAttendanceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisAttendanceRequest request) {
        ...
        @Override
        public GetHrisAttendanceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisAttendanceResponse.Builder resBuilder =
            ...
            GetHrisAttendanceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisAttendanceRequest, to.unified.unified_java_sdk.models.operations.async.GetHrisAttendanceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisAttendanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisAttendanceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisAttendanceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisAttendanceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisAttendanceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisAttendanceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisAttendanceResponse res = resBuilder.build();
