...
public class ListKmsSpaces2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListKmsSpaces2Request, ListKmsSpaces2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListKmsSpaces2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListKmsSpaces2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListKmsSpaces2Request request) {
        ...
        @Override
        public ListKmsSpaces2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListKmsSpaces2Response.Builder resBuilder =
            ...
            ListKmsSpaces2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withKmsSpaces(Utils.unmarshal(response, new TypeReference<List<KmsSpace>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListKmsSpaces2Request, to.unified.unified_java_sdk.models.operations.async.ListKmsSpaces2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListKmsSpaces2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListKmsSpaces2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListKmsSpaces2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListKmsSpaces2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListKmsSpaces2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListKmsSpaces2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListKmsSpaces2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<KmsSpace>>() {})
                            .thenApply(res::withKmsSpaces);
                } else {
