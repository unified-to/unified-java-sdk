...
public class GetSigningTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSigningTemplateRequest, GetSigningTemplateResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSigningTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSigningTemplateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSigningTemplateRequest request) {
        ...
        @Override
        public GetSigningTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSigningTemplateResponse.Builder resBuilder =
            ...
            GetSigningTemplateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSigningTemplateRequest, to.unified.unified_java_sdk.models.operations.async.GetSigningTemplateResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSigningTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSigningTemplateRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSigningTemplateRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetSigningTemplateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetSigningTemplateResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetSigningTemplateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetSigningTemplateResponse res = resBuilder.build();
