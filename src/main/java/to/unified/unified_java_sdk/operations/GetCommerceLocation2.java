...
public class GetCommerceLocation2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommerceLocation2Request, GetCommerceLocation2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCommerceLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceLocation2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommerceLocation2Request request) {
        ...
        @Override
        public GetCommerceLocation2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommerceLocation2Response.Builder resBuilder =
            ...
            GetCommerceLocation2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommerceLocation2Request, to.unified.unified_java_sdk.models.operations.async.GetCommerceLocation2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommerceLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommerceLocation2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommerceLocation2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCommerceLocation2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCommerceLocation2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCommerceLocation2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCommerceLocation2Response res = resBuilder.build();
