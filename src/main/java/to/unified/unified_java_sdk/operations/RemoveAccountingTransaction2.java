...
public class RemoveAccountingTransaction2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingTransaction2Request, RemoveAccountingTransaction2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingTransaction2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingTransaction2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingTransaction2Request request) {
        ...
        @Override
        public RemoveAccountingTransaction2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingTransaction2Response.Builder resBuilder =
            ...
            RemoveAccountingTransaction2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingTransaction2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingTransaction2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingTransaction2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingTransaction2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingTransaction2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingTransaction2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingTransaction2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingTransaction2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingTransaction2Response res = resBuilder.build();
