...
public class CreateAtsApplicationOperation implements RequestOperation<CreateAtsApplicationRequest, CreateAtsApplicationResponse> {
    ...
    public CreateAtsApplicationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAtsApplicationRequest request) throws Exception {
