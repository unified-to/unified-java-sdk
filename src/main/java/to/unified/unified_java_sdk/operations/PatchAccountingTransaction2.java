...
public class PatchAccountingTransaction2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingTransaction2Request, PatchAccountingTransaction2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingTransaction2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingTransaction2Request.class, new TypeReference<PatchAccountingTransaction2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingTransaction2Request request) {
        ...
        @Override
        public PatchAccountingTransaction2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingTransaction2Response.Builder resBuilder =
            ...
            PatchAccountingTransaction2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingTransaction2Request, to.unified.unified_java_sdk.models.operations.async.PatchAccountingTransaction2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingTransaction2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingTransaction2Request.class, new TypeReference<PatchAccountingTransaction2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingTransaction2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingTransaction2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingTransaction2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingTransaction2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingTransaction2Response res = resBuilder.build();
