...
public class UpdateRepoRepository {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateRepoRepositoryRequest request) throws Exception {
        ...
        @Override
        public UpdateRepoRepositoryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    RepoRepository out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withRepoRepository(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
