...
public class UpdateRepoRepository {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateRepoRepositoryRequest, UpdateRepoRepositoryResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateRepoRepositoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoRepositoryRequest.class, new TypeReference<UpdateRepoRepositoryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateRepoRepositoryRequest request) {
        ...
        @Override
        public UpdateRepoRepositoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateRepoRepositoryResponse.Builder resBuilder =
            ...
            UpdateRepoRepositoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateRepoRepositoryRequest, to.unified.unified_java_sdk.models.operations.async.UpdateRepoRepositoryResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateRepoRepositoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoRepositoryRequest.class, new TypeReference<UpdateRepoRepositoryRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateRepoRepositoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateRepoRepositoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateRepoRepositoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateRepoRepositoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateRepoRepositoryResponse res = resBuilder.build();
