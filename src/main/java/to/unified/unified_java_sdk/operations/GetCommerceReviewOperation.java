...
public class GetCommerceReviewOperation implements RequestOperation<GetCommerceReviewRequest, GetCommerceReviewResponse> {
    ...
    public GetCommerceReviewOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetCommerceReviewRequest request) throws Exception {
