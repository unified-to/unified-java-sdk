...
public class ListAtsCandidates2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAtsCandidates2Request, ListAtsCandidates2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAtsCandidates2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsCandidates2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsCandidates2Request request) {
        ...
        @Override
        public ListAtsCandidates2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsCandidates2Response.Builder resBuilder =
            ...
            ListAtsCandidates2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsCandidates(Utils.unmarshal(response, new TypeReference<List<AtsCandidate>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsCandidates2Request, to.unified.unified_java_sdk.models.operations.async.ListAtsCandidates2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsCandidates2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsCandidates2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsCandidates2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsCandidates2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsCandidates2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsCandidates2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsCandidates2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AtsCandidate>>() {})
                            .thenApply(res::withAtsCandidates);
                } else {
