...
public class UpdateCalendarCalendar {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCalendarCalendarRequest, UpdateCalendarCalendarResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCalendarCalendarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCalendarCalendarRequest.class, new TypeReference<UpdateCalendarCalendarRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCalendarCalendarRequest request) {
        ...
        @Override
        public UpdateCalendarCalendarResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCalendarCalendarResponse.Builder resBuilder =
            ...
            UpdateCalendarCalendarResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCalendarCalendarRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCalendarCalendarResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCalendarCalendarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCalendarCalendarRequest.class, new TypeReference<UpdateCalendarCalendarRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCalendarCalendarRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCalendarCalendarResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCalendarCalendarResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCalendarCalendarResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCalendarCalendarResponse res = resBuilder.build();
