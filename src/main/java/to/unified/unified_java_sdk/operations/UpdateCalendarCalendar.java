...
public class UpdateCalendarCalendar {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCalendarCalendarRequest request) throws Exception {
        ...
        @Override
        public UpdateCalendarCalendarResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CalendarCalendar out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCalendarCalendar(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
