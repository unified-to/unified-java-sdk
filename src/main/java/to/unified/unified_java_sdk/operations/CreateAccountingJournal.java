...
public class CreateAccountingJournal {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAccountingJournalRequest, CreateAccountingJournalResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingJournalRequest request) {
        ...
        @Override
        public CreateAccountingJournalResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAccountingJournalResponse.Builder resBuilder =
            ...
            CreateAccountingJournalResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAccountingJournalRequest, to.unified.unified_java_sdk.models.operations.async.CreateAccountingJournalResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAccountingJournalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingJournalRequest.class, new TypeReference<CreateAccountingJournalRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAccountingJournalRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAccountingJournalResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAccountingJournalResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAccountingJournalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAccountingJournalResponse res = resBuilder.build();
