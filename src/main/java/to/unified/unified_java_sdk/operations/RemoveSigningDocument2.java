...
public class RemoveSigningDocument2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveSigningDocument2Request, RemoveSigningDocument2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveSigningDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveSigningDocument2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveSigningDocument2Request request) {
        ...
        @Override
        public RemoveSigningDocument2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveSigningDocument2Response.Builder resBuilder =
            ...
            RemoveSigningDocument2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveSigningDocument2Request, to.unified.unified_java_sdk.models.operations.async.RemoveSigningDocument2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveSigningDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveSigningDocument2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveSigningDocument2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveSigningDocument2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveSigningDocument2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveSigningDocument2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveSigningDocument2Response res = resBuilder.build();
