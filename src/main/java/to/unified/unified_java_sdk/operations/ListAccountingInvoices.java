...
public class ListAccountingInvoices {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountingInvoicesRequest request) throws Exception {
        ...
        @Override
        public ListAccountingInvoicesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AccountingInvoice> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingInvoices(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
