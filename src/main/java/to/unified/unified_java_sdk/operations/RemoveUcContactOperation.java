...
public class RemoveUcContactOperation implements RequestOperation<RemoveUcContactRequest, RemoveUcContactResponse> {
    ...
    public RemoveUcContactOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveUcContactRequest request) throws Exception {
