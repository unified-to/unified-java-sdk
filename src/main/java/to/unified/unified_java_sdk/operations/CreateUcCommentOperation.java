...
public class CreateUcCommentOperation implements RequestOperation<CreateUcCommentRequest, CreateUcCommentResponse> {
    ...
    public CreateUcCommentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateUcCommentRequest request) throws Exception {
