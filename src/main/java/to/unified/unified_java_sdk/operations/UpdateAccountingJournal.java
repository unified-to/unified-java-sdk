...
public class UpdateAccountingJournal {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAccountingJournalRequest request) throws Exception {
        ...
        @Override
        public UpdateAccountingJournalResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingJournal out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingJournal(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
