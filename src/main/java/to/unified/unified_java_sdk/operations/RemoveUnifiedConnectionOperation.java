...
public class RemoveUnifiedConnectionOperation implements RequestOperation<RemoveUnifiedConnectionRequest, RemoveUnifiedConnectionResponse> {
    ...
    public RemoveUnifiedConnectionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveUnifiedConnectionRequest request) throws Exception {
