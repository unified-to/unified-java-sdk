...
public class RemoveAccountingTransaction {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingTransactionRequest, RemoveAccountingTransactionResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(RemoveAccountingTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingTransactionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingTransactionRequest request) throws Exception {
        ...
        @Override
        public RemoveAccountingTransactionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingTransactionResponse.Builder resBuilder =
            ...
            RemoveAccountingTransactionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingTransactionRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingTransactionResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingTransactionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingTransactionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingTransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingTransactionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingTransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingTransactionResponse res = resBuilder.build();
