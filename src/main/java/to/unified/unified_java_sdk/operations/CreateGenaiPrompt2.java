...
public class CreateGenaiPrompt2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateGenaiPrompt2Request, CreateGenaiPrompt2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateGenaiPrompt2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateGenaiPrompt2Request.class, new TypeReference<CreateGenaiPrompt2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateGenaiPrompt2Request request) {
        ...
        @Override
        public CreateGenaiPrompt2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateGenaiPrompt2Response.Builder resBuilder =
            ...
            CreateGenaiPrompt2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateGenaiPrompt2Request, to.unified.unified_java_sdk.models.operations.async.CreateGenaiPrompt2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateGenaiPrompt2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateGenaiPrompt2Request.class, new TypeReference<CreateGenaiPrompt2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateGenaiPrompt2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateGenaiPrompt2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateGenaiPrompt2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateGenaiPrompt2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateGenaiPrompt2Response res = resBuilder.build();
