...
public class PatchCalendarWebinar {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCalendarWebinarRequest, PatchCalendarWebinarResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCalendarWebinarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCalendarWebinarRequest.class, new TypeReference<PatchCalendarWebinarRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCalendarWebinarRequest request) {
        ...
        @Override
        public PatchCalendarWebinarResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCalendarWebinarResponse.Builder resBuilder =
            ...
            PatchCalendarWebinarResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCalendarWebinarRequest, to.unified.unified_java_sdk.models.operations.async.PatchCalendarWebinarResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCalendarWebinarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCalendarWebinarRequest.class, new TypeReference<PatchCalendarWebinarRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCalendarWebinarRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCalendarWebinarResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCalendarWebinarResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCalendarWebinarResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCalendarWebinarResponse res = resBuilder.build();
