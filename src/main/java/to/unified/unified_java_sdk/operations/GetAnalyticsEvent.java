...
public class GetAnalyticsEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAnalyticsEventRequest, GetAnalyticsEventResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAnalyticsEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAnalyticsEventRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAnalyticsEventRequest request) {
        ...
        @Override
        public GetAnalyticsEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAnalyticsEventResponse.Builder resBuilder =
            ...
            GetAnalyticsEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAnalyticsEventRequest, to.unified.unified_java_sdk.models.operations.async.GetAnalyticsEventResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAnalyticsEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAnalyticsEventRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAnalyticsEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAnalyticsEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAnalyticsEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAnalyticsEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAnalyticsEventResponse res = resBuilder.build();
