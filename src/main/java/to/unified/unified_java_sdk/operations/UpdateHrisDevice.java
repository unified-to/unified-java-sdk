...
public class UpdateHrisDevice {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisDeviceRequest, UpdateHrisDeviceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisDeviceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisDeviceRequest.class, new TypeReference<UpdateHrisDeviceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisDeviceRequest request) {
        ...
        @Override
        public UpdateHrisDeviceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisDeviceResponse.Builder resBuilder =
            ...
            UpdateHrisDeviceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisDeviceRequest, to.unified.unified_java_sdk.models.operations.async.UpdateHrisDeviceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisDeviceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisDeviceRequest.class, new TypeReference<UpdateHrisDeviceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisDeviceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisDeviceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisDeviceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisDeviceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisDeviceResponse res = resBuilder.build();
