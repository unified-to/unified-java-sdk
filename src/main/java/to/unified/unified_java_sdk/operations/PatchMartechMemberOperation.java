...
public class PatchMartechMemberOperation implements RequestOperation<PatchMartechMemberRequest, PatchMartechMemberResponse> {
    ...
    public PatchMartechMemberOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchMartechMemberRequest request) throws Exception {
