...
public class PatchHrisAttendance {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisAttendanceRequest, PatchHrisAttendanceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisAttendanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisAttendanceRequest.class, new TypeReference<PatchHrisAttendanceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisAttendanceRequest request) {
        ...
        @Override
        public PatchHrisAttendanceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisAttendanceResponse.Builder resBuilder =
            ...
            PatchHrisAttendanceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisAttendanceRequest, to.unified.unified_java_sdk.models.operations.async.PatchHrisAttendanceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisAttendanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisAttendanceRequest.class, new TypeReference<PatchHrisAttendanceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisAttendanceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisAttendanceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisAttendanceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisAttendanceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisAttendanceResponse res = resBuilder.build();
