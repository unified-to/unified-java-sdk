...
public class RemoveAdsOrganization2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAdsOrganization2Request, RemoveAdsOrganization2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAdsOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsOrganization2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAdsOrganization2Request request) {
        ...
        @Override
        public RemoveAdsOrganization2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAdsOrganization2Response.Builder resBuilder =
            ...
            RemoveAdsOrganization2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAdsOrganization2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAdsOrganization2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAdsOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsOrganization2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAdsOrganization2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAdsOrganization2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAdsOrganization2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAdsOrganization2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAdsOrganization2Response res = resBuilder.build();
