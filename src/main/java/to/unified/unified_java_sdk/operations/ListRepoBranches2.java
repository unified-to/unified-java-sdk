...
public class ListRepoBranches2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRepoBranches2Request, ListRepoBranches2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListRepoBranches2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoBranches2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRepoBranches2Request request) {
        ...
        @Override
        public ListRepoBranches2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListRepoBranches2Response.Builder resBuilder =
            ...
            ListRepoBranches2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRepoBranches(Utils.unmarshal(response, new TypeReference<List<RepoBranch>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListRepoBranches2Request, to.unified.unified_java_sdk.models.operations.async.ListRepoBranches2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListRepoBranches2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoBranches2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRepoBranches2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListRepoBranches2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListRepoBranches2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListRepoBranches2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListRepoBranches2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<RepoBranch>>() {})
                            .thenApply(res::withRepoBranches);
                } else {
