...
public class ListTicketingNotes {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTicketingNotesRequest, ListTicketingNotesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListTicketingNotesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTicketingNotesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTicketingNotesRequest request) {
        ...
        @Override
        public ListTicketingNotesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTicketingNotesResponse.Builder resBuilder =
            ...
            ListTicketingNotesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTicketingNotesRequest, to.unified.unified_java_sdk.models.operations.async.ListTicketingNotesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListTicketingNotesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTicketingNotesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTicketingNotesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListTicketingNotesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListTicketingNotesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListTicketingNotesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListTicketingNotesResponse res = resBuilder.build();
