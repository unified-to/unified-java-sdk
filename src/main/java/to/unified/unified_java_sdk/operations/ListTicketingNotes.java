...
public class ListTicketingNotes {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTicketingNotesRequest request) throws Exception {
        ...
        @Override
        public ListTicketingNotesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<TicketingNote> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTicketingNotes(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
