...
public class UpdateHrisTimeshiftOperation implements RequestOperation<UpdateHrisTimeshiftRequest, UpdateHrisTimeshiftResponse> {
    ...
    public UpdateHrisTimeshiftOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateHrisTimeshiftRequest request) throws Exception {
