...
public class ListDatastoreTables2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDatastoreTables2Request, ListDatastoreTables2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListDatastoreTables2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListDatastoreTables2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDatastoreTables2Request request) {
        ...
        @Override
        public ListDatastoreTables2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListDatastoreTables2Response.Builder resBuilder =
            ...
            ListDatastoreTables2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDatastoreTables(Utils.unmarshal(response, new TypeReference<List<DatastoreTable>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListDatastoreTables2Request, to.unified.unified_java_sdk.models.operations.async.ListDatastoreTables2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListDatastoreTables2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListDatastoreTables2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDatastoreTables2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListDatastoreTables2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListDatastoreTables2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListDatastoreTables2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListDatastoreTables2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<DatastoreTable>>() {})
                            .thenApply(res::withDatastoreTables);
                } else {
