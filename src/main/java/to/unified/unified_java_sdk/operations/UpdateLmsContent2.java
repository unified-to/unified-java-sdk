...
public class UpdateLmsContent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLmsContent2Request, UpdateLmsContent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateLmsContent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsContent2Request.class, new TypeReference<UpdateLmsContent2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLmsContent2Request request) {
        ...
        @Override
        public UpdateLmsContent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateLmsContent2Response.Builder resBuilder =
            ...
            UpdateLmsContent2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLmsContent(Utils.unmarshal(response, new TypeReference<LmsContent>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLmsContent2Request, to.unified.unified_java_sdk.models.operations.async.UpdateLmsContent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLmsContent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsContent2Request.class, new TypeReference<UpdateLmsContent2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLmsContent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateLmsContent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateLmsContent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateLmsContent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateLmsContent2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<LmsContent>() {})
                            .thenApply(res::withLmsContent);
                } else {
