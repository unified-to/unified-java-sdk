...
public class CreateAtsScorecard {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsScorecardRequest request) throws Exception {
        ...
        @Override
        public CreateAtsScorecardResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AtsScorecard out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAtsScorecard(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
