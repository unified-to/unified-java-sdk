...
public class CreateAtsScorecard {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAtsScorecardRequest, CreateAtsScorecardResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAtsScorecardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsScorecardRequest.class, new TypeReference<CreateAtsScorecardRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAtsScorecardRequest request) {
        ...
        @Override
        public CreateAtsScorecardResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAtsScorecardResponse.Builder resBuilder =
            ...
            CreateAtsScorecardResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAtsScorecardRequest, to.unified.unified_java_sdk.models.operations.async.CreateAtsScorecardResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAtsScorecardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAtsScorecardRequest.class, new TypeReference<CreateAtsScorecardRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAtsScorecardRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAtsScorecardResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAtsScorecardResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAtsScorecardResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAtsScorecardResponse res = resBuilder.build();
