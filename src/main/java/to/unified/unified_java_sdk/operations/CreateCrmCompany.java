...
public class CreateCrmCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCrmCompanyRequest, CreateCrmCompanyResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCrmCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmCompanyRequest.class, new TypeReference<CreateCrmCompanyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCrmCompanyRequest request) {
        ...
        @Override
        public CreateCrmCompanyResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCrmCompanyRequest, to.unified.unified_java_sdk.models.operations.async.CreateCrmCompanyResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCrmCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmCompanyRequest.class, new TypeReference<CreateCrmCompanyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCrmCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCrmCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCrmCompanyResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCrmCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCrmCompanyResponse res = resBuilder.build();
