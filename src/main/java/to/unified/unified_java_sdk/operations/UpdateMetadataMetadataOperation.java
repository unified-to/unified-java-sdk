...
public class UpdateMetadataMetadataOperation implements RequestOperation<UpdateMetadataMetadataRequest, UpdateMetadataMetadataResponse> {
    ...
    public UpdateMetadataMetadataOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateMetadataMetadataRequest request) throws Exception {
