...
public class PatchAccountingTaxrate2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingTaxrate2Request, PatchAccountingTaxrate2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingTaxrate2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingTaxrate2Request.class, new TypeReference<PatchAccountingTaxrate2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingTaxrate2Request request) {
        ...
        @Override
        public PatchAccountingTaxrate2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingTaxrate2Response.Builder resBuilder =
            ...
            PatchAccountingTaxrate2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingTaxrate2Request, to.unified.unified_java_sdk.models.operations.async.PatchAccountingTaxrate2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingTaxrate2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingTaxrate2Request.class, new TypeReference<PatchAccountingTaxrate2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingTaxrate2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingTaxrate2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingTaxrate2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingTaxrate2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingTaxrate2Response res = resBuilder.build();
