...
public class PatchMartechList {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(PatchMartechListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMartechListRequest.class, new TypeReference<PatchMartechListRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchMartechListRequest request) {
        ...
        @Override
        public PatchMartechListResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchMartechListRequest, to.unified.unified_java_sdk.models.operations.async.PatchMartechListResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchMartechListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMartechListRequest.class, new TypeReference<PatchMartechListRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchMartechListRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchMartechListResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchMartechListResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchMartechListResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchMartechListResponse res = resBuilder.build();
