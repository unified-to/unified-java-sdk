...
public class GetAccountingSalesorderOperation implements RequestOperation<GetAccountingSalesorderRequest, GetAccountingSalesorderResponse> {
    ...
    public GetAccountingSalesorderOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountingSalesorderRequest request) throws Exception {
        String url = Utils.generateURL(
                GetAccountingSalesorderRequest.class,
                this.baseUrl,
