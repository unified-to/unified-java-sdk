...
public class ListUnifiedConnections {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListUnifiedConnectionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUnifiedConnectionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUnifiedConnectionsRequest request) {
        ...
        @Override
        public ListUnifiedConnectionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUnifiedConnectionsResponse.Builder resBuilder =
            ...
            ListUnifiedConnectionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withConnections(Utils.unmarshal(response, new TypeReference<List<Connection>>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUnifiedConnectionsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListUnifiedConnectionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListUnifiedConnectionsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListUnifiedConnectionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListUnifiedConnectionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<Connection>>() {})
                            .thenApply(res::withConnections);
                } else {
