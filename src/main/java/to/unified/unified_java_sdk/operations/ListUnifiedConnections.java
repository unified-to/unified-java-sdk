...
public class ListUnifiedConnections {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUnifiedConnectionsRequest request) throws Exception {
        ...
        @Override
        public ListUnifiedConnectionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Connection> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withConnections(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
