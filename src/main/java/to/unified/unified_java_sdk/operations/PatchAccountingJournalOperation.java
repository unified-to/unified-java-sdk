...
public class PatchAccountingJournalOperation implements RequestOperation<PatchAccountingJournalRequest, PatchAccountingJournalResponse> {
    ...
    public PatchAccountingJournalOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchAccountingJournalRequest request) throws Exception {
