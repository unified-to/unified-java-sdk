...
public class CreateAccountingPaymentterm {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAccountingPaymenttermRequest, CreateAccountingPaymenttermResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAccountingPaymenttermRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingPaymenttermRequest.class, new TypeReference<CreateAccountingPaymenttermRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingPaymenttermRequest request) {
        ...
        @Override
        public CreateAccountingPaymenttermResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAccountingPaymenttermResponse.Builder resBuilder =
                    CreateAccountingPaymenttermResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateAccountingPaymenttermResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountingPaymentterm(Utils.unmarshal(response, new TypeReference<AccountingPaymentterm>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAccountingPaymenttermRequest, to.unified.unified_java_sdk.models.operations.async.CreateAccountingPaymenttermResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAccountingPaymenttermRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingPaymenttermRequest.class, new TypeReference<CreateAccountingPaymenttermRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAccountingPaymenttermRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAccountingPaymenttermResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAccountingPaymenttermResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAccountingPaymenttermResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAccountingPaymenttermResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountingPaymentterm>() {})
                            .thenApply(res::withAccountingPaymentterm);
                } else {
