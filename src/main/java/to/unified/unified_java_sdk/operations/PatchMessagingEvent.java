...
public class PatchMessagingEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchMessagingEventRequest, PatchMessagingEventResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchMessagingEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMessagingEventRequest.class, new TypeReference<PatchMessagingEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchMessagingEventRequest request) {
        ...
        @Override
        public PatchMessagingEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchMessagingEventResponse.Builder resBuilder =
            ...
            PatchMessagingEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchMessagingEventRequest, to.unified.unified_java_sdk.models.operations.async.PatchMessagingEventResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchMessagingEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMessagingEventRequest.class, new TypeReference<PatchMessagingEventRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchMessagingEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchMessagingEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchMessagingEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchMessagingEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchMessagingEventResponse res = resBuilder.build();
