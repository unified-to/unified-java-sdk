...
public class CreateUcContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateUcContactRequest, CreateUcContactResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateUcContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateUcContactRequest.class, new TypeReference<CreateUcContactRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateUcContactRequest request) {
        ...
        @Override
        public CreateUcContactResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateUcContactResponse.Builder resBuilder =
            ...
            CreateUcContactResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateUcContactRequest, to.unified.unified_java_sdk.models.operations.async.CreateUcContactResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateUcContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateUcContactRequest.class, new TypeReference<CreateUcContactRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateUcContactRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateUcContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateUcContactResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateUcContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateUcContactResponse res = resBuilder.build();
