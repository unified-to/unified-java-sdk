...
public class CreateAccountingPurchaseorderOperation implements RequestOperation<CreateAccountingPurchaseorderRequest, CreateAccountingPurchaseorderResponse> {
    ...
    public CreateAccountingPurchaseorderOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAccountingPurchaseorderRequest request) throws Exception {
