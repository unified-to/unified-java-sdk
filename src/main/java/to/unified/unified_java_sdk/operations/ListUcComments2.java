...
public class ListUcComments2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUcComments2Request, ListUcComments2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListUcComments2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListUcComments2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUcComments2Request request) {
        ...
        @Override
        public ListUcComments2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUcComments2Response.Builder resBuilder =
            ...
            ListUcComments2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUcComments(Utils.unmarshal(response, new TypeReference<List<UcComment>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUcComments2Request, to.unified.unified_java_sdk.models.operations.async.ListUcComments2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListUcComments2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListUcComments2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUcComments2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListUcComments2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListUcComments2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListUcComments2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListUcComments2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<UcComment>>() {})
                            .thenApply(res::withUcComments);
                } else {
