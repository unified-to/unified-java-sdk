...
public class CreateTicketingCategory {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTicketingCategoryRequest, CreateTicketingCategoryResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(CreateTicketingCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTicketingCategoryRequest.class, new TypeReference<CreateTicketingCategoryRequest>() {});
        ...
        public CreateTicketingCategoryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            CreateTicketingCategoryResponse.Builder resBuilder =
            ...
            CreateTicketingCategoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTicketingCategoryRequest, to.unified.unified_java_sdk.models.operations.async.CreateTicketingCategoryResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTicketingCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTicketingCategoryRequest.class, new TypeReference<CreateTicketingCategoryRequest>() {});
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateTicketingCategoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateTicketingCategoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateTicketingCategoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateTicketingCategoryResponse res = resBuilder.build();
