...
public class RemoveHrisTimeshiftOperation implements RequestOperation<RemoveHrisTimeshiftRequest, RemoveHrisTimeshiftResponse> {
    ...
    public RemoveHrisTimeshiftOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveHrisTimeshiftRequest request) throws Exception {
