...
public class UpdateSigningDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateSigningDocumentRequest, UpdateSigningDocumentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateSigningDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSigningDocumentRequest.class, new TypeReference<UpdateSigningDocumentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateSigningDocumentRequest request) {
        ...
        @Override
        public UpdateSigningDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateSigningDocumentResponse.Builder resBuilder =
            ...
            UpdateSigningDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateSigningDocumentRequest, to.unified.unified_java_sdk.models.operations.async.UpdateSigningDocumentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateSigningDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSigningDocumentRequest.class, new TypeReference<UpdateSigningDocumentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateSigningDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateSigningDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateSigningDocumentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateSigningDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateSigningDocumentResponse res = resBuilder.build();
