...
public class ListCommerceCollections2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceCollections2Request, ListCommerceCollections2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommerceCollections2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceCollections2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceCollections2Request request) {
        ...
        @Override
        public ListCommerceCollections2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceCollections2Response.Builder resBuilder =
            ...
            ListCommerceCollections2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceCollections(Utils.unmarshal(response, new TypeReference<List<CommerceCollection>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceCollections2Request, to.unified.unified_java_sdk.models.operations.async.ListCommerceCollections2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceCollections2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceCollections2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceCollections2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceCollections2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceCollections2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceCollections2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceCollections2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CommerceCollection>>() {})
                            .thenApply(res::withCommerceCollections);
                } else {
