...
public class RemoveHrisGroup2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisGroup2Request, RemoveHrisGroup2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisGroup2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisGroup2Request request) {
        ...
        @Override
        public RemoveHrisGroup2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisGroup2Response.Builder resBuilder =
            ...
            RemoveHrisGroup2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisGroup2Request, to.unified.unified_java_sdk.models.operations.async.RemoveHrisGroup2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisGroup2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisGroup2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisGroup2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisGroup2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisGroup2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisGroup2Response res = resBuilder.build();
