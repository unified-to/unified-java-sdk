...
public class CreateCrmLead {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCrmLeadRequest, CreateCrmLeadResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCrmLeadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmLeadRequest.class, new TypeReference<CreateCrmLeadRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCrmLeadRequest request) {
        ...
        @Override
        public CreateCrmLeadResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCrmLeadResponse.Builder resBuilder =
            ...
            CreateCrmLeadResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCrmLeadRequest, to.unified.unified_java_sdk.models.operations.async.CreateCrmLeadResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCrmLeadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmLeadRequest.class, new TypeReference<CreateCrmLeadRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCrmLeadRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCrmLeadResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCrmLeadResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCrmLeadResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCrmLeadResponse res = resBuilder.build();
