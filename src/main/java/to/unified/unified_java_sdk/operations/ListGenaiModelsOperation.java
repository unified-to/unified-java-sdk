...
public class ListGenaiModelsOperation implements RequestOperation<ListGenaiModelsRequest, ListGenaiModelsResponse> {
    ...
    public ListGenaiModelsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListGenaiModelsRequest request) throws Exception {
