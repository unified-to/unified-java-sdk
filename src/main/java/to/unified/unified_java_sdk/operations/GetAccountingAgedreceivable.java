...
public class GetAccountingAgedreceivable {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingAgedreceivableRequest, GetAccountingAgedreceivableResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingAgedreceivableRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingAgedreceivableRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingAgedreceivableRequest request) {
        ...
        @Override
        public GetAccountingAgedreceivableResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingAgedreceivableResponse.Builder resBuilder =
                    GetAccountingAgedreceivableResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetAccountingAgedreceivableResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountingAgedreceivable(Utils.unmarshal(response, new TypeReference<AccountingAgedreceivable>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingAgedreceivableRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingAgedreceivableResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingAgedreceivableRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingAgedreceivableRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingAgedreceivableRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingAgedreceivableResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingAgedreceivableResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingAgedreceivableResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingAgedreceivableResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountingAgedreceivable>() {})
                            .thenApply(res::withAccountingAgedreceivable);
                } else {
