...
public class CreateShippingTracking {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateShippingTrackingRequest, CreateShippingTrackingResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateShippingTrackingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateShippingTrackingRequest.class, new TypeReference<CreateShippingTrackingRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateShippingTrackingRequest request) {
        ...
        @Override
        public CreateShippingTrackingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateShippingTrackingResponse.Builder resBuilder =
            ...
            CreateShippingTrackingResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withShippingTracking(Utils.unmarshal(response, new TypeReference<ShippingTracking>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateShippingTrackingRequest, to.unified.unified_java_sdk.models.operations.async.CreateShippingTrackingResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateShippingTrackingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateShippingTrackingRequest.class, new TypeReference<CreateShippingTrackingRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateShippingTrackingRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateShippingTrackingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateShippingTrackingResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateShippingTrackingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateShippingTrackingResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ShippingTracking>() {})
                            .thenApply(res::withShippingTracking);
                } else {
