...
public class CreateUcComment {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateUcCommentRequest request) throws Exception {
        ...
        @Override
        public CreateUcCommentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UcComment out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUcComment(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
