...
public class PatchHrisTimeshiftOperation implements RequestOperation<PatchHrisTimeshiftRequest, PatchHrisTimeshiftResponse> {
    ...
    public PatchHrisTimeshiftOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchHrisTimeshiftRequest request) throws Exception {
