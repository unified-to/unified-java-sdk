...
public class ListCommerceItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceItemsRequest, ListCommerceItemsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommerceItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceItemsRequest request) {
        ...
        @Override
        public ListCommerceItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceItemsResponse.Builder resBuilder =
            ...
            ListCommerceItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceItemsRequest, to.unified.unified_java_sdk.models.operations.async.ListCommerceItemsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceItemsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceItemsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceItemsResponse res = resBuilder.build();
