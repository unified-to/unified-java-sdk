...
public class ListMetadataMetadatasOperation implements RequestOperation<ListMetadataMetadatasRequest, ListMetadataMetadatasResponse> {
    ...
    public ListMetadataMetadatasOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListMetadataMetadatasRequest request) throws Exception {
