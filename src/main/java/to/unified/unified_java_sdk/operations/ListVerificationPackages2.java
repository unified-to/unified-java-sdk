...
public class ListVerificationPackages2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListVerificationPackages2Request, ListVerificationPackages2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListVerificationPackages2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListVerificationPackages2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListVerificationPackages2Request request) {
        ...
        @Override
        public ListVerificationPackages2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListVerificationPackages2Response.Builder resBuilder =
            ...
            ListVerificationPackages2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withVerificationPackages(Utils.unmarshal(response, new TypeReference<List<VerificationPackage>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListVerificationPackages2Request, to.unified.unified_java_sdk.models.operations.async.ListVerificationPackages2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListVerificationPackages2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListVerificationPackages2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListVerificationPackages2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListVerificationPackages2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListVerificationPackages2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListVerificationPackages2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListVerificationPackages2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<VerificationPackage>>() {})
                            .thenApply(res::withVerificationPackages);
                } else {
