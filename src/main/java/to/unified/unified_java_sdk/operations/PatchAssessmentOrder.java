...
public class PatchAssessmentOrder {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAssessmentOrderRequest, PatchAssessmentOrderResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAssessmentOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAssessmentOrderRequest.class, new TypeReference<PatchAssessmentOrderRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAssessmentOrderRequest request) {
        ...
        @Override
        public PatchAssessmentOrderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAssessmentOrderResponse.Builder resBuilder =
            ...
            PatchAssessmentOrderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAssessmentOrderRequest, to.unified.unified_java_sdk.models.operations.async.PatchAssessmentOrderResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAssessmentOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAssessmentOrderRequest.class, new TypeReference<PatchAssessmentOrderRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAssessmentOrderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAssessmentOrderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAssessmentOrderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAssessmentOrderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAssessmentOrderResponse res = resBuilder.build();
