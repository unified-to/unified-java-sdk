...
public class UpdateRepoRepositoryOperation implements RequestOperation<UpdateRepoRepositoryRequest, UpdateRepoRepositoryResponse> {
    ...
    public UpdateRepoRepositoryOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateRepoRepositoryRequest request) throws Exception {
