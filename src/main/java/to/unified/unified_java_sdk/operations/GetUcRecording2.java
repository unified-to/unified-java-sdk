...
public class GetUcRecording2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUcRecording2Request, GetUcRecording2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUcRecording2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetUcRecording2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUcRecording2Request request) {
        ...
        @Override
        public GetUcRecording2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUcRecording2Response.Builder resBuilder =
            ...
            GetUcRecording2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUcRecording2Request, to.unified.unified_java_sdk.models.operations.async.GetUcRecording2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUcRecording2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetUcRecording2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUcRecording2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetUcRecording2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetUcRecording2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetUcRecording2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetUcRecording2Response res = resBuilder.build();
