...
public class RemovePaymentSubscription2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemovePaymentSubscription2Request, RemovePaymentSubscription2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemovePaymentSubscription2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePaymentSubscription2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemovePaymentSubscription2Request request) {
        ...
        @Override
        public RemovePaymentSubscription2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemovePaymentSubscription2Response.Builder resBuilder =
            ...
            RemovePaymentSubscription2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemovePaymentSubscription2Request, to.unified.unified_java_sdk.models.operations.async.RemovePaymentSubscription2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemovePaymentSubscription2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePaymentSubscription2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemovePaymentSubscription2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemovePaymentSubscription2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemovePaymentSubscription2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemovePaymentSubscription2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemovePaymentSubscription2Response res = resBuilder.build();
