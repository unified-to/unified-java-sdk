...
public class ListUcCalls {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUcCallsRequest, ListUcCallsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListUcCallsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUcCallsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUcCallsRequest request) {
        ...
        @Override
        public ListUcCallsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUcCallsResponse.Builder resBuilder =
                    ListUcCallsResponse
                            .builder()
            ...
            ListUcCallsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUcCallsRequest, to.unified.unified_java_sdk.models.operations.async.ListUcCallsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListUcCallsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUcCallsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUcCallsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListUcCallsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListUcCallsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListUcCallsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListUcCallsResponse res = resBuilder.build();
