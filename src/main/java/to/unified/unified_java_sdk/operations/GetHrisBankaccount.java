...
public class GetHrisBankaccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisBankaccountRequest, GetHrisBankaccountResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisBankaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisBankaccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisBankaccountRequest request) {
        ...
        @Override
        public GetHrisBankaccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisBankaccountResponse.Builder resBuilder =
            ...
            GetHrisBankaccountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisBankaccountRequest, to.unified.unified_java_sdk.models.operations.async.GetHrisBankaccountResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisBankaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisBankaccountRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisBankaccountRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisBankaccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisBankaccountResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisBankaccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisBankaccountResponse res = resBuilder.build();
