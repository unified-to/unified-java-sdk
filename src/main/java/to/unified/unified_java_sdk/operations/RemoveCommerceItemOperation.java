...
public class RemoveCommerceItemOperation implements RequestOperation<RemoveCommerceItemRequest, RemoveCommerceItemResponse> {
    ...
    public RemoveCommerceItemOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveCommerceItemRequest request) throws Exception {
