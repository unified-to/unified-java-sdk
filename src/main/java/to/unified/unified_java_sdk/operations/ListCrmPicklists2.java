...
public class ListCrmPicklists2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCrmPicklists2Request, ListCrmPicklists2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCrmPicklists2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmPicklists2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmPicklists2Request request) {
        ...
        @Override
        public ListCrmPicklists2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCrmPicklists2Response.Builder resBuilder =
            ...
            ListCrmPicklists2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCrmPicklists2Request, to.unified.unified_java_sdk.models.operations.async.ListCrmPicklists2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCrmPicklists2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmPicklists2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCrmPicklists2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCrmPicklists2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCrmPicklists2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCrmPicklists2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCrmPicklists2Response res = resBuilder.build();
