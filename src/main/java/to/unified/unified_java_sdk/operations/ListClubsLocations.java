...
public class ListClubsLocations {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListClubsLocationsRequest, ListClubsLocationsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListClubsLocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsLocationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListClubsLocationsRequest request) {
        ...
        @Override
        public ListClubsLocationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListClubsLocationsResponse.Builder resBuilder =
            ...
            ListClubsLocationsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListClubsLocationsRequest, to.unified.unified_java_sdk.models.operations.async.ListClubsLocationsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListClubsLocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsLocationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListClubsLocationsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListClubsLocationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListClubsLocationsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListClubsLocationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListClubsLocationsResponse res = resBuilder.build();
