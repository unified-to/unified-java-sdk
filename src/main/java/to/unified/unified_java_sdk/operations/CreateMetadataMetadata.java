...
public class CreateMetadataMetadata {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateMetadataMetadataRequest, CreateMetadataMetadataResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMetadataMetadataRequest request) {
        ...
        @Override
        public CreateMetadataMetadataResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateMetadataMetadataRequest, to.unified.unified_java_sdk.models.operations.async.CreateMetadataMetadataResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateMetadataMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMetadataMetadataRequest.class, new TypeReference<CreateMetadataMetadataRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateMetadataMetadataRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateMetadataMetadataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateMetadataMetadataResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateMetadataMetadataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateMetadataMetadataResponse res = resBuilder.build();
