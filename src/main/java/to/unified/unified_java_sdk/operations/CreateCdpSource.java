...
public class CreateCdpSource {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCdpSourceRequest, CreateCdpSourceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCdpSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCdpSourceRequest.class, new TypeReference<CreateCdpSourceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCdpSourceRequest request) {
        ...
        @Override
        public CreateCdpSourceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCdpSourceResponse.Builder resBuilder =
            ...
            CreateCdpSourceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCdpSourceRequest, to.unified.unified_java_sdk.models.operations.async.CreateCdpSourceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCdpSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCdpSourceRequest.class, new TypeReference<CreateCdpSourceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCdpSourceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCdpSourceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCdpSourceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCdpSourceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCdpSourceResponse res = resBuilder.build();
