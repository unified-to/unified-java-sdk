...
public class UpdateCommerceCollection {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommerceCollectionRequest, UpdateCommerceCollectionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCommerceCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceCollectionRequest.class, new TypeReference<UpdateCommerceCollectionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceCollectionRequest request) {
        ...
        @Override
        public UpdateCommerceCollectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommerceCollectionResponse.Builder resBuilder =
            ...
            UpdateCommerceCollectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommerceCollectionRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCommerceCollectionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommerceCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceCollectionRequest.class, new TypeReference<UpdateCommerceCollectionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommerceCollectionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCommerceCollectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceCollectionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCommerceCollectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceCollectionResponse res = resBuilder.build();
