...
public class UpdateCommerceCollection {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceCollectionRequest request) throws Exception {
        ...
        @Override
        public UpdateCommerceCollectionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CommerceCollection out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCommerceCollection(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
