...
public class RemoveKmsSpaceOperation implements RequestOperation<RemoveKmsSpaceRequest, RemoveKmsSpaceResponse> {
    ...
    public RemoveKmsSpaceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveKmsSpaceRequest request) throws Exception {
