...
public class UpdatePassthrough2Json {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatePassthrough2JsonRequest, UpdatePassthrough2JsonResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdatePassthrough2JsonRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePassthrough2JsonRequest.class, new TypeReference<UpdatePassthrough2JsonRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePassthrough2JsonRequest request) {
        ...
        @Override
        public UpdatePassthrough2JsonResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatePassthrough2JsonResponse.Builder resBuilder =
            ...
            UpdatePassthrough2JsonResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatePassthrough2JsonRequest, to.unified.unified_java_sdk.models.operations.async.UpdatePassthrough2JsonResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePassthrough2JsonRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePassthrough2JsonRequest.class, new TypeReference<UpdatePassthrough2JsonRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatePassthrough2JsonRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdatePassthrough2JsonResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdatePassthrough2JsonResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdatePassthrough2JsonResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            to.unified.unified_java_sdk.models.operations.async.UpdatePassthrough2JsonResponse res = resBuilder.build();
