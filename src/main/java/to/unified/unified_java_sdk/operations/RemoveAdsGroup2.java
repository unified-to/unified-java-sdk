...
public class RemoveAdsGroup2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAdsGroup2Request, RemoveAdsGroup2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAdsGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsGroup2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAdsGroup2Request request) {
        ...
        @Override
        public RemoveAdsGroup2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAdsGroup2Response.Builder resBuilder =
            ...
            RemoveAdsGroup2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAdsGroup2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAdsGroup2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAdsGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsGroup2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAdsGroup2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAdsGroup2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAdsGroup2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAdsGroup2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAdsGroup2Response res = resBuilder.build();
