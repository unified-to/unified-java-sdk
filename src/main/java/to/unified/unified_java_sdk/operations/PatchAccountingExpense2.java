...
public class PatchAccountingExpense2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAccountingExpense2Request, PatchAccountingExpense2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAccountingExpense2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingExpense2Request.class, new TypeReference<PatchAccountingExpense2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAccountingExpense2Request request) {
        ...
        @Override
        public PatchAccountingExpense2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAccountingExpense2Response.Builder resBuilder =
            ...
            PatchAccountingExpense2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAccountingExpense2Request, to.unified.unified_java_sdk.models.operations.async.PatchAccountingExpense2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAccountingExpense2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAccountingExpense2Request.class, new TypeReference<PatchAccountingExpense2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAccountingExpense2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAccountingExpense2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAccountingExpense2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAccountingExpense2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAccountingExpense2Response res = resBuilder.build();
