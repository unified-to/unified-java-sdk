...
public class CreateHrisLocation2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisLocation2Request, CreateHrisLocation2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisLocation2Request.class, new TypeReference<CreateHrisLocation2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisLocation2Request request) {
        ...
        @Override
        public CreateHrisLocation2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisLocation2Response.Builder resBuilder =
            ...
            CreateHrisLocation2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisLocation2Request, to.unified.unified_java_sdk.models.operations.async.CreateHrisLocation2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisLocation2Request.class, new TypeReference<CreateHrisLocation2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisLocation2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisLocation2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisLocation2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisLocation2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisLocation2Response res = resBuilder.build();
