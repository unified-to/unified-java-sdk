...
public class ListAccountingTrialbalances {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountingTrialbalancesRequest request) throws Exception {
        ...
        @Override
        public ListAccountingTrialbalancesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AccountingTrialbalance> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingTrialbalances(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
