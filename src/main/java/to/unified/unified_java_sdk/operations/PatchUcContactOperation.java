...
public class PatchUcContactOperation implements RequestOperation<PatchUcContactRequest, PatchUcContactResponse> {
    ...
    public PatchUcContactOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchUcContactRequest request) throws Exception {
