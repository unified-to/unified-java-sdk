...
public class ListAnalyticsVisitors2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAnalyticsVisitors2Request, ListAnalyticsVisitors2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAnalyticsVisitors2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAnalyticsVisitors2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAnalyticsVisitors2Request request) {
        ...
        @Override
        public ListAnalyticsVisitors2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAnalyticsVisitors2Response.Builder resBuilder =
            ...
            ListAnalyticsVisitors2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAnalyticsVisitors(Utils.unmarshal(response, new TypeReference<List<AnalyticsVisitor>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAnalyticsVisitors2Request, to.unified.unified_java_sdk.models.operations.async.ListAnalyticsVisitors2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAnalyticsVisitors2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAnalyticsVisitors2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAnalyticsVisitors2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAnalyticsVisitors2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAnalyticsVisitors2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAnalyticsVisitors2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAnalyticsVisitors2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AnalyticsVisitor>>() {})
                            .thenApply(res::withAnalyticsVisitors);
                } else {
