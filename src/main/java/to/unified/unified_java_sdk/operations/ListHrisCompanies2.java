...
public class ListHrisCompanies2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisCompanies2Request, ListHrisCompanies2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisCompanies2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisCompanies2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisCompanies2Request request) {
        ...
        @Override
        public ListHrisCompanies2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisCompanies2Response.Builder resBuilder =
            ...
            ListHrisCompanies2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisCompanies(Utils.unmarshal(response, new TypeReference<List<HrisCompany>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisCompanies2Request, to.unified.unified_java_sdk.models.operations.async.ListHrisCompanies2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisCompanies2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisCompanies2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisCompanies2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisCompanies2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisCompanies2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisCompanies2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisCompanies2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<HrisCompany>>() {})
                            .thenApply(res::withHrisCompanies);
                } else {
