...
public class GetDatastoreDatabase2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDatastoreDatabase2Request, GetDatastoreDatabase2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDatastoreDatabase2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetDatastoreDatabase2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDatastoreDatabase2Request request) {
        ...
        @Override
        public GetDatastoreDatabase2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDatastoreDatabase2Response.Builder resBuilder =
            ...
            GetDatastoreDatabase2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDatastoreDatabase2Request, to.unified.unified_java_sdk.models.operations.async.GetDatastoreDatabase2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetDatastoreDatabase2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetDatastoreDatabase2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDatastoreDatabase2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetDatastoreDatabase2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetDatastoreDatabase2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetDatastoreDatabase2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetDatastoreDatabase2Response res = resBuilder.build();
