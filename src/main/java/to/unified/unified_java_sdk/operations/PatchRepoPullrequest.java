...
public class PatchRepoPullrequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchRepoPullrequestRequest, PatchRepoPullrequestResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchRepoPullrequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoPullrequestRequest.class, new TypeReference<PatchRepoPullrequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchRepoPullrequestRequest request) {
        ...
        @Override
        public PatchRepoPullrequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchRepoPullrequestResponse.Builder resBuilder =
            ...
            PatchRepoPullrequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchRepoPullrequestRequest, to.unified.unified_java_sdk.models.operations.async.PatchRepoPullrequestResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchRepoPullrequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoPullrequestRequest.class, new TypeReference<PatchRepoPullrequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchRepoPullrequestRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchRepoPullrequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchRepoPullrequestResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchRepoPullrequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchRepoPullrequestResponse res = resBuilder.build();
