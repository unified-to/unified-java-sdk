...
public class ListLmsInstructorsOperation implements RequestOperation<ListLmsInstructorsRequest, ListLmsInstructorsResponse> {
    ...
    public ListLmsInstructorsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListLmsInstructorsRequest request) throws Exception {
