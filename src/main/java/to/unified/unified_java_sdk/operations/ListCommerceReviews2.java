...
public class ListCommerceReviews2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceReviews2Request, ListCommerceReviews2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommerceReviews2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceReviews2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceReviews2Request request) {
        ...
        @Override
        public ListCommerceReviews2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceReviews2Response.Builder resBuilder =
            ...
            ListCommerceReviews2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceReviews(Utils.unmarshal(response, new TypeReference<List<CommerceReview>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceReviews2Request, to.unified.unified_java_sdk.models.operations.async.ListCommerceReviews2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceReviews2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceReviews2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceReviews2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceReviews2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceReviews2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceReviews2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceReviews2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CommerceReview>>() {})
                            .thenApply(res::withCommerceReviews);
                } else {
