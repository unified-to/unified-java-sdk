...
public class ListAtsCandidates {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListAtsCandidatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsCandidatesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsCandidatesRequest request) {
        ...
        @Override
        public ListAtsCandidatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsCandidatesResponse.Builder resBuilder =
            ...
            ListAtsCandidatesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsCandidatesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsCandidatesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsCandidatesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsCandidatesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsCandidatesResponse res = resBuilder.build();
