...
public class ListAtsCandidates {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsCandidatesRequest request) throws Exception {
        ...
        @Override
        public ListAtsCandidatesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AtsCandidate> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAtsCandidates(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
