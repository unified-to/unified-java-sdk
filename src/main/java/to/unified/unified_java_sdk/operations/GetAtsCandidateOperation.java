...
public class GetAtsCandidateOperation implements RequestOperation<GetAtsCandidateRequest, GetAtsCandidateResponse> {
    ...
    public GetAtsCandidateOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAtsCandidateRequest request) throws Exception {
