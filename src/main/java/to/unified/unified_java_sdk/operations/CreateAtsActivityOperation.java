...
public class CreateAtsActivityOperation implements RequestOperation<CreateAtsActivityRequest, CreateAtsActivityResponse> {
    ...
    public CreateAtsActivityOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAtsActivityRequest request) throws Exception {
