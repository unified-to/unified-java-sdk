...
public class RemoveAtsDocument2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAtsDocument2Request, RemoveAtsDocument2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAtsDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsDocument2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAtsDocument2Request request) {
        ...
        @Override
        public RemoveAtsDocument2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAtsDocument2Response.Builder resBuilder =
            ...
            RemoveAtsDocument2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAtsDocument2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAtsDocument2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAtsDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsDocument2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAtsDocument2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAtsDocument2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAtsDocument2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAtsDocument2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAtsDocument2Response res = resBuilder.build();
