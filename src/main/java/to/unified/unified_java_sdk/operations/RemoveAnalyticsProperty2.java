...
public class RemoveAnalyticsProperty2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAnalyticsProperty2Request, RemoveAnalyticsProperty2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAnalyticsProperty2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAnalyticsProperty2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAnalyticsProperty2Request request) {
        ...
        @Override
        public RemoveAnalyticsProperty2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAnalyticsProperty2Response.Builder resBuilder =
            ...
            RemoveAnalyticsProperty2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAnalyticsProperty2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsProperty2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAnalyticsProperty2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAnalyticsProperty2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAnalyticsProperty2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsProperty2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsProperty2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsProperty2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAnalyticsProperty2Response res = resBuilder.build();
