...
public class ListAtsInterviews {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsInterviewsRequest request) throws Exception {
        ...
        @Override
        public ListAtsInterviewsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AtsInterview> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAtsInterviews(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
