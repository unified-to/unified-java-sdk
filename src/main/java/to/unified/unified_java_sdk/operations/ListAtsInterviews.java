...
public class ListAtsInterviews {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAtsInterviewsRequest, ListAtsInterviewsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAtsInterviewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsInterviewsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsInterviewsRequest request) {
        ...
        @Override
        public ListAtsInterviewsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsInterviewsResponse.Builder resBuilder =
            ...
            ListAtsInterviewsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsInterviewsRequest, to.unified.unified_java_sdk.models.operations.async.ListAtsInterviewsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsInterviewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsInterviewsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsInterviewsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsInterviewsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsInterviewsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsInterviewsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsInterviewsResponse res = resBuilder.build();
