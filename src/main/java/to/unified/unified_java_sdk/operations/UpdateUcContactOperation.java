...
public class UpdateUcContactOperation implements RequestOperation<UpdateUcContactRequest, UpdateUcContactResponse> {
    ...
    public UpdateUcContactOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateUcContactRequest request) throws Exception {
