...
public class GetAccountingBalancesheet {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingBalancesheetRequest request) throws Exception {
        ...
        @Override
        public GetAccountingBalancesheetResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingBalancesheet out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingBalancesheet(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
