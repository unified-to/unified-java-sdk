...
public class GetAccountingBalancesheet {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingBalancesheetRequest, GetAccountingBalancesheetResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingBalancesheetRequest request) {
        ...
        @Override
        public GetAccountingBalancesheetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingBalancesheetResponse.Builder resBuilder =
            ...
            GetAccountingBalancesheetResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingBalancesheetRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingBalancesheetResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingBalancesheetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingBalancesheetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingBalancesheetRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingBalancesheetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingBalancesheetResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingBalancesheetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingBalancesheetResponse res = resBuilder.build();
