...
public class GetHrisPayslip2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisPayslip2Request, GetHrisPayslip2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisPayslip2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisPayslip2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisPayslip2Request request) {
        ...
        @Override
        public GetHrisPayslip2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisPayslip2Response.Builder resBuilder =
            ...
            GetHrisPayslip2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisPayslip(Utils.unmarshal(response, new TypeReference<HrisPayslip>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisPayslip2Request, to.unified.unified_java_sdk.models.operations.async.GetHrisPayslip2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisPayslip2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisPayslip2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisPayslip2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisPayslip2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisPayslip2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisPayslip2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisPayslip2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HrisPayslip>() {})
                            .thenApply(res::withHrisPayslip);
                } else {
