...
public class CreateCdpActivation {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCdpActivationRequest, CreateCdpActivationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCdpActivationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCdpActivationRequest.class, new TypeReference<CreateCdpActivationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCdpActivationRequest request) {
        ...
        @Override
        public CreateCdpActivationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCdpActivationResponse.Builder resBuilder =
            ...
            CreateCdpActivationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCdpActivationRequest, to.unified.unified_java_sdk.models.operations.async.CreateCdpActivationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCdpActivationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCdpActivationRequest.class, new TypeReference<CreateCdpActivationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCdpActivationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCdpActivationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCdpActivationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCdpActivationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCdpActivationResponse res = resBuilder.build();
