...
public class PatchCrmLead {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCrmLeadRequest, PatchCrmLeadResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCrmLeadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmLeadRequest.class, new TypeReference<PatchCrmLeadRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCrmLeadRequest request) {
        ...
        @Override
        public PatchCrmLeadResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCrmLeadResponse.Builder resBuilder =
            ...
            PatchCrmLeadResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCrmLeadRequest, to.unified.unified_java_sdk.models.operations.async.PatchCrmLeadResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCrmLeadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmLeadRequest.class, new TypeReference<PatchCrmLeadRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCrmLeadRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCrmLeadResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCrmLeadResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCrmLeadResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCrmLeadResponse res = resBuilder.build();
