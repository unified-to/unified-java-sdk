...
public class ListHrisTimeoffs2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisTimeoffs2Request, ListHrisTimeoffs2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisTimeoffs2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisTimeoffs2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisTimeoffs2Request request) {
        ...
        @Override
        public ListHrisTimeoffs2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisTimeoffs2Response.Builder resBuilder =
            ...
            ListHrisTimeoffs2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisTimeoffs(Utils.unmarshal(response, new TypeReference<List<HrisTimeoff>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisTimeoffs2Request, to.unified.unified_java_sdk.models.operations.async.ListHrisTimeoffs2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisTimeoffs2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisTimeoffs2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisTimeoffs2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisTimeoffs2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisTimeoffs2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisTimeoffs2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisTimeoffs2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<HrisTimeoff>>() {})
                            .thenApply(res::withHrisTimeoffs);
                } else {
