...
public class ListCrmPipelinesOperation implements RequestOperation<ListCrmPipelinesRequest, ListCrmPipelinesResponse> {
    ...
    public ListCrmPipelinesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCrmPipelinesRequest request) throws Exception {
