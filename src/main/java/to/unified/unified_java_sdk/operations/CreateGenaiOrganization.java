...
public class CreateGenaiOrganization {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateGenaiOrganizationRequest, CreateGenaiOrganizationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateGenaiOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateGenaiOrganizationRequest.class, new TypeReference<CreateGenaiOrganizationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateGenaiOrganizationRequest request) {
        ...
        @Override
        public CreateGenaiOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateGenaiOrganizationResponse.Builder resBuilder =
                    CreateGenaiOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateGenaiOrganizationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateGenaiOrganizationRequest, to.unified.unified_java_sdk.models.operations.async.CreateGenaiOrganizationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateGenaiOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateGenaiOrganizationRequest.class, new TypeReference<CreateGenaiOrganizationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateGenaiOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateGenaiOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateGenaiOrganizationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateGenaiOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateGenaiOrganizationResponse res = resBuilder.build();
