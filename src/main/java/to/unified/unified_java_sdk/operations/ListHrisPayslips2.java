...
public class ListHrisPayslips2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisPayslips2Request, ListHrisPayslips2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisPayslips2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisPayslips2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisPayslips2Request request) {
        ...
        @Override
        public ListHrisPayslips2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisPayslips2Response.Builder resBuilder =
            ...
            ListHrisPayslips2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisPayslips(Utils.unmarshal(response, new TypeReference<List<HrisPayslip>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisPayslips2Request, to.unified.unified_java_sdk.models.operations.async.ListHrisPayslips2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisPayslips2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisPayslips2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisPayslips2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisPayslips2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisPayslips2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisPayslips2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisPayslips2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<HrisPayslip>>() {})
                            .thenApply(res::withHrisPayslips);
                } else {
