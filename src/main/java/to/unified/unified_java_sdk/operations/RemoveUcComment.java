...
public class RemoveUcComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveUcCommentRequest, RemoveUcCommentResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(RemoveUcCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUcCommentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveUcCommentRequest request) throws Exception {
        ...
        @Override
        public RemoveUcCommentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveUcCommentResponse.Builder resBuilder =
            ...
            RemoveUcCommentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveUcCommentRequest, to.unified.unified_java_sdk.models.operations.async.RemoveUcCommentResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveUcCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUcCommentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveUcCommentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveUcCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveUcCommentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveUcCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveUcCommentResponse res = resBuilder.build();
