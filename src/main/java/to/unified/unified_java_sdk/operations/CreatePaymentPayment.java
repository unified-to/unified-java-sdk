...
public class CreatePaymentPayment {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePaymentPaymentRequest, CreatePaymentPaymentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreatePaymentPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentPaymentRequest.class, new TypeReference<CreatePaymentPaymentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePaymentPaymentRequest request) {
        ...
        @Override
        public CreatePaymentPaymentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePaymentPaymentResponse.Builder resBuilder =
            ...
            CreatePaymentPaymentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePaymentPaymentRequest, to.unified.unified_java_sdk.models.operations.async.CreatePaymentPaymentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreatePaymentPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentPaymentRequest.class, new TypeReference<CreatePaymentPaymentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePaymentPaymentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreatePaymentPaymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreatePaymentPaymentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreatePaymentPaymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreatePaymentPaymentResponse res = resBuilder.build();
