...
public class CreatePaymentPayment {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePaymentPaymentRequest request) throws Exception {
        ...
        @Override
        public CreatePaymentPaymentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaymentPayment out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentPayment(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
