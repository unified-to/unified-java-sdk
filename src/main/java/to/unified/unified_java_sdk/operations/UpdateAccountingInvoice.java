...
public class UpdateAccountingInvoice {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAccountingInvoiceRequest request) throws Exception {
        ...
        @Override
        public UpdateAccountingInvoiceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    AccountingInvoice out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingInvoice(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
