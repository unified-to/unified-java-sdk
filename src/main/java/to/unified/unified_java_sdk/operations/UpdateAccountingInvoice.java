...
public class UpdateAccountingInvoice {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAccountingInvoiceRequest, UpdateAccountingInvoiceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAccountingInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingInvoiceRequest.class, new TypeReference<UpdateAccountingInvoiceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAccountingInvoiceRequest request) {
        ...
        @Override
        public UpdateAccountingInvoiceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAccountingInvoiceResponse.Builder resBuilder =
            ...
            UpdateAccountingInvoiceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAccountingInvoiceRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAccountingInvoiceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAccountingInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountingInvoiceRequest.class, new TypeReference<UpdateAccountingInvoiceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAccountingInvoiceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAccountingInvoiceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingInvoiceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAccountingInvoiceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAccountingInvoiceResponse res = resBuilder.build();
