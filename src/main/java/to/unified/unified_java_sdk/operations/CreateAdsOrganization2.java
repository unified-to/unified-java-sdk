...
public class CreateAdsOrganization2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAdsOrganization2Request, CreateAdsOrganization2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAdsOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsOrganization2Request.class, new TypeReference<CreateAdsOrganization2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAdsOrganization2Request request) {
        ...
        @Override
        public CreateAdsOrganization2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAdsOrganization2Response.Builder resBuilder =
            ...
            CreateAdsOrganization2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAdsOrganization2Request, to.unified.unified_java_sdk.models.operations.async.CreateAdsOrganization2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAdsOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsOrganization2Request.class, new TypeReference<CreateAdsOrganization2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAdsOrganization2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAdsOrganization2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAdsOrganization2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAdsOrganization2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAdsOrganization2Response res = resBuilder.build();
