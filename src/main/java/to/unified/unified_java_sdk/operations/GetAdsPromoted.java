...
public class GetAdsPromoted {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAdsPromotedRequest, GetAdsPromotedResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAdsPromotedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsPromotedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAdsPromotedRequest request) {
        ...
        @Override
        public GetAdsPromotedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAdsPromotedResponse.Builder resBuilder =
            ...
            GetAdsPromotedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAdsPromotedRequest, to.unified.unified_java_sdk.models.operations.async.GetAdsPromotedResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAdsPromotedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsPromotedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAdsPromotedRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAdsPromotedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAdsPromotedResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAdsPromotedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAdsPromotedResponse res = resBuilder.build();
