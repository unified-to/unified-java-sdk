...
public class UpdateTaskProjectOperation implements RequestOperation<UpdateTaskProjectRequest, UpdateTaskProjectResponse> {
    ...
    public UpdateTaskProjectOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateTaskProjectRequest request) throws Exception {
