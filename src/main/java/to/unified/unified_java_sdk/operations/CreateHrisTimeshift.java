...
public class CreateHrisTimeshift {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisTimeshiftRequest, CreateHrisTimeshiftResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisTimeshiftRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisTimeshiftRequest.class, new TypeReference<CreateHrisTimeshiftRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisTimeshiftRequest request) {
        ...
        @Override
        public CreateHrisTimeshiftResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisTimeshiftResponse.Builder resBuilder =
            ...
            CreateHrisTimeshiftResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisTimeshiftRequest, to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeshiftResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisTimeshiftRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisTimeshiftRequest.class, new TypeReference<CreateHrisTimeshiftRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisTimeshiftRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeshiftResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeshiftResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeshiftResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeshiftResponse res = resBuilder.build();
