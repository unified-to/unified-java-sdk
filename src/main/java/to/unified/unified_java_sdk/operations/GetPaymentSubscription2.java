...
public class GetPaymentSubscription2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPaymentSubscription2Request, GetPaymentSubscription2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetPaymentSubscription2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentSubscription2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentSubscription2Request request) {
        ...
        @Override
        public GetPaymentSubscription2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPaymentSubscription2Response.Builder resBuilder =
            ...
            GetPaymentSubscription2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentSubscription2Request, to.unified.unified_java_sdk.models.operations.async.GetPaymentSubscription2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPaymentSubscription2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentSubscription2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPaymentSubscription2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetPaymentSubscription2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetPaymentSubscription2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetPaymentSubscription2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetPaymentSubscription2Response res = resBuilder.build();
