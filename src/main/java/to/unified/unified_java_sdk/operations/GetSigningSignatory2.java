...
public class GetSigningSignatory2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSigningSignatory2Request, GetSigningSignatory2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSigningSignatory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetSigningSignatory2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSigningSignatory2Request request) {
        ...
        @Override
        public GetSigningSignatory2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSigningSignatory2Response.Builder resBuilder =
            ...
            GetSigningSignatory2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSigningSignatory2Request, to.unified.unified_java_sdk.models.operations.async.GetSigningSignatory2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSigningSignatory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetSigningSignatory2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSigningSignatory2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetSigningSignatory2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetSigningSignatory2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetSigningSignatory2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetSigningSignatory2Response res = resBuilder.build();
