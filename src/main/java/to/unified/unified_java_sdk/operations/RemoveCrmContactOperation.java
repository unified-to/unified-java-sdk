...
public class RemoveCrmContactOperation implements RequestOperation<RemoveCrmContactRequest, RemoveCrmContactResponse> {
    ...
    public RemoveCrmContactOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveCrmContactRequest request) throws Exception {
