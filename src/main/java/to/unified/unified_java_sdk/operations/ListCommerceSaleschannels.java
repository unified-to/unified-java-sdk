...
public class ListCommerceSaleschannels {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceSaleschannelsRequest, ListCommerceSaleschannelsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommerceSaleschannelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceSaleschannelsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceSaleschannelsRequest request) {
        ...
        @Override
        public ListCommerceSaleschannelsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceSaleschannelsResponse.Builder resBuilder =
            ...
            ListCommerceSaleschannelsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceSaleschannelsRequest, to.unified.unified_java_sdk.models.operations.async.ListCommerceSaleschannelsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceSaleschannelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceSaleschannelsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceSaleschannelsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceSaleschannelsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceSaleschannelsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceSaleschannelsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceSaleschannelsResponse res = resBuilder.build();
