...
public class RemoveLmsStudentOperation implements RequestOperation<RemoveLmsStudentRequest, RemoveLmsStudentResponse> {
    ...
    public RemoveLmsStudentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveLmsStudentRequest request) throws Exception {
