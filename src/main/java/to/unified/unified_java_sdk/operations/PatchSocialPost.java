...
public class PatchSocialPost {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchSocialPostRequest, PatchSocialPostResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchSocialPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchSocialPostRequest.class, new TypeReference<PatchSocialPostRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchSocialPostRequest request) {
        ...
        @Override
        public PatchSocialPostResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchSocialPostResponse.Builder resBuilder =
            ...
            PatchSocialPostResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchSocialPostRequest, to.unified.unified_java_sdk.models.operations.async.PatchSocialPostResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchSocialPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchSocialPostRequest.class, new TypeReference<PatchSocialPostRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchSocialPostRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchSocialPostResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchSocialPostResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchSocialPostResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchSocialPostResponse res = resBuilder.build();
