...
public class RemoveLmsActivity2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveLmsActivity2Request, RemoveLmsActivity2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveLmsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsActivity2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveLmsActivity2Request request) {
        ...
        @Override
        public RemoveLmsActivity2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveLmsActivity2Response.Builder resBuilder =
            ...
            RemoveLmsActivity2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveLmsActivity2Request, to.unified.unified_java_sdk.models.operations.async.RemoveLmsActivity2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveLmsActivity2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsActivity2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveLmsActivity2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveLmsActivity2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveLmsActivity2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveLmsActivity2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveLmsActivity2Response res = resBuilder.build();
