...
public class RemoveCdpActivation {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCdpActivationRequest, RemoveCdpActivationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCdpActivationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCdpActivationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCdpActivationRequest request) {
        ...
        @Override
        public RemoveCdpActivationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCdpActivationResponse.Builder resBuilder =
            ...
            RemoveCdpActivationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCdpActivationRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCdpActivationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCdpActivationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCdpActivationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCdpActivationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCdpActivationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCdpActivationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCdpActivationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCdpActivationResponse res = resBuilder.build();
