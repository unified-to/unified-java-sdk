...
public class UpdateHrisGroup2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisGroup2Request, UpdateHrisGroup2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisGroup2Request.class, new TypeReference<UpdateHrisGroup2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisGroup2Request request) {
        ...
        @Override
        public UpdateHrisGroup2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisGroup2Response.Builder resBuilder =
            ...
            UpdateHrisGroup2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisGroup2Request, to.unified.unified_java_sdk.models.operations.async.UpdateHrisGroup2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisGroup2Request.class, new TypeReference<UpdateHrisGroup2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisGroup2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisGroup2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisGroup2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisGroup2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisGroup2Response res = resBuilder.build();
