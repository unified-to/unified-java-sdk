...
public class ListAccountingSalesorders {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountingSalesordersRequest request) throws Exception {
        ...
        @Override
        public ListAccountingSalesordersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AccountingSalesorder> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingSalesorders(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
