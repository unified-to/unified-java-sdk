...
public class UpdateHrisLocation {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisLocationRequest, UpdateHrisLocationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisLocationRequest.class, new TypeReference<UpdateHrisLocationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisLocationRequest request) {
        ...
        @Override
        public UpdateHrisLocationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisLocationResponse.Builder resBuilder =
            ...
            UpdateHrisLocationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisLocationRequest, to.unified.unified_java_sdk.models.operations.async.UpdateHrisLocationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisLocationRequest.class, new TypeReference<UpdateHrisLocationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisLocationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisLocationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisLocationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisLocationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisLocationResponse res = resBuilder.build();
