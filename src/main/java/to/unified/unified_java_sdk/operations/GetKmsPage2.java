...
public class GetKmsPage2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetKmsPage2Request, GetKmsPage2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetKmsPage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetKmsPage2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetKmsPage2Request request) {
        ...
        @Override
        public GetKmsPage2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetKmsPage2Response.Builder resBuilder =
                    GetKmsPage2Response
                            .builder()
            ...
            GetKmsPage2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetKmsPage2Request, to.unified.unified_java_sdk.models.operations.async.GetKmsPage2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetKmsPage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetKmsPage2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetKmsPage2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetKmsPage2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetKmsPage2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetKmsPage2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetKmsPage2Response res = resBuilder.build();
