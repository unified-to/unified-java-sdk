...
public class ListHrisBankaccounts2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisBankaccounts2Request, ListHrisBankaccounts2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisBankaccounts2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisBankaccounts2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisBankaccounts2Request request) {
        ...
        @Override
        public ListHrisBankaccounts2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisBankaccounts2Response.Builder resBuilder =
            ...
            ListHrisBankaccounts2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisBankaccounts(Utils.unmarshal(response, new TypeReference<List<HrisBankaccount>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisBankaccounts2Request, to.unified.unified_java_sdk.models.operations.async.ListHrisBankaccounts2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisBankaccounts2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisBankaccounts2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisBankaccounts2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisBankaccounts2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisBankaccounts2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisBankaccounts2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisBankaccounts2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<HrisBankaccount>>() {})
                            .thenApply(res::withHrisBankaccounts);
                } else {
