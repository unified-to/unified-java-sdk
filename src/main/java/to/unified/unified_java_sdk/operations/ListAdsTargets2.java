...
public class ListAdsTargets2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsTargets2Request, ListAdsTargets2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsTargets2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsTargets2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsTargets2Request request) {
        ...
        @Override
        public ListAdsTargets2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsTargets2Response.Builder resBuilder =
            ...
            ListAdsTargets2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdsTargets(Utils.unmarshal(response, new TypeReference<List<AdsTarget>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsTargets2Request, to.unified.unified_java_sdk.models.operations.async.ListAdsTargets2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsTargets2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsTargets2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsTargets2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsTargets2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsTargets2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsTargets2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsTargets2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AdsTarget>>() {})
                            .thenApply(res::withAdsTargets);
                } else {
