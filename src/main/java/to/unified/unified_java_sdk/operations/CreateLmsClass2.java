...
public class CreateLmsClass2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateLmsClass2Request, CreateLmsClass2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateLmsClass2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsClass2Request.class, new TypeReference<CreateLmsClass2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateLmsClass2Request request) {
        ...
        @Override
        public CreateLmsClass2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateLmsClass2Response.Builder resBuilder =
            ...
            CreateLmsClass2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLmsClass(Utils.unmarshal(response, new TypeReference<LmsClass>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateLmsClass2Request, to.unified.unified_java_sdk.models.operations.async.CreateLmsClass2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateLmsClass2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsClass2Request.class, new TypeReference<CreateLmsClass2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateLmsClass2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateLmsClass2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateLmsClass2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateLmsClass2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateLmsClass2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<LmsClass>() {})
                            .thenApply(res::withLmsClass);
                } else {
