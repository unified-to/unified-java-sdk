...
public class RemoveCrmEventOperation implements RequestOperation<RemoveCrmEventRequest, RemoveCrmEventResponse> {
    ...
    public RemoveCrmEventOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveCrmEventRequest request) throws Exception {
