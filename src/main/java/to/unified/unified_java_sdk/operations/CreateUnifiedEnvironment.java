...
public class CreateUnifiedEnvironment {
    ...
    public static class Sync extends Base
            implements RequestOperation<List<String>, CreateUnifiedEnvironmentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(List<String> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<List<String>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(List<String> request) {
        ...
        @Override
        public CreateUnifiedEnvironmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateUnifiedEnvironmentResponse.Builder resBuilder =
            ...
            CreateUnifiedEnvironmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<List<String>, to.unified.unified_java_sdk.models.operations.async.CreateUnifiedEnvironmentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(List<String> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<List<String>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(List<String> request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateUnifiedEnvironmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateUnifiedEnvironmentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateUnifiedEnvironmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateUnifiedEnvironmentResponse res = resBuilder.build();
