...
public class ListRepoCommits {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRepoCommitsRequest request) throws Exception {
        ...
        @Override
        public ListRepoCommitsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<RepoCommit> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withRepoCommits(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
