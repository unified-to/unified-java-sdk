...
public class ListRepoCommits {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRepoCommitsRequest, ListRepoCommitsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListRepoCommitsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoCommitsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRepoCommitsRequest request) {
        ...
        @Override
        public ListRepoCommitsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListRepoCommitsResponse.Builder resBuilder =
            ...
            ListRepoCommitsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListRepoCommitsRequest, to.unified.unified_java_sdk.models.operations.async.ListRepoCommitsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListRepoCommitsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoCommitsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRepoCommitsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListRepoCommitsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListRepoCommitsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListRepoCommitsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListRepoCommitsResponse res = resBuilder.build();
