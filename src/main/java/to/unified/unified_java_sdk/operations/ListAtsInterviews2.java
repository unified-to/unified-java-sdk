...
public class ListAtsInterviews2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAtsInterviews2Request, ListAtsInterviews2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAtsInterviews2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsInterviews2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsInterviews2Request request) {
        ...
        @Override
        public ListAtsInterviews2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsInterviews2Response.Builder resBuilder =
            ...
            ListAtsInterviews2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsInterviews(Utils.unmarshal(response, new TypeReference<List<AtsInterview>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsInterviews2Request, to.unified.unified_java_sdk.models.operations.async.ListAtsInterviews2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsInterviews2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsInterviews2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsInterviews2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsInterviews2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsInterviews2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsInterviews2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsInterviews2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AtsInterview>>() {})
                            .thenApply(res::withAtsInterviews);
                } else {
