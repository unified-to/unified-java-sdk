...
public class UpdateHrisBankaccount {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisBankaccountRequest, UpdateHrisBankaccountResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisBankaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisBankaccountRequest.class, new TypeReference<UpdateHrisBankaccountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisBankaccountRequest request) {
        ...
        @Override
        public UpdateHrisBankaccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisBankaccountResponse.Builder resBuilder =
            ...
            UpdateHrisBankaccountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisBankaccountRequest, to.unified.unified_java_sdk.models.operations.async.UpdateHrisBankaccountResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisBankaccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisBankaccountRequest.class, new TypeReference<UpdateHrisBankaccountRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisBankaccountRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisBankaccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisBankaccountResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisBankaccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisBankaccountResponse res = resBuilder.build();
