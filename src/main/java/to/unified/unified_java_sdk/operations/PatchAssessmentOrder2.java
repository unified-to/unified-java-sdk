...
public class PatchAssessmentOrder2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAssessmentOrder2Request, PatchAssessmentOrder2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAssessmentOrder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAssessmentOrder2Request.class, new TypeReference<PatchAssessmentOrder2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAssessmentOrder2Request request) {
        ...
        @Override
        public PatchAssessmentOrder2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAssessmentOrder2Response.Builder resBuilder =
            ...
            PatchAssessmentOrder2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAssessmentOrder2Request, to.unified.unified_java_sdk.models.operations.async.PatchAssessmentOrder2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAssessmentOrder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAssessmentOrder2Request.class, new TypeReference<PatchAssessmentOrder2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAssessmentOrder2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAssessmentOrder2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAssessmentOrder2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAssessmentOrder2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAssessmentOrder2Response res = resBuilder.build();
