...
public class GetAccountingTaxrate {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingTaxrateRequest, GetAccountingTaxrateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingTaxrateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingTaxrateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingTaxrateRequest request) {
        ...
        @Override
        public GetAccountingTaxrateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingTaxrateResponse.Builder resBuilder =
            ...
            GetAccountingTaxrateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingTaxrateRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingTaxrateResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingTaxrateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingTaxrateRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingTaxrateRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingTaxrateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingTaxrateResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingTaxrateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingTaxrateResponse res = resBuilder.build();
