...
public class GetStorageFile {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetStorageFileRequest, GetStorageFileResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetStorageFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStorageFileRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetStorageFileRequest request) {
        ...
        @Override
        public GetStorageFileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetStorageFileResponse.Builder resBuilder =
            ...
            GetStorageFileResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetStorageFileRequest, to.unified.unified_java_sdk.models.operations.async.GetStorageFileResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetStorageFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStorageFileRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetStorageFileRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetStorageFileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetStorageFileResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetStorageFileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetStorageFileResponse res = resBuilder.build();
