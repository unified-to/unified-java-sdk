...
public class GetCdpDestination {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCdpDestinationRequest, GetCdpDestinationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCdpDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCdpDestinationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCdpDestinationRequest request) {
        ...
        @Override
        public GetCdpDestinationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCdpDestinationResponse.Builder resBuilder =
            ...
            GetCdpDestinationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCdpDestinationRequest, to.unified.unified_java_sdk.models.operations.async.GetCdpDestinationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCdpDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCdpDestinationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCdpDestinationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCdpDestinationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCdpDestinationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCdpDestinationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCdpDestinationResponse res = resBuilder.build();
