...
public class RemoveShippingShipment {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveShippingShipmentRequest, RemoveShippingShipmentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveShippingShipmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveShippingShipmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveShippingShipmentRequest request) {
        ...
        @Override
        public RemoveShippingShipmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveShippingShipmentResponse.Builder resBuilder =
            ...
            RemoveShippingShipmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveShippingShipmentRequest, to.unified.unified_java_sdk.models.operations.async.RemoveShippingShipmentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveShippingShipmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveShippingShipmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveShippingShipmentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveShippingShipmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveShippingShipmentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveShippingShipmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveShippingShipmentResponse res = resBuilder.build();
