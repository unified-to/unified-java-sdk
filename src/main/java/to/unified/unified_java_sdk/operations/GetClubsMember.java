...
public class GetClubsMember {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetClubsMemberRequest, GetClubsMemberResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetClubsMemberRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsMemberRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClubsMemberRequest request) {
        ...
        @Override
        public GetClubsMemberResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetClubsMemberResponse.Builder resBuilder =
            ...
            GetClubsMemberResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetClubsMemberRequest, to.unified.unified_java_sdk.models.operations.async.GetClubsMemberResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetClubsMemberRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsMemberRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetClubsMemberRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetClubsMemberResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetClubsMemberResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetClubsMemberResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetClubsMemberResponse res = resBuilder.build();
