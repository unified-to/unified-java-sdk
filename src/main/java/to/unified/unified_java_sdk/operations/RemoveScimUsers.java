...
public class RemoveScimUsers {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveScimUsersRequest, RemoveScimUsersResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveScimUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveScimUsersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveScimUsersRequest request) throws Exception {
        ...
        @Override
        public RemoveScimUsersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveScimUsersResponse.Builder resBuilder =
            ...
            RemoveScimUsersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveScimUsersRequest, to.unified.unified_java_sdk.models.operations.async.RemoveScimUsersResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveScimUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveScimUsersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveScimUsersRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveScimUsersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveScimUsersResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveScimUsersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveScimUsersResponse res = resBuilder.build();
