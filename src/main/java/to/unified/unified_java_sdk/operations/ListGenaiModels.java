...
public class ListGenaiModels {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListGenaiModelsRequest, ListGenaiModelsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListGenaiModelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListGenaiModelsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListGenaiModelsRequest request) {
        ...
        @Override
        public ListGenaiModelsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListGenaiModelsResponse.Builder resBuilder =
            ...
            ListGenaiModelsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListGenaiModelsRequest, to.unified.unified_java_sdk.models.operations.async.ListGenaiModelsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListGenaiModelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListGenaiModelsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListGenaiModelsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListGenaiModelsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListGenaiModelsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListGenaiModelsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListGenaiModelsResponse res = resBuilder.build();
