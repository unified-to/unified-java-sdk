...
public class ListGenaiModels {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListGenaiModelsRequest request) throws Exception {
        ...
        @Override
        public ListGenaiModelsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<GenaiModel> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGenaiModels(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
