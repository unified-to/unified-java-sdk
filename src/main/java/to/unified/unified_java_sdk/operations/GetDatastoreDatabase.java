...
public class GetDatastoreDatabase {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDatastoreDatabaseRequest, GetDatastoreDatabaseResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetDatastoreDatabaseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDatastoreDatabaseRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDatastoreDatabaseRequest request) {
        ...
        @Override
        public GetDatastoreDatabaseResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDatastoreDatabaseResponse.Builder resBuilder =
            ...
            GetDatastoreDatabaseResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDatastoreDatabaseRequest, to.unified.unified_java_sdk.models.operations.async.GetDatastoreDatabaseResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetDatastoreDatabaseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDatastoreDatabaseRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDatastoreDatabaseRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetDatastoreDatabaseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetDatastoreDatabaseResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetDatastoreDatabaseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetDatastoreDatabaseResponse res = resBuilder.build();
