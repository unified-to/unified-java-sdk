...
public class GetHrisGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisGroupRequest, GetHrisGroupResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisGroupRequest request) {
        ...
        @Override
        public GetHrisGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisGroupResponse.Builder resBuilder =
            ...
            GetHrisGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisGroupRequest, to.unified.unified_java_sdk.models.operations.async.GetHrisGroupResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisGroupRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisGroupResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisGroupResponse res = resBuilder.build();
