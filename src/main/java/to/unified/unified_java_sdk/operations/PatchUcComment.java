...
public class PatchUcComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchUcCommentRequest, PatchUcCommentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchUcCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUcCommentRequest.class, new TypeReference<PatchUcCommentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchUcCommentRequest request) {
        ...
        @Override
        public PatchUcCommentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchUcCommentResponse.Builder resBuilder =
            ...
            PatchUcCommentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchUcCommentRequest, to.unified.unified_java_sdk.models.operations.async.PatchUcCommentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchUcCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUcCommentRequest.class, new TypeReference<PatchUcCommentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchUcCommentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchUcCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchUcCommentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchUcCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchUcCommentResponse res = resBuilder.build();
