...
public class GetAnalyticsVisitor {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAnalyticsVisitorRequest, GetAnalyticsVisitorResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAnalyticsVisitorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAnalyticsVisitorRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAnalyticsVisitorRequest request) {
        ...
        @Override
        public GetAnalyticsVisitorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAnalyticsVisitorResponse.Builder resBuilder =
            ...
            GetAnalyticsVisitorResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAnalyticsVisitorRequest, to.unified.unified_java_sdk.models.operations.async.GetAnalyticsVisitorResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAnalyticsVisitorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAnalyticsVisitorRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAnalyticsVisitorRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAnalyticsVisitorResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAnalyticsVisitorResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAnalyticsVisitorResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAnalyticsVisitorResponse res = resBuilder.build();
