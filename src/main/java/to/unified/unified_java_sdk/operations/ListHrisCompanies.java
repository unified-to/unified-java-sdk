...
public class ListHrisCompanies {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisCompaniesRequest, ListHrisCompaniesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisCompaniesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisCompaniesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisCompaniesRequest request) {
        ...
        @Override
        public ListHrisCompaniesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisCompaniesResponse.Builder resBuilder =
            ...
            ListHrisCompaniesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisCompaniesRequest, to.unified.unified_java_sdk.models.operations.async.ListHrisCompaniesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisCompaniesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisCompaniesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisCompaniesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisCompaniesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisCompaniesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisCompaniesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisCompaniesResponse res = resBuilder.build();
