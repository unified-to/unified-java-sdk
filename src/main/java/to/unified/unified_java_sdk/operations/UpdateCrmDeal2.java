...
public class UpdateCrmDeal2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCrmDeal2Request, UpdateCrmDeal2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCrmDeal2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmDeal2Request.class, new TypeReference<UpdateCrmDeal2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCrmDeal2Request request) {
        ...
        @Override
        public UpdateCrmDeal2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCrmDeal2Response.Builder resBuilder =
            ...
            UpdateCrmDeal2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCrmDeal(Utils.unmarshal(response, new TypeReference<CrmDeal>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCrmDeal2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCrmDeal2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCrmDeal2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmDeal2Request.class, new TypeReference<UpdateCrmDeal2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCrmDeal2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCrmDeal2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCrmDeal2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCrmDeal2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCrmDeal2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CrmDeal>() {})
                            .thenApply(res::withCrmDeal);
                } else {
