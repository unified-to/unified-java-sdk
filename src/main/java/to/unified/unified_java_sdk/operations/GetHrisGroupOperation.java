...
public class GetHrisGroupOperation implements RequestOperation<GetHrisGroupRequest, GetHrisGroupResponse> {
    ...
    public GetHrisGroupOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetHrisGroupRequest request) throws Exception {
