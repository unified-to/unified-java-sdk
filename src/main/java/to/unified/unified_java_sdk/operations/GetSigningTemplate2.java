...
public class GetSigningTemplate2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSigningTemplate2Request, GetSigningTemplate2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSigningTemplate2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetSigningTemplate2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSigningTemplate2Request request) {
        ...
        @Override
        public GetSigningTemplate2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSigningTemplate2Response.Builder resBuilder =
            ...
            GetSigningTemplate2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSigningTemplate(Utils.unmarshal(response, new TypeReference<SigningTemplate>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSigningTemplate2Request, to.unified.unified_java_sdk.models.operations.async.GetSigningTemplate2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSigningTemplate2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetSigningTemplate2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSigningTemplate2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetSigningTemplate2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetSigningTemplate2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetSigningTemplate2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetSigningTemplate2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SigningTemplate>() {})
                            .thenApply(res::withSigningTemplate);
                } else {
