...
public class RemoveCrmCompanyOperation implements RequestOperation<RemoveCrmCompanyRequest, RemoveCrmCompanyResponse> {
    ...
    public RemoveCrmCompanyOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveCrmCompanyRequest request) throws Exception {
