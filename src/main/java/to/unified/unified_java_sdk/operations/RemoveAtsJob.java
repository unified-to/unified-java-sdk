...
public class RemoveAtsJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAtsJobRequest, RemoveAtsJobResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAtsJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsJobRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAtsJobRequest request) throws Exception {
        ...
        @Override
        public RemoveAtsJobResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAtsJobResponse.Builder resBuilder =
            ...
            RemoveAtsJobResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAtsJobRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAtsJobResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAtsJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsJobRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAtsJobRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAtsJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAtsJobResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAtsJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAtsJobResponse res = resBuilder.build();
