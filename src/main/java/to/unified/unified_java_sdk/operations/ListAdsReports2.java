...
public class ListAdsReports2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsReports2Request, ListAdsReports2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsReports2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsReports2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsReports2Request request) {
        ...
        @Override
        public ListAdsReports2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsReports2Response.Builder resBuilder =
            ...
            ListAdsReports2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsReports2Request, to.unified.unified_java_sdk.models.operations.async.ListAdsReports2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsReports2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsReports2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsReports2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsReports2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsReports2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsReports2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsReports2Response res = resBuilder.build();
