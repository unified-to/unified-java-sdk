...
public class CreateCommerceReview {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommerceReviewRequest, CreateCommerceReviewResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommerceReviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceReviewRequest.class, new TypeReference<CreateCommerceReviewRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceReviewRequest request) {
        ...
        @Override
        public CreateCommerceReviewResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommerceReviewResponse.Builder resBuilder =
            ...
            CreateCommerceReviewResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommerceReviewRequest, to.unified.unified_java_sdk.models.operations.async.CreateCommerceReviewResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommerceReviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceReviewRequest.class, new TypeReference<CreateCommerceReviewRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommerceReviewRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCommerceReviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCommerceReviewResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCommerceReviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCommerceReviewResponse res = resBuilder.build();
