...
public class CreateCommerceReview {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceReviewRequest request) throws Exception {
        ...
        @Override
        public CreateCommerceReviewResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CommerceReview out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCommerceReview(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
