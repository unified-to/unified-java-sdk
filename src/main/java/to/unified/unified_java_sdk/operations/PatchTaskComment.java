...
public class PatchTaskComment {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchTaskCommentRequest request) throws Exception {
        ...
        @Override
        public PatchTaskCommentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TaskComment out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTaskComment(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
