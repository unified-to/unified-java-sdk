...
public class PatchTaskComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchTaskCommentRequest, PatchTaskCommentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchTaskCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTaskCommentRequest.class, new TypeReference<PatchTaskCommentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchTaskCommentRequest request) {
        ...
        @Override
        public PatchTaskCommentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchTaskCommentResponse.Builder resBuilder =
            ...
            PatchTaskCommentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchTaskCommentRequest, to.unified.unified_java_sdk.models.operations.async.PatchTaskCommentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchTaskCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTaskCommentRequest.class, new TypeReference<PatchTaskCommentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchTaskCommentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchTaskCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchTaskCommentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchTaskCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchTaskCommentResponse res = resBuilder.build();
