...
public class UpdateAtsCandidate2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAtsCandidate2Request, UpdateAtsCandidate2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAtsCandidate2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsCandidate2Request.class, new TypeReference<UpdateAtsCandidate2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsCandidate2Request request) {
        ...
        @Override
        public UpdateAtsCandidate2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAtsCandidate2Response.Builder resBuilder =
            ...
            UpdateAtsCandidate2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsCandidate(Utils.unmarshal(response, new TypeReference<AtsCandidate>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAtsCandidate2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAtsCandidate2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAtsCandidate2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsCandidate2Request.class, new TypeReference<UpdateAtsCandidate2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAtsCandidate2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAtsCandidate2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAtsCandidate2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAtsCandidate2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAtsCandidate2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AtsCandidate>() {})
                            .thenApply(res::withAtsCandidate);
                } else {
