...
public class GetAtsInterview2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAtsInterview2Request, GetAtsInterview2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAtsInterview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsInterview2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAtsInterview2Request request) {
        ...
        @Override
        public GetAtsInterview2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAtsInterview2Response.Builder resBuilder =
            ...
            GetAtsInterview2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAtsInterview2Request, to.unified.unified_java_sdk.models.operations.async.GetAtsInterview2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAtsInterview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsInterview2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAtsInterview2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAtsInterview2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAtsInterview2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAtsInterview2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAtsInterview2Response res = resBuilder.build();
