...
public class CreateAdsCampaign2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAdsCampaign2Request, CreateAdsCampaign2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAdsCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsCampaign2Request.class, new TypeReference<CreateAdsCampaign2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAdsCampaign2Request request) {
        ...
        @Override
        public CreateAdsCampaign2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAdsCampaign2Response.Builder resBuilder =
            ...
            CreateAdsCampaign2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdsCampaign(Utils.unmarshal(response, new TypeReference<AdsCampaign>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAdsCampaign2Request, to.unified.unified_java_sdk.models.operations.async.CreateAdsCampaign2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAdsCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAdsCampaign2Request.class, new TypeReference<CreateAdsCampaign2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAdsCampaign2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAdsCampaign2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAdsCampaign2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAdsCampaign2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAdsCampaign2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AdsCampaign>() {})
                            .thenApply(res::withAdsCampaign);
                } else {
