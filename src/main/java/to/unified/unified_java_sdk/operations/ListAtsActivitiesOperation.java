...
public class ListAtsActivitiesOperation implements RequestOperation<ListAtsActivitiesRequest, ListAtsActivitiesResponse> {
    ...
    public ListAtsActivitiesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAtsActivitiesRequest request) throws Exception {
