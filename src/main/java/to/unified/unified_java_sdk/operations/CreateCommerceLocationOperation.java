...
public class CreateCommerceLocationOperation implements RequestOperation<CreateCommerceLocationRequest, CreateCommerceLocationResponse> {
    ...
    public CreateCommerceLocationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateCommerceLocationRequest request) throws Exception {
