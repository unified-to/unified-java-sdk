...
public class ListStorageFilesOperation implements RequestOperation<ListStorageFilesRequest, ListStorageFilesResponse> {
    ...
    public ListStorageFilesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListStorageFilesRequest request) throws Exception {
