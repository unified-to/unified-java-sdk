...
public class CreatePaymentPaymentOperation implements RequestOperation<CreatePaymentPaymentRequest, CreatePaymentPaymentResponse> {
    ...
    public CreatePaymentPaymentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreatePaymentPaymentRequest request) throws Exception {
