...
public class ListHrisPayslipsOperation implements RequestOperation<ListHrisPayslipsRequest, ListHrisPayslipsResponse> {
    ...
    public ListHrisPayslipsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListHrisPayslipsRequest request) throws Exception {
