...
public class PatchCrmPipeline2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCrmPipeline2Request, PatchCrmPipeline2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCrmPipeline2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmPipeline2Request.class, new TypeReference<PatchCrmPipeline2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCrmPipeline2Request request) {
        ...
        @Override
        public PatchCrmPipeline2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCrmPipeline2Response.Builder resBuilder =
            ...
            PatchCrmPipeline2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCrmPipeline2Request, to.unified.unified_java_sdk.models.operations.async.PatchCrmPipeline2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCrmPipeline2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCrmPipeline2Request.class, new TypeReference<PatchCrmPipeline2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCrmPipeline2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCrmPipeline2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCrmPipeline2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCrmPipeline2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCrmPipeline2Response res = resBuilder.build();
