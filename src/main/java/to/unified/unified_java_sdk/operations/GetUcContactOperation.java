...
public class GetUcContactOperation implements RequestOperation<GetUcContactRequest, GetUcContactResponse> {
    ...
    public GetUcContactOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetUcContactRequest request) throws Exception {
