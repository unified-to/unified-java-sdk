...
public class GetAccountingAgedpayable {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountingAgedpayableRequest, GetAccountingAgedpayableResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAccountingAgedpayableRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingAgedpayableRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountingAgedpayableRequest request) {
        ...
        @Override
        public GetAccountingAgedpayableResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAccountingAgedpayableResponse.Builder resBuilder =
                    GetAccountingAgedpayableResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetAccountingAgedpayableResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountingAgedpayable(Utils.unmarshal(response, new TypeReference<AccountingAgedpayable>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountingAgedpayableRequest, to.unified.unified_java_sdk.models.operations.async.GetAccountingAgedpayableResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountingAgedpayableRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountingAgedpayableRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountingAgedpayableRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAccountingAgedpayableResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAccountingAgedpayableResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAccountingAgedpayableResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAccountingAgedpayableResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountingAgedpayable>() {})
                            .thenApply(res::withAccountingAgedpayable);
                } else {
