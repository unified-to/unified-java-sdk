...
public class RemoveMartechMember2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveMartechMember2Request, RemoveMartechMember2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveMartechMember2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMartechMember2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveMartechMember2Request request) {
        ...
        @Override
        public RemoveMartechMember2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveMartechMember2Response.Builder resBuilder =
            ...
            RemoveMartechMember2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveMartechMember2Request, to.unified.unified_java_sdk.models.operations.async.RemoveMartechMember2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveMartechMember2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMartechMember2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveMartechMember2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveMartechMember2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveMartechMember2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveMartechMember2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveMartechMember2Response res = resBuilder.build();
