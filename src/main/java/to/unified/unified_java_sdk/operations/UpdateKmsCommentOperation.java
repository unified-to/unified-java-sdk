...
public class UpdateKmsCommentOperation implements RequestOperation<UpdateKmsCommentRequest, UpdateKmsCommentResponse> {
    ...
    public UpdateKmsCommentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateKmsCommentRequest request) throws Exception {
