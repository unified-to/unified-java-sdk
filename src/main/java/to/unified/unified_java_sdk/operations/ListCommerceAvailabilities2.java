...
import to.unified.unified_java_sdk.models.shared.CommerceAvailability;
...
public class ListCommerceAvailabilities2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceAvailabilities2Request, ListCommerceAvailabilities2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommerceAvailabilities2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceAvailabilities2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceAvailabilities2Request request) {
        ...
        @Override
        public ListCommerceAvailabilities2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceAvailabilities2Response.Builder resBuilder =
            ...
            ListCommerceAvailabilities2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceAvailabilities(Utils.unmarshal(response, new TypeReference<List<CommerceAvailability>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceAvailabilities2Request, to.unified.unified_java_sdk.models.operations.async.ListCommerceAvailabilities2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceAvailabilities2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceAvailabilities2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceAvailabilities2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceAvailabilities2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceAvailabilities2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceAvailabilities2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceAvailabilities2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CommerceAvailability>>() {})
                            .thenApply(res::withCommerceAvailabilities);
                } else {
