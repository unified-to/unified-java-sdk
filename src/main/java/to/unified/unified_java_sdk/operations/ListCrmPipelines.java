...
public class ListCrmPipelines {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCrmPipelinesRequest, ListCrmPipelinesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCrmPipelinesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmPipelinesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmPipelinesRequest request) {
        ...
        @Override
        public ListCrmPipelinesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCrmPipelinesResponse.Builder resBuilder =
            ...
            ListCrmPipelinesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCrmPipelinesRequest, to.unified.unified_java_sdk.models.operations.async.ListCrmPipelinesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCrmPipelinesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmPipelinesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCrmPipelinesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCrmPipelinesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCrmPipelinesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCrmPipelinesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCrmPipelinesResponse res = resBuilder.build();
