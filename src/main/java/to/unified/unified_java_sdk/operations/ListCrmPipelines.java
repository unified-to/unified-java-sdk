...
public class ListCrmPipelines {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmPipelinesRequest request) throws Exception {
        ...
        @Override
        public ListCrmPipelinesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CrmPipeline> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCrmPipelines(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
