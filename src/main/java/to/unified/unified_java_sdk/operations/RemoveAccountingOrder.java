...
public class RemoveAccountingOrder {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingOrderRequest, RemoveAccountingOrderResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingOrderRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingOrderRequest request) throws Exception {
        ...
        @Override
        public RemoveAccountingOrderResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingOrderResponse.Builder resBuilder =
            ...
            RemoveAccountingOrderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingOrderRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingOrderResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingOrderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingOrderRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingOrderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingOrderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingOrderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingOrderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingOrderResponse res = resBuilder.build();
