...
public class RemoveLmsCourse2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveLmsCourse2Request, RemoveLmsCourse2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveLmsCourse2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsCourse2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveLmsCourse2Request request) {
        ...
        @Override
        public RemoveLmsCourse2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveLmsCourse2Response.Builder resBuilder =
            ...
            RemoveLmsCourse2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveLmsCourse2Request, to.unified.unified_java_sdk.models.operations.async.RemoveLmsCourse2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveLmsCourse2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsCourse2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveLmsCourse2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveLmsCourse2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveLmsCourse2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveLmsCourse2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveLmsCourse2Response res = resBuilder.build();
