...
public class CreateStorageFileOperation implements RequestOperation<CreateStorageFileRequest, CreateStorageFileResponse> {
    ...
    public CreateStorageFileOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateStorageFileRequest request) throws Exception {
