...
public class ListClubsMembers2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListClubsMembers2Request, ListClubsMembers2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListClubsMembers2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsMembers2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListClubsMembers2Request request) {
        ...
        @Override
        public ListClubsMembers2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListClubsMembers2Response.Builder resBuilder =
            ...
            ListClubsMembers2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClubsMembers(Utils.unmarshal(response, new TypeReference<List<ClubsMember>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListClubsMembers2Request, to.unified.unified_java_sdk.models.operations.async.ListClubsMembers2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListClubsMembers2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListClubsMembers2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListClubsMembers2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListClubsMembers2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListClubsMembers2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListClubsMembers2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListClubsMembers2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ClubsMember>>() {})
                            .thenApply(res::withClubsMembers);
                } else {
