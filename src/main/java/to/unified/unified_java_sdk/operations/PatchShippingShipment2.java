...
public class PatchShippingShipment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchShippingShipment2Request, PatchShippingShipment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchShippingShipment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchShippingShipment2Request.class, new TypeReference<PatchShippingShipment2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchShippingShipment2Request request) {
        ...
        @Override
        public PatchShippingShipment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchShippingShipment2Response.Builder resBuilder =
            ...
            PatchShippingShipment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchShippingShipment2Request, to.unified.unified_java_sdk.models.operations.async.PatchShippingShipment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchShippingShipment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchShippingShipment2Request.class, new TypeReference<PatchShippingShipment2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchShippingShipment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchShippingShipment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchShippingShipment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchShippingShipment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchShippingShipment2Response res = resBuilder.build();
