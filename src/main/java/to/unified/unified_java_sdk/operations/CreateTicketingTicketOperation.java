...
public class CreateTicketingTicketOperation implements RequestOperation<CreateTicketingTicketRequest, CreateTicketingTicketResponse> {
    ...
    public CreateTicketingTicketOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateTicketingTicketRequest request) throws Exception {
