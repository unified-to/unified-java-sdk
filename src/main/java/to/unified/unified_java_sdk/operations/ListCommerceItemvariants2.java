...
public class ListCommerceItemvariants2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceItemvariants2Request, ListCommerceItemvariants2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommerceItemvariants2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceItemvariants2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceItemvariants2Request request) {
        ...
        @Override
        public ListCommerceItemvariants2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceItemvariants2Response.Builder resBuilder =
            ...
            ListCommerceItemvariants2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceItemvariants(Utils.unmarshal(response, new TypeReference<List<CommerceItemvariant>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceItemvariants2Request, to.unified.unified_java_sdk.models.operations.async.ListCommerceItemvariants2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceItemvariants2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceItemvariants2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceItemvariants2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceItemvariants2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceItemvariants2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceItemvariants2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceItemvariants2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CommerceItemvariant>>() {})
                            .thenApply(res::withCommerceItemvariants);
                } else {
