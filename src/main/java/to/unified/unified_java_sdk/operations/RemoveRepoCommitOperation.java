...
public class RemoveRepoCommitOperation implements RequestOperation<RemoveRepoCommitRequest, RemoveRepoCommitResponse> {
    ...
    public RemoveRepoCommitOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveRepoCommitRequest request) throws Exception {
