...
public class RemoveCalendarWebinar2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCalendarWebinar2Request, RemoveCalendarWebinar2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCalendarWebinar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCalendarWebinar2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCalendarWebinar2Request request) {
        ...
        @Override
        public RemoveCalendarWebinar2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCalendarWebinar2Response.Builder resBuilder =
            ...
            RemoveCalendarWebinar2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCalendarWebinar2Request, to.unified.unified_java_sdk.models.operations.async.RemoveCalendarWebinar2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCalendarWebinar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCalendarWebinar2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCalendarWebinar2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCalendarWebinar2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCalendarWebinar2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCalendarWebinar2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCalendarWebinar2Response res = resBuilder.build();
