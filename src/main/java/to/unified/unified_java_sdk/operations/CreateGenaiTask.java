...
public class CreateGenaiTask {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateGenaiTaskRequest, CreateGenaiTaskResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateGenaiTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateGenaiTaskRequest.class, new TypeReference<CreateGenaiTaskRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateGenaiTaskRequest request) {
        ...
        @Override
        public CreateGenaiTaskResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateGenaiTaskResponse.Builder resBuilder =
            ...
            CreateGenaiTaskResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGenaiTask(Utils.unmarshal(response, new TypeReference<GenaiTask>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateGenaiTaskRequest, to.unified.unified_java_sdk.models.operations.async.CreateGenaiTaskResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateGenaiTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateGenaiTaskRequest.class, new TypeReference<CreateGenaiTaskRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateGenaiTaskRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateGenaiTaskResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateGenaiTaskResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateGenaiTaskResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateGenaiTaskResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GenaiTask>() {})
                            .thenApply(res::withGenaiTask);
                } else {
