...
public class GetAdsOrganization2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAdsOrganization2Request, GetAdsOrganization2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAdsOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsOrganization2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAdsOrganization2Request request) {
        ...
        @Override
        public GetAdsOrganization2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAdsOrganization2Response.Builder resBuilder =
            ...
            GetAdsOrganization2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAdsOrganization2Request, to.unified.unified_java_sdk.models.operations.async.GetAdsOrganization2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAdsOrganization2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsOrganization2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAdsOrganization2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAdsOrganization2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAdsOrganization2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAdsOrganization2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAdsOrganization2Response res = resBuilder.build();
