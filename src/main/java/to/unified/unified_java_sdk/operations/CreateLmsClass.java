...
public class CreateLmsClass {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateLmsClassRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsClassRequest.class, new TypeReference<CreateLmsClassRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateLmsClassRequest request) {
        ...
        @Override
        public CreateLmsClassResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateLmsClassRequest, to.unified.unified_java_sdk.models.operations.async.CreateLmsClassResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateLmsClassRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateLmsClassRequest.class, new TypeReference<CreateLmsClassRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateLmsClassRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateLmsClassResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateLmsClassResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateLmsClassResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateLmsClassResponse res = resBuilder.build();
