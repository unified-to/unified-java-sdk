...
public class CreateMartechList2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateMartechList2Request, CreateMartechList2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateMartechList2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMartechList2Request.class, new TypeReference<CreateMartechList2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMartechList2Request request) {
        ...
        @Override
        public CreateMartechList2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateMartechList2Response.Builder resBuilder =
            ...
            CreateMartechList2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMarketingList(Utils.unmarshal(response, new TypeReference<MarketingList>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateMartechList2Request, to.unified.unified_java_sdk.models.operations.async.CreateMartechList2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateMartechList2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMartechList2Request.class, new TypeReference<CreateMartechList2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateMartechList2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateMartechList2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateMartechList2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateMartechList2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateMartechList2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MarketingList>() {})
                            .thenApply(res::withMarketingList);
                } else {
