...
public class ListHrisCompaniesOperation implements RequestOperation<ListHrisCompaniesRequest, ListHrisCompaniesResponse> {
    ...
    public ListHrisCompaniesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListHrisCompaniesRequest request) throws Exception {
