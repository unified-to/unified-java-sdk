...
public class UpdateSigningDocument2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateSigningDocument2Request, UpdateSigningDocument2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateSigningDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSigningDocument2Request.class, new TypeReference<UpdateSigningDocument2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateSigningDocument2Request request) {
        ...
        @Override
        public UpdateSigningDocument2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateSigningDocument2Response.Builder resBuilder =
            ...
            UpdateSigningDocument2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateSigningDocument2Request, to.unified.unified_java_sdk.models.operations.async.UpdateSigningDocument2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateSigningDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSigningDocument2Request.class, new TypeReference<UpdateSigningDocument2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateSigningDocument2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateSigningDocument2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateSigningDocument2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateSigningDocument2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateSigningDocument2Response res = resBuilder.build();
