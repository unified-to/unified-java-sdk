...
public class RemoveAtsCandidate {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAtsCandidateRequest, RemoveAtsCandidateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAtsCandidateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsCandidateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAtsCandidateRequest request) throws Exception {
        ...
        @Override
        public RemoveAtsCandidateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAtsCandidateResponse.Builder resBuilder =
            ...
            RemoveAtsCandidateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAtsCandidateRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAtsCandidateResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAtsCandidateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsCandidateRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAtsCandidateRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAtsCandidateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAtsCandidateResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAtsCandidateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAtsCandidateResponse res = resBuilder.build();
