...
public class ListAccountingTaxrates {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAccountingTaxratesRequest request) throws Exception {
        ...
        @Override
        public ListAccountingTaxratesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AccountingTaxrate> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAccountingTaxrates(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
