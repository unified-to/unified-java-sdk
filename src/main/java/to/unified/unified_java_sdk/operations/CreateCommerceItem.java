...
public class CreateCommerceItem {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceItemRequest request) throws Exception {
        ...
        @Override
        public CreateCommerceItemResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CommerceItem out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCommerceItem(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
