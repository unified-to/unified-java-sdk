...
public class CreateCommerceItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommerceItemRequest, CreateCommerceItemResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommerceItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceItemRequest.class, new TypeReference<CreateCommerceItemRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceItemRequest request) {
        ...
        @Override
        public CreateCommerceItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommerceItemResponse.Builder resBuilder =
            ...
            CreateCommerceItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommerceItemRequest, to.unified.unified_java_sdk.models.operations.async.CreateCommerceItemResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommerceItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceItemRequest.class, new TypeReference<CreateCommerceItemRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommerceItemRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCommerceItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCommerceItemResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCommerceItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCommerceItemResponse res = resBuilder.build();
