...
public class ListAnalyticsVisitors {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAnalyticsVisitorsRequest, ListAnalyticsVisitorsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAnalyticsVisitorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAnalyticsVisitorsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAnalyticsVisitorsRequest request) {
        ...
        @Override
        public ListAnalyticsVisitorsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAnalyticsVisitorsResponse.Builder resBuilder =
            ...
            ListAnalyticsVisitorsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAnalyticsVisitorsRequest, to.unified.unified_java_sdk.models.operations.async.ListAnalyticsVisitorsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAnalyticsVisitorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAnalyticsVisitorsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAnalyticsVisitorsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAnalyticsVisitorsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAnalyticsVisitorsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAnalyticsVisitorsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAnalyticsVisitorsResponse res = resBuilder.build();
