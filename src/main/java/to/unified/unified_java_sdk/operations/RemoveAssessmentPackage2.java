...
public class RemoveAssessmentPackage2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAssessmentPackage2Request, RemoveAssessmentPackage2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAssessmentPackage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAssessmentPackage2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAssessmentPackage2Request request) {
        ...
        @Override
        public RemoveAssessmentPackage2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAssessmentPackage2Response.Builder resBuilder =
            ...
            RemoveAssessmentPackage2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAssessmentPackage2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAssessmentPackage2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAssessmentPackage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAssessmentPackage2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAssessmentPackage2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAssessmentPackage2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAssessmentPackage2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAssessmentPackage2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAssessmentPackage2Response res = resBuilder.build();
