...
public class RemoveHrisTimeoff {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisTimeoffRequest, RemoveHrisTimeoffResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisTimeoffRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisTimeoffRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisTimeoffRequest request) {
        ...
        @Override
        public RemoveHrisTimeoffResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisTimeoffResponse.Builder resBuilder =
            ...
            RemoveHrisTimeoffResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisTimeoffRequest, to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeoffResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisTimeoffRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisTimeoffRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisTimeoffRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeoffResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeoffResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeoffResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeoffResponse res = resBuilder.build();
