...
public class ListHrisAttendances {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisAttendancesRequest, ListHrisAttendancesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisAttendancesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisAttendancesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisAttendancesRequest request) {
        ...
        @Override
        public ListHrisAttendancesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisAttendancesResponse.Builder resBuilder =
            ...
            ListHrisAttendancesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisAttendances(Utils.unmarshal(response, new TypeReference<List<HrisAttendance>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisAttendancesRequest, to.unified.unified_java_sdk.models.operations.async.ListHrisAttendancesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisAttendancesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisAttendancesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisAttendancesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisAttendancesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisAttendancesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisAttendancesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisAttendancesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<HrisAttendance>>() {})
                            .thenApply(res::withHrisAttendances);
                } else {
