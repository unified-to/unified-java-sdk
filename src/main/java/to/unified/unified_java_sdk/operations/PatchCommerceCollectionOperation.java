...
public class PatchCommerceCollectionOperation implements RequestOperation<PatchCommerceCollectionRequest, PatchCommerceCollectionResponse> {
    ...
    public PatchCommerceCollectionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchCommerceCollectionRequest request) throws Exception {
