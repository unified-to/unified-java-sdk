...
public class CreateAtsScorecardOperation implements RequestOperation<CreateAtsScorecardRequest, CreateAtsScorecardResponse> {
    ...
    public CreateAtsScorecardOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateAtsScorecardRequest request) throws Exception {
