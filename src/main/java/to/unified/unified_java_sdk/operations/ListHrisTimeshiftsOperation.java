...
public class ListHrisTimeshiftsOperation implements RequestOperation<ListHrisTimeshiftsRequest, ListHrisTimeshiftsResponse> {
    ...
    public ListHrisTimeshiftsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListHrisTimeshiftsRequest request) throws Exception {
