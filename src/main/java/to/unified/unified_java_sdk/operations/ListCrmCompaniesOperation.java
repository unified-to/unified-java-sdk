...
public class ListCrmCompaniesOperation implements RequestOperation<ListCrmCompaniesRequest, ListCrmCompaniesResponse> {
    ...
    public ListCrmCompaniesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListCrmCompaniesRequest request) throws Exception {
