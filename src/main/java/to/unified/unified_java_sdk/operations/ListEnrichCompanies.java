...
public class ListEnrichCompanies {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListEnrichCompaniesRequest request) throws Exception {
        ...
        @Override
        public ListEnrichCompaniesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    EnrichCompany out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEnrichCompany(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
