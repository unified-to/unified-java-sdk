...
public class ListEnrichCompanies {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListEnrichCompaniesRequest, ListEnrichCompaniesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListEnrichCompaniesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEnrichCompaniesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListEnrichCompaniesRequest request) {
        ...
        @Override
        public ListEnrichCompaniesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListEnrichCompaniesResponse.Builder resBuilder =
            ...
            ListEnrichCompaniesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListEnrichCompaniesRequest, to.unified.unified_java_sdk.models.operations.async.ListEnrichCompaniesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListEnrichCompaniesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEnrichCompaniesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListEnrichCompaniesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListEnrichCompaniesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListEnrichCompaniesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListEnrichCompaniesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListEnrichCompaniesResponse res = resBuilder.build();
