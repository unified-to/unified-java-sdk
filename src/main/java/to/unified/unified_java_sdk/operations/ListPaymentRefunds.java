...
public class ListPaymentRefunds {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentRefundsRequest request) throws Exception {
        ...
        @Override
        public ListPaymentRefundsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<PaymentRefund> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentRefunds(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
