...
public class ListPaymentRefunds {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPaymentRefundsRequest, ListPaymentRefundsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPaymentRefundsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentRefundsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentRefundsRequest request) {
        ...
        @Override
        public ListPaymentRefundsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPaymentRefundsResponse.Builder resBuilder =
            ...
            ListPaymentRefundsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentRefundsRequest, to.unified.unified_java_sdk.models.operations.async.ListPaymentRefundsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPaymentRefundsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentRefundsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPaymentRefundsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListPaymentRefundsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListPaymentRefundsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListPaymentRefundsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListPaymentRefundsResponse res = resBuilder.build();
