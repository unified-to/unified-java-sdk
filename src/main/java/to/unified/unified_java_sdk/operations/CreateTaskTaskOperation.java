...
public class CreateTaskTaskOperation implements RequestOperation<CreateTaskTaskRequest, CreateTaskTaskResponse> {
    ...
    public CreateTaskTaskOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateTaskTaskRequest request) throws Exception {
