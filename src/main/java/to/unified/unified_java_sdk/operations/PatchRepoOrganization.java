...
public class PatchRepoOrganization {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchRepoOrganizationRequest, PatchRepoOrganizationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchRepoOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoOrganizationRequest.class, new TypeReference<PatchRepoOrganizationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchRepoOrganizationRequest request) {
        ...
        @Override
        public PatchRepoOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchRepoOrganizationResponse.Builder resBuilder =
            ...
            PatchRepoOrganizationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchRepoOrganizationRequest, to.unified.unified_java_sdk.models.operations.async.PatchRepoOrganizationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchRepoOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchRepoOrganizationRequest.class, new TypeReference<PatchRepoOrganizationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchRepoOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchRepoOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchRepoOrganizationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchRepoOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchRepoOrganizationResponse res = resBuilder.build();
