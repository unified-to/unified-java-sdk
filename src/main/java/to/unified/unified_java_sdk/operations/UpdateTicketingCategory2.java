...
public class UpdateTicketingCategory2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTicketingCategory2Request, UpdateTicketingCategory2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTicketingCategory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketingCategory2Request.class, new TypeReference<UpdateTicketingCategory2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTicketingCategory2Request request) {
        ...
        @Override
        public UpdateTicketingCategory2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTicketingCategory2Response.Builder resBuilder =
            ...
            UpdateTicketingCategory2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateTicketingCategory2Request, to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCategory2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateTicketingCategory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketingCategory2Request.class, new TypeReference<UpdateTicketingCategory2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateTicketingCategory2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCategory2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCategory2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCategory2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateTicketingCategory2Response res = resBuilder.build();
