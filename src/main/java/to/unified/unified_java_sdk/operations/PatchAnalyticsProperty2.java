...
public class PatchAnalyticsProperty2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAnalyticsProperty2Request, PatchAnalyticsProperty2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAnalyticsProperty2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAnalyticsProperty2Request.class, new TypeReference<PatchAnalyticsProperty2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAnalyticsProperty2Request request) {
        ...
        @Override
        public PatchAnalyticsProperty2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAnalyticsProperty2Response.Builder resBuilder =
            ...
            PatchAnalyticsProperty2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAnalyticsProperty2Request, to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsProperty2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAnalyticsProperty2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAnalyticsProperty2Request.class, new TypeReference<PatchAnalyticsProperty2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAnalyticsProperty2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsProperty2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsProperty2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsProperty2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsProperty2Response res = resBuilder.build();
