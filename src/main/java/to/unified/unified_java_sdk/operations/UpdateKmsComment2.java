...
public class UpdateKmsComment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateKmsComment2Request, UpdateKmsComment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateKmsComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateKmsComment2Request.class, new TypeReference<UpdateKmsComment2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateKmsComment2Request request) {
        ...
        @Override
        public UpdateKmsComment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateKmsComment2Response.Builder resBuilder =
            ...
            UpdateKmsComment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateKmsComment2Request, to.unified.unified_java_sdk.models.operations.async.UpdateKmsComment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateKmsComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateKmsComment2Request.class, new TypeReference<UpdateKmsComment2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateKmsComment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateKmsComment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateKmsComment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateKmsComment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateKmsComment2Response res = resBuilder.build();
