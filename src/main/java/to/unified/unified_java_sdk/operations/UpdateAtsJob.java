...
public class UpdateAtsJob {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAtsJobRequest, UpdateAtsJobResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAtsJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsJobRequest.class, new TypeReference<UpdateAtsJobRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsJobRequest request) {
        ...
        @Override
        public UpdateAtsJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAtsJobResponse.Builder resBuilder =
            ...
            UpdateAtsJobResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAtsJobRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAtsJobResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAtsJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsJobRequest.class, new TypeReference<UpdateAtsJobRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAtsJobRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAtsJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAtsJobResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAtsJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAtsJobResponse res = resBuilder.build();
