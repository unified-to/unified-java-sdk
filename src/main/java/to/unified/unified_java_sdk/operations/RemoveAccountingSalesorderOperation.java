...
public class RemoveAccountingSalesorderOperation implements RequestOperation<RemoveAccountingSalesorderRequest, RemoveAccountingSalesorderResponse> {
    ...
    public RemoveAccountingSalesorderOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAccountingSalesorderRequest request) throws Exception {
