...
public class ListSocialPosts {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSocialPostsRequest, ListSocialPostsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSocialPostsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSocialPostsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSocialPostsRequest request) {
        ...
        @Override
        public ListSocialPostsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSocialPostsResponse.Builder resBuilder =
            ...
            ListSocialPostsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSocialPosts(Utils.unmarshal(response, new TypeReference<List<SocialPost>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSocialPostsRequest, to.unified.unified_java_sdk.models.operations.async.ListSocialPostsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSocialPostsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSocialPostsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSocialPostsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListSocialPostsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListSocialPostsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListSocialPostsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListSocialPostsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<SocialPost>>() {})
                            .thenApply(res::withSocialPosts);
                } else {
