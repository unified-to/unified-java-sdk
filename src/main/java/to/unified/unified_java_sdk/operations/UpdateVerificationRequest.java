...
public class UpdateVerificationRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateVerificationRequestRequest, UpdateVerificationRequestResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateVerificationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateVerificationRequestRequest.class, new TypeReference<UpdateVerificationRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateVerificationRequestRequest request) {
        ...
        @Override
        public UpdateVerificationRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateVerificationRequestResponse.Builder resBuilder =
            ...
            UpdateVerificationRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateVerificationRequestRequest, to.unified.unified_java_sdk.models.operations.async.UpdateVerificationRequestResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateVerificationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateVerificationRequestRequest.class, new TypeReference<UpdateVerificationRequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateVerificationRequestRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateVerificationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateVerificationRequestResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateVerificationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateVerificationRequestResponse res = resBuilder.build();
