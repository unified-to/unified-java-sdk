...
public class CreateMartechMember2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateMartechMember2Request, CreateMartechMember2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateMartechMember2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMartechMember2Request.class, new TypeReference<CreateMartechMember2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMartechMember2Request request) {
        ...
        @Override
        public CreateMartechMember2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateMartechMember2Response.Builder resBuilder =
            ...
            CreateMartechMember2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMarketingMember(Utils.unmarshal(response, new TypeReference<MarketingMember>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateMartechMember2Request, to.unified.unified_java_sdk.models.operations.async.CreateMartechMember2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateMartechMember2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMartechMember2Request.class, new TypeReference<CreateMartechMember2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateMartechMember2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateMartechMember2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateMartechMember2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateMartechMember2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateMartechMember2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MarketingMember>() {})
                            .thenApply(res::withMarketingMember);
                } else {
