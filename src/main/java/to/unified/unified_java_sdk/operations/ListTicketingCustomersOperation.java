...
public class ListTicketingCustomersOperation implements RequestOperation<ListTicketingCustomersRequest, ListTicketingCustomersResponse> {
    ...
    public ListTicketingCustomersOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListTicketingCustomersRequest request) throws Exception {
