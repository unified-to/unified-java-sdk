...
public class CreateUnifiedWorkspaceSecretsmanager {
    ...
    public static class Sync extends Base
            implements RequestOperation<SecretsManager, CreateUnifiedWorkspaceSecretsmanagerResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(SecretsManager request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<SecretsManager>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SecretsManager request) {
        ...
        @Override
        public CreateUnifiedWorkspaceSecretsmanagerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateUnifiedWorkspaceSecretsmanagerResponse.Builder resBuilder =
            ...
            CreateUnifiedWorkspaceSecretsmanagerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SecretsManager, to.unified.unified_java_sdk.models.operations.async.CreateUnifiedWorkspaceSecretsmanagerResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(SecretsManager request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<SecretsManager>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SecretsManager request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateUnifiedWorkspaceSecretsmanagerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateUnifiedWorkspaceSecretsmanagerResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateUnifiedWorkspaceSecretsmanagerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateUnifiedWorkspaceSecretsmanagerResponse res = resBuilder.build();
