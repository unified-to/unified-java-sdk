...
public class PatchCdpEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCdpEventRequest, PatchCdpEventResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCdpEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCdpEventRequest.class, new TypeReference<PatchCdpEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCdpEventRequest request) {
        ...
        @Override
        public PatchCdpEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCdpEventResponse.Builder resBuilder =
            ...
            PatchCdpEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCdpEventRequest, to.unified.unified_java_sdk.models.operations.async.PatchCdpEventResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCdpEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCdpEventRequest.class, new TypeReference<PatchCdpEventRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCdpEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCdpEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCdpEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCdpEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCdpEventResponse res = resBuilder.build();
