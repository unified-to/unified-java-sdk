...
public class RemoveHrisLocationOperation implements RequestOperation<RemoveHrisLocationRequest, RemoveHrisLocationResponse> {
    ...
    public RemoveHrisLocationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveHrisLocationRequest request) throws Exception {
