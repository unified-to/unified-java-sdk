...
public class CreateCalendarEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCalendarEventRequest, CreateCalendarEventResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCalendarEventRequest request) {
        ...
        @Override
        public CreateCalendarEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCalendarEventResponse.Builder resBuilder =
            ...
            CreateCalendarEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCalendarEventRequest, to.unified.unified_java_sdk.models.operations.async.CreateCalendarEventResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCalendarEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCalendarEventRequest.class, new TypeReference<CreateCalendarEventRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCalendarEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCalendarEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCalendarEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCalendarEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCalendarEventResponse res = resBuilder.build();
