...
public class CreateCalendarCalendarOperation implements RequestOperation<CreateCalendarCalendarRequest, CreateCalendarCalendarResponse> {
    ...
    public CreateCalendarCalendarOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateCalendarCalendarRequest request) throws Exception {
