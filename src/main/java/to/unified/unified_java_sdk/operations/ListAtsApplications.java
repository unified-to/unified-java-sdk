...
public class ListAtsApplications {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAtsApplicationsRequest, ListAtsApplicationsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAtsApplicationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsApplicationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsApplicationsRequest request) {
        ...
        @Override
        public ListAtsApplicationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsApplicationsResponse.Builder resBuilder =
            ...
            ListAtsApplicationsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsApplicationsRequest, to.unified.unified_java_sdk.models.operations.async.ListAtsApplicationsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsApplicationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsApplicationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsApplicationsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsApplicationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsApplicationsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsApplicationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsApplicationsResponse res = resBuilder.build();
