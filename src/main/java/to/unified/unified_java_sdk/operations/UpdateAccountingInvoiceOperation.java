...
public class UpdateAccountingInvoiceOperation implements RequestOperation<UpdateAccountingInvoiceRequest, UpdateAccountingInvoiceResponse> {
    ...
    public UpdateAccountingInvoiceOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAccountingInvoiceRequest request) throws Exception {
