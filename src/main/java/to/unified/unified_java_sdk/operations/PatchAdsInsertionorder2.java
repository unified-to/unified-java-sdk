...
public class PatchAdsInsertionorder2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAdsInsertionorder2Request, PatchAdsInsertionorder2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAdsInsertionorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsInsertionorder2Request.class, new TypeReference<PatchAdsInsertionorder2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAdsInsertionorder2Request request) {
        ...
        @Override
        public PatchAdsInsertionorder2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAdsInsertionorder2Response.Builder resBuilder =
            ...
            PatchAdsInsertionorder2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAdsInsertionorder2Request, to.unified.unified_java_sdk.models.operations.async.PatchAdsInsertionorder2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAdsInsertionorder2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAdsInsertionorder2Request.class, new TypeReference<PatchAdsInsertionorder2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAdsInsertionorder2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAdsInsertionorder2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAdsInsertionorder2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAdsInsertionorder2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAdsInsertionorder2Response res = resBuilder.build();
