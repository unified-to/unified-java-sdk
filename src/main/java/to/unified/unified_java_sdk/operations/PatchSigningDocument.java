...
public class PatchSigningDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchSigningDocumentRequest, PatchSigningDocumentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchSigningDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchSigningDocumentRequest.class, new TypeReference<PatchSigningDocumentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchSigningDocumentRequest request) {
        ...
        @Override
        public PatchSigningDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchSigningDocumentResponse.Builder resBuilder =
            ...
            PatchSigningDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchSigningDocumentRequest, to.unified.unified_java_sdk.models.operations.async.PatchSigningDocumentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchSigningDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchSigningDocumentRequest.class, new TypeReference<PatchSigningDocumentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchSigningDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchSigningDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchSigningDocumentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchSigningDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchSigningDocumentResponse res = resBuilder.build();
