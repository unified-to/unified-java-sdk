...
public class GetLmsCollection {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLmsCollectionRequest, GetLmsCollectionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLmsCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsCollectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLmsCollectionRequest request) {
        ...
        @Override
        public GetLmsCollectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLmsCollectionResponse.Builder resBuilder =
            ...
            GetLmsCollectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLmsCollectionRequest, to.unified.unified_java_sdk.models.operations.async.GetLmsCollectionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLmsCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsCollectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLmsCollectionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetLmsCollectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetLmsCollectionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetLmsCollectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetLmsCollectionResponse res = resBuilder.build();
