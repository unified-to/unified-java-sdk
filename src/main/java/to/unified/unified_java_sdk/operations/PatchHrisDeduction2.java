...
public class PatchHrisDeduction2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisDeduction2Request, PatchHrisDeduction2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisDeduction2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisDeduction2Request.class, new TypeReference<PatchHrisDeduction2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisDeduction2Request request) {
        ...
        @Override
        public PatchHrisDeduction2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisDeduction2Response.Builder resBuilder =
            ...
            PatchHrisDeduction2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisDeduction2Request, to.unified.unified_java_sdk.models.operations.async.PatchHrisDeduction2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisDeduction2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisDeduction2Request.class, new TypeReference<PatchHrisDeduction2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisDeduction2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisDeduction2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisDeduction2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisDeduction2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisDeduction2Response res = resBuilder.build();
