...
public class PatchGenaiAgent {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchGenaiAgentRequest, PatchGenaiAgentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchGenaiAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchGenaiAgentRequest.class, new TypeReference<PatchGenaiAgentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchGenaiAgentRequest request) {
        ...
        @Override
        public PatchGenaiAgentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchGenaiAgentResponse.Builder resBuilder =
            ...
            PatchGenaiAgentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchGenaiAgentRequest, to.unified.unified_java_sdk.models.operations.async.PatchGenaiAgentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchGenaiAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchGenaiAgentRequest.class, new TypeReference<PatchGenaiAgentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchGenaiAgentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchGenaiAgentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchGenaiAgentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchGenaiAgentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchGenaiAgentResponse res = resBuilder.build();
