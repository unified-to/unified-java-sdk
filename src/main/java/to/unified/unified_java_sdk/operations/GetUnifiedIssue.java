...
public class GetUnifiedIssue {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUnifiedIssueRequest, GetUnifiedIssueResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetUnifiedIssueRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUnifiedIssueRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUnifiedIssueRequest request) {
        ...
        @Override
        public GetUnifiedIssueResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUnifiedIssueResponse.Builder resBuilder =
            ...
            GetUnifiedIssueResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withIssue(Utils.unmarshal(response, new TypeReference<Issue>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUnifiedIssueRequest, to.unified.unified_java_sdk.models.operations.async.GetUnifiedIssueResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetUnifiedIssueRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUnifiedIssueRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUnifiedIssueRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetUnifiedIssueResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetUnifiedIssueResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetUnifiedIssueResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetUnifiedIssueResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Issue>() {})
                            .thenApply(res::withIssue);
                } else {
