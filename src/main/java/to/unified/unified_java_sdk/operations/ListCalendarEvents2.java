...
public class ListCalendarEvents2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCalendarEvents2Request, ListCalendarEvents2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCalendarEvents2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarEvents2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarEvents2Request request) {
        ...
        @Override
        public ListCalendarEvents2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCalendarEvents2Response.Builder resBuilder =
            ...
            ListCalendarEvents2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCalendarEvents(Utils.unmarshal(response, new TypeReference<List<CalendarEvent>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCalendarEvents2Request, to.unified.unified_java_sdk.models.operations.async.ListCalendarEvents2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCalendarEvents2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarEvents2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCalendarEvents2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCalendarEvents2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCalendarEvents2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCalendarEvents2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCalendarEvents2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CalendarEvent>>() {})
                            .thenApply(res::withCalendarEvents);
                } else {
