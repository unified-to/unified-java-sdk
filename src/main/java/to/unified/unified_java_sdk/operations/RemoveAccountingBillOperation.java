...
public class RemoveAccountingBillOperation implements RequestOperation<RemoveAccountingBillRequest, RemoveAccountingBillResponse> {
    ...
    public RemoveAccountingBillOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveAccountingBillRequest request) throws Exception {
