...
public class ListAtsApplicationsOperation implements RequestOperation<ListAtsApplicationsRequest, ListAtsApplicationsResponse> {
    ...
    public ListAtsApplicationsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAtsApplicationsRequest request) throws Exception {
