...
public class UpdateUnifiedWebhookOperation implements RequestOperation<UpdateUnifiedWebhookRequest, UpdateUnifiedWebhookResponse> {
    ...
    public UpdateUnifiedWebhookOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateUnifiedWebhookRequest request) throws Exception {
