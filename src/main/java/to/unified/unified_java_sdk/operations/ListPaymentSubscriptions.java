...
public class ListPaymentSubscriptions {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPaymentSubscriptionsRequest, ListPaymentSubscriptionsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPaymentSubscriptionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentSubscriptionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentSubscriptionsRequest request) {
        ...
        @Override
        public ListPaymentSubscriptionsResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentSubscriptionsRequest, to.unified.unified_java_sdk.models.operations.async.ListPaymentSubscriptionsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPaymentSubscriptionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentSubscriptionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPaymentSubscriptionsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListPaymentSubscriptionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListPaymentSubscriptionsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListPaymentSubscriptionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListPaymentSubscriptionsResponse res = resBuilder.build();
