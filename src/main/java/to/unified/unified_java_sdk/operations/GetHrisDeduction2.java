...
public class GetHrisDeduction2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisDeduction2Request, GetHrisDeduction2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisDeduction2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisDeduction2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisDeduction2Request request) {
        ...
        @Override
        public GetHrisDeduction2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisDeduction2Response.Builder resBuilder =
            ...
            GetHrisDeduction2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisDeduction2Request, to.unified.unified_java_sdk.models.operations.async.GetHrisDeduction2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisDeduction2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisDeduction2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisDeduction2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisDeduction2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisDeduction2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisDeduction2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisDeduction2Response res = resBuilder.build();
