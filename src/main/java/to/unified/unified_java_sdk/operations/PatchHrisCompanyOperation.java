...
public class PatchHrisCompanyOperation implements RequestOperation<PatchHrisCompanyRequest, PatchHrisCompanyResponse> {
    ...
    public PatchHrisCompanyOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchHrisCompanyRequest request) throws Exception {
