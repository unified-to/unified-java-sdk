...
public class ListMartechMembers2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMartechMembers2Request, ListMartechMembers2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListMartechMembers2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListMartechMembers2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMartechMembers2Request request) {
        ...
        @Override
        public ListMartechMembers2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMartechMembers2Response.Builder resBuilder =
            ...
            ListMartechMembers2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMarketingMembers(Utils.unmarshal(response, new TypeReference<List<MarketingMember>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMartechMembers2Request, to.unified.unified_java_sdk.models.operations.async.ListMartechMembers2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMartechMembers2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListMartechMembers2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMartechMembers2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListMartechMembers2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListMartechMembers2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListMartechMembers2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListMartechMembers2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<MarketingMember>>() {})
                            .thenApply(res::withMarketingMembers);
                } else {
