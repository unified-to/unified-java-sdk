...
public class GetScimUsers {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetScimUsersRequest, GetScimUsersResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetScimUsersRequest request) {
        ...
        @Override
        public GetScimUsersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetScimUsersResponse.Builder resBuilder =
            ...
            GetScimUsersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetScimUsersRequest, to.unified.unified_java_sdk.models.operations.async.GetScimUsersResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetScimUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetScimUsersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetScimUsersRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetScimUsersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetScimUsersResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetScimUsersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetScimUsersResponse res = resBuilder.build();
