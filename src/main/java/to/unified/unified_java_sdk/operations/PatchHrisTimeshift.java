...
public class PatchHrisTimeshift {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisTimeshiftRequest, PatchHrisTimeshiftResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisTimeshiftRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisTimeshiftRequest.class, new TypeReference<PatchHrisTimeshiftRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisTimeshiftRequest request) {
        ...
        @Override
        public PatchHrisTimeshiftResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisTimeshiftResponse.Builder resBuilder =
            ...
            PatchHrisTimeshiftResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisTimeshiftRequest, to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeshiftResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisTimeshiftRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisTimeshiftRequest.class, new TypeReference<PatchHrisTimeshiftRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisTimeshiftRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeshiftResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeshiftResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeshiftResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisTimeshiftResponse res = resBuilder.build();
