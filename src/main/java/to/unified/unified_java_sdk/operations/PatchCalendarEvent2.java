...
public class PatchCalendarEvent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCalendarEvent2Request, PatchCalendarEvent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCalendarEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCalendarEvent2Request.class, new TypeReference<PatchCalendarEvent2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCalendarEvent2Request request) {
        ...
        @Override
        public PatchCalendarEvent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCalendarEvent2Response.Builder resBuilder =
            ...
            PatchCalendarEvent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCalendarEvent2Request, to.unified.unified_java_sdk.models.operations.async.PatchCalendarEvent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCalendarEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCalendarEvent2Request.class, new TypeReference<PatchCalendarEvent2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCalendarEvent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCalendarEvent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCalendarEvent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCalendarEvent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCalendarEvent2Response res = resBuilder.build();
