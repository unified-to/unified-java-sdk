...
public class CreateRepoPullrequestOperation implements RequestOperation<CreateRepoPullrequestRequest, CreateRepoPullrequestResponse> {
    ...
    public CreateRepoPullrequestOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateRepoPullrequestRequest request) throws Exception {
