...
public class ListAdsAds {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsAdsRequest, ListAdsAdsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsAdsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsAdsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsAdsRequest request) {
        ...
        @Override
        public ListAdsAdsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsAdsResponse.Builder resBuilder =
                    ListAdsAdsResponse
                            .builder()
            ...
            ListAdsAdsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsAdsRequest, to.unified.unified_java_sdk.models.operations.async.ListAdsAdsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsAdsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsAdsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsAdsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsAdsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsAdsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsAdsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsAdsResponse res = resBuilder.build();
