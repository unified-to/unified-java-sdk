...
public class CreateCrmPipeline {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCrmPipelineRequest request) throws Exception {
        ...
        @Override
        public CreateCrmPipelineResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CrmPipeline out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCrmPipeline(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
