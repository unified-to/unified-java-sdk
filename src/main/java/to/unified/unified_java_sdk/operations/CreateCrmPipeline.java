...
public class CreateCrmPipeline {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCrmPipelineRequest, CreateCrmPipelineResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCrmPipelineRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmPipelineRequest.class, new TypeReference<CreateCrmPipelineRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCrmPipelineRequest request) {
        ...
        @Override
        public CreateCrmPipelineResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCrmPipelineResponse.Builder resBuilder =
            ...
            CreateCrmPipelineResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCrmPipelineRequest, to.unified.unified_java_sdk.models.operations.async.CreateCrmPipelineResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCrmPipelineRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmPipelineRequest.class, new TypeReference<CreateCrmPipelineRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCrmPipelineRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCrmPipelineResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCrmPipelineResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCrmPipelineResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCrmPipelineResponse res = resBuilder.build();
