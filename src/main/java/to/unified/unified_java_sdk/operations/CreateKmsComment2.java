...
public class CreateKmsComment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateKmsComment2Request, CreateKmsComment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateKmsComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateKmsComment2Request.class, new TypeReference<CreateKmsComment2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateKmsComment2Request request) {
        ...
        @Override
        public CreateKmsComment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateKmsComment2Response.Builder resBuilder =
            ...
            CreateKmsComment2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withKmsComment(Utils.unmarshal(response, new TypeReference<KmsComment>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateKmsComment2Request, to.unified.unified_java_sdk.models.operations.async.CreateKmsComment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateKmsComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateKmsComment2Request.class, new TypeReference<CreateKmsComment2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateKmsComment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateKmsComment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateKmsComment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateKmsComment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateKmsComment2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<KmsComment>() {})
                            .thenApply(res::withKmsComment);
                } else {
