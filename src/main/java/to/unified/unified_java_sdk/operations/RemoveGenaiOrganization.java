...
public class RemoveGenaiOrganization {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveGenaiOrganizationRequest, RemoveGenaiOrganizationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveGenaiOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveGenaiOrganizationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveGenaiOrganizationRequest request) {
        ...
        @Override
        public RemoveGenaiOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveGenaiOrganizationResponse.Builder resBuilder =
            ...
            RemoveGenaiOrganizationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveGenaiOrganizationRequest, to.unified.unified_java_sdk.models.operations.async.RemoveGenaiOrganizationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveGenaiOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveGenaiOrganizationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveGenaiOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveGenaiOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveGenaiOrganizationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveGenaiOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveGenaiOrganizationResponse res = resBuilder.build();
