...
public class GetCalendarRecordingOperation implements RequestOperation<GetCalendarRecordingRequest, GetCalendarRecordingResponse> {
    ...
    public GetCalendarRecordingOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetCalendarRecordingRequest request) throws Exception {
