...
public class CreateHrisTimeshift2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisTimeshift2Request, CreateHrisTimeshift2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisTimeshift2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisTimeshift2Request.class, new TypeReference<CreateHrisTimeshift2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisTimeshift2Request request) {
        ...
        @Override
        public CreateHrisTimeshift2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisTimeshift2Response.Builder resBuilder =
            ...
            CreateHrisTimeshift2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisTimeshift2Request, to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeshift2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisTimeshift2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisTimeshift2Request.class, new TypeReference<CreateHrisTimeshift2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisTimeshift2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeshift2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeshift2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeshift2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeshift2Response res = resBuilder.build();
