...
public class PatchPassthrough2Raw {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchPassthrough2RawRequest, PatchPassthrough2RawResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchPassthrough2RawRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPassthrough2RawRequest.class, new TypeReference<PatchPassthrough2RawRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchPassthrough2RawRequest request) {
        ...
        @Override
        public PatchPassthrough2RawResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchPassthrough2RawResponse.Builder resBuilder =
            ...
            PatchPassthrough2RawResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchPassthrough2RawRequest, to.unified.unified_java_sdk.models.operations.async.PatchPassthrough2RawResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchPassthrough2RawRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchPassthrough2RawRequest.class, new TypeReference<PatchPassthrough2RawRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchPassthrough2RawRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchPassthrough2RawResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchPassthrough2RawResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchPassthrough2RawResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            to.unified.unified_java_sdk.models.operations.async.PatchPassthrough2RawResponse res = resBuilder.build();
