...
public class CreateCalendarCalendar2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCalendarCalendar2Request, CreateCalendarCalendar2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCalendarCalendar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCalendarCalendar2Request.class, new TypeReference<CreateCalendarCalendar2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCalendarCalendar2Request request) {
        ...
        @Override
        public CreateCalendarCalendar2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCalendarCalendar2Response.Builder resBuilder =
            ...
            CreateCalendarCalendar2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCalendarCalendar2Request, to.unified.unified_java_sdk.models.operations.async.CreateCalendarCalendar2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCalendarCalendar2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCalendarCalendar2Request.class, new TypeReference<CreateCalendarCalendar2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCalendarCalendar2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCalendarCalendar2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCalendarCalendar2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCalendarCalendar2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCalendarCalendar2Response res = resBuilder.build();
