...
public class UpdateHrisDeduction2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisDeduction2Request, UpdateHrisDeduction2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisDeduction2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisDeduction2Request.class, new TypeReference<UpdateHrisDeduction2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisDeduction2Request request) {
        ...
        @Override
        public UpdateHrisDeduction2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisDeduction2Response.Builder resBuilder =
            ...
            UpdateHrisDeduction2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisDeduction(Utils.unmarshal(response, new TypeReference<HrisDeduction>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisDeduction2Request, to.unified.unified_java_sdk.models.operations.async.UpdateHrisDeduction2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisDeduction2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisDeduction2Request.class, new TypeReference<UpdateHrisDeduction2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisDeduction2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisDeduction2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisDeduction2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisDeduction2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisDeduction2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HrisDeduction>() {})
                            .thenApply(res::withHrisDeduction);
                } else {
