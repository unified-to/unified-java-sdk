...
public class RemoveRepoOrganizationOperation implements RequestOperation<RemoveRepoOrganizationRequest, RemoveRepoOrganizationResponse> {
    ...
    public RemoveRepoOrganizationOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveRepoOrganizationRequest request) throws Exception {
