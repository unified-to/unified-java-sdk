...
public class RemoveLmsClass2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveLmsClass2Request, RemoveLmsClass2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveLmsClass2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsClass2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveLmsClass2Request request) {
        ...
        @Override
        public RemoveLmsClass2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveLmsClass2Response.Builder resBuilder =
            ...
            RemoveLmsClass2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveLmsClass2Request, to.unified.unified_java_sdk.models.operations.async.RemoveLmsClass2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveLmsClass2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveLmsClass2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveLmsClass2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveLmsClass2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveLmsClass2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveLmsClass2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveLmsClass2Response res = resBuilder.build();
