...
public class ListCrmLeads {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmLeadsRequest request) throws Exception {
        ...
        @Override
        public ListCrmLeadsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CrmLead> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCrmLeads(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
