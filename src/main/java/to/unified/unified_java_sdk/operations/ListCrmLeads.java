...
public class ListCrmLeads {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCrmLeadsRequest, ListCrmLeadsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCrmLeadsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmLeadsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmLeadsRequest request) {
        ...
        @Override
        public ListCrmLeadsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCrmLeadsResponse.Builder resBuilder =
            ...
            ListCrmLeadsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCrmLeadsRequest, to.unified.unified_java_sdk.models.operations.async.ListCrmLeadsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCrmLeadsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmLeadsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCrmLeadsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCrmLeadsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCrmLeadsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCrmLeadsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCrmLeadsResponse res = resBuilder.build();
