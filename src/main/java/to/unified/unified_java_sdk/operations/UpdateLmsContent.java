...
public class UpdateLmsContent {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLmsContentRequest, UpdateLmsContentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateLmsContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsContentRequest.class, new TypeReference<UpdateLmsContentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLmsContentRequest request) {
        ...
        @Override
        public UpdateLmsContentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateLmsContentResponse.Builder resBuilder =
            ...
            UpdateLmsContentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLmsContentRequest, to.unified.unified_java_sdk.models.operations.async.UpdateLmsContentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLmsContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsContentRequest.class, new TypeReference<UpdateLmsContentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLmsContentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateLmsContentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateLmsContentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateLmsContentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateLmsContentResponse res = resBuilder.build();
