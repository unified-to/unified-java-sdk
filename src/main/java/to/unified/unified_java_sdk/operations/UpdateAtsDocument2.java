...
public class UpdateAtsDocument2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAtsDocument2Request, UpdateAtsDocument2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAtsDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsDocument2Request.class, new TypeReference<UpdateAtsDocument2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAtsDocument2Request request) {
        ...
        @Override
        public UpdateAtsDocument2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAtsDocument2Response.Builder resBuilder =
            ...
            UpdateAtsDocument2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAtsDocument(Utils.unmarshal(response, new TypeReference<AtsDocument>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAtsDocument2Request, to.unified.unified_java_sdk.models.operations.async.UpdateAtsDocument2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAtsDocument2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAtsDocument2Request.class, new TypeReference<UpdateAtsDocument2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAtsDocument2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAtsDocument2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAtsDocument2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAtsDocument2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAtsDocument2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AtsDocument>() {})
                            .thenApply(res::withAtsDocument);
                } else {
