...
public class UpdateShippingShipment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateShippingShipment2Request, UpdateShippingShipment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateShippingShipment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateShippingShipment2Request.class, new TypeReference<UpdateShippingShipment2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateShippingShipment2Request request) {
        ...
        @Override
        public UpdateShippingShipment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateShippingShipment2Response.Builder resBuilder =
            ...
            UpdateShippingShipment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateShippingShipment2Request, to.unified.unified_java_sdk.models.operations.async.UpdateShippingShipment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateShippingShipment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateShippingShipment2Request.class, new TypeReference<UpdateShippingShipment2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateShippingShipment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateShippingShipment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateShippingShipment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateShippingShipment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateShippingShipment2Response res = resBuilder.build();
