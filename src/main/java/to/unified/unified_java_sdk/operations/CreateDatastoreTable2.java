...
public class CreateDatastoreTable2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateDatastoreTable2Request, CreateDatastoreTable2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateDatastoreTable2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDatastoreTable2Request.class, new TypeReference<CreateDatastoreTable2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDatastoreTable2Request request) {
        ...
        @Override
        public CreateDatastoreTable2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDatastoreTable2Response.Builder resBuilder =
            ...
            CreateDatastoreTable2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDatastoreTable(Utils.unmarshal(response, new TypeReference<DatastoreTable>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateDatastoreTable2Request, to.unified.unified_java_sdk.models.operations.async.CreateDatastoreTable2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateDatastoreTable2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDatastoreTable2Request.class, new TypeReference<CreateDatastoreTable2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateDatastoreTable2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateDatastoreTable2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateDatastoreTable2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateDatastoreTable2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateDatastoreTable2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DatastoreTable>() {})
                            .thenApply(res::withDatastoreTable);
                } else {
