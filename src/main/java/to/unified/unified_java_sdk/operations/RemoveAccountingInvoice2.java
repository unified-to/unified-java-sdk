...
public class RemoveAccountingInvoice2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingInvoice2Request, RemoveAccountingInvoice2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingInvoice2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingInvoice2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingInvoice2Request request) {
        ...
        @Override
        public RemoveAccountingInvoice2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingInvoice2Response.Builder resBuilder =
            ...
            RemoveAccountingInvoice2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingInvoice2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingInvoice2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingInvoice2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingInvoice2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingInvoice2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingInvoice2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingInvoice2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingInvoice2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingInvoice2Response res = resBuilder.build();
