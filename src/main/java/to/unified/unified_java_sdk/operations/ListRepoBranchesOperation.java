...
public class ListRepoBranchesOperation implements RequestOperation<ListRepoBranchesRequest, ListRepoBranchesResponse> {
    ...
    public ListRepoBranchesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListRepoBranchesRequest request) throws Exception {
