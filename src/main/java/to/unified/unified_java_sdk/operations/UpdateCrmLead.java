...
public class UpdateCrmLead {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCrmLeadRequest, UpdateCrmLeadResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCrmLeadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmLeadRequest.class, new TypeReference<UpdateCrmLeadRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCrmLeadRequest request) {
        ...
        @Override
        public UpdateCrmLeadResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCrmLeadRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCrmLeadResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCrmLeadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmLeadRequest.class, new TypeReference<UpdateCrmLeadRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCrmLeadRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCrmLeadResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCrmLeadResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCrmLeadResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCrmLeadResponse res = resBuilder.build();
