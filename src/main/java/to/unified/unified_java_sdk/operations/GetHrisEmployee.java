...
public class GetHrisEmployee {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisEmployeeRequest, GetHrisEmployeeResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisEmployeeRequest request) {
        ...
        @Override
        public GetHrisEmployeeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisEmployeeResponse.Builder resBuilder =
            ...
            GetHrisEmployeeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisEmployeeRequest, to.unified.unified_java_sdk.models.operations.async.GetHrisEmployeeResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisEmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisEmployeeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisEmployeeRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisEmployeeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisEmployeeResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisEmployeeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisEmployeeResponse res = resBuilder.build();
