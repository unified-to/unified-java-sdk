...
public class UpdateCommerceReviewOperation implements RequestOperation<UpdateCommerceReviewRequest, UpdateCommerceReviewResponse> {
    ...
    public UpdateCommerceReviewOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateCommerceReviewRequest request) throws Exception {
