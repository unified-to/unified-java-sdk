...
public class GetCalendarEventOperation implements RequestOperation<GetCalendarEventRequest, GetCalendarEventResponse> {
    ...
    public GetCalendarEventOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetCalendarEventRequest request) throws Exception {
