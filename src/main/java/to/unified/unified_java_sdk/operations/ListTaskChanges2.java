...
public class ListTaskChanges2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTaskChanges2Request, ListTaskChanges2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListTaskChanges2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaskChanges2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTaskChanges2Request request) {
        ...
        @Override
        public ListTaskChanges2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListTaskChanges2Response.Builder resBuilder =
            ...
            ListTaskChanges2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTaskChanges(Utils.unmarshal(response, new TypeReference<List<TaskChange>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTaskChanges2Request, to.unified.unified_java_sdk.models.operations.async.ListTaskChanges2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListTaskChanges2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaskChanges2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTaskChanges2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListTaskChanges2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListTaskChanges2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListTaskChanges2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListTaskChanges2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<TaskChange>>() {})
                            .thenApply(res::withTaskChanges);
                } else {
