...
public class PatchHrisCompany2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchHrisCompany2Request, PatchHrisCompany2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchHrisCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisCompany2Request.class, new TypeReference<PatchHrisCompany2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchHrisCompany2Request request) {
        ...
        @Override
        public PatchHrisCompany2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchHrisCompany2Response.Builder resBuilder =
            ...
            PatchHrisCompany2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchHrisCompany2Request, to.unified.unified_java_sdk.models.operations.async.PatchHrisCompany2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchHrisCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchHrisCompany2Request.class, new TypeReference<PatchHrisCompany2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchHrisCompany2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchHrisCompany2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchHrisCompany2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchHrisCompany2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchHrisCompany2Response res = resBuilder.build();
