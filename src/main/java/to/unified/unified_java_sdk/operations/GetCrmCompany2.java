...
public class GetCrmCompany2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCrmCompany2Request, GetCrmCompany2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCrmCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmCompany2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCrmCompany2Request request) {
        ...
        @Override
        public GetCrmCompany2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCrmCompany2Response.Builder resBuilder =
            ...
            GetCrmCompany2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCrmCompany2Request, to.unified.unified_java_sdk.models.operations.async.GetCrmCompany2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCrmCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmCompany2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCrmCompany2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCrmCompany2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCrmCompany2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCrmCompany2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCrmCompany2Response res = resBuilder.build();
