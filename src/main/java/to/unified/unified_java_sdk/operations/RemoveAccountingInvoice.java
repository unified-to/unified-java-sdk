...
public class RemoveAccountingInvoice {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingInvoiceRequest, RemoveAccountingInvoiceResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(RemoveAccountingInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingInvoiceRequest.class);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingInvoiceRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingInvoiceResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingInvoiceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingInvoiceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingInvoiceRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingInvoiceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingInvoiceResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingInvoiceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingInvoiceResponse res = resBuilder.build();
