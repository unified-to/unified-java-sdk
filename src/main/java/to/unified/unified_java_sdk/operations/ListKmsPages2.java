...
public class ListKmsPages2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListKmsPages2Request, ListKmsPages2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListKmsPages2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListKmsPages2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListKmsPages2Request request) {
        ...
        @Override
        public ListKmsPages2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListKmsPages2Response.Builder resBuilder =
            ...
            ListKmsPages2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withKmsPages(Utils.unmarshal(response, new TypeReference<List<KmsPage>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListKmsPages2Request, to.unified.unified_java_sdk.models.operations.async.ListKmsPages2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListKmsPages2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListKmsPages2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListKmsPages2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListKmsPages2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListKmsPages2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListKmsPages2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListKmsPages2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<KmsPage>>() {})
                            .thenApply(res::withKmsPages);
                } else {
