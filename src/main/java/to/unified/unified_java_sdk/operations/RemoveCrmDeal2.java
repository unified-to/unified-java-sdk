...
public class RemoveCrmDeal2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCrmDeal2Request, RemoveCrmDeal2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCrmDeal2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmDeal2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCrmDeal2Request request) {
        ...
        @Override
        public RemoveCrmDeal2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCrmDeal2Response.Builder resBuilder =
            ...
            RemoveCrmDeal2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCrmDeal2Request, to.unified.unified_java_sdk.models.operations.async.RemoveCrmDeal2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCrmDeal2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmDeal2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCrmDeal2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCrmDeal2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCrmDeal2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCrmDeal2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCrmDeal2Response res = resBuilder.build();
