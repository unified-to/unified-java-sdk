...
public class PatchCommerceItem2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCommerceItem2Request, PatchCommerceItem2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCommerceItem2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceItem2Request.class, new TypeReference<PatchCommerceItem2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCommerceItem2Request request) {
        ...
        @Override
        public PatchCommerceItem2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCommerceItem2Response.Builder resBuilder =
            ...
            PatchCommerceItem2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCommerceItem2Request, to.unified.unified_java_sdk.models.operations.async.PatchCommerceItem2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCommerceItem2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceItem2Request.class, new TypeReference<PatchCommerceItem2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCommerceItem2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCommerceItem2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCommerceItem2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCommerceItem2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCommerceItem2Response res = resBuilder.build();
