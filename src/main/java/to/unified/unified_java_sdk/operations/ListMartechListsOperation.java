...
public class ListMartechListsOperation implements RequestOperation<ListMartechListsRequest, ListMartechListsResponse> {
    ...
    public ListMartechListsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListMartechListsRequest request) throws Exception {
