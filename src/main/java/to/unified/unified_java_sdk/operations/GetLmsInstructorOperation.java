...
public class GetLmsInstructorOperation implements RequestOperation<GetLmsInstructorRequest, GetLmsInstructorResponse> {
    ...
    public GetLmsInstructorOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetLmsInstructorRequest request) throws Exception {
