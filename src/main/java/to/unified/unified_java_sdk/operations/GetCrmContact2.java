...
public class GetCrmContact2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCrmContact2Request, GetCrmContact2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCrmContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmContact2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCrmContact2Request request) {
        ...
        @Override
        public GetCrmContact2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCrmContact2Response.Builder resBuilder =
            ...
            GetCrmContact2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCrmContact2Request, to.unified.unified_java_sdk.models.operations.async.GetCrmContact2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCrmContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetCrmContact2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCrmContact2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCrmContact2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCrmContact2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCrmContact2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCrmContact2Response res = resBuilder.build();
