...
public class ListRepoOrganizations2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRepoOrganizations2Request, ListRepoOrganizations2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListRepoOrganizations2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoOrganizations2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRepoOrganizations2Request request) {
        ...
        @Override
        public ListRepoOrganizations2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListRepoOrganizations2Response.Builder resBuilder =
            ...
            ListRepoOrganizations2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRepoOrganizations(Utils.unmarshal(response, new TypeReference<List<RepoOrganization>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListRepoOrganizations2Request, to.unified.unified_java_sdk.models.operations.async.ListRepoOrganizations2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListRepoOrganizations2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoOrganizations2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRepoOrganizations2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListRepoOrganizations2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListRepoOrganizations2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListRepoOrganizations2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListRepoOrganizations2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<RepoOrganization>>() {})
                            .thenApply(res::withRepoOrganizations);
                } else {
