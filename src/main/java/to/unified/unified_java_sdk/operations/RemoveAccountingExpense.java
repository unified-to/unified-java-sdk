...
public class RemoveAccountingExpense {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingExpenseRequest, RemoveAccountingExpenseResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingExpenseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingExpenseRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingExpenseRequest request) {
        ...
        @Override
        public RemoveAccountingExpenseResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingExpenseResponse.Builder resBuilder =
            ...
            RemoveAccountingExpenseResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingExpenseRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingExpenseResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingExpenseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingExpenseRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingExpenseRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingExpenseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingExpenseResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingExpenseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingExpenseResponse res = resBuilder.build();
