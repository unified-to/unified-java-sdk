...
public class PatchKmsPage2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchKmsPage2Request, PatchKmsPage2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchKmsPage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchKmsPage2Request.class, new TypeReference<PatchKmsPage2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchKmsPage2Request request) {
        ...
        @Override
        public PatchKmsPage2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchKmsPage2Response.Builder resBuilder =
            ...
            PatchKmsPage2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchKmsPage2Request, to.unified.unified_java_sdk.models.operations.async.PatchKmsPage2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchKmsPage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchKmsPage2Request.class, new TypeReference<PatchKmsPage2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchKmsPage2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchKmsPage2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchKmsPage2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchKmsPage2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchKmsPage2Response res = resBuilder.build();
