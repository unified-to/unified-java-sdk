...
public class GetAssessmentPackage2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAssessmentPackage2Request, GetAssessmentPackage2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAssessmentPackage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAssessmentPackage2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAssessmentPackage2Request request) {
        ...
        @Override
        public GetAssessmentPackage2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAssessmentPackage2Response.Builder resBuilder =
            ...
            GetAssessmentPackage2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAssessmentPackage2Request, to.unified.unified_java_sdk.models.operations.async.GetAssessmentPackage2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAssessmentPackage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAssessmentPackage2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAssessmentPackage2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAssessmentPackage2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAssessmentPackage2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAssessmentPackage2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAssessmentPackage2Response res = resBuilder.build();
