...
public class UpdateGenaiOrganization {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateGenaiOrganizationRequest, UpdateGenaiOrganizationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateGenaiOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateGenaiOrganizationRequest.class, new TypeReference<UpdateGenaiOrganizationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateGenaiOrganizationRequest request) {
        ...
        @Override
        public UpdateGenaiOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateGenaiOrganizationResponse.Builder resBuilder =
                    UpdateGenaiOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            UpdateGenaiOrganizationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGenaiOrganization(Utils.unmarshal(response, new TypeReference<GenaiOrganization>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateGenaiOrganizationRequest, to.unified.unified_java_sdk.models.operations.async.UpdateGenaiOrganizationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateGenaiOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateGenaiOrganizationRequest.class, new TypeReference<UpdateGenaiOrganizationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateGenaiOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateGenaiOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateGenaiOrganizationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateGenaiOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateGenaiOrganizationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GenaiOrganization>() {})
                            .thenApply(res::withGenaiOrganization);
                } else {
