...
public class GetClubsMember2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetClubsMember2Request, GetClubsMember2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetClubsMember2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsMember2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClubsMember2Request request) {
        ...
        @Override
        public GetClubsMember2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetClubsMember2Response.Builder resBuilder =
            ...
            GetClubsMember2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClubsMember(Utils.unmarshal(response, new TypeReference<ClubsMember>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetClubsMember2Request, to.unified.unified_java_sdk.models.operations.async.GetClubsMember2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetClubsMember2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsMember2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetClubsMember2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetClubsMember2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetClubsMember2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetClubsMember2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetClubsMember2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ClubsMember>() {})
                            .thenApply(res::withClubsMember);
                } else {
