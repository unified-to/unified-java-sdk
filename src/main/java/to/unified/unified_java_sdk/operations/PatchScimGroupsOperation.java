...
public class PatchScimGroupsOperation implements RequestOperation<PatchScimGroupsRequest, PatchScimGroupsResponse> {
    ...
    public PatchScimGroupsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchScimGroupsRequest request) throws Exception {
