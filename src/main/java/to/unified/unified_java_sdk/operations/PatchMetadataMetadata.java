...
public class PatchMetadataMetadata {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchMetadataMetadataRequest, PatchMetadataMetadataResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchMetadataMetadataRequest request) {
        ...
        @Override
        public PatchMetadataMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchMetadataMetadataResponse.Builder resBuilder =
            ...
            PatchMetadataMetadataResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchMetadataMetadataRequest, to.unified.unified_java_sdk.models.operations.async.PatchMetadataMetadataResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchMetadataMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMetadataMetadataRequest.class, new TypeReference<PatchMetadataMetadataRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchMetadataMetadataRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchMetadataMetadataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchMetadataMetadataResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchMetadataMetadataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchMetadataMetadataResponse res = resBuilder.build();
