...
public class PatchRepoCommitOperation implements RequestOperation<PatchRepoCommitRequest, PatchRepoCommitResponse> {
    ...
    public PatchRepoCommitOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchRepoCommitRequest request) throws Exception {
