...
public class CreateCommerceSaleschannel {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommerceSaleschannelRequest, CreateCommerceSaleschannelResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommerceSaleschannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceSaleschannelRequest.class, new TypeReference<CreateCommerceSaleschannelRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceSaleschannelRequest request) {
        ...
        @Override
        public CreateCommerceSaleschannelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommerceSaleschannelResponse.Builder resBuilder =
            ...
            CreateCommerceSaleschannelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommerceSaleschannelRequest, to.unified.unified_java_sdk.models.operations.async.CreateCommerceSaleschannelResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommerceSaleschannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceSaleschannelRequest.class, new TypeReference<CreateCommerceSaleschannelRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommerceSaleschannelRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCommerceSaleschannelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCommerceSaleschannelResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCommerceSaleschannelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCommerceSaleschannelResponse res = resBuilder.build();
