...
public class RemoveCrmCompany2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCrmCompany2Request, RemoveCrmCompany2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveCrmCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmCompany2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCrmCompany2Request request) {
        ...
        @Override
        public RemoveCrmCompany2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCrmCompany2Response.Builder resBuilder =
            ...
            RemoveCrmCompany2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCrmCompany2Request, to.unified.unified_java_sdk.models.operations.async.RemoveCrmCompany2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCrmCompany2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCrmCompany2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCrmCompany2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCrmCompany2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCrmCompany2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCrmCompany2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCrmCompany2Response res = resBuilder.build();
