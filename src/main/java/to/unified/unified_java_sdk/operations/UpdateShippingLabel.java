...
public class UpdateShippingLabel {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateShippingLabelRequest, UpdateShippingLabelResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateShippingLabelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateShippingLabelRequest.class, new TypeReference<UpdateShippingLabelRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateShippingLabelRequest request) {
        ...
        @Override
        public UpdateShippingLabelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateShippingLabelResponse.Builder resBuilder =
            ...
            UpdateShippingLabelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateShippingLabelRequest, to.unified.unified_java_sdk.models.operations.async.UpdateShippingLabelResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateShippingLabelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateShippingLabelRequest.class, new TypeReference<UpdateShippingLabelRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateShippingLabelRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateShippingLabelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateShippingLabelResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateShippingLabelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateShippingLabelResponse res = resBuilder.build();
