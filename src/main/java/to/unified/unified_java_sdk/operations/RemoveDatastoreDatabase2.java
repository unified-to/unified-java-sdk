...
public class RemoveDatastoreDatabase2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveDatastoreDatabase2Request, RemoveDatastoreDatabase2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveDatastoreDatabase2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDatastoreDatabase2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveDatastoreDatabase2Request request) {
        ...
        @Override
        public RemoveDatastoreDatabase2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveDatastoreDatabase2Response.Builder resBuilder =
            ...
            RemoveDatastoreDatabase2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveDatastoreDatabase2Request, to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreDatabase2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveDatastoreDatabase2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDatastoreDatabase2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveDatastoreDatabase2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreDatabase2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreDatabase2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreDatabase2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveDatastoreDatabase2Response res = resBuilder.build();
