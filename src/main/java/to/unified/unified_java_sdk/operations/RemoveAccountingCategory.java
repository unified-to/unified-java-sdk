...
public class RemoveAccountingCategory {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingCategoryRequest, RemoveAccountingCategoryResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingCategoryRequest request) throws Exception {
        ...
        @Override
        public RemoveAccountingCategoryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingCategoryResponse.Builder resBuilder =
            ...
            RemoveAccountingCategoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingCategoryRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingCategoryResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingCategoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingCategoryRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingCategoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingCategoryResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingCategoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingCategoryResponse res = resBuilder.build();
