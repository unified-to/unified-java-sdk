...
public class PatchTicketingTicket2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchTicketingTicket2Request, PatchTicketingTicket2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchTicketingTicket2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTicketingTicket2Request.class, new TypeReference<PatchTicketingTicket2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchTicketingTicket2Request request) {
        ...
        @Override
        public PatchTicketingTicket2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchTicketingTicket2Response.Builder resBuilder =
            ...
            PatchTicketingTicket2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchTicketingTicket2Request, to.unified.unified_java_sdk.models.operations.async.PatchTicketingTicket2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchTicketingTicket2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchTicketingTicket2Request.class, new TypeReference<PatchTicketingTicket2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchTicketingTicket2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchTicketingTicket2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchTicketingTicket2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchTicketingTicket2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchTicketingTicket2Response res = resBuilder.build();
