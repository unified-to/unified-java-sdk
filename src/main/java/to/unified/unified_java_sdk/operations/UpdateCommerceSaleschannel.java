...
public class UpdateCommerceSaleschannel {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommerceSaleschannelRequest, UpdateCommerceSaleschannelResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCommerceSaleschannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceSaleschannelRequest.class, new TypeReference<UpdateCommerceSaleschannelRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceSaleschannelRequest request) {
        ...
        @Override
        public UpdateCommerceSaleschannelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommerceSaleschannelResponse.Builder resBuilder =
            ...
            UpdateCommerceSaleschannelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommerceSaleschannelRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCommerceSaleschannelResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommerceSaleschannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceSaleschannelRequest.class, new TypeReference<UpdateCommerceSaleschannelRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommerceSaleschannelRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCommerceSaleschannelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceSaleschannelResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCommerceSaleschannelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceSaleschannelResponse res = resBuilder.build();
