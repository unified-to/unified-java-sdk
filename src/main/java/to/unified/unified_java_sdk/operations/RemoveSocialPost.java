...
public class RemoveSocialPost {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveSocialPostRequest, RemoveSocialPostResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveSocialPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveSocialPostRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveSocialPostRequest request) {
        ...
        @Override
        public RemoveSocialPostResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveSocialPostResponse.Builder resBuilder =
            ...
            RemoveSocialPostResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveSocialPostRequest, to.unified.unified_java_sdk.models.operations.async.RemoveSocialPostResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveSocialPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveSocialPostRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveSocialPostRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveSocialPostResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveSocialPostResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveSocialPostResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveSocialPostResponse res = resBuilder.build();
