...
public class ListCommerceSaleschannels2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceSaleschannels2Request, ListCommerceSaleschannels2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommerceSaleschannels2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceSaleschannels2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceSaleschannels2Request request) {
        ...
        @Override
        public ListCommerceSaleschannels2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceSaleschannels2Response.Builder resBuilder =
            ...
            ListCommerceSaleschannels2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCommerceSaleschannels(Utils.unmarshal(response, new TypeReference<List<CommerceSaleschannel>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceSaleschannels2Request, to.unified.unified_java_sdk.models.operations.async.ListCommerceSaleschannels2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceSaleschannels2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceSaleschannels2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceSaleschannels2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceSaleschannels2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceSaleschannels2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceSaleschannels2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceSaleschannels2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CommerceSaleschannel>>() {})
                            .thenApply(res::withCommerceSaleschannels);
                } else {
