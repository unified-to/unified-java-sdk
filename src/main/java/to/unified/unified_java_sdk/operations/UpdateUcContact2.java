...
public class UpdateUcContact2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateUcContact2Request, UpdateUcContact2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateUcContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUcContact2Request.class, new TypeReference<UpdateUcContact2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateUcContact2Request request) {
        ...
        @Override
        public UpdateUcContact2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateUcContact2Response.Builder resBuilder =
            ...
            UpdateUcContact2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateUcContact2Request, to.unified.unified_java_sdk.models.operations.async.UpdateUcContact2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateUcContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUcContact2Request.class, new TypeReference<UpdateUcContact2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateUcContact2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateUcContact2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateUcContact2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateUcContact2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateUcContact2Response res = resBuilder.build();
