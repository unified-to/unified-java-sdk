...
public class CreateRepoOrganization {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateRepoOrganizationRequest, CreateRepoOrganizationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateRepoOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoOrganizationRequest.class, new TypeReference<CreateRepoOrganizationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateRepoOrganizationRequest request) {
        ...
        @Override
        public CreateRepoOrganizationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateRepoOrganizationResponse.Builder resBuilder =
            ...
            CreateRepoOrganizationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateRepoOrganizationRequest, to.unified.unified_java_sdk.models.operations.async.CreateRepoOrganizationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateRepoOrganizationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateRepoOrganizationRequest.class, new TypeReference<CreateRepoOrganizationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateRepoOrganizationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateRepoOrganizationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateRepoOrganizationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateRepoOrganizationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateRepoOrganizationResponse res = resBuilder.build();
