...
public class PatchLmsCollection2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchLmsCollection2Request, PatchLmsCollection2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchLmsCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsCollection2Request.class, new TypeReference<PatchLmsCollection2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchLmsCollection2Request request) {
        ...
        @Override
        public PatchLmsCollection2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchLmsCollection2Response.Builder resBuilder =
            ...
            PatchLmsCollection2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchLmsCollection2Request, to.unified.unified_java_sdk.models.operations.async.PatchLmsCollection2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchLmsCollection2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchLmsCollection2Request.class, new TypeReference<PatchLmsCollection2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchLmsCollection2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchLmsCollection2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchLmsCollection2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchLmsCollection2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchLmsCollection2Response res = resBuilder.build();
