...
public class GetAccountingTransactionOperation implements RequestOperation<GetAccountingTransactionRequest, GetAccountingTransactionResponse> {
    ...
    public GetAccountingTransactionOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountingTransactionRequest request) throws Exception {
