...
public class ListAdsCreatives2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdsCreatives2Request, ListAdsCreatives2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdsCreatives2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsCreatives2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdsCreatives2Request request) {
        ...
        @Override
        public ListAdsCreatives2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAdsCreatives2Response.Builder resBuilder =
            ...
            ListAdsCreatives2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdsCreatives(Utils.unmarshal(response, new TypeReference<List<AdsCreative>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdsCreatives2Request, to.unified.unified_java_sdk.models.operations.async.ListAdsCreatives2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdsCreatives2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdsCreatives2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdsCreatives2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAdsCreatives2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAdsCreatives2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAdsCreatives2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAdsCreatives2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AdsCreative>>() {})
                            .thenApply(res::withAdsCreatives);
                } else {
