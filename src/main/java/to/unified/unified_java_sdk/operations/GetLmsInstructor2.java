...
public class GetLmsInstructor2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLmsInstructor2Request, GetLmsInstructor2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLmsInstructor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsInstructor2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLmsInstructor2Request request) {
        ...
        @Override
        public GetLmsInstructor2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLmsInstructor2Response.Builder resBuilder =
            ...
            GetLmsInstructor2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLmsInstructor2Request, to.unified.unified_java_sdk.models.operations.async.GetLmsInstructor2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLmsInstructor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsInstructor2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLmsInstructor2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetLmsInstructor2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetLmsInstructor2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetLmsInstructor2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetLmsInstructor2Response res = resBuilder.build();
