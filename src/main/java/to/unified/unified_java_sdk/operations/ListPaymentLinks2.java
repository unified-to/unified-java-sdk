...
public class ListPaymentLinks2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPaymentLinks2Request, ListPaymentLinks2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPaymentLinks2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentLinks2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPaymentLinks2Request request) {
        ...
        @Override
        public ListPaymentLinks2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPaymentLinks2Response.Builder resBuilder =
            ...
            ListPaymentLinks2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentLinks2Request, to.unified.unified_java_sdk.models.operations.async.ListPaymentLinks2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPaymentLinks2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListPaymentLinks2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPaymentLinks2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListPaymentLinks2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListPaymentLinks2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListPaymentLinks2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListPaymentLinks2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<PaymentLink>>() {})
