...
public class ListLmsCourses {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListLmsCoursesRequest, ListLmsCoursesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListLmsCoursesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsCoursesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsCoursesRequest request) {
        ...
        @Override
        public ListLmsCoursesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListLmsCoursesResponse.Builder resBuilder =
            ...
            ListLmsCoursesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLmsCoursesRequest, to.unified.unified_java_sdk.models.operations.async.ListLmsCoursesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListLmsCoursesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLmsCoursesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListLmsCoursesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListLmsCoursesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListLmsCoursesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListLmsCoursesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListLmsCoursesResponse res = resBuilder.build();
