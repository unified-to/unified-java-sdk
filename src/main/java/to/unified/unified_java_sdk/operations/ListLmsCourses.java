...
public class ListLmsCourses {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLmsCoursesRequest request) throws Exception {
        ...
        @Override
        public ListLmsCoursesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<LmsCourse> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withLmsCourses(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
