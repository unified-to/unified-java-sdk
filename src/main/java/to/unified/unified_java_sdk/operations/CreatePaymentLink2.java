...
public class CreatePaymentLink2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePaymentLink2Request, CreatePaymentLink2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreatePaymentLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentLink2Request.class, new TypeReference<CreatePaymentLink2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePaymentLink2Request request) {
        ...
        @Override
        public CreatePaymentLink2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePaymentLink2Response.Builder resBuilder =
            ...
            CreatePaymentLink2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePaymentLink2Request, to.unified.unified_java_sdk.models.operations.async.CreatePaymentLink2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreatePaymentLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentLink2Request.class, new TypeReference<CreatePaymentLink2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePaymentLink2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreatePaymentLink2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreatePaymentLink2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreatePaymentLink2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreatePaymentLink2Response res = resBuilder.build();
