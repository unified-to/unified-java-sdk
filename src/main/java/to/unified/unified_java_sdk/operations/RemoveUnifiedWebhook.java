...
public class RemoveUnifiedWebhook {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveUnifiedWebhookRequest, RemoveUnifiedWebhookResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(RemoveUnifiedWebhookRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUnifiedWebhookRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveUnifiedWebhookRequest request) throws Exception {
        ...
        @Override
        public RemoveUnifiedWebhookResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveUnifiedWebhookResponse.Builder resBuilder =
            ...
            RemoveUnifiedWebhookResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveUnifiedWebhookRequest, to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedWebhookResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveUnifiedWebhookRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUnifiedWebhookRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveUnifiedWebhookRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedWebhookResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedWebhookResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedWebhookResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedWebhookResponse res = resBuilder.build();
