...
public class UpdateLmsCourse {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLmsCourseRequest, UpdateLmsCourseResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateLmsCourseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsCourseRequest.class, new TypeReference<UpdateLmsCourseRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLmsCourseRequest request) {
        ...
        @Override
        public UpdateLmsCourseResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLmsCourseRequest, to.unified.unified_java_sdk.models.operations.async.UpdateLmsCourseResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLmsCourseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsCourseRequest.class, new TypeReference<UpdateLmsCourseRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLmsCourseRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateLmsCourseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateLmsCourseResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateLmsCourseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateLmsCourseResponse res = resBuilder.build();
