...
public class ListAtsCompanies {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAtsCompaniesRequest, ListAtsCompaniesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAtsCompaniesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsCompaniesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsCompaniesRequest request) {
        ...
        @Override
        public ListAtsCompaniesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListAtsCompaniesResponse.Builder resBuilder =
            ...
            ListAtsCompaniesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAtsCompaniesRequest, to.unified.unified_java_sdk.models.operations.async.ListAtsCompaniesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAtsCompaniesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAtsCompaniesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAtsCompaniesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListAtsCompaniesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListAtsCompaniesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListAtsCompaniesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListAtsCompaniesResponse res = resBuilder.build();
