...
public class ListAtsCompanies {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAtsCompaniesRequest request) throws Exception {
        ...
        @Override
        public ListAtsCompaniesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<AtsCompany> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAtsCompanies(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
