...
public class UpdateAdsCampaign {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAdsCampaignRequest, UpdateAdsCampaignResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAdsCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsCampaignRequest.class, new TypeReference<UpdateAdsCampaignRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAdsCampaignRequest request) {
        ...
        @Override
        public UpdateAdsCampaignResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAdsCampaignResponse.Builder resBuilder =
            ...
            UpdateAdsCampaignResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAdsCampaignRequest, to.unified.unified_java_sdk.models.operations.async.UpdateAdsCampaignResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAdsCampaignRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAdsCampaignRequest.class, new TypeReference<UpdateAdsCampaignRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAdsCampaignRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateAdsCampaignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateAdsCampaignResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateAdsCampaignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateAdsCampaignResponse res = resBuilder.build();
