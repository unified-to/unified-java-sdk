...
public class CreatePaymentSubscription2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePaymentSubscription2Request, CreatePaymentSubscription2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreatePaymentSubscription2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentSubscription2Request.class, new TypeReference<CreatePaymentSubscription2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePaymentSubscription2Request request) {
        ...
        @Override
        public CreatePaymentSubscription2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePaymentSubscription2Response.Builder resBuilder =
            ...
            CreatePaymentSubscription2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentSubscription(Utils.unmarshal(response, new TypeReference<PaymentSubscription>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePaymentSubscription2Request, to.unified.unified_java_sdk.models.operations.async.CreatePaymentSubscription2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreatePaymentSubscription2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePaymentSubscription2Request.class, new TypeReference<CreatePaymentSubscription2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePaymentSubscription2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreatePaymentSubscription2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreatePaymentSubscription2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreatePaymentSubscription2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreatePaymentSubscription2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaymentSubscription>() {})
                            .thenApply(res::withPaymentSubscription);
                } else {
