...
public class ListCrmEvents {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmEventsRequest request) throws Exception {
        ...
        @Override
        public ListCrmEventsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CrmEvent> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCrmEvents(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
