...
public class ListCrmEvents {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCrmEventsRequest, ListCrmEventsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCrmEventsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmEventsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCrmEventsRequest request) {
        ...
        @Override
        public ListCrmEventsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCrmEventsResponse.Builder resBuilder =
            ...
            ListCrmEventsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCrmEventsRequest, to.unified.unified_java_sdk.models.operations.async.ListCrmEventsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCrmEventsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCrmEventsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCrmEventsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCrmEventsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCrmEventsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCrmEventsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCrmEventsResponse res = resBuilder.build();
