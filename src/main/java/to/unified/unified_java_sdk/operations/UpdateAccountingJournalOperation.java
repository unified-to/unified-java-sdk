...
public class UpdateAccountingJournalOperation implements RequestOperation<UpdateAccountingJournalRequest, UpdateAccountingJournalResponse> {
    ...
    public UpdateAccountingJournalOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateAccountingJournalRequest request) throws Exception {
