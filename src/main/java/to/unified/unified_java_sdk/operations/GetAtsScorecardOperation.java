...
public class GetAtsScorecardOperation implements RequestOperation<GetAtsScorecardRequest, GetAtsScorecardResponse> {
    ...
    public GetAtsScorecardOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAtsScorecardRequest request) throws Exception {
