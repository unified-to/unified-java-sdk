...
public class RemoveHrisTimeshift2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisTimeshift2Request, RemoveHrisTimeshift2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisTimeshift2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisTimeshift2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisTimeshift2Request request) {
        ...
        @Override
        public RemoveHrisTimeshift2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisTimeshift2Response.Builder resBuilder =
            ...
            RemoveHrisTimeshift2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisTimeshift2Request, to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeshift2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisTimeshift2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisTimeshift2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisTimeshift2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeshift2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeshift2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeshift2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisTimeshift2Response res = resBuilder.build();
