...
public class CreateTaskProject {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTaskProjectRequest, CreateTaskProjectResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateTaskProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTaskProjectRequest.class, new TypeReference<CreateTaskProjectRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTaskProjectRequest request) {
        ...
        @Override
        public CreateTaskProjectResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTaskProjectResponse.Builder resBuilder =
            ...
            CreateTaskProjectResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTaskProjectRequest, to.unified.unified_java_sdk.models.operations.async.CreateTaskProjectResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTaskProjectRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTaskProjectRequest.class, new TypeReference<CreateTaskProjectRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTaskProjectRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateTaskProjectResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateTaskProjectResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateTaskProjectResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateTaskProjectResponse res = resBuilder.build();
