...
public class ListSigningTemplates2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSigningTemplates2Request, ListSigningTemplates2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSigningTemplates2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListSigningTemplates2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSigningTemplates2Request request) {
        ...
        @Override
        public ListSigningTemplates2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSigningTemplates2Response.Builder resBuilder =
            ...
            ListSigningTemplates2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSigningTemplates(Utils.unmarshal(response, new TypeReference<List<SigningTemplate>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSigningTemplates2Request, to.unified.unified_java_sdk.models.operations.async.ListSigningTemplates2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSigningTemplates2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListSigningTemplates2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSigningTemplates2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListSigningTemplates2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListSigningTemplates2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListSigningTemplates2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListSigningTemplates2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<SigningTemplate>>() {})
                            .thenApply(res::withSigningTemplates);
                } else {
