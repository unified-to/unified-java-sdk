...
public class GetHrisEmployee2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisEmployee2Request, GetHrisEmployee2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetHrisEmployee2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisEmployee2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisEmployee2Request request) {
        ...
        @Override
        public GetHrisEmployee2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisEmployee2Response.Builder resBuilder =
            ...
            GetHrisEmployee2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisEmployee2Request, to.unified.unified_java_sdk.models.operations.async.GetHrisEmployee2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisEmployee2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisEmployee2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisEmployee2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisEmployee2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisEmployee2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisEmployee2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisEmployee2Response res = resBuilder.build();
