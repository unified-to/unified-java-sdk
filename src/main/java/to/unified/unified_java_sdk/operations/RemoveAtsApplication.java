...
public class RemoveAtsApplication {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAtsApplicationRequest, RemoveAtsApplicationResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAtsApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsApplicationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAtsApplicationRequest request) throws Exception {
        ...
        @Override
        public RemoveAtsApplicationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAtsApplicationResponse.Builder resBuilder =
            ...
            RemoveAtsApplicationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAtsApplicationRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAtsApplicationResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAtsApplicationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsApplicationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAtsApplicationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAtsApplicationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAtsApplicationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAtsApplicationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAtsApplicationResponse res = resBuilder.build();
