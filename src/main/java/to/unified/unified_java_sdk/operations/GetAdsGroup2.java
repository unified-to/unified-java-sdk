...
public class GetAdsGroup2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAdsGroup2Request, GetAdsGroup2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAdsGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsGroup2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAdsGroup2Request request) {
        ...
        @Override
        public GetAdsGroup2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAdsGroup2Response.Builder resBuilder =
            ...
            GetAdsGroup2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAdsGroup2Request, to.unified.unified_java_sdk.models.operations.async.GetAdsGroup2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAdsGroup2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsGroup2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAdsGroup2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAdsGroup2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAdsGroup2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAdsGroup2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAdsGroup2Response res = resBuilder.build();
