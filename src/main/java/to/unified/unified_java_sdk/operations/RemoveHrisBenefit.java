...
public class RemoveHrisBenefit {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveHrisBenefitRequest, RemoveHrisBenefitResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveHrisBenefitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisBenefitRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveHrisBenefitRequest request) {
        ...
        @Override
        public RemoveHrisBenefitResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveHrisBenefitResponse.Builder resBuilder =
            ...
            RemoveHrisBenefitResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveHrisBenefitRequest, to.unified.unified_java_sdk.models.operations.async.RemoveHrisBenefitResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveHrisBenefitRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveHrisBenefitRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveHrisBenefitRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveHrisBenefitResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveHrisBenefitResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveHrisBenefitResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveHrisBenefitResponse res = resBuilder.build();
