...
public class ListCalendarWebinars2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCalendarWebinars2Request, ListCalendarWebinars2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCalendarWebinars2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarWebinars2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarWebinars2Request request) {
        ...
        @Override
        public ListCalendarWebinars2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCalendarWebinars2Response.Builder resBuilder =
            ...
            ListCalendarWebinars2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCalendarWebinars(Utils.unmarshal(response, new TypeReference<List<CalendarWebinar>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCalendarWebinars2Request, to.unified.unified_java_sdk.models.operations.async.ListCalendarWebinars2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCalendarWebinars2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarWebinars2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCalendarWebinars2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCalendarWebinars2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCalendarWebinars2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCalendarWebinars2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCalendarWebinars2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CalendarWebinar>>() {})
                            .thenApply(res::withCalendarWebinars);
                } else {
