...
public class RemoveUnifiedWebhookOperation implements RequestOperation<RemoveUnifiedWebhookRequest, RemoveUnifiedWebhookResponse> {
    ...
    public RemoveUnifiedWebhookOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(RemoveUnifiedWebhookRequest request) throws Exception {
