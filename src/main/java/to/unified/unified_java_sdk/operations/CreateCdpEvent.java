...
public class CreateCdpEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCdpEventRequest, CreateCdpEventResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCdpEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCdpEventRequest.class, new TypeReference<CreateCdpEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCdpEventRequest request) {
        ...
        @Override
        public CreateCdpEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCdpEventResponse.Builder resBuilder =
            ...
            CreateCdpEventResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCdpEvent(Utils.unmarshal(response, new TypeReference<CdpEvent>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCdpEventRequest, to.unified.unified_java_sdk.models.operations.async.CreateCdpEventResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCdpEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCdpEventRequest.class, new TypeReference<CreateCdpEventRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCdpEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCdpEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCdpEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCdpEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCdpEventResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CdpEvent>() {})
                            .thenApply(res::withCdpEvent);
                } else {
