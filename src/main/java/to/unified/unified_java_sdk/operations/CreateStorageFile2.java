...
public class CreateStorageFile2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateStorageFile2Request, CreateStorageFile2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateStorageFile2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateStorageFile2Request.class, new TypeReference<CreateStorageFile2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateStorageFile2Request request) {
        ...
        @Override
        public CreateStorageFile2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateStorageFile2Response.Builder resBuilder =
            ...
            CreateStorageFile2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStorageFile(Utils.unmarshal(response, new TypeReference<StorageFile>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateStorageFile2Request, to.unified.unified_java_sdk.models.operations.async.CreateStorageFile2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateStorageFile2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateStorageFile2Request.class, new TypeReference<CreateStorageFile2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateStorageFile2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateStorageFile2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateStorageFile2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateStorageFile2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateStorageFile2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<StorageFile>() {})
                            .thenApply(res::withStorageFile);
                } else {
