...
public class GetTaskComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTaskCommentRequest, GetTaskCommentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTaskCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskCommentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTaskCommentRequest request) {
        ...
        @Override
        public GetTaskCommentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTaskCommentResponse.Builder resBuilder =
            ...
            GetTaskCommentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTaskCommentRequest, to.unified.unified_java_sdk.models.operations.async.GetTaskCommentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTaskCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaskCommentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTaskCommentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetTaskCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetTaskCommentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetTaskCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetTaskCommentResponse res = resBuilder.build();
