...
public class ListMetadataMetadatas {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMetadataMetadatasRequest request) throws Exception {
        ...
        @Override
        public ListMetadataMetadatasResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<MetadataMetadata> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMetadataMetadatas(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
