...
public class CreateTicketingCategory2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTicketingCategory2Request, CreateTicketingCategory2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateTicketingCategory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTicketingCategory2Request.class, new TypeReference<CreateTicketingCategory2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTicketingCategory2Request request) {
        ...
        @Override
        public CreateTicketingCategory2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTicketingCategory2Response.Builder resBuilder =
            ...
            CreateTicketingCategory2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTicketingCategory2Request, to.unified.unified_java_sdk.models.operations.async.CreateTicketingCategory2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTicketingCategory2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTicketingCategory2Request.class, new TypeReference<CreateTicketingCategory2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTicketingCategory2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateTicketingCategory2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateTicketingCategory2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateTicketingCategory2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateTicketingCategory2Response res = resBuilder.build();
