...
public class GetLmsContent {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLmsContentRequest, GetLmsContentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetLmsContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsContentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLmsContentRequest request) {
        ...
        @Override
        public GetLmsContentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLmsContentResponse.Builder resBuilder =
            ...
            GetLmsContentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLmsContentRequest, to.unified.unified_java_sdk.models.operations.async.GetLmsContentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLmsContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLmsContentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLmsContentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetLmsContentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetLmsContentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetLmsContentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetLmsContentResponse res = resBuilder.build();
