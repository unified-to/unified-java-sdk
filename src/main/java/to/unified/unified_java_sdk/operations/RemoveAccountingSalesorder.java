...
public class RemoveAccountingSalesorder {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingSalesorderRequest, RemoveAccountingSalesorderResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingSalesorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingSalesorderRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingSalesorderRequest request) throws Exception {
        ...
        @Override
        public RemoveAccountingSalesorderResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingSalesorderResponse.Builder resBuilder =
            ...
            RemoveAccountingSalesorderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingSalesorderRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingSalesorderResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingSalesorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingSalesorderRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingSalesorderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingSalesorderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingSalesorderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingSalesorderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingSalesorderResponse res = resBuilder.build();
