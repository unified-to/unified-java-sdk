...
public class UpdateRepoCommit2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateRepoCommit2Request, UpdateRepoCommit2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateRepoCommit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoCommit2Request.class, new TypeReference<UpdateRepoCommit2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateRepoCommit2Request request) {
        ...
        @Override
        public UpdateRepoCommit2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateRepoCommit2Response.Builder resBuilder =
            ...
            UpdateRepoCommit2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateRepoCommit2Request, to.unified.unified_java_sdk.models.operations.async.UpdateRepoCommit2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateRepoCommit2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRepoCommit2Request.class, new TypeReference<UpdateRepoCommit2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateRepoCommit2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateRepoCommit2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateRepoCommit2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateRepoCommit2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateRepoCommit2Response res = resBuilder.build();
