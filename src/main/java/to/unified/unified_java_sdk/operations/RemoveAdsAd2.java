...
public class RemoveAdsAd2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAdsAd2Request, RemoveAdsAd2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAdsAd2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsAd2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAdsAd2Request request) {
        ...
        @Override
        public RemoveAdsAd2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAdsAd2Response.Builder resBuilder =
            ...
            RemoveAdsAd2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAdsAd2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAdsAd2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAdsAd2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsAd2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAdsAd2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAdsAd2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAdsAd2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAdsAd2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAdsAd2Response res = resBuilder.build();
