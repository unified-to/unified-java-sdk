...
public class RemoveAccountingBill {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAccountingBillRequest, RemoveAccountingBillResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAccountingBillRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingBillRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAccountingBillRequest request) throws Exception {
        ...
        @Override
        public RemoveAccountingBillResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAccountingBillResponse.Builder resBuilder =
            ...
            RemoveAccountingBillResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAccountingBillRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAccountingBillResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAccountingBillRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAccountingBillRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAccountingBillRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAccountingBillResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingBillResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAccountingBillResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAccountingBillResponse res = resBuilder.build();
