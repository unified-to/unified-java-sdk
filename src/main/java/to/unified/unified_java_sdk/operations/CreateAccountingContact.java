...
public class CreateAccountingContact {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAccountingContactRequest request) {
        ...
        @Override
        public CreateAccountingContactResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAccountingContactRequest, to.unified.unified_java_sdk.models.operations.async.CreateAccountingContactResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAccountingContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAccountingContactRequest.class, new TypeReference<CreateAccountingContactRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAccountingContactRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAccountingContactResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAccountingContactResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAccountingContactResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAccountingContactResponse res = resBuilder.build();
