...
public class GetRepoPullrequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRepoPullrequestRequest, GetRepoPullrequestResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRepoPullrequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoPullrequestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRepoPullrequestRequest request) {
        ...
        @Override
        public GetRepoPullrequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRepoPullrequestResponse.Builder resBuilder =
            ...
            GetRepoPullrequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRepoPullrequestRequest, to.unified.unified_java_sdk.models.operations.async.GetRepoPullrequestResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRepoPullrequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoPullrequestRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRepoPullrequestRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetRepoPullrequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetRepoPullrequestResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetRepoPullrequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetRepoPullrequestResponse res = resBuilder.build();
