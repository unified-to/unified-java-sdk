...
public class CreateCommerceItemvariant {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCommerceItemvariantRequest, CreateCommerceItemvariantResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCommerceItemvariantRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceItemvariantRequest.class, new TypeReference<CreateCommerceItemvariantRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCommerceItemvariantRequest request) {
        ...
        @Override
        public CreateCommerceItemvariantResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCommerceItemvariantResponse.Builder resBuilder =
            ...
            CreateCommerceItemvariantResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCommerceItemvariantRequest, to.unified.unified_java_sdk.models.operations.async.CreateCommerceItemvariantResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCommerceItemvariantRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCommerceItemvariantRequest.class, new TypeReference<CreateCommerceItemvariantRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCommerceItemvariantRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCommerceItemvariantResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCommerceItemvariantResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCommerceItemvariantResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCommerceItemvariantResponse res = resBuilder.build();
