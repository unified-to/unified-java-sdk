...
public class UpdateCrmPipelineOperation implements RequestOperation<UpdateCrmPipelineRequest, UpdateCrmPipelineResponse> {
    ...
    public UpdateCrmPipelineOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateCrmPipelineRequest request) throws Exception {
