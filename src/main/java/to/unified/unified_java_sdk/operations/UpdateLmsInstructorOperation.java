...
public class UpdateLmsInstructorOperation implements RequestOperation<UpdateLmsInstructorRequest, UpdateLmsInstructorResponse> {
    ...
    public UpdateLmsInstructorOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateLmsInstructorRequest request) throws Exception {
