...
public class UpdateLmsInstructor2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLmsInstructor2Request, UpdateLmsInstructor2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateLmsInstructor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsInstructor2Request.class, new TypeReference<UpdateLmsInstructor2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLmsInstructor2Request request) {
        ...
        @Override
        public UpdateLmsInstructor2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateLmsInstructor2Response.Builder resBuilder =
            ...
            UpdateLmsInstructor2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLmsInstructor2Request, to.unified.unified_java_sdk.models.operations.async.UpdateLmsInstructor2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLmsInstructor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLmsInstructor2Request.class, new TypeReference<UpdateLmsInstructor2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLmsInstructor2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateLmsInstructor2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateLmsInstructor2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateLmsInstructor2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateLmsInstructor2Response res = resBuilder.build();
