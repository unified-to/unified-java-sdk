...
public class ListAccountingAccountsOperation implements RequestOperation<ListAccountingAccountsRequest, ListAccountingAccountsResponse> {
    ...
    public ListAccountingAccountsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAccountingAccountsRequest request) throws Exception {
