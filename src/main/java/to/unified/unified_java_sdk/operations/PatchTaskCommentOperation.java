...
public class PatchTaskCommentOperation implements RequestOperation<PatchTaskCommentRequest, PatchTaskCommentResponse> {
    ...
    public PatchTaskCommentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchTaskCommentRequest request) throws Exception {
