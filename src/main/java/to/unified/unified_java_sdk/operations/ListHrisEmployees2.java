...
public class ListHrisEmployees2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHrisEmployees2Request, ListHrisEmployees2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListHrisEmployees2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisEmployees2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHrisEmployees2Request request) {
        ...
        @Override
        public ListHrisEmployees2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListHrisEmployees2Response.Builder resBuilder =
            ...
            ListHrisEmployees2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHrisEmployees(Utils.unmarshal(response, new TypeReference<List<HrisEmployee>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHrisEmployees2Request, to.unified.unified_java_sdk.models.operations.async.ListHrisEmployees2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListHrisEmployees2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListHrisEmployees2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHrisEmployees2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListHrisEmployees2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListHrisEmployees2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListHrisEmployees2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListHrisEmployees2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<HrisEmployee>>() {})
                            .thenApply(res::withHrisEmployees);
                } else {
