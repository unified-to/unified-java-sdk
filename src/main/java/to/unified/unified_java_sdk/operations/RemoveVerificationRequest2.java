...
public class RemoveVerificationRequest2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveVerificationRequest2Request, RemoveVerificationRequest2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveVerificationRequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveVerificationRequest2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveVerificationRequest2Request request) {
        ...
        @Override
        public RemoveVerificationRequest2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveVerificationRequest2Response.Builder resBuilder =
            ...
            RemoveVerificationRequest2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveVerificationRequest2Request, to.unified.unified_java_sdk.models.operations.async.RemoveVerificationRequest2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveVerificationRequest2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveVerificationRequest2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveVerificationRequest2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveVerificationRequest2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveVerificationRequest2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveVerificationRequest2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveVerificationRequest2Response res = resBuilder.build();
