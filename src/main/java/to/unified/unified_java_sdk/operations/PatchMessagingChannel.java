...
public class PatchMessagingChannel {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchMessagingChannelRequest, PatchMessagingChannelResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchMessagingChannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMessagingChannelRequest.class, new TypeReference<PatchMessagingChannelRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchMessagingChannelRequest request) {
        ...
        @Override
        public PatchMessagingChannelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchMessagingChannelResponse.Builder resBuilder =
            ...
            PatchMessagingChannelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchMessagingChannelRequest, to.unified.unified_java_sdk.models.operations.async.PatchMessagingChannelResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchMessagingChannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchMessagingChannelRequest.class, new TypeReference<PatchMessagingChannelRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchMessagingChannelRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchMessagingChannelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchMessagingChannelResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchMessagingChannelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchMessagingChannelResponse res = resBuilder.build();
