...
public class ListPaymentLinks {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPaymentLinksRequest, to.unified.unified_java_sdk.models.operations.async.ListPaymentLinksResponse> {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListPaymentLinksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListPaymentLinksResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListPaymentLinksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListPaymentLinksResponse res = resBuilder.build();
