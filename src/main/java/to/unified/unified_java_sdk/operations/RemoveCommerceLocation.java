...
public class RemoveCommerceLocation {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveCommerceLocationRequest, RemoveCommerceLocationResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(RemoveCommerceLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceLocationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveCommerceLocationRequest request) throws Exception {
        ...
        @Override
        public RemoveCommerceLocationResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveCommerceLocationResponse.Builder resBuilder =
            ...
            RemoveCommerceLocationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveCommerceLocationRequest, to.unified.unified_java_sdk.models.operations.async.RemoveCommerceLocationResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveCommerceLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveCommerceLocationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveCommerceLocationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveCommerceLocationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceLocationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveCommerceLocationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveCommerceLocationResponse res = resBuilder.build();
