...
public class RemoveRepoBranch {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveRepoBranchRequest, RemoveRepoBranchResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveRepoBranchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoBranchRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveRepoBranchRequest request) throws Exception {
        ...
        @Override
        public RemoveRepoBranchResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveRepoBranchResponse.Builder resBuilder =
            ...
            RemoveRepoBranchResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveRepoBranchRequest, to.unified.unified_java_sdk.models.operations.async.RemoveRepoBranchResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveRepoBranchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveRepoBranchRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveRepoBranchRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveRepoBranchResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveRepoBranchResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveRepoBranchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveRepoBranchResponse res = resBuilder.build();
