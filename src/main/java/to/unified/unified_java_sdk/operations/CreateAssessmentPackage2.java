...
public class CreateAssessmentPackage2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAssessmentPackage2Request, CreateAssessmentPackage2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAssessmentPackage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAssessmentPackage2Request.class, new TypeReference<CreateAssessmentPackage2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAssessmentPackage2Request request) {
        ...
        @Override
        public CreateAssessmentPackage2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAssessmentPackage2Response.Builder resBuilder =
            ...
            CreateAssessmentPackage2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAssessmentPackage(Utils.unmarshal(response, new TypeReference<AssessmentPackage>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateAssessmentPackage2Request, to.unified.unified_java_sdk.models.operations.async.CreateAssessmentPackage2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAssessmentPackage2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateAssessmentPackage2Request.class, new TypeReference<CreateAssessmentPackage2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAssessmentPackage2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateAssessmentPackage2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateAssessmentPackage2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateAssessmentPackage2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateAssessmentPackage2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AssessmentPackage>() {})
                            .thenApply(res::withAssessmentPackage);
                } else {
