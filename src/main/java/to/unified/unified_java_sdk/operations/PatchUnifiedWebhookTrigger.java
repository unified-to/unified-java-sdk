...
public class PatchUnifiedWebhookTrigger {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchUnifiedWebhookTriggerRequest, PatchUnifiedWebhookTriggerResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchUnifiedWebhookTriggerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUnifiedWebhookTriggerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchUnifiedWebhookTriggerRequest request) throws Exception {
        ...
        @Override
        public PatchUnifiedWebhookTriggerResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchUnifiedWebhookTriggerResponse.Builder resBuilder =
            ...
            PatchUnifiedWebhookTriggerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchUnifiedWebhookTriggerRequest, to.unified.unified_java_sdk.models.operations.async.PatchUnifiedWebhookTriggerResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchUnifiedWebhookTriggerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchUnifiedWebhookTriggerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchUnifiedWebhookTriggerRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchUnifiedWebhookTriggerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchUnifiedWebhookTriggerResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchUnifiedWebhookTriggerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchUnifiedWebhookTriggerResponse res = resBuilder.build();
