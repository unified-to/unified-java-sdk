...
public class GetAtsInterview {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAtsInterviewRequest, GetAtsInterviewResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAtsInterviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsInterviewRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAtsInterviewRequest request) {
        ...
        @Override
        public GetAtsInterviewResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAtsInterviewResponse.Builder resBuilder =
            ...
            GetAtsInterviewResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAtsInterviewRequest, to.unified.unified_java_sdk.models.operations.async.GetAtsInterviewResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAtsInterviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAtsInterviewRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAtsInterviewRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAtsInterviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAtsInterviewResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAtsInterviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAtsInterviewResponse res = resBuilder.build();
