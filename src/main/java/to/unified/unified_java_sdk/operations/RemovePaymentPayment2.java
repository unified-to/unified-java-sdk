...
public class RemovePaymentPayment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemovePaymentPayment2Request, RemovePaymentPayment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemovePaymentPayment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePaymentPayment2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemovePaymentPayment2Request request) {
        ...
        @Override
        public RemovePaymentPayment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemovePaymentPayment2Response.Builder resBuilder =
            ...
            RemovePaymentPayment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemovePaymentPayment2Request, to.unified.unified_java_sdk.models.operations.async.RemovePaymentPayment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemovePaymentPayment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemovePaymentPayment2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemovePaymentPayment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemovePaymentPayment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemovePaymentPayment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemovePaymentPayment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemovePaymentPayment2Response res = resBuilder.build();
