...
public class RemoveKmsComment {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveKmsCommentRequest, RemoveKmsCommentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveKmsCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveKmsCommentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveKmsCommentRequest request) throws Exception {
        ...
        @Override
        public RemoveKmsCommentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveKmsCommentResponse.Builder resBuilder =
            ...
            RemoveKmsCommentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveKmsCommentRequest, to.unified.unified_java_sdk.models.operations.async.RemoveKmsCommentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveKmsCommentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveKmsCommentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveKmsCommentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveKmsCommentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveKmsCommentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveKmsCommentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveKmsCommentResponse res = resBuilder.build();
