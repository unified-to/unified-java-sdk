...
public class UpdateCalendarEvent2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCalendarEvent2Request, UpdateCalendarEvent2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCalendarEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCalendarEvent2Request.class, new TypeReference<UpdateCalendarEvent2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCalendarEvent2Request request) {
        ...
        @Override
        public UpdateCalendarEvent2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCalendarEvent2Response.Builder resBuilder =
            ...
            UpdateCalendarEvent2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCalendarEvent2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCalendarEvent2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCalendarEvent2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCalendarEvent2Request.class, new TypeReference<UpdateCalendarEvent2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCalendarEvent2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCalendarEvent2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCalendarEvent2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCalendarEvent2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCalendarEvent2Response res = resBuilder.build();
