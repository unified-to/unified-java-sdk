...
public class GetCommerceItemOperation implements RequestOperation<GetCommerceItemRequest, GetCommerceItemResponse> {
    ...
    public GetCommerceItemOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetCommerceItemRequest request) throws Exception {
