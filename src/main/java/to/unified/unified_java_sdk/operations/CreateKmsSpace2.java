...
public class CreateKmsSpace2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateKmsSpace2Request, CreateKmsSpace2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateKmsSpace2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateKmsSpace2Request.class, new TypeReference<CreateKmsSpace2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateKmsSpace2Request request) {
        ...
        @Override
        public CreateKmsSpace2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateKmsSpace2Response.Builder resBuilder =
            ...
            CreateKmsSpace2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateKmsSpace2Request, to.unified.unified_java_sdk.models.operations.async.CreateKmsSpace2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateKmsSpace2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateKmsSpace2Request.class, new TypeReference<CreateKmsSpace2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateKmsSpace2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateKmsSpace2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateKmsSpace2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateKmsSpace2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateKmsSpace2Response res = resBuilder.build();
