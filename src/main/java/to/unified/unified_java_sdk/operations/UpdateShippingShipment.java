...
public class UpdateShippingShipment {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateShippingShipmentRequest, UpdateShippingShipmentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateShippingShipmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateShippingShipmentRequest.class, new TypeReference<UpdateShippingShipmentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateShippingShipmentRequest request) {
        ...
        @Override
        public UpdateShippingShipmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateShippingShipmentResponse.Builder resBuilder =
            ...
            UpdateShippingShipmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateShippingShipmentRequest, to.unified.unified_java_sdk.models.operations.async.UpdateShippingShipmentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateShippingShipmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateShippingShipmentRequest.class, new TypeReference<UpdateShippingShipmentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateShippingShipmentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateShippingShipmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateShippingShipmentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateShippingShipmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateShippingShipmentResponse res = resBuilder.build();
