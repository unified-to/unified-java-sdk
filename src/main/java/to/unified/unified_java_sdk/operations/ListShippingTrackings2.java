...
public class ListShippingTrackings2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListShippingTrackings2Request, ListShippingTrackings2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListShippingTrackings2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListShippingTrackings2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListShippingTrackings2Request request) {
        ...
        @Override
        public ListShippingTrackings2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListShippingTrackings2Response.Builder resBuilder =
            ...
            ListShippingTrackings2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withShippingTrackings(Utils.unmarshal(response, new TypeReference<List<ShippingTracking>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListShippingTrackings2Request, to.unified.unified_java_sdk.models.operations.async.ListShippingTrackings2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListShippingTrackings2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListShippingTrackings2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListShippingTrackings2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListShippingTrackings2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListShippingTrackings2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListShippingTrackings2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListShippingTrackings2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ShippingTracking>>() {})
                            .thenApply(res::withShippingTrackings);
                } else {
