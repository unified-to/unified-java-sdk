...
public class UpdateTicketingNote2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTicketingNote2Request, UpdateTicketingNote2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateTicketingNote2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketingNote2Request.class, new TypeReference<UpdateTicketingNote2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTicketingNote2Request request) {
        ...
        @Override
        public UpdateTicketingNote2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTicketingNote2Response.Builder resBuilder =
            ...
            UpdateTicketingNote2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTicketingNote(Utils.unmarshal(response, new TypeReference<TicketingNote>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateTicketingNote2Request, to.unified.unified_java_sdk.models.operations.async.UpdateTicketingNote2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateTicketingNote2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateTicketingNote2Request.class, new TypeReference<UpdateTicketingNote2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateTicketingNote2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateTicketingNote2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateTicketingNote2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateTicketingNote2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateTicketingNote2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TicketingNote>() {})
                            .thenApply(res::withTicketingNote);
                } else {
