...
public class ListSocialProfiles {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSocialProfilesRequest, ListSocialProfilesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSocialProfilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSocialProfilesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSocialProfilesRequest request) {
        ...
        @Override
        public ListSocialProfilesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSocialProfilesResponse.Builder resBuilder =
            ...
            ListSocialProfilesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSocialProfiles(Utils.unmarshal(response, new TypeReference<List<SocialProfile>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSocialProfilesRequest, to.unified.unified_java_sdk.models.operations.async.ListSocialProfilesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSocialProfilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSocialProfilesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSocialProfilesRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListSocialProfilesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListSocialProfilesResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListSocialProfilesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListSocialProfilesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<SocialProfile>>() {})
                            .thenApply(res::withSocialProfiles);
                } else {
