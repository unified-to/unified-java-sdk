...
public class GetClubsLocation2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetClubsLocation2Request, GetClubsLocation2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetClubsLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsLocation2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClubsLocation2Request request) {
        ...
        @Override
        public GetClubsLocation2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetClubsLocation2Response.Builder resBuilder =
            ...
            GetClubsLocation2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withClubsLocation(Utils.unmarshal(response, new TypeReference<ClubsLocation>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetClubsLocation2Request, to.unified.unified_java_sdk.models.operations.async.GetClubsLocation2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetClubsLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetClubsLocation2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetClubsLocation2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetClubsLocation2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetClubsLocation2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetClubsLocation2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetClubsLocation2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ClubsLocation>() {})
                            .thenApply(res::withClubsLocation);
                } else {
