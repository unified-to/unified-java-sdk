...
public class GetAccountingReportOperation implements RequestOperation<GetAccountingReportRequest, GetAccountingReportResponse> {
    ...
    public GetAccountingReportOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountingReportRequest request) throws Exception {
