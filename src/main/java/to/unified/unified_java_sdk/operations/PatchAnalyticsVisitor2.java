...
public class PatchAnalyticsVisitor2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAnalyticsVisitor2Request, PatchAnalyticsVisitor2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAnalyticsVisitor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAnalyticsVisitor2Request.class, new TypeReference<PatchAnalyticsVisitor2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAnalyticsVisitor2Request request) {
        ...
        @Override
        public PatchAnalyticsVisitor2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAnalyticsVisitor2Response.Builder resBuilder =
            ...
            PatchAnalyticsVisitor2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAnalyticsVisitor2Request, to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsVisitor2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAnalyticsVisitor2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAnalyticsVisitor2Request.class, new TypeReference<PatchAnalyticsVisitor2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAnalyticsVisitor2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsVisitor2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsVisitor2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsVisitor2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAnalyticsVisitor2Response res = resBuilder.build();
