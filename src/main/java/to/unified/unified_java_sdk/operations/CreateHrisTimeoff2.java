...
public class CreateHrisTimeoff2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateHrisTimeoff2Request, CreateHrisTimeoff2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateHrisTimeoff2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisTimeoff2Request.class, new TypeReference<CreateHrisTimeoff2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateHrisTimeoff2Request request) {
        ...
        @Override
        public CreateHrisTimeoff2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateHrisTimeoff2Response.Builder resBuilder =
            ...
            CreateHrisTimeoff2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateHrisTimeoff2Request, to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeoff2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateHrisTimeoff2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateHrisTimeoff2Request.class, new TypeReference<CreateHrisTimeoff2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateHrisTimeoff2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeoff2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeoff2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeoff2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateHrisTimeoff2Response res = resBuilder.build();
