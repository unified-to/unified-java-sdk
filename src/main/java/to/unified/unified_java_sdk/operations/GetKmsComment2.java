...
public class GetKmsComment2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetKmsComment2Request, GetKmsComment2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetKmsComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetKmsComment2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetKmsComment2Request request) {
        ...
        @Override
        public GetKmsComment2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetKmsComment2Response.Builder resBuilder =
            ...
            GetKmsComment2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetKmsComment2Request, to.unified.unified_java_sdk.models.operations.async.GetKmsComment2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetKmsComment2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetKmsComment2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetKmsComment2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetKmsComment2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetKmsComment2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetKmsComment2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetKmsComment2Response res = resBuilder.build();
