...
public class CreateCrmContact2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCrmContact2Request, CreateCrmContact2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCrmContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmContact2Request.class, new TypeReference<CreateCrmContact2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCrmContact2Request request) {
        ...
        @Override
        public CreateCrmContact2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCrmContact2Response.Builder resBuilder =
            ...
            CreateCrmContact2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCrmContact2Request, to.unified.unified_java_sdk.models.operations.async.CreateCrmContact2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCrmContact2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCrmContact2Request.class, new TypeReference<CreateCrmContact2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCrmContact2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCrmContact2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCrmContact2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCrmContact2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCrmContact2Response res = resBuilder.build();
