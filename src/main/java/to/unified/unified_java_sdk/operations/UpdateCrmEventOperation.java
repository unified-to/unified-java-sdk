...
public class UpdateCrmEventOperation implements RequestOperation<UpdateCrmEventRequest, UpdateCrmEventResponse> {
    ...
    public UpdateCrmEventOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(UpdateCrmEventRequest request) throws Exception {
