...
public class PatchCommerceReview2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchCommerceReview2Request, PatchCommerceReview2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchCommerceReview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceReview2Request.class, new TypeReference<PatchCommerceReview2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchCommerceReview2Request request) {
        ...
        @Override
        public PatchCommerceReview2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchCommerceReview2Response.Builder resBuilder =
            ...
            PatchCommerceReview2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchCommerceReview2Request, to.unified.unified_java_sdk.models.operations.async.PatchCommerceReview2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchCommerceReview2Request request) throws Exception {
            HttpRequest req = buildRequest(request, PatchCommerceReview2Request.class, new TypeReference<PatchCommerceReview2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchCommerceReview2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchCommerceReview2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchCommerceReview2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchCommerceReview2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchCommerceReview2Response res = resBuilder.build();
