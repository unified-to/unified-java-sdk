...
public class UpdateHrisDeduction {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHrisDeductionRequest, UpdateHrisDeductionResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateHrisDeductionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisDeductionRequest.class, new TypeReference<UpdateHrisDeductionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHrisDeductionRequest request) {
        ...
        @Override
        public UpdateHrisDeductionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHrisDeductionResponse.Builder resBuilder =
            ...
            UpdateHrisDeductionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHrisDeductionRequest, to.unified.unified_java_sdk.models.operations.async.UpdateHrisDeductionResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHrisDeductionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHrisDeductionRequest.class, new TypeReference<UpdateHrisDeductionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHrisDeductionRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateHrisDeductionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateHrisDeductionResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateHrisDeductionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateHrisDeductionResponse res = resBuilder.build();
