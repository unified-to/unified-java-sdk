...
public class RemoveMartechList {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveMartechListRequest, RemoveMartechListResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveMartechListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMartechListRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveMartechListRequest request) throws Exception {
        ...
        @Override
        public RemoveMartechListResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveMartechListResponse.Builder resBuilder =
            ...
            RemoveMartechListResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveMartechListRequest, to.unified.unified_java_sdk.models.operations.async.RemoveMartechListResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveMartechListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveMartechListRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveMartechListRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveMartechListResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveMartechListResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveMartechListResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveMartechListResponse res = resBuilder.build();
