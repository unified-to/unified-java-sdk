...
public class GetMartechCampaign2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMartechCampaign2Request, GetMartechCampaign2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetMartechCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetMartechCampaign2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMartechCampaign2Request request) {
        ...
        @Override
        public GetMartechCampaign2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMartechCampaign2Response.Builder resBuilder =
            ...
            GetMartechCampaign2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMartechCampaign2Request, to.unified.unified_java_sdk.models.operations.async.GetMartechCampaign2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMartechCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetMartechCampaign2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMartechCampaign2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetMartechCampaign2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetMartechCampaign2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetMartechCampaign2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetMartechCampaign2Response res = resBuilder.build();
