...
public class RemoveAdsInsertionorder {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAdsInsertionorderRequest, RemoveAdsInsertionorderResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAdsInsertionorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsInsertionorderRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAdsInsertionorderRequest request) {
        ...
        @Override
        public RemoveAdsInsertionorderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAdsInsertionorderResponse.Builder resBuilder =
            ...
            RemoveAdsInsertionorderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAdsInsertionorderRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAdsInsertionorderResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAdsInsertionorderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsInsertionorderRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAdsInsertionorderRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAdsInsertionorderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAdsInsertionorderResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAdsInsertionorderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAdsInsertionorderResponse res = resBuilder.build();
