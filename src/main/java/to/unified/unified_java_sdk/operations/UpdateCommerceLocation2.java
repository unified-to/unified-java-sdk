...
public class UpdateCommerceLocation2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCommerceLocation2Request, UpdateCommerceLocation2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCommerceLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceLocation2Request.class, new TypeReference<UpdateCommerceLocation2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCommerceLocation2Request request) {
        ...
        @Override
        public UpdateCommerceLocation2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCommerceLocation2Response.Builder resBuilder =
            ...
            UpdateCommerceLocation2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCommerceLocation2Request, to.unified.unified_java_sdk.models.operations.async.UpdateCommerceLocation2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCommerceLocation2Request request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCommerceLocation2Request.class, new TypeReference<UpdateCommerceLocation2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCommerceLocation2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCommerceLocation2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceLocation2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCommerceLocation2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCommerceLocation2Response res = resBuilder.build();
