...
public class PatchAtsCandidate {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchAtsCandidateRequest, PatchAtsCandidateResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PatchAtsCandidateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsCandidateRequest.class, new TypeReference<PatchAtsCandidateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchAtsCandidateRequest request) {
        ...
        @Override
        public PatchAtsCandidateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchAtsCandidateResponse.Builder resBuilder =
            ...
            PatchAtsCandidateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchAtsCandidateRequest, to.unified.unified_java_sdk.models.operations.async.PatchAtsCandidateResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PatchAtsCandidateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchAtsCandidateRequest.class, new TypeReference<PatchAtsCandidateRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchAtsCandidateRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.PatchAtsCandidateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.PatchAtsCandidateResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.PatchAtsCandidateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.PatchAtsCandidateResponse res = resBuilder.build();
