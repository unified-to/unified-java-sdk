...
public class CreateCdpProfile {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCdpProfileRequest, CreateCdpProfileResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCdpProfileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCdpProfileRequest.class, new TypeReference<CreateCdpProfileRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCdpProfileRequest request) {
        ...
        @Override
        public CreateCdpProfileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCdpProfileResponse.Builder resBuilder =
            ...
            CreateCdpProfileResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCdpProfileRequest, to.unified.unified_java_sdk.models.operations.async.CreateCdpProfileResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCdpProfileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCdpProfileRequest.class, new TypeReference<CreateCdpProfileRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCdpProfileRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCdpProfileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCdpProfileResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCdpProfileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCdpProfileResponse res = resBuilder.build();
