...
public class CreateCdpDestination {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCdpDestinationRequest, CreateCdpDestinationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCdpDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCdpDestinationRequest.class, new TypeReference<CreateCdpDestinationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCdpDestinationRequest request) {
        ...
        @Override
        public CreateCdpDestinationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCdpDestinationResponse.Builder resBuilder =
            ...
            CreateCdpDestinationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCdpDestination(Utils.unmarshal(response, new TypeReference<CdpDestination>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCdpDestinationRequest, to.unified.unified_java_sdk.models.operations.async.CreateCdpDestinationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCdpDestinationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCdpDestinationRequest.class, new TypeReference<CreateCdpDestinationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCdpDestinationRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCdpDestinationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCdpDestinationResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCdpDestinationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCdpDestinationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CdpDestination>() {})
                            .thenApply(res::withCdpDestination);
                } else {
