...
public class RemoveAtsScorecard {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAtsScorecardRequest, RemoveAtsScorecardResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAtsScorecardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsScorecardRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAtsScorecardRequest request) throws Exception {
        ...
        @Override
        public RemoveAtsScorecardResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAtsScorecardResponse.Builder resBuilder =
            ...
            RemoveAtsScorecardResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAtsScorecardRequest, to.unified.unified_java_sdk.models.operations.async.RemoveAtsScorecardResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAtsScorecardRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAtsScorecardRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAtsScorecardRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAtsScorecardResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAtsScorecardResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAtsScorecardResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAtsScorecardResponse res = resBuilder.build();
