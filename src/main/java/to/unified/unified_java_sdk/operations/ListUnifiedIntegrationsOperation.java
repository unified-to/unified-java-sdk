...
public class ListUnifiedIntegrationsOperation implements RequestOperation<ListUnifiedIntegrationsRequest, ListUnifiedIntegrationsResponse> {
    ...
    public ListUnifiedIntegrationsOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListUnifiedIntegrationsRequest request) throws Exception {
