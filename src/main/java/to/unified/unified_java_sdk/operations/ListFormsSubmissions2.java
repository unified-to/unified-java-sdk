...
public class ListFormsSubmissions2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListFormsSubmissions2Request, ListFormsSubmissions2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListFormsSubmissions2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListFormsSubmissions2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListFormsSubmissions2Request request) {
        ...
        @Override
        public ListFormsSubmissions2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListFormsSubmissions2Response.Builder resBuilder =
            ...
            ListFormsSubmissions2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFormsSubmissions(Utils.unmarshal(response, new TypeReference<List<FormsSubmission>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListFormsSubmissions2Request, to.unified.unified_java_sdk.models.operations.async.ListFormsSubmissions2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListFormsSubmissions2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListFormsSubmissions2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListFormsSubmissions2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListFormsSubmissions2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListFormsSubmissions2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListFormsSubmissions2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListFormsSubmissions2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<FormsSubmission>>() {})
                            .thenApply(res::withFormsSubmissions);
                } else {
