...
public class GetUcCommentOperation implements RequestOperation<GetUcCommentRequest, GetUcCommentResponse> {
    ...
    public GetUcCommentOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetUcCommentRequest request) throws Exception {
