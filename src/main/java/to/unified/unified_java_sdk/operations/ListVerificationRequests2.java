...
public class ListVerificationRequests2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListVerificationRequests2Request, ListVerificationRequests2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListVerificationRequests2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListVerificationRequests2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListVerificationRequests2Request request) {
        ...
        @Override
        public ListVerificationRequests2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListVerificationRequests2Response.Builder resBuilder =
            ...
            ListVerificationRequests2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListVerificationRequests2Request, to.unified.unified_java_sdk.models.operations.async.ListVerificationRequests2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListVerificationRequests2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListVerificationRequests2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListVerificationRequests2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListVerificationRequests2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListVerificationRequests2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListVerificationRequests2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListVerificationRequests2Response res = resBuilder.build();
