...
public class GetAdsAd {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAdsAdRequest, GetAdsAdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetAdsAdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsAdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAdsAdRequest request) {
        ...
        @Override
        public GetAdsAdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAdsAdResponse.Builder resBuilder =
                    GetAdsAdResponse
                            .builder()
            ...
            GetAdsAdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAdsAdRequest, to.unified.unified_java_sdk.models.operations.async.GetAdsAdResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAdsAdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAdsAdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAdsAdRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetAdsAdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetAdsAdResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetAdsAdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetAdsAdResponse res = resBuilder.build();
