...
public class GetCdpProfile {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCdpProfileRequest, GetCdpProfileResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCdpProfileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCdpProfileRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCdpProfileRequest request) {
        ...
        @Override
        public GetCdpProfileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCdpProfileResponse.Builder resBuilder =
            ...
            GetCdpProfileResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCdpProfileRequest, to.unified.unified_java_sdk.models.operations.async.GetCdpProfileResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCdpProfileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCdpProfileRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCdpProfileRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetCdpProfileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetCdpProfileResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetCdpProfileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetCdpProfileResponse res = resBuilder.build();
