...
public class PatchHrisEmployeeOperation implements RequestOperation<PatchHrisEmployeeRequest, PatchHrisEmployeeResponse> {
    ...
    public PatchHrisEmployeeOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchHrisEmployeeRequest request) throws Exception {
