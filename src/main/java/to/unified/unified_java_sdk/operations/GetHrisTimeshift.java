...
public class GetHrisTimeshift {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHrisTimeshiftRequest, GetHrisTimeshiftResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHrisTimeshiftRequest request) {
        ...
        @Override
        public GetHrisTimeshiftResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHrisTimeshiftResponse.Builder resBuilder =
            ...
            GetHrisTimeshiftResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHrisTimeshiftRequest, to.unified.unified_java_sdk.models.operations.async.GetHrisTimeshiftResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHrisTimeshiftRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHrisTimeshiftRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHrisTimeshiftRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetHrisTimeshiftResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetHrisTimeshiftResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetHrisTimeshiftResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetHrisTimeshiftResponse res = resBuilder.build();
