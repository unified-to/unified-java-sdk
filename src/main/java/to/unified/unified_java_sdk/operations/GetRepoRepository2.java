...
public class GetRepoRepository2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRepoRepository2Request, GetRepoRepository2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRepoRepository2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoRepository2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRepoRepository2Request request) {
        ...
        @Override
        public GetRepoRepository2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRepoRepository2Response.Builder resBuilder =
            ...
            GetRepoRepository2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRepoRepository2Request, to.unified.unified_java_sdk.models.operations.async.GetRepoRepository2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRepoRepository2Request request) throws Exception {
            HttpRequest req = buildRequest(request, GetRepoRepository2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRepoRepository2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.GetRepoRepository2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.GetRepoRepository2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.GetRepoRepository2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.GetRepoRepository2Response res = resBuilder.build();
