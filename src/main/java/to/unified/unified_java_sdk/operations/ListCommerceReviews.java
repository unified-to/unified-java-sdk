...
public class ListCommerceReviews {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceReviewsRequest request) throws Exception {
        ...
        @Override
        public ListCommerceReviewsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CommerceReview> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCommerceReviews(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
