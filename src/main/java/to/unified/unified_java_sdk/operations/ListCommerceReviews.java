...
public class ListCommerceReviews {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCommerceReviewsRequest, ListCommerceReviewsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCommerceReviewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceReviewsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCommerceReviewsRequest request) {
        ...
        @Override
        public ListCommerceReviewsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCommerceReviewsResponse.Builder resBuilder =
            ...
            ListCommerceReviewsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCommerceReviewsRequest, to.unified.unified_java_sdk.models.operations.async.ListCommerceReviewsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCommerceReviewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCommerceReviewsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCommerceReviewsRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCommerceReviewsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCommerceReviewsResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCommerceReviewsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCommerceReviewsResponse res = resBuilder.build();
