...
public class ListRepoRepositories2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRepoRepositories2Request, ListRepoRepositories2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListRepoRepositories2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoRepositories2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRepoRepositories2Request request) {
        ...
        @Override
        public ListRepoRepositories2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListRepoRepositories2Response.Builder resBuilder =
            ...
            ListRepoRepositories2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRepoRepositories(Utils.unmarshal(response, new TypeReference<List<RepoRepository>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListRepoRepositories2Request, to.unified.unified_java_sdk.models.operations.async.ListRepoRepositories2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListRepoRepositories2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListRepoRepositories2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRepoRepositories2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListRepoRepositories2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListRepoRepositories2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListRepoRepositories2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListRepoRepositories2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<RepoRepository>>() {})
                            .thenApply(res::withRepoRepositories);
                } else {
