...
public class RemoveUnifiedEnvironment {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveUnifiedEnvironmentRequest, RemoveUnifiedEnvironmentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveUnifiedEnvironmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUnifiedEnvironmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveUnifiedEnvironmentRequest request) {
        ...
        @Override
        public RemoveUnifiedEnvironmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveUnifiedEnvironmentResponse.Builder resBuilder =
            ...
            RemoveUnifiedEnvironmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveUnifiedEnvironmentRequest, to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedEnvironmentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveUnifiedEnvironmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveUnifiedEnvironmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveUnifiedEnvironmentRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedEnvironmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedEnvironmentResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedEnvironmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveUnifiedEnvironmentResponse res = resBuilder.build();
