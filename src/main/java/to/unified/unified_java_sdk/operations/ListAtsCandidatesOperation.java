...
public class ListAtsCandidatesOperation implements RequestOperation<ListAtsCandidatesRequest, ListAtsCandidatesResponse> {
    ...
    public ListAtsCandidatesOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(ListAtsCandidatesRequest request) throws Exception {
