...
public class GetAccountingProfitlossOperation implements RequestOperation<GetAccountingProfitlossRequest, GetAccountingProfitlossResponse> {
    ...
    public GetAccountingProfitlossOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetAccountingProfitlossRequest request) throws Exception {
