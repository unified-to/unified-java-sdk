...
public class CreateCalendarLink2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCalendarLink2Request, CreateCalendarLink2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCalendarLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCalendarLink2Request.class, new TypeReference<CreateCalendarLink2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCalendarLink2Request request) {
        ...
        @Override
        public CreateCalendarLink2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCalendarLink2Response.Builder resBuilder =
            ...
            CreateCalendarLink2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCalendarLink(Utils.unmarshal(response, new TypeReference<CalendarLink>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCalendarLink2Request, to.unified.unified_java_sdk.models.operations.async.CreateCalendarLink2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCalendarLink2Request request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCalendarLink2Request.class, new TypeReference<CreateCalendarLink2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCalendarLink2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.CreateCalendarLink2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.CreateCalendarLink2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.CreateCalendarLink2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.CreateCalendarLink2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CalendarLink>() {})
                            .thenApply(res::withCalendarLink);
                } else {
