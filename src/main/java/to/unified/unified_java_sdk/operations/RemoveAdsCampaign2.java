...
public class RemoveAdsCampaign2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveAdsCampaign2Request, RemoveAdsCampaign2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveAdsCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsCampaign2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveAdsCampaign2Request request) {
        ...
        @Override
        public RemoveAdsCampaign2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveAdsCampaign2Response.Builder resBuilder =
            ...
            RemoveAdsCampaign2Response res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveAdsCampaign2Request, to.unified.unified_java_sdk.models.operations.async.RemoveAdsCampaign2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveAdsCampaign2Request request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveAdsCampaign2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveAdsCampaign2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.RemoveAdsCampaign2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.RemoveAdsCampaign2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.RemoveAdsCampaign2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.RemoveAdsCampaign2Response res = resBuilder.build();
