...
public class UpdateCrmEvent {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCrmEventRequest, UpdateCrmEventResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCrmEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmEventRequest.class, new TypeReference<UpdateCrmEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCrmEventRequest request) {
        ...
        @Override
        public UpdateCrmEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCrmEventResponse.Builder resBuilder =
            ...
            UpdateCrmEventResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCrmEventRequest, to.unified.unified_java_sdk.models.operations.async.UpdateCrmEventResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCrmEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCrmEventRequest.class, new TypeReference<UpdateCrmEventRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCrmEventRequest request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.UpdateCrmEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.UpdateCrmEventResponse.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.UpdateCrmEventResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.UpdateCrmEventResponse res = resBuilder.build();
