...
public class PatchAccountingOrderOperation implements RequestOperation<PatchAccountingOrderRequest, PatchAccountingOrderResponse> {
    ...
    public PatchAccountingOrderOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(PatchAccountingOrderRequest request) throws Exception {
