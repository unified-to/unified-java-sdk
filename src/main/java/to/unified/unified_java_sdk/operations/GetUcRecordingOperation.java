...
public class GetUcRecordingOperation implements RequestOperation<GetUcRecordingRequest, GetUcRecordingResponse> {
    ...
    public GetUcRecordingOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetUcRecordingRequest request) throws Exception {
