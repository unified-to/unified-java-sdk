...
public class ListCalendarCalendars2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCalendarCalendars2Request, ListCalendarCalendars2Response> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListCalendarCalendars2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarCalendars2Request.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCalendarCalendars2Request request) {
        ...
        @Override
        public ListCalendarCalendars2Response handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListCalendarCalendars2Response.Builder resBuilder =
            ...
            ListCalendarCalendars2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCalendarCalendars(Utils.unmarshal(response, new TypeReference<List<CalendarCalendar>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCalendarCalendars2Request, to.unified.unified_java_sdk.models.operations.async.ListCalendarCalendars2Response> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListCalendarCalendars2Request request) throws Exception {
            HttpRequest req = buildRequest(request, ListCalendarCalendars2Request.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCalendarCalendars2Request request) {
        ...
        @Override
        public CompletableFuture<to.unified.unified_java_sdk.models.operations.async.ListCalendarCalendars2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            to.unified.unified_java_sdk.models.operations.async.ListCalendarCalendars2Response.Builder resBuilder =
                    to.unified.unified_java_sdk.models.operations.async.ListCalendarCalendars2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            to.unified.unified_java_sdk.models.operations.async.ListCalendarCalendars2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<CalendarCalendar>>() {})
                            .thenApply(res::withCalendarCalendars);
                } else {
