    ...
    public ListUnifiedIssuesResponse listUnifiedIssues(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                List<to.unified.unified_java_sdk.models.shared.Issue> _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<List<to.unified.unified_java_sdk.models.shared.Issue>>() {});
