...
public class PropertyAtsCompanyAddress {
    ...
    public PropertyAtsCompanyAddress withAddress1(Optional<String> address1) {
        Utils.checkNotNull(address1, "address1");
        this.address1 = address1;
        return this;
    }
    ...
    public PropertyAtsCompanyAddress withAddress2(Optional<String> address2) {
        Utils.checkNotNull(address2, "address2");
        this.address2 = address2;
        return this;
    }
    ...
    public PropertyAtsCompanyAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
    ...
    public PropertyAtsCompanyAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    public PropertyAtsCompanyAddress withCountryCode(Optional<String> countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }
    ...
    public PropertyAtsCompanyAddress withPostalCode(Optional<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
    ...
    public PropertyAtsCompanyAddress withRegion(Optional<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
    ...
    public PropertyAtsCompanyAddress withRegionCode(Optional<String> regionCode) {
        Utils.checkNotNull(regionCode, "regionCode");
        this.regionCode = regionCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PropertyAtsCompanyAddress other = (PropertyAtsCompanyAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PropertyAtsCompanyAddress.class,
                "address1", address1,
                "address2", address2,
                "city", city,
                "country", country,
    ...
    public final static class Builder {
        ...
        public PropertyAtsCompanyAddress build() {
            return new PropertyAtsCompanyAddress(
                address1,
                address2,
                city,
                country,
