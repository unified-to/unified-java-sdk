...
public class PropertyAccountingContactShippingAddress {
    ...
    public PropertyAccountingContactShippingAddress withAddress1(Optional<String> address1) {
        Utils.checkNotNull(address1, "address1");
        this.address1 = address1;
        return this;
    }
    ...
    public PropertyAccountingContactShippingAddress withAddress2(Optional<String> address2) {
        Utils.checkNotNull(address2, "address2");
        this.address2 = address2;
        return this;
    }
    ...
    public PropertyAccountingContactShippingAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
    ...
    public PropertyAccountingContactShippingAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    public PropertyAccountingContactShippingAddress withCountryCode(Optional<String> countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }
    ...
    public PropertyAccountingContactShippingAddress withPostalCode(Optional<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
    ...
    public PropertyAccountingContactShippingAddress withRegion(Optional<String> region) {
        Utils.checkNotNull(region, "region");
        this.region = region;
        return this;
    }
    ...
    public PropertyAccountingContactShippingAddress withRegionCode(Optional<String> regionCode) {
        Utils.checkNotNull(regionCode, "regionCode");
        this.regionCode = regionCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PropertyAccountingContactShippingAddress other = (PropertyAccountingContactShippingAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PropertyAccountingContactShippingAddress.class,
                "address1", address1,
                "address2", address2,
                "city", city,
                "country", country,
    ...
    public final static class Builder {
        ...
        public PropertyAccountingContactShippingAddress build() {
            return new PropertyAccountingContactShippingAddress(
                address1,
                address2,
                city,
                country,
