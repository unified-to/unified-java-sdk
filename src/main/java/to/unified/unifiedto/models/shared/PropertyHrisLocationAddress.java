...
public class PropertyHrisLocationAddress {
    ...
    public PropertyHrisLocationAddress withAddress2(String address2) {
        Utils.checkNotNull(address2, "address2");
    ...
    public PropertyHrisLocationAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
    ...
    public PropertyHrisLocationAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
    ...
    public PropertyHrisLocationAddress withCountryCode(String countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
    ...
    public PropertyHrisLocationAddress withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
    ...
    public PropertyHrisLocationAddress withRegion(String region) {
        Utils.checkNotNull(region, "region");
    ...
    public PropertyHrisLocationAddress withRegionCode(String regionCode) {
        Utils.checkNotNull(regionCode, "regionCode");
