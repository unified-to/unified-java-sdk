...
public class ListPaymentSubscriptionsRequest {
     ...
     * ID of the connection
     */
    public ListPaymentSubscriptionsRequest withConnectionId(String connectionId) {
        Utils.checkNotNull(connectionId, "connectionId");
        this.connectionId = connectionId;
        return this;
    }
    ...
    public ListPaymentSubscriptionsRequest withLimit(double limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = Optional.ofNullable(limit);
        return this;
    }

    public ListPaymentSubscriptionsRequest withLimit(Optional<Double> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }

    public ListPaymentSubscriptionsRequest withOffset(double offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = Optional.ofNullable(offset);
        return this;
    }

    public ListPaymentSubscriptionsRequest withOffset(Optional<Double> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public ListPaymentSubscriptionsRequest withOrder(String order) {
        Utils.checkNotNull(order, "order");
        this.order = Optional.ofNullable(order);
        return this;
    }

    public ListPaymentSubscriptionsRequest withOrder(Optional<String> order) {
        Utils.checkNotNull(order, "order");
        this.order = order;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListPaymentSubscriptionsRequest withQuery(String query) {
        Utils.checkNotNull(query, "query");
     ...
     * Query string to search. eg. email address or name
     */
    public ListPaymentSubscriptionsRequest withQuery(Optional<String> query) {
        Utils.checkNotNull(query, "query");
        this.query = query;
        return this;
    }

    public ListPaymentSubscriptionsRequest withSort(String sort) {
        Utils.checkNotNull(sort, "sort");
        this.sort = Optional.ofNullable(sort);
        return this;
    }

    public ListPaymentSubscriptionsRequest withSort(Optional<String> sort) {
        Utils.checkNotNull(sort, "sort");
        this.sort = sort;
        return this;
    }
     ...
     * Return only results whose updated date is equal or greater to this value
     */
    public ListPaymentSubscriptionsRequest withUpdatedGte(OffsetDateTime updatedGte) {
        Utils.checkNotNull(updatedGte, "updatedGte");
     ...
     * Return only results whose updated date is equal or greater to this value
     */
    public ListPaymentSubscriptionsRequest withUpdatedGte(Optional<OffsetDateTime> updatedGte) {
        Utils.checkNotNull(updatedGte, "updatedGte");
        this.updatedGte = updatedGte;
        return this;
    }
