...
public class GetMetadataMetadataResponse implements Response {
    ...
    @JsonCreator
    public GetMetadataMetadataResponse(
            String contentType,
     ...
     * HTTP response content type for this operation
     */
    public GetMetadataMetadataResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Successful
     */
    public GetMetadataMetadataResponse withMetadataMetadata(MetadataMetadata metadataMetadata) {
        Utils.checkNotNull(metadataMetadata, "metadataMetadata");
     ...
     * Successful
     */
    public GetMetadataMetadataResponse withMetadataMetadata(Optional<? extends MetadataMetadata> metadataMetadata) {
        Utils.checkNotNull(metadataMetadata, "metadataMetadata");
        this.metadataMetadata = metadataMetadata;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetMetadataMetadataResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetMetadataMetadataResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMetadataMetadataResponse other = (GetMetadataMetadataResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMetadataMetadataResponse.class,
    ...
    public final static class Builder {
        ...
        public GetMetadataMetadataResponse build() {
            return new GetMetadataMetadataResponse(
                contentType,
                metadataMetadata,
                statusCode,
                rawResponse);
