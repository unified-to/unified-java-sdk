...
public class CreateAtsDocumentResponse implements Response {
     ...
     * Successful
     */
    public CreateAtsDocumentResponse withAtsDocument(AtsDocument atsDocument) {
        Utils.checkNotNull(atsDocument, "atsDocument");
     ...
     * Successful
     */
    public CreateAtsDocumentResponse withAtsDocument(Optional<? extends AtsDocument> atsDocument) {
        Utils.checkNotNull(atsDocument, "atsDocument");
        this.atsDocument = atsDocument;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateAtsDocumentResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
