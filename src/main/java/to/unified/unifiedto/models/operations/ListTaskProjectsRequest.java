...
public class ListTaskProjectsRequest {
    ...
    public ListTaskProjectsRequest withParentId(Optional<String> parentId) {
        Utils.checkNotNull(parentId, "parentId");
        this.parentId = parentId;
        return this;
    }
     ...
     * Query string to search. eg. email address or name
     */
    public ListTaskProjectsRequest withQuery(Optional<String> query) {
        Utils.checkNotNull(query, "query");
        this.query = query;
        return this;
    }
     ...
     * Return only results whose updated date is equal or greater to this value
     */
    public ListTaskProjectsRequest withUpdatedGte(Optional<OffsetDateTime> updatedGte) {
        Utils.checkNotNull(updatedGte, "updatedGte");
        this.updatedGte = updatedGte;
        return this;
    }
