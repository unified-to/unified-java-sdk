...
public class CreateCrmEventResponse implements Response {
     ...
     * Successful
     */
    public CreateCrmEventResponse withCrmEvent(CrmEvent crmEvent) {
        Utils.checkNotNull(crmEvent, "crmEvent");
     ...
     * Successful
     */
    public CreateCrmEventResponse withCrmEvent(Optional<? extends CrmEvent> crmEvent) {
        Utils.checkNotNull(crmEvent, "crmEvent");
        this.crmEvent = crmEvent;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateCrmEventResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
