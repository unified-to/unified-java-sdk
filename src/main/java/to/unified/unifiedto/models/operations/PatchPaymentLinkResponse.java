...
public class PatchPaymentLinkResponse implements Response {
     ...
     * Successful
     */
    public PatchPaymentLinkResponse withPaymentLink(PaymentLink paymentLink) {
        Utils.checkNotNull(paymentLink, "paymentLink");
     ...
     * Successful
     */
    public PatchPaymentLinkResponse withPaymentLink(Optional<? extends PaymentLink> paymentLink) {
        Utils.checkNotNull(paymentLink, "paymentLink");
        this.paymentLink = paymentLink;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PatchPaymentLinkResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
