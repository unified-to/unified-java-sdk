...
public class ListScimUsersRequest {
     ...
     * ID of the connection
     */
    public ListScimUsersRequest withConnectionId(String connectionId) {
        Utils.checkNotNull(connectionId, "connectionId");
        this.connectionId = connectionId;
        return this;
    }

    public ListScimUsersRequest withCount(double count) {
        Utils.checkNotNull(count, "count");
    ...
    public ListScimUsersRequest withFilter(String filter) {
        Utils.checkNotNull(filter, "filter");
    ...
    public ListScimUsersRequest withSortBy(String sortBy) {
        Utils.checkNotNull(sortBy, "sortBy");
    ...
    public ListScimUsersRequest withSortOrder(String sortOrder) {
        Utils.checkNotNull(sortOrder, "sortOrder");
    ...
    public ListScimUsersRequest withStartIndex(double startIndex) {
        Utils.checkNotNull(startIndex, "startIndex");
