...
public class Connection implements
    ...
    public CreateUnifiedConnectionResponse createUnifiedConnection(
            to.unified.unifiedto.models.shared.Connection request) throws Exception {
        ...
        Object _convertedRequest = Utils.convertToShape(
                request, 
                JsonShape.DEFAULT,
                new TypeReference<to.unified.unifiedto.models.shared.Connection>() {});
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                to.unified.unifiedto.models.shared.Connection _out = Utils.mapper().readValue(
    ...
    public ListUnifiedConnectionsResponse listUnifiedConnections(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                List<to.unified.unifiedto.models.shared.Connection> _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<List<to.unified.unifiedto.models.shared.Connection>>() {});
