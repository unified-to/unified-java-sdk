...
public class Webhook implements
    ...
    public CreateUnifiedWebhookResponse createUnifiedWebhook(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                to.unified.unifiedto.models.shared.Webhook _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<to.unified.unifiedto.models.shared.Webhook>() {});
    ...
    public ListUnifiedWebhooksResponse listUnifiedWebhooks(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                List<to.unified.unifiedto.models.shared.Webhook> _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<List<to.unified.unifiedto.models.shared.Webhook>>() {});
