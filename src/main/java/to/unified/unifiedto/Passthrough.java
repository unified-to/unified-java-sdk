...
import to.unified.unifiedto.models.operations.CreatePassthroughJsonRequestBuilder;
...
import to.unified.unifiedto.models.operations.CreatePassthroughRawRequestBuilder;
...
import to.unified.unifiedto.models.operations.ListPassthroughsRequestBuilder;
...
import to.unified.unifiedto.models.operations.PatchPassthroughJsonRequestBuilder;
...
import to.unified.unifiedto.models.operations.PatchPassthroughRawRequestBuilder;
...
import to.unified.unifiedto.models.operations.RemovePassthroughRequestBuilder;
...
import to.unified.unifiedto.models.operations.UpdatePassthroughJsonRequestBuilder;
...
import to.unified.unifiedto.models.operations.UpdatePassthroughRawRequestBuilder;
...
public class Passthrough implements
    ...
    public CreatePassthroughJsonResponse createPassthroughJson(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "204", "205")) {
            _res.withHeaders(_httpRes.headers().map());
            // no content 
            return _res;
        }
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "304")) {
            _res.withHeaders(_httpRes.headers().map());
            // no content 
            return _res;
        }
