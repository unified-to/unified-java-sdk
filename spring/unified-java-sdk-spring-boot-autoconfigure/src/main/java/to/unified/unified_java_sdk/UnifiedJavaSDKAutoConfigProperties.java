...
/**
 * Spring Boot Configuration Properties for Unified-java-sdk SDK
 */
@ConfigurationProperties(prefix = "unifiedjavasdk")
public class UnifiedJavaSDKAutoConfigProperties {

    /**
     * Constructor.
     */
    public UnifiedJavaSDKAutoConfigProperties() {
    }
    ...
    public static class RetryConfig {
         ...
         */
        private to.unified.unified_java_sdk.utils.RetryConfig.Strategy strategy;
         ...
         */
        public to.unified.unified_java_sdk.utils.RetryConfig.Strategy getStrategy() {
            return strategy;
        }
         ...
         */
        public void setStrategy(to.unified.unified_java_sdk.utils.RetryConfig.Strategy strategy) {
